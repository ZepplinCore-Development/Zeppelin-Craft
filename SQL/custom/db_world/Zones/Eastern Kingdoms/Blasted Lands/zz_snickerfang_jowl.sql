...
(5985, 8391, 0, 100, 1, 1, 0, 1, 1, 'Snickerfang Hyena - Snickerfang Jowl');
...
INSERT INTO `creature_loot_template` (`Entry`, `Item`, `Reference`, `Chance`, `QuestRequired`, `LootMode`, `GroupId`, `MinCount`, `MaxCount`, `Comment`) VALUES
(8300, 8391, 0, 100, 1, 1, 0, 1, 1, 'Snickerfang Hyena - Snickerfang Jowl');
...
INSERT INTO `creature_loot_template` (`Entry`, `Item`, `Reference`, `Chance`, `QuestRequired`, `LootMode`, `GroupId`, `MinCount`, `MaxCount`, `Comment`) VALUES
(5984, 8391, 0, 100, 1, 1, 0, 1, 1, 'Starving Snickerfang - Snickerfang Jowl');