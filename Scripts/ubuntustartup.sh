...
gnome-terminal\
	--tab\
		--title="World Server" -- bash -c "cd; cd Zeppelin-Core; git pull; cd; cp -r Zeppelin-Core/custom azerothcore-wotlk/data/sql; azerothcore-wotlk/acore.sh run-worldserver; $SHELL"
gnome-terminal\
	--tab\
