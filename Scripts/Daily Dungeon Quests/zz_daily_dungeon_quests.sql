...
-- Hellfire Ramparts - Nazan - Fel Nether Essence - Item template
                DELETE FROM `item_template` WHERE (`entry` = 900249);
                INSERT INTO `item_template`
                SET `entry` = 900249, 
                    `class` = 12, 
                    `subclass` = 0, 
...
-- Hellfire Ramparts - Nazan - Fel Nether Essence - Quest Item
                DELETE FROM `creature_questitem` WHERE (`CreatureEntry` = 17536) AND (`ItemId` = 900249);
                INSERT INTO `creature_questitem`
...
-- Hellfire Ramparts - Nazan - Fel Nether Essence - Loot Template
                DELETE FROM `creature_loot_template` WHERE (`Entry` = 17536) AND (`Item` IN (900249));
                INSERT INTO `creature_loot_template`
                SET `Entry` = 17536, 
                    `Item` = 900249, 
                    `Chance` = 100, 
...
-- Blood Furnace - Keli''dan the Breaker - Thrallmar / Honor Hold - Quest Template
                ...
                SET `ID` = 441218,
                    ...
                    `QuestDescription` = 'Brave soul, I have a new challenge for you. Within the sinister Blood Furnace, the warlock Keli''dan the Breaker protects a potent artifact: the Blood Crucible. This crucible holds the key to unraveling the mysteries of fel blood magic. Your task is to infiltrate the Blood Furnace, slay Keli''dan, and retrieve the Blood Crucible. Do this, and a generous reward shall be yours.',
                    `AreaDescription` = '',
