-- 1 - 15 Mobs
-- Mutated Root Lasher
UPDATE `creature_template` SET `type_flags` = 256, `skinloot` = 100016 WHERE (`entry` = 16517);
-- Tender
UPDATE `creature_template` SET `type_flags` = 256, `skinloot` = 100016 WHERE (`entry` = 15271);
-- Feral Tender
UPDATE `creature_template` SET `type_flags` = 256, `skinloot` = 100016 WHERE (`entry` = 15294);
-- Bogling
