...
--************************************************
	...
	Naxxramas40 = {
		...
		MinLevel = "60";
		PlayerLimit = "40";
		Acronym = AtlasLocale["Nax"].."40";
		{ BLUE.."A) "..AtlasLocale["Entrance"] };
		{ BLUE..INDENT..AtlasLocale["Mr. Bigglesworth"].." ("..AtlasLocale["Wanders"]..")", NPC, 16998 };
		{ GREY..BabbleSubZone["The Construct Quarter"] };
		{ GREY..INDENT.."1) "..AtlasLocale["Patchwerk"], NPC, 351028 };
		{ GREY..INDENT.."2) "..AtlasLocale["Grobbulus"], NPC, 351003 };
		{ GREY..INDENT.."3) "..AtlasLocale["Gluth"], NPC, 351004 };
		{ GREY..INDENT.."4) "..AtlasLocale["Thaddius"], NPC, 351000 };
		{ ORNG..BabbleSubZone["The Arachnid Quarter"] };
		{ ORNG..INDENT.."1) "..AtlasLocale["Anub'Rekhan"], NPC, 351009 };
		{ ORNG..INDENT.."2) "..AtlasLocale["Grand Widow Faerlina"], NPC, 351007 };
		{ ORNG..INDENT.."3) "..AtlasLocale["Maexxna"], NPC, 351006 };
		{ _RED..BabbleSubZone["The Military Quarter"] };
		{ _RED..INDENT.."1) "..AtlasLocale["Instructor Razuvious"], NPC, 351036 };
		{ _RED..INDENT.."2) "..AtlasLocale["Gothik the Harvester"], NPC, 351035 };
		{ _RED..INDENT.."3) "..AtlasLocale["The Four Horsemen"] };
		{ _RED..INDENT..INDENT..AtlasLocale["Thane Korth'azz"], NPC, 351029 };
		{ _RED..INDENT..INDENT..AtlasLocale["Lady Blaumeux"], NPC, 351030 };
		{ _RED..INDENT..INDENT..AtlasLocale["Highlord Mograine"], NPC, 351031 };
		{ _RED..INDENT..INDENT..AtlasLocale["Sir Zeliek"], NPC, 351032 };
		{ _RED..INDENT..INDENT..AtlasLocale["Four Horsemen Chest"], OBJECT, 361000 };
		{ PURP..BabbleSubZone["The Plague Quarter"] };
		{ PURP..INDENT.."1) "..AtlasLocale["Noth the Plaguebringer"], NPC, 351008 };
		{ PURP..INDENT.."2) "..AtlasLocale["Heigan the Unclean"], NPC, 351005 };
		{ PURP..INDENT.."3) "..AtlasLocale["Loatheb"], NPC, 351020 };
		{ GREN..AtlasLocale["Frostwyrm Lair"] };
		{ GREN..INDENT.."1) "..AtlasLocale["Sapphiron"], NPC, 351018 };
		{ GREN..INDENT.."2) "..AtlasLocale["Kel'Thuzad"], NPC, 351019 };
	};
	ObsidianSanctum = {
