...
-------------------------
  ...
  -- Blackrock Depths
	...
	AtlasLoot_TableNames["BRDAnubshiah"] = { BabbleBoss["Anub'shiah"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["BRDEviscerator"] = { BabbleBoss["Eviscerator"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["BRDGorosh"] = { BabbleBoss["Gorosh the Dervish"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["BRDGrizzle"] = { BabbleBoss["Grizzle"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["BRDHedrum"] = { BabbleBoss["Hedrum the Creeper"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["BRDOkthor"] = { BabbleBoss["Ok'thor the Breaker"], "AtlasLootOriginalWoW" };
