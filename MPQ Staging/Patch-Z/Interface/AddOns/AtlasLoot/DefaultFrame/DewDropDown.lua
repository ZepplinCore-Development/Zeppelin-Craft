...
AtlasLoot_DewDropDown_SubTables = {
	...
	["SunkenTemple"] = {
		...
		{ BabbleBoss["Dreamscythe"].." & "..BabbleBoss["Weaver"], "STDreamscytheWeaver" },
		{ BabbleBoss["Avatar of Hakkar"], "STAvatarofHakkar" },
		{ BabbleBoss["Jammal'an the Prophet"].." & "..BabbleBoss["Ogom the Wretched"], "STJammalanOgom" },
		{ BabbleBoss["Hazzas"].." & "..BabbleBoss["Morphaz"], "STHazzasMorphaz" },
