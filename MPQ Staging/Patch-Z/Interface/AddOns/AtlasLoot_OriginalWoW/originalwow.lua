...
---- Azuregos
    ...
    { 7, 888, "", "=q3=Naga Battle Gloves", "=ds=#a2#", "", "40.0%" };
    { 8, 3078, "", "=q2=Naga Heartpiercer", "=ds=#w3#", "", "20.0%" };
    { 9, 11121, "", "=q2=Darkwater Talwar", "=ds=#w10#", "", "40.0%" };
    { 11, 0, "INV_Box_01", "=q6="..BabbleBoss["Gelihast"], "" };
    { 12, 6905, "", "=q2=Reef Axe", "=ds=#w2#", "", "50.0%" };
    { 13, 6906, "", "=q3=Algae Fists", "=ds=#a3#", "", "50.0%" };
    { 14, 58100, "", "=q3=Giant Murloc", "=ds=#e10#", "", "50.0%" };
    { 16, 0, "INV_Box_01", "=q6="..BabbleBoss["Baron Aquanis"], "" };
    { 17, 1454, "", "=q3=Axe of the Enforcer", "=ds=#w1#", "", "0.02%" };
    { 18, 1481, "", "=q3=Grimclaw", "=ds=#w1#", "", "0.08%" };
    { 19, 1491, "", "=q3=Ring of Precision", "=ds=#e15#", "", "0.12%" };
    { 20, 2271, "", "=q3=Staff of the Blessed Seer", "=ds=#w9#", "", "0.07%" };
    { 21, 3414, "", "=q3=Crested Scepter", "=ds=#w6#", "", "0.08%" };
    { 22, 3416, "", "=q3=Martyr's Chain", "=ds=#a3#", "", "0.05%" };
    ...
    { 27, 1155, "", "=q3=Rod of the Sleepwalker", "=ds=#w9#", "", "60.0%" };
    { 28, 6903, "", "=q2=Gaze Dreamer Pants", "=ds=#a1#", "", "40.0%" };
    { 30, 0, "INV_Box_01", "=q6="..BabbleBoss["Old Serra'kis"], "" };
    { 31, 6901, "", "=q3=Glowing Thresher Cape", "=ds=#a1#", "", "40.0%" };
    { 32, 6902, "", "=q2=Bands of Serra'kis", "=ds=#a2#", "", "30.0%" };
    { 33, 6904, "", "=q3=Bite of Serra'kis", "=ds=#w4#", "", "30.0%" };
	};
	
	AtlasLoot_Data["BlackfathomDeeps2"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Aku'mai"], "" };
    { 2, 901709, "", "=q1=Void Pearl", "=ds=#m3#", "", "100%" };
    { 3, 6909, "", "=q3=Strike of the Hydra", "=ds=#w11#", "", "20.0%" };
    ...
    { 10, 19339, "", "=q4=Mind Quickening Gem", "=ds=#e15#", "", "20.0%" };
    { 11, 19340, "", "=q4=Rune of Metamorphosis", "=ds=#e15#", "", "20.0%" };
    { 12, 19346, "", "=q4=Dragonfang Blade", "=ds=#w4#", "", "10.0%" };
    { 13, 19348, "", "=q4=Red Dragonscale Protector", "=ds=#e16#", "", "10.0%" };
    ...
    { 3, 16898, "", "=q4=Stormrage Boots", "=ds=#a2#", "", "11.1%" };
    { 4, 16906, "", "=q4=Bloodfang Boots", "=ds=#a2#", "", "11.1%" };
    { 5, 16912, "", "=q4=Netherwind Boots", "=ds=#a1#", "", "11.1%" };
    { 6, 16919, "", "=q4=Boots of Transcendence", "=ds=#a1#", "", "11.1%" };
    { 7, 16927, "", "=q4=Nemesis Boots", "=ds=#a1#", "", "11.1%" };
    { 8, 16941, "", "=q4=Dragonstalker's Greaves", "=ds=#a3#", "", "11.1%" };
    { 9, 16949, "", "=q4=Greaves of Ten Storms", "=ds=#a3#", "", "11.1%" };
    { 10, 16957, "", "=q4=Judgement Sabatons", "=ds=#a4#", "", "11.1%" };
    { 11, 16965, "", "=q4=Sabatons of Wrath", "=ds=#a4#", "", "11.1%" };
    { 12, 19341, "", "=q4=Lifegiving Gem", "=ds=#e15#", "", "20.0%" };
    { 13, 19342, "", "=q4=Venomous Totem", "=ds=#e15#", "", "20.0%" };
    { 14, 19350, "", "=q4=Heartstriker", "=ds=#w3#", "", "10.0%" };
    { 15, 19351, "", "=q4=Maladath, Runed Blade of the Black Flight", "=ds=#w10#", "", "10.0%" };
    { 16, 19373, "", "=q4=Black Brood Pauldrons", "=ds=#a3#", "", "20.0%" };
    { 17, 19374, "", "=q4=Bracers of Arcane Accuracy", "=ds=#a1#", "", "20.0%" };
	};
    ...
    { 9, 16899, "", "=q4=Stormrage Handguards", "=ds=#a2#", "", "7.33%" };
    { 10, 16907, "", "=q4=Bloodfang Gloves", "=ds=#a2#", "", "7.33%" };
    { 11, 16913, "", "=q4=Netherwind Gloves", "=ds=#a1#", "", "7.33%" };
    { 12, 16920, "", "=q4=Handguards of Transcendence", "=ds=#a1#", "", "7.33%" };
    { 13, 16928, "", "=q4=Nemesis Gloves", "=ds=#a1#", "", "7.33%" };
    { 14, 16940, "", "=q4=Dragonstalker's Gauntlets", "=ds=#a3#", "", "7.33%" };
    { 15, 16948, "", "=q4=Gauntlets of Ten Storms", "=ds=#a3#", "", "7.33%" };
    { 16, 16956, "", "=q4=Judgement Gauntlets", "=ds=#a4#", "", "7.33%" };
    { 17, 16964, "", "=q4=Gauntlets of Wrath", "=ds=#a4#", "", "7.33%" };
    { 18, 19353, "", "=q4=Drake Talon Cleaver", "=ds=#w2#", "", "3.40%" };
    { 19, 19355, "", "=q4=Shadow Wing Focus Staff", "=ds=#w9#", "", "3.40%" };
    { 20, 19394, "", "=q4=Drake Talon Pauldrons", "=ds=#a4#", "", "6.80%" };
    { 21, 19395, "", "=q4=Rejuvenating Gem", "=ds=#e15#", "", "6.80%" };
    { 22, 19396, "", "=q4=Taut Dragonhide Belt", "=ds=#a2#", "", "6.80%" };
    { 23, 19397, "", "=q4=Ring of Blackrock", "=ds=#e15#", "", "6.80%" };
    ...
    { 1, 16899, "", "=q4=Stormrage Handguards", "=ds=#a2#", "", "7.33%" };
    { 2, 16907, "", "=q4=Bloodfang Gloves", "=ds=#a2#", "", "7.33%" };
    { 3, 16913, "", "=q4=Netherwind Gloves", "=ds=#a1#", "", "7.33%" };
    { 4, 16920, "", "=q4=Handguards of Transcendence", "=ds=#a1#", "", "7.33%" };
    { 5, 16928, "", "=q4=Nemesis Gloves", "=ds=#a1#", "", "7.33%" };
    { 6, 16940, "", "=q4=Dragonstalker's Gauntlets", "=ds=#a3#", "", "7.33%" };
    { 7, 16948, "", "=q4=Gauntlets of Ten Storms", "=ds=#a3#", "", "7.33%" };
    { 8, 16956, "", "=q4=Judgement Gauntlets", "=ds=#a4#", "", "7.33%" };
    { 9, 16964, "", "=q4=Gauntlets of Wrath", "=ds=#a4#", "", "7.33%" };
    { 10, 19353, "", "=q4=Drake Talon Cleaver", "=ds=#w2#", "", "3.40%" };
    { 11, 19355, "", "=q4=Shadow Wing Focus Staff", "=ds=#w9#", "", "3.40%" };
    { 12, 19394, "", "=q4=Drake Talon Pauldrons", "=ds=#a4#", "", "6.80%" };
    { 13, 19395, "", "=q4=Rejuvenating Gem", "=ds=#e15#", "", "6.80%" };
    { 14, 19396, "", "=q4=Taut Dragonhide Belt", "=ds=#a2#", "", "6.80%" };
    { 15, 19397, "", "=q4=Ring of Blackrock", "=ds=#e15#", "", "6.80%" };
    { 16, 19345, "", "=q4=Aegis of Preservation", "=ds=#e15#", "", "18.0%" };
    { 17, 19368, "", "=q4=Dragonbreath Hand Cannon", "=ds=#w13#", "", "10.0%" };
    ...
    { 16, 19353, "", "=q4=Drake Talon Cleaver", "=ds=#w2#", "", "3.40%" };
    { 17, 19355, "", "=q4=Shadow Wing Focus Staff", "=ds=#w9#", "", "3.40%" };
    { 18, 19394, "", "=q4=Drake Talon Pauldrons", "=ds=#a4#", "", "6.80%" };
    { 19, 19395, "", "=q4=Rejuvenating Gem", "=ds=#e15#", "", "6.80%" };
    { 20, 19396, "", "=q4=Taut Dragonhide Belt", "=ds=#a2#", "", "6.80%" };
    { 21, 19397, "", "=q4=Ring of Blackrock", "=ds=#e15#", "", "6.80%" };
    { 22, 57001, "", "=q4=Plans: Elementium Aegis", "=ds=#e2#", "", "33.3%" };
    { 23, 57204, "", "=q4=Schematic: Elementium Targeting Matrix", "=ds=#e2#", "", "33.3%" };
    { 24, 57500, "", "=q4=Design: Elementium Talisman", "=ds=#e2#", "", "33.3%" };
	};
    ...
    { 5, 17962, "", "=q2=Blue Sack of Gems", "=ds=#e10#", "", "20.0%" };
    { 6, 17963, "", "=q2=Green Sack of Gems", "=ds=#e10#", "", "20.0%" };
    { 7, 17964, "", "=q2=Gray Sack of Gems", "=ds=#e10#", "", "20.0%" };
    { 8, 17965, "", "=q2=Yellow Sack of Gems", "=ds=#e10#", "", "20.0%" };
    { 9, 17969, "", "=q2=Red Sack of Gems", "=ds=#e10#", "", "20.0%" };
    { 10, 16897, "", "=q4=Stormrage Chestguard", "=ds=#a2#", "", "11.1%" };
    { 11, 16905, "", "=q4=Bloodfang Chestpiece", "=ds=#a2#", "", "11.1%" };
    { 12, 16916, "", "=q4=Netherwind Robes", "=ds=#a1#", "", "11.1%" };
    { 13, 16923, "", "=q4=Robes of Transcendence", "=ds=#a1#", "", "11.1%" };
    { 14, 16931, "", "=q4=Nemesis Robes", "=ds=#a1#", "", "11.1%" };
    { 15, 16942, "", "=q4=Dragonstalker's Breastplate", "=ds=#a3#", "", "11.1%" };
    { 16, 16950, "", "=q4=Breastplate of Ten Storms", "=ds=#a3#", "", "11.1%" };
    { 17, 16958, "", "=q4=Judgement Breastplate", "=ds=#a4#", "", "11.1%" };
    { 18, 16966, "", "=q4=Breastplate of Wrath", "=ds=#a4#", "", "11.1%" };
    { 19, 19360, "", "=q4=Lok'amir il Romathis", "=ds=#w6#", "", "10.0%" };
    { 20, 19363, "", "=q4=Crul'shorukh, Edge of Chaos", "=ds=#w1#", "", "10.0%" };
    { 21, 19375, "", "=q4=Mish'undare, Circlet of the Mind Flayer", "=ds=#a1#", "", "20.0%" };
    { 22, 19376, "", "=q4=Archimtiros' Ring of Reckoning", "=ds=#e15#", "", "20.0%" };
    { 23, 19377, "", "=q4=Prestor's Talisman of Connivery", "=ds=#e15#", "", "20.0%" };
    { 24, 19378, "", "=q4=Cloak of the Brood Lord", "=ds=#a1#", "", "20.0%" };
    { 25, 19356, "", "=q4=Staff of the Shadow Flame", "=ds=#w9#", "", "10.0%" };
    { 26, 19364, "", "=q4=Ashkandi, Greatsword of the Brotherhood", "=ds=#w11#", "", "10.0%" };
    { 27, 19379, "", "=q4=Neltharion's Tear", "=ds=#e15#", "", "20.0%" };
    { 28, 19380, "", "=q4=Therazane's Link", "=ds=#a3#", "", "20.0%" };
    { 29, 19381, "", "=q4=Boots of the Shadow Flame", "=ds=#a2#", "", "20.0%" };
    { 30, 19382, "", "=q4=Pure Elementium Band", "=ds=#e15#", "", "20.0%" };
	};
    ...
    { 21, 9446, "", "=q3=Electrocutioner Leg", "=ds=#w10#", "", "33.3%" };
    { 22, 9447, "", "=q3=Electrocutioner Lagnut", "=ds=#e15#", "", "33.3%" };
    { 23, 9448, "", "=q2=Spidertank Oilrag", "=ds=#a1#", "", "33.3%" };
    { 25, 0, "INV_Box_01", "=q6="..BabbleBoss["Crowd Pummeler 9-60"], "" };
    { 26, 9309, "", "=q1=Robo-mechanical Guts", "=ds=#m3#", "", "5.00%" };
    { 27, 9327, "", "=q2=Security DELTA Data Access Card", "=ds=#m3#", "", "1.00%" };
    { 28, 11827, "", "=q2=Schematic: Lil' Smoky", "=ds=#e2#", "", "50.0%" };
    { 29, 9449, "", "=q3=Manual Crowd Pummeler", "=ds=#w7#", "", "40.0%" };
    { 30, 9450, "", "=q2=Gnomebot Operating Boots", "=ds=#a2#", "", "60.0%" };
    { 32, 0, "INV_Box_01", "=q6="..BabbleBoss["Dark Iron Ambassador"], "" };
    { 33, 9308, "", "=q1=Grime-Encrusted Object", "=ds=#m3#", "", "40.0%" };
    { 34, 9455, "", "=q3=Emissary Cuffs", "=ds=#a2#", "", "33.3%" };
    { 35, 9456, "", "=q3=Glass Shooter", "=ds=#w13#", "", "33.3%" };
    { 36, 9457, "", "=q3=Royal Diplomatic Scepter", "=ds=#w6#", "", "33.3%" };
	};

	AtlasLoot_Data["Gnomeregan2"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Mekgineer Thermaplugg"], "" };
    { 2, 9309, "", "=q1=Robo-mechanical Guts", "=ds=#m3#", "", "5.00%" };
    { 3, 9327, "", "=q2=Security DELTA Data Access Card", "=ds=#m3#", "", "1.00%" };
    { 4, 901708, "", "=q1=Plugg Nuts", "=ds=#m3#", "", "100%" };
    { 5, 9458, "", "=q3=Thermaplugg's Central Core", "=ds=#e16#", "", "50.0%" };
    ...
    { 9, 4415, "", "=q3=Schematic: Craftsman's Monocle", "=ds=#e2#", "", "2.00%" };
    ...
    { 3, 17702, "", "=q1=Celebrian Rod", "=ds=#m3#", "", "100%" };
    { 4, 17744, "", "=q3=Heart of Noxxion", "=ds=#e15#", "", "50.0%" };
    { 5, 17745, "", "=q3=Noxious Shooter", "=ds=#w15#", "", "20.0%" };
    { 6, 17746, "", "=q3=Noxxion's Shackles", "=ds=#a4#", "", "50.0%" };
    { 8, 0, "INV_Box_01", "=q6="..BabbleBoss["Razorlash"], "" };
    { 9, 17684, "", "=q1=Theradric Crystal Carving", "=ds=#m3#", "", "80.0%" };
    { 10, 22529, "", "=q1=Savage Frond", "=ds=#m3#", "", "54.0%" };
    { 11, 901700, "", "=q1=Razor Petal", "=ds=#m3#", "", "100%" };
    { 12, 17748, "", "=q3=Vinerot Sandals", "=ds=#a1#", "", "25.0%" };
    { 13, 17749, "", "=q3=Phytoskin Spaulders", "=ds=#a2#", "", "25.0%" };
    { 14, 17750, "", "=q2=Chloromesh Girdle", "=ds=#a1#", "", "25.0%" };
    { 15, 17751, "", "=q2=Brusslehide Leggings", "=ds=#a2#", "", "25.0%" };
    { 17, 0, "INV_Box_01", "=q6="..BabbleBoss["Lord Vyletongue"], "" };
    { 18, 17684, "", "=q1=Theradric Crystal Carving", "=ds=#m3#", "", "80.0%" };
    { 19, 17703, "", "=q1=Celebrian Diamond", "=ds=#m3#", "", "100%" };
    { 20, 17752, "", "=q3=Satyr's Lash", "=ds=#w4#", "", "33.3%" };
    { 21, 17754, "", "=q3=Infernal Trickster Leggings", "=ds=#a3#", "", "33.3%" };
    { 22, 17755, "", "=q3=Satyrmane Sash", "=ds=#a1#", "", "33.3%" };
    { 24, 0, "INV_Box_01", "=q6="..BabbleBoss["Meshlok the Harvester"], "" };
    { 25, 17684, "", "=q1=Theradric Crystal Carving", "=ds=#m3#", "", "80.0%" };
    { 26, 17741, "", "=q3=Nature's Embrace", "=ds=#a1#", "", "33.3%" };
    { 27, 17742, "", "=q3=Fungus Shroud Armor", "=ds=#a2#", "", "33.3%" };
    { 28, 17767, "", "=q3=Bloomsprout Headpiece", "=ds=#a3#", "", "33.3%" };
    { 30, 0, "INV_Box_01", "=q6="..BabbleBoss["Celebras the Cursed"], "" };
    { 31, 17684, "", "=q1=Theradric Crystal Carving", "=ds=#m3#", "", "80.0%" };
    { 32, 901701, "", "=q1=Carved Horn of Remulos", "=ds=#m3#", "", "100%" };
    { 33, 17738, "", "=q3=Claw of Celebras", "=ds=#w5#", "", "33.3%" };
    { 34, 17739, "", "=q3=Grovekeeper's Drape", "=ds=#a1#", "", "33.3%" };
    { 35, 17740, "", "=q3=Soothsayer's Headdress", "=ds=#a2#", "", "33.3%" };
	};
	
	AtlasLoot_Data["Maraudon2"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Landslide"], "" };
    { 2, 17684, "", "=q1=Theradric Crystal Carving", "=ds=#m3#", "", "80.0%" };
    { 3, 17734, "", "=q3=Helm of the Mountain", "=ds=#a4#", "", "25.0%" };
    { 4, 17736, "", "=q3=Rockgrip Gauntlets", "=ds=#a3#", "", "25.0%" };
    { 5, 17737, "", "=q3=Cloud Stone", "=ds=#e15#", "", "25.0%" };
    { 6, 17943, "", "=q3=Fist of Stone", "=ds=#w6#", "", "25.0%" };
    { 8, 0, "INV_Box_01", "=q6="..BabbleBoss["Tinkerer Gizlock"], "" };
    { 9, 17684, "", "=q1=Theradric Crystal Carving", "=ds=#m3#", "", "80.0%" };
    { 10, 17717, "", "=q3=Megashot Rifle", "=ds=#w13#", "", "33.3%" };
    { 11, 17718, "", "=q3=Gizlock's Hypertech Buckler", "=ds=#e16#", "", "33.3%" };
    { 12, 17719, "", "=q3=Inventor's Focal Sword", "=ds=#w10#", "", "33.3%" };
    { 14, 0, "INV_Box_01", "=q6="..BabbleBoss["Rotgrip"], "" };
    { 15, 17684, "", "=q1=Theradric Crystal Carving", "=ds=#m3#", "", "80.0%" };
    { 16, 17728, "", "=q3=Albino Crocscale Boots", "=ds=#a2#", "", "50.0%" };
    { 17, 17730, "", "=q3=Gatorbite Axe", "=ds=#w2#", "", "20.0%" };
    { 18, 17732, "", "=q3=Rotgrip Mantle", "=ds=#a1#", "", "50.0%" };
    { 20, 0, "INV_Box_01", "=q6="..BabbleBoss["Princess Theradras"], "" };
    { 21, 17684, "", "=q1=Theradric Crystal Carving", "=ds=#m3#", "", "80.0%" };
    { 22, 901723, "", "=q1=Face of Theradras", "=ds=#m3#", "", "100%" };
	};
    ...
    { 3, 14145, "", "=q2=Cursed Felblade", "=ds=#w10#", "", "20.0%" };
    ...
    { 8, 901707, "", "=q1=Searing Stone", "=ds=#m3#", "", "100%" };
    { 9, 14147, "", "=q2=Cavedweller Bracers", "=ds=#a3#", "", "40.0%" };
    { 10, 14150, "", "=q2=Robe of Evocation", "=ds=#a1#", "", "40.0%" };
    { 11, 14151, "", "=q2=Chanting Blade", "=ds=#w4#", "", "20.0%" };
	};
    ...
    { 4, 10761, "", "=q3=Coldrage Dagger", "=ds=#w4#", "", "20.0%" };
    { 5, 10762, "", "=q3=Robes of the Lich", "=ds=#a1#", "", "20.0%" };
    { 6, 10763, "", "=q3=Icemetal Barbute", "=ds=#a4#", "", "20.0%" };
    { 7, 10764, "", "=q3=Deathchill Armor", "=ds=#a3#", "", "20.0%" };
    { 8, 10765, "", "=q2=Bonefingers", "=ds=#a2#", "", "20.0%" };
    { 10, 0, "INV_Box_01", "=q6="..BabbleBoss["Plaguemaw the Rotting"], "" };
    { 11, 10760, "", "=q2=Swine Fists", "=ds=#a2#", "", "60.0%" };
    { 12, 10766, "", "=q3=Plaguerot Sprig", "=ds=#w15#", "", "40.0%" };
	};
    ...
    { 3, 2816, "", "=q3=Death Speaker Scepter", "=ds=#w6#", "", "20.0%" };
    { 4, 6682, "", "=q2=Death Speaker Robes", "=ds=#a1#", "", "40.0%" };
    { 5, 6685, "", "=q2=Death Speaker Mantle", "=ds=#a1#", "", "40.0%" };
    { 7, 0, "INV_Box_01", "=q6="..BabbleBoss["Overlord Ramtusk"], "" };
    { 8, 5825, "", "=q1=Treshala's Pendant", "=ds=#m3#", "", "10.0%" };
    { 9, 6686, "", "=q2=Tusken Helm", "=ds=#a3#", "", "60.0%" };
    { 10, 6687, "", "=q3=Corpsemaker", "=ds=#w2#", "", "40.0%" };
    ...
    { 18, 6696, "", "=q3=Nightstalker Bow", "=ds=#w3#", "", "33.3%" };
    ...
    { 4, 5825, "", "=q1=Treshala's Pendant", "=ds=#m3#", "", "10.0%" };
    { 5, 901704, "", "=q1=Gauntlets of Growth", "=ds=#m3#", "", "100%" };
    { 6, 6692, "", "=q3=Pronged Reaver", "=ds=#w1#", "", "20.0%" };
    { 7, 6693, "", "=q3=Agamaggan's Clutch", "=ds=#e15#", "", "40.0%" };
    { 8, 6694, "", "=q3=Heart of Agamaggan", "=ds=#e16#", "", "40.0%" };
    { 10, 0, "INV_Box_01", "=q6="..BabbleBoss["Earthcaller Halmgar"], "" };
    { 11, 5825, "", "=q1=Treshala's Pendant", "=ds=#m3#", "", "10.0%" };
    ...
    { 8, 7723, "", "=q3=Mograine's Might", "=ds=#w7#", "", "33.3%" };
    { 9, 7724, "", "=q3=Gauntlets of Divinity", "=ds=#a3#", "", "33.3%" };
    { 10, 7726, "", "=q3=Aegis of the Scarlet Commander", "=ds=#e16#", "", "40.0%" };
    { 11, 10330, "", "=q3=Scarlet Leggings", "=ds=#a3#", "", "33.3%" };
    { 13, 0, "INV_Box_01", "=q6="..BabbleBoss["High Inquisitor Whitemane"], "" };
    { 14, 5805, "", "=q1=Heart of Zeal", "=ds=#m3#", "", "2.00%" };
    { 15, 20976, "", "=q2=Design: Citrine Pendant of Golden Healing", "=ds=#e2#", "", "10.0%" };
    { 16, 901722, "", "=q1=Whitemane's Chapeau", "=ds=#m3#", "", "100%" };
    { 17, 7720, "", "=q3=Whitemane's Chapeau", "=ds=#a1#", "", "50.0%" };
    { 18, 7721, "", "=q3=Hand of Righteousness", "=ds=#w6#", "", "20.0%" };
    { 19, 7722, "", "=q3=Triune Amulet", "=ds=#e15#", "", "50.0%" };
	};
    ...
    { 6, 901710, "", "=q1=Bloodfire Amulet", "=ds=#m3#", "", "100%" };
    ...
    { 15, 0, "INV_Box_01", "=q6="..BabbleBoss["Azshir the Sleepless"], "" };
    { 16, 7708, "", "=q3=Necrotic Wand", "=ds=#w15#", "", "33.3%" };
    { 17, 7709, "", "=q3=Blighted Leggings", "=ds=#a1#", "", "33.3%" };
    { 18, 7731, "", "=q3=Ghostshard Talisman", "=ds=#e15#", "", "33.3%" };
    { 20, 0, "INV_Box_01", "=q6="..BabbleBoss["Fallen Champion"], "" };
    { 21, 7689, "", "=q3=Morbid Dawn", "=ds=#w11#", "", "33.3%" };
    { 22, 7690, "", "=q3=Ebon Vise", "=ds=#a2#", "", "33.3%" };
    { 23, 7691, "", "=q3=Embalmed Shroud", "=ds=#a1#", "", "33.3%" };
	};
    ...
    { 5, 7756, "", "=q2=Dog Training Gloves", "=ds=#a2#", "", "60.0%" };
    { 7, 0, "INV_Box_01", "=q6="..BabbleBoss["Arcanist Doan"], "" };
    { 8, 5805, "", "=q1=Heart of Zeal", "=ds=#m3#", "", "2.00%" };
    { 9, 901723, "", "=q1=Face of Theradras", "=ds=#m3#", "", "100%" };
    { 10, 7711, "", "=q2=Robe of Doan", "=ds=#a1#", "", "25.0%" };
    { 11, 7712, "", "=q2=Mantle of Doan", "=ds=#a1#", "", "25.0%" };
    { 12, 7713, "", "=q3=Illusionary Rod", "=ds=#w9#", "", "25.0%" };
    { 13, 7714, "", "=q3=Hypnotic Blade", "=ds=#w4#", "", "25.0%" };
    { 14, 34227, "", "=q4=Deadman's Hand", "=ds=#e15#", "", "4.00%" };
	};
    ...
    { 6, 1292, "", "=q3=Butcher's Cleaver", "=ds=#w1#", "", "10.0%" };
    { 7, 6226, "", "=q2=Bloody Apron", "=ds=#a1#", "", "45.0%" };
    { 8, 6633, "", "=q2=Butcher's Slicer", "=ds=#w10#", "", "45.0%" };
    { 10, 0, "INV_Box_01", "=q6="..BabbleBoss["Baron Silverlaine"], "" };
    { 11, 6321, "", "=q3=Silverlaine's Family Seal", "=ds=#e15#", "", "30.0%" };
    { 12, 6323, "", "=q2=Baron's Scepter", "=ds=#w6#", "", "70.0%" };
    { 14, 0, "INV_Box_01", "=q6="..BabbleBoss["Commander Springvale"], "" };
    { 15, 3191, "", "=q2=Arced War Axe", "=ds=#w2#", "", "50.0%" };
    { 16, 6320, "", "=q3=Commander's Crest", "=ds=#e16#", "", "50.0%" };
    { 18, 0, "INV_Box_01", "=q6="..BabbleBoss["Odo the Blindwatcher"], "" };
    { 19, 6318, "", "=q3=Odo's Ley Staff", "=ds=#w9#", "", "40.0%" };
    { 20, 6319, "", "=q2=Girdle of the Blindwatcher", "=ds=#a2#", "", "60.0%" };
    { 22, 0, "INV_Box_01", "=q6="..BabbleBoss["Fenrus the Devourer"], "" };
    { 23, 3230, "", "=q2=Black Wolf Bracers", "=ds=#a2#", "", "30.0%" };
    { 24, 6340, "", "=q2=Fenrus' Hide", "=ds=#a1#", "", "70.0%" };
	};
    ...
    { 2, 3019, "", "=q2=Noble's Robe", "=ds=#a1#", "", "100%" };
    { 3, 4660, "", "=q2=Walking Boots", "=ds=#a1#", "", "75.0%" };
    { 5, 0, "INV_Box_01", "=q6="..BabbleBoss["Brainwashed Noble"], "" };
    { 6, 3902, "", "=q2=Staff of Nobles", "=ds=#w9#", "", "100%" };
    { 7, 5967, "", "=q2=Girdle of Nobility", "=ds=#a1#", "", "70.0%" };
    ...
    { 13, 5443, "", "=q3=Gold-plated Buckler", "=ds=#e16#", "", "35.0%" };
    { 14, 5444, "", "=q2=Miner's Cape", "=ds=#a1#", "", "65.0%" };
    { 16, 0, "INV_Box_01", "=q6="..BabbleBoss["Sneed's Shredder"], "" };
    { 17, 7365, "", "=q1=Gnoam Sprecklesprocket", "=ds=#m3#", "", "100%" };
    { 18, 1937, "", "=q2=Buzz Saw", "=ds=#w10#", "", "10.0%" };
    { 20, 0, "INV_Box_01", "=q6="..BabbleBoss["Sneed"], "" };
    { 21, 5194, "", "=q3=Taskmaster Axe", "=ds=#w2#", "", "35.0%" };
    { 22, 5195, "", "=q2=Gold-flecked Gloves", "=ds=#a1#", "", "65.0%" };
	};

	AtlasLoot_Data["TheDeadmines2"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Gilnid"], "" };
    { 2, 1156, "", "=q3=Lavishly Jeweled Ring", "=ds=#e15#", "", "45.0%" };
    { 3, 5199, "", "=q2=Smelting Pants", "=ds=#a2#", "", "55.0%" };
    { 5, 0, "INV_Box_01", "=q6="..BabbleBoss["Mr. Smite"], "" };
    { 6, 5192, "", "=q2=Thief's Blade", "=ds=#w10#", "", "40.0%" };
    { 7, 5196, "", "=q2=Smite's Reaver", "=ds=#w1#", "", "40.0%" };
    { 8, 7230, "", "=q3=Smite's Mighty Hammer", "=ds=#w7#", "", "20.0%" };
    { 10, 0, "INV_Box_01", "=q6="..BabbleBoss["Cookie"], "" };
    { 11, 901727, "", "=q1=Stabby Patty Secret Formula", "=ds=#m3#", "", "100%" };
    { 12, 5197, "", "=q2=Cookie's Tenderizer", "=ds=#w6#", "", "65.0%" };
    { 13, 5198, "", "=q3=Cookie's Stirring Rod", "=ds=#w15#", "", "35.0%" };
	};
    ...
    { 3, 901100, "", "=q3=Dread Sword", "=ds=#w10#", "", "50.0%" };
    { 4, 901101, "", "=q3=Dread Shoulders", "=ds=#a2#", "", "50.0%" };
    { 6, 0, "INV_Box_01", "=q6="..BabbleBoss["Kam Deepfury"], "" };
    { 7, 3640, "", "=q1=Head of Deepfury", "=ds=#m3#", "", "100%" };
    { 8, 2280, "", "=q2=Walking Stick of Kam", "=ds=#w9#", "", "33.3%" };
    { 9, 901102, "", "=q3=Tim Kam Slam", "=ds=#w6#", "", "33.3%" };
    { 10, 901103, "", "=q3=Deepfury Mantle", "=ds=#a3#", "", "33.3%" };
    { 12, 0, "INV_Box_01", "=q6="..BabbleBoss["Bazil Thredd"], "" };
    { 13, 2909, "", "=q1=Red Wool Bandana", "=ds=#m3#", "", "80.0%" };
    { 14, 2926, "", "=q1=Head of Bazil Thredd", "=ds=#m3#", "", "100%" };
    { 15, 3871, "", "=q3=Plans: Golden Scale Shoulders", "=ds=#e2#", "", "0.02%" };
    { 16, 901702, "", "=q1=Prison Wallet", "=ds=#m3#", "", "100%" };
    { 17, 901109, "", "=q3=Thredded Belt", "=ds=#a2#", "", "50.0%" };
    { 18, 901110, "", "=q3=Needle Thredder", "=ds=#w14#", "", "50.0%" };
    { 20, 0, "INV_Box_01", "=q6="..BabbleBoss["Dextren Ward"], "" };
    { 21, 2909, "", "=q1=Red Wool Bandana", "=ds=#m3#", "", "40.0%" };
    { 22, 3628, "", "=q1=Hand of Dextren Ward", "=ds=#m3#", "", "100%" };
    { 23, 901107, "", "=q3=Grave Digging Shovel", "=ds=#w7#", "", "50.0%" };
    { 24, 901108, "", "=q3=Coffin Splinter", "=ds=#w15#", "", "50.0%" };
    { 26, 0, "INV_Box_01", "=q6="..BabbleBoss["Bruegal Ironknuckle"], "" };
    { 27, 2909, "", "=q1=Red Wool Bandana", "=ds=#m3#", "", "80.0%" };
    { 28, 2941, "", "=q3=Prison Shank", "=ds=#w4#", "", "20.0%" };
    { 29, 2942, "", "=q3=Iron Knuckles", "=ds=#w5#", "", "20.0%" };
    { 30, 3228, "", "=q3=Jimmied Handcuffs", "=ds=#a3#", "", "60.0%" };
	};
    ...
    { 14, 6460, "", "=q3=Cobrahn's Grasp", "=ds=#a3#", "", "20.0%" };
    { 15, 6465, "", "=q2=Robe of the Moccasin", "=ds=#a1#", "", "60.0%" };
    { 16, 10410, "", "=q3=Leggings of the Fang", "=ds=#a2#", "", "20.0%" };
    { 18, 0, "INV_Box_01", "=q6="..BabbleBoss["Lady Anacondra"], "" };
    { 19, 9739, "", "=q1=Gem of Anacondra", "=ds=#m3#", "", "100%" };
    { 20, 5404, "", "=q3=Serpent's Shoulders", "=ds=#a2#", "", "80.0%" };
    { 21, 10412, "", "=q2=Belt of the Fang", "=ds=#a2#", "", "10.0%" };
    { 23, 0, "INV_Box_01", "=q6="..BabbleBoss["Kresh"], "" };
    { 24, 6443, "", "=q1=Deviate Hide", "=ds=#m3#", "", "80.0%" };
    { 25, 6447, "", "=q3=Worn Turtle Shell Shield", "=ds=#e16#", "", "90.0%" };
    { 26, 13245, "", "=q3=Kresh's Back", "=ds=#e16#", "", "10.0%" };
	};

	AtlasLoot_Data["WailingCaverns2"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Lord Pythas"], "" };
    { 2, 9740, "", "=q1=Gem of Pythas", "=ds=#m3#", "", "100%" };
    { 3, 6472, "", "=q3=Stinging Viper", "=ds=#w6#", "", "40.0%" };
    { 4, 6473, "", "=q2=Armor of the Fang", "=ds=#a2#", "", "60.0%" };
    { 6, 0, "INV_Box_01", "=q6="..BabbleBoss["Skum"], "" };
    { 7, 6443, "", "=q1=Deviate Hide", "=ds=#m3#", "", "80.0%" };
    { 8, 6448, "", "=q2=Tail Spike", "=ds=#w4#", "", "50.0%" };
    { 9, 6449, "", "=q3=Glowing Lizardscale Cloak", "=ds=#a1#", "", "50.0%" };
    { 11, 0, "INV_Box_01", "=q6="..BabbleBoss["Lord Serpentis"], "" };
    { 12, 9741, "", "=q1=Gem of Serpentis", "=ds=#m3#", "", "100%" };
    { 13, 5970, "", "=q2=Serpent Gloves", "=ds=#a1#", "", "25.0%" };
    { 14, 6459, "", "=q2=Savage Trodders", "=ds=#a3#", "", "25.0%" };
    { 15, 6469, "", "=q3=Venomstrike", "=ds=#w3#", "", "25.0%" };
    { 16, 10411, "", "=q2=Footpads of the Fang", "=ds=#a2#", "", "25.0%" };
    { 18, 0, "INV_Box_01", "=q6="..BabbleBoss["Verdan the Everliving"], "" };
    { 19, 6443, "", "=q1=Deviate Hide", "=ds=#m3#", "", "80.0%" };
    { 20, 901706, "", "=q1=Everliving Spore", "=ds=#m3#", "", "100%" };
    { 21, 6629, "", "=q2=Sporid Cape", "=ds=#a1#", "", "20.0%" };
    { 22, 6630, "", "=q3=Seedcloud Buckler", "=ds=#e16#", "", "40.0%" };
    { 23, 6631, "", "=q3=Living Root", "=ds=#w9#", "", "40.0%" };
    { 25, 0, "INV_Box_01", "=q6="..BabbleBoss["Mutanus the Devourer"], "" };
    { 26, 6443, "", "=q1=Deviate Hide", "=ds=#m3#", "", "80.0%" };
    { 27, 10441, "", "=q1=Glowing Shard", "=ds=#m3#", "", "100%" };
    { 28, 6461, "", "=q3=Slime-encrusted Pads", "=ds=#a1#", "", "33.3%" };
    { 29, 6463, "", "=q3=Deep Fathom Ring", "=ds=#e15#", "", "33.3%" };
    { 30, 6627, "", "=q3=Mutant Scale Breastplate", "=ds=#a3#", "", "33.3%" };
    { 32, 0, "INV_Box_01", "=q6="..BabbleBoss["Deviate Faerie Dragon"], "" };
    { 33, 6443, "", "=q1=Deviate Hide", "=ds=#m3#", "", "80.0%" };
    { 34, 5243, "", "=q3=Firebelcher", "=ds=#w15#", "", "50.0%" };
    { 35, 6632, "", "=q2=Feyscale Cloak", "=ds=#a1#", "", "50.0%" };
	};
