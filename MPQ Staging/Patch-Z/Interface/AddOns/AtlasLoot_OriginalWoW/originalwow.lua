...
---- Azuregos
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Kurinnaxx"], "=q5=Always Drops" };
    { 2, 22217, "", "=q1=Kurinnaxx's Venom Sac", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Kurinnaxx"], "=q5=Chance on Drop" };
    { 5, 21302, "", "=q3=Handbook of Deadly Poison V", "=ds=#e2#", "", "3.85%" };
    { 7, 0, "AO_Unknown", "=q6="..BabbleBoss["Kurinnaxx"], "=q5=One Random Drop" };
    ...
    { 13, 0, "AO_Unknown", "=q6="..BabbleBoss["Kurinnaxx"], "=q5=One Random Drop" };
    ...
    { 21, 0, "AO_Unknown", "=q6="..BabbleBoss["Kurinnaxx"], "=q5=One Random Drop" };
    ...
    { 1, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["General Rajaxx"], "=q5=Chance on Drop" };
    { 2, 21302, "", "=q3=Handbook of Deadly Poison V", "=ds=#e2#", "", "3.85%" };
    { 4, 0, "AO_Unknown", "=q6="..BabbleBoss["General Rajaxx"], "=q5=One Random Drop" };
    ...
    { 10, 0, "AO_Unknown", "=q6="..BabbleBoss["General Rajaxx"], "=q5=One Random Drop" };
    ...
    { 18, 0, "AO_Unknown", "=q6="..BabbleBoss["General Rajaxx"], "=q5=One Random Drop" };
    ...
    { 15, 0, "AO_Unknown", "=q6="..BabbleBoss["Moam"], "=q5=One Random Drop" };
    ...
    { 1, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Buru the Gorger"], "=q5=Chance on Drop" };
    { 2, 21302, "", "=q3=Handbook of Deadly Poison V", "=ds=#e2#", "", "3.85%" };
    { 4, 0, "AO_Unknown", "=q6="..BabbleBoss["Buru the Gorger"], "=q5=One Random Drop" };
    { 5, 20884, "", "=q3=Qiraji Magisterial Ring", "=ds=#m3#", "", "25.0%" };
    { 6, 20885, "", "=q3=Qiraji Martial Drape", "=ds=#m3#", "", "25.0%" };
    { 7, 20888, "", "=q3=Qiraji Ceremonial Ring", "=ds=#m3#", "", "25.0%" };
    { 8, 20889, "", "=q3=Qiraji Regal Drape", "=ds=#m3#", "", "25.0%" };
    { 10, 0, "AO_Unknown", "=q6="..BabbleBoss["Buru the Gorger"], "=q5=One Random Drop" };
    ...
    { 19, 0, "AO_Unknown", "=q6="..BabbleBoss["Buru the Gorger"], "=q5=One Random Drop" };
    ...
    { 1, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Ayamiss the Hunter"], "=q5=Chance on Drop" };
    { 2, 21302, "", "=q3=Handbook of Deadly Poison V", "=ds=#e2#", "", "3.85%" };
    { 4, 0, "AO_Unknown", "=q6="..BabbleBoss["Ayamiss the Hunter"], "=q5=One Random Drop" };
    { 5, 20884, "", "=q3=Qiraji Magisterial Ring", "=ds=#m3#", "", "25.0%" };
    { 6, 20885, "", "=q3=Qiraji Martial Drape", "=ds=#m3#", "", "25.0%" };
    { 7, 20888, "", "=q3=Qiraji Ceremonial Ring", "=ds=#m3#", "", "25.0%" };
    { 8, 20889, "", "=q3=Qiraji Regal Drape", "=ds=#m3#", "", "25.0%" };
    { 10, 0, "AO_Unknown", "=q6="..BabbleBoss["Ayamiss the Hunter"], "=q5=One Random Drop" };
    ...
    { 20, 0, "AO_Unknown", "=q6="..BabbleBoss["Ayamiss the Hunter"], "=q5=One Random Drop" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Ossirian the Unscarred"], "=q5=Always Drops" };
    { 2, 21220, "", "=q4=Head of Ossirian the Unscarred", "=ds=#m3#", "", "100%" };
    { 3, 57604, "", "=q3=Pattern: Drums of Intellect", "=ds=#e2#", "", "100%" };
    { 5, 0, "AO_Unknown", "=q6="..BabbleBoss["Ossirian the Unscarred"], "=q5=One Random Drop" };
    { 6, 20884, "", "=q3=Qiraji Magisterial Ring", "=ds=#m3#", "", "50.0%" };
    { 7, 20888, "", "=q3=Qiraji Ceremonial Ring", "=ds=#m3#", "", "50.0%" };
    { 9, 0, "AO_Unknown", "=q6="..BabbleBoss["Ossirian the Unscarred"], "=q5=One Random Drop" };
    { 10, 20886, "", "=q4=Qiraji Spiked Hilt", "=ds=#m3#", "", "50.0%" };
    { 11, 20890, "", "=q4=Qiraji Ornate Hilt", "=ds=#m3#", "", "50.0%" };
    { 13, 0, "AO_Unknown", "=q6="..BabbleBoss["Ossirian the Unscarred"], "=q5=One Random Drop" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["The Prophet Skeram"], "=q5=Always Drops" };
    { 2, 57610, "", "=q3=Pattern: Drums of the Raid Leader", "=ds=#e2#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["The Prophet Skeram"], "=q5=Chance on Drop" };
    { 5, 22222, "", "=q3=Plans: Thick Obsidian Breastplate", "=ds=#e2#", "", "15.0%" };
    { 7, 0, "AO_Unknown", "=q6="..BabbleBoss["The Prophet Skeram"], "=q5=One Random Drop" };
    ...
    { 16, 0, "AO_Unknown", "=q6="..BabbleBoss["The Prophet Skeram"], "=q5=One Random Drop" };
    ...
    { 2, 0, "AO_Unknown", "=q6="..BabbleBoss["Princess Yauj"], "=q5=One Random Drop" };
    ...
    { 9, 0, "AO_Unknown", "=q6="..BabbleBoss["Princess Yauj"], "=q5=One Random Drop" };
    ...
    { 2, 0, "AO_Unknown", "=q6="..BabbleBoss["Battleguard Sartura"], "=q5=One Random Drop" };
    ...
    { 16, 0, "AO_Unknown", "=q6="..BabbleBoss["Battleguard Sartura"], "=q5=One Random Drop" };
    ...
    { 2, 0, "AO_Unknown", "=q6="..BabbleBoss["Fankriss the Unyielding"], "=q5=One Random Drop" };
    ...
    { 16, 0, "AO_Unknown", "=q6="..BabbleBoss["Fankriss the Unyielding"], "=q5=One Random Drop" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Viscidus"], "=q5=Always Drops" };
    { 2, 59315, "", "=q4=Qiraji Armor Cache - Shoulder", "=ds=#e10#", "", "100%" };
    { 3, 59319, "", "=q4=Viscidus's Crystalline Heart", "=ds=#m3#", "", "100%" };
    { 5, 0, "AO_Unknown", "=q6="..BabbleBoss["Viscidus"], "=q5=One Random Drop" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Princess Huhuran"], "=q5=Always Drops" };
    { 2, 59318, "", "=q4=Qiraji Armor Cache - Boots", "=ds=#e10#", "", "100%" };
    { 3, 59320, "", "=q4=Huhuran's Stinger", "=ds=#m3#", "", "100%" };
    { 5, 0, "AO_Unknown", "=q6="..BabbleBoss["Princess Huhuran"], "=q5=One Random Drop" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Emperor Vek'lor"], "=q5=Always Drops" };
    { 2, 20930, "", "=q4=Vek'lor's Diadem", "=ds=#e10#", "", "100%" };
    { 3, 59314, "", "=q4=Qiraji Armor Cache - Helm", "=ds=#e10#", "", "100%" };
    { 5, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Emperor Vek'lor"], "=q5=Chance on Drop" };
    { 6, 20735, "", "=q3=Formula: Enchant Cloak - Subtlety", "=ds=#e2#", "", "6.50%" };
    { 8, 0, "AO_Unknown", "=q6="..BabbleBoss["Emperor Vek'lor"], "=q5=One Random Drop" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Ouro"], "=q5=Always Drops" };
    { 2, 20927, "", "=q4=Ouro's Intact Hide", "=ds=#m3#", "", "100%" };
    { 3, 59317, "", "=q4=Qiraji Armor Cache - Legs", "=ds=#e10#", "", "100%" };
    { 5, 0, "AO_Unknown", "=q6="..BabbleBoss["Ouro"], "=q5=One Random Drop" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["C'Thun"], "=q5=Always Drops" };
    ...
    { 7, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["C'Thun"], "=q5=Chance on Drop" };
    { 8, 21579, "", "=q4=Vanquished Tentacle of C'Thun", "=ds=#s14#", "", "20.0%" };
    { 10, 0, "AO_Unknown", "=q6="..BabbleBoss["C'Thun"], "=q5=One Random Drop" };
    ...
    { 18, 0, "AO_Unknown", "=q6="..BabbleBoss["C'Thun"], "=q5=One Random Drop" };
    ...
    { 1, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Lord Roccor"], "=q5=Chance on Drop" };
    ...
    { 7, 0, "AO_Unknown", "=q6="..BabbleBoss["Lord Roccor"], "=q5=One Random Drop" };
    ...
    { 2, 0, "AO_Unknown", "=q6="..BabbleBoss["High Interrogator Gerstahn"], "=q5=One Random Drop" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Theldren"], "=q5=Always Drops" };
    { 2, 22047, "", "=q1=Top Piece of Lord Valthalak's Amulet", "=ds=#m3#", "", "100%" };
	};

	AtlasLoot_Data["BRDHoundmaster"] = {
    { 2, 0, "AO_Unknown", "=q6="..BabbleBoss["Houndmaster Grebmar"], "=q5=One Random Drop" };
    ...
    { 1, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Pyromancer Loregrain"], "=q5=Chance on Drop" };
    { 2, 11207, "", "=q2=Formula: Enchant Weapon - Fiery Weapon", "=ds=#e2#", "", "16.0%" };
    { 4, 0, "AO_Unknown", "=q6="..BabbleBoss["Pyromancer Loregrain"], "=q5=One Random Drop" };
    ...
    { 2, 0, "AO_Unknown", "=q6="..BabbleBoss["Warder Stilgiss"], "=q5=One Random Drop" };
    ...
    { 1, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Verek"], "=q5=Chance on Drop" };
    { 2, 22242, "", "=q3=Verek's Leash", "=ds=#a3#", "", "13.0%" };
    { 3, 11755, "", "=q3=Verek's Collar", "=ds=#s2#", "", "12.0%" };
	};

	AtlasLoot_Data["BRDFineousDarkvire"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Fineous Darkvire"], "=q5=Always Drops" };
    { 2, 10999, "", "=q1=Ironfel", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Fineous Darkvire"], "=q5=Chance on Drop" };
    { 5, 11468, "", "=q1=Dark Iron Fanny Pack", "=ds=#m3#", "", "80.0%" };
    { 7, 0, "AO_Unknown", "=q6="..BabbleBoss["Fineous Darkvire"], "=q5=One Random Drop" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Lord Incendius"], "=q5=Always Drops" };
    { 2, 11126, "", "=q1=Tablet of Kurniya", "=ds=#m3#", "", "100%" };
    { 3, 21987, "", "=q1=Incendicite of Incendius", "=ds=#m3#", "", "100%" };
    { 4, 901714, "", "=q1=Incendiary Core", "=ds=#m3#", "", "100%" };
    { 6, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Lord Incendius"], "=q5=Chance on Drop" };
    ...
    { 11, 0, "AO_Unknown", "=q6="..BabbleBoss["Lord Incendius"], "=q5=One Random Drop" };
    ...
    { 2, 0, "AO_Unknown", "=q6="..BabbleBoss["Bael'Gar"], "=q5=One Random Drop" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["General Angerforge"], "=q5=Always Drops" };
    { 2, 11464, "", "=q1=Marshal Windsor's Lost Information", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["General Angerforge"], "=q5=Chance on Drop" };
    { 5, 11468, "", "=q1=Dark Iron Fanny Pack", "=ds=#m3#", "", "80.0%" };
    { 7, 0, "AO_Unknown", "=q6="..BabbleBoss["General Angerforge"], "=q5=One Random Drop" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Golem Lord Argelmach"], "=q5=Always Drops" };
    { 2, 11268, "", "=q1=Head of Argelmach", "=ds=#m3#", "", "100%" };
    { 3, 11465, "", "=q1=Marshal Windsor's Lost Information", "=ds=#m3#", "", "100%" };
    { 5, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Golem Lord Argelmach"], "=q5=Chance on Drop" };
    { 6, 11468, "", "=q1=Dark Iron Fanny Pack", "=ds=#m3#", "", "80.0%" };
    { 7, 21956, "", "=q2=Design: Dark Iron Scorpid", "=ds=#e2#", "", "60.0%" };
    { 9, 0, "AO_Unknown", "=q6="..BabbleBoss["Golem Lord Argelmach"], "=q5=One Random Drop" };
    ...
    { 1, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Ambassador Flamelash"], "=q5=Chance on Drop" };
    { 2, 11129, "", "=q1=Essence of the Elements", "=ds=#m3#", "", "80.0%" };
    { 3, 57458, "", "=q2=Technique: Scroll of Fire Resistance IV", "=ds=#e2#", "", "15.0%" };
    { 5, 0, "AO_Unknown", "=q6="..BabbleBoss["Ambassador Flamelash"], "=q5=One Random Drop" };
    ...
    { 1, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Panzor the Invincible"], "=q5=Chance on Drop" };
    { 2, 11129, "", "=q1=Essence of the Elements", "=ds=#m3#", "", "80.0%" };
    { 4, 0, "AO_Unknown", "=q6="..BabbleBoss["Panzor the Invincible"], "=q5=One Random Drop" };
    ...
    { 2, 0, "AO_Unknown", "=q6="..BabbleBoss["Magmus"], "=q5=One Random Drop" };
    ...
    { 1, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Spirestone Butcher"], "=q5=Chance on Drop" };
    { 2, 21982, "", "=q1=Ogre Warbeads", "=ds=#m3#", "", "80.0%" };
    { 4, 0, "AO_Unknown", "=q6="..BabbleBoss["Spirestone Butcher"], "=q5=One Random Drop" };
    { 5, 12608, "", "=q3=Butcher's Apron", "=ds=#a1#", "", "60.0%" };
    { 6, 13286, "", "=q3=Rivenspike", "=ds=#w1#", "", "40.0%" };
	};

	AtlasLoot_Data["LBRSOmokk"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Highlord Omokk"], "=q5=Always Drops" };
    { 2, 12336, "", "=q2=Gemstone of Spirestone", "=ds=#m3#", "", "100%" };
    { 3, 12534, "", "=q1=Omokk's Head", "=ds=#m3#", "", "100%" };
    { 5, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Highlord Omokk"], "=q5=Chance on Drop" };
    { 6, 21982, "", "=q1=Ogre Warbeads", "=ds=#m3#", "", "80.0%" };
    { 8, 0, "AO_Unknown", "=q6="..BabbleBoss["Highlord Omokk"], "=q5=One Random Drop" };
    ...
    { 1, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Spirestone Battle Lord"], "=q5=Chance on Drop" };
    { 2, 21982, "", "=q1=Ogre Warbeads", "=ds=#m3#", "", "80.0%" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Shadow Hunter Vosh'gajin"], "=q5=Always Drops" };
    { 2, 13352, "", "=q1=Vosh'gajin's Snakestone", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Shadow Hunter Vosh'gajin"], "=q5=Chance on Drop" };
    { 5, 12654, "", "=q3=Doomshot", "=ds=#e6#", "", "30.0%" };
    { 7, 0, "AO_Unknown", "=q6="..BabbleBoss["Shadow Hunter Vosh'gajin"], "=q5=One Random Drop" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["War Master Voone"], "=q5=Always Drops" };
    { 2, 12335, "", "=q2=Gemstone of Smolderthorn", "=ds=#m3#", "", "100%" };
    { 3, 28972, "", "=q3=Flightblade Throwing Axe", "=ds=#w11#", "", "100%" };
    { 5, 0, "AO_Unknown", "=q6="..BabbleBoss["War Master Voone"], "=q5=One Random Drop" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Mor Grayhoof"], "=q5=Always Drops" };
    { 2, 21984, "", "=q1=Left Piece of Lord Valthalak's Amulet", "=ds=#m3#", "", "100%" };
    { 3, 22046, "", "=q1=Right Piece of Lord Valthalak's Amulet", "=ds=#m3#", "", "100%" };
    { 5, 0, "AO_Unknown", "=q6="..BabbleBoss["Mor Grayhoof"], "=q5=One Random Drop" };
    ...
    { 1, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Bannok Grimaxe"], "=q5=Chance on Drop" };
    { 2, 22138, "", "=q1=Blackrock Bracer", "=ds=#m3#", "", "80.0%" };
    { 3, 12838, "", "=q3=Plans: Arcanite Reaper", "=ds=#e2#", "", "7.00%" };
    { 5, 0, "AO_Unknown", "=q6="..BabbleBoss["Bannok Grimaxe"], "=q5=One Random Drop" };
    ...
    { 2, 0, "AO_Unknown", "=q6="..BabbleBoss["Mother Smolderweb"], "=q5=One Random Drop" };
    ...
    { 2, 0, "AO_Unknown", "=q6="..BabbleBoss["Crystal Fang"], "=q5=One Random Drop" };
    ...
    { 1, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Urok Doomhowl"], "=q5=Chance on Drop" };
    { 2, 21982, "", "=q1=Ogre Warbeads", "=ds=#m3#", "", "80.0%" };
    { 4, 0, "AO_Unknown", "=q6="..BabbleBoss["Urok Doomhowl"], "=q5=One Random Drop" };
    ...
    { 1, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Quartermaster Zigris"], "=q5=Chance on Drop" };
    { 2, 22138, "", "=q1=Blackrock Bracer", "=ds=#m3#", "", "80.0%" };
    ...
    { 2, 0, "AO_Unknown", "=q6="..BabbleBoss["Gizrul the Slavener"], "=q5=One Random Drop" };
    ...
    { 2, 0, "AO_Unknown", "=q6="..BabbleBoss["Halycon"], "=q5=One Random Drop" };
    ...
    { 1, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Ghok Bashguud"], "=q5=Chance on Drop" };
    { 2, 22138, "", "=q1=Blackrock Bracer", "=ds=#m3#", "", "80.0%" };
    { 4, 0, "AO_Unknown", "=q6="..BabbleBoss["Ghok Bashguud"], "=q5=One Random Drop" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Overlord Wyrmthalak"], "=q5=Always Drops" };
    ...
    { 6, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Overlord Wyrmthalak"], "=q5=Chance on Drop" };
    { 7, 16786, "", "=q1=Black Dragonspawn Eye", "=ds=#m3#", "", "80.0%" };
    { 8, 13143, "", "=q4=Mark of the Dragon Lord", "=ds=#s13#", "", "2.00%" };
    { 10, 0, "AO_Unknown", "=q6="..BabbleBoss["Overlord Wyrmthalak"], "=q5=One Random Drop" };
    ...
    { 1, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Burning Felguard"], "=q5=Chance on Drop" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Pyroguard Emberseer"], "=q5=Always Drops" };
    { 2, 17322, "", "=q1=Eye of the Emberseer", "=ds=#m3#", "", "100%" };
    { 3, 21988, "", "=q1=Ember of Emberseer", "=ds=#m3#", "", "100%" };
    { 5, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Pyroguard Emberseer"], "=q5=Chance on Drop" };
    { 6, 23320, "", "=q3=Tablet of Flame Shock VI", "=ds=#e2#", "", "8.00%" };
    { 8, 0, "AO_Unknown", "=q6="..BabbleBoss["Pyroguard Emberseer"], "=q5=One Random Drop" };
    ...
    { 1, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Solakar Flamewreath"], "=q5=Chance on Drop" };
    { 2, 16786, "", "=q1=Black Dragonspawn Eye", "=ds=#m3#", "", "80.0%" };
    { 4, 0, "AO_Unknown", "=q6="..BabbleBoss["Solakar Flamewreath"], "=q5=One Random Drop" };
    ...
    { 1, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Jed Runewatcher"], "=q5=Chance on Drop" };
    { 2, 22138, "", "=q1=Blackrock Bracer", "=ds=#m3#", "", "80.0%" };
    { 4, 0, "AO_Unknown", "=q6="..BabbleBoss["Jed Runewatcher"], "=q5=One Random Drop" };
    ...
    { 1, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Goraluk Anvilcrack"], "=q5=Chance on Drop" };
    { 2, 22138, "", "=q1=Blackrock Bracer", "=ds=#m3#", "", "80.0%" };
    { 4, 0, "AO_Unknown", "=q6="..BabbleBoss["Goraluk Anvilcrack"], "=q5=One Random Drop" };
    ...
    { 1, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["The Beast"], "=q5=Chance on Drop" };
    { 2, 24101, "", "=q3=Book of Ferocious Bite V", "=ds=#e2#", "", "13.0%" };
    { 4, 0, "AO_Unknown", "=q6="..BabbleBoss["The Beast"], "=q5=One Random Drop" };
    ...
    { 2, 0, "AO_Unknown", "=q6="..BabbleBoss["Lord Valthalak"], "=q5=One Random Drop" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["General Drakkisath"], "=q5=Always Drops" };
    ...
    { 6, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["General Drakkisath"], "=q5=Chance on Drop" };
    { 7, 15730, "", "=q3=Pattern: Red Dragonscale Breastplate", "=ds=#e2#", "", "4.00%" };
    { 16, 0, "AO_Unknown", "=q6="..BabbleBoss["General Drakkisath"], "=q5=One Random Drop" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Lucifron"], "=q5=Always Drops" };
    ...
    { 7, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Lucifron"], "=q5=Chance on Drop" };
    { 8, 7078, "", "=q2=Essence of Fire", "=ds=#e7#", "", "40.0%" };
	};

	AtlasLoot_Data["MCMagmadar"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Magmadar"], "=q5=Always Drops" };
    { 2, 59304, "", "=q4=Flamewaker Armor Cache - Legs", "=ds=#e10#", "", "100%" };
    { 16, 0, "AO_Unknown", "=q6="..BabbleBoss["Magmadar"], "=q5=One Random Drop" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Gehennas"], "=q5=Always Drops" };
    ...
    { 6, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Gehennas"], "=q5=Chance on Drop" };
    { 7, 7078, "", "=q2=Essence of Fire", "=ds=#e7#", "", "40.0%" };
	};

	AtlasLoot_Data["MCGarr"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Garr"], "=q5=Always Drops" };
    { 2, 59300, "", "=q4=Flamewaker Armor Cache - Helm", "=ds=#e10#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Garr"], "=q5=Chance on Drop" };
    { 5, 7076, "", "=q2=Essence of Earth", "=ds=#e7#", "", "40.0%" };
    { 6, 17011, "", "=q3=Lava Core", "=ds=#e7#", "", "14.0%" };
    { 7, 18564, "", "=q5=Bindings of the Windseeker", "=ds=#e10#", "", "3.00%" };
    { 16, 0, "AO_Unknown", "=q6="..BabbleBoss["Garr"], "=q5=One Random Drop" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Shazzrah"], "=q5=Always Drops" };
    ...
    { 6, 0, "AO_Unknown", "=q6="..BabbleBoss["Shazzrah"], "=q5=One Random Drop" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Baron Geddon"], "=q5=Always Drops" };
    { 2, 59301, "", "=q4=Flamewaker Armor Cache - Shoulder", "=ds=#e10#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Baron Geddon"], "=q5=Chance on Drop" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Golemagg the Incinerator"], "=q5=Always Drops" };
    { 2, 59302, "", "=q4=Flamewaker Armor Cache - Chest", "=ds=#e10#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Golemagg the Incinerator"], "=q5=Chance on Drop" };
    { 5, 7076, "", "=q2=Essence of Earth", "=ds=#e7#", "", "40.0%" };
    { 6, 7078, "", "=q2=Essence of Fire", "=ds=#e7#", "", "40.0%" };
    { 7, 17203, "", "=q4=Sulfuron Ingot", "=ds=#e7#", "", "20.0%" };
    { 8, 17011, "", "=q3=Lava Core", "=ds=#e7#", "", "14.0%" };
    { 16, 0, "AO_Unknown", "=q6="..BabbleBoss["Golemagg the Incinerator"], "=q5=One Random Drop" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Sulfuron Harbinger"], "=q5=Always Drops" };
    ...
    { 6, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Sulfuron Harbinger"], "=q5=Chance on Drop" };
    { 7, 7078, "", "=q2=Essence of Fire", "=ds=#e7#", "", "40.0%" };
	};
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Ragnaros"], "=q5=Always Drops" };
    { 2, 19017, "", "=q5=Essence of the Firelord", "=ds=#m3#", "", "100%" };
    { 3, 59310, "", "=q4=Firelord's Armor Cache - Legs", "=ds=#e10#", "", "100%" };
    { 5, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Ragnaros"], "=q5=Chance on Drop" };
    { 6, 7078, "", "=q2=Essence of Fire", "=ds=#e7#", "", "40.0%" };
    ...
    { 16, 0, "AO_Unknown", "=q6="..BabbleBoss["Ragnaros"], "=q5=One Random Drop" };
    ...
    { 23, 0, "AO_Unknown", "=q6="..BabbleBoss["Ragnaros"], "=q5=One Random Drop" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Razorgore the Untamed"], "=q5=Always Drops" };
    { 2, 59312, "", "=q4=Blackwing Armor Cache - Bracers", "=ds=#e10#", "", "100%" };
    { 4, 0, "AO_Unknown", "=q6="..BabbleBoss["Razorgore the Untamed"], "=q5=One Random Drop" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Vaelastrasz the Corrupt"], "=q5=Always Drops" };
    { 2, 59309, "", "=q4=Blackwing Armor Cache - Belt", "=ds=#e10#", "", "100%" };
    { 4, 0, "AO_Unknown", "=q6="..BabbleBoss["Vaelastrasz the Corrupt"], "=q5=One Random Drop" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Broodlord Lashlayer"], "=q5=Always Drops" };
    { 2, 20383, "", "=q4=Head of the Broodlord Lashlayer", "=ds=#m3#", "", "100%" };
    { 3, 59311, "", "=q4=Blackwing Armor Cache - Boots", "=ds=#e10#", "", "100%" };
    { 5, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Broodlord Lashlayer"], "=q5=Chance on Drop" };
    { 6, 100002, "", "=q3=Tome: Greater Blessing of Kings", "=ds=#e2#", "", "12.0%" };
    { 8, 0, "AO_Unknown", "=q6="..BabbleBoss["Broodlord Lashlayer"], "=q5=One Random Drop" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Firemaw"], "=q5=Always Drops" };
    { 2, 59313, "", "=q4=Blackwing Armor Cache - Gloves", "=ds=#e10#", "", "100%" };
    { 4, 0, "AO_Unknown", "=q6="..BabbleBoss["Firemaw"], "=q5=One Random Drop" };
    ...
    { 16, 0, "AO_Unknown", "=q6="..BabbleBoss["Firemaw"], "=q5=One Random Drop" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Ebonroc"], "=q5=Always Drops" };
    { 2, 59313, "", "=q4=Blackwing Armor Cache - Gloves", "=ds=#e10#", "", "100%" };
    { 4, 0, "AO_Unknown", "=q6="..BabbleBoss["Ebonroc"], "=q5=One Random Drop" };
    ...
    { 12, 0, "AO_Unknown", "=q6="..BabbleBoss["Ebonroc"], "=q5=One Random Drop" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Flamegor"], "=q5=Always Drops" };
    { 2, 59313, "", "=q4=Blackwing Armor Cache - Gloves", "=ds=#e10#", "", "100%" };
    { 4, 0, "AO_Unknown", "=q6="..BabbleBoss["Flamegor"], "=q5=One Random Drop" };
    ...
    { 12, 0, "AO_Unknown", "=q6="..BabbleBoss["Flamegor"], "=q5=One Random Drop" };
    { 13, 57001, "", "=q4=Plans: Elementium Aegis", "=ds=#e2#", "", "33.3%" };
    { 14, 57204, "", "=q4=Schematic: Elementium Targeting Matrix", "=ds=#e2#", "", "33.3%" };
    { 15, 57500, "", "=q4=Design: Elementium Talisman", "=ds=#e2#", "", "33.3%" };
	};
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Chromaggus"], "=q5=Always Drops" };
    { 2, 59307, "", "=q4=Blackwing Armor Cache - Shoulder", "=ds=#e10#", "", "100%" };
    { 4, 0, "AO_Unknown", "=q6="..BabbleBoss["Chromaggus"], "=q5=One Random Drop" };
    ...
    { 16, 0, "AO_Unknown", "=q6="..BabbleBoss["Chromaggus"], "=q5=One Random Drop" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Nefarian"], "=q5=Always Drops" };
    ...
    { 8, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Nefarian"], "=q5=Chance on Drop" };
    { 9, 100002, "", "=q3=Tome: Greater Blessing of Kings", "=ds=#e2#", "", "15.0%" };
    { 16, 0, "AO_Unknown", "=q6="..BabbleBoss["Nefarian"], "=q5=One Random Drop" };
    ...
    { 24, 0, "AO_Unknown", "=q6="..BabbleBoss["Nefarian"], "=q5=One Random Drop" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Pusillin"], "=q5=Always Drops" };
    ...
    { 2, 0, "AO_Unknown", "=q6="..BabbleBoss["Zevrim Thornhoof"], "=q5=One Random Drop" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Lethtendris"], "=q5=Always Drops" };
    { 2, 18426, "", "=q1=Lethtendris's Web", "=ds=#m3#", "", "100%" };
    { 4, 0, "AO_Unknown", "=q6="..BabbleBoss["Lethtendris"], "=q5=One Random Drop" };
    ...
    { 1, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Pimgib"], "=q5=Chance on Drop" };
    { 2, 18354, "", "=q3=Pimgib's Collar", "=ds=#s14#", "", "14.0%" };
	};

	AtlasLoot_Data["DMEHydro"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Hydrospawn"], "=q5=Always Drops" };
    { 2, 18299, "", "=q1=Hydrospawn Essence", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Hydrospawn"], "=q5=Chance on Drop" };
    { 5, 22527, "", "=q1=Core of Elements", "=ds=#m3#", "", "63.0%" };
    { 6, 7080, "", "=q2=Essence of Water", "=ds=#e7#", "", "11.0%" };
    { 8, 0, "AO_Unknown", "=q6="..BabbleBoss["Hydrospawn"], "=q5=One Random Drop" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Alzzin the Wildshaper"], "=q5=Always Drops" };
    { 2, 901716, "", "=q1=Scepter of Sylvan Corruption", "=ds=#m3#", "", "100%" };
    { 4, 0, "AO_Unknown", "=q6="..BabbleBoss["Alzzin the Wildshaper"], "=q5=One Random Drop" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Isalien"], "=q5=Always Drops" };
    { 2, 21984, "", "=q1=Left Piece of Lord Valthalak's Amulet", "=ds=#m3#", "", "100%" };
    { 3, 22046, "", "=q1=Right Piece of Lord Valthalak's Amulet", "=ds=#m3#", "", "100%" };
    { 5, 0, "AO_Unknown", "=q6="..BabbleBoss["Isalien"], "=q5=One Random Drop" };
    ...
    { 1, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Guard Mol'dar"], "=q5=Chance on Drop" };
    ...
    { 1, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Stomper Kreeg"], "=q5=Chance on Drop" };
    { 2, 18425, "", "=q2=Kreeg's Mug", "=ds=#s15#", "", "40.0%" };
	};

	AtlasLoot_Data["DMNGuardFengus"] = {
    { 1, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Guard Fengus"], "=q5=Chance on Drop" };
    { 2, 18250, "", "=q2=Gordok Shackle Key", "=ds=#e10#", "", "13.0%" };
    { 4, 0, "AO_Unknown", "=q6="..BabbleBoss["Guard Fengus"], "=q5=One Random Drop" };
    ...
    { 1, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Guard Slip'kik"], "=q5=Chance on Drop" };
    { 2, 18250, "", "=q2=Gordok Shackle Key", "=ds=#e10#", "", "13.0%" };
    { 3, 18493, "", "=q3=Bulky Iron Spaulders", "=ds=#a4#", "", "7.69%" };
    { 4, 18494, "", "=q3=Denwatcher's Shoulders", "=ds=#a3#", "", "7.69%" };
    { 5, 18496, "", "=q3=Heliotrope Cloak", "=ds=#a1#", "", "7.69%" };
    { 6, 18497, "", "=q3=Sublime Wristguards", "=ds=#a1#", "", "7.69%" };
    { 7, 18498, "", "=q3=Hedgecutter", "=ds=#w1#", "", "7.69%" };
    { 9, 0, "AO_Unknown", "=q6="..BabbleBoss["Guard Slip'kik"], "=q5=One Random Drop" };
    { 10, 18332, "", "=q2=Libram of Rapidity", "=ds=#e2#", "", "50.0%" };
    { 11, 18333, "", "=q2=Libram of Focus", "=ds=#e2#", "", "50.0%" };
	};

	AtlasLoot_Data["DMNCaptainKromcrush"] = {
    { 1, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Captain Kromcrush"], "=q5=Chance on Drop" };
    { 2, 18250, "", "=q2=Gordok Shackle Key", "=ds=#e10#", "", "13.0%" };
    { 4, 0, "AO_Unknown", "=q6="..BabbleBoss["Captain Kromcrush"], "=q5=One Random Drop" };
    ...
    { 2, 0, "AO_Unknown", "=q6="..BabbleBoss["Cho'Rush the Observer"], "=q5=One Random Drop" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["King Gordok"], "=q5=Always Drops" };
    { 2, 901718, "", "=q1=Gordok's Skull Goblet", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["King Gordok"], "=q5=Chance on Drop" };
    { 5, 21982, "", "=q1=Ogre Warbeads", "=ds=#m3#", "", "80.0%" };
    { 6, 57101, "", "=q4=Formula: Nexus Shard", "=ds=#e2#", "", "10.0%" };
    { 8, 0, "AO_Unknown", "=q6="..BabbleBoss["King Gordok"], "=q5=One Random Drop" };
    ...
    { 2, 0, "AO_Unknown", "=q6="..BabbleBoss["Tendris Warpwood"], "=q5=One Random Drop" };
    ...
    { 2, 0, "AO_Unknown", "=q6="..BabbleBoss["Illyanna Ravenoak"], "=q5=One Random Drop" };
    ...
    { 1, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Magister Kalendris"], "=q5=Chance on Drop" };
    { 2, 22309, "", "=q2=Pattern: Big Bag of Enchantment", "=ds=#e2#", "", "15.0%" };
    { 4, 0, "AO_Unknown", "=q6="..BabbleBoss["Magister Kalendris"], "=q5=One Random Drop" };
    ...
    { 2, 0, "AO_Unknown", "=q6="..BabbleBoss["Tsu'zee"], "=q5=One Random Drop" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Immol'thar"], "=q5=Always Drops" };
    { 2, 901717, "", "=q1=Immol'thar's Fel Essence", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Immol'thar"], "=q5=Chance on Drop" };
    { 5, 24345, "", "=q3=Book of Cower IV", "=ds=#e2#", "", "13.0%" };
    { 16, 0, "AO_Unknown", "=q6="..BabbleBoss["Immol'thar"], "=q5=One Random Drop" };
    ...
    { 2, 0, "AO_Unknown", "=q6="..BabbleBoss["Lord Hel'nurath"], "=q5=One Random Drop" };
    ...
    { 2, 0, "AO_Unknown", "=q6="..BabbleBoss["Prince Tortheldrin"], "=q5=One Random Drop" };
    ...
    { 2, 0, "AO_Unknown", "=q6="..BabbleBoss["High Inquisitor Fairbanks"], "=q5=One Random Drop" };
    ...
    { 1, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Interrogator Vishas"], "=q5=Chance on Drop" };
    { 2, 7682, "", "=q3=Torturing Poker", "=ds=#w4#", "", "10.0%" };
	};

	AtlasLoot_Data["SMGThalnos"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Bloodmage Thalnos"], "=q5=Always Drops" };
    { 2, 901710, "", "=q1=Bloodfire Amulet", "=ds=#m3#", "", "100%" };
    { 4, 0, "AO_Unknown", "=q6="..BabbleBoss["Bloodmage Thalnos"], "=q5=One Random Drop" };
    { 5, 7684, "", "=q2=Bloodmage Mantle", "=ds=#a1#", "", "50.0%" };
    { 6, 7685, "", "=q3=Orb of the Forgotten Seer", "=ds=#s15#", "", "50.0%" };
	};

	AtlasLoot_Data["SMGIronspine"] = {
    { 2, 0, "AO_Unknown", "=q6="..BabbleBoss["Ironspine"], "=q5=One Random Drop" };
    ...
    { 2, 0, "AO_Unknown", "=q6="..BabbleBoss["Azshir the Sleepless"], "=q5=One Random Drop" };
    ...
    { 2, 0, "AO_Unknown", "=q6="..BabbleBoss["Fallen Champion"], "=q5=One Random Drop" };
    ...
    { 2, 0, "AO_Unknown", "=q6="..BabbleBoss["Houndmaster Loksey"], "=q5=One Random Drop" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Arcanist Doan"], "=q5=Always Drops" };
    { 2, 901723, "", "=q1=Arcane Orb of Doan", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Arcanist Doan"], "=q5=Chance on Drop" };
    { 5, 57467, "", "=q2=Technique: Scroll of Arcane Resistance III", "=ds=#e2#", "", "15.0%" };
    { 7, 0, "AO_Unknown", "=q6="..BabbleBoss["Arcanist Doan"], "=q5=One Random Drop" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Kel'Thuzad"], "=q5=Always Drops" };
    ...
    { 16, 0, "AO_Unknown", "=q6="..BabbleBoss["Kel'Thuzad"], "=q5=One Random Drop" };
    ...
    { 2, 0, "AO_Unknown", "=q6="..BabbleBoss["Sapphiron"], "=q5=One Random Drop" };
    ...
    { 1, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Gluth"], "=q5=Chance on Drop" };
    { 2, 22726, "", "=q5=Splinter of Atiesh", "=ds=#e10#", "", "30.0%" };
    { 4, 0, "AO_Unknown", "=q6="..BabbleBoss["Gluth"], "=q5=One Random Drop" };
    ...
    { 10, 0, "AO_Unknown", "=q6="..BabbleBoss["Gluth"], "=q5=One Random Drop" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Grobbulus"], "=q5=Always Drops" };
    { 2, 22361, "", "=q4=Desecrated Spaulders", "=ds=#e10#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Grobbulus"], "=q5=Chance on Drop" };
    { 5, 22726, "", "=q5=Splinter of Atiesh", "=ds=#e10#", "", "30.0%" };
    { 7, 0, "AO_Unknown", "=q6="..BabbleBoss["Grobbulus"], "=q5=One Random Drop" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Patchwerk"], "=q5=Always Drops" };
    { 2, 22361, "", "=q4=Desecrated Spaulders", "=ds=#e10#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Patchwerk"], "=q5=Chance on Drop" };
    { 5, 22726, "", "=q5=Splinter of Atiesh", "=ds=#e10#", "", "30.0%" };
    { 7, 0, "AO_Unknown", "=q6="..BabbleBoss["Patchwerk"], "=q5=One Random Drop" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Gothik the Harvester"], "=q5=Always Drops" };
    { 2, 22365, "", "=q4=Desecrated Boots", "=ds=#e10#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Gothik the Harvester"], "=q5=Chance on Drop" };
    { 5, 22726, "", "=q5=Splinter of Atiesh", "=ds=#e10#", "", "30.0%" };
    { 7, 0, "AO_Unknown", "=q6="..BabbleBoss["Gothik the Harvester"], "=q5=One Random Drop" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Instructor Razuvious"], "=q5=Always Drops" };
    { 2, 22365, "", "=q4=Desecrated Boots", "=ds=#e10#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Instructor Razuvious"], "=q5=Chance on Drop" };
    { 5, 22726, "", "=q5=Splinter of Atiesh", "=ds=#e10#", "", "30.0%" };
    { 7, 0, "AO_Unknown", "=q6="..BabbleBoss["Instructor Razuvious"], "=q5=One Random Drop" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Loatheb"], "=q5=Always Drops" };
    { 2, 30474, "", "=q0=NPC Equip 30474", "=ds=#e2#", "", "100%" };
    { 3, 22359, "", "=q4=Desecrated Legguards", "=ds=#e10#", "", "100%" };
    { 5, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Loatheb"], "=q5=Chance on Drop" };
    { 6, 22726, "", "=q5=Splinter of Atiesh", "=ds=#e10#", "", "30.0%" };
    { 8, 0, "AO_Unknown", "=q6="..BabbleBoss["Loatheb"], "=q5=One Random Drop" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Heigan the Unclean"], "=q5=Always Drops" };
    { 2, 22363, "", "=q4=Desecrated Girdle", "=ds=#e10#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Heigan the Unclean"], "=q5=Chance on Drop" };
    { 5, 22726, "", "=q5=Splinter of Atiesh", "=ds=#e10#", "", "30.0%" };
    { 7, 0, "AO_Unknown", "=q6="..BabbleBoss["Heigan the Unclean"], "=q5=One Random Drop" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Noth the Plaguebringer"], "=q5=Always Drops" };
    { 2, 57401, "", "=q6=Artisan Mining Pick", "=ds=#e3#", "", "100%" };
    { 3, 22363, "", "=q4=Desecrated Girdle", "=ds=#e10#", "", "100%" };
    { 5, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Noth the Plaguebringer"], "=q5=Chance on Drop" };
    { 6, 22726, "", "=q5=Splinter of Atiesh", "=ds=#e10#", "", "30.0%" };
    { 8, 0, "AO_Unknown", "=q6="..BabbleBoss["Noth the Plaguebringer"], "=q5=One Random Drop" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Maexxna"], "=q5=Always Drops" };
    { 2, 30459, "", "=q3=Netherflame Robe", "=ds=#a1#", "", "100%" };
    { 3, 22364, "", "=q4=Desecrated Handguards", "=ds=#e10#", "", "100%" };
    { 5, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Maexxna"], "=q5=Chance on Drop" };
    { 6, 22726, "", "=q5=Splinter of Atiesh", "=ds=#e10#", "", "30.0%" };
    { 8, 0, "AO_Unknown", "=q6="..BabbleBoss["Maexxna"], "=q5=One Random Drop" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Grand Widow Faerlina"], "=q5=Always Drops" };
    { 2, 22362, "", "=q4=Desecrated Wristguards", "=ds=#e10#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Grand Widow Faerlina"], "=q5=Chance on Drop" };
    { 5, 22726, "", "=q5=Splinter of Atiesh", "=ds=#e10#", "", "30.0%" };
    { 7, 0, "AO_Unknown", "=q6="..BabbleBoss["Grand Widow Faerlina"], "=q5=One Random Drop" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Anub'Rekhan"], "=q5=Always Drops" };
    { 2, 22362, "", "=q4=Desecrated Wristguards", "=ds=#e10#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Anub'Rekhan"], "=q5=Chance on Drop" };
    { 5, 22726, "", "=q5=Splinter of Atiesh", "=ds=#e10#", "", "30.0%" };
    { 7, 0, "AO_Unknown", "=q6="..BabbleBoss["Anub'Rekhan"], "=q5=One Random Drop" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Edwin VanCleef"], "=q5=Always Drops" };
    { 2, 2874, "", "=q1=An Unsent Letter", "=ds=#m3#", "", "100%" };
    { 3, 3637, "", "=q1=Head of VanCleef", "=ds=#m3#", "", "100%" };
    { 5, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Edwin VanCleef"], "=q5=Chance on Drop" };
    { 6, 57471, "", "=q2=Technique: Scroll of Shadow Resistance II", "=ds=#e2#", "", "15.0%" };
    { 8, 0, "AO_Unknown", "=q6="..BabbleBoss["Edwin VanCleef"], "=q5=One Random Drop" };
    ...
    { 2, 0, "AO_Unknown", "=q6="..BabbleBoss["Captain Greenskin"], "=q5=One Random Drop" };
    ...
    { 2, 0, "AO_Unknown", "=q6="..BabbleBoss["Gilnid"], "=q5=One Random Drop" };
    { 3, 5199, "", "=q2=Smelting Pants", "=ds=#a2#", "", "55.0%" };
    { 4, 1156, "", "=q3=Lavishly Jeweled Ring", "=ds=#s13#", "", "45.0%" };
	};

	AtlasLoot_Data["VCMinerJohnson"] = {
    { 2, 0, "AO_Unknown", "=q6="..BabbleBoss["Miner Johnson"], "=q5=One Random Drop" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Foreman Thistlenettle"], "=q5=Always Drops" };
    { 2, 1875, "", "=q1=Thistlenettle's Badge", "=ds=#m3#", "", "100%" };
	};

	AtlasLoot_Data["VCNoble"] = {
    { 2, 0, "AO_Unknown", "=q6="..BabbleBoss["Brainwashed Noble"], "=q5=One Random Drop" };
    { 3, 5967, "", "=q2=Girdle of Nobility", "=ds=#a1#", "", "70.0%" };
    { 4, 3902, "", "=q2=Staff of Nobles", "=ds=#w9#", "", "30.0%" };
	};

	AtlasLoot_Data["VCRhahkZor"] = {
    { 2, 0, "AO_Unknown", "=q6="..BabbleBoss["Rhahk'Zor"], "=q5=One Random Drop" };
    { 3, 5187, "", "=q1=Rhahk'Zor's Hammer", "=ds=#w6#", "", "95.0%" };
    { 4, 872, "", "=q2=Rockslicer", "=ds=#w1#", "", "5.00%" };
	};

	AtlasLoot_Data["VCMarisa"] = {
    { 2, 0, "AO_Unknown", "=q6="..BabbleBoss["Marisa du'Paige"], "=q5=One Random Drop" };
    ...
    { 2, 0, "AO_Unknown", "=q6="..BabbleBoss["Stratholme Courier"], "=q5=One Random Drop" };
    { 3, 13306, "", "=q1=King's Square Postbox Key", "=ds=#e5#", "", "50.0%" };
    { 4, 13307, "", "=q1=Fras Siabi's Postbox Key", "=ds=#e5#", "", "50.0%" };
    { 6, 0, "AO_Unknown", "=q6="..BabbleBoss["Stratholme Courier"], "=q5=One Random Drop" };
    { 7, 13303, "", "=q1=Crusaders' Square Postbox Key", "=ds=#e5#", "", "50.0%" };
    { 8, 13305, "", "=q1=Elders' Square Postbox Key", "=ds=#e5#", "", "50.0%" };
    { 10, 0, "AO_Unknown", "=q6="..BabbleBoss["Stratholme Courier"], "=q5=One Random Drop" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Fras Siabi"], "=q5=Always Drops" };
    { 2, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Hearthsinger Forresten"], "=q5=Always Drops" };
    { 2, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Hearthsinger Forresten"], "=q5=Chance on Drop" };
    { 5, 13174, "", "=q1=Plagued Flesh Sample", "=ds=#m3#", "", "80.0%" };
    { 7, 0, "AO_Unknown", "=q6="..BabbleBoss["Hearthsinger Forresten"], "=q5=One Random Drop" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["The Unforgiven"], "=q5=Always Drops" };
    { 2, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["The Unforgiven"], "=q5=Chance on Drop" };
    { 5, 13174, "", "=q1=Plagued Flesh Sample", "=ds=#m3#", "", "80.0%" };
    { 7, 0, "AO_Unknown", "=q6="..BabbleBoss["The Unforgiven"], "=q5=One Random Drop" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Timmy the Cruel"], "=q5=Always Drops" };
    { 2, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Timmy the Cruel"], "=q5=Chance on Drop" };
    { 5, 13174, "", "=q1=Plagued Flesh Sample", "=ds=#m3#", "", "80.0%" };
    { 7, 0, "AO_Unknown", "=q6="..BabbleBoss["Timmy the Cruel"], "=q5=One Random Drop" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Cannon Master Willey"], "=q5=Always Drops" };
    { 2, 13377, "", "=q3=Miniature Cannon Balls", "=ds=#e6#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Cannon Master Willey"], "=q5=Chance on Drop" };
    { 5, 12839, "", "=q3=Plans: Heartseeker", "=ds=#e2#", "", "6.00%" };
    { 16, 0, "AO_Unknown", "=q6="..BabbleBoss["Cannon Master Willey"], "=q5=One Random Drop" };
    ...
    { 1, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Archivist Galford"], "=q5=Chance on Drop" };
    { 2, 12811, "", "=q2=Righteous Orb", "=ds=#e7#", "", "66.0%" };
    { 3, 22897, "", "=q3=Tome of Conjure Food VII", "=ds=#e2#", "", "14.0%" };
    { 5, 0, "AO_Unknown", "=q6="..BabbleBoss["Archivist Galford"], "=q5=One Random Drop" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Stonespine"], "=q5=Always Drops" };
    { 2, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    { 4, 0, "AO_Unknown", "=q6="..BabbleBoss["Stonespine"], "=q5=One Random Drop" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Baroness Anastari"], "=q5=Always Drops" };
    { 2, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Baroness Anastari"], "=q5=Chance on Drop" };
    { 5, 13174, "", "=q1=Plagued Flesh Sample", "=ds=#m3#", "", "80.0%" };
    { 6, 100003, "", "=q3=Codex: Prayer of Spirit", "=ds=#e2#", "", "12.0%" };
    { 8, 0, "AO_Unknown", "=q6="..BabbleBoss["Baroness Anastari"], "=q5=One Random Drop" };
    ...
    { 16, 0, "AO_Unknown", "=q6="..BabbleBoss["Baroness Anastari"], "=q5=One Random Drop" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Nerub'enkan"], "=q5=Always Drops" };
    { 2, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Nerub'enkan"], "=q5=Chance on Drop" };
    { 5, 13174, "", "=q1=Plagued Flesh Sample", "=ds=#m3#", "", "80.0%" };
    { 7, 0, "AO_Unknown", "=q6="..BabbleBoss["Nerub'enkan"], "=q5=One Random Drop" };
    ...
    { 16, 0, "AO_Unknown", "=q6="..BabbleBoss["Nerub'enkan"], "=q5=One Random Drop" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Maleki the Pallid"], "=q5=Always Drops" };
    { 2, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Maleki the Pallid"], "=q5=Chance on Drop" };
    { 5, 100003, "", "=q3=Codex: Prayer of Spirit", "=ds=#e2#", "", "10.0%" };
    { 6, 12833, "", "=q3=Plans: Hammer of the Titans", "=ds=#e2#", "", "6.00%" };
    { 8, 0, "AO_Unknown", "=q6="..BabbleBoss["Maleki the Pallid"], "=q5=One Random Drop" };
    ...
    { 16, 0, "AO_Unknown", "=q6="..BabbleBoss["Maleki the Pallid"], "=q5=One Random Drop" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Magistrate Barthilas"], "=q5=Always Drops" };
    { 2, 12382, "", "=q2=Key to the City", "=ds=#e5#", "", "100%" };
    { 3, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    { 5, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Magistrate Barthilas"], "=q5=Chance on Drop" };
    { 6, 13174, "", "=q1=Plagued Flesh Sample", "=ds=#m3#", "", "80.0%" };
    { 7, 57483, "", "=q2=Technique: Scroll of Holy Resistance IV", "=ds=#e2#", "", "15.0%" };
    { 9, 0, "AO_Unknown", "=q6="..BabbleBoss["Magistrate Barthilas"], "=q5=One Random Drop" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Ramstein the Gorger"], "=q5=Always Drops" };
    { 2, 12735, "", "=q2=Frayed Abomination Stitching", "=ds=#m3#", "", "100%" };
    { 3, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    { 4, 15880, "", "=q1=Head of Ramstein the Gorger", "=ds=#m3#", "", "100%" };
    { 6, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Ramstein the Gorger"], "=q5=Chance on Drop" };
    { 7, 13174, "", "=q1=Plagued Flesh Sample", "=ds=#m3#", "", "80.0%" };
    { 9, 0, "AO_Unknown", "=q6="..BabbleBoss["Ramstein the Gorger"], "=q5=One Random Drop" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Baron Rivendare"], "=q5=Always Drops" };
    { 2, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    ...
    { 7, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Baron Rivendare"], "=q5=Chance on Drop" };
    ...
    { 16, 0, "AO_Unknown", "=q6="..BabbleBoss["Baron Rivendare"], "=q5=One Random Drop" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Atal'alarion"], "=q5=Always Drops" };
    { 2, 901729, "", "=q1=Shirvallah's Tear", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Atal'alarion"], "=q5=Chance on Drop" };
    { 5, 6181, "", "=q1=Fetish of Hakkar", "=ds=#m3#", "", "80.0%" };
    { 7, 0, "AO_Unknown", "=q6="..BabbleBoss["Atal'alarion"], "=q5=One Random Drop" };
    ...
    { 2, 0, "AO_Unknown", "=q6="..BabbleBoss["Avatar of Hakkar"], "=q5=One Random Drop" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Shade of Eranikus"], "=q5=Always Drops" };
    { 2, 10454, "", "=q2=Essence of Eranikus", "=ds=#m3#", "", "100%" };
    { 3, 901713, "", "=q1=Dream Seed", "=ds=#m3#", "", "100%" };
    { 5, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Shade of Eranikus"], "=q5=Chance on Drop" };
    { 6, 57468, "", "=q2=Technique: Scroll of Arcane Resistance IV", "=ds=#e2#", "", "15.0%" };
    { 8, 0, "AO_Unknown", "=q6="..BabbleBoss["Shade of Eranikus"], "=q5=One Random Drop" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Baelog"], "=q5=Always Drops" };
    { 2, 9399, "", "=q2=Precision Arrow", "=ds=#e6#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Baelog"], "=q5=Chance on Drop" };
    { 5, 9401, "", "=q3=Nordic Longshank", "=ds=#w10#", "", "10.0%" };
	};

	AtlasLoot_Data["UldRevelosh"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Revelosh"], "=q5=Always Drops" };
    { 2, 7741, "", "=q1=The Shaft of Tsol", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Revelosh"], "=q5=Chance on Drop" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Ironaya"], "=q5=Always Drops" };
    { 2, 901728, "", "=q1=Titanforged Beacon", "=ds=#m3#", "", "100%" };
    { 4, 0, "AO_Unknown", "=q6="..BabbleBoss["Ironaya"], "=q5=One Random Drop" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Obsidian Sentinel"], "=q5=Always Drops" };
    { 2, 8053, "", "=q1=Obsidian Power Source", "=ds=#m3#", "", "100%" };
	};

	AtlasLoot_Data["UldAncientStoneKeeper"] = {
    { 2, 0, "AO_Unknown", "=q6="..BabbleBoss["Ancient Stone Keeper"], "=q5=One Random Drop" };
    { 3, 9410, "", "=q3=Cragfists", "=ds=#a4#", "", "50.0%" };
    { 4, 9411, "", "=q2=Rockshard Pauldrons", "=ds=#a3#", "", "50.0%" };
	};

	AtlasLoot_Data["UldGalgannFirehammer"] = {
    { 2, 0, "AO_Unknown", "=q6="..BabbleBoss["Galgann Firehammer"], "=q5=One Random Drop" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Grimlok"], "=q5=Always Drops" };
    { 2, 7670, "", "=q1=Shattered Necklace Sapphire", "=ds=#m3#", "", "100%" };
    { 4, 0, "AO_Unknown", "=q6="..BabbleBoss["Grimlok"], "=q5=One Random Drop" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Archaedas"], "=q5=Always Drops" };
    { 2, 7672, "", "=q1=Shattered Necklace Power Source", "=ds=#m3#", "", "100%" };
    { 3, 901711, "", "=q1=Resonating Stone of Unity", "=ds=#m3#", "", "100%" };
    { 5, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Archaedas"], "=q5=Chance on Drop" };
    { 6, 57467, "", "=q2=Technique: Scroll of Arcane Resistance III", "=ds=#e2#", "", "15.0%" };
    { 8, 0, "AO_Unknown", "=q6="..BabbleBoss["Archaedas"], "=q5=One Random Drop" };
    ...
    { 1, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Antu'sul"], "=q5=Chance on Drop" };
    { 2, 9523, "", "=q1=Troll Temper", "=ds=#m3#", "", "55.0%" };
    { 4, 0, "AO_Unknown", "=q6="..BabbleBoss["Antu'sul"], "=q5=One Random Drop" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Theka the Martyr"], "=q5=Always Drops" };
    { 2, 10660, "", "=q1=First Mosh'aru Tablet", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Theka the Martyr"], "=q5=Chance on Drop" };
    ...
    { 1, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Witch Doctor Zum'rah"], "=q5=Chance on Drop" };
    { 2, 18083, "", "=q3=Jumanza Grips", "=ds=#a1#", "", "30.0%" };
    { 3, 18082, "", "=q3=Zum'rah's Vexing Cane", "=ds=#w9#", "", "15.0%" };
	};

	AtlasLoot_Data["ZFNekrumGutchewer"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Nekrum Gutchewer"], "=q5=Always Drops" };
    { 2, 9471, "", "=q1=Nekrum's Medallion", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Nekrum Gutchewer"], "=q5=Chance on Drop" };
    { 5, 9523, "", "=q1=Troll Temper", "=ds=#m3#", "", "55.0%" };
	};

	AtlasLoot_Data["ZFSezzziz"] = {
    { 2, 0, "AO_Unknown", "=q6="..BabbleBoss["Shadowpriest Sezz'ziz"], "=q5=One Random Drop" };
    ...
    { 1, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Dustwraith"], "=q5=Chance on Drop" };
    { 2, 9523, "", "=q1=Troll Temper", "=ds=#m3#", "", "55.0%" };
    { 3, 12471, "", "=q3=Desertwalker Cane", "=ds=#s15#", "", "18.6%" };
	};

	AtlasLoot_Data["ZFSandfury"] = {
    { 1, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Sandfury Executioner"], "=q5=Chance on Drop" };
    { 2, 9523, "", "=q1=Troll Temper", "=ds=#m3#", "", "55.0%" };
	};

	AtlasLoot_Data["ZFSergeantBly"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Sergeant Bly"], "=q5=Always Drops" };
    { 2, 8548, "", "=q1=Divino-matic Rod", "=ds=#m3#", "", "100%" };
	};

	AtlasLoot_Data["ZFHydromancerVelratha"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Hydromancer Velratha"], "=q5=Always Drops" };
    { 2, 9234, "", "=q1=Tiara of the Deep", "=ds=#m3#", "", "100%" };
    { 3, 10661, "", "=q1=Second Mosh'aru Tablet", "=ds=#m3#", "", "100%" };
    { 5, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Hydromancer Velratha"], "=q5=Chance on Drop" };
    { 6, 57463, "", "=q2=Technique: Scroll of Frost Resistance IV", "=ds=#e2#", "", "15.0%" };
	};

	AtlasLoot_Data["ZFGahzrilla"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Gahz'rilla"], "=q5=Always Drops" };
    { 2, 8707, "", "=q1=Gahz'rilla's Electrified Scale", "=ds=#m3#", "", "100%" };
    { 4, 0, "AO_Unknown", "=q6="..BabbleBoss["Gahz'rilla"], "=q5=One Random Drop" };
    { 5, 9467, "", "=q2=Gahz'rilla Fang", "=ds=#w4#", "", "50.0%" };
    { 6, 9469, "", "=q3=Gahz'rilla Scale Armor", "=ds=#a3#", "", "50.0%" };
	};

	AtlasLoot_Data["ZFChiefUkorzSandscalp"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Chief Ukorz Sandscalp"], "=q5=Always Drops" };
    { 2, 901712, "", "=q1=Sandfury War Drum", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Chief Ukorz Sandscalp"], "=q5=Chance on Drop" };
    { 5, 9523, "", "=q1=Troll Temper", "=ds=#m3#", "", "55.0%" };
    { 7, 0, "AO_Unknown", "=q6="..BabbleBoss["Chief Ukorz Sandscalp"], "=q5=One Random Drop" };
    ...
    { 1, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Zerillis"], "=q5=Chance on Drop" };
    { 2, 9523, "", "=q1=Troll Temper", "=ds=#m3#", "", "55.0%" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["High Priestess Jeklik"], "=q5=Always Drops" };
    { 2, 19881, "", "=q1=Channeler's Head", "=ds=#m3#", "", "100%" };
    { 3, 57608, "", "=q3=Pattern: Drums of the Wild", "=ds=#e2#", "", "100%" };
    { 5, 0, "AO_Unknown", "=q6="..BabbleBoss["High Priestess Jeklik"], "=q5=One Random Drop" };
    ...
    { 16, 0, "AO_Unknown", "=q6="..BabbleBoss["High Priestess Jeklik"], "=q5=One Random Drop" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["High Priest Venoxis"], "=q5=Always Drops" };
    { 2, 19881, "", "=q1=Channeler's Head", "=ds=#m3#", "", "100%" };
    { 3, 22216, "", "=q1=Venoxis's Venom Sac", "=ds=#m3#", "", "100%" };
    { 5, 0, "AO_Unknown", "=q6="..BabbleBoss["High Priest Venoxis"], "=q5=One Random Drop" };
    ...
    { 16, 0, "AO_Unknown", "=q6="..BabbleBoss["High Priest Venoxis"], "=q5=One Random Drop" };
    { 17, 22711, "", "=q3=Cloak of the Hakkari Worshippers", "=ds=#a1#", "", "10.0%" };
    { 18, 22712, "", "=q3=Might of the Tribe", "=ds=#a1#", "", "10.0%" };
    { 19, 22713, "", "=q3=Zulian Scepter of Rites", "=ds=#w6#", "", "10.0%" };
    { 20, 22714, "", "=q3=Sacrificial Gauntlets", "=ds=#a4#", "", "10.0%" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["High Priestess Mar'li"], "=q5=Always Drops" };
    { 2, 19881, "", "=q1=Channeler's Head", "=ds=#m3#", "", "100%" };
    { 4, 0, "AO_Unknown", "=q6="..BabbleBoss["High Priestess Mar'li"], "=q5=One Random Drop" };
    ...
    { 16, 0, "AO_Unknown", "=q6="..BabbleBoss["High Priestess Mar'li"], "=q5=One Random Drop" };
    { 17, 22711, "", "=q3=Cloak of the Hakkari Worshippers", "=ds=#a1#", "", "10.0%" };
    { 18, 22712, "", "=q3=Might of the Tribe", "=ds=#a1#", "", "10.0%" };
    { 19, 22713, "", "=q3=Zulian Scepter of Rites", "=ds=#w6#", "", "10.0%" };
    { 20, 22714, "", "=q3=Sacrificial Gauntlets", "=ds=#a4#", "", "10.0%" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Bloodlord Mandokir"], "=q5=Always Drops" };
    { 2, 22637, "", "=q3=Primal Hakkari Idol", "=ds=#e10#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Bloodlord Mandokir"], "=q5=Chance on Drop" };
    { 5, 19872, "", "=q4=Swift Razzashi Raptor", "=ds=#e10#", "", "2.00%" };
    { 16, 0, "AO_Unknown", "=q6="..BabbleBoss["Bloodlord Mandokir"], "=q5=One Random Drop" };
    ...
    { 1, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Gahz'ranka"], "=q5=Chance on Drop" };
    { 2, 22739, "", "=q3=Tome of Polymorph: Turtle", "=ds=#e2#", "", "15.0%" };
    { 4, 0, "AO_Unknown", "=q6="..BabbleBoss["Gahz'ranka"], "=q5=One Random Drop" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["High Priest Thekal"], "=q5=Always Drops" };
    { 2, 19881, "", "=q1=Channeler's Head", "=ds=#m3#", "", "100%" };
    { 3, 57602, "", "=q3=Pattern: Drums of Fortitude", "=ds=#e2#", "", "100%" };
    { 5, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["High Priest Thekal"], "=q5=Chance on Drop" };
    { 6, 19902, "", "=q4=Swift Zulian Tiger", "=ds=#e10#", "", "2.00%" };
    { 8, 0, "AO_Unknown", "=q6="..BabbleBoss["High Priest Thekal"], "=q5=One Random Drop" };
    ...
    { 16, 0, "AO_Unknown", "=q6="..BabbleBoss["High Priest Thekal"], "=q5=One Random Drop" };
    { 17, 22711, "", "=q3=Cloak of the Hakkari Worshippers", "=ds=#a1#", "", "10.0%" };
    { 18, 22712, "", "=q3=Might of the Tribe", "=ds=#a1#", "", "10.0%" };
    { 19, 22713, "", "=q3=Zulian Scepter of Rites", "=ds=#w6#", "", "10.0%" };
    { 20, 22714, "", "=q3=Sacrificial Gauntlets", "=ds=#a4#", "", "10.0%" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["High Priestess Arlokk"], "=q5=Always Drops" };
    { 2, 19881, "", "=q1=Channeler's Head", "=ds=#m3#", "", "100%" };
    { 4, 0, "AO_Unknown", "=q6="..BabbleBoss["High Priestess Arlokk"], "=q5=One Random Drop" };
    ...
    { 16, 0, "AO_Unknown", "=q6="..BabbleBoss["High Priestess Arlokk"], "=q5=One Random Drop" };
    { 17, 22711, "", "=q3=Cloak of the Hakkari Worshippers", "=ds=#a1#", "", "10.0%" };
    { 18, 22712, "", "=q3=Might of the Tribe", "=ds=#a1#", "", "10.0%" };
    { 19, 22713, "", "=q3=Zulian Scepter of Rites", "=ds=#w6#", "", "10.0%" };
    { 20, 22714, "", "=q3=Sacrificial Gauntlets", "=ds=#a4#", "", "10.0%" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Jin'do the Hexxer"], "=q5=Always Drops" };
    { 2, 22637, "", "=q3=Primal Hakkari Idol", "=ds=#e10#", "", "100%" };
    { 4, 0, "AO_Unknown", "=q6="..BabbleBoss["Jin'do the Hexxer"], "=q5=One Random Drop" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6="..BabbleBoss["Hakkar"], "=q5=Always Drops" };
    { 2, 19802, "", "=q4=Heart of Hakkar", "=ds=#m3#", "", "100%" };
    { 4, 0, "AO_Unknown", "=q6="..BabbleBoss["Hakkar"], "=q5=One Random Drop" };
    ...
    { 16, 0, "AO_Unknown", "=q6="..BabbleBoss["Hakkar"], "=q5=One Random Drop" };
