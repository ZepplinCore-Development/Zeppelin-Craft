...
---- Azuregos
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Kurinnaxx"].." - Always Drops", "=q5=Always Drops"};
    { 2, 22217, "", "=q1=Kurinnaxx's Venom Sac", "=ds=#m3#", "", "100%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Kurinnaxx"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 5, 21302, "", "=q3=Handbook of Deadly Poison V", "=ds=#e2#", "", "3.85%" };
    { 7, 0, "INV_Box_01", "=q6="..BabbleBoss["Kurinnaxx"].." - One Random Drop", "=q5=Random Drop"};
    { 8, 20884, "", "=q3=Qiraji Magisterial Ring", "=ds=#m3#", "", "25.0%" };
    { 9, 20885, "", "=q3=Qiraji Martial Drape", "=ds=#m3#", "", "25.0%" };
    { 10, 20888, "", "=q3=Qiraji Ceremonial Ring", "=ds=#m3#", "", "25.0%" };
    { 11, 20889, "", "=q3=Qiraji Regal Drape", "=ds=#m3#", "", "25.0%" };
    { 13, 0, "INV_Box_01", "=q6="..BabbleBoss["Kurinnaxx"].." - One Random Drop", "=q5=Random Drop"};
    { 14, 21500, "", "=q3=Belt of the Inquisition", "=ds=#a1#", "", "20.0%" };
    { 15, 21501, "", "=q3=Toughened Silithid Hide Gloves", "=ds=#a2#", "", "20.0%" };
    { 16, 21502, "", "=q3=Sand Reaver Wristguards", "=ds=#a3#", "", "20.0%" };
    { 17, 21503, "", "=q3=Belt of the Sand Reaver", "=ds=#a4#", "", "20.0%" };
    { 18, 21498, "", "=q4=Qiraji Sacrificial Dagger", "=ds=#w4#", "", "10.0%" };
    { 19, 21499, "", "=q4=Vestments of the Shifting Sands", "=ds=#a1#", "", "10.0%" };
    { 21, 0, "INV_Box_01", "=q6="..BabbleBoss["Kurinnaxx"].." - One Random Drop", "=q5=Random Drop"};
    { 22, 20727, "", "=q3=Formula: Enchant Gloves - Shadow Power", "=ds=#e2#", "", "14.3%" };
    { 23, 20728, "", "=q3=Formula: Enchant Gloves - Frost Power", "=ds=#e2#", "", "14.3%" };
    { 24, 20729, "", "=q3=Formula: Enchant Gloves - Fire Power", "=ds=#e2#", "", "14.3%" };
    { 25, 20730, "", "=q3=Formula: Enchant Gloves - Healing Power", "=ds=#e2#", "", "14.3%" };
    { 26, 20731, "", "=q3=Formula: Enchant Gloves - Superior Agility", "=ds=#e2#", "", "14.3%" };
    { 27, 20734, "", "=q3=Formula: Enchant Cloak - Stealth", "=ds=#e2#", "", "14.3%" };
    { 28, 20736, "", "=q3=Formula: Enchant Cloak - Dodge", "=ds=#e2#", "", "14.3%" };
	};

	AtlasLoot_Data["AQ20Rajaxx"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["General Rajaxx"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 2, 21302, "", "=q3=Handbook of Deadly Poison V", "=ds=#e2#", "", "3.85%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["General Rajaxx"].." - One Random Drop", "=q5=Random Drop"};
    { 5, 20884, "", "=q3=Qiraji Magisterial Ring", "=ds=#m3#", "", "25.0%" };
    { 6, 20885, "", "=q3=Qiraji Martial Drape", "=ds=#m3#", "", "25.0%" };
    { 7, 20888, "", "=q3=Qiraji Ceremonial Ring", "=ds=#m3#", "", "25.0%" };
    { 8, 20889, "", "=q3=Qiraji Regal Drape", "=ds=#m3#", "", "25.0%" };
    { 10, 0, "INV_Box_01", "=q6="..BabbleBoss["General Rajaxx"].." - One Random Drop", "=q5=Random Drop"};
    { 11, 21494, "", "=q3=Southwind's Grasp", "=ds=#a2#", "", "20.0%" };
    { 12, 21495, "", "=q3=Legplates of the Qiraji Command", "=ds=#a4#", "", "20.0%" };
    { 13, 21496, "", "=q3=Bracers of Qiraji Command", "=ds=#a1#", "", "20.0%" };
    { 14, 21497, "", "=q3=Boots of the Qiraji General", "=ds=#a3#", "", "20.0%" };
    { 15, 21492, "", "=q4=Manslayer of the Qiraji", "=ds=#w10#", "", "10.0%" };
    { 16, 21493, "", "=q4=Boots of the Vanguard", "=ds=#a2#", "", "10.0%" };
    { 18, 0, "INV_Box_01", "=q6="..BabbleBoss["General Rajaxx"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Moam"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 2, 22220, "", "=q3=Plans: Black Grasp of the Destroyer", "=ds=#e2#", "", "15.0%" };
    { 3, 21302, "", "=q3=Handbook of Deadly Poison V", "=ds=#e2#", "", "3.85%" };
    { 5, 0, "INV_Box_01", "=q6="..BabbleBoss["Moam"].." - One Random Drop", "=q5=Random Drop"};
    { 6, 20884, "", "=q3=Qiraji Magisterial Ring", "=ds=#m3#", "", "50.0%" };
    { 7, 20888, "", "=q3=Qiraji Ceremonial Ring", "=ds=#m3#", "", "50.0%" };
    { 9, 0, "INV_Box_01", "=q6="..BabbleBoss["Moam"].." - One Random Drop", "=q5=Random Drop"};
    { 10, 21467, "", "=q4=Thick Silithid Chestguard", "=ds=#a2#", "", "25.0%" };
    { 11, 21471, "", "=q4=Talon of Furious Concentration", "=ds=#s15#", "", "25.0%" };
    { 12, 21472, "", "=q4=Dustwind Turban", "=ds=#a1#", "", "25.0%" };
    { 13, 21479, "", "=q4=Gauntlets of the Immovable", "=ds=#a4#", "", "25.0%" };
    { 15, 0, "INV_Box_01", "=q6="..BabbleBoss["Moam"].." - One Random Drop", "=q5=Random Drop"};
    { 16, 21455, "", "=q3=Southwind Helm", "=ds=#a2#", "", "11.1%" };
    { 17, 21468, "", "=q3=Mantle of Maz'Nadir", "=ds=#a1#", "", "11.1%" };
    { 18, 21469, "", "=q3=Gauntlets of Southwind", "=ds=#a2#", "", "11.1%" };
    { 19, 21470, "", "=q3=Cloak of the Savior", "=ds=#a1#", "", "11.1%" };
    { 20, 21473, "", "=q3=Eye of Moam", "=ds=#s14#", "", "11.1%" };
    { 21, 21474, "", "=q3=Chitinous Shoulderguards", "=ds=#a2#", "", "11.1%" };
    { 22, 21475, "", "=q3=Legplates of the Destroyer", "=ds=#a4#", "", "11.1%" };
    { 23, 21476, "", "=q3=Obsidian Scaled Leggings", "=ds=#a3#", "", "11.1%" };
    { 24, 21477, "", "=q3=Ring of Fury", "=ds=#s13#", "", "11.1%" };
	};

	AtlasLoot_Data["AQ20Buru"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Buru the Gorger"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 2, 21302, "", "=q3=Handbook of Deadly Poison V", "=ds=#e2#", "", "3.85%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Buru the Gorger"].." - One Random Drop", "=q5=Random Drop"};
    { 5, 20884, "", "=q3=Qiraji Magisterial Ring", "=ds=#m3#", "", "25.0%" };
    { 6, 20885, "", "=q3=Qiraji Martial Drape", "=ds=#m3#", "", "25.0%" };
    { 7, 20888, "", "=q3=Qiraji Ceremonial Ring", "=ds=#m3#", "", "25.0%" };
    { 8, 20889, "", "=q3=Qiraji Regal Drape", "=ds=#m3#", "", "25.0%" };
    { 10, 0, "INV_Box_01", "=q6="..BabbleBoss["Buru the Gorger"].." - One Random Drop", "=q5=Random Drop"};
    { 11, 21488, "", "=q3=Fetish of Chitinous Spikes", "=ds=#s14#", "", "20.0%" };
    { 12, 21489, "", "=q3=Quicksand Waders", "=ds=#a1#", "", "20.0%" };
    { 13, 21490, "", "=q3=Slime Kickers", "=ds=#a4#", "", "20.0%" };
    { 14, 21491, "", "=q3=Scaled Bracers of the Gorger", "=ds=#a2#", "", "20.0%" };
    { 15, 21485, "", "=q4=Buru's Skull Fragment", "=ds=#w8#", "", "6.67%" };
    { 16, 21486, "", "=q4=Gloves of the Swarm", "=ds=#a4#", "", "6.67%" };
    { 17, 21487, "", "=q4=Slimy Scaled Gauntlets", "=ds=#a3#", "", "6.67%" };
    { 19, 0, "INV_Box_01", "=q6="..BabbleBoss["Buru the Gorger"].." - One Random Drop", "=q5=Random Drop"};
    { 20, 20727, "", "=q3=Formula: Enchant Gloves - Shadow Power", "=ds=#e2#", "", "14.3%" };
    { 21, 20728, "", "=q3=Formula: Enchant Gloves - Frost Power", "=ds=#e2#", "", "14.3%" };
    { 22, 20729, "", "=q3=Formula: Enchant Gloves - Fire Power", "=ds=#e2#", "", "14.3%" };
    { 23, 20730, "", "=q3=Formula: Enchant Gloves - Healing Power", "=ds=#e2#", "", "14.3%" };
    { 24, 20731, "", "=q3=Formula: Enchant Gloves - Superior Agility", "=ds=#e2#", "", "14.3%" };
    { 25, 20734, "", "=q3=Formula: Enchant Cloak - Stealth", "=ds=#e2#", "", "14.3%" };
    { 26, 20736, "", "=q3=Formula: Enchant Cloak - Dodge", "=ds=#e2#", "", "14.3%" };
	};

	AtlasLoot_Data["AQ20Ayamiss"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Ayamiss the Hunter"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 2, 21302, "", "=q3=Handbook of Deadly Poison V", "=ds=#e2#", "", "3.85%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Ayamiss the Hunter"].." - One Random Drop", "=q5=Random Drop"};
    { 5, 20884, "", "=q3=Qiraji Magisterial Ring", "=ds=#m3#", "", "25.0%" };
    { 6, 20885, "", "=q3=Qiraji Martial Drape", "=ds=#m3#", "", "25.0%" };
    { 7, 20888, "", "=q3=Qiraji Ceremonial Ring", "=ds=#m3#", "", "25.0%" };
    { 8, 20889, "", "=q3=Qiraji Regal Drape", "=ds=#m3#", "", "25.0%" };
    { 10, 0, "INV_Box_01", "=q6="..BabbleBoss["Ayamiss the Hunter"].." - One Random Drop", "=q5=Random Drop"};
    { 11, 21480, "", "=q3=Scaled Silithid Gauntlets", "=ds=#a3#", "", "16.0%" };
    { 12, 21481, "", "=q3=Boots of the Desert Protector", "=ds=#a4#", "", "16.0%" };
    { 13, 21482, "", "=q3=Boots of the Fiery Sands", "=ds=#a3#", "", "16.0%" };
    { 14, 21483, "", "=q3=Ring of the Desert Winds", "=ds=#s13#", "", "16.0%" };
    { 15, 21484, "", "=q3=Helm of Regrowth", "=ds=#a2#", "", "16.0%" };
    { 16, 21466, "", "=q4=Stinger of Ayamiss", "=ds=#w6#", "", "6.67%" };
    { 17, 21478, "", "=q4=Bow of Taut Sinew", "=ds=#w2#", "", "6.67%" };
    { 18, 21479, "", "=q4=Gauntlets of the Immovable", "=ds=#a4#", "", "6.67%" };
    { 20, 0, "INV_Box_01", "=q6="..BabbleBoss["Ayamiss the Hunter"].." - One Random Drop", "=q5=Random Drop"};
    { 21, 20727, "", "=q3=Formula: Enchant Gloves - Shadow Power", "=ds=#e2#", "", "14.3%" };
    { 22, 20728, "", "=q3=Formula: Enchant Gloves - Frost Power", "=ds=#e2#", "", "14.3%" };
    { 23, 20729, "", "=q3=Formula: Enchant Gloves - Fire Power", "=ds=#e2#", "", "14.3%" };
    { 24, 20730, "", "=q3=Formula: Enchant Gloves - Healing Power", "=ds=#e2#", "", "14.3%" };
    { 25, 20731, "", "=q3=Formula: Enchant Gloves - Superior Agility", "=ds=#e2#", "", "14.3%" };
    { 26, 20734, "", "=q3=Formula: Enchant Cloak - Stealth", "=ds=#e2#", "", "14.3%" };
    { 27, 20736, "", "=q3=Formula: Enchant Cloak - Dodge", "=ds=#e2#", "", "14.3%" };
	};

	AtlasLoot_Data["AQ20Ossirian"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Ossirian the Unscarred"].." - Always Drops", "=q5=Always Drops"};
    { 2, 21220, "", "=q4=Head of Ossirian the Unscarred", "=ds=#m3#", "", "100%" };
    { 3, 57604, "", "=q3=Pattern: Drums of Intellect", "=ds=#e2#", "", "100%" };
    { 5, 0, "INV_Box_01", "=q6="..BabbleBoss["Ossirian the Unscarred"].." - One Random Drop", "=q5=Random Drop"};
    { 6, 20884, "", "=q3=Qiraji Magisterial Ring", "=ds=#m3#", "", "50.0%" };
    { 7, 20888, "", "=q3=Qiraji Ceremonial Ring", "=ds=#m3#", "", "50.0%" };
    { 9, 0, "INV_Box_01", "=q6="..BabbleBoss["Ossirian the Unscarred"].." - One Random Drop", "=q5=Random Drop"};
    { 10, 20886, "", "=q4=Qiraji Spiked Hilt", "=ds=#m3#", "", "50.0%" };
    { 11, 20890, "", "=q4=Qiraji Ornate Hilt", "=ds=#m3#", "", "50.0%" };
    { 13, 0, "INV_Box_01", "=q6="..BabbleBoss["Ossirian the Unscarred"].." - One Random Drop", "=q5=Random Drop"};
    { 14, 21214, "", "=q3=Tome of Frostbolt XI", "=ds=#e2#", "", "11.1%" };
    { 15, 21279, "", "=q3=Tome of Fireball XII", "=ds=#e2#", "", "11.1%" };
    { 16, 21280, "", "=q3=Tome of Arcane Missiles VIII", "=ds=#e2#", "", "11.1%" };
    { 17, 21281, "", "=q3=Grimoire of Shadow Bolt X", "=ds=#e2#", "", "11.1%" };
    { 18, 21282, "", "=q3=Grimoire of Immolate VIII", "=ds=#e2#", "", "11.1%" };
    { 19, 21283, "", "=q3=Grimoire of Corruption VII", "=ds=#e2#", "", "11.1%" };
    { 20, 21288, "", "=q3=Libram: Blessing of Wisdom VI", "=ds=#e2#", "", "11.1%" };
    { 21, 21291, "", "=q3=Tablet of Healing Wave X", "=ds=#e2#", "", "11.1%" };
    { 22, 21297, "", "=q3=Manual of Heroic Strike IX", "=ds=#e2#", "", "11.1%" };
	};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["The Prophet Skeram"].." - Always Drops", "=q5=Always Drops"};
    { 2, 57610, "", "=q3=Pattern: Drums of the Raid Leader", "=ds=#e2#", "", "100%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["The Prophet Skeram"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 5, 22222, "", "=q3=Plans: Thick Obsidian Breastplate", "=ds=#e2#", "", "15.0%" };
    { 7, 0, "INV_Box_01", "=q6="..BabbleBoss["The Prophet Skeram"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 16, 0, "INV_Box_01", "=q6="..BabbleBoss["The Prophet Skeram"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 2, 0, "INV_Box_01", "=q6="..BabbleBoss["Princess Yauj"].." - One Random Drop", "=q5=Random Drop"};
    { 3, 21682, "", "=q4=Bile-Covered Gauntlets", "=ds=#a2#", "", "20.0%" };
    { 4, 21683, "", "=q4=Mantle of the Desert Crusade", "=ds=#a4#", "", "20.0%" };
    { 5, 21684, "", "=q4=Mantle of the Desert's Fury", "=ds=#a3#", "", "20.0%" };
    { 6, 21686, "", "=q4=Mantle of Phrenic Power", "=ds=#a1#", "", "20.0%" };
    { 7, 21687, "", "=q4=Ukko's Ring of Darkness", "=ds=#s13#", "", "20.0%" };
    { 9, 0, "INV_Box_01", "=q6="..BabbleBoss["Princess Yauj"].." - One Random Drop", "=q5=Random Drop"};
    { 10, 21692, "", "=q4=Triad Girdle", "=ds=#a4#", "", "16.7%" };
    { 11, 21693, "", "=q4=Guise of the Devourer", "=ds=#a2#", "", "16.7%" };
    { 12, 21694, "", "=q4=Ternary Mantle", "=ds=#a1#", "", "16.7%" };
    { 13, 21695, "", "=q4=Angelista's Touch", "=ds=#s13#", "", "16.7%" };
    { 14, 21696, "", "=q4=Robes of the Triumvirate", "=ds=#a1#", "", "16.7%" };
    { 15, 21697, "", "=q4=Cape of the Trinity", "=ds=#a1#", "", "16.7%" };
	};

	AtlasLoot_Data["AQ40Sartura"] = {
    { 2, 0, "INV_Box_01", "=q6="..BabbleBoss["Battleguard Sartura"].." - One Random Drop", "=q5=Random Drop"};
    { 3, 21667, "", "=q4=Legplates of Blazing Light", "=ds=#a4#", "", "15.4%" };
    { 4, 21668, "", "=q4=Scaled Leggings of Qiraji Fury", "=ds=#a3#", "", "15.4%" };
    { 5, 21669, "", "=q4=Creeping Vine Helm", "=ds=#a2#", "", "15.4%" };
    { 6, 21670, "", "=q4=Badge of the Swarmguard", "=ds=#s14#", "", "15.4%" };
    { 7, 21671, "", "=q4=Robes of the Battleguard", "=ds=#a1#", "", "15.4%" };
    { 8, 21672, "", "=q4=Gloves of Enforcement", "=ds=#a2#", "", "15.4%" };
    { 9, 21666, "", "=q4=Sartura's Might", "=ds=#s15#", "", "7.70%" };
    { 16, 0, "INV_Box_01", "=q6="..BabbleBoss["Battleguard Sartura"].." - One Random Drop", "=q5=Random Drop"};
    { 17, 21648, "", "=q4=Recomposed Boots", "=ds=#a1#", "", "18.2%" };
    { 18, 21674, "", "=q4=Gauntlets of Steadfast Determination", "=ds=#a4#", "", "18.2%" };
    { 19, 21675, "", "=q4=Thick Qirajihide Belt", "=ds=#a2#", "", "18.2%" };
    { 20, 21676, "", "=q4=Leggings of the Festering Swarm", "=ds=#a1#", "", "18.2%" };
    { 21, 21678, "", "=q4=Necklace of Purity", "=ds=#s2#", "", "18.2%" };
    { 22, 21673, "", "=q4=Silithid Claw", "=ds=#w13#", "", "9.09%" };
	};

	AtlasLoot_Data["AQ40Fankriss"] = {
    { 2, 0, "INV_Box_01", "=q6="..BabbleBoss["Fankriss the Unyielding"].." - One Random Drop", "=q5=Random Drop"};
    { 3, 21639, "", "=q4=Pauldrons of the Unrelenting", "=ds=#a4#", "", "15.0%" };
    { 4, 21651, "", "=q4=Scaled Sand Reaver Leggings", "=ds=#a3#", "", "15.0%" };
    { 5, 21652, "", "=q4=Silithid Carapace Chestguard", "=ds=#a4#", "", "15.0%" };
    { 6, 21663, "", "=q4=Robes of the Guardian Saint", "=ds=#a1#", "", "15.0%" };
    { 7, 21664, "", "=q4=Barbed Choker", "=ds=#s2#", "", "15.0%" };
    { 8, 21665, "", "=q4=Mantle of Wicked Revenge", "=ds=#a2#", "", "15.0%" };
    { 9, 21650, "", "=q4=Ancient Qiraji Ripper", "=ds=#w10#", "", "10.0%" };
    { 16, 0, "INV_Box_01", "=q6="..BabbleBoss["Fankriss the Unyielding"].." - One Random Drop", "=q5=Random Drop"};
    { 17, 21627, "", "=q4=Cloak of Untold Secrets", "=ds=#a1#", "", "18.0%" };
    { 18, 21645, "", "=q4=Hive Tunneler's Boots", "=ds=#a2#", "", "18.0%" };
    { 19, 21647, "", "=q4=Fetish of the Sand Reaver", "=ds=#s14#", "", "18.0%" };
    { 20, 22396, "", "=q4=Totem of Life", "", "", "18.0%" };
    { 21, 22402, "", "=q4=Libram of Grace", "", "", "18.0%" };
    { 22, 21635, "", "=q4=Barb of the Sand Reaver", "=ds=#w7#", "", "10.0%" };
	};

	AtlasLoot_Data["AQ40Viscidus"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Viscidus"].." - Always Drops", "=q5=Always Drops"};
    { 2, 59315, "", "=q4=Qiraji Armor Cache - Shoulder", "=ds=#e10#", "", "100%" };
    { 3, 59319, "", "=q4=Viscidus's Crystalline Heart", "=ds=#m3#", "", "100%" };
    { 5, 0, "INV_Box_01", "=q6="..BabbleBoss["Viscidus"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Princess Huhuran"].." - Always Drops", "=q5=Always Drops"};
    { 2, 59318, "", "=q4=Qiraji Armor Cache - Boots", "=ds=#e10#", "", "100%" };
    { 3, 59320, "", "=q4=Huhuran's Stinger", "=ds=#m3#", "", "100%" };
    { 5, 0, "INV_Box_01", "=q6="..BabbleBoss["Princess Huhuran"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Emperor Vek'lor"].." - Always Drops", "=q5=Always Drops"};
    { 2, 20930, "", "=q4=Vek'lor's Diadem", "=ds=#e10#", "", "100%" };
    { 3, 59314, "", "=q4=Qiraji Armor Cache - Helm", "=ds=#e10#", "", "100%" };
    { 5, 0, "INV_Box_01", "=q6="..BabbleBoss["Emperor Vek'lor"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 6, 20735, "", "=q3=Formula: Enchant Cloak - Subtlety", "=ds=#e2#", "", "6.50%" };
    { 8, 0, "INV_Box_01", "=q6="..BabbleBoss["Emperor Vek'lor"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Ouro"].." - Always Drops", "=q5=Always Drops"};
    { 2, 20927, "", "=q4=Ouro's Intact Hide", "=ds=#m3#", "", "100%" };
    { 3, 59317, "", "=q4=Qiraji Armor Cache - Legs", "=ds=#e10#", "", "100%" };
    { 5, 0, "INV_Box_01", "=q6="..BabbleBoss["Ouro"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["C'Thun"].." - Always Drops", "=q5=Always Drops"};
    { 2, 20929, "", "=q4=Carapace of the Old God", "=ds=#e10#", "", "100%" };
    { 3, 21221, "", "=q4=Eye of C'Thun", "=ds=#m3#", "", "100%" };
    { 4, 22734, "", "=q5=Base of Atiesh", "=ds=#m3#", "", "100%" };
    { 5, 59316, "", "=q4=Qiraji Armor Cache - Chest", "=ds=#e10#", "", "100%" };
    { 7, 0, "INV_Box_01", "=q6="..BabbleBoss["C'Thun"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 8, 21579, "", "=q4=Vanquished Tentacle of C'Thun", "=ds=#s14#", "", "20.0%" };
    { 10, 0, "INV_Box_01", "=q6="..BabbleBoss["C'Thun"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 18, 0, "INV_Box_01", "=q6="..BabbleBoss["C'Thun"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 2, 0, "INV_Box_01", "=q6="..BabbleBoss["Ghamoo-ra"].." - One Random Drop", "=q5=Random Drop"};
    { 3, 6908, "", "=q2=Ghamoo-ra's Bind", "=ds=#a1#", "", "60.0%" };
    { 4, 6907, "", "=q3=Tortoise Armor", "=ds=#a3#", "", "40.0%" };
	};

	AtlasLoot_Data["BFDSarevess"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Lady Sarevess"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 2, 5952, "", "=q1=Corrupted Brain Stem", "=ds=#m3#", "", "80.0%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Lady Sarevess"].." - One Random Drop", "=q5=Random Drop"};
    { 5, 888, "", "=q3=Naga Battle Gloves", "=ds=#a2#", "", "40.0%" };
    { 6, 11121, "", "=q2=Darkwater Talwar", "=ds=#w10#", "", "40.0%" };
    { 7, 3078, "", "=q2=Naga Heartpiercer", "=ds=#w2#", "", "20.0%" };
	};

	AtlasLoot_Data["BFDGelihast"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Gelihast"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 2, 58100, "", "=q3=Giant Murloc", "=ds=#e10#", "", "50.0%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Gelihast"].." - One Random Drop", "=q5=Random Drop"};
    { 5, 6905, "", "=q2=Reef Axe", "=ds=#w1#", "", "50.0%" };
    { 6, 6906, "", "=q3=Algae Fists", "=ds=#a3#", "", "50.0%" };
	};

	AtlasLoot_Data["BFDAquanis"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Baron Aquanis"].." - Always Drops", "=q5=Always Drops"};
    { 2, 16782, "", "=q2=Strange Water Globe", "=ds=#m3#", "", "100%" };
	};

	AtlasLoot_Data["BFDKelris"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Twilight Lord Kelris"].." - Always Drops", "=q5=Always Drops"};
    { 2, 5881, "", "=q1=Head of Kelris", "=ds=#m3#", "", "100%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Twilight Lord Kelris"].." - One Random Drop", "=q5=Random Drop"};
    { 5, 1155, "", "=q3=Rod of the Sleepwalker", "=ds=#w9#", "", "60.0%" };
    { 6, 6903, "", "=q2=Gaze Dreamer Pants", "=ds=#a1#", "", "40.0%" };
	};

	AtlasLoot_Data["BFDSerrakis"] = {
    { 2, 0, "INV_Box_01", "=q6="..BabbleBoss["Old Serra'kis"].." - One Random Drop", "=q5=Random Drop"};
    { 3, 6901, "", "=q3=Glowing Thresher Cape", "=ds=#a1#", "", "40.0%" };
    { 4, 6902, "", "=q2=Bands of Serra'kis", "=ds=#a2#", "", "30.0%" };
    { 5, 6904, "", "=q3=Bite of Serra'kis", "=ds=#w4#", "", "30.0%" };
	};

	AtlasLoot_Data["BFDAkumai"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Aku'mai"].." - Always Drops", "=q5=Always Drops"};
    { 2, 901709, "", "=q1=Void Pearl", "=ds=#m3#", "", "100%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Aku'mai"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Lord Roccor"].." - Chance on Drop", "=q5=Chance on Drop"};
    ...
    { 7, 0, "INV_Box_01", "=q6="..BabbleBoss["Lord Roccor"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 2, 0, "INV_Box_01", "=q6="..BabbleBoss["High Interrogator Gerstahn"].." - One Random Drop", "=q5=Random Drop"};
    { 3, 11624, "", "=q3=Kentic Amice", "=ds=#a1#", "", "25.0%" };
    { 4, 11625, "", "=q3=Enthralled Sphere", "=ds=#s15#", "", "25.0%" };
    { 5, 11626, "", "=q3=Blackveil Cape", "=ds=#a1#", "", "25.0%" };
    { 6, 22240, "", "=q3=Greaves of Withering Despair", "=ds=#a3#", "", "25.0%" };
	};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Theldren"].." - Always Drops", "=q5=Always Drops"};
    { 2, 22047, "", "=q1=Top Piece of Lord Valthalak's Amulet", "=ds=#m3#", "", "100%" };
	};

	AtlasLoot_Data["BRDHoundmaster"] = {
    { 2, 0, "INV_Box_01", "=q6="..BabbleBoss["Houndmaster Grebmar"].." - One Random Drop", "=q5=Random Drop"};
    { 3, 11623, "", "=q3=Spritecaster Cape", "=ds=#a1#", "", "35.0%" };
    { 4, 11627, "", "=q3=Fleetfoot Greaves", "=ds=#a3#", "", "35.0%" };
    { 5, 11628, "", "=q3=Houndmaster's Bow", "=ds=#w2#", "", "15.0%" };
    { 6, 11629, "", "=q3=Houndmaster's Rifle", "=ds=#w5#", "", "15.0%" };
	};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Pyromancer Loregrain"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 2, 11207, "", "=q2=Formula: Enchant Weapon - Fiery Weapon", "=ds=#e2#", "", "16.0%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Pyromancer Loregrain"].." - One Random Drop", "=q5=Random Drop"};
    { 5, 11747, "", "=q3=Flamestrider Robes", "=ds=#a2#", "", "26.7%" };
    { 6, 11748, "", "=q3=Pyric Caduceus", "=ds=#w12#", "", "26.7%" };
    { 7, 11749, "", "=q3=Searingscale Leggings", "=ds=#a3#", "", "26.7%" };
    { 8, 11750, "", "=q3=Kindling Stave", "=ds=#w9#", "", "20.0%" };
	};
    ...
    { 2, 0, "INV_Box_01", "=q6="..BabbleBoss["Warder Stilgiss"].." - One Random Drop", "=q5=Random Drop"};
    { 3, 11782, "", "=q3=Boreal Mantle", "=ds=#a1#", "", "25.0%" };
    { 4, 11783, "", "=q3=Chillsteel Girdle", "=ds=#a3#", "", "25.0%" };
    { 5, 11784, "", "=q3=Arbiter's Blade", "=ds=#w10#", "", "25.0%" };
    { 6, 22241, "", "=q3=Dark Warder's Pauldrons", "=ds=#a2#", "", "25.0%" };
	};

	AtlasLoot_Data["BRDVerek"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Verek"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 2, 22242, "", "=q3=Verek's Leash", "=ds=#a3#", "", "13.0%" };
    { 3, 11755, "", "=q3=Verek's Collar", "=ds=#s2#", "", "12.0%" };
	};

	AtlasLoot_Data["BRDFineousDarkvire"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Fineous Darkvire"].." - Always Drops", "=q5=Always Drops"};
    { 2, 10999, "", "=q1=Ironfel", "=ds=#m3#", "", "100%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Fineous Darkvire"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 5, 11468, "", "=q1=Dark Iron Fanny Pack", "=ds=#m3#", "", "80.0%" };
    { 7, 0, "INV_Box_01", "=q6="..BabbleBoss["Fineous Darkvire"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Lord Incendius"].." - Always Drops", "=q5=Always Drops"};
    { 2, 11126, "", "=q1=Tablet of Kurniya", "=ds=#m3#", "", "100%" };
    { 3, 21987, "", "=q1=Incendicite of Incendius", "=ds=#m3#", "", "100%" };
    { 4, 901714, "", "=q1=Incendiary Core", "=ds=#m3#", "", "100%" };
    { 6, 0, "INV_Box_01", "=q6="..BabbleBoss["Lord Incendius"].." - Chance on Drop", "=q5=Chance on Drop"};
    ...
    { 11, 0, "INV_Box_01", "=q6="..BabbleBoss["Lord Incendius"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 2, 0, "INV_Box_01", "=q6="..BabbleBoss["Bael'Gar"].." - One Random Drop", "=q5=Random Drop"};
    { 3, 11802, "", "=q3=Lavacrest Leggings", "=ds=#a4#", "", "32.0%" };
    { 4, 11803, "", "=q3=Force of Magma", "=ds=#w6#", "", "32.0%" };
    { 5, 11805, "", "=q3=Rubidium Hammer", "=ds=#w6#", "", "18.0%" };
    { 6, 11807, "", "=q3=Sash of the Burning Heart", "=ds=#a1#", "", "18.0%" };
	};

	AtlasLoot_Data["BRDGeneralAngerforge"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["General Angerforge"].." - Always Drops", "=q5=Always Drops"};
    { 2, 11464, "", "=q1=Marshal Windsor's Lost Information", "=ds=#m3#", "", "100%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["General Angerforge"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 5, 11468, "", "=q1=Dark Iron Fanny Pack", "=ds=#m3#", "", "80.0%" };
    { 7, 0, "INV_Box_01", "=q6="..BabbleBoss["General Angerforge"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Golem Lord Argelmach"].." - Always Drops", "=q5=Always Drops"};
    { 2, 11268, "", "=q1=Head of Argelmach", "=ds=#m3#", "", "100%" };
    { 3, 11465, "", "=q1=Marshal Windsor's Lost Information", "=ds=#m3#", "", "100%" };
    { 5, 0, "INV_Box_01", "=q6="..BabbleBoss["Golem Lord Argelmach"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 6, 11468, "", "=q1=Dark Iron Fanny Pack", "=ds=#m3#", "", "80.0%" };
    { 7, 21956, "", "=q2=Design: Dark Iron Scorpid", "=ds=#e2#", "", "60.0%" };
    { 9, 0, "INV_Box_01", "=q6="..BabbleBoss["Golem Lord Argelmach"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Ambassador Flamelash"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 2, 11129, "", "=q1=Essence of the Elements", "=ds=#m3#", "", "80.0%" };
    { 3, 57458, "", "=q2=Technique: Scroll of Fire Resistance IV", "=ds=#e2#", "", "15.0%" };
    { 5, 0, "INV_Box_01", "=q6="..BabbleBoss["Ambassador Flamelash"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Panzor the Invincible"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 2, 11129, "", "=q1=Essence of the Elements", "=ds=#m3#", "", "80.0%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Panzor the Invincible"].." - One Random Drop", "=q5=Random Drop"};
    { 5, 11785, "", "=q3=Rock Golem Bulwark", "=ds=#w8#", "", "25.0%" };
    { 6, 11786, "", "=q3=Stone of the Earth", "=ds=#w10#", "", "25.0%" };
    { 7, 11787, "", "=q3=Shalehusk Boots", "=ds=#a4#", "", "25.0%" };
    { 8, 22245, "", "=q3=Soot Encrusted Footwear", "=ds=#a1#", "", "25.0%" };
	};
    ...
    { 2, 0, "INV_Box_01", "=q6="..BabbleBoss["Magmus"].." - One Random Drop", "=q5=Random Drop"};
    { 3, 11746, "", "=q3=Golem Skull Helm", "=ds=#a4#", "", "20.0%" };
    { 4, 11935, "", "=q3=Magmus Stone", "=ds=#s15#", "", "20.0%" };
    { 5, 22208, "", "=q3=Lavastone Hammer", "=ds=#w6#", "", "20.0%" };
    { 6, 22395, "", "=q3=Totem of Rage", "", "", "20.0%" };
    { 7, 22400, "", "=q3=Libram of Truth", "", "", "20.0%" };
	};

	AtlasLoot_Data["BRDEmperorPrincess"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Emperor Dagran Thaurissan"].." - Always Drops", "=q5=Always Drops"};
    ...
    { 7, 0, "INV_Box_01", "=q6="..BabbleBoss["Emperor Dagran Thaurissan"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 20, 0, "INV_Box_01", "=q6="..BabbleBoss["Princess Moira Bronzebeard"].." - Always Drops", "=q5=Always Drops"};
    { 21, 11468, "", "=q1=Dark Iron Fanny Pack", "=ds=#m3#", "", "100%" };
    { 23, 0, "INV_Box_01", "=q6="..BabbleBoss["Princess Moira Bronzebeard"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Spirestone Butcher"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 2, 21982, "", "=q1=Ogre Warbeads", "=ds=#m3#", "", "80.0%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Spirestone Butcher"].." - One Random Drop", "=q5=Random Drop"};
    { 5, 12608, "", "=q3=Butcher's Apron", "=ds=#a1#", "", "60.0%" };
    { 6, 13286, "", "=q3=Rivenspike", "=ds=#w1#", "", "40.0%" };
	};

	AtlasLoot_Data["LBRSOmokk"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Highlord Omokk"].." - Always Drops", "=q5=Always Drops"};
    { 2, 12336, "", "=q2=Gemstone of Spirestone", "=ds=#m3#", "", "100%" };
    { 3, 12534, "", "=q1=Omokk's Head", "=ds=#m3#", "", "100%" };
    { 5, 0, "INV_Box_01", "=q6="..BabbleBoss["Highlord Omokk"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 6, 21982, "", "=q1=Ogre Warbeads", "=ds=#m3#", "", "80.0%" };
    { 8, 0, "INV_Box_01", "=q6="..BabbleBoss["Highlord Omokk"].." - One Random Drop", "=q5=Random Drop"};
    { 9, 13166, "", "=q3=Slamshot Shoulders", "=ds=#a4#", "", "16.7%" };
    { 10, 13167, "", "=q3=Fist of Omokk", "=ds=#w6#", "", "16.7%" };
    { 11, 13168, "", "=q3=Plate of the Shaman King", "=ds=#a4#", "", "16.7%" };
    { 12, 13169, "", "=q3=Tressermane Leggings", "=ds=#a2#", "", "16.7%" };
    { 13, 13170, "", "=q3=Skyshroud Leggings", "=ds=#a1#", "", "16.7%" };
    { 14, 16670, "", "=q3=Boots of Elements", "=ds=#a3#", "", "16.7%" };
	};

	AtlasLoot_Data["LBRSSpirestoneLord"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Spirestone Battle Lord"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 2, 21982, "", "=q1=Ogre Warbeads", "=ds=#m3#", "", "80.0%" };
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Shadow Hunter Vosh'gajin"].." - Always Drops", "=q5=Always Drops"};
    { 2, 13352, "", "=q1=Vosh'gajin's Snakestone", "=ds=#m3#", "", "100%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Shadow Hunter Vosh'gajin"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 5, 12654, "", "=q3=Doomshot", "=ds=#e6#", "", "30.0%" };
    { 7, 0, "INV_Box_01", "=q6="..BabbleBoss["Shadow Hunter Vosh'gajin"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["War Master Voone"].." - Always Drops", "=q5=Always Drops"};
    { 2, 12335, "", "=q2=Gemstone of Smolderthorn", "=ds=#m3#", "", "100%" };
    { 3, 28972, "", "=q3=Flightblade Throwing Axe", "=ds=#w11#", "", "100%" };
    { 5, 0, "INV_Box_01", "=q6="..BabbleBoss["War Master Voone"].." - One Random Drop", "=q5=Random Drop"};
    { 6, 12582, "", "=q3=Keris of Zul'Serak", "=ds=#w4#", "", "20.0%" };
    { 7, 13177, "", "=q3=Talisman of Evasion", "=ds=#s2#", "", "20.0%" };
    { 8, 13179, "", "=q3=Brazecore Armguards", "=ds=#a3#", "", "20.0%" };
    { 9, 16676, "", "=q3=Beaststalker's Gloves", "=ds=#a3#", "", "20.0%" };
    { 10, 22231, "", "=q3=Kayser's Boots of Precision", "=ds=#a1#", "", "20.0%" };
	};

	AtlasLoot_Data["LBRSGrayhoof"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Mor Grayhoof"].." - Always Drops", "=q5=Always Drops"};
    { 2, 21984, "", "=q1=Left Piece of Lord Valthalak's Amulet", "=ds=#m3#", "", "100%" };
    { 3, 22046, "", "=q1=Right Piece of Lord Valthalak's Amulet", "=ds=#m3#", "", "100%" };
    { 5, 0, "INV_Box_01", "=q6="..BabbleBoss["Mor Grayhoof"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Bannok Grimaxe"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 2, 22138, "", "=q1=Blackrock Bracer", "=ds=#m3#", "", "80.0%" };
    { 3, 12838, "", "=q3=Plans: Arcanite Reaper", "=ds=#e2#", "", "7.00%" };
    { 5, 0, "INV_Box_01", "=q6="..BabbleBoss["Bannok Grimaxe"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 2, 0, "INV_Box_01", "=q6="..BabbleBoss["Mother Smolderweb"].." - One Random Drop", "=q5=Random Drop"};
    { 3, 13213, "", "=q3=Smolderweb's Eye", "=ds=#s14#", "", "35.0%" };
    { 4, 13244, "", "=q3=Gilded Gauntlets", "=ds=#a3#", "", "35.0%" };
    { 5, 13183, "", "=q3=Venomspitter", "=ds=#w6#", "", "15.0%" };
    { 6, 16715, "", "=q3=Wildheart Boots", "=ds=#a2#", "", "15.0%" };
	};

	AtlasLoot_Data["LBRSCrystalFang"] = {
    { 2, 0, "INV_Box_01", "=q6="..BabbleBoss["Crystal Fang"].." - One Random Drop", "=q5=Random Drop"};
    { 3, 13184, "", "=q3=Fallbrush Handgrips", "=ds=#a2#", "", "43.0%" };
    { 4, 13185, "", "=q3=Sunderseer Mantle", "=ds=#a1#", "", "43.0%" };
    { 5, 13218, "", "=q3=Fang of the Crystal Spider", "=ds=#w4#", "", "14.0%" };
	};

	AtlasLoot_Data["LBRSDoomhowl"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Urok Doomhowl"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 2, 21982, "", "=q1=Ogre Warbeads", "=ds=#m3#", "", "80.0%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Urok Doomhowl"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Quartermaster Zigris"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 2, 22138, "", "=q1=Blackrock Bracer", "=ds=#m3#", "", "80.0%" };
    ...
    { 2, 0, "INV_Box_01", "=q6="..BabbleBoss["Gizrul the Slavener"].." - One Random Drop", "=q5=Random Drop"};
    { 3, 13205, "", "=q3=Rhombeard Protector", "=ds=#w8#", "", "28.3%" };
    { 4, 13206, "", "=q3=Wolfshear Leggings", "=ds=#a1#", "", "28.3%" };
    { 5, 13208, "", "=q3=Bleak Howler Armguards", "=ds=#a2#", "", "28.3%" };
    { 6, 16718, "", "=q3=Wildheart Spaulders", "=ds=#a2#", "", "15.0%" };
	};

	AtlasLoot_Data["LBRSHalycon"] = {
    { 2, 0, "INV_Box_01", "=q6="..BabbleBoss["Halycon"].." - One Random Drop", "=q5=Random Drop"};
    { 3, 13211, "", "=q3=Slashclaw Bracers", "=ds=#a3#", "", "28.7%" };
    { 4, 13212, "", "=q3=Halycon's Spiked Collar", "=ds=#s2#", "", "28.7%" };
    { 5, 22313, "", "=q3=Ironweave Bracers", "=ds=#a1#", "", "28.7%" };
    { 6, 13210, "", "=q3=Pads of the Dread Wolf", "=ds=#a2#", "", "14.0%" };
	};

	AtlasLoot_Data["LBRSBashguud"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Ghok Bashguud"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 2, 22138, "", "=q1=Blackrock Bracer", "=ds=#m3#", "", "80.0%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Ghok Bashguud"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Overlord Wyrmthalak"].." - Always Drops", "=q5=Always Drops"};
    ...
    { 6, 0, "INV_Box_01", "=q6="..BabbleBoss["Overlord Wyrmthalak"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 7, 16786, "", "=q1=Black Dragonspawn Eye", "=ds=#m3#", "", "80.0%" };
    { 8, 13143, "", "=q4=Mark of the Dragon Lord", "=ds=#s13#", "", "2.00%" };
    { 10, 0, "INV_Box_01", "=q6="..BabbleBoss["Overlord Wyrmthalak"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Burning Felguard"].." - Chance on Drop", "=q5=Chance on Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Pyroguard Emberseer"].." - Always Drops", "=q5=Always Drops"};
    { 2, 17322, "", "=q1=Eye of the Emberseer", "=ds=#m3#", "", "100%" };
    { 3, 21988, "", "=q1=Ember of Emberseer", "=ds=#m3#", "", "100%" };
    { 5, 0, "INV_Box_01", "=q6="..BabbleBoss["Pyroguard Emberseer"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 6, 23320, "", "=q3=Tablet of Flame Shock VI", "=ds=#e2#", "", "8.00%" };
    { 8, 0, "INV_Box_01", "=q6="..BabbleBoss["Pyroguard Emberseer"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Solakar Flamewreath"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 2, 16786, "", "=q1=Black Dragonspawn Eye", "=ds=#m3#", "", "80.0%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Solakar Flamewreath"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Jed Runewatcher"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 2, 22138, "", "=q1=Blackrock Bracer", "=ds=#m3#", "", "80.0%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Jed Runewatcher"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Goraluk Anvilcrack"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 2, 22138, "", "=q1=Blackrock Bracer", "=ds=#m3#", "", "80.0%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Goraluk Anvilcrack"].." - One Random Drop", "=q5=Random Drop"};
    { 5, 13498, "", "=q3=Handcrafted Mastersmith Leggings", "=ds=#a4#", "", "22.0%" };
    { 6, 13502, "", "=q3=Handcrafted Mastersmith Girdle", "=ds=#a4#", "", "22.0%" };
    { 7, 18047, "", "=q3=Flame Walkers", "=ds=#a3#", "", "22.0%" };
    { 8, 18048, "", "=q3=Mastersmith's Hammer", "=ds=#w6#", "", "22.0%" };
    { 9, 12834, "", "=q3=Plans: Arcanite Champion", "=ds=#e2#", "", "5.00%" };
    { 10, 12837, "", "=q3=Plans: Masterwork Stormhammer", "=ds=#e2#", "", "5.00%" };
    { 11, 12728, "", "=q4=Plans: Invulnerable Mail", "=ds=#e2#", "", "2.00%" };
	};

	AtlasLoot_Data["UBRSRendGyth"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Gyth"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 2, 12871, "", "=q4=Chromatic Carapace", "=ds=#e10#", "", "4.00%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Gyth"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 11, 0, "INV_Box_01", "=q6="..BabbleBoss["Warchief Rend Blackhand"].." - Always Drops", "=q5=Always Drops"};
    { 12, 12630, "", "=q1=Head of Rend Blackhand", "=ds=#m3#", "", "100%" };
    { 14, 0, "INV_Box_01", "=q6="..BabbleBoss["Warchief Rend Blackhand"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 15, 22138, "", "=q1=Blackrock Bracer", "=ds=#m3#", "", "80.0%" };
    { 16, 0, "INV_Box_01", "=q6="..BabbleBoss["Warchief Rend Blackhand"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["The Beast"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 2, 24101, "", "=q3=Book of Ferocious Bite V", "=ds=#e2#", "", "13.0%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["The Beast"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 6, 0, "INV_Box_01", "=q6="..BabbleBoss["General Drakkisath"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 7, 15730, "", "=q3=Pattern: Red Dragonscale Breastplate", "=ds=#e2#", "", "4.00%" };
    { 16, 0, "INV_Box_01", "=q6="..BabbleBoss["General Drakkisath"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Lucifron"].." - Always Drops", "=q5=Always Drops"};
    ...
    { 7, 0, "INV_Box_01", "=q6="..BabbleBoss["Lucifron"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 8, 7078, "", "=q2=Essence of Fire", "=ds=#e7#", "", "40.0%" };
	};

	AtlasLoot_Data["MCMagmadar"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Magmadar"].." - Always Drops", "=q5=Always Drops"};
    { 2, 59304, "", "=q4=Flamewaker Armor Cache - Legs", "=ds=#e10#", "", "100%" };
    { 16, 0, "INV_Box_01", "=q6="..BabbleBoss["Magmadar"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Gehennas"].." - Always Drops", "=q5=Always Drops"};
    ...
    { 6, 0, "INV_Box_01", "=q6="..BabbleBoss["Gehennas"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 7, 7078, "", "=q2=Essence of Fire", "=ds=#e7#", "", "40.0%" };
	};

	AtlasLoot_Data["MCGarr"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Garr"].." - Always Drops", "=q5=Always Drops"};
    { 2, 59300, "", "=q4=Flamewaker Armor Cache - Helm", "=ds=#e10#", "", "100%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Garr"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 5, 7076, "", "=q2=Essence of Earth", "=ds=#e7#", "", "40.0%" };
    { 6, 17011, "", "=q3=Lava Core", "=ds=#e7#", "", "14.0%" };
    { 7, 18564, "", "=q5=Bindings of the Windseeker", "=ds=#e10#", "", "3.00%" };
    { 16, 0, "INV_Box_01", "=q6="..BabbleBoss["Garr"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Shazzrah"].." - Always Drops", "=q5=Always Drops"};
    { 2, 59303, "", "=q4=Flamewaker Armor Cache - Gloves", "=ds=#e10#", "", "100%" };
    { 3, 59305, "", "=q4=Flamewaker Armor Cache - Boots", "=ds=#e10#", "", "100%" };
    { 4, 57100, "", "=q4=Formula: Mystic Resonator", "=ds=#e2#", "", "100%" };
    { 6, 0, "INV_Box_01", "=q6="..BabbleBoss["Shazzrah"].." - One Random Drop", "=q5=Random Drop"};
    { 7, 17077, "", "=q4=Crimson Shocker", "=ds=#w12#", "", "10.0%" };
    { 8, 18861, "", "=q4=Flamewaker Legplates", "=ds=#a4#", "", "10.0%" };
    { 9, 18870, "", "=q4=Helm of the Lifegiver", "=ds=#a3#", "", "10.0%" };
    { 10, 18872, "", "=q4=Manastorm Leggings", "=ds=#a1#", "", "10.0%" };
    { 11, 18875, "", "=q4=Salamander Scale Pants", "=ds=#a2#", "", "10.0%" };
    { 12, 18878, "", "=q4=Sorcerous Dagger", "=ds=#w4#", "", "10.0%" };
    { 13, 18879, "", "=q4=Heavy Dark Iron Ring", "=ds=#s13#", "", "10.0%" };
    { 14, 19145, "", "=q4=Robe of Volatile Power", "=ds=#a1#", "", "10.0%" };
    { 15, 19146, "", "=q4=Wristguards of Stability", "=ds=#a2#", "", "10.0%" };
    { 16, 19147, "", "=q4=Ring of Spell Power", "=ds=#s13#", "", "10.0%" };
	};

	AtlasLoot_Data["MCGeddon"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Baron Geddon"].." - Always Drops", "=q5=Always Drops"};
    { 2, 59301, "", "=q4=Flamewaker Armor Cache - Shoulder", "=ds=#e10#", "", "100%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Baron Geddon"].." - Chance on Drop", "=q5=Chance on Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Golemagg the Incinerator"].." - Always Drops", "=q5=Always Drops"};
    { 2, 59302, "", "=q4=Flamewaker Armor Cache - Chest", "=ds=#e10#", "", "100%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Golemagg the Incinerator"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 5, 7076, "", "=q2=Essence of Earth", "=ds=#e7#", "", "40.0%" };
    { 6, 7078, "", "=q2=Essence of Fire", "=ds=#e7#", "", "40.0%" };
    { 7, 17203, "", "=q4=Sulfuron Ingot", "=ds=#e7#", "", "20.0%" };
    { 8, 17011, "", "=q3=Lava Core", "=ds=#e7#", "", "14.0%" };
    { 16, 0, "INV_Box_01", "=q6="..BabbleBoss["Golemagg the Incinerator"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Sulfuron Harbinger"].." - Always Drops", "=q5=Always Drops"};
    ...
    { 6, 0, "INV_Box_01", "=q6="..BabbleBoss["Sulfuron Harbinger"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 7, 7078, "", "=q2=Essence of Fire", "=ds=#e7#", "", "40.0%" };
	};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Ragnaros"].." - Always Drops", "=q5=Always Drops"};
    { 2, 19017, "", "=q5=Essence of the Firelord", "=ds=#m3#", "", "100%" };
    { 3, 59310, "", "=q4=Firelord's Armor Cache - Legs", "=ds=#e10#", "", "100%" };
    { 5, 0, "INV_Box_01", "=q6="..BabbleBoss["Ragnaros"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 6, 7078, "", "=q2=Essence of Fire", "=ds=#e7#", "", "40.0%" };
    ...
    { 16, 0, "INV_Box_01", "=q6="..BabbleBoss["Ragnaros"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 23, 0, "INV_Box_01", "=q6="..BabbleBoss["Ragnaros"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Razorgore the Untamed"].." - Always Drops", "=q5=Always Drops"};
    { 2, 59312, "", "=q4=Blackwing Armor Cache - Bracers", "=ds=#e10#", "", "100%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Razorgore the Untamed"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Vaelastrasz the Corrupt"].." - Always Drops", "=q5=Always Drops"};
    { 2, 59309, "", "=q4=Blackwing Armor Cache - Belt", "=ds=#e10#", "", "100%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Vaelastrasz the Corrupt"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Broodlord Lashlayer"].." - Always Drops", "=q5=Always Drops"};
    { 2, 20383, "", "=q4=Head of the Broodlord Lashlayer", "=ds=#m3#", "", "100%" };
    { 3, 59311, "", "=q4=Blackwing Armor Cache - Boots", "=ds=#e10#", "", "100%" };
    { 5, 0, "INV_Box_01", "=q6="..BabbleBoss["Broodlord Lashlayer"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 6, 100002, "", "=q3=Tome: Greater Blessing of Kings", "=ds=#e2#", "", "12.0%" };
    { 8, 0, "INV_Box_01", "=q6="..BabbleBoss["Broodlord Lashlayer"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Firemaw"].." - Always Drops", "=q5=Always Drops"};
    { 2, 59313, "", "=q4=Blackwing Armor Cache - Gloves", "=ds=#e10#", "", "100%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Firemaw"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 16, 0, "INV_Box_01", "=q6="..BabbleBoss["Firemaw"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Ebonroc"].." - Always Drops", "=q5=Always Drops"};
    { 2, 59313, "", "=q4=Blackwing Armor Cache - Gloves", "=ds=#e10#", "", "100%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Ebonroc"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 12, 0, "INV_Box_01", "=q6="..BabbleBoss["Ebonroc"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Flamegor"].." - Always Drops", "=q5=Always Drops"};
    { 2, 59313, "", "=q4=Blackwing Armor Cache - Gloves", "=ds=#e10#", "", "100%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Flamegor"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 12, 0, "INV_Box_01", "=q6="..BabbleBoss["Flamegor"].." - One Random Drop", "=q5=Random Drop"};
    { 13, 57001, "", "=q4=Plans: Elementium Aegis", "=ds=#e2#", "", "33.3%" };
    { 14, 57204, "", "=q4=Schematic: Elementium Targeting Matrix", "=ds=#e2#", "", "33.3%" };
    { 15, 57500, "", "=q4=Design: Elementium Talisman", "=ds=#e2#", "", "33.3%" };
	};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Chromaggus"].." - Always Drops", "=q5=Always Drops"};
    { 2, 59307, "", "=q4=Blackwing Armor Cache - Shoulder", "=ds=#e10#", "", "100%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Chromaggus"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 16, 0, "INV_Box_01", "=q6="..BabbleBoss["Chromaggus"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Nefarian"].." - Always Drops", "=q5=Always Drops"};
    ...
    { 8, 0, "INV_Box_01", "=q6="..BabbleBoss["Nefarian"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 9, 100002, "", "=q3=Tome: Greater Blessing of Kings", "=ds=#e2#", "", "15.0%" };
    { 16, 0, "INV_Box_01", "=q6="..BabbleBoss["Nefarian"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 24, 0, "INV_Box_01", "=q6="..BabbleBoss["Nefarian"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Pusillin"].." - Always Drops", "=q5=Always Drops"};
    ...
    { 2, 0, "INV_Box_01", "=q6="..BabbleBoss["Zevrim Thornhoof"].." - One Random Drop", "=q5=Random Drop"};
    { 3, 18306, "", "=q2=Gloves of Shadowy Mist", "=ds=#a1#", "", "26.0%" };
    { 4, 18308, "", "=q2=Clever Hat", "=ds=#a2#", "", "26.0%" };
    { 5, 18313, "", "=q3=Helm of Awareness", "=ds=#a4#", "", "20.0%" };
    { 6, 18323, "", "=q3=Satyr's Bow", "=ds=#w2#", "", "20.0%" };
    { 7, 18319, "", "=q3=Fervent Helm", "=ds=#a3#", "", "8.00%" };
	};

	AtlasLoot_Data["DMELethtendris"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Lethtendris"].." - Always Drops", "=q5=Always Drops"};
    { 2, 18426, "", "=q1=Lethtendris's Web", "=ds=#m3#", "", "100%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Lethtendris"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Pimgib"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 2, 18354, "", "=q3=Pimgib's Collar", "=ds=#s14#", "", "14.0%" };
	};

	AtlasLoot_Data["DMEHydro"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Hydrospawn"].." - Always Drops", "=q5=Always Drops"};
    { 2, 18299, "", "=q1=Hydrospawn Essence", "=ds=#m3#", "", "100%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Hydrospawn"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 5, 22527, "", "=q1=Core of Elements", "=ds=#m3#", "", "63.0%" };
    { 6, 7080, "", "=q2=Essence of Water", "=ds=#e7#", "", "11.0%" };
    { 8, 0, "INV_Box_01", "=q6="..BabbleBoss["Hydrospawn"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Alzzin the Wildshaper"].." - Always Drops", "=q5=Always Drops"};
    { 2, 901716, "", "=q1=Scepter of Sylvan Corruption", "=ds=#m3#", "", "100%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Alzzin the Wildshaper"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 8, 18314, "", "=q3=Ring of Demonic Guile", "=ds=#s13#", "", "10.0%" };
    { 9, 18315, "", "=q3=Ring of Demonic Potency", "=ds=#s13#", "", "10.0%" };
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Isalien"].." - Always Drops", "=q5=Always Drops"};
    { 2, 21984, "", "=q1=Left Piece of Lord Valthalak's Amulet", "=ds=#m3#", "", "100%" };
    { 3, 22046, "", "=q1=Right Piece of Lord Valthalak's Amulet", "=ds=#m3#", "", "100%" };
    { 5, 0, "INV_Box_01", "=q6="..BabbleBoss["Isalien"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Guard Mol'dar"].." - Chance on Drop", "=q5=Chance on Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Stomper Kreeg"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 2, 18425, "", "=q2=Kreeg's Mug", "=ds=#s15#", "", "40.0%" };
	};

	AtlasLoot_Data["DMNGuardFengus"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Guard Fengus"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 2, 18250, "", "=q2=Gordok Shackle Key", "=ds=#e10#", "", "13.0%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Guard Fengus"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Guard Slip'kik"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 2, 18250, "", "=q2=Gordok Shackle Key", "=ds=#e10#", "", "13.0%" };
    { 3, 18493, "", "=q3=Bulky Iron Spaulders", "=ds=#a4#", "", "7.69%" };
    { 4, 18494, "", "=q3=Denwatcher's Shoulders", "=ds=#a3#", "", "7.69%" };
    { 5, 18496, "", "=q3=Heliotrope Cloak", "=ds=#a1#", "", "7.69%" };
    { 6, 18497, "", "=q3=Sublime Wristguards", "=ds=#a1#", "", "7.69%" };
    { 7, 18498, "", "=q3=Hedgecutter", "=ds=#w1#", "", "7.69%" };
    { 9, 0, "INV_Box_01", "=q6="..BabbleBoss["Guard Slip'kik"].." - One Random Drop", "=q5=Random Drop"};
    { 10, 18332, "", "=q2=Libram of Rapidity", "=ds=#e2#", "", "50.0%" };
    { 11, 18333, "", "=q2=Libram of Focus", "=ds=#e2#", "", "50.0%" };
	};

	AtlasLoot_Data["DMNCaptainKromcrush"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Captain Kromcrush"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 2, 18250, "", "=q2=Gordok Shackle Key", "=ds=#e10#", "", "13.0%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Captain Kromcrush"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 2, 0, "INV_Box_01", "=q6="..BabbleBoss["Cho'Rush the Observer"].." - One Random Drop", "=q5=Random Drop"};
    { 3, 18483, "", "=q3=Mana Channeling Wand", "=ds=#w12#", "", "25.0%" };
    { 4, 18484, "", "=q3=Cho'Rush's Blade", "=ds=#w10#", "", "25.0%" };
    { 5, 18485, "", "=q3=Observer's Shield", "=ds=#w8#", "", "25.0%" };
    { 6, 18490, "", "=q3=Insightful Hood", "=ds=#a2#", "", "25.0%" };
	};

	AtlasLoot_Data["DMNKingGordok"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["King Gordok"].." - Always Drops", "=q5=Always Drops"};
    { 2, 901718, "", "=q1=Gordok's Skull Goblet", "=ds=#m3#", "", "100%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["King Gordok"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 5, 21982, "", "=q1=Ogre Warbeads", "=ds=#m3#", "", "80.0%" };
    { 6, 57101, "", "=q4=Formula: Nexus Shard", "=ds=#e2#", "", "10.0%" };
    { 8, 0, "INV_Box_01", "=q6="..BabbleBoss["King Gordok"].." - One Random Drop", "=q5=Random Drop"};
    { 9, 18520, "", "=q3=Barbarous Blade", "=ds=#w10#", "", "12.5%" };
    { 10, 18521, "", "=q3=Grimy Metal Boots", "=ds=#a4#", "", "12.5%" };
    { 11, 18522, "", "=q3=Band of the Ogre King", "=ds=#s13#", "", "12.5%" };
    { 12, 18523, "", "=q3=Brightly Glowing Stone", "=ds=#s15#", "", "12.5%" };
    { 13, 18524, "", "=q3=Leggings of Destruction", "=ds=#a3#", "", "12.5%" };
    ...
    { 2, 0, "INV_Box_01", "=q6="..BabbleBoss["Tendris Warpwood"].." - One Random Drop", "=q5=Random Drop"};
    { 3, 18352, "", "=q2=Petrified Bark Shield", "=ds=#w8#", "", "25.0%" };
    { 4, 18353, "", "=q2=Stoneflower Staff", "=ds=#w9#", "", "25.0%" };
    { 5, 18390, "", "=q3=Tanglemoss Leggings", "=ds=#a2#", "", "25.0%" };
    { 6, 18393, "", "=q3=Warpwood Binding", "=ds=#a3#", "", "25.0%" };
	};

	AtlasLoot_Data["DMWIllyannaRavenoak"] = {
    { 2, 0, "INV_Box_01", "=q6="..BabbleBoss["Illyanna Ravenoak"].." - One Random Drop", "=q5=Random Drop"};
    { 3, 18347, "", "=q2=Well Balanced Axe", "=ds=#w1#", "", "25.0%" };
    { 4, 18349, "", "=q2=Gauntlets of Accuracy", "=ds=#a3#", "", "25.0%" };
    { 5, 18383, "", "=q3=Force Imbued Gauntlets", "=ds=#a4#", "", "25.0%" };
    { 6, 18386, "", "=q3=Padre's Trousers", "=ds=#a1#", "", "25.0%" };
	};

	AtlasLoot_Data["DMWMagisterKalendris"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Magister Kalendris"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 2, 22309, "", "=q2=Pattern: Big Bag of Enchantment", "=ds=#e2#", "", "15.0%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Magister Kalendris"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 2, 0, "INV_Box_01", "=q6="..BabbleBoss["Tsu'zee"].." - One Random Drop", "=q5=Random Drop"};
    { 3, 18345, "", "=q2=Murmuring Ring", "=ds=#s13#", "", "33.3%" };
    { 4, 18346, "", "=q2=Threadbare Trousers", "=ds=#a1#", "", "33.3%" };
    { 5, 18387, "", "=q3=Brightspark Gloves", "=ds=#a1#", "", "33.3%" };
	};

	AtlasLoot_Data["DMWImmolthar"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Immol'thar"].." - Always Drops", "=q5=Always Drops"};
    { 2, 901717, "", "=q1=Immol'thar's Fel Essence", "=ds=#m3#", "", "100%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Immol'thar"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 5, 24345, "", "=q3=Book of Cower IV", "=ds=#e2#", "", "13.0%" };
    { 16, 0, "INV_Box_01", "=q6="..BabbleBoss["Immol'thar"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 2, 0, "INV_Box_01", "=q6="..BabbleBoss["Lord Hel'nurath"].." - One Random Drop", "=q5=Random Drop"};
    { 3, 18754, "", "=q3=Fel Hardened Bracers", "=ds=#a4#", "", "25.0%" };
    { 4, 18755, "", "=q3=Xorothian Firestick", "=ds=#w5#", "", "25.0%" };
    { 5, 18756, "", "=q3=Dreadguard's Protector", "=ds=#w8#", "", "25.0%" };
    { 6, 18757, "", "=q3=Diabolic Mantle", "=ds=#a1#", "", "25.0%" };
	};

	AtlasLoot_Data["DMWPrinceTortheldrin"] = {
    { 2, 0, "INV_Box_01", "=q6="..BabbleBoss["Prince Tortheldrin"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 11, 18395, "", "=q3=Emerald Flame Ring", "=ds=#s13#", "", "10.0%" };
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Techbot"].." - Always Drops", "=q5=Always Drops"};
    { 2, 9277, "", "=q1=Techbot's Memory Core", "=ds=#m3#", "", "100%" };
    { 3, 9309, "", "=q1=Robo-mechanical Guts", "=ds=#m3#", "", "100%" };
    { 5, 0, "INV_Box_01", "=q6="..BabbleBoss["Techbot"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 6, 9444, "", "=q2=Techbot CPU Shell", "=ds=#w8#", "", "69.2%" };
	};

	AtlasLoot_Data["GnomeGrubbis"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Grubbis"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 2, 9445, "", "=q3=Grubbis Paws", "=ds=#a3#", "", "10.0%" };
	};

	AtlasLoot_Data["GnomeViscousFallout"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Viscous Fallout"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 2, 57457, "", "=q2=Technique: Scroll of Fire Resistance III", "=ds=#e2#", "", "15.0%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Viscous Fallout"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 2, 0, "INV_Box_01", "=q6="..BabbleBoss["Electrocutioner 6000"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Crowd Pummeler 9-60"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 2, 11827, "", "=q2=Schematic: Lil' Smoky", "=ds=#e2#", "", "50.0%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Crowd Pummeler 9-60"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 2, 0, "INV_Box_01", "=q6="..BabbleBoss["Dark Iron Ambassador"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Mekgineer Thermaplugg"].." - Always Drops", "=q5=Always Drops"};
    { 2, 901708, "", "=q1=Plugg Nuts", "=ds=#m3#", "", "100%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Mekgineer Thermaplugg"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 5, 11828, "", "=q2=Schematic: Pet Bombling", "=ds=#e2#", "", "90.0%" };
    { 7, 0, "INV_Box_01", "=q6="..BabbleBoss["Mekgineer Thermaplugg"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Noxxion"].." - Always Drops", "=q5=Always Drops"};
    { 2, 17702, "", "=q1=Celebrian Rod", "=ds=#m3#", "", "100%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Noxxion"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 5, 17684, "", "=q1=Theradric Crystal Carving", "=ds=#m3#", "", "80.0%" };
    { 7, 0, "INV_Box_01", "=q6="..BabbleBoss["Noxxion"].." - One Random Drop", "=q5=Random Drop"};
    { 8, 17744, "", "=q3=Heart of Noxxion", "=ds=#s14#", "", "40.0%" };
    { 9, 17746, "", "=q3=Noxxion's Shackles", "=ds=#a4#", "", "40.0%" };
    { 10, 17745, "", "=q3=Noxious Shooter", "=ds=#w12#", "", "20.0%" };
	};

	AtlasLoot_Data["MaraRazorlash"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Razorlash"].." - Always Drops", "=q5=Always Drops"};
    { 2, 901700, "", "=q1=Razor Petal", "=ds=#m3#", "", "100%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Razorlash"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 5, 17684, "", "=q1=Theradric Crystal Carving", "=ds=#m3#", "", "80.0%" };
    { 6, 22529, "", "=q1=Savage Frond", "=ds=#m3#", "", "54.0%" };
    { 8, 0, "INV_Box_01", "=q6="..BabbleBoss["Razorlash"].." - One Random Drop", "=q5=Random Drop"};
    { 9, 17748, "", "=q3=Vinerot Sandals", "=ds=#a1#", "", "25.0%" };
    { 10, 17749, "", "=q3=Phytoskin Spaulders", "=ds=#a2#", "", "25.0%" };
    { 11, 17750, "", "=q2=Chloromesh Girdle", "=ds=#a1#", "", "25.0%" };
    { 12, 17751, "", "=q2=Brusslehide Leggings", "=ds=#a2#", "", "25.0%" };
	};

	AtlasLoot_Data["MaraVyletongue"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Lord Vyletongue"].." - Always Drops", "=q5=Always Drops"};
    { 2, 17703, "", "=q1=Celebrian Diamond", "=ds=#m3#", "", "100%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Lord Vyletongue"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 5, 17684, "", "=q1=Theradric Crystal Carving", "=ds=#m3#", "", "80.0%" };
    { 7, 0, "INV_Box_01", "=q6="..BabbleBoss["Lord Vyletongue"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Meshlok the Harvester"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 2, 17684, "", "=q1=Theradric Crystal Carving", "=ds=#m3#", "", "80.0%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Meshlok the Harvester"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Celebras the Cursed"].." - Always Drops", "=q5=Always Drops"};
    { 2, 901701, "", "=q1=Carved Horn of Remulos", "=ds=#m3#", "", "100%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Celebras the Cursed"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 5, 17684, "", "=q1=Theradric Crystal Carving", "=ds=#m3#", "", "80.0%" };
    { 6, 57478, "", "=q2=Technique: Scroll of Nature Resistance IV", "=ds=#e2#", "", "15.0%" };
    { 8, 0, "INV_Box_01", "=q6="..BabbleBoss["Celebras the Cursed"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Landslide"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 2, 17684, "", "=q1=Theradric Crystal Carving", "=ds=#m3#", "", "80.0%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Landslide"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Tinkerer Gizlock"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 2, 17684, "", "=q1=Theradric Crystal Carving", "=ds=#m3#", "", "80.0%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Tinkerer Gizlock"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Rotgrip"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 2, 17684, "", "=q1=Theradric Crystal Carving", "=ds=#m3#", "", "80.0%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Rotgrip"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Princess Theradras"].." - Always Drops", "=q5=Always Drops"};
    { 2, 901746, "", "=q1=Face of Theradras", "=ds=#m3#", "", "100%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Princess Theradras"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 5, 17684, "", "=q1=Theradric Crystal Carving", "=ds=#m3#", "", "80.0%" };
    { 6, 57478, "", "=q2=Technique: Scroll of Nature Resistance IV", "=ds=#e2#", "", "15.0%" };
    { 8, 0, "INV_Box_01", "=q6="..BabbleBoss["Princess Theradras"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Taragaman the Hungerer"].." - Always Drops", "=q5=Always Drops"};
    { 2, 14540, "", "=q1=Taragaman the Hungerer's Heart", "=ds=#m3#", "", "100%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Taragaman the Hungerer"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 5, 57456, "", "=q2=Technique: Scroll of Fire Resistance II", "=ds=#e2#", "", "15.0%" };
    { 7, 0, "INV_Box_01", "=q6="..BabbleBoss["Taragaman the Hungerer"].." - One Random Drop", "=q5=Random Drop"};
    { 8, 14148, "", "=q2=Crystalline Cuffs", "=ds=#a1#", "", "40.0%" };
    { 9, 14149, "", "=q2=Subterranean Cape", "=ds=#a1#", "", "40.0%" };
    { 10, 14145, "", "=q2=Cursed Felblade", "=ds=#w10#", "", "20.0%" };
	};

	AtlasLoot_Data["RFCJergosh"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Jergosh the Invoker"].." - Always Drops", "=q5=Always Drops"};
    { 2, 901707, "", "=q1=Searing Stone", "=ds=#m3#", "", "100%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Jergosh the Invoker"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 5, 57456, "", "=q2=Technique: Scroll of Fire Resistance II", "=ds=#e2#", "", "15.0%" };
    { 7, 0, "INV_Box_01", "=q6="..BabbleBoss["Jergosh the Invoker"].." - One Random Drop", "=q5=Random Drop"};
    { 8, 14147, "", "=q2=Cavedweller Bracers", "=ds=#a3#", "", "40.0%" };
    { 9, 14150, "", "=q2=Robe of Evocation", "=ds=#a1#", "", "40.0%" };
    { 10, 14151, "", "=q2=Chanting Blade", "=ds=#w4#", "", "20.0%" };
	};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Tuten'kash"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 2, 57472, "", "=q2=Technique: Scroll of Shadow Resistance III", "=ds=#e2#", "", "15.0%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Tuten'kash"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Mordresh Fire Eye"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 2, 57472, "", "=q2=Technique: Scroll of Shadow Resistance III", "=ds=#e2#", "", "15.0%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Mordresh Fire Eye"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 2, 0, "INV_Box_01", "=q6="..BabbleBoss["Glutton"].." - One Random Drop", "=q5=Random Drop"};
    { 3, 10772, "", "=q2=Glutton's Cleaver", "=ds=#w1#", "", "50.0%" };
    { 4, 10774, "", "=q3=Fleshhide Shoulders", "=ds=#a2#", "", "50.0%" };
	};

	AtlasLoot_Data["RFDRagglesnout"] = {
    { 2, 0, "INV_Box_01", "=q6="..BabbleBoss["Ragglesnout"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Amnennar the Coldbringer"].." - Always Drops", "=q5=Always Drops"};
    { 2, 10420, "", "=q1=Skull of the Coldbringer", "=ds=#m3#", "", "100%" };
    { 3, 901705, "", "=q1=Frozen Bone", "=ds=#m3#", "", "100%" };
    { 5, 0, "INV_Box_01", "=q6="..BabbleBoss["Amnennar the Coldbringer"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 6, 57462, "", "=q2=Technique: Scroll of Frost Resistance III", "=ds=#e2#", "", "20.0%" };
    { 8, 0, "INV_Box_01", "=q6="..BabbleBoss["Amnennar the Coldbringer"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 2, 0, "INV_Box_01", "=q6="..BabbleBoss["Plaguemaw the Rotting"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 2, 0, "INV_Box_01", "=q6="..BabbleBoss["Death Speaker Jargba"].." - One Random Drop", "=q5=Random Drop"};
    { 3, 6682, "", "=q2=Death Speaker Robes", "=ds=#a1#", "", "40.0%" };
    { 4, 6685, "", "=q2=Death Speaker Mantle", "=ds=#a1#", "", "40.0%" };
    { 5, 2816, "", "=q3=Death Speaker Scepter", "=ds=#w6#", "", "20.0%" };
	};

	AtlasLoot_Data["RFKRamtusk"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Overlord Ramtusk"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 2, 57477, "", "=q2=Technique: Scroll of Nature Resistance III", "=ds=#e2#", "", "15.0%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Overlord Ramtusk"].." - One Random Drop", "=q5=Random Drop"};
    { 5, 6686, "", "=q2=Tusken Helm", "=ds=#a3#", "", "60.0%" };
    { 6, 6687, "", "=q3=Corpsemaker", "=ds=#w1#", "", "40.0%" };
	};

	AtlasLoot_Data["RFKAgathelos"] = {
    { 2, 0, "INV_Box_01", "=q6="..BabbleBoss["Agathelos the Raging"].." - One Random Drop", "=q5=Random Drop"};
    { 3, 6690, "", "=q2=Ferine Leggings", "=ds=#a2#", "", "60.0%" };
    { 4, 6691, "", "=q3=Swinetusk Shank", "=ds=#w4#", "", "40.0%" };
	};

	AtlasLoot_Data["RFKBlindHunter"] = {
    { 2, 0, "INV_Box_01", "=q6="..BabbleBoss["Blind Hunter"].." - One Random Drop", "=q5=Random Drop"};
    { 3, 6695, "", "=q3=Stygian Bone Amulet", "=ds=#s2#", "", "33.3%" };
    { 4, 6696, "", "=q3=Nightstalker Bow", "=ds=#w2#", "", "33.3%" };
    { 5, 6697, "", "=q3=Batwing Mantle", "=ds=#a1#", "", "33.3%" };
	};

	AtlasLoot_Data["RFKCharlga"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Charlga Razorflank"].." - Always Drops", "=q5=Always Drops"};
    ...
    { 6, 0, "INV_Box_01", "=q6="..BabbleBoss["Charlga Razorflank"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 7, 57477, "", "=q2=Technique: Scroll of Nature Resistance III", "=ds=#e2#", "", "15.0%" };
    { 9, 0, "INV_Box_01", "=q6="..BabbleBoss["Charlga Razorflank"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 2, 0, "INV_Box_01", "=q6="..BabbleBoss["Earthcaller Halmgar"].." - One Random Drop", "=q5=Random Drop"};
    { 3, 6688, "", "=q2=Whisperwind Headdress", "=ds=#a2#", "", "50.0%" };
    { 4, 6689, "", "=q3=Wind Spirit Staff", "=ds=#w9#", "", "50.0%" };
	};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Herod"].." - Always Drops", "=q5=Always Drops"};
    { 2, 901721, "", "=q1=Herod's War Banner", "=ds=#m3#", "", "100%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Herod"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 5, 57457, "", "=q2=Technique: Scroll of Fire Resistance III", "=ds=#e2#", "", "15.0%" };
    { 7, 0, "INV_Box_01", "=q6="..BabbleBoss["Herod"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 13, 0, "INV_Box_01", "=q6=Scarlet Trainee - Chance on Drop", "=q5=Chance on Drop"};
    { 14, 23192, "", "=q1=Tabard of the Scarlet Crusade", "=ds=#s7#", "", "1.60%" };
	};

	AtlasLoot_Data["SMCFairbanks"] = {
    { 2, 0, "INV_Box_01", "=q6="..BabbleBoss["High Inquisitor Fairbanks"].." - One Random Drop", "=q5=Random Drop"};
    { 3, 19507, "", "=q2=Inquisitor's Shawl", "=ds=#a1#", "", "33.3%" };
    { 4, 19508, "", "=q2=Branded Leather Bracers", "=ds=#a2#", "", "33.3%" };
    { 5, 19509, "", "=q2=Dusty Mail Boots", "=ds=#a3#", "", "33.3%" };
	};

	AtlasLoot_Data["SMCMograineWhitemane"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Scarlet Commander Mograine"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 2, 57482, "", "=q2=Technique: Scroll of Holy Resistance III", "=ds=#e2#", "", "15.0%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Scarlet Commander Mograine"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 16, 0, "INV_Box_01", "=q6="..BabbleBoss["High Inquisitor Whitemane"].." - Always Drops", "=q5=Always Drops"};
    { 17, 901722, "", "=q1=Whitemane's Prayer Book", "=ds=#m3#", "", "100%" };
    { 19, 0, "INV_Box_01", "=q6="..BabbleBoss["High Inquisitor Whitemane"].." - Chance on Drop", "=q5=Chance on Drop"};
    ...
    { 23, 0, "INV_Box_01", "=q6="..BabbleBoss["High Inquisitor Whitemane"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Interrogator Vishas"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 2, 7682, "", "=q3=Torturing Poker", "=ds=#w4#", "", "10.0%" };
	};

	AtlasLoot_Data["SMGThalnos"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Bloodmage Thalnos"].." - Always Drops", "=q5=Always Drops"};
    { 2, 901710, "", "=q1=Bloodfire Amulet", "=ds=#m3#", "", "100%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Bloodmage Thalnos"].." - One Random Drop", "=q5=Random Drop"};
    { 5, 7684, "", "=q2=Bloodmage Mantle", "=ds=#a1#", "", "50.0%" };
    { 6, 7685, "", "=q3=Orb of the Forgotten Seer", "=ds=#s15#", "", "50.0%" };
	};

	AtlasLoot_Data["SMGIronspine"] = {
    { 2, 0, "INV_Box_01", "=q6="..BabbleBoss["Ironspine"].." - One Random Drop", "=q5=Random Drop"};
    { 3, 7686, "", "=q3=Ironspine's Eye", "=ds=#s13#", "", "33.3%" };
    { 4, 7687, "", "=q3=Ironspine's Fist", "=ds=#w6#", "", "33.3%" };
    { 5, 7688, "", "=q3=Ironspine's Ribcage", "=ds=#a3#", "", "33.3%" };
	};

	AtlasLoot_Data["SMGAzshir"] = {
    { 2, 0, "INV_Box_01", "=q6="..BabbleBoss["Azshir the Sleepless"].." - One Random Drop", "=q5=Random Drop"};
    { 3, 7708, "", "=q3=Necrotic Wand", "=ds=#w12#", "", "33.3%" };
    { 4, 7709, "", "=q3=Blighted Leggings", "=ds=#a1#", "", "33.3%" };
    { 5, 7731, "", "=q3=Ghostshard Talisman", "=ds=#s2#", "", "33.3%" };
	};

	AtlasLoot_Data["SMGFallenChampion"] = {
    { 2, 0, "INV_Box_01", "=q6="..BabbleBoss["Fallen Champion"].." - One Random Drop", "=q5=Random Drop"};
    { 3, 7689, "", "=q3=Morbid Dawn", "=ds=#w10#", "", "33.3%" };
    { 4, 7690, "", "=q3=Ebon Vise", "=ds=#a2#", "", "33.3%" };
    { 5, 7691, "", "=q3=Embalmed Shroud", "=ds=#a1#", "", "33.3%" };
	};

	AtlasLoot_Data["SMLLoksey"] = {
    { 2, 0, "INV_Box_01", "=q6="..BabbleBoss["Houndmaster Loksey"].." - One Random Drop", "=q5=Random Drop"};
    { 3, 7756, "", "=q2=Dog Training Gloves", "=ds=#a2#", "", "60.0%" };
    { 4, 3456, "", "=q2=Dog Whistle", "=ds=#e0#", "", "30.0%" };
    { 5, 7710, "", "=q3=Loksey's Training Stick", "=ds=#w9#", "", "10.0%" };
	};

	AtlasLoot_Data["SMLDoan"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Arcanist Doan"].." - Always Drops", "=q5=Always Drops"};
    { 2, 901723, "", "=q1=Arcane Orb of Doan", "=ds=#m3#", "", "100%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Arcanist Doan"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 5, 57467, "", "=q2=Technique: Scroll of Arcane Resistance III", "=ds=#e2#", "", "15.0%" };
    { 7, 0, "INV_Box_01", "=q6="..BabbleBoss["Arcanist Doan"].." - One Random Drop", "=q5=Random Drop"};
    { 8, 7711, "", "=q2=Robe of Doan", "=ds=#a1#", "", "24.0%" };
    { 9, 7712, "", "=q2=Mantle of Doan", "=ds=#a1#", "", "24.0%" };
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Deviate Faerie Dragon"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 2, 6443, "", "=q1=Deviate Hide", "=ds=#m3#", "", "80.0%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Deviate Faerie Dragon"].." - One Random Drop", "=q5=Random Drop"};
    { 5, 5243, "", "=q3=Firebelcher", "=ds=#w12#", "", "50.0%" };
    { 6, 6632, "", "=q2=Feyscale Cloak", "=ds=#a1#", "", "50.0%" };
	};

	AtlasLoot_Data["WCMutanus"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Mutanus the Devourer"].." - Always Drops", "=q5=Always Drops"};
    { 2, 10441, "", "=q1=Glowing Shard", "=ds=#m3#", "", "100%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Mutanus the Devourer"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 5, 6443, "", "=q1=Deviate Hide", "=ds=#m3#", "", "80.0%" };
    { 7, 0, "INV_Box_01", "=q6="..BabbleBoss["Mutanus the Devourer"].." - One Random Drop", "=q5=Random Drop"};
    { 8, 6461, "", "=q3=Slime-encrusted Pads", "=ds=#a1#", "", "33.3%" };
    { 9, 6463, "", "=q3=Deep Fathom Ring", "=ds=#s13#", "", "33.3%" };
    { 10, 6627, "", "=q3=Mutant Scale Breastplate", "=ds=#a3#", "", "33.3%" };
	};

	AtlasLoot_Data["WCVerdan"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Verdan the Everliving"].." - Always Drops", "=q5=Always Drops"};
    { 2, 901706, "", "=q1=Everliving Spore", "=ds=#m3#", "", "100%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Verdan the Everliving"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 5, 6443, "", "=q1=Deviate Hide", "=ds=#m3#", "", "80.0%" };
    { 6, 57476, "", "=q2=Technique: Scroll of Nature Resistance II", "=ds=#e2#", "", "15.0%" };
    { 8, 0, "INV_Box_01", "=q6="..BabbleBoss["Verdan the Everliving"].." - One Random Drop", "=q5=Random Drop"};
    { 9, 6630, "", "=q3=Seedcloud Buckler", "=ds=#w8#", "", "40.0%" };
    { 10, 6631, "", "=q3=Living Root", "=ds=#w9#", "", "40.0%" };
    { 11, 6629, "", "=q2=Sporid Cape", "=ds=#a1#", "", "20.0%" };
	};

	AtlasLoot_Data["WCSerpentis"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Lord Serpentis"].." - Always Drops", "=q5=Always Drops"};
    { 2, 9741, "", "=q1=Gem of Serpentis", "=ds=#m3#", "", "100%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Lord Serpentis"].." - One Random Drop", "=q5=Random Drop"};
    { 5, 5970, "", "=q2=Serpent Gloves", "=ds=#a1#", "", "25.0%" };
    { 6, 6459, "", "=q2=Savage Trodders", "=ds=#a3#", "", "25.0%" };
    { 7, 6469, "", "=q3=Venomstrike", "=ds=#w2#", "", "25.0%" };
    { 8, 10411, "", "=q2=Footpads of the Fang", "=ds=#a2#", "", "25.0%" };
	};

	AtlasLoot_Data["WCSkum"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Skum"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 2, 6443, "", "=q1=Deviate Hide", "=ds=#m3#", "", "80.0%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Skum"].." - One Random Drop", "=q5=Random Drop"};
    { 5, 6448, "", "=q2=Tail Spike", "=ds=#w4#", "", "50.0%" };
    { 6, 6449, "", "=q3=Glowing Lizardscale Cloak", "=ds=#a1#", "", "50.0%" };
	};

	AtlasLoot_Data["WCPythas"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Lord Pythas"].." - Always Drops", "=q5=Always Drops"};
    { 2, 9740, "", "=q1=Gem of Pythas", "=ds=#m3#", "", "100%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Lord Pythas"].." - One Random Drop", "=q5=Random Drop"};
    { 5, 6473, "", "=q2=Armor of the Fang", "=ds=#a2#", "", "60.0%" };
    { 6, 6472, "", "=q3=Stinging Viper", "=ds=#w6#", "", "40.0%" };
	};

	AtlasLoot_Data["WCKresh"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Kresh"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 2, 6443, "", "=q1=Deviate Hide", "=ds=#m3#", "", "80.0%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Kresh"].." - One Random Drop", "=q5=Random Drop"};
    { 5, 6447, "", "=q3=Worn Turtle Shell Shield", "=ds=#w8#", "", "90.0%" };
    { 6, 13245, "", "=q3=Kresh's Back", "=ds=#w8#", "", "10.0%" };
	};

	AtlasLoot_Data["WCAnacondra"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Lady Anacondra"].." - Always Drops", "=q5=Always Drops"};
    { 2, 9739, "", "=q1=Gem of Anacondra", "=ds=#m3#", "", "100%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Lady Anacondra"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 5, 57466, "", "=q2=Technique: Scroll of Arcane Resistance II", "=ds=#e2#", "", "15.0%" };
    { 7, 0, "INV_Box_01", "=q6="..BabbleBoss["Lady Anacondra"].." - One Random Drop", "=q5=Random Drop"};
    { 8, 5404, "", "=q3=Serpent's Shoulders", "=ds=#a2#", "", "80.0%" };
    { 9, 10412, "", "=q2=Belt of the Fang", "=ds=#a2#", "", "10.0%" };
	};

	AtlasLoot_Data["WCCobrahn"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Lord Cobrahn"].." - Always Drops", "=q5=Always Drops"};
    { 2, 9738, "", "=q1=Gem of Cobrahn", "=ds=#m3#", "", "100%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Lord Cobrahn"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 5, 57476, "", "=q2=Technique: Scroll of Nature Resistance II", "=ds=#e2#", "", "15.0%" };
    { 7, 0, "INV_Box_01", "=q6="..BabbleBoss["Lord Cobrahn"].." - One Random Drop", "=q5=Random Drop"};
    { 8, 6465, "", "=q2=Robe of the Moccasin", "=ds=#a1#", "", "60.0%" };
    { 9, 6460, "", "=q3=Cobrahn's Grasp", "=ds=#a3#", "", "20.0%" };
    { 10, 10410, "", "=q3=Leggings of the Fang", "=ds=#a2#", "", "20.0%" };
	};

	AtlasLoot_Data["WCBoahn"] = {
    { 2, 0, "INV_Box_01", "=q6="..BabbleBoss["Boahn"].." - One Random Drop", "=q5=Random Drop"};
    { 3, 5422, "", "=q2=Brambleweed Leggings", "=ds=#a2#", "", "60.0%" };
    { 4, 5423, "", "=q3=Boahn's Fang", "=ds=#w1#", "", "40.0%" };
	};

	AtlasLoot_Data["WCTrigore"] = {
    { 2, 0, "INV_Box_01", "=q6="..BabbleBoss["Trigore the Lasher"].." - One Random Drop", "=q5=Random Drop"};
    { 3, 5425, "", "=q2=Runescale Girdle", "=ds=#a3#", "", "60.0%" };
    { 4, 5426, "", "=q3=Serpent's Kiss", "=ds=#w1#", "", "40.0%" };
	};

	AtlasLoot_Data["WCMagglish"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Mad Magglish"].." - Always Drops", "=q5=Always Drops"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Kel'Thuzad"].." - Always Drops", "=q5=Always Drops"};
    ...
    { 6, 59323, "", "=q4=Naxxramas Armor Cache - Chest", "=ds=#e10#", "", "100%" };
    { 7, 59331, "", "=q4=Kel'Thuzad's Phylactery Fragment", "=ds=#m3#", "", "100%" };
    { 8, 23059, "", "=q4=Ring of the Dreadnaught", "=ds=#s13#", "", "100%" };
    { 9, 23060, "", "=q4=Bonescythe Ring", "=ds=#s13#", "", "100%" };
    { 10, 23061, "", "=q4=Ring of Faith", "=ds=#s13#", "", "100%" };
    { 11, 23062, "", "=q4=Frostfire Ring", "=ds=#s13#", "", "100%" };
    { 12, 23063, "", "=q4=Plagueheart Ring", "=ds=#s13#", "", "100%" };
    { 13, 23064, "", "=q4=Ring of the Dreamwalker", "=ds=#s13#", "", "100%" };
    { 14, 23065, "", "=q4=Ring of the Earthshatterer", "=ds=#s13#", "", "100%" };
    { 15, 23066, "", "=q4=Ring of Redemption", "=ds=#s13#", "", "100%" };
    { 16, 23067, "", "=q4=Ring of the Cryptstalker", "=ds=#s13#", "", "100%" };
    { 18, 0, "INV_Box_01", "=q6="..BabbleBoss["Kel'Thuzad"].." - One Random Drop", "=q5=Random Drop"};
    { 19, 22798, "", "=q4=Might of Menethil", "=ds=#w6#", "", "9.09%" };
    { 20, 22799, "", "=q4=Soulseeker", "=ds=#w9#", "", "9.09%" };
    { 21, 22802, "", "=q4=Kingsfall", "=ds=#w4#", "", "9.09%" };
    { 22, 22812, "", "=q4=Nerubian Slavemaker", "=ds=#w3#", "", "9.09%" };
    { 23, 22819, "", "=q4=Shield of Condemnation", "=ds=#w8#", "", "9.09%" };
    { 24, 22821, "", "=q4=Doomfinger", "=ds=#w12#", "", "9.09%" };
    { 25, 23053, "", "=q4=Stormrage's Talisman of Seething", "=ds=#s2#", "", "9.09%" };
    { 26, 23054, "", "=q4=Gressil, Dawn of Ruin", "=ds=#w10#", "", "9.09%" };
    { 27, 23056, "", "=q4=Hammer of the Twisting Nether", "=ds=#w6#", "", "9.09%" };
    { 28, 23057, "", "=q4=Gem of Trapped Innocents", "=ds=#s2#", "", "9.09%" };
    { 29, 23577, "", "=q4=The Hungering Cold", "=ds=#w10#", "", "9.09%" };
	};

	AtlasLoot_Data["Naxx40Sapphiron"] = {
    { 2, 0, "INV_Box_01", "=q6="..BabbleBoss["Sapphiron"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 14, 0, "INV_Box_01", "=q6="..BabbleBoss["Sapphiron"].." - One Random Drop", "=q5=Random Drop"};
    { 15, 23545, "", "=q4=Power of the Scourge", "=ds=#m3#", "", "50.0%" };
    { 16, 23547, "", "=q4=Resilience of the Scourge", "=ds=#m3#", "", "50.0%" };
    { 18, 0, "INV_Box_01", "=q6="..BabbleBoss["Sapphiron"].." - One Random Drop", "=q5=Random Drop"};
    { 19, 23548, "", "=q4=Might of the Scourge", "=ds=#m3#", "", "50.0%" };
    { 20, 23549, "", "=q4=Fortitude of the Scourge", "=ds=#m3#", "", "50.0%" };
	};

	AtlasLoot_Data["Naxx40Thaddius"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Thaddius"].." - Always Drops", "=q5=Always Drops"};
    { 2, 30450, "", "=q4=Warp-Spring Coil", "=ds=#s14#", "", "100%" };
    { 3, 59321, "", "=q4=Naxxramas Armor Cache - Helm", "=ds=#e10#", "", "100%" };
    { 4, 59329, "", "=q4=Thaddius's Power Core", "=ds=#m3#", "", "100%" };
    { 5, 22360, "", "=q4=Desecrated Headpiece", "=ds=#e10#", "", "100%" };
    { 7, 0, "INV_Box_01", "=q6="..BabbleBoss["Thaddius"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 8, 22726, "", "=q5=Splinter of Atiesh", "=ds=#e10#", "", "30.0%" };
    { 10, 0, "INV_Box_01", "=q6="..BabbleBoss["Thaddius"].." - One Random Drop", "=q5=Random Drop"};
    { 11, 22801, "", "=q4=Spire of Twilight", "=ds=#w9#", "", "20.0%" };
    { 12, 22808, "", "=q4=The Castigator", "=ds=#w6#", "", "20.0%" };
    { 13, 23000, "", "=q4=Plated Abomination Ribcage", "=ds=#a4#", "", "20.0%" };
    { 14, 23001, "", "=q4=Eye of Diminution", "=ds=#s14#", "", "20.0%" };
    { 15, 23070, "", "=q4=Leggings of Polarity", "=ds=#a1#", "", "20.0%" };
	};

	AtlasLoot_Data["Naxx40Gluth"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Gluth"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 2, 22726, "", "=q5=Splinter of Atiesh", "=ds=#e10#", "", "30.0%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Gluth"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 10, 0, "INV_Box_01", "=q6="..BabbleBoss["Gluth"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Grobbulus"].." - Always Drops", "=q5=Always Drops"};
    { 2, 59322, "", "=q4=Naxxramas Armor Cache - Shoulder", "=ds=#e10#", "", "100%" };
    { 3, 59330, "", "=q4=Grobbulus's Injection Vial", "=ds=#m3#", "", "100%" };
    { 4, 22361, "", "=q4=Desecrated Spaulders", "=ds=#e10#", "", "100%" };
    { 6, 0, "INV_Box_01", "=q6="..BabbleBoss["Grobbulus"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 7, 22726, "", "=q5=Splinter of Atiesh", "=ds=#e10#", "", "30.0%" };
    { 9, 0, "INV_Box_01", "=q6="..BabbleBoss["Grobbulus"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Patchwerk"].." - Always Drops", "=q5=Always Drops"};
    { 2, 59322, "", "=q4=Naxxramas Armor Cache - Shoulder", "=ds=#e10#", "", "100%" };
    { 3, 22361, "", "=q4=Desecrated Spaulders", "=ds=#e10#", "", "100%" };
    { 5, 0, "INV_Box_01", "=q6="..BabbleBoss["Patchwerk"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 6, 22726, "", "=q5=Splinter of Atiesh", "=ds=#e10#", "", "30.0%" };
    { 8, 0, "INV_Box_01", "=q6="..BabbleBoss["Patchwerk"].." - One Random Drop", "=q5=Random Drop"};
    { 9, 22815, "", "=q4=Severance", "=ds=#w1#", "", "20.0%" };
    { 10, 22818, "", "=q4=The Plague Bearer", "=ds=#w8#", "", "20.0%" };
    { 11, 22820, "", "=q4=Wand of Fates", "=ds=#w12#", "", "20.0%" };
    { 12, 22960, "", "=q4=Cloak of Suturing", "=ds=#a1#", "", "20.0%" };
    { 13, 22961, "", "=q4=Band of Reanimation", "=ds=#s13#", "", "20.0%" };
	};

	AtlasLoot_Data["Naxx40Gothik"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Gothik the Harvester"].." - Always Drops", "=q5=Always Drops"};
    { 2, 59325, "", "=q4=Naxxramas Armor Cache - Boots", "=ds=#e10#", "", "100%" };
    { 3, 59333, "", "=q4=Gothik's Unholy Sigil", "=ds=#m3#", "", "100%" };
    { 4, 22365, "", "=q4=Desecrated Boots", "=ds=#e10#", "", "100%" };
    { 6, 0, "INV_Box_01", "=q6="..BabbleBoss["Gothik the Harvester"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 7, 22726, "", "=q5=Splinter of Atiesh", "=ds=#e10#", "", "30.0%" };
    { 9, 0, "INV_Box_01", "=q6="..BabbleBoss["Gothik the Harvester"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Instructor Razuvious"].." - Always Drops", "=q5=Always Drops"};
    { 2, 59325, "", "=q4=Naxxramas Armor Cache - Boots", "=ds=#e10#", "", "100%" };
    { 3, 22365, "", "=q4=Desecrated Boots", "=ds=#e10#", "", "100%" };
    { 5, 0, "INV_Box_01", "=q6="..BabbleBoss["Instructor Razuvious"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 6, 22726, "", "=q5=Splinter of Atiesh", "=ds=#e10#", "", "30.0%" };
    { 8, 0, "INV_Box_01", "=q6="..BabbleBoss["Instructor Razuvious"].." - One Random Drop", "=q5=Random Drop"};
    { 9, 23004, "", "=q4=Idol of Longevity", "", "", "16.7%" };
    { 10, 23009, "", "=q4=Wand of the Whispering Dead", "=ds=#w12#", "", "16.7%" };
    { 11, 23014, "", "=q4=Iblis, Blade of the Fallen Seraph", "=ds=#w10#", "", "16.7%" };
    { 12, 23017, "", "=q4=Veil of Eclipse", "=ds=#a1#", "", "16.7%" };
    { 13, 23018, "", "=q4=Signet of the Fallen Defender", "=ds=#s13#", "", "16.7%" };
    { 14, 23219, "", "=q4=Girdle of the Mentor", "=ds=#a4#", "", "16.7%" };
	};

	AtlasLoot_Data["Naxx40Loatheb"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Loatheb"].." - Always Drops", "=q5=Always Drops"};
    { 2, 30474, "", "=q0=NPC Equip 30474", "=ds=#e2#", "", "100%" };
    { 3, 59324, "", "=q4=Naxxramas Armor Cache - Legs", "=ds=#e10#", "", "100%" };
    { 4, 59332, "", "=q4=Loatheb's Spore Essence", "=ds=#m3#", "", "100%" };
    { 5, 22359, "", "=q4=Desecrated Legguards", "=ds=#e10#", "", "100%" };
    { 7, 0, "INV_Box_01", "=q6="..BabbleBoss["Loatheb"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 8, 22726, "", "=q5=Splinter of Atiesh", "=ds=#e10#", "", "30.0%" };
    { 10, 0, "INV_Box_01", "=q6="..BabbleBoss["Loatheb"].." - One Random Drop", "=q5=Random Drop"};
    { 11, 22800, "", "=q4=Brimstone Staff", "=ds=#w9#", "", "20.0%" };
    { 12, 23037, "", "=q4=Ring of Spiritual Fervor", "=ds=#s13#", "", "20.0%" };
    { 13, 23038, "", "=q4=Band of Unnatural Forces", "=ds=#s13#", "", "20.0%" };
    { 14, 23039, "", "=q4=The Eye of Nerub", "=ds=#w7#", "", "20.0%" };
    { 15, 23042, "", "=q4=Loatheb's Reflection", "=ds=#s14#", "", "20.0%" };
	};

	AtlasLoot_Data["Naxx40Heigan"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Heigan the Unclean"].." - Always Drops", "=q5=Always Drops"};
    { 2, 59328, "", "=q4=Naxxramas Armor Cache - Belt", "=ds=#e10#", "", "100%" };
    { 3, 59336, "", "=q4=Heigan's Plague Vial", "=ds=#m3#", "", "100%" };
    { 4, 22363, "", "=q4=Desecrated Girdle", "=ds=#e10#", "", "100%" };
    { 6, 0, "INV_Box_01", "=q6="..BabbleBoss["Heigan the Unclean"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 7, 22726, "", "=q5=Splinter of Atiesh", "=ds=#e10#", "", "30.0%" };
    { 9, 0, "INV_Box_01", "=q6="..BabbleBoss["Heigan the Unclean"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Noth the Plaguebringer"].." - Always Drops", "=q5=Always Drops"};
    { 2, 57401, "", "=q6=Artisan Mining Pick", "=ds=#e3#", "", "100%" };
    { 3, 59328, "", "=q4=Naxxramas Armor Cache - Belt", "=ds=#e10#", "", "100%" };
    { 4, 22363, "", "=q4=Desecrated Girdle", "=ds=#e10#", "", "100%" };
    { 6, 0, "INV_Box_01", "=q6="..BabbleBoss["Noth the Plaguebringer"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 7, 22726, "", "=q5=Splinter of Atiesh", "=ds=#e10#", "", "30.0%" };
    { 9, 0, "INV_Box_01", "=q6="..BabbleBoss["Noth the Plaguebringer"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Maexxna"].." - Always Drops", "=q5=Always Drops"};
    { 2, 30459, "", "=q3=Netherflame Robe", "=ds=#a1#", "", "100%" };
    { 3, 59327, "", "=q4=Naxxramas Armor Cache - Gloves", "=ds=#e10#", "", "100%" };
    { 4, 59335, "", "=q4=Maexxna's Fang", "=ds=#m3#", "", "100%" };
    { 5, 22364, "", "=q4=Desecrated Handguards", "=ds=#e10#", "", "100%" };
    { 7, 0, "INV_Box_01", "=q6="..BabbleBoss["Maexxna"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 8, 22726, "", "=q5=Splinter of Atiesh", "=ds=#e10#", "", "30.0%" };
    { 10, 0, "INV_Box_01", "=q6="..BabbleBoss["Maexxna"].." - One Random Drop", "=q5=Random Drop"};
    { 11, 22804, "", "=q4=Maexxna's Fang", "=ds=#w4#", "", "20.0%" };
    { 12, 22807, "", "=q4=Wraith Blade", "=ds=#w10#", "", "20.0%" };
    { 13, 22947, "", "=q4=Pendant of Forgotten Names", "=ds=#s2#", "", "20.0%" };
    { 14, 22954, "", "=q4=Kiss of the Spider", "=ds=#s14#", "", "20.0%" };
    { 15, 23220, "", "=q4=Crystal Webbed Robe", "=ds=#a1#", "", "20.0%" };
	};

	AtlasLoot_Data["Naxx40Faerlina"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Grand Widow Faerlina"].." - Always Drops", "=q5=Always Drops"};
    { 2, 59326, "", "=q4=Naxxramas Armor Cache - Bracers", "=ds=#e10#", "", "100%" };
    { 3, 59334, "", "=q4=Faerlina's Webbing", "=ds=#m3#", "", "100%" };
    { 4, 22362, "", "=q4=Desecrated Wristguards", "=ds=#e10#", "", "100%" };
    { 6, 0, "INV_Box_01", "=q6="..BabbleBoss["Grand Widow Faerlina"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 7, 22726, "", "=q5=Splinter of Atiesh", "=ds=#e10#", "", "30.0%" };
    { 9, 0, "INV_Box_01", "=q6="..BabbleBoss["Grand Widow Faerlina"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Anub'Rekhan"].." - Always Drops", "=q5=Always Drops"};
    { 2, 59326, "", "=q4=Naxxramas Armor Cache - Bracers", "=ds=#e10#", "", "100%" };
    { 3, 22362, "", "=q4=Desecrated Wristguards", "=ds=#e10#", "", "100%" };
    { 5, 0, "INV_Box_01", "=q6="..BabbleBoss["Anub'Rekhan"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 6, 22726, "", "=q5=Splinter of Atiesh", "=ds=#e10#", "", "30.0%" };
    { 8, 0, "INV_Box_01", "=q6="..BabbleBoss["Anub'Rekhan"].." - One Random Drop", "=q5=Random Drop"};
    { 9, 22935, "", "=q4=Touch of Frost", "=ds=#s2#", "", "20.0%" };
    { 10, 22936, "", "=q4=Wristguards of Vengeance", "=ds=#a4#", "", "20.0%" };
    { 11, 22937, "", "=q4=Gem of Nerubis", "=ds=#s15#", "", "20.0%" };
    { 12, 22938, "", "=q4=Cryptfiend Silk Cloak", "=ds=#a1#", "", "20.0%" };
    { 13, 22939, "", "=q4=Band of Unanswered Prayers", "=ds=#s13#", "", "20.0%" };
	};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Darkmaster Gandling"].." - Always Drops", "=q5=Always Drops"};
    ...
    { 6, 0, "INV_Box_01", "=q6="..BabbleBoss["Darkmaster Gandling"].." - Chance on Drop", "=q5=Chance on Drop"};
    ...
    { 16, 0, "INV_Box_01", "=q6="..BabbleBoss["Darkmaster Gandling"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Edwin VanCleef"].." - Always Drops", "=q5=Always Drops"};
    { 2, 2874, "", "=q1=An Unsent Letter", "=ds=#m3#", "", "100%" };
    { 3, 3637, "", "=q1=Head of VanCleef", "=ds=#m3#", "", "100%" };
    { 5, 0, "INV_Box_01", "=q6="..BabbleBoss["Edwin VanCleef"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 6, 57471, "", "=q2=Technique: Scroll of Shadow Resistance II", "=ds=#e2#", "", "15.0%" };
    { 8, 0, "INV_Box_01", "=q6="..BabbleBoss["Edwin VanCleef"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 2, 0, "INV_Box_01", "=q6="..BabbleBoss["Captain Greenskin"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Cookie"].." - Always Drops", "=q5=Always Drops"};
    { 2, 901727, "", "=q1=Stabby Patty Secret Formula", "=ds=#m3#", "", "100%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Cookie"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 5, 8490, "", "=q1=Cat Carrier (Siamese)", "=ds=#e10#", "", "15.0%" };
    { 6, 57461, "", "=q2=Technique: Scroll of Frost Resistance II", "=ds=#e2#", "", "15.0%" };
    { 8, 0, "INV_Box_01", "=q6="..BabbleBoss["Cookie"].." - One Random Drop", "=q5=Random Drop"};
    { 9, 5197, "", "=q2=Cookie's Tenderizer", "=ds=#w6#", "", "65.0%" };
    { 10, 5198, "", "=q3=Cookie's Stirring Rod", "=ds=#w12#", "", "35.0%" };
	};

	AtlasLoot_Data["VCSmite"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Mr. Smite"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 2, 57481, "", "=q2=Technique: Scroll of Holy Resistance II", "=ds=#e2#", "", "15.0%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Mr. Smite"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Kirtonos the Herald"].." - Always Drops", "=q5=Always Drops"};
    { 2, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Kirtonos the Herald"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Jandice Barov"].." - Always Drops", "=q5=Always Drops"};
    { 2, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    { 3, 13523, "", "=q1=Blood of Innocents", "=ds=#m3#", "", "100%" };
    { 4, 13725, "", "=q1=Krastinov's Bag of Horrors", "=ds=#m3#", "", "100%" };
    { 6, 0, "INV_Box_01", "=q6="..BabbleBoss["Jandice Barov"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Rattlegore"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 2, 57473, "", "=q2=Technique: Scroll of Shadow Resistance IV", "=ds=#e2#", "", "15.0%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Rattlegore"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Vectus"].." - Always Drops", "=q5=Always Drops"};
    { 2, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Vectus"].." - Chance on Drop", "=q5=Chance on Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Marduk Blackpool"].." - Always Drops", "=q5=Always Drops"};
    { 2, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Marduk Blackpool"].." - Chance on Drop", "=q5=Chance on Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Ras Frostwhisper"].." - Always Drops", "=q5=Always Drops"};
    { 2, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    { 3, 13626, "", "=q1=Human Head of Ras Frostwhisper", "=ds=#m3#", "", "100%" };
    { 16, 0, "INV_Box_01", "=q6="..BabbleBoss["Ras Frostwhisper"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Kormok"].." - Always Drops", "=q5=Always Drops"};
    { 2, 21984, "", "=q1=Left Piece of Lord Valthalak's Amulet", "=ds=#m3#", "", "100%" };
    { 3, 22046, "", "=q1=Right Piece of Lord Valthalak's Amulet", "=ds=#m3#", "", "100%" };
    { 5, 0, "INV_Box_01", "=q6="..BabbleBoss["Kormok"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Instructor Malicia"].." - Always Drops", "=q5=Always Drops"};
    { 2, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Instructor Malicia"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 5, 20520, "", "=q2=Dark Rune", "=ds=#e7#", "", "44.0%" };
    { 6, 16710, "", "=q3=Shadowcraft Bracers", "=ds=#a2#", "", "5.00%" };
	};

	AtlasLoot_Data["SCHOLODoctorTheolenKrastinov"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Doctor Theolen Krastinov"].." - Always Drops", "=q5=Always Drops"};
    { 2, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    { 3, 13523, "", "=q1=Blood of Innocents", "=ds=#m3#", "", "100%" };
    { 5, 0, "INV_Box_01", "=q6="..BabbleBoss["Doctor Theolen Krastinov"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 6, 16684, "", "=q3=Magister's Gloves", "=ds=#a1#", "", "14.0%" };
	};

	AtlasLoot_Data["SCHOLOLorekeeperPolkelt"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Lorekeeper Polkelt"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 2, 20520, "", "=q2=Dark Rune", "=ds=#e7#", "", "44.0%" };
    { 3, 16705, "", "=q3=Dreadmist Wraps", "=ds=#a1#", "", "17.0%" };
	};

	AtlasLoot_Data["SCHOLOTheRavenian"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["The Ravenian"].." - Always Drops", "=q5=Always Drops"};
    { 2, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["The Ravenian"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 5, 20520, "", "=q2=Dark Rune", "=ds=#e7#", "", "44.0%" };
    { 6, 16716, "", "=q3=Wildheart Belt", "=ds=#a2#", "", "4.00%" };
	};

	AtlasLoot_Data["SCHOLOLordAlexeiBarov"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Lord Alexei Barov"].." - Always Drops", "=q5=Always Drops"};
    { 2, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Lord Alexei Barov"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 5, 16722, "", "=q3=Lightforge Bracers", "=ds=#a4#", "", "5.00%" };
	};

	AtlasLoot_Data["SCHOLOLadyIlluciaBarov"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Lady Illucia Barov"].." - Always Drops", "=q5=Always Drops"};
    { 2, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Lady Illucia Barov"].." - Chance on Drop", "=q5=Chance on Drop"};
    ...
    { 2, 0, "INV_Box_01", "=q6="..BabbleBoss["Deathsworn Captain"].." - One Random Drop", "=q5=Random Drop"};
    { 3, 6641, "", "=q2=Haunting Blade", "=ds=#w10#", "", "60.0%" };
    { 4, 6642, "", "=q3=Phantom Armor", "=ds=#a3#", "", "40.0%" };
	};

	AtlasLoot_Data["SFKRazorclaw"] = {
    { 2, 0, "INV_Box_01", "=q6="..BabbleBoss["Razorclaw the Butcher"].." - One Random Drop", "=q5=Random Drop"};
    { 3, 6226, "", "=q2=Bloody Apron", "=ds=#a1#", "", "45.0%" };
    { 4, 6633, "", "=q2=Butcher's Slicer", "=ds=#w10#", "", "45.0%" };
    { 5, 1292, "", "=q3=Butcher's Cleaver", "=ds=#w1#", "", "10.0%" };
	};

	AtlasLoot_Data["SFKSilverlaine"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Baron Silverlaine"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 2, 57461, "", "=q2=Technique: Scroll of Frost Resistance II", "=ds=#e2#", "", "15.0%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Baron Silverlaine"].." - One Random Drop", "=q5=Random Drop"};
    { 5, 6323, "", "=q2=Baron's Scepter", "=ds=#w6#", "", "70.0%" };
    { 6, 6321, "", "=q3=Silverlaine's Family Seal", "=ds=#s13#", "", "30.0%" };
	};

	AtlasLoot_Data["SFKSpringvale"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Commander Springvale"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 2, 57481, "", "=q2=Technique: Scroll of Holy Resistance II", "=ds=#e2#", "", "15.0%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Commander Springvale"].." - One Random Drop", "=q5=Random Drop"};
    { 5, 3191, "", "=q2=Arced War Axe", "=ds=#w1#", "", "50.0%" };
    { 6, 6320, "", "=q3=Commander's Crest", "=ds=#w8#", "", "50.0%" };
	};

	AtlasLoot_Data["SFKOdo"] = {
    { 2, 0, "INV_Box_01", "=q6="..BabbleBoss["Odo the Blindwatcher"].." - One Random Drop", "=q5=Random Drop"};
    { 3, 6319, "", "=q2=Girdle of the Blindwatcher", "=ds=#a2#", "", "60.0%" };
    { 4, 6318, "", "=q3=Odo's Ley Staff", "=ds=#w9#", "", "40.0%" };
	};

	AtlasLoot_Data["SFKFenrus"] = {
    { 2, 0, "INV_Box_01", "=q6="..BabbleBoss["Fenrus the Devourer"].." - One Random Drop", "=q5=Random Drop"};
    { 3, 6340, "", "=q2=Fenrus' Hide", "=ds=#a1#", "", "70.0%" };
    { 4, 3230, "", "=q2=Black Wolf Bracers", "=ds=#a2#", "", "30.0%" };
	};

	AtlasLoot_Data["SFKNandos"] = {
    { 2, 0, "INV_Box_01", "=q6="..BabbleBoss["Wolf Master Nandos"].." - One Random Drop", "=q5=Random Drop"};
    { 3, 3748, "", "=q3=Feline Mantle", "=ds=#a1#", "", "60.0%" };
    { 4, 6314, "", "=q2=Wolfmaster Cape", "=ds=#a1#", "", "40.0%" };
	};

	AtlasLoot_Data["SFKArugal"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Archmage Arugal"].." - Always Drops", "=q5=Always Drops"};
    { 2, 5442, "", "=q1=Head of Arugal", "=ds=#m3#", "", "100%" };
    { 3, 901703, "", "=q1=Fangfire Amulet", "=ds=#m3#", "", "100%" };
    { 5, 0, "INV_Box_01", "=q6="..BabbleBoss["Archmage Arugal"].." - Chance on Drop", "=q5=Chance on Drop"};
    ...
    { 9, 0, "INV_Box_01", "=q6="..BabbleBoss["Archmage Arugal"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 2, 0, "INV_Box_01", "=q6="..BabbleBoss["Stratholme Courier"].." - One Random Drop", "=q5=Random Drop"};
    { 3, 13306, "", "=q1=King's Square Postbox Key", "=ds=#e5#", "", "50.0%" };
    { 4, 13307, "", "=q1=Fras Siabi's Postbox Key", "=ds=#e5#", "", "50.0%" };
    { 6, 0, "INV_Box_01", "=q6="..BabbleBoss["Stratholme Courier"].." - One Random Drop", "=q5=Random Drop"};
    { 7, 13303, "", "=q1=Crusaders' Square Postbox Key", "=ds=#e5#", "", "50.0%" };
    { 8, 13305, "", "=q1=Elders' Square Postbox Key", "=ds=#e5#", "", "50.0%" };
    { 10, 0, "INV_Box_01", "=q6="..BabbleBoss["Stratholme Courier"].." - One Random Drop", "=q5=Random Drop"};
    { 11, 13302, "", "=q1=Market Row Postbox Key", "=ds=#e5#", "", "50.0%" };
    { 12, 13304, "", "=q1=Festival Lane Postbox Key", "=ds=#e5#", "", "50.0%" };
	};

	AtlasLoot_Data["STRATFrasSiabi"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Fras Siabi"].." - Always Drops", "=q5=Always Drops"};
    { 2, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Hearthsinger Forresten"].." - Always Drops", "=q5=Always Drops"};
    { 2, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Hearthsinger Forresten"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 5, 13174, "", "=q1=Plagued Flesh Sample", "=ds=#m3#", "", "80.0%" };
    { 7, 0, "INV_Box_01", "=q6="..BabbleBoss["Hearthsinger Forresten"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["The Unforgiven"].." - Always Drops", "=q5=Always Drops"};
    { 2, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["The Unforgiven"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 5, 13174, "", "=q1=Plagued Flesh Sample", "=ds=#m3#", "", "80.0%" };
    { 7, 0, "INV_Box_01", "=q6="..BabbleBoss["The Unforgiven"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Timmy the Cruel"].." - Always Drops", "=q5=Always Drops"};
    { 2, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Timmy the Cruel"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 5, 13174, "", "=q1=Plagued Flesh Sample", "=ds=#m3#", "", "80.0%" };
    { 7, 0, "INV_Box_01", "=q6="..BabbleBoss["Timmy the Cruel"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Cannon Master Willey"].." - Always Drops", "=q5=Always Drops"};
    { 2, 13377, "", "=q3=Miniature Cannon Balls", "=ds=#e6#", "", "100%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Cannon Master Willey"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 5, 12839, "", "=q3=Plans: Heartseeker", "=ds=#e2#", "", "6.00%" };
    { 16, 0, "INV_Box_01", "=q6="..BabbleBoss["Cannon Master Willey"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Archivist Galford"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 2, 12811, "", "=q2=Righteous Orb", "=ds=#e7#", "", "66.0%" };
    { 3, 22897, "", "=q3=Tome of Conjure Food VII", "=ds=#e2#", "", "14.0%" };
    { 5, 0, "INV_Box_01", "=q6="..BabbleBoss["Archivist Galford"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Balnazzar"].." - Always Drops", "=q5=Always Drops"};
    { 2, 13250, "", "=q1=Head of Balnazzar", "=ds=#m3#", "", "100%" };
    { 3, 901719, "", "=q1=Dathrohan's Tainted Medallion", "=ds=#m3#", "", "100%" };
    { 5, 0, "INV_Box_01", "=q6="..BabbleBoss["Balnazzar"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 6, 57483, "", "=q2=Technique: Scroll of Holy Resistance IV", "=ds=#e2#", "", "15.0%" };
    { 7, 14512, "", "=q4=Pattern: Truefaith Vestments", "=ds=#e2#", "", "6.00%" };
    { 16, 0, "INV_Box_01", "=q6="..BabbleBoss["Balnazzar"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Stonespine"].." - Always Drops", "=q5=Always Drops"};
    { 2, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Stonespine"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Baroness Anastari"].." - Always Drops", "=q5=Always Drops"};
    { 2, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Baroness Anastari"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 5, 13174, "", "=q1=Plagued Flesh Sample", "=ds=#m3#", "", "80.0%" };
    { 6, 100003, "", "=q3=Codex: Prayer of Spirit", "=ds=#e2#", "", "12.0%" };
    { 8, 0, "INV_Box_01", "=q6="..BabbleBoss["Baroness Anastari"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 16, 0, "INV_Box_01", "=q6="..BabbleBoss["Baroness Anastari"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Nerub'enkan"].." - Always Drops", "=q5=Always Drops"};
    { 2, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Nerub'enkan"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 5, 13174, "", "=q1=Plagued Flesh Sample", "=ds=#m3#", "", "80.0%" };
    { 7, 0, "INV_Box_01", "=q6="..BabbleBoss["Nerub'enkan"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 16, 0, "INV_Box_01", "=q6="..BabbleBoss["Nerub'enkan"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Maleki the Pallid"].." - Always Drops", "=q5=Always Drops"};
    { 2, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Maleki the Pallid"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 5, 100003, "", "=q3=Codex: Prayer of Spirit", "=ds=#e2#", "", "10.0%" };
    { 6, 12833, "", "=q3=Plans: Hammer of the Titans", "=ds=#e2#", "", "6.00%" };
    { 8, 0, "INV_Box_01", "=q6="..BabbleBoss["Maleki the Pallid"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 16, 0, "INV_Box_01", "=q6="..BabbleBoss["Maleki the Pallid"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Magistrate Barthilas"].." - Always Drops", "=q5=Always Drops"};
    { 2, 12382, "", "=q2=Key to the City", "=ds=#e5#", "", "100%" };
    { 3, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    { 5, 0, "INV_Box_01", "=q6="..BabbleBoss["Magistrate Barthilas"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 6, 13174, "", "=q1=Plagued Flesh Sample", "=ds=#m3#", "", "80.0%" };
    { 7, 57483, "", "=q2=Technique: Scroll of Holy Resistance IV", "=ds=#e2#", "", "15.0%" };
    { 9, 0, "INV_Box_01", "=q6="..BabbleBoss["Magistrate Barthilas"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Ramstein the Gorger"].." - Always Drops", "=q5=Always Drops"};
    { 2, 12735, "", "=q2=Frayed Abomination Stitching", "=ds=#m3#", "", "100%" };
    { 3, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    { 4, 15880, "", "=q1=Head of Ramstein the Gorger", "=ds=#m3#", "", "100%" };
    { 6, 0, "INV_Box_01", "=q6="..BabbleBoss["Ramstein the Gorger"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 7, 13174, "", "=q1=Plagued Flesh Sample", "=ds=#m3#", "", "80.0%" };
    { 9, 0, "INV_Box_01", "=q6="..BabbleBoss["Ramstein the Gorger"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Baron Rivendare"].." - Always Drops", "=q5=Always Drops"};
    { 2, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    ...
    { 7, 0, "INV_Box_01", "=q6="..BabbleBoss["Baron Rivendare"].." - Chance on Drop", "=q5=Chance on Drop"};
    ...
    { 16, 0, "INV_Box_01", "=q6="..BabbleBoss["Baron Rivendare"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Targorr the Dread"].." - Always Drops", "=q5=Always Drops"};
    { 2, 3630, "", "=q1=Head of Targorr", "=ds=#m3#", "", "100%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Targorr the Dread"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 5, 24062, "", "=q3=Enduring Talasite", "", "", "5.00%" };
    { 7, 0, "INV_Box_01", "=q6="..BabbleBoss["Targorr the Dread"].." - One Random Drop", "=q5=Random Drop"};
    { 8, 901100, "", "=q3=Dread Sword", "=ds=#w10#", "", "50.0%" };
    { 9, 901101, "", "=q3=Dread Shoulders", "=ds=#a2#", "", "50.0%" };
	};

	AtlasLoot_Data["StockKam"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Kam Deepfury"].." - Always Drops", "=q5=Always Drops"};
    { 2, 3640, "", "=q1=Head of Deepfury", "=ds=#m3#", "", "100%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Kam Deepfury"].." - One Random Drop", "=q5=Random Drop"};
    { 5, 2280, "", "=q2=Walking Stick of Kam", "=ds=#w9#", "", "33.3%" };
    { 6, 901102, "", "=q3=Tim Kam Slam", "=ds=#w6#", "", "33.3%" };
    { 7, 901103, "", "=q3=Deepfury Mantle", "=ds=#a3#", "", "33.3%" };
	};

	AtlasLoot_Data["StockBazil"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Bazil Thredd"].." - Always Drops", "=q5=Always Drops"};
    { 2, 2926, "", "=q1=Head of Bazil Thredd", "=ds=#m3#", "", "100%" };
    { 3, 901702, "", "=q1=Prison Wallet", "=ds=#m3#", "", "100%" };
    { 5, 0, "INV_Box_01", "=q6="..BabbleBoss["Bazil Thredd"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 6, 2909, "", "=q1=Red Wool Bandana", "=ds=#m3#", "", "80.0%" };
    { 8, 0, "INV_Box_01", "=q6="..BabbleBoss["Bazil Thredd"].." - One Random Drop", "=q5=Random Drop"};
    { 9, 901109, "", "=q3=Thredded Belt", "=ds=#a2#", "", "50.0%" };
    { 10, 901110, "", "=q3=Needle Thredder", "=ds=#w3#", "", "50.0%" };
	};

	AtlasLoot_Data["StockDextren"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Dextren Ward"].." - Always Drops", "=q5=Always Drops"};
    { 2, 3628, "", "=q1=Hand of Dextren Ward", "=ds=#m3#", "", "100%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Dextren Ward"].." - One Random Drop", "=q5=Random Drop"};
    { 5, 901107, "", "=q3=Grave Digging Shovel", "=ds=#w6#", "", "50.0%" };
    { 6, 901108, "", "=q3=Coffin Splinter", "=ds=#w12#", "", "50.0%" };
	};

	AtlasLoot_Data["StockBruegal"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Bruegal Ironknuckle"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 2, 2909, "", "=q1=Red Wool Bandana", "=ds=#m3#", "", "80.0%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Bruegal Ironknuckle"].." - One Random Drop", "=q5=Random Drop"};
    { 5, 3228, "", "=q3=Jimmied Handcuffs", "=ds=#a3#", "", "60.0%" };
    { 6, 2941, "", "=q3=Prison Shank", "=ds=#w4#", "", "20.0%" };
    { 7, 2942, "", "=q3=Iron Knuckles", "=ds=#w13#", "", "20.0%" };
	};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Atal'alarion"].." - Always Drops", "=q5=Always Drops"};
    { 2, 901729, "", "=q1=Shirvallah's Tear", "=ds=#m3#", "", "100%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Atal'alarion"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 5, 6181, "", "=q1=Fetish of Hakkar", "=ds=#m3#", "", "80.0%" };
    { 7, 0, "INV_Box_01", "=q6="..BabbleBoss["Atal'alarion"].." - One Random Drop", "=q5=Random Drop"};
    { 8, 10798, "", "=q3=Atal'alarion's Tusk Ring", "=ds=#a4#", "", "40.0%" };
    { 9, 10800, "", "=q3=Darkwater Bracers", "=ds=#a2#", "", "40.0%" };
    { 10, 10799, "", "=q3=Headspike", "=ds=#w7#", "", "20.0%" };
	};

	AtlasLoot_Data["STDreamscytheWeaver"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Dreamscythe"].." - Chance on Drop", "=q5=Chance on Drop"};
    ...
    { 16, 0, "INV_Box_01", "=q6="..BabbleBoss["Weaver"].." - Chance on Drop", "=q5=Chance on Drop"};
    ...
    { 2, 0, "INV_Box_01", "=q6="..BabbleBoss["Avatar of Hakkar"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Jammal'an the Prophet"].." - Always Drops", "=q5=Always Drops"};
    { 2, 6212, "", "=q1=Head of Jammal'an", "=ds=#m3#", "", "100%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Jammal'an the Prophet"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 5, 6181, "", "=q1=Fetish of Hakkar", "=ds=#m3#", "", "80.0%" };
    { 6, 57468, "", "=q2=Technique: Scroll of Arcane Resistance IV", "=ds=#e2#", "", "15.0%" };
    { 8, 0, "INV_Box_01", "=q6="..BabbleBoss["Jammal'an the Prophet"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 16, 0, "INV_Box_01", "=q6="..BabbleBoss["Ogom the Wretched"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 17, 6181, "", "=q1=Fetish of Hakkar", "=ds=#m3#", "", "80.0%" };
    { 19, 0, "INV_Box_01", "=q6="..BabbleBoss["Ogom the Wretched"].." - One Random Drop", "=q5=Random Drop"};
    { 20, 10803, "", "=q2=Blade of the Wretched", "=ds=#w10#", "", "33.3%" };
    { 21, 10804, "", "=q2=Fist of the Damned", "=ds=#w6#", "", "33.3%" };
    { 22, 10805, "", "=q2=Eater of the Dead", "=ds=#w1#", "", "33.3%" };
	};

	AtlasLoot_Data["STHazzasMorphaz"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Hazzas"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 2, 10795, "", "=q3=Drakeclaw Band", "=ds=#s13#", "", "5.00%" };
    { 3, 10796, "", "=q3=Drakestone", "=ds=#s15#", "", "5.00%" };
    { 4, 10797, "", "=q3=Firebreather", "=ds=#w10#", "", "5.00%" };
    { 5, 12243, "", "=q3=Smoldering Claw", "=ds=#w7#", "", "5.00%" };
    ...
    { 8, 12465, "", "=q3=Nightfall Drape", "=ds=#a1#", "", "5.00%" };
    { 9, 12466, "", "=q3=Dawnspire Cord", "=ds=#a1#", "", "5.00%" };
    { 16, 0, "INV_Box_01", "=q6="..BabbleBoss["Morphaz"].." - Always Drops", "=q5=Always Drops"};
    { 17, 20025, "", "=q1=Blood of Morphaz", "=ds=#m3#", "", "100%" };
    { 19, 0, "INV_Box_01", "=q6="..BabbleBoss["Morphaz"].." - Chance on Drop", "=q5=Chance on Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Shade of Eranikus"].." - Always Drops", "=q5=Always Drops"};
    { 2, 10454, "", "=q2=Essence of Eranikus", "=ds=#m3#", "", "100%" };
    { 3, 901713, "", "=q1=Dream Seed", "=ds=#m3#", "", "100%" };
    { 5, 0, "INV_Box_01", "=q6="..BabbleBoss["Shade of Eranikus"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 6, 57468, "", "=q2=Technique: Scroll of Arcane Resistance IV", "=ds=#e2#", "", "15.0%" };
    { 8, 0, "INV_Box_01", "=q6="..BabbleBoss["Shade of Eranikus"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Baelog"].." - Always Drops", "=q5=Always Drops"};
    { 2, 9399, "", "=q2=Precision Arrow", "=ds=#e6#", "", "100%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Baelog"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 5, 9401, "", "=q3=Nordic Longshank", "=ds=#w10#", "", "10.0%" };
	};

	AtlasLoot_Data["UldRevelosh"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Revelosh"].." - Always Drops", "=q5=Always Drops"};
    { 2, 7741, "", "=q1=The Shaft of Tsol", "=ds=#m3#", "", "100%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Revelosh"].." - Chance on Drop", "=q5=Chance on Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Ironaya"].." - Always Drops", "=q5=Always Drops"};
    { 2, 901728, "", "=q1=Titanforged Beacon", "=ds=#m3#", "", "100%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Ironaya"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Obsidian Sentinel"].." - Always Drops", "=q5=Always Drops"};
    { 2, 8053, "", "=q1=Obsidian Power Source", "=ds=#m3#", "", "100%" };
	};

	AtlasLoot_Data["UldAncientStoneKeeper"] = {
    { 2, 0, "INV_Box_01", "=q6="..BabbleBoss["Ancient Stone Keeper"].." - One Random Drop", "=q5=Random Drop"};
    { 3, 9410, "", "=q3=Cragfists", "=ds=#a4#", "", "50.0%" };
    { 4, 9411, "", "=q2=Rockshard Pauldrons", "=ds=#a3#", "", "50.0%" };
	};

	AtlasLoot_Data["UldGalgannFirehammer"] = {
    { 2, 0, "INV_Box_01", "=q6="..BabbleBoss["Galgann Firehammer"].." - One Random Drop", "=q5=Random Drop"};
    { 3, 11311, "", "=q2=Emberscale Cape", "=ds=#a1#", "", "40.0%" };
    { 4, 9412, "", "=q3=Galgann's Fireblaster", "=ds=#w5#", "", "20.0%" };
    { 5, 9419, "", "=q2=Galgann's Firehammer", "=ds=#w6#", "", "20.0%" };
    { 6, 11310, "", "=q3=Flameseer Mantle", "=ds=#a1#", "", "20.0%" };
	};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Grimlok"].." - Always Drops", "=q5=Always Drops"};
    { 2, 7670, "", "=q1=Shattered Necklace Sapphire", "=ds=#m3#", "", "100%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Grimlok"].." - One Random Drop", "=q5=Random Drop"};
    { 5, 9414, "", "=q2=Oilskin Leggings", "=ds=#a2#", "", "40.0%" };
    { 6, 9415, "", "=q3=Grimlok's Tribal Vestments", "=ds=#a1#", "", "40.0%" };
    { 7, 9416, "", "=q3=Grimlok's Charge", "=ds=#w7#", "", "20.0%" };
	};

	AtlasLoot_Data["UldArchaedas"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Archaedas"].." - Always Drops", "=q5=Always Drops"};
    { 2, 7672, "", "=q1=Shattered Necklace Power Source", "=ds=#m3#", "", "100%" };
    { 3, 901711, "", "=q1=Resonating Stone of Unity", "=ds=#m3#", "", "100%" };
    { 5, 0, "INV_Box_01", "=q6="..BabbleBoss["Archaedas"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 6, 57467, "", "=q2=Technique: Scroll of Arcane Resistance III", "=ds=#e2#", "", "15.0%" };
    { 8, 0, "INV_Box_01", "=q6="..BabbleBoss["Archaedas"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Antu'sul"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 2, 9523, "", "=q1=Troll Temper", "=ds=#m3#", "", "55.0%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Antu'sul"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Theka the Martyr"].." - Always Drops", "=q5=Always Drops"};
    { 2, 10660, "", "=q1=First Mosh'aru Tablet", "=ds=#m3#", "", "100%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Theka the Martyr"].." - Chance on Drop", "=q5=Chance on Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Witch Doctor Zum'rah"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 2, 18083, "", "=q3=Jumanza Grips", "=ds=#a1#", "", "30.0%" };
    { 3, 18082, "", "=q3=Zum'rah's Vexing Cane", "=ds=#w9#", "", "15.0%" };
	};

	AtlasLoot_Data["ZFNekrumGutchewer"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Nekrum Gutchewer"].." - Always Drops", "=q5=Always Drops"};
    { 2, 9471, "", "=q1=Nekrum's Medallion", "=ds=#m3#", "", "100%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Nekrum Gutchewer"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 5, 9523, "", "=q1=Troll Temper", "=ds=#m3#", "", "55.0%" };
	};

	AtlasLoot_Data["ZFSezzziz"] = {
    { 2, 0, "INV_Box_01", "=q6="..BabbleBoss["Shadowpriest Sezz'ziz"].." - One Random Drop", "=q5=Random Drop"};
    { 3, 9470, "", "=q3=Bad Mojo Mask", "=ds=#a1#", "", "25.0%" };
    { 4, 9473, "", "=q3=Jinxed Hoodoo Skin", "=ds=#a2#", "", "25.0%" };
    { 5, 9474, "", "=q3=Jinxed Hoodoo Kilt", "=ds=#a2#", "", "25.0%" };
    { 6, 9475, "", "=q3=Diabolic Skiver", "=ds=#w7#", "", "25.0%" };
	};

	AtlasLoot_Data["ZFDustwraith"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Dustwraith"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 2, 9523, "", "=q1=Troll Temper", "=ds=#m3#", "", "55.0%" };
    { 3, 12471, "", "=q3=Desertwalker Cane", "=ds=#s15#", "", "18.6%" };
	};

	AtlasLoot_Data["ZFSandfury"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Sandfury Executioner"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 2, 9523, "", "=q1=Troll Temper", "=ds=#m3#", "", "55.0%" };
	};

	AtlasLoot_Data["ZFSergeantBly"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Sergeant Bly"].." - Always Drops", "=q5=Always Drops"};
    { 2, 8548, "", "=q1=Divino-matic Rod", "=ds=#m3#", "", "100%" };
	};

	AtlasLoot_Data["ZFHydromancerVelratha"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Hydromancer Velratha"].." - Always Drops", "=q5=Always Drops"};
    { 2, 9234, "", "=q1=Tiara of the Deep", "=ds=#m3#", "", "100%" };
    { 3, 10661, "", "=q1=Second Mosh'aru Tablet", "=ds=#m3#", "", "100%" };
    { 5, 0, "INV_Box_01", "=q6="..BabbleBoss["Hydromancer Velratha"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 6, 57463, "", "=q2=Technique: Scroll of Frost Resistance IV", "=ds=#e2#", "", "15.0%" };
	};

	AtlasLoot_Data["ZFGahzrilla"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Gahz'rilla"].." - Always Drops", "=q5=Always Drops"};
    { 2, 8707, "", "=q1=Gahz'rilla's Electrified Scale", "=ds=#m3#", "", "100%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Gahz'rilla"].." - One Random Drop", "=q5=Random Drop"};
    { 5, 9467, "", "=q2=Gahz'rilla Fang", "=ds=#w4#", "", "50.0%" };
    { 6, 9469, "", "=q3=Gahz'rilla Scale Armor", "=ds=#a3#", "", "50.0%" };
	};

	AtlasLoot_Data["ZFChiefUkorzSandscalp"] = {
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Chief Ukorz Sandscalp"].." - Always Drops", "=q5=Always Drops"};
    { 2, 901712, "", "=q1=Sandfury War Drum", "=ds=#m3#", "", "100%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Chief Ukorz Sandscalp"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 5, 9523, "", "=q1=Troll Temper", "=ds=#m3#", "", "55.0%" };
    { 7, 0, "INV_Box_01", "=q6="..BabbleBoss["Chief Ukorz Sandscalp"].." - One Random Drop", "=q5=Random Drop"};
    { 8, 9476, "", "=q3=Big Bad Pauldrons", "=ds=#a4#", "", "30.0%" };
    { 9, 9477, "", "=q3=The Chief's Enforcer", "=ds=#w9#", "", "20.0%" };
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Zerillis"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 2, 9523, "", "=q1=Troll Temper", "=ds=#m3#", "", "55.0%" };
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["High Priestess Jeklik"].." - Always Drops", "=q5=Always Drops"};
    { 2, 19881, "", "=q1=Channeler's Head", "=ds=#m3#", "", "100%" };
    { 3, 57608, "", "=q3=Pattern: Drums of the Wild", "=ds=#e2#", "", "100%" };
    { 5, 0, "INV_Box_01", "=q6="..BabbleBoss["High Priestess Jeklik"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 16, 0, "INV_Box_01", "=q6="..BabbleBoss["High Priestess Jeklik"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["High Priest Venoxis"].." - Always Drops", "=q5=Always Drops"};
    { 2, 19881, "", "=q1=Channeler's Head", "=ds=#m3#", "", "100%" };
    { 3, 22216, "", "=q1=Venoxis's Venom Sac", "=ds=#m3#", "", "100%" };
    { 5, 0, "INV_Box_01", "=q6="..BabbleBoss["High Priest Venoxis"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 16, 0, "INV_Box_01", "=q6="..BabbleBoss["High Priest Venoxis"].." - One Random Drop", "=q5=Random Drop"};
    { 17, 22711, "", "=q3=Cloak of the Hakkari Worshippers", "=ds=#a1#", "", "10.0%" };
    { 18, 22712, "", "=q3=Might of the Tribe", "=ds=#a1#", "", "10.0%" };
    { 19, 22713, "", "=q3=Zulian Scepter of Rites", "=ds=#w6#", "", "10.0%" };
    { 20, 22714, "", "=q3=Sacrificial Gauntlets", "=ds=#a4#", "", "10.0%" };
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["High Priestess Mar'li"].." - Always Drops", "=q5=Always Drops"};
    { 2, 19881, "", "=q1=Channeler's Head", "=ds=#m3#", "", "100%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["High Priestess Mar'li"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 16, 0, "INV_Box_01", "=q6="..BabbleBoss["High Priestess Mar'li"].." - One Random Drop", "=q5=Random Drop"};
    { 17, 22711, "", "=q3=Cloak of the Hakkari Worshippers", "=ds=#a1#", "", "10.0%" };
    { 18, 22712, "", "=q3=Might of the Tribe", "=ds=#a1#", "", "10.0%" };
    { 19, 22713, "", "=q3=Zulian Scepter of Rites", "=ds=#w6#", "", "10.0%" };
    { 20, 22714, "", "=q3=Sacrificial Gauntlets", "=ds=#a4#", "", "10.0%" };
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Bloodlord Mandokir"].." - Always Drops", "=q5=Always Drops"};
    { 2, 22637, "", "=q3=Primal Hakkari Idol", "=ds=#e10#", "", "100%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Bloodlord Mandokir"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 5, 19872, "", "=q4=Swift Razzashi Raptor", "=ds=#e10#", "", "2.00%" };
    { 16, 0, "INV_Box_01", "=q6="..BabbleBoss["Bloodlord Mandokir"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Gahz'ranka"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 2, 22739, "", "=q3=Tome of Polymorph: Turtle", "=ds=#e2#", "", "15.0%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Gahz'ranka"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["High Priest Thekal"].." - Always Drops", "=q5=Always Drops"};
    { 2, 19881, "", "=q1=Channeler's Head", "=ds=#m3#", "", "100%" };
    { 3, 57602, "", "=q3=Pattern: Drums of Fortitude", "=ds=#e2#", "", "100%" };
    { 5, 0, "INV_Box_01", "=q6="..BabbleBoss["High Priest Thekal"].." - Chance on Drop", "=q5=Chance on Drop"};
    { 6, 19902, "", "=q4=Swift Zulian Tiger", "=ds=#e10#", "", "2.00%" };
    { 8, 0, "INV_Box_01", "=q6="..BabbleBoss["High Priest Thekal"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 16, 0, "INV_Box_01", "=q6="..BabbleBoss["High Priest Thekal"].." - One Random Drop", "=q5=Random Drop"};
    { 17, 22711, "", "=q3=Cloak of the Hakkari Worshippers", "=ds=#a1#", "", "10.0%" };
    { 18, 22712, "", "=q3=Might of the Tribe", "=ds=#a1#", "", "10.0%" };
    { 19, 22713, "", "=q3=Zulian Scepter of Rites", "=ds=#w6#", "", "10.0%" };
    { 20, 22714, "", "=q3=Sacrificial Gauntlets", "=ds=#a4#", "", "10.0%" };
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["High Priestess Arlokk"].." - Always Drops", "=q5=Always Drops"};
    { 2, 19881, "", "=q1=Channeler's Head", "=ds=#m3#", "", "100%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["High Priestess Arlokk"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 16, 0, "INV_Box_01", "=q6="..BabbleBoss["High Priestess Arlokk"].." - One Random Drop", "=q5=Random Drop"};
    { 17, 22711, "", "=q3=Cloak of the Hakkari Worshippers", "=ds=#a1#", "", "10.0%" };
    { 18, 22712, "", "=q3=Might of the Tribe", "=ds=#a1#", "", "10.0%" };
    { 19, 22713, "", "=q3=Zulian Scepter of Rites", "=ds=#w6#", "", "10.0%" };
    { 20, 22714, "", "=q3=Sacrificial Gauntlets", "=ds=#a4#", "", "10.0%" };
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Jin'do the Hexxer"].." - Always Drops", "=q5=Always Drops"};
    { 2, 22637, "", "=q3=Primal Hakkari Idol", "=ds=#e10#", "", "100%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Jin'do the Hexxer"].." - One Random Drop", "=q5=Random Drop"};
    { 5, 19884, "", "=q4=Jin'do's Judgement", "=ds=#w9#", "", "9.09%" };
    { 6, 19885, "", "=q4=Jin'do's Evil Eye", "=ds=#s2#", "", "9.09%" };
    ...
    { 12, 19891, "", "=q4=Jin'do's Bag of Whammies", "=ds=#s15#", "", "9.09%" };
    ...
    { 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Hakkar"].." - Always Drops", "=q5=Always Drops"};
    { 2, 19802, "", "=q4=Heart of Hakkar", "=ds=#m3#", "", "100%" };
    { 4, 0, "INV_Box_01", "=q6="..BabbleBoss["Hakkar"].." - One Random Drop", "=q5=Random Drop"};
    ...
    { 16, 0, "INV_Box_01", "=q6="..BabbleBoss["Hakkar"].." - One Random Drop", "=q5=Random Drop"};
