...
-- Effect 1 deals base Physical damage + 4/level + 20% AP coefficient.
-- $apbonus = attack power contribution (20% of AP)
-- $total   = base damage + AP bonus (shown in tooltip)
-- ============================================================================
DELETE FROM `spelldescriptionvariables` WHERE `id` = 189;
INSERT INTO `spelldescriptionvariables` (`id`, `var`) VALUES (189, '$apbonus=${$AP*0.2}
$total=${$m1+$<apbonus>}');
...
INSERT INTO `spelldescriptionvariables` (`id`, `var`) VALUES (190, '$imp1=$?a900129[${$900138m1*$900129m1/100}][${0}]
$imp2=$?a900130[${$900138m1*$900130m1/100}][${0}]
$total=${$900138m1+$<imp1>+$<imp2>}
$thr1=$?a900129[${$900129m2}][${0}]
$thr2=$?a900130[${$900130m2}][${0}]
$threat=${$<thr1>+$<thr2>}');

-- Rockbiter Weapon R2 (spell 8018) - references aura 900139
DELETE FROM `spelldescriptionvariables` WHERE `id` = 191;
INSERT INTO `spelldescriptionvariables` (`id`, `var`) VALUES (191, '$imp1=$?a900129[${$900139m1*$900129m1/100}][${0}]
$imp2=$?a900130[${$900139m1*$900130m1/100}][${0}]
...
INSERT INTO `spelldescriptionvariables` (`id`, `var`) VALUES (192, '$imp1=$?a900129[${$900140m1*$900129m1/100}][${0}]
$imp2=$?a900130[${$900140m1*$900130m1/100}][${0}]
...
INSERT INTO `spelldescriptionvariables` (`id`, `var`) VALUES (193, '$imp1=$?a900129[${$900141m1*$900129m1/100}][${0}]
$imp2=$?a900130[${$900141m1*$900130m1/100}][${0}]
