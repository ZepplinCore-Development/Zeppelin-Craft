...
INSERT INTO `spelldescriptionvariables` (`id`, `var`) VALUES (182, '$crop1=$?a100010[${$100010m1}][${0}]
...
INSERT INTO `spelldescriptionvariables` (`id`, `var`) VALUES (183, '$mortar=$?a91203[${1+0.01*($91203m2+1)}][$?a91202[${1+0.01*($91202m2+1)}][$?a91201[${1+0.01*($91201m2+1)}][$?a91200[${1+0.01*($91200m2+1)}][${1}]]]]
