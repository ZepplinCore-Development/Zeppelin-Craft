...
DELETE FROM `skillraceclassinfo` WHERE `skill_id` IN (43, 44, 45, 46, 54, 55, 136, 160, 162, 172, 173, 176, 226, 228, 229, 433, 473);
...
-- Maces (skill 54) - classMask 1147
INSERT INTO `skillraceclassinfo` (`id`, `skill_id`, `race_mask`, `class_mask`, `flags`, `min_level`, `skill_tier_id`, `skill_cost_id`) VALUES (1004, 54, 4095, 1147, 128, 0, 0, 0);
...
-- Staves (skill 136) - classMask 1493
INSERT INTO `skillraceclassinfo` (`id`, `skill_id`, `race_mask`, `class_mask`, `flags`, `min_level`, `skill_tier_id`, `skill_cost_id`) VALUES (1006, 136, 4095, 1493, 128, 0, 0, 0);

-- Two-Handed Maces (skill 160) - classMask 1123
INSERT INTO `skillraceclassinfo` (`id`, `skill_id`, `race_mask`, `class_mask`, `flags`, `min_level`, `skill_tier_id`, `skill_cost_id`) VALUES (1007, 160, 4095, 1123, 128, 0, 0, 0);

-- Unarmed (skill 162) - classMask 1535
INSERT INTO `skillraceclassinfo` (`id`, `skill_id`, `race_mask`, `class_mask`, `flags`, `min_level`, `skill_tier_id`, `skill_cost_id`) VALUES (1008, 162, 4095, 1535, 128, 0, 0, 0);
...
-- Daggers (skill 173) - classMask 1501
INSERT INTO `skillraceclassinfo` (`id`, `skill_id`, `race_mask`, `class_mask`, `flags`, `min_level`, `skill_tier_id`, `skill_cost_id`) VALUES (1010, 173, 4095, 1501, 128, 0, 0, 0);
...
-- Fist Weapons (skill 473) - classMask 1101
INSERT INTO `skillraceclassinfo` (`id`, `skill_id`, `race_mask`, `class_mask`, `flags`, `min_level`, `skill_tier_id`, `skill_cost_id`) VALUES (1016, 473, 4095, 1101, 128, 0, 0, 0);
