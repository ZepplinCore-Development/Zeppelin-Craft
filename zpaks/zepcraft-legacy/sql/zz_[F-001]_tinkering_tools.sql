...
INSERT INTO `item_template` SET
    ...
    `description` = 'Contains a Blacksmith Hammer and Arclight Spanner. Speeds up engineering crafting.',
    `displayid` = 134962,
    `Quality` = 6,
    `ItemLevel` = 20,
    `maxcount` = 1,
...
INSERT INTO `item_template` SET
    ...
    `description` = 'Contains a Blacksmith Hammer, Arclight Spanner and Gyromatic Micro-Adjustor. Speeds up engineering crafting.',
    `displayid` = 134961,
    `Quality` = 6,
    `ItemLevel` = 60,
    `maxcount` = 1,
...
INSERT INTO `item_template` SET
    ...
    `description` = 'Contains a Blacksmith Hammer, Arclight Spanner, Gyromatic Micro-Adjustor and Zapthrottle Mote Extractor. Speeds up engineering crafting.',
    `displayid` = 134963,
    `Quality` = 6,
    `ItemLevel` = 70,
    `maxcount` = 1,
