-- Dungeon Access
--
-- ISSUE: I-108 Dungeon Access Requirements Cleanup
-- This file needs to be split into independent feature files:
-- - Upper/Lower Stratholme separation
-- - East/West Uldaman separation
-- - Heroic dungeon requirements
-- - Mythic dungeon requirements
-- - IPP-specific: Onyxia 40man attunement
-- - IPP-specific: Naxx 40man access
-- - TBC attunements (SSC, TK, Hyjal, BT)
-- - Key requirements (various dungeon keys)
--
