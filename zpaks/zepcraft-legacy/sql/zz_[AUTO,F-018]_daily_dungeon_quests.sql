...
-- Sunken Temple Upper - Shade of Eranikus - Horde - Pool Quest
...
-- Sunken Temple Upper - Shade of Eranikus - Horde - Quest Template
...
SET `ID` = 441168,
    ...
    `LogDescription` = 'Retrieve the Dream Seed from Shade of Eranikus in Sunken Temple Upper.',
...
-- Sunken Temple Upper - Shade of Eranikus - Horde - Quest Template Addon
...
-- Sunken Temple Upper - Shade of Eranikus - Horde - Quest Offer Reward
...
-- Sunken Temple Upper - Shade of Eranikus - Horde - Quest Request Items
...
-- Sunken Temple Upper - Shade of Eranikus - Horde - Creature Quest Starter
DELETE FROM `creature_queststarter` WHERE (`quest` = 441168);
INSERT INTO `creature_queststarter`
SET`quest` = 441168,
    `id` = 14392;

-- Sunken Temple Upper - Shade of Eranikus - Horde - Creature Quest Ender
DELETE FROM `creature_questender` WHERE (`quest` = 441168);
INSERT INTO `creature_questender`
    SET `quest` = 441168,
    `id` = 14392;

-- Sunken Temple Upper - Shade of Eranikus - Horde - Quest POI (Turn-in)
...
-- Sunken Temple Upper - Shade of Eranikus - Alliance - Pool Quest
...
-- Sunken Temple Upper - Shade of Eranikus - Alliance - Quest Template
...
-- Sunken Temple Upper - Shade of Eranikus - Alliance - Quest Template Addon
...
-- Sunken Temple Upper - Shade of Eranikus - Alliance - Quest Offer Reward
...
-- Sunken Temple Upper - Shade of Eranikus - Alliance - Quest Request Items
...
-- Sunken Temple Upper - Shade of Eranikus - Alliance - Creature Quest Starter
DELETE FROM `creature_queststarter` WHERE (`quest` = 441196);
INSERT INTO `creature_queststarter`
SET`quest` = 441196,
    `id` = 29093;

-- Sunken Temple Upper - Shade of Eranikus - Alliance - Creature Quest Ender
DELETE FROM `creature_questender` WHERE (`quest` = 441196);
INSERT INTO `creature_questender`
    SET `quest` = 441196,
    `id` = 29093;

-- Sunken Temple Upper - Shade of Eranikus - Alliance - Quest POI (Turn-in)
...
-- Sunken Temple Lower - Atal''alarion - Alliance - Pool Quest
...
-- Sunken Temple Lower - Atal''alarion - Alliance - Quest Template
...
SET `ID` = 441215,
    ...
    `LogDescription` = 'Retrieve the Shirvallah''s Tear from Atal''alarion in Sunken Temple Lower.',
    `QuestDescription` = 'Howdy there, brave one! Heard tell that them Horde Zugs, led by Zuglord Runthak, are schemin'' to snatch the Dream Seed from the Shade of Eranikus in the Temple of Atal''Hakkar. And get this they''re thinkin'' ''bout startin'' a garden! Can''t let that happen! Head on down, confront the Shade of Eranikus, and bring back that Dream Seed. There''s a reward waitin'' for ya. Let''s stomp out them Horde''s gardening dreams and keep the Dream Seed safe!',
    `AreaDescription` = '',
...
-- Sunken Temple Lower - Atal''alarion - Alliance - Quest Template Addon
...
-- Sunken Temple Lower - Atal''alarion - Alliance - Quest Offer Reward
...
-- Sunken Temple Lower - Atal''alarion - Alliance - Quest Request Items
...
-- Sunken Temple Lower - Atal''alarion - Alliance - Creature Quest Starter
DELETE FROM `creature_queststarter` WHERE (`quest` = 441215);
INSERT INTO `creature_queststarter`
SET`quest` = 441215,
    `id` = 29093;

-- Sunken Temple Lower - Atal''alarion - Alliance - Creature Quest Ender
DELETE FROM `creature_questender` WHERE (`quest` = 441215);
INSERT INTO `creature_questender`
    SET `quest` = 441215,
    `id` = 29093;

-- Sunken Temple Lower - Atal''alarion - Alliance - Quest POI (Turn-in)
...
-- Sunken Temple Lower - Atal''alarion - Horde - Pool Quest
...
-- Sunken Temple Lower - Atal''alarion - Horde - Quest Template
...
-- Sunken Temple Lower - Atal''alarion - Horde - Quest Template Addon
...
-- Sunken Temple Lower - Atal''alarion - Horde - Quest Offer Reward
...
-- Sunken Temple Lower - Atal''alarion - Horde - Quest Request Items
...
-- Sunken Temple Lower - Atal''alarion - Horde - Creature Quest Starter
DELETE FROM `creature_queststarter` WHERE (`quest` = 441216);
INSERT INTO `creature_queststarter`
SET`quest` = 441216,
    `id` = 14392;

-- Sunken Temple Lower - Atal''alarion - Horde - Creature Quest Ender
DELETE FROM `creature_questender` WHERE (`quest` = 441216);
INSERT INTO `creature_questender`
    SET `quest` = 441216,
    `id` = 14392;

-- Sunken Temple Lower - Atal''alarion - Horde - Quest POI (Turn-in)
