...
--- World Bosses
    ...
    { 17, 25739, "", "=q3=Pattern: Felstalker Bracers", "=ds=#p7#"};
    { 18, 25740, "", "=q3=Pattern: Felstalker Breastplate", "=ds=#p7#"};
    { 19, 35339, "", "=q3=Satin Hood", "=ds=#s1#, #a1#"};
    { 20, 35409, "", "=q3=Savage Plate Helm", "=ds=#s1#, #a4#"};
    { 21, 35383, "", "=q3=Seer's Linked Helm", "=ds=#s1#, #a3#"};
    { 22, 35386, "", "=q3=Seer's Mail Armor", "=ds=#s5#, #a3#"};
    { 23, 35392, "", "=q3=Seer's Ringmail Gloves", "=ds=#s9#, #a3#"};
    { 24, 35377, "", "=q3=Stalker's Chain Gauntlets", "=ds=#s9#, #a3#"};
    { 25, 35371, "", "=q3=Wyrmhide Gloves", "=ds=#s9#, #a2#"};
    { 26, 29197, "", "=q2=Arcanum of Fire Warding", "=ds=#m3#"};
    { 27, 31361, "", "=q1=Pattern: Cobrahide Leg Armor", "=ds=#p7#"};
    { 28, 24001, "", "=q1=Recipe: Elixir of Major Agility", "=ds=#p1#"};
    { 29, 29232, "", "=q1=Recipe: Transmute Skyfire Diamond", "=ds=#p1#"};
    ...
    { 6, 29190, "", "=q2=Arcanum of Renewal", "=ds=#m3#"};
    { 7, 30637, "", "=q1=Flamewrought Key", "=ds=#e5#"};
    { 8, 24003, "", "=q1=Formula: Enchant Chest - Exceptional Stats", "=ds=#p4#"};
    { 9, 34201, "", "=q1=Pattern: Netherscale Ammo Pouch", "=ds=#p7#"};
    { 16, 0, "INV_BannerPVP_01", "=q6=#r5#", ""};
    { 17, 29152, "", "=q4=Marksman's Bow", "=ds=#w2#"};
    { 18, 29155, "", "=q4=Stormcaller", "=ds=#h3#, #w10#"};
    { 19, 29165, "", "=q4=Warbringer", "=ds=#h1#, #w1#"};
    { 20, 33151, "", "=q3=Formula: Enchant Cloak - Subtlety", "=ds=#p4#"};
    { 21, 31362, "", "=q1=Pattern: Nethercobra Leg Armor", "=ds=#p7#"};
    { 22, 24002, "", "=q1=Plans: Felsteel Shield Spike", "=ds=#p2#"};
    Prev = "Thrallmar1";
    Back = "REPMENU_BURNINGCRUSADE";
	};

	AtlasLoot_Data["Thrallmar3"] = {
    { 1, 0, "INV_BannerPVP_01", "=q6=#r4#", ""};
    { 2, 29168, "", "=q3=Ancestral Band", "=ds=#s13#"};
    { 3, 29167, "", "=q3=Blackened Spear", "=ds=#h2#, #w7#"};
    { 4, 31358, "", "=q3=Design: Dawnstone Crab", "=ds=#p12#"};
    ...
    { 4, 33209, "", "=q2=Recipe: Flask of Chromatic Wonder", "=ds=#p1#"};
    ...
    { 13, 33124, "", "=q3=Pattern: Cloak of Darkness", "=ds=#p7#"};
    ...
    { 2, 35500, "", "=q1=Formula: Enchant Chest - Defense", "=ds=#p4#"};
    { 3, 34872, "", "=q1=Formula: Void Shatter", "=ds=#p4#"};
    { 4, 35221, "", "=q1=Tabard of the Shattered Sun", "=ds=#s7#"};
    { 6, 0, "inv_shield_48", "=q6=#r4#", ""};
    { 7, 35769, "", "=q4=Design: Forceful Seaspray Emerald", "=ds=#p12#"};
    { 8, 35768, "", "=q4=Design: Quick Lionseye", "=ds=#p12#"};
    { 9, 35767, "", "=q4=Design: Reckless Pyrestone", "=ds=#p12#"};
    { 10, 35766, "", "=q4=Design: Steady Seaspray Emerald", "=ds=#p12#"};
    { 11, 34667, "", "=q3=Archmage's Guile", "=ds=#h3#, #w10#"};
    { 12, 34665, "", "=q3=Bombardier's Blade", "=ds=#h1#, #w4#"};
    { 13, 34672, "", "=q3=Inuuro's Blade", "=ds=#h1#, #w10#"};
    { 14, 34671, "", "=q3=K'iru's Presage", "=ds=#h3#, #w6#"};
    { 15, 34673, "", "=q3=Legionfoe", "=ds=#h2#, #w1#"};
    { 16, 34670, "", "=q3=Seeker's Gavel", "=ds=#h3#, #w6#"};
    { 17, 34666, "", "=q3=The Sunbreaker", "=ds=#h1#, #w10#"};
    { 18, 34674, "", "=q3=Truestrike Crossbow", "=ds=#w3#"};
    { 19, 29193, "", "=q2=Arcanum of the Gladiator", "=ds=#m3#"};
    { 20, 35505, "", "=q1=Design: Ember Skyfire Diamond", "=ds=#p12#"};
    { 21, 35502, "", "=q1=Design: Eternal Earthstorm Diamond", "=ds=#p12#"};
    { 22, 35697, "", "=q1=Design: Figurine - Crimson Serpent", "=ds=#p12#"};
    { 23, 35695, "", "=q1=Design: Figurine - Empyrean Tortoise", "=ds=#p12#"};
    { 24, 35696, "", "=q1=Design: Figurine - Khorium Boar", "=ds=#p12#"};
    { 25, 35699, "", "=q1=Design: Figurine - Seaspray Albatross", "=ds=#p12#"};
    { 26, 35698, "", "=q1=Design: Figurine - Shadowsong Panther", "=ds=#p12#"};
    { 27, 35708, "", "=q1=Design: Regal Nightseye", "=ds=#p12#"};
    Next = "SunOffensive2";
    Back = "REPMENU_BURNINGCRUSADE";
	};
    ...
    { 3, 34678, "", "=q4=Shattered Sun Pendant of Acumen", "=ds=#s2#"};
    { 4, 34679, "", "=q4=Shattered Sun Pendant of Might", "=ds=#s2#"};
    { 5, 34680, "", "=q4=Shattered Sun Pendant of Resolve", "=ds=#s2#"};
    { 6, 34677, "", "=q4=Shattered Sun Pendant of Restoration", "=ds=#s2#"};
    { 7, 34675, "", "=q4=Sunward Crest", "=ds=#w8#, #w8#"};
    { 8, 35755, "", "=q1=Recipe: Assassin's Alchemist Stone", "=ds=#p1#"};
    { 9, 35752, "", "=q1=Recipe: Guardian's Alchemist Stone", "=ds=#p1#"};
    { 10, 35754, "", "=q1=Recipe: Redeemer's Alchemist Stone", "=ds=#p1#"};
    { 11, 35753, "", "=q1=Recipe: Sorcerer's Alchemist Stone", "=ds=#p1#"};
    Prev = "SunOffensive1";
    Back = "REPMENU_BURNINGCRUSADE";
	};
    ...
    { 2, 25904, "", "=q1=Design: Insightful Earthstorm Diamond", "=ds=#p12#"};
    { 4, 0, "Ability_Warrior_ShieldMastery", "=q6=#r3#", ""};
    { 5, 35404, "", "=q3=Crusader's Ornamented Headguard", "=ds=#s1#, #a4#"};
    { 6, 35416, "", "=q3=Crusader's Scaled Shoulders", "=ds=#s3#, #a4#"};
    { 7, 30826, "", "=q3=Design: Ring of Arcane Shielding", "=ds=#p12#"};
    { 8, 35359, "", "=q3=Dragonhide Spaulders", "=ds=#s3#, #a2#"};
    { 9, 35330, "", "=q3=Dreadweave Leggings", "=ds=#s11#, #a1#"};
    { 10, 35345, "", "=q3=Evoker's Silk Handguards", "=ds=#s9#, #a1#"};
    { 11, 35362, "", "=q3=Kodohide Helm", "=ds=#s1#, #a2#"};
    { 12, 35333, "", "=q3=Mooncloth Cowl", "=ds=#s1#, #a1#"};
    { 13, 35368, "", "=q3=Opportunist's Leather Legguards", "=ds=#s11#, #a2#"};
    { 14, 35341, "", "=q3=Satin Mantle", "=ds=#s3#, #a1#"};
    { 15, 35407, "", "=q3=Savage Plate Chestpiece", "=ds=#s5#, #a4#"};
    { 16, 35381, "", "=q3=Seer's Linked Armor", "=ds=#s5#, #a3#"};
    { 17, 35388, "", "=q3=Seer's Mail Helm", "=ds=#s1#, #a3#"};
    { 18, 35395, "", "=q3=Seer's Ringmail Shoulderpads", "=ds=#s3#, #a3#"};
    { 19, 35380, "", "=q3=Stalker's Chain Spaulders", "=ds=#s3#, #a3#"};
    { 20, 35375, "", "=q3=Wyrmhide Robe", "=ds=#s5#, #a2#"};
    { 21, 29195, "", "=q2=Arcanum of Arcane Warding", "=ds=#m3#"};
    { 22, 28273, "", "=q2=Formula: Enchant Gloves - Major Healing", "=ds=#p4#"};
    { 23, 33155, "", "=q1=Design: Kailee's Rose", "=ds=#p12#"};
    { 24, 29717, "", "=q1=Pattern: Drums of Battle", "=ds=#p7#"};
    ...
    { 2, 29180, "", "=q3=Blessed Scale Girdle", "=ds=#s10#, #a3#"};
    { 3, 24182, "", "=q3=Design: Talasite Owl", "=ds=#p12#"};
    { 4, 29179, "", "=q3=Xi'ri's Gift", "=ds=#s14#"};
    { 5, 29191, "", "=q2=Arcanum of Power", "=ds=#m3#"};
    { 6, 28281, "", "=q2=Formula: Enchant Weapon - Major Healing", "=ds=#p4#"};
    { 7, 22915, "", "=q2=Recipe: Transmute Primal Air to Fire", "=ds=#p1#"};
    { 8, 33159, "", "=q1=Design: Blood of Amber", "=ds=#p12#"};
    { 9, 22537, "", "=q1=Formula: Enchant Ring - Healing Power", "=ds=#p4#"};
    { 10, 13517, "", "=q1=Recipe: Alchemist's Stone", "=ds=#p1#"};
    ...
    { 21, 31354, "", "=q2=Recipe: Flask of the Titans", "=ds=#p1#"};
    Prev = "Shatar1";
    Back = "REPMENU_BURNINGCRUSADE";
	};

	AtlasLoot_Data["Shatar3"] = {
    { 1, 0, "Ability_Warrior_ShieldMastery", "=q6=#r4#", ""};
    { 2, 29180, "", "=q3=Blessed Scale Girdle", "=ds=#s10#, #a3#"};
    { 3, 24182, "", "=q3=Design: Talasite Owl", "=ds=#p12#"};
    { 4, 29179, "", "=q3=Xi'ri's Gift", "=ds=#s14#"};
    ...
    { 13, 35340, "", "=q3=Satin Leggings", "=ds=#s11#, #a1#"};
    { 14, 35411, "", "=q3=Savage Plate Shoulders", "=ds=#s3#, #a4#"};
    { 15, 35382, "", "=q3=Seer's Linked Gauntlets", "=ds=#s9#, #a3#"};
    { 16, 35389, "", "=q3=Seer's Mail Leggings", "=ds=#s11#, #a3#"};
    { 17, 35391, "", "=q3=Seer's Ringmail Chestguard", "=ds=#s5#, #a3#"};
    { 18, 35378, "", "=q3=Stalker's Chain Helm", "=ds=#s1#, #a3#"};
    { 19, 35373, "", "=q3=Wyrmhide Legguards", "=ds=#s11#, #a2#"};
    { 20, 29199, "", "=q2=Arcanum of Shadow Warding", "=ds=#m3#"};
    { 21, 22538, "", "=q1=Formula: Enchant Ring - Stats", "=ds=#p4#"};
    { 22, 31778, "", "=q1=Lower City Tabard", "=ds=#s7#"};
    { 23, 30833, "", "=q1=Pattern: Cloak of Arcane Evasion", "=ds=#p7#"};
    Next = "LowerCity2";
    Back = "REPMENU_BURNINGCRUSADE";
	};
    ...
    { 2, 24179, "", "=q3=Design: Felsteel Boar", "=ds=#p12#"};
    { 3, 24175, "", "=q3=Design: Pendant of Thawing", "=ds=#p12#"};
    { 4, 30836, "", "=q3=Leggings of the Skettis Exile", "=ds=#s11#, #a1#"};
    { 5, 30841, "", "=q3=Lower City Prayerbook", "=ds=#s14#"};
    { 6, 30835, "", "=q3=Salvager's Hauberk", "=ds=#s5#, #a3#"};
    { 7, 30846, "", "=q2=Arcanum of the Outcast", "=ds=#m3#"};
    { 8, 22910, "", "=q2=Recipe: Elixir of Major Shadow Power", "=ds=#p1#"};
    { 9, 30633, "", "=q1=Auchenai Key", "=ds=#e5#"};
    { 10, 33157, "", "=q1=Design: Falling Star", "=ds=#p12#"};
    { 11, 34200, "", "=q1=Pattern: Quiver of a Thousand Feathers", "=ds=#p7#"};
    ...
    { 21, 31357, "", "=q2=Recipe: Flask of Chromatic Resistance", "=ds=#p1#"};
    Prev = "LowerCity1";
    Back = "REPMENU_BURNINGCRUSADE";
	};

	AtlasLoot_Data["LowerCity3"] = {
    { 1, 0, "Spell_Holy_ChampionsBond", "=q6=#r4#", ""};
    { 2, 24179, "", "=q3=Design: Felsteel Boar", "=ds=#p12#"};
    { 3, 24175, "", "=q3=Design: Pendant of Thawing", "=ds=#p12#"};
    { 4, 30836, "", "=q3=Leggings of the Skettis Exile", "=ds=#s11#, #a1#"};
    ...
    { 2, 35402, "", "=q3=Crusader's Ornamented Chestplate", "=ds=#s5#, #a4#"};
    { 3, 35414, "", "=q3=Crusader's Scaled Helm", "=ds=#s1#, #a4#"};
    { 4, 35356, "", "=q3=Dragonhide Gloves", "=ds=#s9#, #a2#"};
    { 5, 35328, "", "=q3=Dreadweave Gloves", "=ds=#s9#, #a1#"};
    { 6, 35346, "", "=q3=Evoker's Silk Raiment", "=ds=#s5#, #a1#"};
    { 7, 35363, "", "=q3=Kodohide Legguards", "=ds=#s11#, #a2#"};
    { 8, 35334, "", "=q3=Mooncloth Legguards", "=ds=#s11#, #a1#"};
    { 9, 35369, "", "=q3=Opportunist's Leather Spaulders", "=ds=#s3#, #a2#"};
    { 10, 35338, "", "=q3=Satin Gloves", "=ds=#s9#, #a1#"};
    { 11, 35410, "", "=q3=Savage Plate Legguards", "=ds=#s11#, #a4#"};
    { 12, 35384, "", "=q3=Seer's Linked Leggings", "=ds=#s11#, #a3#"};
    { 13, 35390, "", "=q3=Seer's Mail Spaulders", "=ds=#s3#, #a3#"};
    { 14, 35393, "", "=q3=Seer's Ringmail Headpiece", "=ds=#s1#, #a3#"};
    { 15, 35376, "", "=q3=Stalker's Chain Armor", "=ds=#s5#, #a3#"};
    { 16, 35372, "", "=q3=Wyrmhide Helm", "=ds=#s1#, #a2#"};
    { 17, 29198, "", "=q2=Arcanum of Frost Warding", "=ds=#m3#"};
    { 18, 28272, "", "=q2=Formula: Enchant Gloves - Major Spellpower", "=ds=#p4#"};
    { 19, 25910, "", "=q1=Design: Enigmatic Skyfire Diamond", "=ds=#p12#"};
    { 20, 33160, "", "=q1=Design: Facet of Eternity", "=ds=#p12#"};
    { 21, 22536, "", "=q1=Formula: Enchant Ring - Spellpower", "=ds=#p4#"};
    { 22, 31777, "", "=q1=Keepers of Time Tabard", "=ds=#s7#"};
    { 23, 29713, "", "=q1=Pattern: Drums of Panic", "=ds=#p7#"};
    Next = "KeepersofTime2";
    Back = "REPMENU_BURNINGCRUSADE";
	};
    ...
    { 3, 24181, "", "=q3=Design: Living Ruby Serpent", "=ds=#p12#"};
    { 4, 24174, "", "=q3=Design: Pendant of Frozen Flame", "=ds=#p12#"};
    { 5, 29184, "", "=q3=Timewarden's Leggings", "=ds=#s11#, #a4#"};
    { 6, 29186, "", "=q2=Arcanum of the Defender", "=ds=#m3#"};
    { 7, 33158, "", "=q1=Design: Stone of Blades", "=ds=#p12#"};
    ...
    { 15, 31355, "", "=q2=Recipe: Flask of Supreme Power", "=ds=#p1#"};
    Prev = "KeepersofTime1";
    Back = "REPMENU_BURNINGCRUSADE";
	};
    ...
    { 8, 29115, "", "=q3=Consortium Blaster", "=ds=#w5#"};
    { 9, 24178, "", "=q3=Design: Pendant of the Null Rune", "=ds=#p12#"};
    { 10, 29116, "", "=q3=Nomad's Leggings", "=ds=#s11#, #a2#"};
    { 11, 25734, "", "=q3=Pattern: Fel Leather Leggings", "=ds=#p7#"};
    { 12, 29117, "", "=q3=Stormspire Vest", "=ds=#s5#, #a1#"};
    { 13, 33156, "", "=q1=Design: Crimson Sun", "=ds=#p12#"};
    { 14, 33305, "", "=q1=Design: Don Julio's Heart", "=ds=#p12#"};
    { 15, 23874, "", "=q1=Schematic: Elemental Seaforium Charge", "=ds=#p5#"};
    { 16, 0, "INV_Weapon_Shortblade_31", "=q6=#r3#", ""};
    { 17, 29456, "", "=q3=Gift of the Ethereal", "=ds=#h1#, #w10#"};
    { 18, 29457, "", "=q3=Nethershard", "=ds=#h3#, #w4#"};
    { 19, 25733, "", "=q3=Pattern: Fel Leather Boots", "=ds=#p7#"};
    { 20, 29118, "", "=q3=Smuggler's Ammo Pouch", "=ds=#e11#"};
    { 21, 23134, "", "=q2=Design: Delicate Blood Garnet", "=ds=#p12#"};
    { 22, 23155, "", "=q2=Design: Lustrous Azure Moonstone", "=ds=#p12#"};
    { 23, 23150, "", "=q2=Design: Thick Golden Draenite", "=ds=#p12#"};
    { 24, 31776, "", "=q1=Consortium Tabard", "=ds=#s7#"};
    { 25, 25908, "", "=q1=Design: Swift Skyfire Diamond", "=ds=#p12#"};
    { 26, 22552, "", "=q1=Formula: Enchant Weapon - Major Striking", "=ds=#p4#"};
    { 27, 24314, "", "=q1=Pattern: Bag of Jewels", "=ds=#p8#"};
    Next = "Consortium2";
    Back = "REPMENU_BURNINGCRUSADE";
	};
    ...
    { 2, 32429, "", "=q1=Pattern: Boots of Shackled Souls", "=ds=#p7#"};
    { 3, 32430, "", "=q1=Pattern: Bracers of Shackled Souls", "=ds=#p7#"};
    { 4, 32436, "", "=q1=Pattern: Redeemed Soul Cinch", "=ds=#p7#"};
    { 5, 32435, "", "=q1=Pattern: Redeemed Soul Legguards", "=ds=#p7#"};
    { 6, 32438, "", "=q1=Pattern: Soulguard Bracers", "=ds=#p7#"};
    { 7, 32440, "", "=q1=Pattern: Soulguard Girdle", "=ds=#p7#"};
    { 8, 32442, "", "=q1=Plans: Shadesteel Bracers", "=ds=#p2#"};
    { 9, 32444, "", "=q1=Plans: Shadesteel Girdle", "=ds=#p2#"};
    { 16, 0, "achievement_reputation_ashtonguedeathsworn", "=q6=#r3#", ""};
    { 17, 902004, "", "=q1=Ashtongue Deathsworn Tabard", "=ds=#s7#"};
    { 18, 32431, "", "=q1=Pattern: Greaves of Shackled Souls", "=ds=#p7#"};
    { 19, 32447, "", "=q1=Pattern: Night's End", "=ds=#p7#"};
    { 20, 32433, "", "=q1=Pattern: Redeemed Soul Moccasins", "=ds=#p7#"};
    { 21, 32434, "", "=q1=Pattern: Redeemed Soul Wristguards", "=ds=#p7#"};
    { 22, 32439, "", "=q1=Pattern: Soulguard Leggings", "=ds=#p7#"};
    { 23, 32437, "", "=q1=Pattern: Soulguard Slippers", "=ds=#p7#"};
    { 24, 32432, "", "=q1=Pattern: Waistguard of Shackled Souls", "=ds=#p7#"};
    { 25, 32443, "", "=q1=Plans: Shadesteel Greaves", "=ds=#p2#"};
    { 26, 32441, "", "=q1=Plans: Shadesteel Sabots", "=ds=#p2#"};
    Next = "Ashtongue2";
    Back = "REPMENU_BURNINGCRUSADE";
	};
    ...
    { 12, 29149, "", "=q3=Sporeling's Firestick", "=ds=#w12#"};
    { 13, 22916, "", "=q2=Recipe: Transmute Primal Earth to Water", "=ds=#p1#"};
    { 14, 38229, "", "=q1=Pattern: Mycah's Botanical Bag", "=ds=#p8#"};
    { 16, 0, "inv_mushroom_11", "=q6=#r5#", ""};
    { 17, 34478, "", "=q3=Tiny Sporebat", "=ds=#e10#"};
    { 18, 22906, "", "=q2=Recipe: Shrouding Potion", "=ds=#p1#"};
    Back = "REPMENU_BURNINGCRUSADE";
	};
    ...
    { 2, 23133, "", "=q2=Design: Runed Blood Garnet", "=ds=#p12#"};
    { 3, 23597, "", "=q1=Plans: Enchanted Adamantite Belt", "=ds=#p2#"};
    { 5, 0, "INV_Misc_Foot_Centaur", "=q6=#r3#", ""};
    { 6, 23143, "", "=q2=Design: Dazzling Deep Peridot", "=ds=#p12#"};
    { 7, 29701, "", "=q1=Pattern: Enchanted Clefthoof Boots", "=ds=#p7#"};
    { 8, 29682, "", "=q1=Pattern: Enchanted Felscale Gloves", "=ds=#p7#"};
    { 9, 24292, "", "=q1=Pattern: Mystic Spellthread", "=ds=#p8#"};
    { 10, 23598, "", "=q1=Plans: Enchanted Adamantite Boots", "=ds=#p2#"};
    ...
    { 19, 29131, "", "=q3=Retainer's Leggings", "=ds=#s11#, #a2#"};
    { 20, 29132, "", "=q3=Scryer's Bloodgem", "=ds=#s14#"};
    { 21, 29133, "", "=q3=Seer's Cane", "=ds=#h2#, #w9#"};
    { 22, 22908, "", "=q2=Recipe: Elixir of Major Firepower", "=ds=#p1#"};
    { 23, 29700, "", "=q1=Pattern: Enchanted Clefthoof Gloves", "=ds=#p7#"};
    { 24, 29684, "", "=q1=Pattern: Enchanted Felscale Boots", "=ds=#p7#"};
    { 25, 25722, "", "=q1=Pattern: Magister's Armor Kit", "=ds=#p7#"};
    { 26, 23599, "", "=q1=Plans: Enchanted Adamantite Breastplate", "=ds=#p2#"};
    Next = "Scryer2";
    Back = "REPMENU_BURNINGCRUSADE";
	};
    ...
    { 3, 29126, "", "=q4=Seer's Signet", "=ds=#s13#"};
    { 4, 29698, "", "=q1=Pattern: Enchanted Clefthoof Leggings", "=ds=#p7#"};
    { 5, 29677, "", "=q1=Pattern: Enchanted Felscale Leggings", "=ds=#p7#"};
    { 6, 24294, "", "=q1=Pattern: Runic Spellthread", "=ds=#p8#"};
    { 7, 23600, "", "=q1=Plans: Enchanted Adamantite Leggings", "=ds=#p2#"};
    Prev = "Scryer1";
    Back = "REPMENU_BURNINGCRUSADE";
	};
    ...
    { 7, 31773, "", "=q1=Mag'har Tabard", "=ds=#s7#"};
    { 8, 34174, "", "=q1=Pattern: Drums of Restoration", "=ds=#p7#"};
    { 9, 34172, "", "=q1=Pattern: Drums of Speed", "=ds=#p7#"};
    { 10, 29664, "", "=q1=Pattern: Reinforced Mining Bag", "=ds=#p8#"};
	...
	AtlasLoot_Data["Maghar2"] = {
    { 1, 0, "INV_Misc_Foot_Centaur", "=q6=#r5#", ""};
    { 2, 31829, "", "=q4=Reins of the Cobalt Riding Talbuk", "=ds=#e10#"};
    { 3, 29102, "", "=q4=Reins of the Cobalt War Talbuk", "=ds=#e10#"};
    { 4, 31831, "", "=q4=Reins of the Silver Riding Talbuk", "=ds=#e10#"};
    { 5, 29104, "", "=q4=Reins of the Silver War Talbuk", "=ds=#e10#"};
    { 6, 31833, "", "=q4=Reins of the Tan Riding Talbuk", "=ds=#e10#"};
    { 7, 29105, "", "=q4=Reins of the Tan War Talbuk", "=ds=#e10#"};
    { 8, 31835, "", "=q4=Reins of the White Riding Talbuk", "=ds=#e10#"};
    { 9, 29103, "", "=q4=Reins of the White War Talbuk", "=ds=#e10#"};
    { 10, 29139, "", "=q3=Ceremonial Cover", "=ds=#s4#, #a1#"};
    { 11, 29135, "", "=q3=Earthcaller's Headdress", "=ds=#s1#, #a3#"};
    { 12, 29137, "", "=q3=Hellscream's Will", "=ds=#h2#, #w1#"};
    Prev = "Maghar1";
    Back = "REPMENU_BURNINGCRUSADE";
	};
    ...
    { 8, 34175, "", "=q1=Pattern: Drums of Restoration", "=ds=#p7#"};
    { 9, 34173, "", "=q1=Pattern: Drums of Speed", "=ds=#p7#"};
    { 10, 30444, "", "=q1=Pattern: Reinforced Mining Bag", "=ds=#p8#"};
    { 12, 0, "INV_Misc_Foot_Centaur", "=q6=#r4#", ""};
	...
	AtlasLoot_Data["Kurenai2"] = {
    { 1, 0, "INV_Misc_Foot_Centaur", "=q6=#r5#", ""};
    { 2, 31830, "", "=q4=Reins of the Cobalt Riding Talbuk", "=ds=#e10#"};
    { 3, 29227, "", "=q4=Reins of the Cobalt War Talbuk", "=ds=#e10#"};
    { 4, 31832, "", "=q4=Reins of the Silver Riding Talbuk", "=ds=#e10#"};
    { 5, 29229, "", "=q4=Reins of the Silver War Talbuk", "=ds=#e10#"};
    { 6, 31834, "", "=q4=Reins of the Tan Riding Talbuk", "=ds=#e10#"};
    { 7, 29230, "", "=q4=Reins of the Tan War Talbuk", "=ds=#e10#"};
    { 8, 31836, "", "=q4=Reins of the White Riding Talbuk", "=ds=#e10#"};
    { 9, 29231, "", "=q4=Reins of the White War Talbuk", "=ds=#e10#"};
    { 10, 29138, "", "=q3=Arechron's Gift", "=ds=#h2#, #w6#"};
    { 11, 29140, "", "=q3=Cloak of the Ancient Spirits", "=ds=#s4#, #a1#"};
    { 12, 29136, "", "=q3=Far Seer's Helm", "=ds=#s1#, #a3#"};
    Prev = "Kurenai1";
    Back = "REPMENU_BURNINGCRUSADE";
	};
    ...
    { 11, 25736, "", "=q3=Pattern: Heavy Clefthoof Leggings", "=ds=#p7#"};
    { 12, 25735, "", "=q3=Pattern: Heavy Clefthoof Vest", "=ds=#p7#"};
    { 13, 25836, "", "=q3=Preserver's Cudgel", "=ds=#h3#, #w6#"};
    { 14, 35342, "", "=q3=Satin Robe", "=ds=#s5#, #a1#"};
    { 15, 35408, "", "=q3=Savage Plate Gauntlets", "=ds=#s9#, #a4#"};
    { 16, 35385, "", "=q3=Seer's Linked Spaulders", "=ds=#s3#, #a3#"};
    { 17, 35387, "", "=q3=Seer's Mail Gauntlets", "=ds=#s9#, #a3#"};
    { 18, 35394, "", "=q3=Seer's Ringmail Legguards", "=ds=#s11#, #a3#"};
    { 19, 35379, "", "=q3=Stalker's Chain Leggings", "=ds=#s11#, #a3#"};
    { 20, 25838, "", "=q3=Warden's Hauberk", "=ds=#s5#, #a2#"};
    { 21, 35374, "", "=q3=Wyrmhide Spaulders", "=ds=#s3#, #a2#"};
    { 22, 29194, "", "=q2=Arcanum of Nature Warding", "=ds=#m3#"};
    { 23, 31804, "", "=q1=Cenarion Expedition Tabard", "=ds=#s7#"};
    { 24, 29720, "", "=q1=Pattern: Clefthide Leg Armor", "=ds=#p7#"};
    { 25, 23618, "", "=q1=Plans: Adamantite Sharpening Stone", "=ds=#p2#"};
    { 26, 28632, "", "=q1=Plans: Adamantite Weightstone", "=ds=#p2#"};
    { 27, 25526, "", "=q1=Plans: Greater Rune of Warding", "=ds=#p2#"};
    { 28, 32070, "", "=q1=Recipe: Earthen Elixir", "=ds=#p1#"};
    { 29, 25869, "", "=q1=Recipe: Transmute Earthstorm Diamond", "=ds=#p1#"};
    Next = "CExpedition3";
    Prev = "CExpedition1";
    Back = "REPMENU_BURNINGCRUSADE";
	};
    ...
    { 21, 31390, "", "=q4=Plans: Wildguard Breastplate", "=ds=#p2#"};
    { 22, 29170, "", "=q4=Windcaller's Orb", "=ds=#s15#"};
    { 23, 33149, "", "=q3=Formula: Enchant Cloak - Stealth", "=ds=#p4#"};
    { 24, 31356, "", "=q2=Recipe: Flask of Distilled Wisdom", "=ds=#p1#"};
    { 25, 29721, "", "=q1=Pattern: Nethercleft Leg Armor", "=ds=#p7#"};
    ...
    { 2, 23149, "", "=q2=Design: Gleaming Golden Draenite", "=ds=#p12#"};
    { 3, 30842, "", "=q1=Pattern: Flameheart Bracers", "=ds=#p7#"};
    { 4, 23601, "", "=q1=Plans: Flamebane Bracers", "=ds=#p2#"};
    { 6, 0, "INV_Jewelry_Talisman_08", "=q6=#r3#", ""};
    { 7, 29129, "", "=q3=Anchorite's Robes", "=ds=#s5#, #a1#"};
    { 8, 23145, "", "=q2=Design: Royal Shadow Draenite", "=ds=#p12#"};
    { 9, 31779, "", "=q1=Aldor Tabard", "=ds=#s7#"};
    { 10, 29704, "", "=q1=Pattern: Blastguard Belt", "=ds=#p7#"};
    { 11, 30843, "", "=q1=Pattern: Flameheart Gloves", "=ds=#p7#"};
    { 12, 29693, "", "=q1=Pattern: Flamescale Belt", "=ds=#p7#"};
    { 13, 24293, "", "=q1=Pattern: Silver Spellthread", "=ds=#p8#"};
    { 14, 23603, "", "=q1=Plans: Flamebane Gloves", "=ds=#p2#"};
    ...
    { 20, 29127, "", "=q3=Vindicator's Hauberk", "=ds=#s5#, #a4#"};
    { 21, 29703, "", "=q1=Pattern: Blastguard Boots", "=ds=#p7#"};
    { 22, 29691, "", "=q1=Pattern: Flamescale Boots", "=ds=#p7#"};
    { 23, 25721, "", "=q1=Pattern: Vindicator's Armor Kit", "=ds=#p7#"};
    { 24, 23604, "", "=q1=Plans: Flamebane Breastplate", "=ds=#p2#"};
    Next = "Aldor2";
    Back = "REPMENU_BURNINGCRUSADE";
	};
    ...
    { 3, 29124, "", "=q4=Vindicator's Brand", "=ds=#h1#, #w10#"};
    { 4, 29702, "", "=q1=Pattern: Blastguard Pants", "=ds=#p7#"};
    { 5, 30844, "", "=q1=Pattern: Flameheart Vest", "=ds=#p7#"};
    { 6, 29689, "", "=q1=Pattern: Flamescale Leggings", "=ds=#p7#"};
    { 7, 24295, "", "=q1=Pattern: Golden Spellthread", "=ds=#p8#"};
    { 8, 23602, "", "=q1=Plans: Flamebane Helm", "=ds=#p2#"};
    Prev = "Aldor1";
    Back = "REPMENU_BURNINGCRUSADE";
	};
    ...
    { 16, 29214, "", "=q3=Pattern: Felstalker Bracers", "=ds=#p7#"};
    { 17, 29215, "", "=q3=Pattern: Felstalker Breastplate", "=ds=#p7#"};
    { 18, 25826, "", "=q3=Sage's Band", "=ds=#s13#"};
    { 19, 35466, "", "=q3=Satin Hood", "=ds=#s1#, #a1#"};
    { 20, 35478, "", "=q3=Savage Plate Helm", "=ds=#s1#, #a4#"};
    { 21, 35474, "", "=q3=Seer's Linked Helm", "=ds=#s1#, #a3#"};
    { 22, 35472, "", "=q3=Seer's Mail Armor", "=ds=#s5#, #a3#"};
    { 23, 35473, "", "=q3=Seer's Ringmail Gloves", "=ds=#s9#, #a3#"};
    { 24, 35475, "", "=q3=Stalker's Chain Gauntlets", "=ds=#s9#, #a3#"};
    { 25, 35471, "", "=q3=Wyrmhide Gloves", "=ds=#s9#, #a2#"};
    { 26, 29196, "", "=q2=Arcanum of Fire Warding", "=ds=#m3#"};
    { 27, 23999, "", "=q1=Honor Hold Tabard", "=ds=#s7#"};
    { 28, 29719, "", "=q1=Pattern: Cobrahide Leg Armor", "=ds=#p7#"};
    { 29, 22905, "", "=q1=Recipe: Elixir of Major Agility", "=ds=#p1#"};
    { 30, 25870, "", "=q1=Recipe: Transmute Skyfire Diamond", "=ds=#p1#"};
    Next = "HonorHold2";
    Back = "REPMENU_BURNINGCRUSADE";
	};
    ...
    { 5, 29169, "", "=q3=Ring of Convalescence", "=ds=#s13#"};
    { 6, 29189, "", "=q2=Arcanum of Renewal", "=ds=#m3#"};
    { 7, 30622, "", "=q1=Flamewrought Key", "=ds=#e5#"};
    { 8, 22547, "", "=q1=Formula: Enchant Chest - Exceptional Stats", "=ds=#p4#"};
    { 9, 34218, "", "=q1=Pattern: Netherscale Ammo Pouch", "=ds=#p7#"};
    ...
    { 20, 33150, "", "=q3=Formula: Enchant Cloak - Subtlety", "=ds=#p4#"};
    { 21, 29722, "", "=q1=Pattern: Nethercobra Leg Armor", "=ds=#p7#"};
    { 22, 23619, "", "=q1=Plans: Felsteel Shield Spike", "=ds=#p2#"};
    Prev = "HonorHold1";
    Back = "REPMENU_BURNINGCRUSADE";
	};
	AtlasLoot_Data["HonorHold3"] = {
    { 1, 0, "INV_BannerPVP_02", "=q6=#r4#", ""};
    { 2, 24180, "", "=q3=Design: Dawnstone Crab", "=ds=#p12#"};
    { 3, 32883, "", "=q3=Felbane Slugs", "=ds=#e6#"};
    { 4, 29166, "", "=q3=Hellforged Halberd", "=ds=#h2#, #w7#"};
