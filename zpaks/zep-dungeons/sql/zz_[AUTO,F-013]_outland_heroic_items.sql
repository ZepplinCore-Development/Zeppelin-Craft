...
DELETE FROM `item_template` WHERE `entry` BETWEEN 62200 AND 63199;
...
INSERT INTO `item_template` SET
  ...
  `subclass` = 4,
  `SoundOverrideSubclass` = -1,
  `name` = 'Joint Hammer of Literature',
  `displayid` = 0,
  `Quality` = 4,
  `Flags` = 8,
  `InventoryType` = 21,
...
INSERT INTO `item_template` SET
  ...
  `subclass` = 15,
  `SoundOverrideSubclass` = -1,
  `name` = 'Spotted Slicer of the Emergency',
  `displayid` = 0,
  `Quality` = 4,
  `Flags` = 8,
  `InventoryType` = 21,
...
INSERT INTO `item_template` SET
  ...
  `subclass` = 4,
  `SoundOverrideSubclass` = -1,
  `name` = 'Fist of Excitedly Considering',
  `displayid` = 0,
  `Quality` = 4,
  `Flags` = 8,
  `InventoryType` = 21,
...
INSERT INTO `item_template` SET
  ...
  `subclass` = 15,
  `SoundOverrideSubclass` = -1,
  `name` = 'Passionately Excusable Barb',
  `displayid` = 0,
  `Quality` = 4,
  `Flags` = 8,
  `InventoryType` = 21,
...
INSERT INTO `item_template` SET
  ...
  `subclass` = 4,
  `SoundOverrideSubclass` = -1,
  `name` = 'Pummeler of the Believable College',
  `displayid` = 0,
  `Quality` = 4,
  `Flags` = 8,
  `InventoryType` = 21,
