...
-- spell_bonus_data
-- ============================================================================
DELETE FROM `spell_bonus_data` WHERE `entry` IN (900116, 900117, 900118, 900119, 900122, 900121);

INSERT INTO `spell_bonus_data` (`entry`, `direct_bonus`, `dot_bonus`, `ap_bonus`, `ap_dot_bonus`, `comments`) VALUES
(900119, 0, 0, 0.25, 0, 'Rockslam - 25% AP as bonus physical damage'),
(900122, 0.30, 0, 0, 0, 'Volcanic Shield (triggered) - 30% SP as bonus nature damage on block'),
(900121, 0, 0, 0.20, 0, 'Tectonic Blast - 20% AP as bonus nature damage');

-- ============================================================================
-- spell_threat - Tectonic Blast high threat multiplier
-- ============================================================================
DELETE FROM `spell_threat` WHERE `entry` = 900121;
