...
-- The C++ SpellScript SOURCE (spell_sha_stonebond, spell_sha_stonebond_pulse, spell_sha_stonebond_split) stays in core
...
-- ============================================================================
DELETE FROM `spell_script_names` WHERE `spell_id` IN (5730, 6390, 6391, 6392, 10427, 10428, 25525, 58580, 58581, 58582, 900222, 900224, 900226);
...
-- Stonebond split (900222): range-gate the soak — null the split when the totem is >30 yds from the shaman
(900222, 'spell_sha_stonebond_split'),
