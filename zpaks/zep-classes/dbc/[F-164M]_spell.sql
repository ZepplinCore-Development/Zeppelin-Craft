...
INSERT INTO `spell` SET
    ...
    `spell_subtext_enus` = 'Rank 1',
    `spell_subtext_flags` = 16712190,
    `spell_desc_enus` = 'Increases your armor from items by $s1%, and reduces your chance to be critically hit by melee attacks by $s3%.',
    `spell_desc_flags` = 16712190,
    `spell_tooltip_enus` = 'Increases armor from items by $s1%; reduces your chance to be critically hit by $s3%.',
    `spell_tooltip_flags` = 16712188,
    `effect_damage_multiplier_1` = 1.0,
...
-- E2: aura 150 (MOD_SHIELD_BLOCKVALUE_PCT) - +5/10/15% block value (moved here from Molten Plating).
-- ============================================================================
...
INSERT INTO `spell` SET
    ...
    `spell_subtext_enus` = 'Rank 1',
    `spell_subtext_flags` = 16712190,
    `spell_desc_enus` = 'Your successful blocks have a $s1% chance to block double the normal amount, and increase your block value by $s2%.',
    `spell_desc_flags` = 16712190,
    `spell_tooltip_flags` = 16712188,
    `effect_damage_multiplier_1` = 1.0,
    `effect_damage_multiplier_2` = 1.0,
...
-- Bulwark Rank 3 (900202) - +30% critical block, +15% block value
...
-- Stoneforged (900192, 900193, 900194) - Passive, 3 ranks (was Ironhide)
-- E1: aura 317 MOD_STAT_OF_ARMOR, misc 0 (Str) - +1 Strength per base_points armor (150/100/50).
-- E2: aura 107 ADD_FLAT_MODIFIER, misc 7 (SPELLMOD_CRITICAL_CHANCE), mask_b_3 = 1835008
--     -> +5/10/15% crit chance to Rockslam (262144) + Crag Strike (524288) + Rocksurge (1048576).
-- Icon 4614.
-- ============================================================================
...
INSERT INTO `spell` SET
    ...
    `effect_spell_class_mask_b_3` = 1835008,
    `spell_icon_id` = 4614,
    `spell_priority` = 50,
    ...
    `spell_subtext_enus` = 'Rank 1',
    `spell_subtext_flags` = 16712190,
    `spell_desc_enus` = 'Increases your Strength by 1 for every $s1 armor value you have, and increases the critical strike chance of Rockslam, Rocksurge and Crag Strike by $s2%.',
    `spell_desc_flags` = 16712190,
    `spell_tooltip_flags` = 16712188,
    `effect_damage_multiplier_1` = 1.0,
    `effect_damage_multiplier_2` = 1.0,
