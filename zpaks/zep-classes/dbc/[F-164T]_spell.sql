...
-- 900296 Glyph of Thunderborne Leap (Inscription CREATE_ITEM recipe -> item 57496).
-- Reagent Celestial Ink (43120). Split from [F-164]_spell.sql with the rest of the glyph.
DELETE FROM `spell` WHERE `id` = 900296;
