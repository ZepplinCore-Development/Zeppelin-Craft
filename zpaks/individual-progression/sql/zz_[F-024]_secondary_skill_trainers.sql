...
-- FISHING
-- ============================================================================
-- IPP removes: 18249 (req 125), 54083 (req 225), 54084 (req 350)
...
--   18249 Artisan Fishing       (req 125) - REMOVED by IPP
--   54083 Expert Fishing        (req 225) - REMOVED by IPP
--   54084 Master Fishing        (req 350) - REMOVED by IPP
--   51293 Grand Master Fishing  (req 350) - only on trainer 97
--
-- Trainer mapping:
--   647 = Starting area (Journeyman)  - no changes needed
--   98  = Old world (Artisan)         - add 18249, 54083
--   99  = Outland (Master)            - add 18249, 54083, 54084
--   97  = Northrend (Grand Master)    - add 18249, 54083, 54084
-- ============================================================================
...
(98, 18249, 5000, 356, 125, 0),
(98, 54083, 100000, 356, 225, 0);

-- Master tier: Outland trainers (TrainerId 99)
DELETE FROM `trainer_spell` WHERE `TrainerId` = 99 AND `SpellId` IN (18249, 54083, 54084);
INSERT INTO `trainer_spell` (`TrainerId`, `SpellId`, `MoneyCost`, `ReqSkillLine`, `ReqSkillRank`, `ReqLevel`) VALUES
(99, 18249, 5000, 356, 125, 0),
(99, 54083, 100000, 356, 225, 0),
(99, 54084, 350000, 356, 350, 0);
...
INSERT INTO `trainer_spell` (`TrainerId`, `SpellId`, `MoneyCost`, `ReqSkillLine`, `ReqSkillRank`, `ReqLevel`) VALUES
(97, 18249, 5000, 356, 125, 0),
(97, 54083, 100000, 356, 225, 0),
(97, 54084, 350000, 356, 350, 0);
...
-- COOKING
-- ============================================================================
-- IPP removes: 18261 (req 125), 19886 (req 200), 54256 (req 275), 54257 (req 350)
-- Spell progression by ReqSkillRank:
--   2551  Apprentice Cook  (req 0)   - already on trainers
--   3412  Journeyman Cook  (req 50)  - already on trainers
--   18261 Artisan Cook     (req 125) - REMOVED by IPP
--   19886 Expert Cook      (req 200) - REMOVED by IPP
...
INSERT INTO `trainer_spell` (`TrainerId`, `SpellId`, `MoneyCost`, `ReqSkillLine`, `ReqSkillRank`, `ReqLevel`) VALUES
(75, 18261, 5000, 185, 125, 0),
(75, 19886, 25000, 185, 200, 0),
...
-- FIRST AID
-- ============================================================================
-- IPP removes: 10847 (req 125), 54255 (req 225), 54254 (req 350)
-- Spell progression by ReqSkillRank:
--   3279  Apprentice First Aid    (req 0)   - already on trainers
--   3280  Journeyman First Aid    (req 50)  - already on trainers
--   10847 Artisan First Aid       (req 125) - REMOVED by IPP
--   54255 Master First Aid        (req 225) - REMOVED by IPP
--   54254 Expert First Aid        (req 350) - REMOVED by IPP
--   50299 Grand Master First Aid  (req 350) - only on trainer 81
--
-- Trainer mapping:
--   645 = Old world (Artisan)         - add 10847, 54255
--   646 = Doctors (Artisan)           - add 10847, 54255
--   82  = Outland (Master)            - add 10847, 54255, 54254
--   83  = Generic (Master)            - add 10847, 54255, 54254
--   81  = Northrend (Grand Master)    - add 10847, 54255, 54254
-- ============================================================================

-- Artisan tier: Old world trainers (TrainerId 645)
DELETE FROM `trainer_spell` WHERE `TrainerId` = 645 AND `SpellId` IN (10847, 54255);
INSERT INTO `trainer_spell` (`TrainerId`, `SpellId`, `MoneyCost`, `ReqSkillLine`, `ReqSkillRank`, `ReqLevel`) VALUES
(645, 10847, 5000, 129, 125, 0),
(645, 54255, 100000, 129, 225, 0);

-- Artisan tier: Doctor trainers (TrainerId 646) — already teach Artisan bandages
DELETE FROM `trainer_spell` WHERE `TrainerId` = 646 AND `SpellId` IN (10847, 54255);
INSERT INTO `trainer_spell` (`TrainerId`, `SpellId`, `MoneyCost`, `ReqSkillLine`, `ReqSkillRank`, `ReqLevel`) VALUES
(646, 10847, 5000, 129, 125, 0),
(646, 54255, 100000, 129, 225, 0);

-- Master tier: Outland trainers (TrainerId 82)
DELETE FROM `trainer_spell` WHERE `TrainerId` = 82 AND `SpellId` IN (10847, 54255, 54254);
INSERT INTO `trainer_spell` (`TrainerId`, `SpellId`, `MoneyCost`, `ReqSkillLine`, `ReqSkillRank`, `ReqLevel`) VALUES
(82, 10847, 5000, 129, 125, 0),
(82, 54255, 100000, 129, 225, 0),
(82, 54254, 350000, 129, 350, 0);

-- Master tier: Generic trainer (TrainerId 83)
DELETE FROM `trainer_spell` WHERE `TrainerId` = 83 AND `SpellId` IN (10847, 54255, 54254);
INSERT INTO `trainer_spell` (`TrainerId`, `SpellId`, `MoneyCost`, `ReqSkillLine`, `ReqSkillRank`, `ReqLevel`) VALUES
(83, 10847, 5000, 129, 125, 0),
(83, 54255, 100000, 129, 225, 0),
(83, 54254, 350000, 129, 350, 0);
...
DELETE FROM `trainer_spell` WHERE `TrainerId` = 81 AND `SpellId` IN (10847, 54255, 54254);
INSERT INTO `trainer_spell` (`TrainerId`, `SpellId`, `MoneyCost`, `ReqSkillLine`, `ReqSkillRank`, `ReqLevel`) VALUES
(81, 10847, 5000, 129, 125, 0),
(81, 54255, 100000, 129, 225, 0),
(81, 54254, 350000, 129, 350, 0);
