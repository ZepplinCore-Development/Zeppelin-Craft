...
-- FISHING
-- ============================================================================
-- IPP removes: 54083 (req 125), 18249 (req 225), 54084 (req 350)
...
--   18249 Artisan Fishing       (req 225) - REMOVED by IPP
...
-- FIRST AID
-- ============================================================================
-- IPP removes: 54254 (req 125), 10847 (req 225), 54255 (req 350)
-- Spell progression by ReqSkillRank:
...
--   10847 Artisan First Aid       (req 225) - REMOVED by IPP
--   54255 Master First Aid        (req 350) - REMOVED by IPP
...
DELETE FROM `trainer_spell` WHERE `TrainerId` = 645 AND `SpellId` IN (54254, 10847);
INSERT INTO `trainer_spell` (`TrainerId`, `SpellId`, `MoneyCost`, `ReqSkillLine`, `ReqSkillRank`, `ReqLevel`) VALUES
(645, 54254, 5000, 129, 125, 0),
(645, 10847, 100000, 129, 225, 0);

-- Artisan tier: Doctor trainers (TrainerId 646) — already teach Artisan bandages
DELETE FROM `trainer_spell` WHERE `TrainerId` = 646 AND `SpellId` IN (54254, 10847);
INSERT INTO `trainer_spell` (`TrainerId`, `SpellId`, `MoneyCost`, `ReqSkillLine`, `ReqSkillRank`, `ReqLevel`) VALUES
(646, 54254, 5000, 129, 125, 0),
(646, 10847, 100000, 129, 225, 0);
...
(82, 10847, 100000, 129, 225, 0),
(82, 54255, 350000, 129, 350, 0);
...
(83, 10847, 100000, 129, 225, 0),
(83, 54255, 350000, 129, 350, 0);
...
(81, 10847, 100000, 129, 225, 0),
(81, 54255, 350000, 129, 350, 0);
