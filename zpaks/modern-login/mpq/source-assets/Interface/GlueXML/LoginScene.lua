...
ModelList = {
	...
	sceneData = {
		{10,"Interface/Extras/Black.blp"}
	},
	
	-- Scene: 1
	{1, -0.500, 0.400, -0.500, 3.783, 0.600, 1.000, _, 1, 1, 1, "interface/glues/models/ui_demonhunter/ui_demonhunter.m2", _, _},
	{1, -0.479, 0.993, -0.200, 0.400, 0.123, 1.000, _, 1, 1, 1, "world/generic/activedoodads/spellportals/7fx_orderhallportal_deadscarrift.m2", _, _},
	{1, -1.435, 0.033, 0.000, 5.683, 0.259, 1.000, _, 1, 1, 1, "world/expansion05/doodads/dungeon/doodads/6du_hellfireraid_feltree01.m2", _, _}
}
