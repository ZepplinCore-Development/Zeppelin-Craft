...
--------------------
  ...
  -- Auch: Auchenai Crypts
	...
	AtlasLoot_TableNames["AuchCryptsShirrakMYTHIC"] = { "Shirrak the Dead Watcher (Mythic)", "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["AuchCryptsShirrakHEROIC"] = { BabbleBoss["Shirrak the Dead Watcher"].." ("..AL["Heroic"]..")", "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["AuchCryptsExarch"] = { BabbleBoss["Exarch Maladaar"], "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["AuchCryptsExarchMYTHIC"] = { "Exarch Maladaar (Mythic)", "AtlasLootBurningCrusade" };
  ...
  -- Auch: Mana-Tombs
	...
	AtlasLoot_TableNames["AuchManaPandemoniusMYTHIC"] = { "Pandemonius (Mythic)", "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["AuchManaPandemoniusHEROIC"] = { BabbleBoss["Pandemonius"].." ("..AL["Heroic"]..")", "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["AuchManaPaxivi"] = { "Ambassador Pax'ivi ("..AL["Heroic"]..")", "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["AuchManaTavarok"] = { BabbleBoss["Tavarok"], "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["AuchManaTavarokMYTHIC"] = { "Tavarok (Mythic)", "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["AuchManaTavarokHEROIC"] = { BabbleBoss["Tavarok"].." ("..AL["Heroic"]..")", "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["AuchManaNexusPrince"] = { BabbleBoss["Nexus-Prince Shaffar"], "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["AuchManaNexusPrinceMYTHIC"] = { "Nexus-Prince Shaffar (Mythic)", "AtlasLootBurningCrusade" };
  ...
  -- Auch: Sethekk Halls
	...
	AtlasLoot_TableNames["AuchSethekkDarkweaverMYTHIC"] = { "Darkweaver Syth (Mythic)", "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["AuchSethekkDarkweaverHEROIC"] = { BabbleBoss["Darkweaver Syth"].." ("..AL["Heroic"]..")", "AtlasLootBurningCrusade" };
	...
	AtlasLoot_TableNames["AuchSethekkTalonKingMYTHIC"] = { "Talon King Ikiss (Mythic)", "AtlasLootBurningCrusade" };
  ...
  -- Auch: Shadow Labyrinth
	...
	AtlasLoot_TableNames["AuchShadowHellmawMYTHIC"] = { "Ambassador Hellmaw (Mythic)", "AtlasLootBurningCrusade" };
	...
	AtlasLoot_TableNames["AuchShadowBlackheartMYTHIC"] = { "Blackheart the Inciter (Mythic)", "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["AuchShadowBlackheartHEROIC"] = { BabbleBoss["Blackheart the Inciter"].." ("..AL["Heroic"]..")", "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["AuchShadowGrandmaster"] = { BabbleBoss["Grandmaster Vorpil"], "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["AuchShadowGrandmasterMYTHIC"] = { "Grandmaster Vorpil (Mythic)", "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["AuchShadowGrandmasterHEROIC"] = { BabbleBoss["Grandmaster Vorpil"].." ("..AL["Heroic"]..")", "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["AuchShadowMurmur"] = { BabbleBoss["Murmur"], "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["AuchShadowMurmurMYTHIC"] = { "Murmur (Mythic)", "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["AuchShadowMurmurHEROIC"] = { BabbleBoss["Murmur"].." ("..AL["Heroic"]..")", "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["AuchTrash"] = { "Trash Mobs (Auchindoun)", "AtlasLootBurningCrusade" };
  -- The Black Temple
  ...
  -- CFR: Slave Pens
	...
	AtlasLoot_TableNames["CFRSlaveMennuMYTHIC"] = { "Mennu the Betrayer (Mythic)", "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["CFRSlaveMennuHEROIC"] = { BabbleBoss["Mennu the Betrayer"].." ("..AL["Heroic"]..")", "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["CFRSlaveRokmar"] = { BabbleBoss["Rokmar the Crackler"], "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["CFRSlaveRokmarMYTHIC"] = { "Rokmar the Crackler (Mythic)", "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["CFRSlaveRokmarHEROIC"] = { BabbleBoss["Rokmar the Crackler"].." ("..AL["Heroic"]..")", "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["CFRSlaveQuagmirran"] = { BabbleBoss["Quagmirran"], "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["CFRSlaveQuagmirranMYTHIC"] = { "Quagmirran (Mythic)", "AtlasLootBurningCrusade" };
  ...
  -- CFR: The Steamvault
	...
	AtlasLoot_TableNames["CFRSteamThespiaMYTHIC"] = { "Hydromancer Thespia (Mythic)", "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["CFRSteamThespiaHEROIC"] = { BabbleBoss["Hydromancer Thespia"].." ("..AL["Heroic"]..")", "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["CFRSteamSteamrigger"] = { BabbleBoss["Mekgineer Steamrigger"], "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["CFRSteamSteamriggerMYTHIC"] = { "Mekgineer Steamrigger (Mythic)", "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["CFRSteamSteamriggerHEROIC"] = { BabbleBoss["Mekgineer Steamrigger"].." ("..AL["Heroic"]..")", "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["CFRSteamWarlord"] = { BabbleBoss["Warlord Kalithresh"], "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["CFRSteamWarlordMYTHIC"] = { "Warlord Kalithresh (Mythic)", "AtlasLootBurningCrusade" };
  ...
  -- CFR: The Underbog
	...
	AtlasLoot_TableNames["CFRUnderHungarfenMYTHIC"] = { "Hungarfen (Mythic)", "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["CFRUnderHungarfenHEROIC"] = { BabbleBoss["Hungarfen"].." ("..AL["Heroic"]..")", "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["CFRUnderGhazan"] = { BabbleBoss["Ghaz'an"], "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["CFRUnderGhazanMYTHIC"] = { "Ghaz'an (Mythic)", "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["CFRUnderGhazanHEROIC"] = { BabbleBoss["Ghaz'an"].." ("..AL["Heroic"]..")", "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["CFRUnderSwamplord"] = { BabbleBoss["Swamplord Musel'ek"], "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["CFRUnderSwamplordMYTHIC"] = { "Swamplord Musel'ek (Mythic)", "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["CFRUnderSwamplordHEROIC"] = { BabbleBoss["Swamplord Musel'ek"].." ("..AL["Heroic"]..")", "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["CFRUnderStalker"] = { BabbleBoss["The Black Stalker"], "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["CFRUnderStalkerMYTHIC"] = { "The Black Stalker (Mythic)", "AtlasLootBurningCrusade" };
  ...
  -- CoT: Old Hillsbrad Foothills
	...
	AtlasLoot_TableNames["CoTHillsbradDrakeMYTHIC"] = { "Lieutenant Drake (Mythic)", "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["CoTHillsbradDrakeHEROIC"] = { BabbleBoss["Lieutenant Drake"].." ("..AL["Heroic"]..")", "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["CoTHillsbradSkarloc"] = { BabbleBoss["Captain Skarloc"], "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["CoTHillsbradSkarlocMYTHIC"] = { "Captain Skarloc (Mythic)", "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["CoTHillsbradSkarlocHEROIC"] = { BabbleBoss["Captain Skarloc"].." ("..AL["Heroic"]..")", "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["CoTHillsbradHunter"] = { BabbleBoss["Epoch Hunter"], "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["CoTHillsbradHunterMYTHIC"] = { "Epoch Hunter (Mythic)", "AtlasLootBurningCrusade" };
  ...
  -- CoT: Black Morass
	...
	AtlasLoot_TableNames["CoTMorassDejaMYTHIC"] = { "Chrono Lord Deja (Mythic)", "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["CoTMorassDejaHEROIC"] = { BabbleBoss["Chrono Lord Deja"].." ("..AL["Heroic"]..")", "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["CoTMorassTemporus"] = { BabbleBoss["Temporus"], "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["CoTMorassTemporusMYTHIC"] = { "Temporus (Mythic)", "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["CoTMorassTemporusHEROIC"] = { BabbleBoss["Temporus"].." ("..AL["Heroic"]..")", "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["CoTMorassAeonus"] = { BabbleBoss["Aeonus"], "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["CoTMorassAeonusMYTHIC"] = { "Aeonus (Mythic)", "AtlasLootBurningCrusade" };
  ...
  -- HC: Blood Furnace
	...
	AtlasLoot_TableNames["HCFurnaceMakerMYTHIC"] = { "The Maker (Mythic)", "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["HCFurnaceMakerHEROIC"] = { BabbleBoss["The Maker"].." ("..AL["Heroic"]..")", "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["HCFurnaceBroggok"] = { BabbleBoss["Broggok"], "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["HCFurnaceBroggokMYTHIC"] = { "Broggok (Mythic)", "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["HCFurnaceBroggokHEROIC"] = { BabbleBoss["Broggok"].." ("..AL["Heroic"]..")", "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["HCFurnaceBreaker"] = { BabbleBoss["Keli'dan the Breaker"], "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["HCFurnaceBreakerMYTHIC"] = { "Keli'dan the Breaker (Mythic)", "AtlasLootBurningCrusade" };
  ...
  -- HC: Ramparts
	...
	AtlasLoot_TableNames["HCRampWatchkeeperMYTHIC"] = { "Watchkeeper Gargolmar (Mythic)", "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["HCRampWatchkeeperHEROIC"] = { BabbleBoss["Watchkeeper Gargolmar"].." ("..AL["Heroic"]..")", "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["HCRampOmor"] = { BabbleBoss["Omor the Unscarred"], "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["HCRampOmorMYTHIC"] = { "Omor the Unscarred (Mythic)", "AtlasLootBurningCrusade" };
	...
	AtlasLoot_TableNames["HCRampVazrudenMYTHIC"] = { "Vazruden (Mythic)", "AtlasLootBurningCrusade" };
  ...
  -- HC: Shattered Halls
	...
	AtlasLoot_TableNames["HCHallsNethekurseMYTHIC"] = { "Grand Warlock Nethekurse (Mythic)", "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["HCHallsNethekurseHEROIC"] = { BabbleBoss["Grand Warlock Nethekurse"].." ("..AL["Heroic"]..")", "AtlasLootBurningCrusade" };
	...
	AtlasLoot_TableNames["HCHallsOmroggMYTHIC"] = { "Warbringer O'mrogg (Mythic)", "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["HCHallsOmroggHEROIC"] = { BabbleBoss["Warbringer O'mrogg"].." ("..AL["Heroic"]..")", "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["HCHallsKargath"] = { BabbleBoss["Warchief Kargath Bladefist"], "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["HCHallsKargathMYTHIC"] = { "Warchief Kargath Bladefist (Mythic)", "AtlasLootBurningCrusade" };
  ...
  -- Sunwell Isle: Magister's Terrace
	...
	AtlasLoot_TableNames["SMTFireheartMYTHIC"] = { "Selin Fireheart (Mythic)", "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["SMTVexallus"] = { BabbleBoss["Vexallus"], "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["SMTVexallusMYTHIC"] = { "Vexallus (Mythic)", "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["SMTDelrissa"] = { BabbleBoss["Priestess Delrissa"], "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["SMTDelrissaMYTHIC"] = { "Priestess Delrissa (Mythic)", "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["SMTKaelthas"] = { BabbleBoss["Kael'thas Sunstrider"], "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["SMTKaelthasMYTHIC"] = { "Kael'thas Sunstrider (Mythic)", "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["SMTKaelthasHEROIC"] = { BabbleBoss["Kael'thas Sunstrider"].." ("..AL["Heroic"]..")", "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["SMTFireheartHEROIC"] = { BabbleBoss["Selin Fireheart"].." ("..AL["Heroic"]..")", "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["SMTVexallusHEROIC"] = { BabbleBoss["Vexallus"].." ("..AL["Heroic"]..")", "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["SMTDelrissaHEROIC"] = { BabbleBoss["Priestess Delrissa"].." ("..AL["Heroic"]..")", "AtlasLootBurningCrusade" };
  ...
  -- TK: The Arcatraz
	...
	AtlasLoot_TableNames["TKArcUnboundMYTHIC"] = { "Zereketh the Unbound (Mythic)", "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["TKArcUnboundHEROIC"] = { BabbleBoss["Zereketh the Unbound"].." ("..AL["Heroic"]..")", "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["TKArcDalliah"] = { BabbleBoss["Dalliah the Doomsayer"], "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["TKArcDalliahMYTHIC"] = { "Dalliah the Doomsayer (Mythic)", "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["TKArcDalliahHEROIC"] = { BabbleBoss["Dalliah the Doomsayer"].." ("..AL["Heroic"]..")", "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["TKArcScryer"] = { BabbleBoss["Wrath-Scryer Soccothrates"], "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["TKArcScryerMYTHIC"] = { "Wrath-Scryer Soccothrates (Mythic)", "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["TKArcScryerHEROIC"] = { BabbleBoss["Wrath-Scryer Soccothrates"].." ("..AL["Heroic"]..")", "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["TKArcHarbinger"] = { BabbleBoss["Harbinger Skyriss"], "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["TKArcHarbingerMYTHIC"] = { "Harbinger Skyriss (Mythic)", "AtlasLootBurningCrusade" };
  ...
  -- TK: The Botanica
	...
	AtlasLoot_TableNames["TKBotSarannisMYTHIC"] = { "Commander Sarannis (Mythic)", "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["TKBotSarannisHEROIC"] = { BabbleBoss["Commander Sarannis"].." ("..AL["Heroic"]..")", "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["TKBotFreywinn"] = { BabbleBoss["High Botanist Freywinn"], "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["TKBotFreywinnMYTHIC"] = { "High Botanist Freywinn (Mythic)", "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["TKBotFreywinnHEROIC"] = { BabbleBoss["High Botanist Freywinn"].." ("..AL["Heroic"]..")", "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["TKBotThorngrin"] = { BabbleBoss["Thorngrin the Tender"], "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["TKBotThorngrinMYTHIC"] = { "Thorngrin the Tender (Mythic)", "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["TKBotThorngrinHEROIC"] = { BabbleBoss["Thorngrin the Tender"].." ("..AL["Heroic"]..")", "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["TKBotLaj"] = { BabbleBoss["Laj"], "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["TKBotLajMYTHIC"] = { "Laj (Mythic)", "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["TKBotLajHEROIC"] = { BabbleBoss["Laj"].." ("..AL["Heroic"]..")", "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["TKBotSplinter"] = { BabbleBoss["Warp Splinter"], "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["TKBotSplinterMYTHIC"] = { "Warp Splinter (Mythic)", "AtlasLootBurningCrusade" };
  ...
  -- TK: The Mechanar
	...
	AtlasLoot_TableNames["TKMechCapacitusMYTHIC"] = { "Mechano-Lord Capacitus (Mythic)", "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["TKMechCapacitusHEROIC"] = { BabbleBoss["Mechano-Lord Capacitus"].." ("..AL["Heroic"]..")", "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["TKMechSepethrea"] = { BabbleBoss["Nethermancer Sepethrea"], "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["TKMechSepethreaMYTHIC"] = { "Nethermancer Sepethrea (Mythic)", "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["TKMechSepethreaHEROIC"] = { BabbleBoss["Nethermancer Sepethrea"].." ("..AL["Heroic"]..")", "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["TKMechCalc"] = { BabbleBoss["Pathaleon the Calculator"], "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["TKMechCalcMYTHIC"] = { "Pathaleon the Calculator (Mythic)", "AtlasLootBurningCrusade" };
...
-------------------------
  ...
  -- Blackfathom Deeps
	...
	AtlasLoot_TableNames["BFDGhamooraMYTHIC"] = { "Mythic Ghamoo-ra (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["BFDGhamooraHEROIC"] = { "Heroic Ghamoo-ra (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["BFDSarevess"] = { BabbleBoss["Lady Sarevess"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["BFDSarevessMYTHIC"] = { "Mythic Lady Sarevess (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["BFDSarevessHEROIC"] = { "Heroic Lady Sarevess (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["BFDGelihast"] = { BabbleBoss["Gelihast"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["BFDGelihastMYTHIC"] = { "Mythic Gelihast (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["BFDGelihastHEROIC"] = { "Heroic Gelihast (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["BFDAquanis"] = { BabbleBoss["Baron Aquanis"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["BFDAquanisMYTHIC"] = { "Mythic Baron Aquanis (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["BFDAquanisHEROIC"] = { "Heroic Baron Aquanis (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["BFDKelris"] = { BabbleBoss["Twilight Lord Kelris"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["BFDKelrisMYTHIC"] = { "Mythic Twilight Lord Kelris (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["BFDKelrisHEROIC"] = { "Heroic Twilight Lord Kelris (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["BFDSerrakis"] = { BabbleBoss["Old Serra'kis"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["BFDSerrakisMYTHIC"] = { "Mythic Old Serra'kis (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["BFDSerrakisHEROIC"] = { "Heroic Old Serra'kis (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["BFDAkumai"] = { BabbleBoss["Aku'mai"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["BFDAkumaiMYTHIC"] = { "Mythic Aku'mai (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["BFDAkumaiHEROIC"] = { "Heroic Aku'mai (Heroic)", "AtlasLootOriginalWoW" };
  -- Blackrock Mountain
  ...
  -- Blackrock Depths
	...
	AtlasLoot_TableNames["BRDLordRoccorMYTHIC"] = { "Mythic Lord Roccor (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["BRDLordRoccorHEROIC"] = { "Heroic Lord Roccor (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["BRDHighInterrogatorGerstahn"] = { BabbleBoss["High Interrogator Gerstahn"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["BRDHighInterrogatorGerstahnMYTHIC"] = { "Mythic High Interrogator Gerstahn (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["BRDHighInterrogatorGerstahnHEROIC"] = { "Heroic High Interrogator Gerstahn (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["BRDAnubshiah"] = { "Anub'shiah", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["BRDAnubshiahMYTHIC"] = { "Mythic Anub'shiah (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["BRDAnubshiahHEROIC"] = { "Heroic Anub'shiah (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["BRDEviscerator"] = { "Eviscerator", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["BRDEvisceratorMYTHIC"] = { "Mythic Eviscerator (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["BRDEvisceratorHEROIC"] = { "Heroic Eviscerator (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["BRDGorosh"] = { "Gorosh the Dervish", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["BRDGoroshMYTHIC"] = { "Mythic Gorosh the Dervish (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["BRDGoroshHEROIC"] = { "Heroic Gorosh the Dervish (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["BRDGrizzle"] = { "Grizzle", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["BRDGrizzleMYTHIC"] = { "Mythic Grizzle (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["BRDGrizzleHEROIC"] = { "Heroic Grizzle (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["BRDHedrum"] = { "Hedrum the Creeper", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["BRDHedrumMYTHIC"] = { "Mythic Hedrum the Creeper (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["BRDHedrumHEROIC"] = { "Heroic Hedrum the Creeper (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["BRDOkthor"] = { "Ok'thor the Breaker", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["BRDOkthorMYTHIC"] = { "Mythic Ok'thor the Breaker (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["BRDOkthorHEROIC"] = { "Heroic Ok'thor the Breaker (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["BRDTheldren"] = { AL["Theldren"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["BRDTheldrenMYTHIC"] = { "Mythic Theldren (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["BRDTheldrenHEROIC"] = { "Heroic Theldren (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["BRDHoundmaster"] = { BabbleBoss["Houndmaster Grebmar"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["BRDHoundmasterMYTHIC"] = { "Mythic Houndmaster Grebmar (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["BRDHoundmasterHEROIC"] = { "Heroic Houndmaster Grebmar (Heroic)", "AtlasLootOriginalWoW" };
	...
	AtlasLoot_TableNames["BRDPyromantLoregrainMYTHIC"] = { "Mythic Pyromancer Loregrain (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["BRDPyromantLoregrainHEROIC"] = { "Heroic Pyromancer Loregrain (Heroic)", "AtlasLootOriginalWoW" };
	...
	AtlasLoot_TableNames["BRDWarderStilgissMYTHIC"] = { "Mythic Warder Stilgiss (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["BRDWarderStilgissHEROIC"] = { "Heroic Warder Stilgiss (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["BRDVerek"] = { BabbleBoss["Verek"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["BRDVerekMYTHIC"] = { "Mythic Verek (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["BRDVerekHEROIC"] = { "Heroic Verek (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["BRDFineousDarkvire"] = { BabbleBoss["Fineous Darkvire"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["BRDFineousDarkvireMYTHIC"] = { "Mythic Fineous Darkvire (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["BRDFineousDarkvireHEROIC"] = { "Heroic Fineous Darkvire (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["BRDLordIncendius"] = { BabbleBoss["Lord Incendius"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["BRDLordIncendiusMYTHIC"] = { "Mythic Lord Incendius (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["BRDLordIncendiusHEROIC"] = { "Heroic Lord Incendius (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["BRDBaelGar"] = { BabbleBoss["Bael'Gar"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["BRDBaelGarMYTHIC"] = { "Mythic Bael'Gar (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["BRDBaelGarHEROIC"] = { "Heroic Bael'Gar (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["BRDGeneralAngerforge"] = { BabbleBoss["General Angerforge"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["BRDGeneralAngerforgeMYTHIC"] = { "Mythic General Angerforge (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["BRDGeneralAngerforgeHEROIC"] = { "Heroic General Angerforge (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["BRDGolemLordArgelmach"] = { BabbleBoss["Golem Lord Argelmach"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["BRDGolemLordArgelmachMYTHIC"] = { "Mythic Golem Lord Argelmach (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["BRDGolemLordArgelmachHEROIC"] = { "Heroic Golem Lord Argelmach (Heroic)", "AtlasLootOriginalWoW" };
	...
	AtlasLoot_TableNames["BRDFlamelashMYTHIC"] = { "Mythic Ambassador Flamelash (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["BRDFlamelashHEROIC"] = { "Heroic Ambassador Flamelash (Heroic)", "AtlasLootOriginalWoW" };
	...
	AtlasLoot_TableNames["BRDMagmusMYTHIC"] = { "Mythic Magmus (Mythic)", "AtlasLootOriginalWoW" };
  ...
  -- Lower Blackrock Spire
	...
	AtlasLoot_TableNames["LBRSOmokkMYTHIC"] = { "Mythic Highlord Omokk (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["LBRSOmokkHEROIC"] = { "Heroic Highlord Omokk (Heroic)", "AtlasLootOriginalWoW" };
	...
	AtlasLoot_TableNames["LBRSVoshMYTHIC"] = { "Mythic Shadow Hunter Vosh'gajin (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["LBRSVoshHEROIC"] = { "Heroic Shadow Hunter Vosh'gajin (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["LBRSVoone"] = { BabbleBoss["War Master Voone"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["LBRSVooneMYTHIC"] = { "Mythic War Master Voone (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["LBRSVooneHEROIC"] = { "Heroic War Master Voone (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["LBRSGrayhoof"] = { BabbleBoss["Mor Grayhoof"].." ("..AL["Summon"]..")", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["LBRSGrayhoofMYTHIC"] = { "Mythic Mor Grayhoof (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["LBRSGrayhoofHEROIC"] = { "Heroic Mor Grayhoof (Heroic)", "AtlasLootOriginalWoW" };
	...
	AtlasLoot_TableNames["LBRSSmolderwebMYTHIC"] = { "Mythic Mother Smolderweb (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["LBRSSmolderwebHEROIC"] = { "Heroic Mother Smolderweb (Heroic)", "AtlasLootOriginalWoW" };
	...
	AtlasLoot_TableNames["LBRSDoomhowlMYTHIC"] = { "Mythic Urok Doomhowl (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["LBRSDoomhowlHEROIC"] = { "Heroic Urok Doomhowl (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["LBRSZigris"] = { BabbleBoss["Quartermaster Zigris"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["LBRSZigrisMYTHIC"] = { "Mythic Quartermaster Zigris (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["LBRSZigrisHEROIC"] = { "Heroic Quartermaster Zigris (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["LBRSHalycon"] = { BabbleBoss["Halycon"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["LBRSHalyconMYTHIC"] = { "Mythic Halycon (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["LBRSHalyconHEROIC"] = { "Heroic Halycon (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["LBRSSlavener"] = { BabbleBoss["Gizrul the Slavener"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["LBRSSlavenerMYTHIC"] = { "Mythic Gizrul the Slavener (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["LBRSSlavenerHEROIC"] = { "Heroic Gizrul the Slavener (Heroic)", "AtlasLootOriginalWoW" };
	...
	AtlasLoot_TableNames["LBRSWyrmthalakMYTHIC"] = { "Mythic Overlord Wyrmthalak (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["LBRSWyrmthalakHEROIC"] = { "Heroic Overlord Wyrmthalak (Heroic)", "AtlasLootOriginalWoW" };
  ...
  -- Upper Blackrock Spire
	...
	AtlasLoot_TableNames["UBRSEmberseerMYTHIC"] = { "Mythic Pyroguard Emberseer (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["UBRSEmberseerHEROIC"] = { "Heroic Pyroguard Emberseer (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["UBRSSolakar"] = { BabbleBoss["Solakar Flamewreath"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["UBRSSolakarMYTHIC"] = { "Mythic Solakar Flamewreath (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["UBRSSolakarHEROIC"] = { "Heroic Solakar Flamewreath (Heroic)", "AtlasLootOriginalWoW" };
	...
	AtlasLoot_TableNames["UBRSRendGyth"] = { BabbleBoss["Gyth"].." & "..BabbleBoss["Warchief Rend Blackhand"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["UBRSBeast"] = { BabbleBoss["The Beast"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["UBRSBeastMYTHIC"] = { "Mythic The Beast (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["UBRSBeastHEROIC"] = { "Heroic The Beast (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["UBRSValthalak"] = { BabbleBoss["Lord Valthalak"].." ("..AL["Summon"]..")", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["UBRSValthalakMYTHIC"] = { "Mythic Lord Valthalak (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["UBRSValthalakHEROIC"] = { "Heroic Lord Valthalak (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["UBRSDrakkisath"] = { BabbleBoss["General Drakkisath"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["UBRSDrakkisathMYTHIC"] = { "Mythic General Drakkisath (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["UBRSDrakkisathHEROIC"] = { "Heroic General Drakkisath (Heroic)", "AtlasLootOriginalWoW" };
  ...
  -- The Deadmines
	...
	AtlasLoot_TableNames["VCRhahkZorMYTHIC"] = { "Mythic Rhahk'Zor (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["VCRhahkZorHEROIC"] = { "Heroic Rhahk'Zor (Heroic)", "AtlasLootOriginalWoW" };
	...
	AtlasLoot_TableNames["VCGilnidMYTHIC"] = { "Mythic Gilnid (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["VCGilnidHEROIC"] = { "Heroic Gilnid (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["VCSmite"] = { BabbleBoss["Mr. Smite"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["VCSmiteMYTHIC"] = { "Mythic Mr. Smite (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["VCSmiteHEROIC"] = { "Heroic Mr. Smite (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["VCCookie"] = { BabbleBoss["Cookie"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["VCCookieMYTHIC"] = { "Mythic Cookie (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["VCCookieHEROIC"] = { "Heroic Cookie (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["VCGreenskin"] = { BabbleBoss["Captain Greenskin"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["VCGreenskinMYTHIC"] = { "Mythic Captain Greenskin (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["VCGreenskinHEROIC"] = { "Heroic Captain Greenskin (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["VCVanCleef"] = { BabbleBoss["Edwin VanCleef"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["VCVanCleefMYTHIC"] = { "Mythic Edwin VanCleef (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["VCVanCleefHEROIC"] = { "Heroic Edwin VanCleef (Heroic)", "AtlasLootOriginalWoW" };
  -- Dire Maul East
	AtlasLoot_TableNames["DMEPusillin"] = { BabbleBoss["Pusillin"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["DMEPusillinMYTHIC"] = { "Mythic Pusillin (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["DMEPusillinHEROIC"] = { "Heroic Pusillin (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["DMEZevrimThornhoof"] = { BabbleBoss["Zevrim Thornhoof"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["DMEZevrimThornhoofMYTHIC"] = { "Mythic Zevrim Thornhoof (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["DMEZevrimThornhoofHEROIC"] = { "Heroic Zevrim Thornhoof (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["DMEHydro"] = { BabbleBoss["Hydrospawn"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["DMEHydroMYTHIC"] = { "Mythic Hydrospawn (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["DMEHydroHEROIC"] = { "Heroic Hydrospawn (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["DMELethtendris"] = { BabbleBoss["Lethtendris"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["DMELethtendrisMYTHIC"] = { "Mythic Lethtendris (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["DMELethtendrisHEROIC"] = { "Heroic Lethtendris (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["DMEPimgib"] = { BabbleBoss["Pimgib"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["DMEPimgibMYTHIC"] = { "Mythic Pimgib (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["DMEPimgibHEROIC"] = { "Heroic Pimgib (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["DMEAlzzin"] = { BabbleBoss["Alzzin the Wildshaper"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["DMEAlzzinMYTHIC"] = { "Mythic Alzzin the Wildshaper (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["DMEAlzzinHEROIC"] = { "Heroic Alzzin the Wildshaper (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["DMEIsalien"] = { BabbleBoss["Isalien"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["DMEIsalienMYTHIC"] = { "Mythic Isalien (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["DMEIsalienHEROIC"] = { "Heroic Isalien (Heroic)", "AtlasLootOriginalWoW" };
  ...
  -- Dire Maul North
	...
	AtlasLoot_TableNames["DMNGuardMoldarMYTHIC"] = { "Mythic Guard Mol'dar (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["DMNGuardMoldarHEROIC"] = { "Heroic Guard Mol'dar (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["DMNStomperKreeg"] = { BabbleBoss["Stomper Kreeg"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["DMNStomperKreegMYTHIC"] = { "Mythic Stomper Kreeg (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["DMNStomperKreegHEROIC"] = { "Heroic Stomper Kreeg (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["DMNGuardFengus"] = { BabbleBoss["Guard Fengus"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["DMNGuardFengusMYTHIC"] = { "Mythic Guard Fengus (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["DMNGuardFengusHEROIC"] = { "Heroic Guard Fengus (Heroic)", "AtlasLootOriginalWoW" };
	...
	AtlasLoot_TableNames["DMNGuardSlipkikMYTHIC"] = { "Mythic Guard Slip'kik (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["DMNGuardSlipkikHEROIC"] = { "Heroic Guard Slip'kik (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["DMNCaptainKromcrush"] = { BabbleBoss["Captain Kromcrush"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["DMNCaptainKromcrushMYTHIC"] = { "Mythic Captain Kromcrush (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["DMNCaptainKromcrushHEROIC"] = { "Heroic Captain Kromcrush (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["DMNChoRush"] = { BabbleBoss["Cho'Rush the Observer"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["DMNChoRushMYTHIC"] = { "Mythic Cho'Rush the Observer (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["DMNChoRushHEROIC"] = { "Heroic Cho'Rush the Observer (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["DMNKingGordok"] = { BabbleBoss["King Gordok"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["DMNKingGordokMYTHIC"] = { "Mythic King Gordok (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["DMNKingGordokHEROIC"] = { "Heroic King Gordok (Heroic)", "AtlasLootOriginalWoW" };
  ...
  -- Dire Maul West
	...
	AtlasLoot_TableNames["DMWTendrisWarpwoodMYTHIC"] = { "Mythic Tendris Warpwood (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["DMWTendrisWarpwoodHEROIC"] = { "Heroic Tendris Warpwood (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["DMWIllyannaRavenoak"] = { BabbleBoss["Illyanna Ravenoak"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["DMWIllyannaRavenoakMYTHIC"] = { "Mythic Illyanna Ravenoak (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["DMWIllyannaRavenoakHEROIC"] = { "Heroic Illyanna Ravenoak (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["DMWMagisterKalendris"] = { BabbleBoss["Magister Kalendris"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["DMWMagisterKalendrisMYTHIC"] = { "Mythic Magister Kalendris (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["DMWMagisterKalendrisHEROIC"] = { "Heroic Magister Kalendris (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["DMWTsuzee"] = { BabbleBoss["Tsu'zee"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["DMWTsuzeeMYTHIC"] = { "Mythic Tsu'zee (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["DMWTsuzeeHEROIC"] = { "Heroic Tsu'zee (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["DMWImmolthar"] = { BabbleBoss["Immol'thar"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["DMWImmoltharMYTHIC"] = { "Mythic Immol'thar (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["DMWImmoltharHEROIC"] = { "Heroic Immol'thar (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["DMWHelnurath"] = { BabbleBoss["Lord Hel'nurath"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["DMWHelnurathMYTHIC"] = { "Mythic Lord Hel'nurath (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["DMWHelnurathHEROIC"] = { "Heroic Lord Hel'nurath (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["DMWPrinceTortheldrin"] = { BabbleBoss["Prince Tortheldrin"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["DMWPrinceTortheldrinMYTHIC"] = { "Mythic Prince Tortheldrin (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["DMWPrinceTortheldrinHEROIC"] = { "Heroic Prince Tortheldrin (Heroic)", "AtlasLootOriginalWoW" };
  ...
  -- Gnomeregan
	...
	AtlasLoot_TableNames["GnomeGrubbisMYTHIC"] = { "Mythic Grubbis (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["GnomeGrubbisHEROIC"] = { "Heroic Grubbis (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["GnomeViscousFallout"] = { BabbleBoss["Viscous Fallout"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["GnomeViscousFalloutMYTHIC"] = { "Mythic Viscous Fallout (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["GnomeViscousFalloutHEROIC"] = { "Heroic Viscous Fallout (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["GnomeElectrocutioner"] = { BabbleBoss["Electrocutioner 6000"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["GnomeElectrocutionerMYTHIC"] = { "Mythic Electrocutioner 6000 (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["GnomeElectrocutionerHEROIC"] = { "Heroic Electrocutioner 6000 (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["GnomeCrowdPummeler"] = { BabbleBoss["Crowd Pummeler 9-60"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["GnomeCrowdPummelerMYTHIC"] = { "Mythic Crowd Pummeler 9-60 (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["GnomeCrowdPummelerHEROIC"] = { "Heroic Crowd Pummeler 9-60 (Heroic)", "AtlasLootOriginalWoW" };
	...
	AtlasLoot_TableNames["GnomeThermapluggMYTHIC"] = { "Mythic Mekgineer Thermaplugg (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["GnomeThermapluggHEROIC"] = { "Heroic Mekgineer Thermaplugg (Heroic)", "AtlasLootOriginalWoW" };
  -- Maraudon
	AtlasLoot_TableNames["MaraNoxxion"] = { BabbleBoss["Noxxion"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["MaraNoxxionMYTHIC"] = { "Mythic Noxxion (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["MaraNoxxionHEROIC"] = { "Heroic Noxxion (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["MaraRazorlash"] = { BabbleBoss["Razorlash"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["MaraRazorlashMYTHIC"] = { "Mythic Razorlash (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["MaraRazorlashHEROIC"] = { "Heroic Razorlash (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["MaraVyletongue"] = { BabbleBoss["Lord Vyletongue"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["MaraVyletongueMYTHIC"] = { "Mythic Lord Vyletongue (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["MaraVyletongueHEROIC"] = { "Heroic Lord Vyletongue (Heroic)", "AtlasLootOriginalWoW" };
	...
	AtlasLoot_TableNames["MaraCelebrasMYTHIC"] = { "Mythic Celebras the Cursed (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["MaraCelebrasHEROIC"] = { "Heroic Celebras the Cursed (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["MaraLandslide"] = { BabbleBoss["Landslide"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["MaraLandslideMYTHIC"] = { "Mythic Landslide (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["MaraLandslideHEROIC"] = { "Heroic Landslide (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["MaraGizlock"] = { BabbleBoss["Tinkerer Gizlock"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["MaraGizlockMYTHIC"] = { "Mythic Tinkerer Gizlock (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["MaraGizlockHEROIC"] = { "Heroic Tinkerer Gizlock (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["MaraRotgrip"] = { BabbleBoss["Rotgrip"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["MaraRotgripMYTHIC"] = { "Mythic Rotgrip (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["MaraRotgripHEROIC"] = { "Heroic Rotgrip (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["MaraTheradras"] = { BabbleBoss["Princess Theradras"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["MaraTheradrasMYTHIC"] = { "Mythic Princess Theradras (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["MaraTheradrasHEROIC"] = { "Heroic Princess Theradras (Heroic)", "AtlasLootOriginalWoW" };
  -- Molten Core
  ...
  -- Ragefire Chasm
	...
	AtlasLoot_TableNames["RFCTaragamanMYTHIC"] = { "Mythic Taragaman the Hungerer (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["RFCTaragamanHEROIC"] = { "Heroic Taragaman the Hungerer (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["RFCJergosh"] = { BabbleBoss["Jergosh the Invoker"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["RFCJergoshMYTHIC"] = { "Mythic Jergosh the Invoker (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["RFCJergoshHEROIC"] = { "Heroic Jergosh the Invoker (Heroic)", "AtlasLootOriginalWoW" };
  -- Razorfen Downs
	AtlasLoot_TableNames["RFDTutenkash"] = { BabbleBoss["Tuten'kash"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["RFDTutenkashMYTHIC"] = { "Mythic Tuten'kash (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["RFDTutenkashHEROIC"] = { "Heroic Tuten'kash (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["RFDMordresh"] = { BabbleBoss["Mordresh Fire Eye"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["RFDMordreshMYTHIC"] = { "Mythic Mordresh Fire Eye (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["RFDMordreshHEROIC"] = { "Heroic Mordresh Fire Eye (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["RFDGlutton"] = { BabbleBoss["Glutton"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["RFDGluttonMYTHIC"] = { "Mythic Glutton (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["RFDGluttonHEROIC"] = { "Heroic Glutton (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["RFDRagglesnout"] = { BabbleBoss["Ragglesnout"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["RFDRagglesnoutMYTHIC"] = { "Mythic Ragglesnout (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["RFDRagglesnoutHEROIC"] = { "Heroic Ragglesnout (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["RFDAmnennar"] = { BabbleBoss["Amnennar the Coldbringer"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["RFDAmnennarMYTHIC"] = { "Mythic Amnennar the Coldbringer (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["RFDAmnennarHEROIC"] = { "Heroic Amnennar the Coldbringer (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["RFDPlaguemaw"] = { BabbleBoss["Plaguemaw the Rotting"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["RFDPlaguemawMYTHIC"] = { "Mythic Plaguemaw the Rotting (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["RFDPlaguemawHEROIC"] = { "Heroic Plaguemaw the Rotting (Heroic)", "AtlasLootOriginalWoW" };
  -- Razorfen Kraul
	AtlasLoot_TableNames["RFKJargba"] = { BabbleBoss["Death Speaker Jargba"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["RFKJargbaMYTHIC"] = { "Mythic Death Speaker Jargba (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["RFKJargbaHEROIC"] = { "Heroic Death Speaker Jargba (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["RFKRamtusk"] = { BabbleBoss["Overlord Ramtusk"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["RFKRamtuskMYTHIC"] = { "Mythic Overlord Ramtusk (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["RFKRamtuskHEROIC"] = { "Heroic Overlord Ramtusk (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["RFKAgathelos"] = { BabbleBoss["Agathelos the Raging"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["RFKAgathelosMYTHIC"] = { "Mythic Agathelos the Raging (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["RFKAgathelosHEROIC"] = { "Heroic Agathelos the Raging (Heroic)", "AtlasLootOriginalWoW" };
	...
	AtlasLoot_TableNames["RFKCharlgaMYTHIC"] = { "Mythic Charlga Razorflank (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["RFKCharlgaHEROIC"] = { "Heroic Charlga Razorflank (Heroic)", "AtlasLootOriginalWoW" };
  ...
  -- Scarlet Monestery
	...
	AtlasLoot_TableNames["SMCFairbanksMYTHIC"] = { "Mythic High Inquisitor Fairbanks (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["SMCFairbanksHEROIC"] = { "Heroic High Inquisitor Fairbanks (Heroic)", "AtlasLootOriginalWoW" };
	...
	AtlasLoot_TableNames["SMGVishasMYTHIC"] = { "Mythic Interrogator Vishas (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["SMGVishasHEROIC"] = { "Heroic Interrogator Vishas (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["SMGThalnos"] = { BabbleBoss["Bloodmage Thalnos"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["SMGThalnosMYTHIC"] = { "Mythic Bloodmage Thalnos (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["SMGThalnosHEROIC"] = { "Heroic Bloodmage Thalnos (Heroic)", "AtlasLootOriginalWoW" };
	...
	AtlasLoot_TableNames["SMLLokseyMYTHIC"] = { "Mythic Houndmaster Loksey (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["SMLLokseyHEROIC"] = { "Heroic Houndmaster Loksey (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["SMLDoan"] = { BabbleBoss["Arcanist Doan"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["SMLDoanMYTHIC"] = { "Mythic Arcanist Doan (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["SMLDoanHEROIC"] = { "Heroic Arcanist Doan (Heroic)", "AtlasLootOriginalWoW" };
  ...
  -- Scholomance
	...
	AtlasLoot_TableNames["SCHOLOKirtonostheHeraldMYTHIC"] = { "Mythic Kirtonos the Herald (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["SCHOLOKirtonostheHeraldHEROIC"] = { "Heroic Kirtonos the Herald (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["SCHOLOJandiceBarov"] = { BabbleBoss["Jandice Barov"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["SCHOLOJandiceBarovMYTHIC"] = { "Mythic Jandice Barov (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["SCHOLOJandiceBarovHEROIC"] = { "Heroic Jandice Barov (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["SCHOLORattlegore"] = { BabbleBoss["Rattlegore"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["SCHOLORattlegoreMYTHIC"] = { "Mythic Rattlegore (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["SCHOLORattlegoreHEROIC"] = { "Heroic Rattlegore (Heroic)", "AtlasLootOriginalWoW" };
	...
	AtlasLoot_TableNames["SCHOLOMardukMYTHIC"] = { "Mythic Marduk Blackpool (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["SCHOLOMardukHEROIC"] = { "Heroic Marduk Blackpool (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["SCHOLOVectus"] = { BabbleBoss["Vectus"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["SCHOLOVectusMYTHIC"] = { "Mythic Vectus (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["SCHOLOVectusHEROIC"] = { "Heroic Vectus (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["SCHOLORasFrostwhisper"] = { BabbleBoss["Ras Frostwhisper"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["SCHOLORasFrostwhisperMYTHIC"] = { "Mythic Ras Frostwhisper (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["SCHOLORasFrostwhisperHEROIC"] = { "Heroic Ras Frostwhisper (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["SCHOLOKormok"] = { BabbleBoss["Kormok"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["SCHOLOKormokMYTHIC"] = { "Mythic Kormok (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["SCHOLOKormokHEROIC"] = { "Heroic Kormok (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["SCHOLOInstructorMalicia"] = { BabbleBoss["Instructor Malicia"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["SCHOLOInstructorMaliciaMYTHIC"] = { "Mythic Instructor Malicia (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["SCHOLOInstructorMaliciaHEROIC"] = { "Heroic Instructor Malicia (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["SCHOLODoctorTheolenKrastinov"] = { BabbleBoss["Doctor Theolen Krastinov"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["SCHOLODoctorTheolenKrastinovMYTHIC"] = { "Mythic Doctor Theolen Krastinov (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["SCHOLODoctorTheolenKrastinovHEROIC"] = { "Heroic Doctor Theolen Krastinov (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["SCHOLOLorekeeperPolkelt"] = { BabbleBoss["Lorekeeper Polkelt"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["SCHOLOLorekeeperPolkeltMYTHIC"] = { "Mythic Lorekeeper Polkelt (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["SCHOLOLorekeeperPolkeltHEROIC"] = { "Heroic Lorekeeper Polkelt (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["SCHOLOTheRavenian"] = { BabbleBoss["The Ravenian"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["SCHOLOTheRavenianMYTHIC"] = { "Mythic The Ravenian (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["SCHOLOTheRavenianHEROIC"] = { "Heroic The Ravenian (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["SCHOLOLordAlexeiBarov"] = { BabbleBoss["Lord Alexei Barov"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["SCHOLOLordAlexeiBarovMYTHIC"] = { "Mythic Lord Alexei Barov (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["SCHOLOLordAlexeiBarovHEROIC"] = { "Heroic Lord Alexei Barov (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["SCHOLOLadyIlluciaBarov"] = { BabbleBoss["Lady Illucia Barov"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["SCHOLOLadyIlluciaBarovMYTHIC"] = { "Mythic Lady Illucia Barov (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["SCHOLOLadyIlluciaBarovHEROIC"] = { "Heroic Lady Illucia Barov (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["SCHOLODarkmasterGandling"] = { BabbleBoss["Darkmaster Gandling"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["SCHOLODarkmasterGandlingMYTHIC"] = { "Mythic Darkmaster Gandling (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["SCHOLODarkmasterGandlingHEROIC"] = { "Heroic Darkmaster Gandling (Heroic)", "AtlasLootOriginalWoW" };
  ...
  -- Shadowfang Keep
	...
	AtlasLoot_TableNames["SFKDeathswornMYTHIC"] = { "Mythic Deathsworn Captain (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["SFKDeathswornHEROIC"] = { "Heroic Deathsworn Captain (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["SFKRazorclaw"] = { BabbleBoss["Razorclaw the Butcher"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["SFKRazorclawMYTHIC"] = { "Mythic Razorclaw the Butcher (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["SFKRazorclawHEROIC"] = { "Heroic Razorclaw the Butcher (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["SFKSilverlaine"] = { BabbleBoss["Baron Silverlaine"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["SFKSilverlaineMYTHIC"] = { "Mythic Baron Silverlaine (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["SFKSilverlaineHEROIC"] = { "Heroic Baron Silverlaine (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["SFKSpringvale"] = { BabbleBoss["Commander Springvale"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["SFKSpringvaleMYTHIC"] = { "Mythic Commander Springvale (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["SFKSpringvaleHEROIC"] = { "Heroic Commander Springvale (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["SFKOdo"] = { BabbleBoss["Odo the Blindwatcher"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["SFKOdoMYTHIC"] = { "Mythic Odo the Blindwatcher (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["SFKOdoHEROIC"] = { "Heroic Odo the Blindwatcher (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["SFKFenrus"] = { BabbleBoss["Fenrus the Devourer"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["SFKFenrusMYTHIC"] = { "Mythic Fenrus the Devourer (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["SFKFenrusHEROIC"] = { "Heroic Fenrus the Devourer (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["SFKNandos"] = { BabbleBoss["Wolf Master Nandos"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["SFKNandosMYTHIC"] = { "Mythic Wolf Master Nandos (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["SFKNandosHEROIC"] = { "Heroic Wolf Master Nandos (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["SFKArugal"] = { BabbleBoss["Archmage Arugal"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["SFKArugalMYTHIC"] = { "Mythic Archmage Arugal (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["SFKArugalHEROIC"] = { "Heroic Archmage Arugal (Heroic)", "AtlasLootOriginalWoW" };
  -- The Stockade
	AtlasLoot_TableNames["StockTargorr"] = { BabbleBoss["Targorr the Dread"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["StockTargorrMYTHIC"] = { "Mythic Targorr the Dread (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["StockTargorrHEROIC"] = { "Heroic Targorr the Dread (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["StockKam"] = { BabbleBoss["Kam Deepfury"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["StockKamMYTHIC"] = { "Mythic Kam Deepfury (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["StockKamHEROIC"] = { "Heroic Kam Deepfury (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["StockBazil"] = { BabbleBoss["Bazil Thredd"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["StockBazilMYTHIC"] = { "Mythic Bazil Thredd (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["StockBazilHEROIC"] = { "Heroic Bazil Thredd (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["StockDextren"] = { BabbleBoss["Dextren Ward"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["StockDextrenMYTHIC"] = { "Mythic Dextren Ward (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["StockDextrenHEROIC"] = { "Heroic Dextren Ward (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["StockBruegal"] = { BabbleBoss["Bruegal Ironknuckle"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["StockBruegalMYTHIC"] = { "Mythic Bruegal Ironknuckle (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["StockBruegalHEROIC"] = { "Heroic Bruegal Ironknuckle (Heroic)", "AtlasLootOriginalWoW" };
  -- Stratholme
	...
	AtlasLoot_TableNames["STRATStratholmeCourierMYTHIC"] = { "Mythic Stratholme Courier (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["STRATStratholmeCourierHEROIC"] = { "Heroic Stratholme Courier (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["STRATFrasSiabi"] = { BabbleBoss["Fras Siabi"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["STRATFrasSiabiMYTHIC"] = { "Mythic Fras Siabi (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["STRATFrasSiabiHEROIC"] = { "Heroic Fras Siabi (Heroic)", "AtlasLootOriginalWoW" };
	...
	AtlasLoot_TableNames["STRATTheUnforgivenMYTHIC"] = { "Mythic The Unforgiven (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["STRATTheUnforgivenHEROIC"] = { "Heroic The Unforgiven (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["STRATTimmytheCruel"] = { BabbleBoss["Timmy the Cruel"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["STRATTimmytheCruelMYTHIC"] = { "Mythic Timmy the Cruel (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["STRATTimmytheCruelHEROIC"] = { "Heroic Timmy the Cruel (Heroic)", "AtlasLootOriginalWoW" };
	...
	AtlasLoot_TableNames["STRATCannonMasterWilleyMYTHIC"] = { "Mythic Cannon Master Willey (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["STRATCannonMasterWilleyHEROIC"] = { "Heroic Cannon Master Willey (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["STRATArchivistGalford"] = { BabbleBoss["Archivist Galford"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["STRATArchivistGalfordMYTHIC"] = { "Mythic Archivist Galford (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["STRATArchivistGalfordHEROIC"] = { "Heroic Archivist Galford (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["STRATBalnazzar"] = { BabbleBoss["Balnazzar"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["STRATBalnazzarMYTHIC"] = { "Mythic Balnazzar (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["STRATBalnazzarHEROIC"] = { "Heroic Balnazzar (Heroic)", "AtlasLootOriginalWoW" };
	...
	AtlasLoot_TableNames["STRATNerubenkanMYTHIC"] = { "Mythic Nerub'enkan (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["STRATNerubenkanHEROIC"] = { "Heroic Nerub'enkan (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["STRATBaronessAnastari"] = { BabbleBoss["Baroness Anastari"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["STRATBaronessAnastariMYTHIC"] = { "Mythic Baroness Anastari (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["STRATBaronessAnastariHEROIC"] = { "Heroic Baroness Anastari (Heroic)", "AtlasLootOriginalWoW" };
	...
	AtlasLoot_TableNames["STRATMalekithePallidMYTHIC"] = { "Mythic Maleki the Pallid (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["STRATMalekithePallidHEROIC"] = { "Heroic Maleki the Pallid (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["STRATMagistrateBarthilas"] = { BabbleBoss["Magistrate Barthilas"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["STRATMagistrateBarthilasMYTHIC"] = { "Mythic Magistrate Barthilas (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["STRATMagistrateBarthilasHEROIC"] = { "Heroic Magistrate Barthilas (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["STRATRamsteintheGorger"] = { BabbleBoss["Ramstein the Gorger"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["STRATRamsteintheGorgerMYTHIC"] = { "Mythic Ramstein the Gorger (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["STRATRamsteintheGorgerHEROIC"] = { "Heroic Ramstein the Gorger (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["STRATBaronRivendare"] = { BabbleBoss["Baron Rivendare"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["STRATBaronRivendareMYTHIC"] = { "Mythic Baron Rivendare (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["STRATBaronRivendareHEROIC"] = { "Heroic Baron Rivendare (Heroic)", "AtlasLootOriginalWoW" };
  ...
  -- Sunken Temple
	...
	AtlasLoot_TableNames["STAtalalarionMYTHIC"] = { "Mythic Atal'alarion (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["STAtalalarionHEROIC"] = { "Heroic Atal'alarion (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["STDreamscytheWeaver"] = { BabbleBoss["Dreamscythe"].." & "..BabbleBoss["Weaver"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["STAvatarofHakkar"] = { BabbleBoss["Avatar of Hakkar"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["STAvatarofHakkarMYTHIC"] = { "Mythic Avatar of Hakkar (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["STAvatarofHakkarHEROIC"] = { "Heroic Avatar of Hakkar (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["STJammalanOgom"] = { BabbleBoss["Jammal'an the Prophet"].." & "..BabbleBoss["Ogom the Wretched"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["STHazzasMorphaz"] = { BabbleBoss["Hazzas"].." & "..BabbleBoss["Morphaz"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["STEranikus"] = { BabbleBoss["Shade of Eranikus"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["STEranikusMYTHIC"] = { "Mythic Shade of Eranikus (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["STEranikusHEROIC"] = { "Heroic Shade of Eranikus (Heroic)", "AtlasLootOriginalWoW" };
  ...
  -- Uldaman
	...
	AtlasLoot_TableNames["UldReveloshMYTHIC"] = { "Mythic Revelosh (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["UldReveloshHEROIC"] = { "Heroic Revelosh (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["UldBaelog"] = { BabbleBoss["Baelog"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["UldBaelogMYTHIC"] = { "Mythic Baelog (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["UldBaelogHEROIC"] = { "Heroic Baelog (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["UldIronaya"] = { BabbleBoss["Ironaya"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["UldIronayaMYTHIC"] = { "Mythic Ironaya (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["UldIronayaHEROIC"] = { "Heroic Ironaya (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["UldObsidianSentinel"] = { BabbleBoss["Obsidian Sentinel"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["UldObsidianSentinelMYTHIC"] = { "Mythic Obsidian Sentinel (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["UldObsidianSentinelHEROIC"] = { "Heroic Obsidian Sentinel (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["UldAncientStoneKeeper"] = { BabbleBoss["Ancient Stone Keeper"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["UldAncientStoneKeeperMYTHIC"] = { "Mythic Ancient Stone Keeper (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["UldAncientStoneKeeperHEROIC"] = { "Heroic Ancient Stone Keeper (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["UldGalgannFirehammer"] = { BabbleBoss["Galgann Firehammer"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["UldGalgannFirehammerMYTHIC"] = { "Mythic Galgann Firehammer (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["UldGalgannFirehammerHEROIC"] = { "Heroic Galgann Firehammer (Heroic)", "AtlasLootOriginalWoW" };
	...
	AtlasLoot_TableNames["UldGrimlokMYTHIC"] = { "Mythic Grimlok (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["UldGrimlokHEROIC"] = { "Heroic Grimlok (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["UldArchaedas"] = { BabbleBoss["Archaedas"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["UldArchaedasMYTHIC"] = { "Mythic Archaedas (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["UldArchaedasHEROIC"] = { "Heroic Archaedas (Heroic)", "AtlasLootOriginalWoW" };
  ...
  -- Wailing Caverns
	...
	AtlasLoot_TableNames["WCCobrahnMYTHIC"] = { "Mythic Lord Cobrahn (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["WCCobrahnHEROIC"] = { "Heroic Lord Cobrahn (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["WCAnacondra"] = { BabbleBoss["Lady Anacondra"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["WCAnacondraMYTHIC"] = { "Mythic Lady Anacondra (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["WCAnacondraHEROIC"] = { "Heroic Lady Anacondra (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["WCKresh"] = { BabbleBoss["Kresh"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["WCKreshMYTHIC"] = { "Mythic Kresh (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["WCKreshHEROIC"] = { "Heroic Kresh (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["WCPythas"] = { BabbleBoss["Lord Pythas"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["WCPythasMYTHIC"] = { "Mythic Lord Pythas (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["WCPythasHEROIC"] = { "Heroic Lord Pythas (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["WCSkum"] = { BabbleBoss["Skum"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["WCSkumMYTHIC"] = { "Mythic Skum (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["WCSkumHEROIC"] = { "Heroic Skum (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["WCSerpentis"] = { BabbleBoss["Lord Serpentis"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["WCSerpentisMYTHIC"] = { "Mythic Lord Serpentis (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["WCSerpentisHEROIC"] = { "Heroic Lord Serpentis (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["WCVerdan"] = { BabbleBoss["Verdan the Everliving"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["WCVerdanMYTHIC"] = { "Mythic Verdan the Everliving (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["WCVerdanHEROIC"] = { "Heroic Verdan the Everliving (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["WCMutanus"] = { BabbleBoss["Mutanus the Devourer"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["WCMutanusMYTHIC"] = { "Mythic Mutanus the Devourer (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["WCMutanusHEROIC"] = { "Heroic Mutanus the Devourer (Heroic)", "AtlasLootOriginalWoW" };
  ...
  -- Zul'Farrak
	...
	AtlasLoot_TableNames["ZFAntusulMYTHIC"] = { "Mythic Antu'sul (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["ZFAntusulHEROIC"] = { "Heroic Antu'sul (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["ZFThekatheMartyr"] = { BabbleBoss["Theka the Martyr"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["ZFThekatheMartyrMYTHIC"] = { "Mythic Theka the Martyr (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["ZFThekatheMartyrHEROIC"] = { "Heroic Theka the Martyr (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["ZFWitchDoctorZumrah"] = { BabbleBoss["Witch Doctor Zum'rah"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["ZFWitchDoctorZumrahMYTHIC"] = { "Mythic Witch Doctor Zum'rah (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["ZFWitchDoctorZumrahHEROIC"] = { "Heroic Witch Doctor Zum'rah (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["ZFNekrumGutchewer"] = { BabbleBoss["Nekrum Gutchewer"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["ZFNekrumGutchewerMYTHIC"] = { "Mythic Nekrum Gutchewer (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["ZFNekrumGutchewerHEROIC"] = { "Heroic Nekrum Gutchewer (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["ZFSezzziz"] = { BabbleBoss["Shadowpriest Sezz'ziz"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["ZFSezzzizMYTHIC"] = { "Mythic Shadowpriest Sezz'ziz (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["ZFSezzzizHEROIC"] = { "Heroic Shadowpriest Sezz'ziz (Heroic)", "AtlasLootOriginalWoW" };
	...
	AtlasLoot_TableNames["ZFHydromancerVelrathaMYTHIC"] = { "Mythic Hydromancer Velratha (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["ZFHydromancerVelrathaHEROIC"] = { "Heroic Hydromancer Velratha (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["ZFGahzrilla"] = { BabbleBoss["Gahz'rilla"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["ZFGahzrillaMYTHIC"] = { "Mythic Gahz'rilla (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["ZFGahzrillaHEROIC"] = { "Heroic Gahz'rilla (Heroic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["ZFChiefUkorzSandscalp"] = { BabbleBoss["Chief Ukorz Sandscalp"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["ZFChiefUkorzSandscalpMYTHIC"] = { "Mythic Chief Ukorz Sandscalp (Mythic)", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["ZFChiefUkorzSandscalpHEROIC"] = { "Heroic Chief Ukorz Sandscalp (Heroic)", "AtlasLootOriginalWoW" };
