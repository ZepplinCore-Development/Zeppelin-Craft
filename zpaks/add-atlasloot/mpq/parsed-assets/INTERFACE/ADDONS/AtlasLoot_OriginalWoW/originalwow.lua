...
---- Azuregos
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6=Kurinnaxx", "=q5=ALL WILL DROP"};
    { 2, 22217, "", "=q1=Kurinnaxx's Venom Sac", "=ds=#m3#", "", "100%" };
    { 4, 0, "AO_Unknown", "=q6=Kurinnaxx", "=q5=ONE WILL DROP"};
    { 5, 21498, "", "=q4=Qiraji Sacrificial Dagger", "=ds=#w4#", "", "16.7%" };
    { 6, 21499, "", "=q4=Vestments of the Shifting Sands", "=ds=#a1#", "", "16.7%" };
    { 7, 21500, "", "=q3=Belt of the Inquisition", "=ds=#a1#", "", "16.7%" };
    { 8, 21501, "", "=q3=Toughened Silithid Hide Gloves", "=ds=#a2#", "", "16.7%" };
    { 9, 21502, "", "=q3=Sand Reaver Wristguards", "=ds=#a3#", "", "16.7%" };
    { 10, 21503, "", "=q3=Belt of the Sand Reaver", "=ds=#a4#", "", "16.7%" };
	};

	AtlasLoot_Data["AQ20Rajaxx"] = {
    { 1, 0, "AO_Unknown", "=q6=General Rajaxx", "=q5=ONE WILL DROP"};
    { 2, 21492, "", "=q4=Manslayer of the Qiraji", "=ds=#w10#", "", "16.7%" };
    { 3, 21493, "", "=q4=Boots of the Vanguard", "=ds=#a2#", "", "16.7%" };
    { 4, 21494, "", "=q3=Southwind's Grasp", "=ds=#a2#", "", "16.7%" };
    { 5, 21495, "", "=q3=Legplates of the Qiraji Command", "=ds=#a4#", "", "16.7%" };
    { 6, 21496, "", "=q3=Bracers of Qiraji Command", "=ds=#a1#", "", "16.7%" };
    { 7, 21497, "", "=q3=Boots of the Qiraji General", "=ds=#a3#", "", "16.7%" };
	};

	AtlasLoot_Data["AQ20Moam"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Moam", "=q5=CHANCE TO DROP"};
    { 2, 22220, "", "=q4=Plans: Black Grasp of the Destroyer", "=ds=#e2#", "", "15.0%" };
    { 4, 0, "AO_Unknown", "=q6=Moam", "=q5=ONE WILL DROP"};
    { 5, 21455, "", "=q3=Southwind Helm", "=ds=#a2#", "", "11.1%" };
    { 6, 21468, "", "=q3=Mantle of Maz'Nadir", "=ds=#a1#", "", "11.1%" };
    { 7, 21469, "", "=q3=Gauntlets of Southwind", "=ds=#a2#", "", "11.1%" };
    { 8, 21470, "", "=q3=Cloak of the Savior", "=ds=#a1#", "", "11.1%" };
    { 9, 21473, "", "=q3=Eye of Moam", "=ds=#s14#", "", "11.1%" };
    { 10, 21474, "", "=q3=Chitinous Shoulderguards", "=ds=#a2#", "", "11.1%" };
    { 11, 21475, "", "=q3=Legplates of the Destroyer", "=ds=#a4#", "", "11.1%" };
    { 12, 21476, "", "=q3=Obsidian Scaled Leggings", "=ds=#a3#", "", "11.1%" };
    { 13, 21477, "", "=q3=Ring of Fury", "=ds=#s13#", "", "11.1%" };
    { 16, 0, "AO_Unknown", "=q6=Moam", "=q5=ONE WILL DROP"};
    { 17, 21467, "", "=q4=Thick Silithid Chestguard", "=ds=#a2#", "", "25.0%" };
    { 18, 21471, "", "=q4=Talon of Furious Concentration", "=ds=#s15#", "", "25.0%" };
    { 19, 21472, "", "=q4=Dustwind Turban", "=ds=#a1#", "", "25.0%" };
    { 20, 21479, "", "=q4=Gauntlets of the Immovable", "=ds=#a4#", "", "25.0%" };
	};

	AtlasLoot_Data["AQ20Buru"] = {
    { 1, 0, "AO_Unknown", "=q6=Buru the Gorger", "=q5=ONE WILL DROP"};
    { 2, 21485, "", "=q4=Buru's Skull Fragment", "=ds=#w8#", "", "14.3%" };
    { 3, 21486, "", "=q4=Gloves of the Swarm", "=ds=#a4#", "", "14.3%" };
    { 4, 21487, "", "=q4=Slimy Scaled Gauntlets", "=ds=#a3#", "", "14.3%" };
    { 5, 21488, "", "=q3=Fetish of Chitinous Spikes", "=ds=#s14#", "", "14.3%" };
    { 6, 21489, "", "=q3=Quicksand Waders", "=ds=#a1#", "", "14.3%" };
    { 7, 21490, "", "=q3=Slime Kickers", "=ds=#a4#", "", "14.3%" };
    { 8, 21491, "", "=q3=Scaled Bracers of the Gorger", "=ds=#a2#", "", "14.3%" };
	};

	AtlasLoot_Data["AQ20Ayamiss"] = {
    { 1, 0, "AO_Unknown", "=q6=Ayamiss the Hunter", "=q5=ONE WILL DROP"};
    { 2, 21466, "", "=q4=Stinger of Ayamiss", "=ds=#w6#", "", "12.5%" };
    { 3, 21478, "", "=q4=Bow of Taut Sinew", "=ds=#w2#", "", "12.5%" };
    { 4, 21479, "", "=q4=Gauntlets of the Immovable", "=ds=#a4#", "", "12.5%" };
    { 5, 21480, "", "=q3=Scaled Silithid Gauntlets", "=ds=#a3#", "", "12.5%" };
    { 6, 21481, "", "=q3=Boots of the Desert Protector", "=ds=#a4#", "", "12.5%" };
    { 7, 21482, "", "=q3=Boots of the Fiery Sands", "=ds=#a3#", "", "12.5%" };
    { 8, 21483, "", "=q3=Ring of the Desert Winds", "=ds=#s13#", "", "12.5%" };
    { 9, 21484, "", "=q3=Helm of Regrowth", "=ds=#a2#", "", "12.5%" };
	};

	AtlasLoot_Data["AQ20Ossirian"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Ossirian the Unscarred", "=q5=ALL WILL DROP"};
    { 2, 21220, "", "=q4=Head of Ossirian the Unscarred", "=ds=#m3#", "", "100%" };
    { 4, 0, "AO_Unknown", "=q6=Ossirian the Unscarred", "=q5=ONE WILL DROP"};
    { 5, 20727, "", "=q3=Formula: Enchant Gloves - Shadow Power", "=ds=#e2#", "", "14.3%" };
    { 6, 20728, "", "=q3=Formula: Enchant Gloves - Frost Power", "=ds=#e2#", "", "14.3%" };
    { 7, 20729, "", "=q3=Formula: Enchant Gloves - Fire Power", "=ds=#e2#", "", "14.3%" };
    { 8, 20730, "", "=q3=Formula: Enchant Gloves - Healing Power", "=ds=#e2#", "", "14.3%" };
    { 9, 20731, "", "=q3=Formula: Enchant Gloves - Superior Agility", "=ds=#e2#", "", "14.3%" };
    { 10, 20734, "", "=q3=Formula: Enchant Cloak - Stealth", "=ds=#e2#", "", "14.3%" };
    { 11, 20736, "", "=q3=Formula: Enchant Cloak - Dodge", "=ds=#e2#", "", "14.3%" };
    { 13, 0, "AO_Unknown", "=q6=Ossirian the Unscarred", "=q5=ONE WILL DROP"};
    { 14, 21457, "", "=q4=Bracers of Brutality", "=ds=#a4#", "", "15.0%" };
    { 15, 21460, "", "=q4=Helm of Domination", "=ds=#a4#", "", "15.0%" };
    { 16, 21461, "", "=q4=Leggings of the Black Blizzard", "=ds=#a1#", "", "15.0%" };
    { 17, 21462, "", "=q4=Gloves of Dark Wisdom", "=ds=#a1#", "", "15.0%" };
    { 18, 21463, "", "=q4=Ossirian's Binding", "=ds=#a3#", "", "15.0%" };
    { 19, 21464, "", "=q4=Shackles of the Unscarred", "=ds=#a1#", "", "15.0%" };
    { 20, 21459, "", "=q4=Crossbow of Imminent Doom", "=ds=#w3#", "", "10.0%" };
    { 22, 0, "AO_Unknown", "=q6=Ossirian the Unscarred", "=q5=ONE WILL DROP"};
    { 23, 21452, "", "=q4=Staff of the Ruins", "=ds=#w9#", "", "18.0%" };
    { 24, 21453, "", "=q4=Mantle of the Horusath", "=ds=#a4#", "", "18.0%" };
    { 25, 21454, "", "=q4=Runic Stone Shoulders", "=ds=#a3#", "", "18.0%" };
    { 26, 21456, "", "=q4=Sandstorm Cloak", "=ds=#a1#", "", "18.0%" };
    { 27, 21458, "", "=q4=Gauntlets of New Life", "=ds=#a2#", "", "18.0%" };
    { 28, 21715, "", "=q4=Sand Polished Hammer", "=ds=#w6#", "", "10.0%" };
	};
    ...
    { 10, 21700, "", "=q4=Pendant of the Qiraji Guardian", "=ds=#s2#", "", "18.0%" };
    { 11, 21701, "", "=q4=Cloak of Concentrated Hatred", "=ds=#a1#", "", "18.0%" };
    { 12, 21702, "", "=q4=Amulet of Foul Warding", "=ds=#s2#", "", "18.0%" };
    { 13, 21128, "", "=q4=Staff of the Qiraji Prophets", "=ds=#w9#", "", "10.0%" };
    { 16, 0, "AO_Unknown", "=q6=The Prophet Skeram", "=q5=ONE WILL DROP"};
    { 17, 21704, "", "=q4=Boots of the Redeemed Prophecy", "=ds=#a4#", "", "15.0%" };
    { 18, 21705, "", "=q4=Boots of the Fallen Prophet", "=ds=#a3#", "", "15.0%" };
    { 19, 21706, "", "=q4=Boots of the Unwavering Will", "=ds=#a4#", "", "15.0%" };
    { 20, 21707, "", "=q4=Ring of Swarming Thought", "=ds=#s13#", "", "15.0%" };
    { 21, 21708, "", "=q4=Beetle Scaled Wristguards", "=ds=#a2#", "", "15.0%" };
    { 22, 21814, "", "=q4=Breastplate of Annihilation", "=ds=#a4#", "", "15.0%" };
    { 23, 21703, "", "=q4=Hammer of Ji'zhi", "=ds=#w6#", "", "10.0%" };
	};

	AtlasLoot_Data["AQ40Vem"] = {
    { 1, 0, "AO_Unknown", "=q6=Princess Yauj", "=q5=ONE WILL DROP"};
    { 2, 21682, "", "=q4=Bile-Covered Gauntlets", "=ds=#a2#", "", "20.0%" };
    { 3, 21683, "", "=q4=Mantle of the Desert Crusade", "=ds=#a4#", "", "20.0%" };
    { 4, 21684, "", "=q4=Mantle of the Desert's Fury", "=ds=#a3#", "", "20.0%" };
    { 5, 21686, "", "=q4=Mantle of Phrenic Power", "=ds=#a1#", "", "20.0%" };
    { 6, 21687, "", "=q4=Ukko's Ring of Darkness", "=ds=#s13#", "", "20.0%" };
    { 8, 0, "AO_Unknown", "=q6=Princess Yauj", "=q5=ONE WILL DROP"};
    { 9, 21692, "", "=q4=Triad Girdle", "=ds=#a4#", "", "16.7%" };
    { 10, 21693, "", "=q4=Guise of the Devourer", "=ds=#a2#", "", "16.7%" };
    { 11, 21694, "", "=q4=Ternary Mantle", "=ds=#a1#", "", "16.7%" };
    { 12, 21695, "", "=q4=Angelista's Touch", "=ds=#s13#", "", "16.7%" };
    { 13, 21696, "", "=q4=Robes of the Triumvirate", "=ds=#a1#", "", "16.7%" };
    { 14, 21697, "", "=q4=Cape of the Trinity", "=ds=#a1#", "", "16.7%" };
	};

	AtlasLoot_Data["AQ40Sartura"] = {
    { 1, 0, "AO_Unknown", "=q6=Battleguard Sartura", "=q5=ONE WILL DROP"};
    { 2, 21667, "", "=q4=Legplates of Blazing Light", "=ds=#a4#", "", "15.4%" };
    { 3, 21668, "", "=q4=Scaled Leggings of Qiraji Fury", "=ds=#a3#", "", "15.4%" };
    { 4, 21669, "", "=q4=Creeping Vine Helm", "=ds=#a2#", "", "15.4%" };
    { 5, 21670, "", "=q4=Badge of the Swarmguard", "=ds=#s14#", "", "15.4%" };
    { 6, 21671, "", "=q4=Robes of the Battleguard", "=ds=#a1#", "", "15.4%" };
    { 7, 21672, "", "=q4=Gloves of Enforcement", "=ds=#a2#", "", "15.4%" };
    { 8, 21666, "", "=q4=Sartura's Might", "=ds=#s15#", "", "7.70%" };
    { 10, 0, "AO_Unknown", "=q6=Battleguard Sartura", "=q5=ONE WILL DROP"};
    { 11, 21648, "", "=q4=Recomposed Boots", "=ds=#a1#", "", "18.2%" };
    { 12, 21674, "", "=q4=Gauntlets of Steadfast Determination", "=ds=#a4#", "", "18.2%" };
    { 13, 21675, "", "=q4=Thick Qirajihide Belt", "=ds=#a2#", "", "18.2%" };
    { 14, 21676, "", "=q4=Leggings of the Festering Swarm", "=ds=#a1#", "", "18.2%" };
    { 15, 21678, "", "=q4=Necklace of Purity", "=ds=#s2#", "", "18.2%" };
    { 16, 21673, "", "=q4=Silithid Claw", "=ds=#w13#", "", "9.09%" };
	};

	AtlasLoot_Data["AQ40Fankriss"] = {
    { 1, 0, "AO_Unknown", "=q6=Fankriss the Unyielding", "=q5=ONE WILL DROP"};
    { 2, 21639, "", "=q4=Pauldrons of the Unrelenting", "=ds=#a4#", "", "15.0%" };
    { 3, 21651, "", "=q4=Scaled Sand Reaver Leggings", "=ds=#a3#", "", "15.0%" };
    { 4, 21652, "", "=q4=Silithid Carapace Chestguard", "=ds=#a4#", "", "15.0%" };
    { 5, 21663, "", "=q4=Robes of the Guardian Saint", "=ds=#a1#", "", "15.0%" };
    { 6, 21664, "", "=q4=Barbed Choker", "=ds=#s2#", "", "15.0%" };
    { 7, 21665, "", "=q4=Mantle of Wicked Revenge", "=ds=#a2#", "", "15.0%" };
    { 8, 21650, "", "=q4=Ancient Qiraji Ripper", "=ds=#w10#", "", "10.0%" };
    { 10, 0, "AO_Unknown", "=q6=Fankriss the Unyielding", "=q5=ONE WILL DROP"};
    { 11, 21627, "", "=q4=Cloak of Untold Secrets", "=ds=#a1#", "", "18.0%" };
    { 12, 21645, "", "=q4=Hive Tunneler's Boots", "=ds=#a2#", "", "18.0%" };
    { 13, 21647, "", "=q4=Fetish of the Sand Reaver", "=ds=#s14#", "", "18.0%" };
    { 14, 22396, "", "=q4=Totem of Life", "", "", "18.0%" };
    { 15, 22402, "", "=q4=Libram of Grace", "", "", "18.0%" };
    { 16, 21635, "", "=q4=Barb of the Sand Reaver", "=ds=#w7#", "", "10.0%" };
	};

	AtlasLoot_Data["AQ40Viscidus"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Viscidus", "=q5=ALL WILL DROP"};
    { 2, 59315, "", "=q4=Qiraji Armor Cache - Shoulder", "=ds=#e10#", "", "100%" };
    { 3, 59319, "", "=q4=Viscidus's Crystalline Heart", "=ds=#m3#", "", "100%" };
    { 5, 0, "AO_Unknown", "=q6=Viscidus", "=q5=ONE WILL DROP"};
    { 6, 21622, "", "=q4=Sharpened Silithid Femur", "=ds=#w10#", "", "14.3%" };
    { 7, 21623, "", "=q4=Gauntlets of the Righteous Champion", "=ds=#a4#", "", "14.3%" };
    { 8, 21624, "", "=q4=Gauntlets of Kalimdor", "=ds=#a3#", "", "14.3%" };
    { 9, 21625, "", "=q4=Scarab Brooch", "=ds=#s14#", "", "14.3%" };
    { 10, 21626, "", "=q4=Slime-coated Leggings", "=ds=#a3#", "", "14.3%" };
    { 11, 21677, "", "=q4=Ring of the Qiraji Fury", "=ds=#s13#", "", "14.3%" };
    { 12, 22399, "", "=q4=Idol of Health", "", "", "14.3%" };
	};

	AtlasLoot_Data["AQ40Huhuran"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Princess Huhuran", "=q5=ALL WILL DROP"};
    { 2, 59318, "", "=q4=Qiraji Armor Cache - Boots", "=ds=#e10#", "", "100%" };
    { 3, 59320, "", "=q4=Huhuran's Stinger", "=ds=#m3#", "", "100%" };
    { 5, 0, "AO_Unknown", "=q6=Princess Huhuran", "=q5=ONE WILL DROP"};
    { 6, 21616, "", "=q4=Huhuran's Stinger", "=ds=#w2#", "", "16.7%" };
    { 7, 21617, "", "=q4=Wasphide Gauntlets", "=ds=#a2#", "", "16.7%" };
    { 8, 21618, "", "=q4=Hive Defiler Wristguards", "=ds=#a4#", "", "16.7%" };
    { 9, 21619, "", "=q4=Gloves of the Messiah", "=ds=#a1#", "", "16.7%" };
    { 10, 21620, "", "=q4=Ring of the Martyr", "=ds=#s13#", "", "16.7%" };
    { 11, 21621, "", "=q4=Cloak of the Golden Hive", "=ds=#a1#", "", "16.7%" };
	};

	AtlasLoot_Data["AQ40Emperors"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Emperor Vek'lor", "=q5=ALL WILL DROP"};
    { 2, 20930, "", "=q4=Vek'lor's Diadem", "=ds=#e10#", "", "100%" };
    { 3, 59314, "", "=q4=Qiraji Armor Cache - Helm", "=ds=#e10#", "", "100%" };
    { 5, 0, "RoM_stellar_dice", "=q6=Emperor Vek'lor", "=q5=CHANCE TO DROP"};
    { 6, 20735, "", "=q3=Formula: Enchant Cloak - Subtlety", "=ds=#e2#", "", "6.50%" };
    { 8, 0, "AO_Unknown", "=q6=Emperor Vek'lor", "=q5=ONE WILL DROP"};
    { 9, 21597, "", "=q4=Royal Scepter of Vek'lor", "=ds=#s15#", "", "16.7%" };
    { 10, 21598, "", "=q4=Royal Qiraji Belt", "=ds=#a4#", "", "16.7%" };
    { 11, 21599, "", "=q4=Vek'lor's Gloves of Devastation", "=ds=#a3#", "", "16.7%" };
    { 12, 21600, "", "=q4=Boots of Epiphany", "=ds=#a1#", "", "16.7%" };
    { 13, 21601, "", "=q4=Ring of Emperor Vek'lor", "=ds=#s13#", "", "16.7%" };
    { 14, 21602, "", "=q4=Qiraji Execution Bracers", "=ds=#a2#", "", "16.7%" };
	};

	AtlasLoot_Data["AQ40Ouro"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Ouro", "=q5=ALL WILL DROP"};
    { 2, 20927, "", "=q4=Ouro's Intact Hide", "=ds=#m3#", "", "100%" };
    { 3, 59317, "", "=q4=Qiraji Armor Cache - Legs", "=ds=#e10#", "", "100%" };
    { 5, 0, "AO_Unknown", "=q6=Ouro", "=q5=ONE WILL DROP"};
    { 6, 21610, "", "=q4=Wormscale Blocker", "=ds=#w8#", "", "16.7%" };
    { 7, 21611, "", "=q4=Burrower Bracers", "=ds=#a1#", "", "16.7%" };
    { 8, 21615, "", "=q4=Don Rigoberto's Lost Hat", "=ds=#a1#", "", "16.7%" };
    { 9, 23557, "", "=q4=Larvae of the Great Worm", "=ds=#w5#", "", "16.7%" };
    { 10, 23558, "", "=q4=The Burrower's Shell", "=ds=#s14#", "", "16.7%" };
    { 11, 23570, "", "=q4=Jom Gabbar", "=ds=#s14#", "", "16.7%" };
	};

	AtlasLoot_Data["AQ40CThun"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=C'Thun", "=q5=ALL WILL DROP"};
    { 2, 20929, "", "=q4=Carapace of the Old God", "=ds=#e10#", "", "100%" };
    { 3, 21221, "", "=q4=Eye of C'Thun", "=ds=#m3#", "", "100%" };
    { 4, 22734, "", "=q1=Base of Atiesh", "=ds=#m3#", "", "100%" };
    { 5, 59316, "", "=q4=Qiraji Armor Cache - Chest", "=ds=#e10#", "", "100%" };
    { 7, 0, "RoM_stellar_dice", "=q6=C'Thun", "=q5=CHANCE TO DROP"};
    { 8, 21579, "", "=q4=Vanquished Tentacle of C'Thun", "=ds=#s14#", "", "20.0%" };
    { 10, 0, "AO_Unknown", "=q6=C'Thun", "=q5=ONE WILL DROP"};
    { 11, 21585, "", "=q4=Dark Storm Gauntlets", "=ds=#a1#", "", "18.4%" };
    { 12, 21586, "", "=q4=Belt of Never-ending Agony", "=ds=#a2#", "", "18.4%" };
    { 13, 21596, "", "=q4=Ring of the Godslayer", "=ds=#s13#", "", "18.4%" };
    { 14, 22730, "", "=q4=Eyestalk Waist Cord", "=ds=#a1#", "", "18.4%" };
    { 15, 22731, "", "=q4=Cloak of the Devoured", "=ds=#a1#", "", "18.4%" };
    { 16, 21126, "", "=q4=Death's Sting", "=ds=#w4#", "", "8.00%" };
    { 18, 0, "AO_Unknown", "=q6=C'Thun", "=q5=ONE WILL DROP"};
    { 19, 21581, "", "=q4=Gauntlets of Annihilation", "=ds=#a4#", "", "21.0%" };
    { 20, 21582, "", "=q4=Grasp of the Old God", "=ds=#a1#", "", "21.0%" };
    { 21, 21583, "", "=q4=Cloak of Clarity", "=ds=#a1#", "", "21.0%" };
    { 22, 22732, "", "=q4=Mark of C'Thun", "=ds=#s2#", "", "21.0%" };
    { 23, 21134, "", "=q4=Dark Edge of Insanity", "=ds=#w1#", "", "8.00%" };
    { 24, 21839, "", "=q4=Scepter of the False Prophet", "=ds=#w6#", "", "8.00%" };
	};
	...
	AtlasLoot_Data["BFDGhamoora"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Ghamoo-ra", "=q5=CHANCE TO DROP"};
    { 2, 23720, "", "=q3=Riding Turtle", "=ds=#e10#", "", "50.0%" };
    { 4, 0, "AO_Unknown", "=q6=Ghamoo-ra", "=q5=ONE WILL DROP"};
    { 5, 6908, "", "=q3=Ghamoo-ra's Bind", "=ds=#a1#", "", "60.0%" };
    { 6, 6907, "", "=q3=Tortoise Armor", "=ds=#a3#", "", "40.0%" };
	};

	AtlasLoot_Data["BFDGhamooraMYTHIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Mythic Ghamoo-ra", "=q5=CHANCE TO DROP"};
    { 2, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 23720, "", "=q3=Riding Turtle", "=ds=#e10#", "", "50.0%" };
    { 6, 0, "AO_Unknown", "=q6=Mythic Ghamoo-ra", "=q5=ONE WILL DROP"};
    { 7, 69384, "", "=q4=Ghamoo-ra's Bind", "=ds=#a1#", "", "60.0%" };
    { 8, 69383, "", "=q4=Tortoise Armor", "=ds=#a3#", "", "40.0%" };
	};

	AtlasLoot_Data["BFDGhamooraHEROIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Heroic Ghamoo-ra", "=q5=CHANCE TO DROP"};
    { 2, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 23720, "", "=q3=Riding Turtle", "=ds=#e10#", "", "50.0%" };
    { 6, 0, "AO_Unknown", "=q6=Heroic Ghamoo-ra", "=q5=ONE WILL DROP"};
    { 7, 66384, "", "=q4=Ghamoo-ra's Bind", "=ds=#a1#", "", "60.0%" };
    { 8, 66383, "", "=q4=Tortoise Armor", "=ds=#a3#", "", "40.0%" };
	};
    ...
    { 4, 0, "AO_Unknown", "=q6=Lady Sarevess", "=q5=ONE WILL DROP"};
    { 5, 888, "", "=q3=Naga Battle Gloves", "=ds=#a2#", "", "40.0%" };
    { 6, 11121, "", "=q3=Darkwater Talwar", "=ds=#w10#", "", "40.0%" };
    { 7, 3078, "", "=q3=Naga Heartpiercer", "=ds=#w2#", "", "20.0%" };
	};

	AtlasLoot_Data["BFDSarevessMYTHIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Mythic Lady Sarevess", "=q5=CHANCE TO DROP"};
    { 2, 5952, "", "=q1=Corrupted Brain Stem", "=ds=#m3#", "", "80.0%" };
    { 3, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 0, "AO_Unknown", "=q6=Mythic Lady Sarevess", "=q5=ONE WILL DROP"};
    { 7, 11121, "", "=q3=Darkwater Talwar", "=ds=#w10#", "", "40.0%" };
    { 8, 69301, "", "=q4=Naga Battle Gloves", "=ds=#a2#", "", "40.0%" };
    { 9, 69309, "", "=q4=Naga Heartpiercer", "=ds=#w2#", "", "20.0%" };
	};

	AtlasLoot_Data["BFDSarevessHEROIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Heroic Lady Sarevess", "=q5=CHANCE TO DROP"};
    { 2, 5952, "", "=q1=Corrupted Brain Stem", "=ds=#m3#", "", "80.0%" };
    { 3, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 0, "AO_Unknown", "=q6=Heroic Lady Sarevess", "=q5=ONE WILL DROP"};
    { 7, 11121, "", "=q3=Darkwater Talwar", "=ds=#w10#", "", "40.0%" };
    { 8, 66301, "", "=q4=Naga Battle Gloves", "=ds=#a2#", "", "40.0%" };
    { 9, 66309, "", "=q4=Naga Heartpiercer", "=ds=#w2#", "", "20.0%" };
	};

	AtlasLoot_Data["BFDGelihast"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Gelihast", "=q5=CHANCE TO DROP"};
    { 2, 58100, "", "=q3=Giant Murloc", "=ds=#e10#", "", "50.0%" };
    { 4, 0, "AO_Unknown", "=q6=Gelihast", "=q5=ONE WILL DROP"};
    { 5, 6905, "", "=q3=Reef Axe", "=ds=#w1#", "", "50.0%" };
    { 6, 6906, "", "=q3=Algae Fists", "=ds=#a3#", "", "50.0%" };
	};

	AtlasLoot_Data["BFDGelihastMYTHIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Mythic Gelihast", "=q5=CHANCE TO DROP"};
    { 2, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 5, 0, "AO_Unknown", "=q6=Mythic Gelihast", "=q5=ONE WILL DROP"};
    { 6, 69381, "", "=q4=Reef Axe", "=ds=#w1#", "", "50.0%" };
    { 7, 69382, "", "=q4=Algae Fists", "=ds=#a3#", "", "50.0%" };
	};

	AtlasLoot_Data["BFDGelihastHEROIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Heroic Gelihast", "=q5=CHANCE TO DROP"};
    { 2, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 5, 0, "AO_Unknown", "=q6=Heroic Gelihast", "=q5=ONE WILL DROP"};
    { 6, 66381, "", "=q4=Reef Axe", "=ds=#w1#", "", "50.0%" };
    { 7, 66382, "", "=q4=Algae Fists", "=ds=#a3#", "", "50.0%" };
	};
	...
	AtlasLoot_Data["BFDAquanisMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Baron Aquanis", "=q5=ALL WILL DROP"};
    { 2, 16782, "", "=q2=Strange Water Globe", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Mythic Baron Aquanis", "=q5=CHANCE TO DROP"};
    { 5, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
	};

	AtlasLoot_Data["BFDAquanisHEROIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Heroic Baron Aquanis", "=q5=ALL WILL DROP"};
    { 2, 16782, "", "=q2=Strange Water Globe", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Heroic Baron Aquanis", "=q5=CHANCE TO DROP"};
    { 5, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
	};

	AtlasLoot_Data["BFDKelris"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Twilight Lord Kelris", "=q5=ALL WILL DROP"};
    { 2, 5881, "", "=q1=Head of Kelris", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Twilight Lord Kelris", "=q5=CHANCE TO DROP"};
    { 5, 59045, "", "=q2=Stormcaller's Stone", "", "", "10.0%" };
    { 7, 0, "AO_Unknown", "=q6=Twilight Lord Kelris", "=q5=ONE WILL DROP"};
    { 8, 1155, "", "=q3=Rod of the Sleepwalker", "=ds=#w9#", "", "60.0%" };
    { 9, 6903, "", "=q3=Gaze Dreamer Pants", "=ds=#a1#", "", "40.0%" };
	};

	AtlasLoot_Data["BFDKelrisMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Twilight Lord Kelris", "=q5=ALL WILL DROP"};
    { 2, 5881, "", "=q1=Head of Kelris", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Mythic Twilight Lord Kelris", "=q5=CHANCE TO DROP"};
    { 5, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 59045, "", "=q2=Stormcaller's Stone", "", "", "10.0%" };
    { 9, 0, "AO_Unknown", "=q6=Mythic Twilight Lord Kelris", "=q5=ONE WILL DROP"};
    { 10, 69302, "", "=q4=Rod of the Sleepwalker", "=ds=#w9#", "", "60.0%" };
    { 11, 69380, "", "=q4=Gaze Dreamer Pants", "=ds=#a1#", "", "40.0%" };
	};

	AtlasLoot_Data["BFDKelrisHEROIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Heroic Twilight Lord Kelris", "=q5=ALL WILL DROP"};
    { 2, 5881, "", "=q1=Head of Kelris", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Heroic Twilight Lord Kelris", "=q5=CHANCE TO DROP"};
    { 5, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 59045, "", "=q2=Stormcaller's Stone", "", "", "10.0%" };
    { 9, 0, "AO_Unknown", "=q6=Heroic Twilight Lord Kelris", "=q5=ONE WILL DROP"};
    { 10, 66302, "", "=q4=Rod of the Sleepwalker", "=ds=#w9#", "", "60.0%" };
    { 11, 66380, "", "=q4=Gaze Dreamer Pants", "=ds=#a1#", "", "40.0%" };
	};
	...
	AtlasLoot_Data["BFDSerrakisMYTHIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Mythic Old Serra'kis", "=q5=CHANCE TO DROP"};
    { 2, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
	};

	AtlasLoot_Data["BFDSerrakisHEROIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Heroic Old Serra'kis", "=q5=CHANCE TO DROP"};
    { 2, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
	};

	AtlasLoot_Data["BFDAkumai"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Aku'mai", "=q5=ALL WILL DROP"};
    { 2, 58709, "", "=q1=Void Pearl", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Aku'mai", "=q5=CHANCE TO DROP"};
    { 5, 59046, "", "=q2=Idol of Tidesong", "", "", "10.0%" };
    { 7, 0, "AO_Unknown", "=q6=Aku'mai", "=q5=ONE WILL DROP"};
    { 8, 6910, "", "=q3=Leech Pants", "=ds=#a1#", "", "40.0%" };
    { 9, 6911, "", "=q3=Moss Cinch", "=ds=#a2#", "", "40.0%" };
    { 10, 6909, "", "=q3=Strike of the Hydra", "=ds=#w10#", "", "20.0%" };
	};

	AtlasLoot_Data["BFDAkumaiMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Aku'mai", "=q5=ALL WILL DROP"};
    { 2, 58709, "", "=q1=Void Pearl", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Mythic Aku'mai", "=q5=CHANCE TO DROP"};
    { 5, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 59046, "", "=q2=Idol of Tidesong", "", "", "10.0%" };
    { 9, 0, "AO_Unknown", "=q6=Mythic Aku'mai", "=q5=ONE WILL DROP"};
    { 10, 69385, "", "=q4=Leech Pants", "=ds=#a1#", "", "40.0%" };
    { 11, 69386, "", "=q4=Moss Cinch", "=ds=#a2#", "", "40.0%" };
    { 12, 6909, "", "=q3=Strike of the Hydra", "=ds=#w10#", "", "20.0%" };
	};

	AtlasLoot_Data["BFDAkumaiHEROIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Heroic Aku'mai", "=q5=ALL WILL DROP"};
    { 2, 58709, "", "=q1=Void Pearl", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Heroic Aku'mai", "=q5=CHANCE TO DROP"};
    { 5, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 59046, "", "=q2=Idol of Tidesong", "", "", "10.0%" };
    { 9, 0, "AO_Unknown", "=q6=Heroic Aku'mai", "=q5=ONE WILL DROP"};
    { 10, 66385, "", "=q4=Leech Pants", "=ds=#a1#", "", "40.0%" };
    { 11, 66386, "", "=q4=Moss Cinch", "=ds=#a2#", "", "40.0%" };
    { 12, 6909, "", "=q3=Strike of the Hydra", "=ds=#w10#", "", "20.0%" };
	};
    ...
    { 1, 0, "RoM_stellar_dice", "=q6=Lord Roccor", "=q5=CHANCE TO DROP"};
    ...
    { 10, 22234, "", "=q3=Mantle of Lost Hope", "=ds=#a1#", "", "25.0%" };
    { 11, 22397, "", "=q3=Idol of Ferocity", "", "", "25.0%" };
	};

	AtlasLoot_Data["BRDLordRoccorMYTHIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Mythic Lord Roccor", "=q5=CHANCE TO DROP"};
    { 2, 11129, "", "=q1=Essence of the Elements", "=ds=#m3#", "", "80.0%" };
    { 3, 22527, "", "=q1=Core of Elements", "=ds=#m3#", "", "55.0%" };
    { 4, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 5, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 11630, "", "=q3=Rockshard Pellets", "=ds=#e6#", "", "16.0%" };
    { 7, 11813, "", "=q3=Formula: Smoking Heart of the Mountain", "=ds=#e2#", "", "15.0%" };
    { 9, 0, "AO_Unknown", "=q6=Mythic Lord Roccor", "=q5=ONE WILL DROP"};
    { 10, 69508, "", "=q4=Stoneshell Guard", "=ds=#w8#", "", "25.0%" };
    { 11, 69509, "", "=q4=Earthslag Shoulders", "=ds=#a4#", "", "25.0%" };
    { 12, 69926, "", "=q4=Mantle of Lost Hope", "=ds=#a1#", "", "25.0%" };
    { 13, 69961, "", "=q4=Idol of Ferocity", "", "", "25.0%" };
	};

	AtlasLoot_Data["BRDLordRoccorHEROIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Heroic Lord Roccor", "=q5=CHANCE TO DROP"};
    { 2, 11129, "", "=q1=Essence of the Elements", "=ds=#m3#", "", "80.0%" };
    { 3, 22527, "", "=q1=Core of Elements", "=ds=#m3#", "", "55.0%" };
    { 4, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 5, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 11630, "", "=q3=Rockshard Pellets", "=ds=#e6#", "", "16.0%" };
    { 7, 11813, "", "=q3=Formula: Smoking Heart of the Mountain", "=ds=#e2#", "", "15.0%" };
    { 9, 0, "AO_Unknown", "=q6=Heroic Lord Roccor", "=q5=ONE WILL DROP"};
    { 10, 66508, "", "=q4=Stoneshell Guard", "=ds=#w8#", "", "25.0%" };
    { 11, 66509, "", "=q4=Earthslag Shoulders", "=ds=#a4#", "", "25.0%" };
    { 12, 66926, "", "=q4=Mantle of Lost Hope", "=ds=#a1#", "", "25.0%" };
    { 13, 66961, "", "=q4=Idol of Ferocity", "", "", "25.0%" };
	};
	...
	AtlasLoot_Data["BRDHighInterrogatorGerstahnMYTHIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Mythic High Interrogator Gerstahn", "=q5=CHANCE TO DROP"};
    { 2, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 5, 0, "AO_Unknown", "=q6=Mythic High Interrogator Gerstahn", "=q5=ONE WILL DROP"};
    { 6, 69504, "", "=q4=Kentic Amice", "=ds=#a1#", "", "25.0%" };
    { 7, 69505, "", "=q4=Enthralled Sphere", "=ds=#s15#", "", "25.0%" };
    { 8, 69506, "", "=q4=Blackveil Cape", "=ds=#a1#", "", "25.0%" };
    { 9, 69927, "", "=q4=Greaves of Withering Despair", "=ds=#a3#", "", "25.0%" };
	};

	AtlasLoot_Data["BRDHighInterrogatorGerstahnHEROIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Heroic High Interrogator Gerstahn", "=q5=CHANCE TO DROP"};
    { 2, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 5, 0, "AO_Unknown", "=q6=Heroic High Interrogator Gerstahn", "=q5=ONE WILL DROP"};
    { 6, 66504, "", "=q4=Kentic Amice", "=ds=#a1#", "", "25.0%" };
    { 7, 66505, "", "=q4=Enthralled Sphere", "=ds=#s15#", "", "25.0%" };
    { 8, 66506, "", "=q4=Blackveil Cape", "=ds=#a1#", "", "25.0%" };
    { 9, 66927, "", "=q4=Greaves of Withering Despair", "=ds=#a3#", "", "25.0%" };
	};
	...
	AtlasLoot_Data["BRDAnubshiahMYTHIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Mythic Anub'shiah", "=q5=CHANCE TO DROP"};
    { 2, 22525, "", "=q1=Crypt Fiend Parts", "=ds=#m3#", "", "57.0%" };
    { 3, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 5, 69515, "", "=q4=Carapace of Anub'shiah", "=ds=#a4#", "", "15.0%" };
    { 7, 0, "AO_Unknown", "=q6=Mythic Anub'shiah", "=q5=ONE WILL DROP"};
    { 8, 69513, "", "=q4=Shadefiend Boots", "=ds=#a2#", "", "42.5%" };
    { 9, 69514, "", "=q4=Graverot Cape", "=ds=#a1#", "", "42.5%" };
    { 10, 11731, "", "=q3=Savage Gladiator Greaves", "=ds=#a3#", "", "15.0%" };
	};

	AtlasLoot_Data["BRDAnubshiahHEROIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Heroic Anub'shiah", "=q5=CHANCE TO DROP"};
    { 2, 22525, "", "=q1=Crypt Fiend Parts", "=ds=#m3#", "", "57.0%" };
    { 3, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 5, 66515, "", "=q4=Carapace of Anub'shiah", "=ds=#a4#", "", "15.0%" };
    { 7, 0, "AO_Unknown", "=q6=Heroic Anub'shiah", "=q5=ONE WILL DROP"};
    { 8, 66513, "", "=q4=Shadefiend Boots", "=ds=#a2#", "", "42.5%" };
    { 9, 66514, "", "=q4=Graverot Cape", "=ds=#a1#", "", "42.5%" };
    { 10, 11731, "", "=q3=Savage Gladiator Greaves", "=ds=#a3#", "", "15.0%" };
	};
	...
	AtlasLoot_Data["BRDEvisceratorMYTHIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Mythic Eviscerator", "=q5=CHANCE TO DROP"};
    { 2, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 5, 0, "AO_Unknown", "=q6=Mythic Eviscerator", "=q5=ONE WILL DROP"};
    { 6, 69516, "", "=q4=Rubicund Armguards", "=ds=#a3#", "", "35.0%" };
    { 7, 69517, "", "=q4=Splinthide Shoulders", "=ds=#a2#", "", "35.0%" };
    { 8, 11730, "", "=q3=Savage Gladiator Grips", "=ds=#a3#", "", "15.0%" };
    { 9, 69518, "", "=q4=Girdle of Beastial Fury", "=ds=#a2#", "", "15.0%" };
	};

	AtlasLoot_Data["BRDEvisceratorHEROIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Heroic Eviscerator", "=q5=CHANCE TO DROP"};
    { 2, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 5, 0, "AO_Unknown", "=q6=Heroic Eviscerator", "=q5=ONE WILL DROP"};
    { 6, 66516, "", "=q4=Rubicund Armguards", "=ds=#a3#", "", "35.0%" };
    { 7, 66517, "", "=q4=Splinthide Shoulders", "=ds=#a2#", "", "35.0%" };
    { 8, 11730, "", "=q3=Savage Gladiator Grips", "=ds=#a3#", "", "15.0%" };
    { 9, 66518, "", "=q4=Girdle of Beastial Fury", "=ds=#a2#", "", "15.0%" };
	};
	...
	AtlasLoot_Data["BRDGoroshMYTHIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Mythic Gorosh the Dervish", "=q5=CHANCE TO DROP"};
    { 2, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 5, 0, "AO_Unknown", "=q6=Mythic Gorosh the Dervish", "=q5=ONE WILL DROP"};
    { 6, 69936, "", "=q4=Bloodclot Band", "=ds=#s13#", "", "35.0%" };
    { 7, 69941, "", "=q4=Leggings of Frenzied Magic", "=ds=#a2#", "", "35.0%" };
    { 8, 11726, "", "=q4=Savage Gladiator Chain", "=ds=#a3#", "", "15.0%" };
    { 9, 69937, "", "=q4=Flarethorn", "=ds=#w4#", "", "15.0%" };
	};

	AtlasLoot_Data["BRDGoroshHEROIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Heroic Gorosh the Dervish", "=q5=CHANCE TO DROP"};
    { 2, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 5, 0, "AO_Unknown", "=q6=Heroic Gorosh the Dervish", "=q5=ONE WILL DROP"};
    { 6, 66936, "", "=q4=Bloodclot Band", "=ds=#s13#", "", "35.0%" };
    { 7, 66941, "", "=q4=Leggings of Frenzied Magic", "=ds=#a2#", "", "35.0%" };
    { 8, 11726, "", "=q4=Savage Gladiator Chain", "=ds=#a3#", "", "15.0%" };
    { 9, 66937, "", "=q4=Flarethorn", "=ds=#w4#", "", "15.0%" };
	};
	...
	AtlasLoot_Data["BRDGrizzleMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Grizzle", "=q5=ALL WILL DROP"};
    { 2, 11610, "", "=q3=Plans: Dark Iron Pulverizer", "=ds=#e2#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Mythic Grizzle", "=q5=CHANCE TO DROP"};
    { 5, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 8, 0, "AO_Unknown", "=q6=Mythic Grizzle", "=q5=ONE WILL DROP"};
    { 9, 69519, "", "=q4=Grizzle's Skinner", "=ds=#w1#", "", "35.0%" };
    { 10, 69520, "", "=q4=Stonewall Girdle", "=ds=#a4#", "", "35.0%" };
    { 11, 69521, "", "=q4=Dregmetal Spaulders", "=ds=#a3#", "", "15.0%" };
    { 12, 69940, "", "=q4=Entrenching Boots", "=ds=#a4#", "", "15.0%" };
	};

	AtlasLoot_Data["BRDGrizzleHEROIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Heroic Grizzle", "=q5=ALL WILL DROP"};
    { 2, 11610, "", "=q3=Plans: Dark Iron Pulverizer", "=ds=#e2#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Heroic Grizzle", "=q5=CHANCE TO DROP"};
    { 5, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 8, 0, "AO_Unknown", "=q6=Heroic Grizzle", "=q5=ONE WILL DROP"};
    { 9, 66519, "", "=q4=Grizzle's Skinner", "=ds=#w1#", "", "35.0%" };
    { 10, 66520, "", "=q4=Stonewall Girdle", "=ds=#a4#", "", "35.0%" };
    { 11, 66521, "", "=q4=Dregmetal Spaulders", "=ds=#a3#", "", "15.0%" };
    { 12, 66940, "", "=q4=Entrenching Boots", "=ds=#a4#", "", "15.0%" };
	};
	...
	AtlasLoot_Data["BRDHedrumMYTHIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Mythic Hedrum the Creeper", "=q5=CHANCE TO DROP"};
    { 2, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 5, 0, "AO_Unknown", "=q6=Mythic Hedrum the Creeper", "=q5=ONE WILL DROP"};
    { 6, 69510, "", "=q4=Spiderfang Carapace", "=ds=#a4#", "", "35.0%" };
    { 7, 69511, "", "=q4=Silkweb Gloves", "=ds=#a1#", "", "35.0%" };
    { 8, 11635, "", "=q3=Hookfang Shanker", "=ds=#w4#", "", "15.0%" };
    { 9, 11729, "", "=q3=Savage Gladiator Helm", "=ds=#a3#", "", "15.0%" };
	};

	AtlasLoot_Data["BRDHedrumHEROIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Heroic Hedrum the Creeper", "=q5=CHANCE TO DROP"};
    { 2, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 5, 0, "AO_Unknown", "=q6=Heroic Hedrum the Creeper", "=q5=ONE WILL DROP"};
    { 6, 66510, "", "=q4=Spiderfang Carapace", "=ds=#a4#", "", "35.0%" };
    { 7, 66511, "", "=q4=Silkweb Gloves", "=ds=#a1#", "", "35.0%" };
    { 8, 11635, "", "=q3=Hookfang Shanker", "=ds=#w4#", "", "15.0%" };
    { 9, 11729, "", "=q3=Savage Gladiator Helm", "=ds=#a3#", "", "15.0%" };
	};
	...
	AtlasLoot_Data["BRDOkthorMYTHIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Mythic Ok'thor the Breaker", "=q5=CHANCE TO DROP"};
    { 2, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 5, 0, "AO_Unknown", "=q6=Mythic Ok'thor the Breaker", "=q5=ONE WILL DROP"};
    { 6, 11662, "", "=q3=Ban'thok Sash", "=ds=#a1#", "", "35.0%" };
    { 7, 69512, "", "=q4=Ogreseer Fists", "=ds=#a2#", "", "35.0%" };
    { 8, 11728, "", "=q3=Savage Gladiator Leggings", "=ds=#a3#", "", "15.0%" };
    { 9, 69552, "", "=q4=Cyclopean Band", "=ds=#s13#", "", "15.0%" };
	};

	AtlasLoot_Data["BRDOkthorHEROIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Heroic Ok'thor the Breaker", "=q5=CHANCE TO DROP"};
    { 2, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 5, 0, "AO_Unknown", "=q6=Heroic Ok'thor the Breaker", "=q5=ONE WILL DROP"};
    { 6, 11662, "", "=q3=Ban'thok Sash", "=ds=#a1#", "", "35.0%" };
    { 7, 66512, "", "=q4=Ogreseer Fists", "=ds=#a2#", "", "35.0%" };
    { 8, 11728, "", "=q3=Savage Gladiator Leggings", "=ds=#a3#", "", "15.0%" };
    { 9, 66552, "", "=q4=Cyclopean Band", "=ds=#s13#", "", "15.0%" };
	};
	...
	AtlasLoot_Data["BRDTheldrenMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Theldren", "=q5=ALL WILL DROP"};
    { 2, 22047, "", "=q1=Top Piece of Lord Valthalak's Amulet", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Mythic Theldren", "=q5=CHANCE TO DROP"};
    { 5, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
	};
    ...
    { 2, 22047, "", "=q1=Top Piece of Lord Valthalak's Amulet", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Heroic Theldren", "=q5=CHANCE TO DROP"};
    { 5, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
	};

	AtlasLoot_Data["BRDHoundmaster"] = {
    { 1, 0, "AO_Unknown", "=q6=Houndmaster Grebmar", "=q5=ONE WILL DROP"};
    { 2, 11623, "", "=q3=Spritecaster Cape", "=ds=#a1#", "", "35.0%" };
    { 3, 11627, "", "=q3=Fleetfoot Greaves", "=ds=#a3#", "", "35.0%" };
    { 4, 11628, "", "=q3=Houndmaster's Bow", "=ds=#w2#", "", "15.0%" };
    { 5, 11629, "", "=q3=Houndmaster's Rifle", "=ds=#w5#", "", "15.0%" };
	};

	AtlasLoot_Data["BRDHoundmasterMYTHIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Mythic Houndmaster Grebmar", "=q5=CHANCE TO DROP"};
    { 2, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 5, 0, "AO_Unknown", "=q6=Mythic Houndmaster Grebmar", "=q5=ONE WILL DROP"};
    { 6, 69503, "", "=q4=Spritecaster Cape", "=ds=#a1#", "", "35.0%" };
    { 7, 69507, "", "=q4=Fleetfoot Greaves", "=ds=#a3#", "", "35.0%" };
    { 8, 11628, "", "=q3=Houndmaster's Bow", "=ds=#w2#", "", "15.0%" };
    { 9, 11629, "", "=q3=Houndmaster's Rifle", "=ds=#w5#", "", "15.0%" };
	};

	AtlasLoot_Data["BRDHoundmasterHEROIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Heroic Houndmaster Grebmar", "=q5=CHANCE TO DROP"};
    { 2, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 5, 0, "AO_Unknown", "=q6=Heroic Houndmaster Grebmar", "=q5=ONE WILL DROP"};
    { 6, 66503, "", "=q4=Spritecaster Cape", "=ds=#a1#", "", "35.0%" };
    { 7, 66507, "", "=q4=Fleetfoot Greaves", "=ds=#a3#", "", "35.0%" };
    { 8, 11628, "", "=q3=Houndmaster's Bow", "=ds=#w2#", "", "15.0%" };
    { 9, 11629, "", "=q3=Houndmaster's Rifle", "=ds=#w5#", "", "15.0%" };
	};
    ...
    { 1, 0, "RoM_stellar_dice", "=q6=Pyromancer Loregrain", "=q5=CHANCE TO DROP"};
    { 2, 11207, "", "=q2=Formula: Enchant Weapon - Fiery Weapon", "=ds=#e2#", "", "16.0%" };
    { 3, 17, "", "=q6=Martin Fury", "=ds=#a4#", "", "" };
    { 5, 0, "AO_Unknown", "=q6=Pyromancer Loregrain", "=q5=ONE WILL DROP"};
    { 6, 11747, "", "=q3=Flamestrider Robes", "=ds=#a2#", "", "26.7%" };
    { 7, 11748, "", "=q3=Pyric Caduceus", "=ds=#w12#", "", "26.7%" };
    { 8, 11749, "", "=q3=Searingscale Leggings", "=ds=#a3#", "", "26.7%" };
    { 9, 11750, "", "=q3=Kindling Stave", "=ds=#w9#", "", "20.0%" };
	};

	AtlasLoot_Data["BRDPyromantLoregrainMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Pyromancer Loregrain", "=q5=ALL WILL DROP"};
    { 2, 17, "", "=q6=Martin Fury", "=ds=#a4#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Mythic Pyromancer Loregrain", "=q5=CHANCE TO DROP"};
    { 5, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 11207, "", "=q2=Formula: Enchant Weapon - Fiery Weapon", "=ds=#e2#", "", "16.0%" };
    { 9, 0, "AO_Unknown", "=q6=Mythic Pyromancer Loregrain", "=q5=ONE WILL DROP"};
    { 10, 69529, "", "=q4=Kindling Stave", "=ds=#w9#", "", "20.0%" };
    { 11, 12527, "", "=q3=Ribsplitter", "=ds=#w1#", "", "5.71%" };
    { 12, 12528, "", "=q3=The Judge's Gavel", "=ds=#w6#", "", "5.71%" };
    { 13, 12531, "", "=q3=Searing Needle", "=ds=#w4#", "", "5.71%" };
    { 14, 12532, "", "=q3=Spire of the Stoneshaper", "=ds=#w9#", "", "5.71%" };
    { 15, 12535, "", "=q3=Doomforged Straightedge", "=ds=#w10#", "", "5.71%" };
    { 16, 12542, "", "=q3=Funeral Pyre Vestment", "=ds=#a1#", "", "5.71%" };
    { 17, 12546, "", "=q3=Aristocratic Cuffs", "=ds=#a1#", "", "5.71%" };
    { 18, 12547, "", "=q3=Mar Alom's Grip", "=ds=#a2#", "", "5.71%" };
    { 19, 12550, "", "=q3=Runed Golem Shackles", "=ds=#a4#", "", "5.71%" };
    { 20, 12551, "", "=q3=Stoneshield Cloak", "=ds=#a1#", "", "5.71%" };
    { 21, 12552, "", "=q3=Blisterbane Wrap", "=ds=#a1#", "", "5.71%" };
    { 22, 69526, "", "=q4=Flamestrider Robes", "=ds=#a2#", "", "5.71%" };
    { 23, 69527, "", "=q4=Pyric Caduceus", "=ds=#w12#", "", "5.71%" };
    { 24, 69528, "", "=q4=Searingscale Leggings", "=ds=#a3#", "", "5.71%" };
	};

	AtlasLoot_Data["BRDPyromantLoregrainHEROIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Heroic Pyromancer Loregrain", "=q5=ALL WILL DROP"};
    { 2, 17, "", "=q6=Martin Fury", "=ds=#a4#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Heroic Pyromancer Loregrain", "=q5=CHANCE TO DROP"};
    { 5, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 11207, "", "=q2=Formula: Enchant Weapon - Fiery Weapon", "=ds=#e2#", "", "16.0%" };
    { 9, 0, "AO_Unknown", "=q6=Heroic Pyromancer Loregrain", "=q5=ONE WILL DROP"};
    { 10, 66529, "", "=q4=Kindling Stave", "=ds=#w9#", "", "20.0%" };
    { 11, 12527, "", "=q3=Ribsplitter", "=ds=#w1#", "", "5.71%" };
    { 12, 12528, "", "=q3=The Judge's Gavel", "=ds=#w6#", "", "5.71%" };
    { 13, 12531, "", "=q3=Searing Needle", "=ds=#w4#", "", "5.71%" };
    { 14, 12532, "", "=q3=Spire of the Stoneshaper", "=ds=#w9#", "", "5.71%" };
    ...
    { 20, 12551, "", "=q3=Stoneshield Cloak", "=ds=#a1#", "", "5.71%" };
    { 21, 12552, "", "=q3=Blisterbane Wrap", "=ds=#a1#", "", "5.71%" };
    { 22, 66526, "", "=q4=Flamestrider Robes", "=ds=#a2#", "", "5.71%" };
    { 23, 66527, "", "=q4=Pyric Caduceus", "=ds=#w12#", "", "5.71%" };
    { 24, 66528, "", "=q4=Searingscale Leggings", "=ds=#a3#", "", "5.71%" };
	};
    ...
    { 1, 0, "RoM_stellar_dice", "=q6=Warder Stilgiss", "=q5=CHANCE TO DROP"};
    { 2, 17, "", "=q6=Martin Fury", "=ds=#a4#", "", "" };
    { 4, 0, "AO_Unknown", "=q6=Warder Stilgiss", "=q5=ONE WILL DROP"};
    { 5, 11782, "", "=q3=Boreal Mantle", "=ds=#a1#", "", "25.0%" };
    { 6, 11783, "", "=q3=Chillsteel Girdle", "=ds=#a3#", "", "25.0%" };
    { 7, 11784, "", "=q3=Arbiter's Blade", "=ds=#w10#", "", "25.0%" };
    { 8, 22241, "", "=q3=Dark Warder's Pauldrons", "=ds=#a2#", "", "25.0%" };
	};

	AtlasLoot_Data["BRDWarderStilgissMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Warder Stilgiss", "=q5=ALL WILL DROP"};
    { 2, 17, "", "=q6=Martin Fury", "=ds=#a4#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Mythic Warder Stilgiss", "=q5=CHANCE TO DROP"};
    { 5, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 8, 0, "AO_Unknown", "=q6=Mythic Warder Stilgiss", "=q5=ONE WILL DROP"};
    { 9, 12527, "", "=q3=Ribsplitter", "=ds=#w1#", "", "6.67%" };
    { 10, 12528, "", "=q3=The Judge's Gavel", "=ds=#w6#", "", "6.67%" };
    { 11, 12531, "", "=q3=Searing Needle", "=ds=#w4#", "", "6.67%" };
    { 12, 12532, "", "=q3=Spire of the Stoneshaper", "=ds=#w9#", "", "6.67%" };
    { 13, 12535, "", "=q3=Doomforged Straightedge", "=ds=#w10#", "", "6.67%" };
    { 14, 12542, "", "=q3=Funeral Pyre Vestment", "=ds=#a1#", "", "6.67%" };
    { 15, 12546, "", "=q3=Aristocratic Cuffs", "=ds=#a1#", "", "6.67%" };
    { 16, 12547, "", "=q3=Mar Alom's Grip", "=ds=#a2#", "", "6.67%" };
    { 17, 12550, "", "=q3=Runed Golem Shackles", "=ds=#a4#", "", "6.67%" };
    { 18, 12551, "", "=q3=Stoneshield Cloak", "=ds=#a1#", "", "6.67%" };
    { 19, 12552, "", "=q3=Blisterbane Wrap", "=ds=#a1#", "", "6.67%" };
    { 20, 69535, "", "=q4=Boreal Mantle", "=ds=#a1#", "", "6.67%" };
    { 21, 69536, "", "=q4=Chillsteel Girdle", "=ds=#a3#", "", "6.67%" };
    { 22, 69537, "", "=q4=Arbiter's Blade", "=ds=#w10#", "", "6.67%" };
    { 23, 69928, "", "=q4=Dark Warder's Pauldrons", "=ds=#a2#", "", "6.67%" };
	};

	AtlasLoot_Data["BRDWarderStilgissHEROIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Heroic Warder Stilgiss", "=q5=ALL WILL DROP"};
    { 2, 17, "", "=q6=Martin Fury", "=ds=#a4#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Heroic Warder Stilgiss", "=q5=CHANCE TO DROP"};
    { 5, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    ...
    { 18, 12551, "", "=q3=Stoneshield Cloak", "=ds=#a1#", "", "6.67%" };
    { 19, 12552, "", "=q3=Blisterbane Wrap", "=ds=#a1#", "", "6.67%" };
    { 20, 66535, "", "=q4=Boreal Mantle", "=ds=#a1#", "", "6.67%" };
    { 21, 66536, "", "=q4=Chillsteel Girdle", "=ds=#a3#", "", "6.67%" };
    { 22, 66537, "", "=q4=Arbiter's Blade", "=ds=#w10#", "", "6.67%" };
    { 23, 66928, "", "=q4=Dark Warder's Pauldrons", "=ds=#a2#", "", "6.67%" };
	};
	...
	AtlasLoot_Data["BRDVerekMYTHIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Mythic Verek", "=q5=CHANCE TO DROP"};
    { 2, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 16, 0, "AO_Unknown", "=q6=Mythic Verek", "=q5=ONE WILL DROP"};
    { 17, 69929, "", "=q4=Verek's Leash", "=ds=#a3#", "", "13.0%" };
    { 18, 69530, "", "=q4=Verek's Collar", "=ds=#s2#", "", "12.0%" };
    { 19, 12527, "", "=q3=Ribsplitter", "=ds=#w1#", "", "6.82%" };
    { 20, 12528, "", "=q3=The Judge's Gavel", "=ds=#w6#", "", "6.82%" };
    { 21, 12531, "", "=q3=Searing Needle", "=ds=#w4#", "", "6.82%" };
    { 22, 12532, "", "=q3=Spire of the Stoneshaper", "=ds=#w9#", "", "6.82%" };
    { 23, 12535, "", "=q3=Doomforged Straightedge", "=ds=#w10#", "", "6.82%" };
    { 24, 12542, "", "=q3=Funeral Pyre Vestment", "=ds=#a1#", "", "6.82%" };
    { 25, 12546, "", "=q3=Aristocratic Cuffs", "=ds=#a1#", "", "6.82%" };
    { 26, 12547, "", "=q3=Mar Alom's Grip", "=ds=#a2#", "", "6.82%" };
    { 27, 12550, "", "=q3=Runed Golem Shackles", "=ds=#a4#", "", "6.82%" };
    { 28, 12551, "", "=q3=Stoneshield Cloak", "=ds=#a1#", "", "6.82%" };
    { 29, 12552, "", "=q3=Blisterbane Wrap", "=ds=#a1#", "", "6.82%" };
	};

	AtlasLoot_Data["BRDVerekHEROIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Heroic Verek", "=q5=CHANCE TO DROP"};
    { 2, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 16, 0, "AO_Unknown", "=q6=Heroic Verek", "=q5=ONE WILL DROP"};
    { 17, 66929, "", "=q4=Verek's Leash", "=ds=#a3#", "", "13.0%" };
    { 18, 66530, "", "=q4=Verek's Collar", "=ds=#s2#", "", "12.0%" };
    { 19, 12527, "", "=q3=Ribsplitter", "=ds=#w1#", "", "6.82%" };
    { 20, 12528, "", "=q3=The Judge's Gavel", "=ds=#w6#", "", "6.82%" };
    { 21, 12531, "", "=q3=Searing Needle", "=ds=#w4#", "", "6.82%" };
    { 22, 12532, "", "=q3=Spire of the Stoneshaper", "=ds=#w9#", "", "6.82%" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6=Fineous Darkvire", "=q5=ALL WILL DROP"};
    { 2, 10999, "", "=q1=Ironfel", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Fineous Darkvire", "=q5=CHANCE TO DROP"};
    { 5, 11468, "", "=q1=Dark Iron Fanny Pack", "=ds=#m3#", "", "80.0%" };
    { 7, 0, "AO_Unknown", "=q6=Fineous Darkvire", "=q5=ONE WILL DROP"};
    { 8, 11839, "", "=q3=Chief Architect's Monocle", "=ds=#a1#", "", "25.0%" };
	...
	AtlasLoot_Data["BRDFineousDarkvireMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Fineous Darkvire", "=q5=ALL WILL DROP"};
    { 2, 10999, "", "=q1=Ironfel", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Mythic Fineous Darkvire", "=q5=CHANCE TO DROP"};
    { 5, 11468, "", "=q1=Dark Iron Fanny Pack", "=ds=#m3#", "", "80.0%" };
    { 6, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 9, 0, "AO_Unknown", "=q6=Mythic Fineous Darkvire", "=q5=ONE WILL DROP"};
    { 10, 69554, "", "=q4=Chief Architect's Monocle", "=ds=#a1#", "", "25.0%" };
    { 11, 69555, "", "=q4=Senior Designer's Pantaloons", "=ds=#a1#", "", "25.0%" };
    { 12, 69556, "", "=q4=Lead Surveyor's Mantle", "=ds=#a3#", "", "25.0%" };
    { 13, 69923, "", "=q4=Foreman's Head Protector", "=ds=#a4#", "", "25.0%" };
	};

	AtlasLoot_Data["BRDFineousDarkvireHEROIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Heroic Fineous Darkvire", "=q5=ALL WILL DROP"};
    { 2, 10999, "", "=q1=Ironfel", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Heroic Fineous Darkvire", "=q5=CHANCE TO DROP"};
    { 5, 11468, "", "=q1=Dark Iron Fanny Pack", "=ds=#m3#", "", "80.0%" };
    { 6, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 9, 0, "AO_Unknown", "=q6=Heroic Fineous Darkvire", "=q5=ONE WILL DROP"};
    { 10, 66554, "", "=q4=Chief Architect's Monocle", "=ds=#a1#", "", "25.0%" };
    { 11, 66555, "", "=q4=Senior Designer's Pantaloons", "=ds=#a1#", "", "25.0%" };
    { 12, 66556, "", "=q4=Lead Surveyor's Mantle", "=ds=#a3#", "", "25.0%" };
    { 13, 66923, "", "=q4=Foreman's Head Protector", "=ds=#a4#", "", "25.0%" };
	};

	AtlasLoot_Data["BRDLordIncendius"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Lord Incendius", "=q5=ALL WILL DROP"};
    { 2, 11126, "", "=q1=Tablet of Kurniya", "=ds=#m3#", "", "100%" };
    { 3, 21987, "", "=q1=Incendicite of Incendius", "=ds=#m3#", "", "100%" };
    { 4, 58714, "", "=q1=Incendiary Core", "=ds=#m3#", "", "100%" };
    ...
    { 9, 57458, "", "=q1=Technique: Scroll of Fire Resistance IV", "=ds=#e2#", "", "15.0%" };
	...
	AtlasLoot_Data["BRDLordIncendiusMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Lord Incendius", "=q5=ALL WILL DROP"};
    { 2, 11126, "", "=q1=Tablet of Kurniya", "=ds=#m3#", "", "100%" };
    { 3, 21987, "", "=q1=Incendicite of Incendius", "=ds=#m3#", "", "100%" };
    { 4, 58714, "", "=q1=Incendiary Core", "=ds=#m3#", "", "100%" };
    { 6, 0, "RoM_stellar_dice", "=q6=Mythic Lord Incendius", "=q5=CHANCE TO DROP"};
    { 7, 11129, "", "=q1=Essence of the Elements", "=ds=#m3#", "", "80.0%" };
    { 8, 22527, "", "=q1=Core of Elements", "=ds=#m3#", "", "55.0%" };
    { 9, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 10, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 11, 57458, "", "=q1=Technique: Scroll of Fire Resistance IV", "=ds=#e2#", "", "15.0%" };
    { 16, 0, "AO_Unknown", "=q6=Mythic Lord Incendius", "=q5=ONE WILL DROP"};
    { 17, 69531, "", "=q4=Cinderhide Armsplints", "=ds=#a2#", "", "25.0%" };
    { 18, 69532, "", "=q4=Pyremail Wristguards", "=ds=#a3#", "", "25.0%" };
    { 19, 69533, "", "=q4=Flameweave Cuffs", "=ds=#a1#", "", "25.0%" };
    { 20, 69534, "", "=q4=Emberplate Armguards", "=ds=#a4#", "", "25.0%" };
	};
    ...
    { 3, 21987, "", "=q1=Incendicite of Incendius", "=ds=#m3#", "", "100%" };
    { 4, 58714, "", "=q1=Incendiary Core", "=ds=#m3#", "", "100%" };
    { 6, 0, "RoM_stellar_dice", "=q6=Heroic Lord Incendius", "=q5=CHANCE TO DROP"};
    { 7, 11129, "", "=q1=Essence of the Elements", "=ds=#m3#", "", "80.0%" };
    { 8, 22527, "", "=q1=Core of Elements", "=ds=#m3#", "", "55.0%" };
    { 9, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 10, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 11, 57458, "", "=q1=Technique: Scroll of Fire Resistance IV", "=ds=#e2#", "", "15.0%" };
    { 16, 0, "AO_Unknown", "=q6=Heroic Lord Incendius", "=q5=ONE WILL DROP"};
    { 17, 66531, "", "=q4=Cinderhide Armsplints", "=ds=#a2#", "", "25.0%" };
    { 18, 66532, "", "=q4=Pyremail Wristguards", "=ds=#a3#", "", "25.0%" };
    { 19, 66533, "", "=q4=Flameweave Cuffs", "=ds=#a1#", "", "25.0%" };
    { 20, 66534, "", "=q4=Emberplate Armguards", "=ds=#a4#", "", "25.0%" };
	};
	...
	AtlasLoot_Data["BRDBaelGarMYTHIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Mythic Bael'Gar", "=q5=CHANCE TO DROP"};
    { 2, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 5, 0, "AO_Unknown", "=q6=Mythic Bael'Gar", "=q5=ONE WILL DROP"};
    { 6, 11803, "", "=q3=Force of Magma", "=ds=#w6#", "", "32.0%" };
    { 7, 69541, "", "=q4=Lavacrest Leggings", "=ds=#a4#", "", "32.0%" };
    { 8, 69542, "", "=q4=Rubidium Hammer", "=ds=#w6#", "", "18.0%" };
    { 9, 69543, "", "=q4=Sash of the Burning Heart", "=ds=#a1#", "", "18.0%" };
	};

	AtlasLoot_Data["BRDBaelGarHEROIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Heroic Bael'Gar", "=q5=CHANCE TO DROP"};
    { 2, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 5, 0, "AO_Unknown", "=q6=Heroic Bael'Gar", "=q5=ONE WILL DROP"};
    { 6, 11803, "", "=q3=Force of Magma", "=ds=#w6#", "", "32.0%" };
    { 7, 66541, "", "=q4=Lavacrest Leggings", "=ds=#a4#", "", "32.0%" };
    { 8, 66542, "", "=q4=Rubidium Hammer", "=ds=#w6#", "", "18.0%" };
    { 9, 66543, "", "=q4=Sash of the Burning Heart", "=ds=#a1#", "", "18.0%" };
	};

	AtlasLoot_Data["BRDGeneralAngerforge"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=General Angerforge", "=q5=ALL WILL DROP"};
    { 2, 11464, "", "=q1=Marshal Windsor's Lost Information", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=General Angerforge", "=q5=CHANCE TO DROP"};
    { 5, 11468, "", "=q1=Dark Iron Fanny Pack", "=ds=#m3#", "", "80.0%" };
    { 7, 0, "AO_Unknown", "=q6=General Angerforge", "=q5=ONE WILL DROP"};
    { 8, 11810, "", "=q3=Force of Will", "=ds=#s14#", "", "20.0%" };
    { 9, 11816, "", "=q3=Angerforge's Battle Axe", "=ds=#w1#", "", "20.0%" };
    { 10, 11817, "", "=q3=Lord General's Sword", "=ds=#w10#", "", "20.0%" };
    { 11, 11820, "", "=q3=Royal Decorated Armor", "=ds=#a3#", "", "20.0%" };
    { 12, 11821, "", "=q3=Warstrife Leggings", "=ds=#a2#", "", "20.0%" };
	};

	AtlasLoot_Data["BRDGeneralAngerforgeMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic General Angerforge", "=q5=ALL WILL DROP"};
    { 2, 11464, "", "=q1=Marshal Windsor's Lost Information", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Mythic General Angerforge", "=q5=CHANCE TO DROP"};
    { 5, 11468, "", "=q1=Dark Iron Fanny Pack", "=ds=#m3#", "", "80.0%" };
    { 6, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 9, 0, "AO_Unknown", "=q6=Mythic General Angerforge", "=q5=ONE WILL DROP"};
    { 10, 11810, "", "=q3=Force of Will", "=ds=#s14#", "", "20.0%" };
    { 11, 11817, "", "=q3=Lord General's Sword", "=ds=#w10#", "", "20.0%" };
    { 12, 69546, "", "=q4=Angerforge's Battle Axe", "=ds=#w1#", "", "20.0%" };
    { 13, 69548, "", "=q4=Royal Decorated Armor", "=ds=#a3#", "", "20.0%" };
    { 14, 69549, "", "=q4=Warstrife Leggings", "=ds=#a2#", "", "20.0%" };
	};

	AtlasLoot_Data["BRDGeneralAngerforgeHEROIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Heroic General Angerforge", "=q5=ALL WILL DROP"};
    { 2, 11464, "", "=q1=Marshal Windsor's Lost Information", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Heroic General Angerforge", "=q5=CHANCE TO DROP"};
    { 5, 11468, "", "=q1=Dark Iron Fanny Pack", "=ds=#m3#", "", "80.0%" };
    { 6, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    ...
    { 10, 11810, "", "=q3=Force of Will", "=ds=#s14#", "", "20.0%" };
    { 11, 11817, "", "=q3=Lord General's Sword", "=ds=#w10#", "", "20.0%" };
    { 12, 66546, "", "=q4=Angerforge's Battle Axe", "=ds=#w1#", "", "20.0%" };
    { 13, 66548, "", "=q4=Royal Decorated Armor", "=ds=#a3#", "", "20.0%" };
    { 14, 66549, "", "=q4=Warstrife Leggings", "=ds=#a2#", "", "20.0%" };
	};
    ...
    { 13, 11823, "", "=q3=Luminary Kilt", "=ds=#a2#", "", "30.7%" };
    { 14, 11819, "", "=q3=Second Wind", "=ds=#s14#", "", "8.00%" };
	};

	AtlasLoot_Data["BRDGolemLordArgelmachMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Golem Lord Argelmach", "=q5=ALL WILL DROP"};
    { 2, 11268, "", "=q1=Head of Argelmach", "=ds=#m3#", "", "100%" };
    { 3, 11465, "", "=q1=Marshal Windsor's Lost Information", "=ds=#m3#", "", "100%" };
    { 5, 0, "RoM_stellar_dice", "=q6=Mythic Golem Lord Argelmach", "=q5=CHANCE TO DROP"};
    { 6, 11468, "", "=q1=Dark Iron Fanny Pack", "=ds=#m3#", "", "80.0%" };
    { 7, 21956, "", "=q3=Design: Dark Iron Scorpid", "=ds=#e2#", "", "60.0%" };
    { 8, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 9, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 11, 0, "AO_Unknown", "=q6=Mythic Golem Lord Argelmach", "=q5=ONE WILL DROP"};
    { 12, 11669, "", "=q3=Naglering", "=ds=#s13#", "", "30.7%" };
    { 13, 69550, "", "=q4=Omnicast Boots", "=ds=#a1#", "", "30.7%" };
    { 14, 69551, "", "=q4=Luminary Kilt", "=ds=#a2#", "", "30.7%" };
    { 15, 69547, "", "=q4=Second Wind", "=ds=#s14#", "", "8.00%" };
	};
    ...
    { 2, 11268, "", "=q1=Head of Argelmach", "=ds=#m3#", "", "100%" };
    { 3, 11465, "", "=q1=Marshal Windsor's Lost Information", "=ds=#m3#", "", "100%" };
    { 5, 0, "RoM_stellar_dice", "=q6=Heroic Golem Lord Argelmach", "=q5=CHANCE TO DROP"};
    { 6, 11468, "", "=q1=Dark Iron Fanny Pack", "=ds=#m3#", "", "80.0%" };
    { 7, 21956, "", "=q3=Design: Dark Iron Scorpid", "=ds=#e2#", "", "60.0%" };
    { 8, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 9, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 11, 0, "AO_Unknown", "=q6=Heroic Golem Lord Argelmach", "=q5=ONE WILL DROP"};
    { 12, 11669, "", "=q3=Naglering", "=ds=#s13#", "", "30.7%" };
    { 13, 66550, "", "=q4=Omnicast Boots", "=ds=#a1#", "", "30.7%" };
    { 14, 66551, "", "=q4=Luminary Kilt", "=ds=#a2#", "", "30.7%" };
    { 15, 66547, "", "=q4=Second Wind", "=ds=#s14#", "", "8.00%" };
	};
    ...
    { 2, 11129, "", "=q1=Essence of the Elements", "=ds=#m3#", "", "80.0%" };
    { 3, 57458, "", "=q1=Technique: Scroll of Fire Resistance IV", "=ds=#e2#", "", "15.0%" };
    { 4, 59075, "", "=q3=Idol of the Deep Vein", "", "", "10.0%" };
    { 6, 0, "AO_Unknown", "=q6=Ambassador Flamelash", "=q5=ONE WILL DROP"};
    { 7, 11812, "", "=q3=Cape of the Fire Salamander", "=ds=#a1#", "", "31.0%" };
    { 8, 11814, "", "=q3=Molten Fists", "=ds=#a3#", "", "31.0%" };
    { 9, 11809, "", "=q3=Flame Wrath", "=ds=#w7#", "", "20.0%" };
    { 10, 11832, "", "=q3=Burst of Knowledge", "=ds=#s14#", "", "17.0%" };
    { 11, 11808, "", "=q4=Circle of Flame", "=ds=#a1#", "", "1.00%" };
	};

	AtlasLoot_Data["BRDFlamelashMYTHIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Mythic Ambassador Flamelash", "=q5=CHANCE TO DROP"};
    { 2, 11129, "", "=q1=Essence of the Elements", "=ds=#m3#", "", "80.0%" };
    { 3, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 5, 57458, "", "=q1=Technique: Scroll of Fire Resistance IV", "=ds=#e2#", "", "15.0%" };
    { 6, 59075, "", "=q3=Idol of the Deep Vein", "", "", "10.0%" };
    { 8, 0, "AO_Unknown", "=q6=Mythic Ambassador Flamelash", "=q5=ONE WILL DROP"};
    { 9, 69544, "", "=q4=Cape of the Fire Salamander", "=ds=#a1#", "", "31.0%" };
    { 10, 69545, "", "=q4=Molten Fists", "=ds=#a3#", "", "31.0%" };
    { 11, 11809, "", "=q3=Flame Wrath", "=ds=#w7#", "", "20.0%" };
    { 12, 69553, "", "=q4=Burst of Knowledge", "=ds=#s14#", "", "17.0%" };
    { 13, 11808, "", "=q4=Circle of Flame", "=ds=#a1#", "", "1.00%" };
	};

	AtlasLoot_Data["BRDFlamelashHEROIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Heroic Ambassador Flamelash", "=q5=CHANCE TO DROP"};
    { 2, 11129, "", "=q1=Essence of the Elements", "=ds=#m3#", "", "80.0%" };
    { 3, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 5, 57458, "", "=q1=Technique: Scroll of Fire Resistance IV", "=ds=#e2#", "", "15.0%" };
    ...
    { 9, 66544, "", "=q4=Cape of the Fire Salamander", "=ds=#a1#", "", "31.0%" };
    { 10, 66545, "", "=q4=Molten Fists", "=ds=#a3#", "", "31.0%" };
    { 11, 11809, "", "=q3=Flame Wrath", "=ds=#w7#", "", "20.0%" };
    { 12, 66553, "", "=q4=Burst of Knowledge", "=ds=#s14#", "", "17.0%" };
    { 13, 11808, "", "=q4=Circle of Flame", "=ds=#a1#", "", "1.00%" };
	};
    ...
    { 2, 11129, "", "=q1=Essence of the Elements", "=ds=#m3#", "", "80.0%" };
    { 3, 17, "", "=q6=Martin Fury", "=ds=#a4#", "", "" };
    { 5, 0, "AO_Unknown", "=q6=Panzor the Invincible", "=q5=ONE WILL DROP"};
    { 6, 11785, "", "=q3=Rock Golem Bulwark", "=ds=#w8#", "", "25.0%" };
    { 7, 11786, "", "=q3=Stone of the Earth", "=ds=#w10#", "", "25.0%" };
    { 8, 11787, "", "=q3=Shalehusk Boots", "=ds=#a4#", "", "25.0%" };
    { 9, 22245, "", "=q3=Soot Encrusted Footwear", "=ds=#a1#", "", "25.0%" };
	};
    ...
    { 3, 11935, "", "=q3=Magmus Stone", "=ds=#s15#", "", "20.0%" };
    { 4, 22208, "", "=q3=Lavastone Hammer", "=ds=#w6#", "", "20.0%" };
    { 5, 22395, "", "=q3=Totem of Rage", "", "", "20.0%" };
    { 6, 22400, "", "=q3=Libram of Truth", "", "", "20.0%" };
	};

	AtlasLoot_Data["BRDMagmusMYTHIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Mythic Magmus", "=q5=CHANCE TO DROP"};
    { 2, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 5, 0, "AO_Unknown", "=q6=Mythic Magmus", "=q5=ONE WILL DROP"};
    { 6, 69525, "", "=q4=Golem Skull Helm", "=ds=#a4#", "", "20.0%" };
    { 7, 69568, "", "=q4=Magmus Stone", "=ds=#s15#", "", "20.0%" };
    { 8, 69921, "", "=q4=Lavastone Hammer", "=ds=#w6#", "", "20.0%" };
    { 9, 69960, "", "=q4=Totem of Rage", "", "", "20.0%" };
    { 10, 69963, "", "=q4=Libram of Truth", "", "", "20.0%" };
	};

	AtlasLoot_Data["BRDMagmusHEROIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Heroic Magmus", "=q5=CHANCE TO DROP"};
    { 2, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 5, 0, "AO_Unknown", "=q6=Heroic Magmus", "=q5=ONE WILL DROP"};
    { 6, 66525, "", "=q4=Golem Skull Helm", "=ds=#a4#", "", "20.0%" };
    { 7, 66568, "", "=q4=Magmus Stone", "=ds=#s15#", "", "20.0%" };
    { 8, 66921, "", "=q4=Lavastone Hammer", "=ds=#w6#", "", "20.0%" };
    { 9, 66960, "", "=q4=Totem of Rage", "", "", "20.0%" };
    { 10, 66963, "", "=q4=Libram of Truth", "", "", "20.0%" };
	};
    ...
    { 5, 58725, "", "=q1=Emperor's Dark Iron Seal", "=ds=#m3#", "", "100%" };
    { 7, 0, "RoM_stellar_dice", "=q6=Emperor Dagran Thaurissan", "=q5=CHANCE TO DROP"};
    { 8, 59076, "", "=q3=Libram of Molten Devotion", "", "", "10.0%" };
    { 10, 0, "AO_Unknown", "=q6=Emperor Dagran Thaurissan", "=q5=ONE WILL DROP"};
    { 11, 11815, "", "=q3=Hand of Justice", "=ds=#s14#", "", "9.90%" };
    { 12, 11924, "", "=q3=Robes of the Royal Crown", "=ds=#a1#", "", "9.90%" };
    { 13, 11928, "", "=q3=Thaurissan's Royal Scepter", "=ds=#s15#", "", "9.90%" };
    { 14, 11930, "", "=q3=The Emperor's New Cape", "=ds=#a1#", "", "9.90%" };
    { 15, 11931, "", "=q3=Dreadforge Retaliator", "=ds=#w1#", "", "9.90%" };
    { 16, 11932, "", "=q3=Guiding Stave of Wisdom", "=ds=#w9#", "", "9.90%" };
    { 17, 11933, "", "=q3=Imperial Jewel", "=ds=#s2#", "", "9.90%" };
    { 18, 11934, "", "=q3=Emperor's Seal", "=ds=#s13#", "", "9.90%" };
    { 19, 22204, "", "=q3=Wristguards of Renown", "=ds=#a2#", "", "9.90%" };
    { 20, 22207, "", "=q3=Sash of the Grand Hunt", "=ds=#a3#", "", "9.90%" };
    { 21, 11684, "", "=q4=Ironfoe", "=ds=#w6#", "", "1.00%" };
    { 23, 0, "AO_ChestWithTreasures", "=q6=Princess Moira Bronzebeard", "=q5=ALL WILL DROP"};
    { 24, 11468, "", "=q1=Dark Iron Fanny Pack", "=ds=#m3#", "", "100%" };
    { 26, 0, "AO_Unknown", "=q6=Princess Moira Bronzebeard", "=q5=ONE WILL DROP"};
    { 27, 12553, "", "=q3=Swiftwalker Boots", "=ds=#a2#", "", "25.0%" };
    { 28, 12554, "", "=q3=Hands of the Exalted Herald", "=ds=#a1#", "", "25.0%" };
    { 29, 12556, "", "=q3=High Priestess Boots", "=ds=#a1#", "", "25.0%" };
    { 30, 12557, "", "=q3=Ebonsteel Spaulders", "=ds=#a4#", "", "25.0%" };
	};
    ...
    { 1, 0, "RoM_stellar_dice", "=q6=Spirestone Butcher", "=q5=CHANCE TO DROP"};
    { 2, 21982, "", "=q1=Ogre Warbeads", "=ds=#m3#", "", "80.0%" };
    { 4, 0, "AO_Unknown", "=q6=Spirestone Butcher", "=q5=ONE WILL DROP"};
    { 5, 12608, "", "=q3=Butcher's Apron", "=ds=#a1#", "", "60.0%" };
    { 6, 13286, "", "=q3=Rivenspike", "=ds=#w1#", "", "40.0%" };
	};

	AtlasLoot_Data["LBRSOmokk"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Highlord Omokk", "=q5=ALL WILL DROP"};
    { 2, 12534, "", "=q1=Omokk's Head", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Highlord Omokk", "=q5=CHANCE TO DROP"};
    { 5, 21982, "", "=q1=Ogre Warbeads", "=ds=#m3#", "", "80.0%" };
    { 7, 0, "AO_Unknown", "=q6=Highlord Omokk", "=q5=ONE WILL DROP"};
    { 8, 13166, "", "=q3=Slamshot Shoulders", "=ds=#a4#", "", "16.7%" };
    { 9, 13167, "", "=q3=Fist of Omokk", "=ds=#w6#", "", "16.7%" };
    { 10, 13168, "", "=q3=Plate of the Shaman King", "=ds=#a4#", "", "16.7%" };
    { 11, 13169, "", "=q3=Tressermane Leggings", "=ds=#a2#", "", "16.7%" };
    { 12, 13170, "", "=q3=Skyshroud Leggings", "=ds=#a1#", "", "16.7%" };
    { 13, 16670, "", "=q3=Boots of Elements", "=ds=#a3#", "", "16.7%" };
	};

	AtlasLoot_Data["LBRSOmokkMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Highlord Omokk", "=q5=ALL WILL DROP"};
    { 2, 12534, "", "=q1=Omokk's Head", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Mythic Highlord Omokk", "=q5=CHANCE TO DROP"};
    { 5, 21982, "", "=q1=Ogre Warbeads", "=ds=#m3#", "", "80.0%" };
    { 6, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 9, 0, "AO_Unknown", "=q6=Mythic Highlord Omokk", "=q5=ONE WILL DROP"};
    { 10, 16670, "", "=q3=Boots of Elements", "=ds=#a3#", "", "16.7%" };
    { 11, 69617, "", "=q4=Slamshot Shoulders", "=ds=#a4#", "", "16.7%" };
    { 12, 69618, "", "=q4=Fist of Omokk", "=ds=#w6#", "", "16.7%" };
    { 13, 69619, "", "=q4=Plate of the Shaman King", "=ds=#a4#", "", "16.7%" };
    { 14, 69620, "", "=q4=Tressermane Leggings", "=ds=#a2#", "", "16.7%" };
    { 15, 69621, "", "=q4=Skyshroud Leggings", "=ds=#a1#", "", "16.7%" };
	};

	AtlasLoot_Data["LBRSOmokkHEROIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Heroic Highlord Omokk", "=q5=ALL WILL DROP"};
    { 2, 12534, "", "=q1=Omokk's Head", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Heroic Highlord Omokk", "=q5=CHANCE TO DROP"};
    { 5, 21982, "", "=q1=Ogre Warbeads", "=ds=#m3#", "", "80.0%" };
    { 6, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 9, 0, "AO_Unknown", "=q6=Heroic Highlord Omokk", "=q5=ONE WILL DROP"};
    { 10, 16670, "", "=q3=Boots of Elements", "=ds=#a3#", "", "16.7%" };
    { 11, 66617, "", "=q4=Slamshot Shoulders", "=ds=#a4#", "", "16.7%" };
    { 12, 66618, "", "=q4=Fist of Omokk", "=ds=#w6#", "", "16.7%" };
    { 13, 66619, "", "=q4=Plate of the Shaman King", "=ds=#a4#", "", "16.7%" };
    { 14, 66620, "", "=q4=Tressermane Leggings", "=ds=#a2#", "", "16.7%" };
    { 15, 66621, "", "=q4=Skyshroud Leggings", "=ds=#a1#", "", "16.7%" };
	};
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6=Shadow Hunter Vosh'gajin", "=q5=ALL WILL DROP"};
    { 2, 13352, "", "=q1=Vosh'gajin's Snakestone", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Shadow Hunter Vosh'gajin", "=q5=CHANCE TO DROP"};
    { 5, 12654, "", "=q3=Doomshot", "=ds=#e6#", "", "30.0%" };
    { 7, 0, "AO_Unknown", "=q6=Shadow Hunter Vosh'gajin", "=q5=ONE WILL DROP"};
    { 8, 12626, "", "=q3=Funeral Cuffs", "=ds=#a1#", "", "21.0%" };
    { 9, 13255, "", "=q3=Trueaim Gauntlets", "=ds=#a3#", "", "21.0%" };
    { 10, 13257, "", "=q3=Demonic Runed Spaulders", "=ds=#a2#", "", "21.0%" };
    { 11, 16712, "", "=q3=Shadowcraft Gloves", "=ds=#a2#", "", "21.0%" };
    { 12, 12651, "", "=q3=Blackcrow", "=ds=#w3#", "", "8.00%" };
    { 13, 12653, "", "=q3=Riphook", "=ds=#w2#", "", "8.00%" };
	};

	AtlasLoot_Data["LBRSVoshMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Shadow Hunter Vosh'gajin", "=q5=ALL WILL DROP"};
    { 2, 13352, "", "=q1=Vosh'gajin's Snakestone", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Mythic Shadow Hunter Vosh'gajin", "=q5=CHANCE TO DROP"};
    { 5, 12654, "", "=q3=Doomshot", "=ds=#e6#", "", "30.0%" };
    { 6, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 9, 0, "AO_Unknown", "=q6=Mythic Shadow Hunter Vosh'gajin", "=q5=ONE WILL DROP"};
    { 10, 16712, "", "=q3=Shadowcraft Gloves", "=ds=#a2#", "", "21.0%" };
    { 11, 69589, "", "=q4=Funeral Cuffs", "=ds=#a1#", "", "21.0%" };
    { 12, 69640, "", "=q4=Trueaim Gauntlets", "=ds=#a3#", "", "21.0%" };
    { 13, 69641, "", "=q4=Demonic Runed Spaulders", "=ds=#a2#", "", "21.0%" };
    { 14, 69592, "", "=q4=Blackcrow", "=ds=#w3#", "", "8.00%" };
    { 15, 69593, "", "=q4=Riphook", "=ds=#w2#", "", "8.00%" };
	};

	AtlasLoot_Data["LBRSVoshHEROIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Heroic Shadow Hunter Vosh'gajin", "=q5=ALL WILL DROP"};
    { 2, 13352, "", "=q1=Vosh'gajin's Snakestone", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Heroic Shadow Hunter Vosh'gajin", "=q5=CHANCE TO DROP"};
    { 5, 12654, "", "=q3=Doomshot", "=ds=#e6#", "", "30.0%" };
    { 6, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 9, 0, "AO_Unknown", "=q6=Heroic Shadow Hunter Vosh'gajin", "=q5=ONE WILL DROP"};
    { 10, 16712, "", "=q3=Shadowcraft Gloves", "=ds=#a2#", "", "21.0%" };
    { 11, 66589, "", "=q4=Funeral Cuffs", "=ds=#a1#", "", "21.0%" };
    { 12, 66640, "", "=q4=Trueaim Gauntlets", "=ds=#a3#", "", "21.0%" };
    { 13, 66641, "", "=q4=Demonic Runed Spaulders", "=ds=#a2#", "", "21.0%" };
    { 14, 66592, "", "=q4=Blackcrow", "=ds=#w3#", "", "8.00%" };
    { 15, 66593, "", "=q4=Riphook", "=ds=#w2#", "", "8.00%" };
	};
    ...
    { 4, 0, "AO_Unknown", "=q6=War Master Voone", "=q5=ONE WILL DROP"};
    { 5, 12582, "", "=q3=Keris of Zul'Serak", "=ds=#w4#", "", "20.0%" };
    { 6, 13177, "", "=q3=Talisman of Evasion", "=ds=#s2#", "", "20.0%" };
	...
	AtlasLoot_Data["LBRSVooneMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic War Master Voone", "=q5=ALL WILL DROP"};
    { 2, 70235, "", "=q4=Flightblade Throwing Axe", "=ds=#w11#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Mythic War Master Voone", "=q5=CHANCE TO DROP"};
    { 5, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 69622, "", "=q4=Voone's Twitchbow", "=ds=#w2#", "", "1.00%" };
    { 9, 0, "AO_Unknown", "=q6=Mythic War Master Voone", "=q5=ONE WILL DROP"};
    { 10, 12582, "", "=q3=Keris of Zul'Serak", "=ds=#w4#", "", "20.0%" };
    { 11, 16676, "", "=q3=Beaststalker's Gloves", "=ds=#a3#", "", "20.0%" };
    { 12, 22231, "", "=q3=Kayser's Boots of Precision", "=ds=#a1#", "", "20.0%" };
    { 13, 69623, "", "=q4=Talisman of Evasion", "=ds=#s2#", "", "20.0%" };
    { 14, 69625, "", "=q4=Brazecore Armguards", "=ds=#a3#", "", "20.0%" };
	};

	AtlasLoot_Data["LBRSVooneHEROIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Heroic War Master Voone", "=q5=ALL WILL DROP"};
    { 2, 67235, "", "=q4=Flightblade Throwing Axe", "=ds=#w11#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Heroic War Master Voone", "=q5=CHANCE TO DROP"};
    { 5, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 66622, "", "=q4=Voone's Twitchbow", "=ds=#w2#", "", "1.00%" };
    { 9, 0, "AO_Unknown", "=q6=Heroic War Master Voone", "=q5=ONE WILL DROP"};
    { 10, 12582, "", "=q3=Keris of Zul'Serak", "=ds=#w4#", "", "20.0%" };
    { 11, 16676, "", "=q3=Beaststalker's Gloves", "=ds=#a3#", "", "20.0%" };
    { 12, 22231, "", "=q3=Kayser's Boots of Precision", "=ds=#a1#", "", "20.0%" };
    { 13, 66623, "", "=q4=Talisman of Evasion", "=ds=#s2#", "", "20.0%" };
    { 14, 66625, "", "=q4=Brazecore Armguards", "=ds=#a3#", "", "20.0%" };
	};

	AtlasLoot_Data["LBRSGrayhoof"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mor Grayhoof", "=q5=ALL WILL DROP"};
    { 2, 21984, "", "=q1=Left Piece of Lord Valthalak's Amulet", "=ds=#m3#", "", "100%" };
    { 3, 22046, "", "=q1=Right Piece of Lord Valthalak's Amulet", "=ds=#m3#", "", "100%" };
    { 5, 0, "AO_Unknown", "=q6=Mor Grayhoof", "=q5=ONE WILL DROP"};
    { 6, 22306, "", "=q3=Ironweave Belt", "=ds=#a1#", "", "20.0%" };
    { 7, 22319, "", "=q3=Tome of Divine Right", "=ds=#s15#", "", "20.0%" };
    { 8, 22322, "", "=q3=The Jaw Breaker", "=ds=#w6#", "", "20.0%" };
    { 9, 22325, "", "=q3=Belt of the Trickster", "=ds=#a2#", "", "20.0%" };
    { 10, 22398, "", "=q3=Idol of Rejuvenation", "", "", "20.0%" };
	};

	AtlasLoot_Data["LBRSGrayhoofMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Mor Grayhoof", "=q5=ALL WILL DROP"};
    { 2, 21984, "", "=q1=Left Piece of Lord Valthalak's Amulet", "=ds=#m3#", "", "100%" };
    { 3, 22046, "", "=q1=Right Piece of Lord Valthalak's Amulet", "=ds=#m3#", "", "100%" };
    { 5, 0, "RoM_stellar_dice", "=q6=Mythic Mor Grayhoof", "=q5=CHANCE TO DROP"};
    { 6, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 9, 0, "AO_Unknown", "=q6=Mythic Mor Grayhoof", "=q5=ONE WILL DROP"};
    { 10, 22306, "", "=q3=Ironweave Belt", "=ds=#a1#", "", "20.0%" };
    { 11, 69945, "", "=q4=Tome of Divine Right", "=ds=#s15#", "", "20.0%" };
    { 12, 69946, "", "=q4=The Jaw Breaker", "=ds=#w6#", "", "20.0%" };
    { 13, 69947, "", "=q4=Belt of the Trickster", "=ds=#a2#", "", "20.0%" };
    { 14, 69962, "", "=q4=Idol of Rejuvenation", "", "", "20.0%" };
	};
    ...
    { 2, 21984, "", "=q1=Left Piece of Lord Valthalak's Amulet", "=ds=#m3#", "", "100%" };
    { 3, 22046, "", "=q1=Right Piece of Lord Valthalak's Amulet", "=ds=#m3#", "", "100%" };
    { 5, 0, "RoM_stellar_dice", "=q6=Heroic Mor Grayhoof", "=q5=CHANCE TO DROP"};
    { 6, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 9, 0, "AO_Unknown", "=q6=Heroic Mor Grayhoof", "=q5=ONE WILL DROP"};
    { 10, 22306, "", "=q3=Ironweave Belt", "=ds=#a1#", "", "20.0%" };
    { 11, 66945, "", "=q4=Tome of Divine Right", "=ds=#s15#", "", "20.0%" };
    { 12, 66946, "", "=q4=The Jaw Breaker", "=ds=#w6#", "", "20.0%" };
    { 13, 66947, "", "=q4=Belt of the Trickster", "=ds=#a2#", "", "20.0%" };
    { 14, 66962, "", "=q4=Idol of Rejuvenation", "", "", "20.0%" };
	};

	AtlasLoot_Data["LBRSGrimaxe"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Bannok Grimaxe", "=q5=CHANCE TO DROP"};
    { 2, 22138, "", "=q1=Blackrock Bracer", "=ds=#m3#", "", "80.0%" };
    { 3, 12838, "", "=q3=Plans: Arcanite Reaper", "=ds=#e2#", "", "7.00%" };
    { 5, 0, "AO_Unknown", "=q6=Bannok Grimaxe", "=q5=ONE WILL DROP"};
    { 6, 12621, "", "=q3=Demonfork", "=ds=#w1#", "", "33.3%" };
    { 7, 12634, "", "=q3=Chiselbrand Girdle", "=ds=#a3#", "", "33.3%" };
    { 8, 12637, "", "=q3=Backusarian Gauntlets", "=ds=#a4#", "", "33.3%" };
	};

	AtlasLoot_Data["LBRSSmolderweb"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Mother Smolderweb", "=q5=CHANCE TO DROP"};
    { 2, 59077, "", "=q3=Libram of Righteous Hammer", "", "", "10.0%" };
    { 4, 0, "AO_Unknown", "=q6=Mother Smolderweb", "=q5=ONE WILL DROP"};
    { 5, 13213, "", "=q3=Smolderweb's Eye", "=ds=#s14#", "", "35.0%" };
    { 6, 13244, "", "=q3=Gilded Gauntlets", "=ds=#a3#", "", "35.0%" };
    { 7, 13183, "", "=q3=Venomspitter", "=ds=#w6#", "", "15.0%" };
    { 8, 16715, "", "=q3=Wildheart Boots", "=ds=#a2#", "", "15.0%" };
	};

	AtlasLoot_Data["LBRSSmolderwebMYTHIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Mythic Mother Smolderweb", "=q5=CHANCE TO DROP"};
    { 2, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 59077, "", "=q3=Libram of Righteous Hammer", "", "", "10.0%" };
    { 6, 0, "AO_Unknown", "=q6=Mythic Mother Smolderweb", "=q5=ONE WILL DROP"};
    { 7, 13213, "", "=q3=Smolderweb's Eye", "=ds=#s14#", "", "35.0%" };
    { 8, 69636, "", "=q4=Gilded Gauntlets", "=ds=#a3#", "", "35.0%" };
    { 9, 13183, "", "=q3=Venomspitter", "=ds=#w6#", "", "15.0%" };
    { 10, 16715, "", "=q3=Wildheart Boots", "=ds=#a2#", "", "15.0%" };
	};

	AtlasLoot_Data["LBRSSmolderwebHEROIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Heroic Mother Smolderweb", "=q5=CHANCE TO DROP"};
    { 2, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 59077, "", "=q3=Libram of Righteous Hammer", "", "", "10.0%" };
    { 6, 0, "AO_Unknown", "=q6=Heroic Mother Smolderweb", "=q5=ONE WILL DROP"};
    { 7, 13213, "", "=q3=Smolderweb's Eye", "=ds=#s14#", "", "35.0%" };
    { 8, 66636, "", "=q4=Gilded Gauntlets", "=ds=#a3#", "", "35.0%" };
    { 9, 13183, "", "=q3=Venomspitter", "=ds=#w6#", "", "15.0%" };
    { 10, 16715, "", "=q3=Wildheart Boots", "=ds=#a2#", "", "15.0%" };
	};
    ...
    { 3, 13185, "", "=q3=Sunderseer Mantle", "=ds=#a1#", "", "43.0%" };
    { 4, 13218, "", "=q3=Fang of the Crystal Spider", "=ds=#w4#", "", "14.0%" };
	};

	AtlasLoot_Data["LBRSDoomhowl"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Urok Doomhowl", "=q5=CHANCE TO DROP"};
    { 2, 21982, "", "=q1=Ogre Warbeads", "=ds=#m3#", "", "80.0%" };
    { 4, 0, "AO_Unknown", "=q6=Urok Doomhowl", "=q5=ONE WILL DROP"};
    { 5, 13178, "", "=q3=Rosewine Circle", "=ds=#s13#", "", "25.0%" };
    { 6, 13258, "", "=q3=Slaghide Gauntlets", "=ds=#a2#", "", "25.0%" };
    { 7, 13259, "", "=q3=Ribsteel Footguards", "=ds=#a4#", "", "25.0%" };
    { 8, 22232, "", "=q3=Marksman's Girdle", "=ds=#a3#", "", "25.0%" };
	};

	AtlasLoot_Data["LBRSDoomhowlMYTHIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Mythic Urok Doomhowl", "=q5=CHANCE TO DROP"};
    { 2, 21982, "", "=q1=Ogre Warbeads", "=ds=#m3#", "", "80.0%" };
    { 3, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 0, "AO_Unknown", "=q6=Mythic Urok Doomhowl", "=q5=ONE WILL DROP"};
    { 7, 69624, "", "=q4=Rosewine Circle", "=ds=#s13#", "", "25.0%" };
    { 8, 69642, "", "=q4=Slaghide Gauntlets", "=ds=#a2#", "", "25.0%" };
    { 9, 69643, "", "=q4=Ribsteel Footguards", "=ds=#a4#", "", "25.0%" };
    { 10, 69925, "", "=q4=Marksman's Girdle", "=ds=#a3#", "", "25.0%" };
	};

	AtlasLoot_Data["LBRSDoomhowlHEROIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Heroic Urok Doomhowl", "=q5=CHANCE TO DROP"};
    { 2, 21982, "", "=q1=Ogre Warbeads", "=ds=#m3#", "", "80.0%" };
    { 3, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 0, "AO_Unknown", "=q6=Heroic Urok Doomhowl", "=q5=ONE WILL DROP"};
    { 7, 66624, "", "=q4=Rosewine Circle", "=ds=#s13#", "", "25.0%" };
    { 8, 66642, "", "=q4=Slaghide Gauntlets", "=ds=#a2#", "", "25.0%" };
    { 9, 66643, "", "=q4=Ribsteel Footguards", "=ds=#a4#", "", "25.0%" };
    { 10, 66925, "", "=q4=Marksman's Girdle", "=ds=#a3#", "", "25.0%" };
	};
	...
	AtlasLoot_Data["LBRSZigrisMYTHIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Mythic Quartermaster Zigris", "=q5=CHANCE TO DROP"};
    { 2, 22138, "", "=q1=Blackrock Bracer", "=ds=#m3#", "", "80.0%" };
    { 3, 21955, "", "=q3=Design: Black Diamond Crab", "=ds=#e2#", "", "60.0%" };
    { 4, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 5, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 12835, "", "=q3=Plans: Annihilator", "=ds=#e2#", "", "13.0%" };
    { 7, 69638, "", "=q4=Cloudrunner Girdle", "=ds=#a2#", "", "20.0%" };
    { 8, 69639, "", "=q4=Hands of Power", "=ds=#a1#", "", "19.0%" };
	};

	AtlasLoot_Data["LBRSZigrisHEROIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Heroic Quartermaster Zigris", "=q5=CHANCE TO DROP"};
    { 2, 22138, "", "=q1=Blackrock Bracer", "=ds=#m3#", "", "80.0%" };
    { 3, 21955, "", "=q3=Design: Black Diamond Crab", "=ds=#e2#", "", "60.0%" };
    { 4, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 5, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 12835, "", "=q3=Plans: Annihilator", "=ds=#e2#", "", "13.0%" };
    { 7, 66638, "", "=q4=Cloudrunner Girdle", "=ds=#a2#", "", "20.0%" };
    { 8, 66639, "", "=q4=Hands of Power", "=ds=#a1#", "", "19.0%" };
	};

	AtlasLoot_Data["LBRSSlavener"] = {
    { 1, 0, "AO_Unknown", "=q6=Gizrul the Slavener", "=q5=ONE WILL DROP"};
    { 2, 13205, "", "=q3=Rhombeard Protector", "=ds=#w8#", "", "28.3%" };
    { 3, 13206, "", "=q3=Wolfshear Leggings", "=ds=#a1#", "", "28.3%" };
    { 4, 13208, "", "=q3=Bleak Howler Armguards", "=ds=#a2#", "", "28.3%" };
    { 5, 16718, "", "=q3=Wildheart Spaulders", "=ds=#a2#", "", "15.0%" };
	};

	AtlasLoot_Data["LBRSSlavenerMYTHIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Mythic Gizrul the Slavener", "=q5=CHANCE TO DROP"};
    { 2, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 5, 0, "AO_Unknown", "=q6=Mythic Gizrul the Slavener", "=q5=ONE WILL DROP"};
    { 6, 69631, "", "=q4=Rhombeard Protector", "=ds=#w8#", "", "28.3%" };
    { 7, 69632, "", "=q4=Wolfshear Leggings", "=ds=#a1#", "", "28.3%" };
    { 8, 69633, "", "=q4=Bleak Howler Armguards", "=ds=#a2#", "", "28.3%" };
    { 9, 16718, "", "=q3=Wildheart Spaulders", "=ds=#a2#", "", "15.0%" };
	};

	AtlasLoot_Data["LBRSSlavenerHEROIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Heroic Gizrul the Slavener", "=q5=CHANCE TO DROP"};
    { 2, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 5, 0, "AO_Unknown", "=q6=Heroic Gizrul the Slavener", "=q5=ONE WILL DROP"};
    { 6, 66631, "", "=q4=Rhombeard Protector", "=ds=#w8#", "", "28.3%" };
    { 7, 66632, "", "=q4=Wolfshear Leggings", "=ds=#a1#", "", "28.3%" };
    { 8, 66633, "", "=q4=Bleak Howler Armguards", "=ds=#a2#", "", "28.3%" };
    { 9, 16718, "", "=q3=Wildheart Spaulders", "=ds=#a2#", "", "15.0%" };
	};
	...
	AtlasLoot_Data["LBRSHalyconMYTHIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Mythic Halycon", "=q5=CHANCE TO DROP"};
    { 2, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 5, 0, "AO_Unknown", "=q6=Mythic Halycon", "=q5=ONE WILL DROP"};
    { 6, 13212, "", "=q3=Halycon's Spiked Collar", "=ds=#s2#", "", "28.7%" };
    { 7, 22313, "", "=q3=Ironweave Bracers", "=ds=#a1#", "", "28.7%" };
    { 8, 69635, "", "=q4=Slashclaw Bracers", "=ds=#a3#", "", "28.7%" };
    { 9, 69634, "", "=q4=Pads of the Dread Wolf", "=ds=#a2#", "", "14.0%" };
	};

	AtlasLoot_Data["LBRSHalyconHEROIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Heroic Halycon", "=q5=CHANCE TO DROP"};
    { 2, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 5, 0, "AO_Unknown", "=q6=Heroic Halycon", "=q5=ONE WILL DROP"};
    { 6, 13212, "", "=q3=Halycon's Spiked Collar", "=ds=#s2#", "", "28.7%" };
    { 7, 22313, "", "=q3=Ironweave Bracers", "=ds=#a1#", "", "28.7%" };
    { 8, 66635, "", "=q4=Slashclaw Bracers", "=ds=#a3#", "", "28.7%" };
    { 9, 66634, "", "=q4=Pads of the Dread Wolf", "=ds=#a2#", "", "14.0%" };
	};

	AtlasLoot_Data["LBRSBashguud"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Ghok Bashguud", "=q5=CHANCE TO DROP"};
    { 2, 22138, "", "=q1=Blackrock Bracer", "=ds=#m3#", "", "80.0%" };
    { 4, 0, "AO_Unknown", "=q6=Ghok Bashguud", "=q5=ONE WILL DROP"};
    { 5, 13198, "", "=q3=Hurd Smasher", "=ds=#w13#", "", "33.3%" };
    { 6, 13203, "", "=q3=Armswake Cloak", "=ds=#a1#", "", "33.3%" };
    { 7, 13204, "", "=q3=Bashguuder", "=ds=#w6#", "", "33.3%" };
	};

	AtlasLoot_Data["LBRSWyrmthalak"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Overlord Wyrmthalak", "=q5=ALL WILL DROP"};
    { 2, 12780, "", "=q1=General Drakkisath's Command", "=ds=#m3#", "", "100%" };
    { 3, 58715, "", "=q1=Wyrmthalak's War Horn", "=ds=#m3#", "", "100%" };
    { 5, 0, "RoM_stellar_dice", "=q6=Overlord Wyrmthalak", "=q5=CHANCE TO DROP"};
    { 6, 16786, "", "=q1=Black Dragonspawn Eye", "=ds=#m3#", "", "80.0%" };
    { 7, 57625, "", "=q6=Pattern: Artisan Riding Crop", "=ds=#e2#", "", "10.0%" };
    { 8, 59078, "", "=q3=Totem of Lava Surge", "", "", "10.0%" };
    { 9, 13143, "", "=q4=Mark of the Dragon Lord", "=ds=#s13#", "", "2.00%" };
    { 11, 0, "AO_Unknown", "=q6=Overlord Wyrmthalak", "=q5=ONE WILL DROP"};
    { 12, 13161, "", "=q3=Trindlehaven Staff", "=ds=#w9#", "", "20.0%" };
    { 13, 13162, "", "=q3=Reiver Claws", "=ds=#a4#", "", "20.0%" };
    { 14, 13163, "", "=q3=Relentless Scythe", "=ds=#w10#", "", "20.0%" };
    { 15, 16679, "", "=q3=Beaststalker's Mantle", "=ds=#a3#", "", "20.0%" };
    { 16, 22321, "", "=q3=Heart of Wyrmthalak", "=ds=#s14#", "", "20.0%" };
	};

	AtlasLoot_Data["LBRSWyrmthalakMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Overlord Wyrmthalak", "=q5=ALL WILL DROP"};
    { 2, 12780, "", "=q1=General Drakkisath's Command", "=ds=#m3#", "", "100%" };
    { 3, 58715, "", "=q1=Wyrmthalak's War Horn", "=ds=#m3#", "", "100%" };
    { 5, 0, "RoM_stellar_dice", "=q6=Mythic Overlord Wyrmthalak", "=q5=CHANCE TO DROP"};
    { 6, 16786, "", "=q1=Black Dragonspawn Eye", "=ds=#m3#", "", "80.0%" };
    { 7, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 8, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 9, 57625, "", "=q6=Pattern: Artisan Riding Crop", "=ds=#e2#", "", "10.0%" };
    { 10, 59078, "", "=q3=Totem of Lava Surge", "", "", "10.0%" };
    { 11, 13143, "", "=q4=Mark of the Dragon Lord", "=ds=#s13#", "", "2.00%" };
    { 16, 0, "AO_Unknown", "=q6=Mythic Overlord Wyrmthalak", "=q5=ONE WILL DROP"};
    { 17, 16679, "", "=q3=Beaststalker's Mantle", "=ds=#a3#", "", "20.0%" };
    { 18, 22321, "", "=q3=Heart of Wyrmthalak", "=ds=#s14#", "", "20.0%" };
    { 19, 69614, "", "=q4=Trindlehaven Staff", "=ds=#w9#", "", "20.0%" };
    { 20, 69615, "", "=q4=Reiver Claws", "=ds=#a4#", "", "20.0%" };
    { 21, 69616, "", "=q4=Relentless Scythe", "=ds=#w10#", "", "20.0%" };
	};
    ...
    { 2, 12780, "", "=q1=General Drakkisath's Command", "=ds=#m3#", "", "100%" };
    { 3, 58715, "", "=q1=Wyrmthalak's War Horn", "=ds=#m3#", "", "100%" };
    { 5, 0, "RoM_stellar_dice", "=q6=Heroic Overlord Wyrmthalak", "=q5=CHANCE TO DROP"};
    { 6, 16786, "", "=q1=Black Dragonspawn Eye", "=ds=#m3#", "", "80.0%" };
    { 7, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 8, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 9, 57625, "", "=q6=Pattern: Artisan Riding Crop", "=ds=#e2#", "", "10.0%" };
    { 10, 59078, "", "=q3=Totem of Lava Surge", "", "", "10.0%" };
    { 11, 13143, "", "=q4=Mark of the Dragon Lord", "=ds=#s13#", "", "2.00%" };
    ...
    { 17, 16679, "", "=q3=Beaststalker's Mantle", "=ds=#a3#", "", "20.0%" };
    { 18, 22321, "", "=q3=Heart of Wyrmthalak", "=ds=#s14#", "", "20.0%" };
    { 19, 66614, "", "=q4=Trindlehaven Staff", "=ds=#w9#", "", "20.0%" };
    { 20, 66615, "", "=q4=Reiver Claws", "=ds=#a4#", "", "20.0%" };
    { 21, 66616, "", "=q4=Relentless Scythe", "=ds=#w10#", "", "20.0%" };
	};

	AtlasLoot_Data["LBRSFelguard"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Burning Felguard", "=q5=CHANCE TO DROP"};
    { 2, 12662, "", "=q2=Demonic Rune", "=ds=#e7#", "", "10.0%" };
    { 3, 17, "", "=q6=Martin Fury", "=ds=#a4#", "", "" };
    { 4, 13181, "", "=q3=Demonskin Gloves", "=ds=#a1#", "", "14.0%" };
    { 5, 13182, "", "=q3=Phase Blade", "=ds=#w10#", "", "14.0%" };
	};
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6=Pyroguard Emberseer", "=q5=ALL WILL DROP"};
    { 2, 17322, "", "=q1=Eye of the Emberseer", "=ds=#m3#", "", "100%" };
    { 3, 21988, "", "=q1=Ember of Emberseer", "=ds=#m3#", "", "100%" };
    { 5, 0, "RoM_stellar_dice", "=q6=Pyroguard Emberseer", "=q5=CHANCE TO DROP"};
    { 6, 23320, "", "=q3=Tablet of Flame Shock VI", "=ds=#e2#", "", "8.00%" };
    { 8, 0, "AO_Unknown", "=q6=Pyroguard Emberseer", "=q5=ONE WILL DROP"};
    { 9, 12905, "", "=q3=Wildfire Cape", "=ds=#a1#", "", "20.0%" };
    { 10, 12926, "", "=q3=Flaming Band", "=ds=#s13#", "", "20.0%" };
    { 11, 12927, "", "=q3=Truestrike Shoulders", "=ds=#a2#", "", "20.0%" };
    { 12, 12929, "", "=q3=Emberfury Talisman", "=ds=#s2#", "", "20.0%" };
    { 13, 16672, "", "=q3=Gauntlets of Elements", "=ds=#a3#", "", "20.0%" };
	};

	AtlasLoot_Data["UBRSEmberseerMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Pyroguard Emberseer", "=q5=ALL WILL DROP"};
    { 2, 17322, "", "=q1=Eye of the Emberseer", "=ds=#m3#", "", "100%" };
    { 3, 21988, "", "=q1=Ember of Emberseer", "=ds=#m3#", "", "100%" };
    { 5, 0, "RoM_stellar_dice", "=q6=Mythic Pyroguard Emberseer", "=q5=CHANCE TO DROP"};
    { 6, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 8, 23320, "", "=q3=Tablet of Flame Shock VI", "=ds=#e2#", "", "8.00%" };
    { 10, 0, "AO_Unknown", "=q6=Mythic Pyroguard Emberseer", "=q5=ONE WILL DROP"};
    { 11, 16672, "", "=q3=Gauntlets of Elements", "=ds=#a3#", "", "20.0%" };
    { 12, 69595, "", "=q4=Wildfire Cape", "=ds=#a1#", "", "20.0%" };
    { 13, 69596, "", "=q4=Flaming Band", "=ds=#s13#", "", "20.0%" };
    { 14, 69597, "", "=q4=Truestrike Shoulders", "=ds=#a2#", "", "20.0%" };
    { 15, 69598, "", "=q4=Emberfury Talisman", "=ds=#s2#", "", "20.0%" };
	};
    ...
    { 2, 17322, "", "=q1=Eye of the Emberseer", "=ds=#m3#", "", "100%" };
    { 3, 21988, "", "=q1=Ember of Emberseer", "=ds=#m3#", "", "100%" };
    { 5, 0, "RoM_stellar_dice", "=q6=Heroic Pyroguard Emberseer", "=q5=CHANCE TO DROP"};
    { 6, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 8, 23320, "", "=q3=Tablet of Flame Shock VI", "=ds=#e2#", "", "8.00%" };
    { 10, 0, "AO_Unknown", "=q6=Heroic Pyroguard Emberseer", "=q5=ONE WILL DROP"};
    { 11, 16672, "", "=q3=Gauntlets of Elements", "=ds=#a3#", "", "20.0%" };
    { 12, 66595, "", "=q4=Wildfire Cape", "=ds=#a1#", "", "20.0%" };
    { 13, 66596, "", "=q4=Flaming Band", "=ds=#s13#", "", "20.0%" };
    { 14, 66597, "", "=q4=Truestrike Shoulders", "=ds=#a2#", "", "20.0%" };
    { 15, 66598, "", "=q4=Emberfury Talisman", "=ds=#s2#", "", "20.0%" };
	};
	...
	AtlasLoot_Data["UBRSSolakarMYTHIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Mythic Solakar Flamewreath", "=q5=CHANCE TO DROP"};
    { 2, 16786, "", "=q1=Black Dragonspawn Eye", "=ds=#m3#", "", "80.0%" };
    { 3, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 5, 18657, "", "=q3=Schematic: Hyper-Radiant Flame Reflector", "=ds=#e2#", "", "6.00%" };
    { 7, 0, "AO_Unknown", "=q6=Mythic Solakar Flamewreath", "=q5=ONE WILL DROP"};
    { 8, 16695, "", "=q3=Devout Mantle", "=ds=#a1#", "", "20.0%" };
    { 9, 69581, "", "=q4=Dustfeather Sash", "=ds=#a1#", "", "20.0%" };
    { 10, 69583, "", "=q4=Nightbrace Tunic", "=ds=#a2#", "", "20.0%" };
    { 11, 69586, "", "=q4=Crystallized Girdle", "=ds=#a2#", "", "20.0%" };
    { 12, 69588, "", "=q4=Polychromatic Visionwrap", "=ds=#a1#", "", "20.0%" };
	};

	AtlasLoot_Data["UBRSSolakarHEROIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Heroic Solakar Flamewreath", "=q5=CHANCE TO DROP"};
    { 2, 16786, "", "=q1=Black Dragonspawn Eye", "=ds=#m3#", "", "80.0%" };
    { 3, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 5, 18657, "", "=q3=Schematic: Hyper-Radiant Flame Reflector", "=ds=#e2#", "", "6.00%" };
    { 7, 0, "AO_Unknown", "=q6=Heroic Solakar Flamewreath", "=q5=ONE WILL DROP"};
    { 8, 16695, "", "=q3=Devout Mantle", "=ds=#a1#", "", "20.0%" };
    { 9, 66581, "", "=q4=Dustfeather Sash", "=ds=#a1#", "", "20.0%" };
    { 10, 66583, "", "=q4=Nightbrace Tunic", "=ds=#a2#", "", "20.0%" };
    { 11, 66586, "", "=q4=Crystallized Girdle", "=ds=#a2#", "", "20.0%" };
    { 12, 66588, "", "=q4=Polychromatic Visionwrap", "=ds=#a1#", "", "20.0%" };
	};
    ...
    { 1, 0, "RoM_stellar_dice", "=q6=Jed Runewatcher", "=q5=CHANCE TO DROP"};
    { 2, 22138, "", "=q1=Blackrock Bracer", "=ds=#m3#", "", "80.0%" };
    { 4, 0, "AO_Unknown", "=q6=Jed Runewatcher", "=q5=ONE WILL DROP"};
    { 5, 12604, "", "=q3=Starfire Tiara", "=ds=#a1#", "", "33.3%" };
    { 6, 12605, "", "=q3=Serpentine Skuller", "=ds=#w12#", "", "33.3%" };
    { 7, 12930, "", "=q3=Briarwood Reed", "=ds=#s14#", "", "33.3%" };
	};

	AtlasLoot_Data["UBRSAnvilcrack"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Goraluk Anvilcrack", "=q5=CHANCE TO DROP"};
    { 2, 22138, "", "=q1=Blackrock Bracer", "=ds=#m3#", "", "80.0%" };
    { 4, 0, "AO_Unknown", "=q6=Goraluk Anvilcrack", "=q5=ONE WILL DROP"};
    { 5, 13498, "", "=q3=Handcrafted Mastersmith Leggings", "=ds=#a4#", "", "22.5%" };
    { 6, 13502, "", "=q3=Handcrafted Mastersmith Girdle", "=ds=#a4#", "", "22.5%" };
    { 7, 18047, "", "=q3=Flame Walkers", "=ds=#a3#", "", "22.5%" };
    { 8, 18048, "", "=q3=Mastersmith's Hammer", "=ds=#w6#", "", "22.5%" };
    { 9, 12834, "", "=q3=Plans: Arcanite Champion", "=ds=#e2#", "", "5.00%" };
    { 10, 12837, "", "=q3=Plans: Masterwork Stormhammer", "=ds=#e2#", "", "5.00%" };
	};

	AtlasLoot_Data["UBRSRendGyth"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Gyth", "=q5=CHANCE TO DROP"};
    { 2, 12871, "", "=q4=Chromatic Carapace", "=ds=#e10#", "", "4.00%" };
    { 4, 0, "AO_Unknown", "=q6=Gyth", "=q5=ONE WILL DROP"};
    { 5, 12952, "", "=q3=Gyth's Skull", "=ds=#a4#", "", "20.0%" };
    { 6, 12953, "", "=q3=Dragoneye Coif", "=ds=#a3#", "", "20.0%" };
    { 7, 12960, "", "=q3=Tribal War Feathers", "=ds=#a2#", "", "20.0%" };
    { 8, 16669, "", "=q3=Pauldrons of Elements", "=ds=#a3#", "", "20.0%" };
    { 9, 22225, "", "=q3=Dragonskin Cowl", "=ds=#a1#", "", "20.0%" };
    { 11, 0, "AO_ChestWithTreasures", "=q6=Warchief Rend Blackhand", "=q5=ALL WILL DROP"};
    { 12, 12630, "", "=q1=Head of Rend Blackhand", "=ds=#m3#", "", "100%" };
    { 14, 0, "RoM_stellar_dice", "=q6=Warchief Rend Blackhand", "=q5=CHANCE TO DROP"};
    { 15, 22138, "", "=q1=Blackrock Bracer", "=ds=#m3#", "", "80.0%" };
    { 16, 0, "AO_Unknown", "=q6=Warchief Rend Blackhand", "=q5=ONE WILL DROP"};
    ...
    { 1, 0, "RoM_stellar_dice", "=q6=The Beast", "=q5=CHANCE TO DROP"};
    { 2, 24101, "", "=q3=Book of Ferocious Bite V", "=ds=#e2#", "", "13.0%" };
    { 3, 59079, "", "=q3=Totem of Drakkisath's Wrath", "", "", "10.0%" };
    { 5, 0, "AO_Unknown", "=q6=The Beast", "=q5=ONE WILL DROP"};
    { 6, 12964, "", "=q3=Tristam Legguards", "=ds=#a3#", "", "20.0%" };
    { 7, 12967, "", "=q3=Bloodmoon Cloak", "=ds=#a1#", "", "20.0%" };
    { 8, 12709, "", "=q3=Finkle's Skinner", "=ds=#w4#", "", "7.50%" };
    { 9, 12963, "", "=q3=Blademaster Leggings", "=ds=#a2#", "", "7.50%" };
    { 10, 12965, "", "=q3=Spiritshroud Leggings", "=ds=#a1#", "", "7.50%" };
    { 11, 12966, "", "=q3=Blackmist Armguards", "=ds=#a2#", "", "7.50%" };
    { 12, 12968, "", "=q3=Frostweaver Cape", "=ds=#a1#", "", "7.50%" };
    { 13, 12969, "", "=q3=Seeping Willow", "=ds=#w6#", "", "7.50%" };
    { 14, 16729, "", "=q3=Lightforge Spaulders", "=ds=#a4#", "", "7.50%" };
    { 15, 22311, "", "=q3=Ironweave Boots", "=ds=#a1#", "", "7.50%" };
	};

	AtlasLoot_Data["UBRSBeastMYTHIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Mythic The Beast", "=q5=CHANCE TO DROP"};
    { 2, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 24101, "", "=q3=Book of Ferocious Bite V", "=ds=#e2#", "", "13.0%" };
    { 5, 59079, "", "=q3=Totem of Drakkisath's Wrath", "", "", "10.0%" };
    { 16, 0, "AO_Unknown", "=q6=Mythic The Beast", "=q5=ONE WILL DROP"};
    { 17, 69606, "", "=q4=Tristam Legguards", "=ds=#a3#", "", "20.0%" };
    { 18, 69609, "", "=q4=Bloodmoon Cloak", "=ds=#a1#", "", "20.0%" };
    { 19, 12709, "", "=q3=Finkle's Skinner", "=ds=#w4#", "", "7.50%" };
    { 20, 12969, "", "=q3=Seeping Willow", "=ds=#w6#", "", "7.50%" };
    { 21, 16729, "", "=q3=Lightforge Spaulders", "=ds=#a4#", "", "7.50%" };
    { 22, 22311, "", "=q3=Ironweave Boots", "=ds=#a1#", "", "7.50%" };
    { 23, 69605, "", "=q4=Blademaster Leggings", "=ds=#a2#", "", "7.50%" };
    { 24, 69607, "", "=q4=Spiritshroud Leggings", "=ds=#a1#", "", "7.50%" };
    { 25, 69608, "", "=q4=Blackmist Armguards", "=ds=#a2#", "", "7.50%" };
    { 26, 69610, "", "=q4=Frostweaver Cape", "=ds=#a1#", "", "7.50%" };
	};

	AtlasLoot_Data["UBRSBeastHEROIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Heroic The Beast", "=q5=CHANCE TO DROP"};
    { 2, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 24101, "", "=q3=Book of Ferocious Bite V", "=ds=#e2#", "", "13.0%" };
    { 5, 59079, "", "=q3=Totem of Drakkisath's Wrath", "", "", "10.0%" };
    { 16, 0, "AO_Unknown", "=q6=Heroic The Beast", "=q5=ONE WILL DROP"};
    { 17, 66606, "", "=q4=Tristam Legguards", "=ds=#a3#", "", "20.0%" };
    { 18, 66609, "", "=q4=Bloodmoon Cloak", "=ds=#a1#", "", "20.0%" };
    { 19, 12709, "", "=q3=Finkle's Skinner", "=ds=#w4#", "", "7.50%" };
    { 20, 12969, "", "=q3=Seeping Willow", "=ds=#w6#", "", "7.50%" };
    { 21, 16729, "", "=q3=Lightforge Spaulders", "=ds=#a4#", "", "7.50%" };
    { 22, 22311, "", "=q3=Ironweave Boots", "=ds=#a1#", "", "7.50%" };
    { 23, 66605, "", "=q4=Blademaster Leggings", "=ds=#a2#", "", "7.50%" };
    { 24, 66607, "", "=q4=Spiritshroud Leggings", "=ds=#a1#", "", "7.50%" };
    { 25, 66608, "", "=q4=Blackmist Armguards", "=ds=#a2#", "", "7.50%" };
    { 26, 66610, "", "=q4=Frostweaver Cape", "=ds=#a1#", "", "7.50%" };
	};

	AtlasLoot_Data["UBRSValthalak"] = {
    { 1, 0, "AO_Unknown", "=q6=Lord Valthalak", "=q5=ONE WILL DROP"};
    { 2, 22302, "", "=q3=Ironweave Cowl", "=ds=#a1#", "", "12.5%" };
    { 3, 22335, "", "=q3=Lord Valthalak's Staff of Command", "=ds=#w9#", "", "12.5%" };
    { 4, 22336, "", "=q3=Draconian Aegis of the Legion", "=ds=#w8#", "", "12.5%" };
    { 5, 22337, "", "=q3=Shroud of Domination", "=ds=#a1#", "", "12.5%" };
    { 6, 22339, "", "=q3=Rune Band of Wizardry", "=ds=#s13#", "", "12.5%" };
    { 7, 22340, "", "=q3=Pendant of Celerity", "=ds=#s2#", "", "12.5%" };
    { 8, 22342, "", "=q3=Leggings of Torment", "=ds=#a1#", "", "12.5%" };
    { 9, 22343, "", "=q3=Handguards of Savagery", "=ds=#a3#", "", "12.5%" };
	};

	AtlasLoot_Data["UBRSValthalakMYTHIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Mythic Lord Valthalak", "=q5=CHANCE TO DROP"};
    { 2, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 5, 0, "AO_Unknown", "=q6=Mythic Lord Valthalak", "=q5=ONE WILL DROP"};
    { 6, 22302, "", "=q3=Ironweave Cowl", "=ds=#a1#", "", "12.5%" };
    { 7, 22339, "", "=q3=Rune Band of Wizardry", "=ds=#s13#", "", "12.5%" };
    { 8, 69952, "", "=q4=Lord Valthalak's Staff of Command", "=ds=#w9#", "", "12.5%" };
    { 9, 69953, "", "=q4=Draconian Aegis of the Legion", "=ds=#w8#", "", "12.5%" };
    { 10, 69954, "", "=q4=Shroud of Domination", "=ds=#a1#", "", "12.5%" };
    { 11, 69955, "", "=q4=Pendant of Celerity", "=ds=#s2#", "", "12.5%" };
    { 12, 69956, "", "=q4=Leggings of Torment", "=ds=#a1#", "", "12.5%" };
    { 13, 69957, "", "=q4=Handguards of Savagery", "=ds=#a3#", "", "12.5%" };
	};

	AtlasLoot_Data["UBRSValthalakHEROIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Heroic Lord Valthalak", "=q5=CHANCE TO DROP"};
    { 2, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 5, 0, "AO_Unknown", "=q6=Heroic Lord Valthalak", "=q5=ONE WILL DROP"};
    { 6, 22302, "", "=q3=Ironweave Cowl", "=ds=#a1#", "", "12.5%" };
    { 7, 22339, "", "=q3=Rune Band of Wizardry", "=ds=#s13#", "", "12.5%" };
    { 8, 66952, "", "=q4=Lord Valthalak's Staff of Command", "=ds=#w9#", "", "12.5%" };
    { 9, 66953, "", "=q4=Draconian Aegis of the Legion", "=ds=#w8#", "", "12.5%" };
    { 10, 66954, "", "=q4=Shroud of Domination", "=ds=#a1#", "", "12.5%" };
    { 11, 66955, "", "=q4=Pendant of Celerity", "=ds=#s2#", "", "12.5%" };
    { 12, 66956, "", "=q4=Leggings of Torment", "=ds=#a1#", "", "12.5%" };
    { 13, 66957, "", "=q4=Handguards of Savagery", "=ds=#a3#", "", "12.5%" };
	};
    ...
    { 3, 58720, "", "=q1=Black Dragonflight Cipher", "=ds=#m3#", "", "100%" };
    { 4, 59001, "", "=q3=Drakkisath's Armor Cache - Chest", "=ds=#e10#", "", "100%" };
    { 6, 0, "RoM_stellar_dice", "=q6=General Drakkisath", "=q5=CHANCE TO DROP"};
    { 7, 57625, "", "=q6=Pattern: Artisan Riding Crop", "=ds=#e2#", "", "10.0%" };
    { 8, 59080, "", "=q3=Idol of the Beast Lord", "", "", "10.0%" };
    { 9, 15730, "", "=q3=Pattern: Red Dragonscale Breastplate", "=ds=#e2#", "", "4.00%" };
	...
	AtlasLoot_Data["UBRSDrakkisathMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic General Drakkisath", "=q5=ALL WILL DROP"};
    { 2, 16663, "", "=q1=Blood of the Black Dragon Champion", "=ds=#m3#", "", "100%" };
    { 3, 58720, "", "=q1=Black Dragonflight Cipher", "=ds=#m3#", "", "100%" };
    { 5, 0, "RoM_stellar_dice", "=q6=Mythic General Drakkisath", "=q5=CHANCE TO DROP"};
    { 6, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 8, 57625, "", "=q6=Pattern: Artisan Riding Crop", "=ds=#e2#", "", "10.0%" };
    { 9, 59080, "", "=q3=Idol of the Beast Lord", "", "", "10.0%" };
    { 10, 15730, "", "=q3=Pattern: Red Dragonscale Breastplate", "=ds=#e2#", "", "4.00%" };
    { 16, 0, "AO_Unknown", "=q6=Mythic General Drakkisath", "=q5=ONE WILL DROP"};
    { 17, 69582, "", "=q4=Draconian Deflector", "=ds=#w8#", "", "18.0%" };
    { 18, 69611, "", "=q4=Painweaver Band", "=ds=#s13#", "", "18.0%" };
    { 19, 69613, "", "=q4=Brigam Girdle", "=ds=#a4#", "", "18.0%" };
    { 20, 69939, "", "=q4=Shadow Prowler's Cloak", "=ds=#a1#", "", "18.0%" };
    { 21, 22268, "", "=q3=Draconic Infused Emblem", "=ds=#s14#", "", "8.00%" };
    { 22, 59001, "", "=q3=Drakkisath's Armor Cache - Chest", "=ds=#e10#", "", "4.50%" };
    { 23, 69612, "", "=q4=Tooth of Gnarr", "=ds=#s2#", "", "4.50%" };
    { 24, 69932, "", "=q4=Tome of the Lost", "=ds=#s15#", "", "4.50%" };
    { 25, 69938, "", "=q4=Spellweaver's Turban", "=ds=#a1#", "", "4.50%" };
    { 26, 12592, "", "=q4=Blackblade of Shahram", "=ds=#w10#", "", "2.00%" };
	};
    ...
    { 2, 16663, "", "=q1=Blood of the Black Dragon Champion", "=ds=#m3#", "", "100%" };
    { 3, 58720, "", "=q1=Black Dragonflight Cipher", "=ds=#m3#", "", "100%" };
    { 5, 0, "RoM_stellar_dice", "=q6=Heroic General Drakkisath", "=q5=CHANCE TO DROP"};
    { 6, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 8, 57625, "", "=q6=Pattern: Artisan Riding Crop", "=ds=#e2#", "", "10.0%" };
    { 9, 59080, "", "=q3=Idol of the Beast Lord", "", "", "10.0%" };
    ...
    { 17, 66582, "", "=q4=Draconian Deflector", "=ds=#w8#", "", "18.0%" };
    { 18, 66611, "", "=q4=Painweaver Band", "=ds=#s13#", "", "18.0%" };
    { 19, 66613, "", "=q4=Brigam Girdle", "=ds=#a4#", "", "18.0%" };
    { 20, 66939, "", "=q4=Shadow Prowler's Cloak", "=ds=#a1#", "", "18.0%" };
    { 21, 22268, "", "=q3=Draconic Infused Emblem", "=ds=#s14#", "", "8.00%" };
    { 22, 59001, "", "=q3=Drakkisath's Armor Cache - Chest", "=ds=#e10#", "", "4.50%" };
    { 23, 66612, "", "=q4=Tooth of Gnarr", "=ds=#s2#", "", "4.50%" };
    { 24, 66932, "", "=q4=Tome of the Lost", "=ds=#s15#", "", "4.50%" };
    { 25, 66938, "", "=q4=Spellweaver's Turban", "=ds=#a1#", "", "4.50%" };
    { 26, 12592, "", "=q4=Blackblade of Shahram", "=ds=#w10#", "", "2.00%" };
	};
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6=Lucifron", "=q5=ALL WILL DROP"};
    { 2, 17329, "", "=q1=Hand of Lucifron", "=ds=#m3#", "", "100%" };
    { 3, 59303, "", "=q4=Flamewaker Armor Cache - Gloves", "=ds=#e10#", "", "100%" };
    { 4, 59305, "", "=q4=Flamewaker Armor Cache - Boots", "=ds=#e10#", "", "100%" };
    { 6, 0, "RoM_stellar_dice", "=q6=Lucifron", "=q5=CHANCE TO DROP"};
    { 7, 7078, "", "=q2=Essence of Fire", "=ds=#e7#", "", "40.0%" };
	};

	AtlasLoot_Data["MCMagmadar"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Magmadar", "=q5=ALL WILL DROP"};
    { 2, 59304, "", "=q4=Flamewaker Armor Cache - Legs", "=ds=#e10#", "", "100%" };
    { 16, 0, "AO_Unknown", "=q6=Magmadar", "=q5=ONE WILL DROP"};
    { 17, 17073, "", "=q4=Earthshaker", "=ds=#w6#", "", "20.0%" };
    { 18, 18203, "", "=q4=Eskhandar's Right Claw", "=ds=#w13#", "", "20.0%" };
    { 19, 18820, "", "=q4=Talisman of Ephemeral Power", "=ds=#s14#", "", "5.45%" };
    { 20, 18821, "", "=q4=Quick Strike Ring", "=ds=#s13#", "", "5.45%" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6=Shazzrah", "=q5=ALL WILL DROP"};
    { 2, 17332, "", "=q1=Hand of Shazzrah", "=ds=#m3#", "", "100%" };
    { 3, 59303, "", "=q4=Flamewaker Armor Cache - Gloves", "=ds=#e10#", "", "100%" };
    { 4, 59305, "", "=q4=Flamewaker Armor Cache - Boots", "=ds=#e10#", "", "100%" };
    { 6, 0, "RoM_stellar_dice", "=q6=Shazzrah", "=q5=CHANCE TO DROP"};
    { 7, 7078, "", "=q2=Essence of Fire", "=ds=#e7#", "", "40.0%" };
    { 16, 0, "AO_Unknown", "=q6=Shazzrah", "=q5=ONE WILL DROP"};
    ...
    { 20, 18820, "", "=q4=Talisman of Ephemeral Power", "=ds=#s14#", "", "2.27%" };
    { 21, 18821, "", "=q4=Quick Strike Ring", "=ds=#s13#", "", "2.27%" };
    ...
    { 6, 0, "RoM_stellar_dice", "=q6=Sulfuron Harbinger", "=q5=CHANCE TO DROP"};
    { 7, 7078, "", "=q2=Essence of Fire", "=ds=#e7#", "", "40.0%" };
	};

	AtlasLoot_Data["MCMajordomo"] = {
    { 1, 0, "RoM_stellar_dice", "=q6="..BabbleBoss["Molten Core - Cache of the Firelord"], "=q5=Chance on Drop" };
    { 2, 18646, "", "=q4=The Eye of Divinity", "=ds=#s14#", "", "50.0%" };
    ...
    { 8, 19140, "", "=q4=Cauterizing Band", "=ds=#s13#", "", "20.0%" };
    { 10, 0, "AO_Unknown", "=q6="..BabbleBoss["Molten Core - Cache of the Firelord"], "=q5=One Random Drop" };
    { 11, 18803, "", "=q4=Finkle's Lava Dredger", "=ds=#w6#", "", "20.0%" };
    { 12, 18805, "", "=q4=Core Hound Tooth", "=ds=#w4#", "", "20.0%" };
    { 13, 18808, "", "=q4=Gloves of the Hypnotic Flame", "=ds=#a1#", "", "20.0%" };
    { 14, 18811, "", "=q4=Fireproof Cloak", "=ds=#a1#", "", "20.0%" };
    { 15, 19139, "", "=q4=Fireguard Shoulders", "=ds=#a2#", "", "20.0%" };
	};

	AtlasLoot_Data["MCRagnaros"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Ragnaros", "=q5=ALL WILL DROP"};
    { 2, 19017, "", "=q1=Essence of the Firelord", "=ds=#m3#", "", "100%" };
    { 3, 59310, "", "=q4=Firelord's Armor Cache - Legs", "=ds=#e10#", "", "100%" };
    { 5, 0, "RoM_stellar_dice", "=q6=Ragnaros", "=q5=CHANCE TO DROP"};
    { 6, 7078, "", "=q2=Essence of Fire", "=ds=#e7#", "", "40.0%" };
    { 7, 17204, "", "=q5=Eye of Sulfuras", "=ds=#e7#", "", "3.00%" };
    { 8, 17076, "", "=q4=Bonereaver's Edge", "=ds=#w10#", "", "8.00%" };
    { 9, 17082, "", "=q4=Shard of the Flame", "=ds=#s14#", "", "8.00%" };
    { 10, 17104, "", "=q4=Spinal Reaper", "=ds=#w1#", "", "8.00%" };
    { 16, 0, "AO_Unknown", "=q6=Ragnaros", "=q5=ONE WILL DROP"};
    { 17, 18814, "", "=q4=Choker of the Fire Lord", "=ds=#s2#", "", "20.0%" };
    { 18, 18815, "", "=q4=Essence of the Pure Flame", "=ds=#s14#", "", "20.0%" };
    { 19, 18816, "", "=q4=Perdition's Blade", "=ds=#w4#", "", "20.0%" };
    { 20, 18817, "", "=q4=Crown of Destruction", "=ds=#a3#", "", "20.0%" };
    { 21, 19138, "", "=q4=Band of Sulfuras", "=ds=#s13#", "", "20.0%" };
    { 23, 0, "AO_Unknown", "=q6=Ragnaros", "=q5=ONE WILL DROP"};
    { 24, 17063, "", "=q4=Band of Accuria", "=ds=#s13#", "", "20.0%" };
    { 25, 17102, "", "=q4=Cloak of the Shrouded Mists", "=ds=#a1#", "", "20.0%" };
    { 26, 17106, "", "=q4=Malistar's Defender", "=ds=#w8#", "", "20.0%" };
    { 27, 17107, "", "=q4=Dragon's Blood Cape", "=ds=#a1#", "", "20.0%" };
    { 28, 19137, "", "=q4=Onslaught Girdle", "=ds=#a4#", "", "20.0%" };
	};
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6=Razorgore the Untamed", "=q5=ALL WILL DROP"};
    { 2, 59312, "", "=q4=Blackwing Armor Cache - Bracers", "=ds=#e10#", "", "100%" };
    { 4, 0, "AO_Unknown", "=q6=Razorgore the Untamed", "=q5=ONE WILL DROP"};
    { 5, 19336, "", "=q4=Arcane Infused Gem", "=ds=#s14#", "", "20.0%" };
    { 6, 19337, "", "=q4=The Black Book", "=ds=#s14#", "", "20.0%" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6=Vaelastrasz the Corrupt", "=q5=ALL WILL DROP"};
    { 2, 59309, "", "=q4=Blackwing Armor Cache - Belt", "=ds=#e10#", "", "100%" };
    { 4, 0, "AO_Unknown", "=q6=Vaelastrasz the Corrupt", "=q5=ONE WILL DROP"};
    { 5, 19339, "", "=q4=Mind Quickening Gem", "=ds=#s14#", "", "20.0%" };
    { 6, 19340, "", "=q4=Rune of Metamorphosis", "=ds=#s14#", "", "20.0%" };
    { 7, 19371, "", "=q4=Pendant of the Fallen Dragon", "=ds=#s2#", "", "20.0%" };
    { 8, 19372, "", "=q4=Helm of Endless Rage", "=ds=#a4#", "", "20.0%" };
    { 9, 19346, "", "=q4=Dragonfang Blade", "=ds=#w4#", "", "10.0%" };
    { 10, 19348, "", "=q4=Red Dragonscale Protector", "=ds=#w8#", "", "10.0%" };
	};

	AtlasLoot_Data["BWLLashlayer"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Broodlord Lashlayer", "=q5=ALL WILL DROP"};
    { 2, 20383, "", "=q1=Head of the Broodlord Lashlayer", "=ds=#m3#", "", "100%" };
    { 3, 59311, "", "=q4=Blackwing Armor Cache - Boots", "=ds=#e10#", "", "100%" };
    { 5, 0, "RoM_stellar_dice", "=q6=Broodlord Lashlayer", "=q5=CHANCE TO DROP"};
    { 6, 58336, "", "=q3=Tome: Greater Blessing of Kings", "=ds=#e2#", "", "12.0%" };
    { 8, 0, "AO_Unknown", "=q6=Broodlord Lashlayer", "=q5=ONE WILL DROP"};
    { 9, 19341, "", "=q4=Lifegiving Gem", "=ds=#s14#", "", "20.0%" };
    { 10, 19342, "", "=q4=Venomous Totem", "=ds=#s14#", "", "20.0%" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6=Firemaw", "=q5=ALL WILL DROP"};
    { 2, 59313, "", "=q4=Blackwing Armor Cache - Gloves", "=ds=#e10#", "", "100%" };
    { 4, 0, "AO_Unknown", "=q6=Firemaw", "=q5=ONE WILL DROP"};
    { 5, 19343, "", "=q4=Scrolls of Blinding Light", "=ds=#s14#", "", "12.5%" };
    { 6, 19344, "", "=q4=Natural Alignment Crystal", "=ds=#s14#", "", "12.5%" };
    ...
    { 16, 0, "AO_Unknown", "=q6=Firemaw", "=q5=ONE WILL DROP"};
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6=Ebonroc", "=q5=ALL WILL DROP"};
    { 2, 59313, "", "=q4=Blackwing Armor Cache - Gloves", "=ds=#e10#", "", "100%" };
    { 4, 0, "AO_Unknown", "=q6=Ebonroc", "=q5=ONE WILL DROP"};
    { 5, 19345, "", "=q4=Aegis of Preservation", "=ds=#s14#", "", "18.0%" };
    { 6, 19403, "", "=q4=Band of Forced Concentration", "=ds=#s13#", "", "18.0%" };
    { 7, 19405, "", "=q4=Malfurion's Blessed Bulwark", "=ds=#a2#", "", "18.0%" };
    { 8, 19406, "", "=q4=Drake Fang Talisman", "=ds=#s14#", "", "18.0%" };
    { 9, 19407, "", "=q4=Ebony Flame Gloves", "=ds=#a1#", "", "18.0%" };
    { 10, 19368, "", "=q4=Dragonbreath Hand Cannon", "=ds=#w5#", "", "10.0%" };
    { 12, 0, "AO_Unknown", "=q6=Ebonroc", "=q5=ONE WILL DROP"};
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6=Flamegor", "=q5=ALL WILL DROP"};
    { 2, 59313, "", "=q4=Blackwing Armor Cache - Gloves", "=ds=#e10#", "", "100%" };
    { 4, 0, "AO_Unknown", "=q6=Flamegor", "=q5=ONE WILL DROP"};
    { 5, 19430, "", "=q4=Shroud of Pure Thought", "=ds=#a1#", "", "20.0%" };
    { 6, 19431, "", "=q4=Styleen's Impeding Scarab", "=ds=#s14#", "", "20.0%" };
    { 7, 19432, "", "=q4=Circle of Applied Force", "=ds=#s13#", "", "20.0%" };
    { 8, 19433, "", "=q4=Emberweave Leggings", "=ds=#a3#", "", "20.0%" };
    { 9, 19357, "", "=q4=Herald of Woe", "=ds=#w6#", "", "10.0%" };
    { 10, 19367, "", "=q4=Dragon's Touch", "=ds=#w12#", "", "10.0%" };
    { 12, 0, "AO_Unknown", "=q6=Flamegor", "=q5=ONE WILL DROP"};
    { 13, 57001, "", "=q4=Plans: Elementium Aegis", "=ds=#e2#", "", "33.3%" };
    { 14, 57204, "", "=q4=Schematic: Elementium Targeting Matrix", "=ds=#e2#", "", "33.3%" };
    { 15, 57500, "", "=q4=Design: Elementium Talisman", "=ds=#e2#", "", "33.3%" };
	};
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6=Chromaggus", "=q5=ALL WILL DROP"};
    { 2, 59307, "", "=q4=Blackwing Armor Cache - Shoulder", "=ds=#e10#", "", "100%" };
    { 4, 0, "AO_Unknown", "=q6=Chromaggus", "=q5=ONE WILL DROP"};
    ...
    { 9, 19349, "", "=q4=Elementium Reinforced Bulwark", "=ds=#w8#", "", "10.0%" };
    { 10, 19352, "", "=q4=Chromatically Tempered Sword", "=ds=#w10#", "", "10.0%" };
    { 16, 0, "AO_Unknown", "=q6=Chromaggus", "=q5=ONE WILL DROP"};
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6=Nefarian", "=q5=ALL WILL DROP"};
    { 2, 19002, "", "=q4=Head of Nefarian", "=ds=#m3#", "", "100%" };
    { 3, 19003, "", "=q4=Head of Nefarian", "=ds=#m3#", "", "100%" };
    { 4, 21138, "", "=q1=Red Scepter Shard", "=ds=#m3#", "", "100%" };
    { 6, 0, "AO_Unknown", "=q6=Nefarian", "=q5=ONE WILL DROP"};
    { 7, 16897, "", "=q4=Stormrage Chestguard", "=ds=#a2#", "", "11.1%" };
    { 8, 16905, "", "=q4=Bloodfang Chestpiece", "=ds=#a2#", "", "11.1%" };
    { 9, 16916, "", "=q4=Netherwind Robes", "=ds=#a1#", "", "11.1%" };
    { 10, 16923, "", "=q4=Robes of Transcendence", "=ds=#a1#", "", "11.1%" };
    { 11, 16931, "", "=q4=Nemesis Robes", "=ds=#a1#", "", "11.1%" };
    { 12, 16942, "", "=q4=Dragonstalker's Breastplate", "=ds=#a3#", "", "11.1%" };
    { 13, 16950, "", "=q4=Breastplate of Ten Storms", "=ds=#a3#", "", "11.1%" };
    { 14, 16958, "", "=q4=Judgement Breastplate", "=ds=#a4#", "", "11.1%" };
    { 15, 16966, "", "=q4=Breastplate of Wrath", "=ds=#a4#", "", "11.1%" };
    { 16, 0, "AO_Unknown", "=q6=Nefarian", "=q5=ONE WILL DROP"};
    { 17, 19375, "", "=q4=Mish'undare, Circlet of the Mind Flayer", "=ds=#a1#", "", "20.0%" };
    { 18, 19376, "", "=q4=Archimtiros' Ring of Reckoning", "=ds=#s13#", "", "20.0%" };
    { 19, 19377, "", "=q4=Prestor's Talisman of Connivery", "=ds=#s2#", "", "20.0%" };
    ...
    { 24, 0, "AO_Unknown", "=q6=Nefarian", "=q5=ONE WILL DROP"};
    { 25, 19379, "", "=q4=Neltharion's Tear", "=ds=#s14#", "", "20.0%" };
    { 26, 19380, "", "=q4=Therazane's Link", "=ds=#a3#", "", "20.0%" };
    { 27, 19381, "", "=q4=Boots of the Shadow Flame", "=ds=#a2#", "", "20.0%" };
    { 28, 19382, "", "=q4=Pure Elementium Band", "=ds=#s13#", "", "20.0%" };
    ...
    { 3, 18267, "", "=q1=Recipe: Runn Tum Tuber Surprise", "=ds=#e2#", "", "100%" };
	};

	AtlasLoot_Data["DMEPusillinMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Pusillin", "=q5=ALL WILL DROP"};
    { 2, 18261, "", "=q1=Book of Incantations", "=ds=#m3#", "", "100%" };
    { 3, 18267, "", "=q1=Recipe: Runn Tum Tuber Surprise", "=ds=#e2#", "", "100%" };
    { 4, 18332, "", "=q2=Libram of Rapidity", "=ds=#e2#", "", "100%" };
    { 5, 18333, "", "=q2=Libram of Focus", "=ds=#e2#", "", "100%" };
    { 7, 0, "RoM_stellar_dice", "=q6=Mythic Pusillin", "=q5=CHANCE TO DROP"};
    { 8, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 9, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 16, 0, "AO_Unknown", "=q6=Mythic Pusillin", "=q5=ONE WILL DROP"};
    { 17, 18356, "", "=q3=Garona: A Study on Stealth and Treachery", "=ds=#m3#", "", "10.0%" };
    { 18, 18357, "", "=q3=Codex of Defense", "=ds=#m3#", "", "10.0%" };
    { 19, 18358, "", "=q3=The Arcanist's Cookbook", "=ds=#m3#", "", "10.0%" };
    { 20, 18359, "", "=q3=The Light and How to Swing It", "=ds=#m3#", "", "10.0%" };
    { 21, 18360, "", "=q3=Harnessing Shadows", "=ds=#m3#", "", "10.0%" };
    { 22, 18361, "", "=q3=The Greatest Race of Hunters", "=ds=#m3#", "", "10.0%" };
    { 23, 18362, "", "=q3=Holy Bologna: What the Light Won't Tell You", "=ds=#m3#", "", "10.0%" };
    { 24, 18363, "", "=q3=Frost Shock and You", "=ds=#m3#", "", "10.0%" };
    { 25, 18364, "", "=q3=The Emerald Dream", "=ds=#m3#", "", "10.0%" };
    { 26, 18401, "", "=q4=Foror's Compendium of Dragon Slaying", "=ds=#m3#", "", "10.0%" };
	};
    ...
    { 4, 18332, "", "=q2=Libram of Rapidity", "=ds=#e2#", "", "100%" };
    { 5, 18333, "", "=q2=Libram of Focus", "=ds=#e2#", "", "100%" };
    { 7, 0, "RoM_stellar_dice", "=q6=Heroic Pusillin", "=q5=CHANCE TO DROP"};
    { 8, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 9, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 16, 0, "AO_Unknown", "=q6=Heroic Pusillin", "=q5=ONE WILL DROP"};
    { 17, 18356, "", "=q3=Garona: A Study on Stealth and Treachery", "=ds=#m3#", "", "10.0%" };
    { 18, 18357, "", "=q3=Codex of Defense", "=ds=#m3#", "", "10.0%" };
    { 19, 18358, "", "=q3=The Arcanist's Cookbook", "=ds=#m3#", "", "10.0%" };
    { 20, 18359, "", "=q3=The Light and How to Swing It", "=ds=#m3#", "", "10.0%" };
    ...
    { 1, 0, "RoM_stellar_dice", "=q6=Zevrim Thornhoof", "=q5=CHANCE TO DROP"};
    { 2, 59081, "", "=q3=Idol of Verdant Renewal", "", "", "10.0%" };
    { 4, 0, "AO_Unknown", "=q6=Zevrim Thornhoof", "=q5=ONE WILL DROP"};
    { 5, 18306, "", "=q2=Gloves of Shadowy Mist", "=ds=#a1#", "", "26.0%" };
    { 6, 18308, "", "=q2=Clever Hat", "=ds=#a2#", "", "26.0%" };
    { 7, 18313, "", "=q3=Helm of Awareness", "=ds=#a4#", "", "20.0%" };
    { 8, 18323, "", "=q3=Satyr's Bow", "=ds=#w2#", "", "20.0%" };
    { 9, 18319, "", "=q3=Fervent Helm", "=ds=#a3#", "", "8.00%" };
	};

	AtlasLoot_Data["DMEZevrimThornhoofMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Zevrim Thornhoof", "=q5=ALL WILL DROP"};
    { 2, 18332, "", "=q2=Libram of Rapidity", "=ds=#e2#", "", "100%" };
    { 3, 18333, "", "=q2=Libram of Focus", "=ds=#e2#", "", "100%" };
    { 5, 0, "RoM_stellar_dice", "=q6=Mythic Zevrim Thornhoof", "=q5=CHANCE TO DROP"};
    { 6, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 8, 59081, "", "=q3=Idol of Verdant Renewal", "", "", "10.0%" };
    { 10, 0, "AO_Unknown", "=q6=Mythic Zevrim Thornhoof", "=q5=ONE WILL DROP"};
    { 11, 69773, "", "=q4=Helm of Awareness", "=ds=#a4#", "", "20.0%" };
    { 12, 69779, "", "=q4=Satyr's Bow", "=ds=#w2#", "", "20.0%" };
    { 13, 18319, "", "=q3=Fervent Helm", "=ds=#a3#", "", "8.00%" };
    { 14, 18356, "", "=q3=Garona: A Study on Stealth and Treachery", "=ds=#m3#", "", "4.33%" };
    { 15, 18357, "", "=q3=Codex of Defense", "=ds=#m3#", "", "4.33%" };
    { 16, 18358, "", "=q3=The Arcanist's Cookbook", "=ds=#m3#", "", "4.33%" };
    { 17, 18359, "", "=q3=The Light and How to Swing It", "=ds=#m3#", "", "4.33%" };
    { 18, 18360, "", "=q3=Harnessing Shadows", "=ds=#m3#", "", "4.33%" };
    { 19, 18361, "", "=q3=The Greatest Race of Hunters", "=ds=#m3#", "", "4.33%" };
    { 20, 18362, "", "=q3=Holy Bologna: What the Light Won't Tell You", "=ds=#m3#", "", "4.33%" };
    { 21, 18363, "", "=q3=Frost Shock and You", "=ds=#m3#", "", "4.33%" };
    { 22, 18364, "", "=q3=The Emerald Dream", "=ds=#m3#", "", "4.33%" };
    { 23, 18401, "", "=q4=Foror's Compendium of Dragon Slaying", "=ds=#m3#", "", "4.33%" };
    { 24, 69767, "", "=q4=Gloves of Shadowy Mist", "=ds=#a1#", "", "4.33%" };
    { 25, 69769, "", "=q4=Clever Hat", "=ds=#a2#", "", "4.33%" };
	};
    ...
    { 2, 18332, "", "=q2=Libram of Rapidity", "=ds=#e2#", "", "100%" };
    { 3, 18333, "", "=q2=Libram of Focus", "=ds=#e2#", "", "100%" };
    { 5, 0, "RoM_stellar_dice", "=q6=Heroic Zevrim Thornhoof", "=q5=CHANCE TO DROP"};
    { 6, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 8, 59081, "", "=q3=Idol of Verdant Renewal", "", "", "10.0%" };
    { 10, 0, "AO_Unknown", "=q6=Heroic Zevrim Thornhoof", "=q5=ONE WILL DROP"};
    { 11, 66773, "", "=q4=Helm of Awareness", "=ds=#a4#", "", "20.0%" };
    { 12, 66779, "", "=q4=Satyr's Bow", "=ds=#w2#", "", "20.0%" };
    { 13, 18319, "", "=q3=Fervent Helm", "=ds=#a3#", "", "8.00%" };
    { 14, 18356, "", "=q3=Garona: A Study on Stealth and Treachery", "=ds=#m3#", "", "4.33%" };
    { 15, 18357, "", "=q3=Codex of Defense", "=ds=#m3#", "", "4.33%" };
    { 16, 18358, "", "=q3=The Arcanist's Cookbook", "=ds=#m3#", "", "4.33%" };
    ...
    { 22, 18364, "", "=q3=The Emerald Dream", "=ds=#m3#", "", "4.33%" };
    { 23, 18401, "", "=q4=Foror's Compendium of Dragon Slaying", "=ds=#m3#", "", "4.33%" };
    { 24, 66767, "", "=q4=Gloves of Shadowy Mist", "=ds=#a1#", "", "4.33%" };
    { 25, 66769, "", "=q4=Clever Hat", "=ds=#a2#", "", "4.33%" };
	};

	AtlasLoot_Data["DMELethtendris"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Lethtendris", "=q5=ALL WILL DROP"};
    { 2, 18426, "", "=q1=Lethtendris's Web", "=ds=#m3#", "", "100%" };
    { 4, 0, "AO_Unknown", "=q6=Lethtendris", "=q5=ONE WILL DROP"};
    { 5, 18301, "", "=q2=Lethtendris's Wand", "=ds=#w12#", "", "30.0%" };
    { 6, 18302, "", "=q2=Band of Vigor", "=ds=#s13#", "", "30.0%" };
    { 7, 18325, "", "=q3=Felhide Cap", "=ds=#a2#", "", "30.0%" };
    { 8, 18311, "", "=q3=Quel'dorei Channeling Rod", "=ds=#w9#", "", "10.0%" };
	};

	AtlasLoot_Data["DMELethtendrisMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Lethtendris", "=q5=ALL WILL DROP"};
    { 2, 18332, "", "=q2=Libram of Rapidity", "=ds=#e2#", "", "100%" };
    { 3, 18333, "", "=q2=Libram of Focus", "=ds=#e2#", "", "100%" };
    { 4, 18426, "", "=q1=Lethtendris's Web", "=ds=#m3#", "", "100%" };
    { 6, 0, "RoM_stellar_dice", "=q6=Mythic Lethtendris", "=q5=CHANCE TO DROP"};
    { 7, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 8, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 10, 0, "AO_Unknown", "=q6=Mythic Lethtendris", "=q5=ONE WILL DROP"};
    { 11, 69764, "", "=q4=Lethtendris's Wand", "=ds=#w12#", "", "30.0%" };
    { 12, 69765, "", "=q4=Band of Vigor", "=ds=#s13#", "", "30.0%" };
    { 13, 69781, "", "=q4=Felhide Cap", "=ds=#a2#", "", "30.0%" };
    { 14, 69771, "", "=q4=Quel'dorei Channeling Rod", "=ds=#w9#", "", "10.0%" };
	};
    ...
    { 3, 18333, "", "=q2=Libram of Focus", "=ds=#e2#", "", "100%" };
    { 4, 18426, "", "=q1=Lethtendris's Web", "=ds=#m3#", "", "100%" };
    { 6, 0, "RoM_stellar_dice", "=q6=Heroic Lethtendris", "=q5=CHANCE TO DROP"};
    { 7, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 8, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 10, 0, "AO_Unknown", "=q6=Heroic Lethtendris", "=q5=ONE WILL DROP"};
    { 11, 66764, "", "=q4=Lethtendris's Wand", "=ds=#w12#", "", "30.0%" };
    { 12, 66765, "", "=q4=Band of Vigor", "=ds=#s13#", "", "30.0%" };
    { 13, 66781, "", "=q4=Felhide Cap", "=ds=#a2#", "", "30.0%" };
    { 14, 66771, "", "=q4=Quel'dorei Channeling Rod", "=ds=#w9#", "", "10.0%" };
	};
	...
	AtlasLoot_Data["DMEPimgibMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Pimgib", "=q5=ALL WILL DROP"};
    { 2, 18332, "", "=q2=Libram of Rapidity", "=ds=#e2#", "", "100%" };
    { 3, 18333, "", "=q2=Libram of Focus", "=ds=#e2#", "", "100%" };
    { 5, 0, "RoM_stellar_dice", "=q6=Mythic Pimgib", "=q5=CHANCE TO DROP"};
    { 6, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 8, 18354, "", "=q3=Pimgib's Collar", "=ds=#s14#", "", "14.0%" };
	};
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6=Hydrospawn", "=q5=ALL WILL DROP"};
    { 2, 18299, "", "=q1=Hydrospawn Essence", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Hydrospawn", "=q5=CHANCE TO DROP"};
    { 5, 22527, "", "=q1=Core of Elements", "=ds=#m3#", "", "63.0%" };
    { 6, 7080, "", "=q2=Essence of Water", "=ds=#e7#", "", "11.0%" };
    { 8, 0, "AO_Unknown", "=q6=Hydrospawn", "=q5=ONE WILL DROP"};
    { 9, 18305, "", "=q2=Breakwater Legguards", "=ds=#a4#", "", "25.0%" };
    { 10, 18307, "", "=q2=Riptide Shoes", "=ds=#a1#", "", "25.0%" };
    { 11, 18317, "", "=q3=Tempest Talisman", "=ds=#s2#", "", "20.0%" };
    { 12, 18322, "", "=q3=Waterspout Boots", "=ds=#a2#", "", "20.0%" };
    { 13, 18324, "", "=q3=Waveslicer", "=ds=#w1#", "", "10.0%" };
	};

	AtlasLoot_Data["DMEHydroMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Hydrospawn", "=q5=ALL WILL DROP"};
    { 2, 18299, "", "=q1=Hydrospawn Essence", "=ds=#m3#", "", "100%" };
    { 3, 18332, "", "=q2=Libram of Rapidity", "=ds=#e2#", "", "100%" };
    { 4, 18333, "", "=q2=Libram of Focus", "=ds=#e2#", "", "100%" };
    { 6, 0, "RoM_stellar_dice", "=q6=Mythic Hydrospawn", "=q5=CHANCE TO DROP"};
    { 7, 22527, "", "=q1=Core of Elements", "=ds=#m3#", "", "63.0%" };
    { 8, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 9, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 10, 7080, "", "=q2=Essence of Water", "=ds=#e7#", "", "11.0%" };
    { 12, 0, "AO_Unknown", "=q6=Mythic Hydrospawn", "=q5=ONE WILL DROP"};
    { 13, 69775, "", "=q4=Tempest Talisman", "=ds=#s2#", "", "20.0%" };
    { 14, 69778, "", "=q4=Waterspout Boots", "=ds=#a2#", "", "20.0%" };
    { 15, 69780, "", "=q4=Waveslicer", "=ds=#w1#", "", "10.0%" };
    { 16, 18356, "", "=q3=Garona: A Study on Stealth and Treachery", "=ds=#m3#", "", "4.17%" };
    { 17, 18357, "", "=q3=Codex of Defense", "=ds=#m3#", "", "4.17%" };
    { 18, 18358, "", "=q3=The Arcanist's Cookbook", "=ds=#m3#", "", "4.17%" };
    { 19, 18359, "", "=q3=The Light and How to Swing It", "=ds=#m3#", "", "4.17%" };
    { 20, 18360, "", "=q3=Harnessing Shadows", "=ds=#m3#", "", "4.17%" };
    { 21, 18361, "", "=q3=The Greatest Race of Hunters", "=ds=#m3#", "", "4.17%" };
    { 22, 18362, "", "=q3=Holy Bologna: What the Light Won't Tell You", "=ds=#m3#", "", "4.17%" };
    { 23, 18363, "", "=q3=Frost Shock and You", "=ds=#m3#", "", "4.17%" };
    { 24, 18364, "", "=q3=The Emerald Dream", "=ds=#m3#", "", "4.17%" };
    { 25, 18401, "", "=q4=Foror's Compendium of Dragon Slaying", "=ds=#m3#", "", "4.17%" };
    { 26, 69766, "", "=q4=Breakwater Legguards", "=ds=#a4#", "", "4.17%" };
    { 27, 69768, "", "=q4=Riptide Shoes", "=ds=#a1#", "", "4.17%" };
	};
    ...
    { 9, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 10, 7080, "", "=q2=Essence of Water", "=ds=#e7#", "", "11.0%" };
    { 12, 0, "AO_Unknown", "=q6=Heroic Hydrospawn", "=q5=ONE WILL DROP"};
    { 13, 66775, "", "=q4=Tempest Talisman", "=ds=#s2#", "", "20.0%" };
    { 14, 66778, "", "=q4=Waterspout Boots", "=ds=#a2#", "", "20.0%" };
    { 15, 66780, "", "=q4=Waveslicer", "=ds=#w1#", "", "10.0%" };
    { 16, 18356, "", "=q3=Garona: A Study on Stealth and Treachery", "=ds=#m3#", "", "4.17%" };
    { 17, 18357, "", "=q3=Codex of Defense", "=ds=#m3#", "", "4.17%" };
    { 18, 18358, "", "=q3=The Arcanist's Cookbook", "=ds=#m3#", "", "4.17%" };
    { 19, 18359, "", "=q3=The Light and How to Swing It", "=ds=#m3#", "", "4.17%" };
    ...
    { 24, 18364, "", "=q3=The Emerald Dream", "=ds=#m3#", "", "4.17%" };
    { 25, 18401, "", "=q4=Foror's Compendium of Dragon Slaying", "=ds=#m3#", "", "4.17%" };
    { 26, 66766, "", "=q4=Breakwater Legguards", "=ds=#a4#", "", "4.17%" };
    { 27, 66768, "", "=q4=Riptide Shoes", "=ds=#a1#", "", "4.17%" };
	};

	AtlasLoot_Data["DMEAlzzin"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Alzzin the Wildshaper", "=q5=ALL WILL DROP"};
    { 2, 58716, "", "=q1=Scepter of Sylvan Corruption", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Alzzin the Wildshaper", "=q5=CHANCE TO DROP"};
    { 5, 59082, "", "=q3=Totem of the Warpwood", "", "", "10.0%" };
    { 16, 0, "AO_Unknown", "=q6=Alzzin the Wildshaper", "=q5=ONE WILL DROP"};
    { 17, 18309, "", "=q3=Gloves of Restoration", "=ds=#a2#", "", "10.0%" };
    { 18, 18310, "", "=q3=Fiendish Machete", "=ds=#w10#", "", "10.0%" };
    { 19, 18312, "", "=q3=Energized Chestplate", "=ds=#a4#", "", "10.0%" };
    { 20, 18314, "", "=q3=Ring of Demonic Guile", "=ds=#s13#", "", "10.0%" };
    { 21, 18315, "", "=q3=Ring of Demonic Potency", "=ds=#s13#", "", "10.0%" };
    { 22, 18318, "", "=q3=Merciful Greaves", "=ds=#a3#", "", "10.0%" };
    { 23, 18321, "", "=q3=Energetic Rod", "=ds=#w6#", "", "10.0%" };
    { 24, 18326, "", "=q3=Razor Gauntlets", "=ds=#a4#", "", "10.0%" };
    { 25, 18327, "", "=q3=Whipvine Cord", "=ds=#a1#", "", "10.0%" };
    { 26, 18328, "", "=q3=Shadewood Cloak", "=ds=#a1#", "", "10.0%" };
	};

	AtlasLoot_Data["DMEAlzzinMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Alzzin the Wildshaper", "=q5=ALL WILL DROP"};
    { 2, 18332, "", "=q2=Libram of Rapidity", "=ds=#e2#", "", "100%" };
    { 3, 18333, "", "=q2=Libram of Focus", "=ds=#e2#", "", "100%" };
    { 4, 58716, "", "=q1=Scepter of Sylvan Corruption", "=ds=#m3#", "", "100%" };
    { 6, 0, "RoM_stellar_dice", "=q6=Mythic Alzzin the Wildshaper", "=q5=CHANCE TO DROP"};
    { 7, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 8, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 9, 59082, "", "=q3=Totem of the Warpwood", "", "", "10.0%" };
	};
    ...
    { 3, 18333, "", "=q2=Libram of Focus", "=ds=#e2#", "", "100%" };
    { 4, 58716, "", "=q1=Scepter of Sylvan Corruption", "=ds=#m3#", "", "100%" };
    { 6, 0, "RoM_stellar_dice", "=q6=Heroic Alzzin the Wildshaper", "=q5=CHANCE TO DROP"};
    { 7, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 8, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 9, 59082, "", "=q3=Totem of the Warpwood", "", "", "10.0%" };
	};
    ...
    { 2, 21984, "", "=q1=Left Piece of Lord Valthalak's Amulet", "=ds=#m3#", "", "100%" };
    { 3, 22046, "", "=q1=Right Piece of Lord Valthalak's Amulet", "=ds=#m3#", "", "100%" };
    { 5, 0, "AO_Unknown", "=q6=Isalien", "=q5=ONE WILL DROP"};
    { 6, 22304, "", "=q3=Ironweave Gloves", "=ds=#a1#", "", "16.7%" };
    { 7, 22314, "", "=q3=Huntsman's Harpoon", "=ds=#w7#", "", "16.7%" };
    { 8, 22315, "", "=q3=Hammer of Revitalization", "=ds=#w6#", "", "16.7%" };
    { 9, 22345, "", "=q3=Totem of Rebirth", "", "", "16.7%" };
    { 10, 22401, "", "=q3=Libram of Hope", "", "", "16.7%" };
    { 11, 22472, "", "=q3=Boots of Ferocity", "=ds=#a2#", "", "16.7%" };
	};

	AtlasLoot_Data["DMEIsalienMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Isalien", "=q5=ALL WILL DROP"};
    { 2, 21984, "", "=q1=Left Piece of Lord Valthalak's Amulet", "=ds=#m3#", "", "100%" };
    { 3, 22046, "", "=q1=Right Piece of Lord Valthalak's Amulet", "=ds=#m3#", "", "100%" };
    { 5, 0, "RoM_stellar_dice", "=q6=Mythic Isalien", "=q5=CHANCE TO DROP"};
    { 6, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 9, 0, "AO_Unknown", "=q6=Mythic Isalien", "=q5=ONE WILL DROP"};
    { 10, 22304, "", "=q3=Ironweave Gloves", "=ds=#a1#", "", "16.7%" };
    { 11, 69943, "", "=q4=Huntsman's Harpoon", "=ds=#w7#", "", "16.7%" };
    { 12, 69944, "", "=q4=Hammer of Revitalization", "=ds=#w6#", "", "16.7%" };
    { 13, 69958, "", "=q4=Totem of Rebirth", "", "", "16.7%" };
    { 14, 69964, "", "=q4=Libram of Hope", "", "", "16.7%" };
    { 15, 69975, "", "=q4=Boots of Ferocity", "=ds=#a2#", "", "16.7%" };
	};
    ...
    { 2, 21984, "", "=q1=Left Piece of Lord Valthalak's Amulet", "=ds=#m3#", "", "100%" };
    { 3, 22046, "", "=q1=Right Piece of Lord Valthalak's Amulet", "=ds=#m3#", "", "100%" };
    { 5, 0, "RoM_stellar_dice", "=q6=Heroic Isalien", "=q5=CHANCE TO DROP"};
    { 6, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 9, 0, "AO_Unknown", "=q6=Heroic Isalien", "=q5=ONE WILL DROP"};
    { 10, 22304, "", "=q3=Ironweave Gloves", "=ds=#a1#", "", "16.7%" };
    { 11, 66943, "", "=q4=Huntsman's Harpoon", "=ds=#w7#", "", "16.7%" };
    { 12, 66944, "", "=q4=Hammer of Revitalization", "=ds=#w6#", "", "16.7%" };
    { 13, 66958, "", "=q4=Totem of Rebirth", "", "", "16.7%" };
    { 14, 66964, "", "=q4=Libram of Hope", "", "", "16.7%" };
    { 15, 66975, "", "=q4=Boots of Ferocity", "=ds=#a2#", "", "16.7%" };
	};
    ...
    { 3, 57625, "", "=q6=Pattern: Artisan Riding Crop", "=ds=#e2#", "", "5.00%" };
	...
	AtlasLoot_Data["DMNGuardMoldarMYTHIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Mythic Guard Mol'dar", "=q5=CHANCE TO DROP"};
    { 2, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 18250, "", "=q2=Gordok Shackle Key", "=ds=#e10#", "", "13.0%" };
    { 5, 57625, "", "=q6=Pattern: Artisan Riding Crop", "=ds=#e2#", "", "5.00%" };
    { 16, 0, "AO_Unknown", "=q6=Mythic Guard Mol'dar", "=q5=ONE WILL DROP"};
    { 17, 69818, "", "=q4=Robe of Combustion", "=ds=#a1#", "", "7.69%" };
    { 18, 69819, "", "=q4=Hyena Hide Belt", "=ds=#a2#", "", "7.69%" };
    { 19, 69820, "", "=q4=Modest Armguards", "=ds=#a3#", "", "7.69%" };
    { 20, 69821, "", "=q4=Gallant's Wristguards", "=ds=#a4#", "", "7.69%" };
    { 21, 69822, "", "=q4=Unsophisticated Hand Cannon", "=ds=#w5#", "", "7.69%" };
    { 22, 69823, "", "=q4=Jagged Bone Fist", "=ds=#w13#", "", "7.69%" };
    { 23, 69824, "", "=q4=Ogre Pocket Knife", "=ds=#w10#", "", "7.69%" };
    { 24, 69825, "", "=q4=Gordok Nose Ring", "=ds=#s13#", "", "7.69%" };
    { 25, 69833, "", "=q4=Bulky Iron Spaulders", "=ds=#a4#", "", "7.69%" };
    { 26, 69834, "", "=q4=Denwatcher's Shoulders", "=ds=#a3#", "", "7.69%" };
    { 27, 69835, "", "=q4=Heliotrope Cloak", "=ds=#a1#", "", "7.69%" };
    { 28, 69836, "", "=q4=Sublime Wristguards", "=ds=#a1#", "", "7.69%" };
    { 29, 69837, "", "=q4=Hedgecutter", "=ds=#w1#", "", "7.69%" };
	};

	AtlasLoot_Data["DMNGuardMoldarHEROIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Heroic Guard Mol'dar", "=q5=CHANCE TO DROP"};
    { 2, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 18250, "", "=q2=Gordok Shackle Key", "=ds=#e10#", "", "13.0%" };
    { 5, 57625, "", "=q6=Pattern: Artisan Riding Crop", "=ds=#e2#", "", "5.00%" };
    { 16, 0, "AO_Unknown", "=q6=Heroic Guard Mol'dar", "=q5=ONE WILL DROP"};
    { 17, 66818, "", "=q4=Robe of Combustion", "=ds=#a1#", "", "7.69%" };
    { 18, 66819, "", "=q4=Hyena Hide Belt", "=ds=#a2#", "", "7.69%" };
    { 19, 66820, "", "=q4=Modest Armguards", "=ds=#a3#", "", "7.69%" };
    { 20, 66821, "", "=q4=Gallant's Wristguards", "=ds=#a4#", "", "7.69%" };
    { 21, 66822, "", "=q4=Unsophisticated Hand Cannon", "=ds=#w5#", "", "7.69%" };
    { 22, 66823, "", "=q4=Jagged Bone Fist", "=ds=#w13#", "", "7.69%" };
    { 23, 66824, "", "=q4=Ogre Pocket Knife", "=ds=#w10#", "", "7.69%" };
    { 24, 66825, "", "=q4=Gordok Nose Ring", "=ds=#s13#", "", "7.69%" };
    { 25, 66833, "", "=q4=Bulky Iron Spaulders", "=ds=#a4#", "", "7.69%" };
    { 26, 66834, "", "=q4=Denwatcher's Shoulders", "=ds=#a3#", "", "7.69%" };
    { 27, 66835, "", "=q4=Heliotrope Cloak", "=ds=#a1#", "", "7.69%" };
    { 28, 66836, "", "=q4=Sublime Wristguards", "=ds=#a1#", "", "7.69%" };
    { 29, 66837, "", "=q4=Hedgecutter", "=ds=#w1#", "", "7.69%" };
	};

	AtlasLoot_Data["DMNStomperKreeg"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Stomper Kreeg", "=q5=CHANCE TO DROP"};
    { 2, 18425, "", "=q2=Kreeg's Mug", "=ds=#s15#", "", "40.0%" };
	};

	AtlasLoot_Data["DMNStomperKreegMYTHIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Mythic Stomper Kreeg", "=q5=CHANCE TO DROP"};
    { 2, 69817, "", "=q4=Kreeg's Mug", "=ds=#s15#", "", "40.0%" };
    { 3, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
	};

	AtlasLoot_Data["DMNStomperKreegHEROIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Heroic Stomper Kreeg", "=q5=CHANCE TO DROP"};
    { 2, 66817, "", "=q4=Kreeg's Mug", "=ds=#s15#", "", "40.0%" };
    { 3, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
	};
    ...
    { 2, 18250, "", "=q2=Gordok Shackle Key", "=ds=#e10#", "", "13.0%" };
    { 3, 59083, "", "=q3=Libram of the Ogre's Crest", "", "", "10.0%" };
    { 4, 57625, "", "=q6=Pattern: Artisan Riding Crop", "=ds=#e2#", "", "5.00%" };
    { 6, 0, "AO_Unknown", "=q6=Guard Fengus", "=q5=ONE WILL DROP"};
    { 7, 18450, "", "=q2=Robe of Combustion", "=ds=#a1#", "", "12.5%" };
    { 8, 18451, "", "=q2=Hyena Hide Belt", "=ds=#a2#", "", "12.5%" };
    { 9, 18458, "", "=q2=Modest Armguards", "=ds=#a3#", "", "12.5%" };
    { 10, 18459, "", "=q2=Gallant's Wristguards", "=ds=#a4#", "", "12.5%" };
    { 11, 18460, "", "=q2=Unsophisticated Hand Cannon", "=ds=#w5#", "", "12.5%" };
    { 12, 18462, "", "=q2=Jagged Bone Fist", "=ds=#w13#", "", "12.5%" };
    { 13, 18463, "", "=q2=Ogre Pocket Knife", "=ds=#w10#", "", "12.5%" };
    { 14, 18464, "", "=q2=Gordok Nose Ring", "=ds=#s13#", "", "12.5%" };
	};

	AtlasLoot_Data["DMNGuardFengusMYTHIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Mythic Guard Fengus", "=q5=CHANCE TO DROP"};
    { 2, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 18250, "", "=q2=Gordok Shackle Key", "=ds=#e10#", "", "13.0%" };
    { 5, 59083, "", "=q3=Libram of the Ogre's Crest", "", "", "10.0%" };
    { 6, 57625, "", "=q6=Pattern: Artisan Riding Crop", "=ds=#e2#", "", "5.00%" };
    { 8, 0, "AO_Unknown", "=q6=Mythic Guard Fengus", "=q5=ONE WILL DROP"};
    { 9, 18356, "", "=q3=Garona: A Study on Stealth and Treachery", "=ds=#m3#", "", "5.56%" };
    { 10, 18357, "", "=q3=Codex of Defense", "=ds=#m3#", "", "5.56%" };
    { 11, 18358, "", "=q3=The Arcanist's Cookbook", "=ds=#m3#", "", "5.56%" };
    { 12, 18359, "", "=q3=The Light and How to Swing It", "=ds=#m3#", "", "5.56%" };
    { 13, 18360, "", "=q3=Harnessing Shadows", "=ds=#m3#", "", "5.56%" };
    { 14, 18361, "", "=q3=The Greatest Race of Hunters", "=ds=#m3#", "", "5.56%" };
    { 15, 18362, "", "=q3=Holy Bologna: What the Light Won't Tell You", "=ds=#m3#", "", "5.56%" };
    { 16, 18363, "", "=q3=Frost Shock and You", "=ds=#m3#", "", "5.56%" };
    { 17, 18364, "", "=q3=The Emerald Dream", "=ds=#m3#", "", "5.56%" };
    { 18, 18401, "", "=q4=Foror's Compendium of Dragon Slaying", "=ds=#m3#", "", "5.56%" };
    { 19, 69818, "", "=q4=Robe of Combustion", "=ds=#a1#", "", "5.56%" };
    { 20, 69819, "", "=q4=Hyena Hide Belt", "=ds=#a2#", "", "5.56%" };
    { 21, 69820, "", "=q4=Modest Armguards", "=ds=#a3#", "", "5.56%" };
    { 22, 69821, "", "=q4=Gallant's Wristguards", "=ds=#a4#", "", "5.56%" };
    { 23, 69822, "", "=q4=Unsophisticated Hand Cannon", "=ds=#w5#", "", "5.56%" };
    { 24, 69823, "", "=q4=Jagged Bone Fist", "=ds=#w13#", "", "5.56%" };
    { 25, 69824, "", "=q4=Ogre Pocket Knife", "=ds=#w10#", "", "5.56%" };
    { 26, 69825, "", "=q4=Gordok Nose Ring", "=ds=#s13#", "", "5.56%" };
	};

	AtlasLoot_Data["DMNGuardFengusHEROIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Heroic Guard Fengus", "=q5=CHANCE TO DROP"};
    { 2, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 18250, "", "=q2=Gordok Shackle Key", "=ds=#e10#", "", "13.0%" };
    { 5, 59083, "", "=q3=Libram of the Ogre's Crest", "", "", "10.0%" };
    ...
    { 17, 18364, "", "=q3=The Emerald Dream", "=ds=#m3#", "", "5.56%" };
    { 18, 18401, "", "=q4=Foror's Compendium of Dragon Slaying", "=ds=#m3#", "", "5.56%" };
    { 19, 66818, "", "=q4=Robe of Combustion", "=ds=#a1#", "", "5.56%" };
    { 20, 66819, "", "=q4=Hyena Hide Belt", "=ds=#a2#", "", "5.56%" };
    { 21, 66820, "", "=q4=Modest Armguards", "=ds=#a3#", "", "5.56%" };
    { 22, 66821, "", "=q4=Gallant's Wristguards", "=ds=#a4#", "", "5.56%" };
    { 23, 66822, "", "=q4=Unsophisticated Hand Cannon", "=ds=#w5#", "", "5.56%" };
    { 24, 66823, "", "=q4=Jagged Bone Fist", "=ds=#w13#", "", "5.56%" };
    { 25, 66824, "", "=q4=Ogre Pocket Knife", "=ds=#w10#", "", "5.56%" };
    { 26, 66825, "", "=q4=Gordok Nose Ring", "=ds=#s13#", "", "5.56%" };
	};
	...
	AtlasLoot_Data["DMNGuardSlipkikMYTHIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Mythic Guard Slip'kik", "=q5=CHANCE TO DROP"};
    { 2, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 18250, "", "=q2=Gordok Shackle Key", "=ds=#e10#", "", "13.0%" };
    { 5, 57625, "", "=q6=Pattern: Artisan Riding Crop", "=ds=#e2#", "", "5.00%" };
    { 7, 0, "AO_Unknown", "=q6=Mythic Guard Slip'kik", "=q5=ONE WILL DROP"};
    { 8, 18356, "", "=q3=Garona: A Study on Stealth and Treachery", "=ds=#m3#", "", "4.35%" };
    { 9, 18357, "", "=q3=Codex of Defense", "=ds=#m3#", "", "4.35%" };
    { 10, 18358, "", "=q3=The Arcanist's Cookbook", "=ds=#m3#", "", "4.35%" };
    { 11, 18359, "", "=q3=The Light and How to Swing It", "=ds=#m3#", "", "4.35%" };
    { 12, 18360, "", "=q3=Harnessing Shadows", "=ds=#m3#", "", "4.35%" };
    { 13, 18361, "", "=q3=The Greatest Race of Hunters", "=ds=#m3#", "", "4.35%" };
    { 14, 18362, "", "=q3=Holy Bologna: What the Light Won't Tell You", "=ds=#m3#", "", "4.35%" };
    { 15, 18363, "", "=q3=Frost Shock and You", "=ds=#m3#", "", "4.35%" };
    { 16, 18364, "", "=q3=The Emerald Dream", "=ds=#m3#", "", "4.35%" };
    { 17, 18401, "", "=q4=Foror's Compendium of Dragon Slaying", "=ds=#m3#", "", "4.35%" };
    { 18, 69818, "", "=q4=Robe of Combustion", "=ds=#a1#", "", "4.35%" };
    { 19, 69819, "", "=q4=Hyena Hide Belt", "=ds=#a2#", "", "4.35%" };
    { 20, 69820, "", "=q4=Modest Armguards", "=ds=#a3#", "", "4.35%" };
    { 21, 69821, "", "=q4=Gallant's Wristguards", "=ds=#a4#", "", "4.35%" };
    { 22, 69822, "", "=q4=Unsophisticated Hand Cannon", "=ds=#w5#", "", "4.35%" };
    { 23, 69823, "", "=q4=Jagged Bone Fist", "=ds=#w13#", "", "4.35%" };
    { 24, 69824, "", "=q4=Ogre Pocket Knife", "=ds=#w10#", "", "4.35%" };
    { 25, 69825, "", "=q4=Gordok Nose Ring", "=ds=#s13#", "", "4.35%" };
    { 26, 69833, "", "=q4=Bulky Iron Spaulders", "=ds=#a4#", "", "4.35%" };
    { 27, 69834, "", "=q4=Denwatcher's Shoulders", "=ds=#a3#", "", "4.35%" };
    { 28, 69835, "", "=q4=Heliotrope Cloak", "=ds=#a1#", "", "4.35%" };
    { 29, 69836, "", "=q4=Sublime Wristguards", "=ds=#a1#", "", "4.35%" };
    { 30, 69837, "", "=q4=Hedgecutter", "=ds=#w1#", "", "4.35%" };
	};

	AtlasLoot_Data["DMNGuardSlipkikHEROIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Heroic Guard Slip'kik", "=q5=CHANCE TO DROP"};
    { 2, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 18250, "", "=q2=Gordok Shackle Key", "=ds=#e10#", "", "13.0%" };
    { 5, 57625, "", "=q6=Pattern: Artisan Riding Crop", "=ds=#e2#", "", "5.00%" };
    { 7, 0, "AO_Unknown", "=q6=Heroic Guard Slip'kik", "=q5=ONE WILL DROP"};
    { 8, 18356, "", "=q3=Garona: A Study on Stealth and Treachery", "=ds=#m3#", "", "4.35%" };
    { 9, 18357, "", "=q3=Codex of Defense", "=ds=#m3#", "", "4.35%" };
    { 10, 18358, "", "=q3=The Arcanist's Cookbook", "=ds=#m3#", "", "4.35%" };
    { 11, 18359, "", "=q3=The Light and How to Swing It", "=ds=#m3#", "", "4.35%" };
    ...
    { 16, 18364, "", "=q3=The Emerald Dream", "=ds=#m3#", "", "4.35%" };
    { 17, 18401, "", "=q4=Foror's Compendium of Dragon Slaying", "=ds=#m3#", "", "4.35%" };
    { 18, 66818, "", "=q4=Robe of Combustion", "=ds=#a1#", "", "4.35%" };
    { 19, 66819, "", "=q4=Hyena Hide Belt", "=ds=#a2#", "", "4.35%" };
    { 20, 66820, "", "=q4=Modest Armguards", "=ds=#a3#", "", "4.35%" };
    { 21, 66821, "", "=q4=Gallant's Wristguards", "=ds=#a4#", "", "4.35%" };
    { 22, 66822, "", "=q4=Unsophisticated Hand Cannon", "=ds=#w5#", "", "4.35%" };
    { 23, 66823, "", "=q4=Jagged Bone Fist", "=ds=#w13#", "", "4.35%" };
    { 24, 66824, "", "=q4=Ogre Pocket Knife", "=ds=#w10#", "", "4.35%" };
    { 25, 66825, "", "=q4=Gordok Nose Ring", "=ds=#s13#", "", "4.35%" };
    { 26, 66833, "", "=q4=Bulky Iron Spaulders", "=ds=#a4#", "", "4.35%" };
    { 27, 66834, "", "=q4=Denwatcher's Shoulders", "=ds=#a3#", "", "4.35%" };
    { 28, 66835, "", "=q4=Heliotrope Cloak", "=ds=#a1#", "", "4.35%" };
    { 29, 66836, "", "=q4=Sublime Wristguards", "=ds=#a1#", "", "4.35%" };
    { 30, 66837, "", "=q4=Hedgecutter", "=ds=#w1#", "", "4.35%" };
	};

	AtlasLoot_Data["DMNCaptainKromcrush"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Captain Kromcrush", "=q5=CHANCE TO DROP"};
    { 2, 18250, "", "=q2=Gordok Shackle Key", "=ds=#e10#", "", "13.0%" };
    { 4, 0, "AO_Unknown", "=q6=Captain Kromcrush", "=q5=ONE WILL DROP"};
    { 5, 18502, "", "=q3=Monstrous Glaive", "=ds=#w7#", "", "25.0%" };
    { 6, 18503, "", "=q3=Kromcrush's Chestplate", "=ds=#a4#", "", "25.0%" };
    { 7, 18505, "", "=q3=Mugger's Belt", "=ds=#a2#", "", "25.0%" };
    { 8, 18507, "", "=q3=Boots of the Full Moon", "=ds=#a1#", "", "25.0%" };
	};

	AtlasLoot_Data["DMNCaptainKromcrushMYTHIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Mythic Captain Kromcrush", "=q5=CHANCE TO DROP"};
    { 2, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 18250, "", "=q2=Gordok Shackle Key", "=ds=#e10#", "", "13.0%" };
    { 16, 0, "AO_Unknown", "=q6=Mythic Captain Kromcrush", "=q5=ONE WILL DROP"};
    { 17, 18356, "", "=q3=Garona: A Study on Stealth and Treachery", "=ds=#m3#", "", "7.14%" };
    { 18, 18357, "", "=q3=Codex of Defense", "=ds=#m3#", "", "7.14%" };
    { 19, 18358, "", "=q3=The Arcanist's Cookbook", "=ds=#m3#", "", "7.14%" };
    { 20, 18359, "", "=q3=The Light and How to Swing It", "=ds=#m3#", "", "7.14%" };
    { 21, 18360, "", "=q3=Harnessing Shadows", "=ds=#m3#", "", "7.14%" };
    { 22, 18361, "", "=q3=The Greatest Race of Hunters", "=ds=#m3#", "", "7.14%" };
    { 23, 18362, "", "=q3=Holy Bologna: What the Light Won't Tell You", "=ds=#m3#", "", "7.14%" };
    { 24, 18363, "", "=q3=Frost Shock and You", "=ds=#m3#", "", "7.14%" };
    { 25, 18364, "", "=q3=The Emerald Dream", "=ds=#m3#", "", "7.14%" };
    { 26, 18401, "", "=q4=Foror's Compendium of Dragon Slaying", "=ds=#m3#", "", "7.14%" };
    { 27, 69838, "", "=q4=Monstrous Glaive", "=ds=#w7#", "", "7.14%" };
    { 28, 69839, "", "=q4=Kromcrush's Chestplate", "=ds=#a4#", "", "7.14%" };
    { 29, 69840, "", "=q4=Mugger's Belt", "=ds=#a2#", "", "7.14%" };
    { 30, 69841, "", "=q4=Boots of the Full Moon", "=ds=#a1#", "", "7.14%" };
	};

	AtlasLoot_Data["DMNCaptainKromcrushHEROIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Heroic Captain Kromcrush", "=q5=CHANCE TO DROP"};
    { 2, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 18250, "", "=q2=Gordok Shackle Key", "=ds=#e10#", "", "13.0%" };
    { 16, 0, "AO_Unknown", "=q6=Heroic Captain Kromcrush", "=q5=ONE WILL DROP"};
    { 17, 18356, "", "=q3=Garona: A Study on Stealth and Treachery", "=ds=#m3#", "", "7.14%" };
    { 18, 18357, "", "=q3=Codex of Defense", "=ds=#m3#", "", "7.14%" };
    { 19, 18358, "", "=q3=The Arcanist's Cookbook", "=ds=#m3#", "", "7.14%" };
    { 20, 18359, "", "=q3=The Light and How to Swing It", "=ds=#m3#", "", "7.14%" };
    ...
    { 25, 18364, "", "=q3=The Emerald Dream", "=ds=#m3#", "", "7.14%" };
    { 26, 18401, "", "=q4=Foror's Compendium of Dragon Slaying", "=ds=#m3#", "", "7.14%" };
    { 27, 66838, "", "=q4=Monstrous Glaive", "=ds=#w7#", "", "7.14%" };
    { 28, 66839, "", "=q4=Kromcrush's Chestplate", "=ds=#a4#", "", "7.14%" };
    { 29, 66840, "", "=q4=Mugger's Belt", "=ds=#a2#", "", "7.14%" };
    { 30, 66841, "", "=q4=Boots of the Full Moon", "=ds=#a1#", "", "7.14%" };
	};
	...
	AtlasLoot_Data["DMNChoRushMYTHIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Mythic Cho'Rush the Observer", "=q5=CHANCE TO DROP"};
    { 2, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 16, 0, "AO_Unknown", "=q6=Mythic Cho'Rush the Observer", "=q5=ONE WILL DROP"};
    { 17, 18356, "", "=q3=Garona: A Study on Stealth and Treachery", "=ds=#m3#", "", "7.14%" };
    { 18, 18357, "", "=q3=Codex of Defense", "=ds=#m3#", "", "7.14%" };
    { 19, 18358, "", "=q3=The Arcanist's Cookbook", "=ds=#m3#", "", "7.14%" };
    { 20, 18359, "", "=q3=The Light and How to Swing It", "=ds=#m3#", "", "7.14%" };
    ...
    { 25, 18364, "", "=q3=The Emerald Dream", "=ds=#m3#", "", "7.14%" };
    { 26, 18401, "", "=q4=Foror's Compendium of Dragon Slaying", "=ds=#m3#", "", "7.14%" };
    { 27, 69829, "", "=q4=Mana Channeling Wand", "=ds=#w12#", "", "7.14%" };
    { 28, 69830, "", "=q4=Cho'Rush's Blade", "=ds=#w10#", "", "7.14%" };
    { 29, 69831, "", "=q4=Observer's Shield", "=ds=#w8#", "", "7.14%" };
    { 30, 69832, "", "=q4=Insightful Hood", "=ds=#a2#", "", "7.14%" };
	};

	AtlasLoot_Data["DMNChoRushHEROIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Heroic Cho'Rush the Observer", "=q5=CHANCE TO DROP"};
    { 2, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 16, 0, "AO_Unknown", "=q6=Heroic Cho'Rush the Observer", "=q5=ONE WILL DROP"};
    { 17, 18356, "", "=q3=Garona: A Study on Stealth and Treachery", "=ds=#m3#", "", "7.14%" };
    { 18, 18357, "", "=q3=Codex of Defense", "=ds=#m3#", "", "7.14%" };
    { 19, 18358, "", "=q3=The Arcanist's Cookbook", "=ds=#m3#", "", "7.14%" };
    { 20, 18359, "", "=q3=The Light and How to Swing It", "=ds=#m3#", "", "7.14%" };
    ...
    { 25, 18364, "", "=q3=The Emerald Dream", "=ds=#m3#", "", "7.14%" };
    { 26, 18401, "", "=q4=Foror's Compendium of Dragon Slaying", "=ds=#m3#", "", "7.14%" };
    { 27, 66829, "", "=q4=Mana Channeling Wand", "=ds=#w12#", "", "7.14%" };
    { 28, 66830, "", "=q4=Cho'Rush's Blade", "=ds=#w10#", "", "7.14%" };
    { 29, 66831, "", "=q4=Observer's Shield", "=ds=#w8#", "", "7.14%" };
    { 30, 66832, "", "=q4=Insightful Hood", "=ds=#a2#", "", "7.14%" };
	};

	AtlasLoot_Data["DMNKingGordok"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=King Gordok", "=q5=ALL WILL DROP"};
    { 2, 58718, "", "=q1=Gordok's Skull Goblet", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=King Gordok", "=q5=CHANCE TO DROP"};
    { 5, 21982, "", "=q1=Ogre Warbeads", "=ds=#m3#", "", "80.0%" };
    { 6, 59084, "", "=q3=Totem of Tribal Bonds", "", "", "10.0%" };
    { 7, 57101, "", "=q4=Formula: Nexus Shard", "=ds=#e2#", "", "10.0%" };
    { 16, 0, "AO_Unknown", "=q6=King Gordok", "=q5=ONE WILL DROP"};
	...
	AtlasLoot_Data["DMNKingGordokMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic King Gordok", "=q5=ALL WILL DROP"};
    { 2, 58718, "", "=q1=Gordok's Skull Goblet", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Mythic King Gordok", "=q5=CHANCE TO DROP"};
    { 5, 21982, "", "=q1=Ogre Warbeads", "=ds=#m3#", "", "80.0%" };
    { 6, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 8, 59084, "", "=q3=Totem of Tribal Bonds", "", "", "10.0%" };
    { 10, 0, "AO_Unknown", "=q6=Mythic King Gordok", "=q5=ONE WILL DROP"};
    { 11, 57101, "", "=q4=Formula: Nexus Shard", "=ds=#e2#", "", "10.0%" };
    { 12, 18356, "", "=q3=Garona: A Study on Stealth and Treachery", "=ds=#m3#", "", "5.00%" };
    { 13, 18357, "", "=q3=Codex of Defense", "=ds=#m3#", "", "5.00%" };
    { 14, 18358, "", "=q3=The Arcanist's Cookbook", "=ds=#m3#", "", "5.00%" };
    { 15, 18359, "", "=q3=The Light and How to Swing It", "=ds=#m3#", "", "5.00%" };
    { 16, 18360, "", "=q3=Harnessing Shadows", "=ds=#m3#", "", "5.00%" };
    { 17, 18361, "", "=q3=The Greatest Race of Hunters", "=ds=#m3#", "", "5.00%" };
    { 18, 18362, "", "=q3=Holy Bologna: What the Light Won't Tell You", "=ds=#m3#", "", "5.00%" };
    { 19, 18363, "", "=q3=Frost Shock and You", "=ds=#m3#", "", "5.00%" };
    { 20, 18364, "", "=q3=The Emerald Dream", "=ds=#m3#", "", "5.00%" };
    { 21, 18401, "", "=q4=Foror's Compendium of Dragon Slaying", "=ds=#m3#", "", "5.00%" };
    { 22, 69842, "", "=q4=Barbarous Blade", "=ds=#w10#", "", "5.00%" };
    { 23, 69843, "", "=q4=Grimy Metal Boots", "=ds=#a4#", "", "5.00%" };
    { 24, 69844, "", "=q4=Band of the Ogre King", "=ds=#s13#", "", "5.00%" };
    { 25, 69845, "", "=q4=Brightly Glowing Stone", "=ds=#s15#", "", "5.00%" };
    { 26, 69846, "", "=q4=Leggings of Destruction", "=ds=#a3#", "", "5.00%" };
    { 27, 69847, "", "=q4=Bracers of Prosperity", "=ds=#a2#", "", "5.00%" };
    { 28, 69848, "", "=q4=Crown of the Ogre King", "=ds=#a1#", "", "5.00%" };
    { 29, 69849, "", "=q4=Harmonious Gauntlets", "=ds=#a3#", "", "5.00%" };
	};

	AtlasLoot_Data["DMNKingGordokHEROIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Heroic King Gordok", "=q5=ALL WILL DROP"};
    { 2, 58718, "", "=q1=Gordok's Skull Goblet", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Heroic King Gordok", "=q5=CHANCE TO DROP"};
    { 5, 21982, "", "=q1=Ogre Warbeads", "=ds=#m3#", "", "80.0%" };
    { 6, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 8, 59084, "", "=q3=Totem of Tribal Bonds", "", "", "10.0%" };
    { 10, 0, "AO_Unknown", "=q6=Heroic King Gordok", "=q5=ONE WILL DROP"};
    { 11, 57101, "", "=q4=Formula: Nexus Shard", "=ds=#e2#", "", "10.0%" };
    { 12, 18356, "", "=q3=Garona: A Study on Stealth and Treachery", "=ds=#m3#", "", "5.00%" };
    { 13, 18357, "", "=q3=Codex of Defense", "=ds=#m3#", "", "5.00%" };
    { 14, 18358, "", "=q3=The Arcanist's Cookbook", "=ds=#m3#", "", "5.00%" };
    ...
    { 20, 18364, "", "=q3=The Emerald Dream", "=ds=#m3#", "", "5.00%" };
    { 21, 18401, "", "=q4=Foror's Compendium of Dragon Slaying", "=ds=#m3#", "", "5.00%" };
    { 22, 66842, "", "=q4=Barbarous Blade", "=ds=#w10#", "", "5.00%" };
    { 23, 66843, "", "=q4=Grimy Metal Boots", "=ds=#a4#", "", "5.00%" };
    { 24, 66844, "", "=q4=Band of the Ogre King", "=ds=#s13#", "", "5.00%" };
    { 25, 66845, "", "=q4=Brightly Glowing Stone", "=ds=#s15#", "", "5.00%" };
    { 26, 66846, "", "=q4=Leggings of Destruction", "=ds=#a3#", "", "5.00%" };
    { 27, 66847, "", "=q4=Bracers of Prosperity", "=ds=#a2#", "", "5.00%" };
    { 28, 66848, "", "=q4=Crown of the Ogre King", "=ds=#a1#", "", "5.00%" };
    { 29, 66849, "", "=q4=Harmonious Gauntlets", "=ds=#a3#", "", "5.00%" };
	};
    ...
    { 1, 0, "RoM_stellar_dice", "=q6=Tendris Warpwood", "=q5=CHANCE TO DROP"};
    { 2, 59085, "", "=q3=Idol of the Eldreth", "", "", "10.0%" };
    { 4, 0, "AO_Unknown", "=q6=Tendris Warpwood", "=q5=ONE WILL DROP"};
    { 5, 18352, "", "=q2=Petrified Bark Shield", "=ds=#w8#", "", "25.0%" };
    { 6, 18353, "", "=q2=Stoneflower Staff", "=ds=#w9#", "", "25.0%" };
    { 7, 18390, "", "=q3=Tanglemoss Leggings", "=ds=#a2#", "", "25.0%" };
    { 8, 18393, "", "=q3=Warpwood Binding", "=ds=#a3#", "", "25.0%" };
	};

	AtlasLoot_Data["DMWTendrisWarpwoodMYTHIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Mythic Tendris Warpwood", "=q5=CHANCE TO DROP"};
    { 2, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 59085, "", "=q3=Idol of the Eldreth", "", "", "10.0%" };
    { 16, 0, "AO_Unknown", "=q6=Mythic Tendris Warpwood", "=q5=ONE WILL DROP"};
    { 17, 18356, "", "=q3=Garona: A Study on Stealth and Treachery", "=ds=#m3#", "", "7.14%" };
    { 18, 18357, "", "=q3=Codex of Defense", "=ds=#m3#", "", "7.14%" };
    { 19, 18358, "", "=q3=The Arcanist's Cookbook", "=ds=#m3#", "", "7.14%" };
    { 20, 18359, "", "=q3=The Light and How to Swing It", "=ds=#m3#", "", "7.14%" };
    ...
    { 25, 18364, "", "=q3=The Emerald Dream", "=ds=#m3#", "", "7.14%" };
    { 26, 18401, "", "=q4=Foror's Compendium of Dragon Slaying", "=ds=#m3#", "", "7.14%" };
    { 27, 69788, "", "=q4=Petrified Bark Shield", "=ds=#w8#", "", "7.14%" };
    { 28, 69789, "", "=q4=Stoneflower Staff", "=ds=#w9#", "", "7.14%" };
    { 29, 69809, "", "=q4=Tanglemoss Leggings", "=ds=#a2#", "", "7.14%" };
    { 30, 69812, "", "=q4=Warpwood Binding", "=ds=#a3#", "", "7.14%" };
	};

	AtlasLoot_Data["DMWTendrisWarpwoodHEROIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Heroic Tendris Warpwood", "=q5=CHANCE TO DROP"};
    { 2, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 59085, "", "=q3=Idol of the Eldreth", "", "", "10.0%" };
    { 16, 0, "AO_Unknown", "=q6=Heroic Tendris Warpwood", "=q5=ONE WILL DROP"};
    { 17, 18356, "", "=q3=Garona: A Study on Stealth and Treachery", "=ds=#m3#", "", "7.14%" };
    { 18, 18357, "", "=q3=Codex of Defense", "=ds=#m3#", "", "7.14%" };
    { 19, 18358, "", "=q3=The Arcanist's Cookbook", "=ds=#m3#", "", "7.14%" };
    { 20, 18359, "", "=q3=The Light and How to Swing It", "=ds=#m3#", "", "7.14%" };
    ...
    { 25, 18364, "", "=q3=The Emerald Dream", "=ds=#m3#", "", "7.14%" };
    { 26, 18401, "", "=q4=Foror's Compendium of Dragon Slaying", "=ds=#m3#", "", "7.14%" };
    { 27, 66788, "", "=q4=Petrified Bark Shield", "=ds=#w8#", "", "7.14%" };
    { 28, 66789, "", "=q4=Stoneflower Staff", "=ds=#w9#", "", "7.14%" };
    { 29, 66809, "", "=q4=Tanglemoss Leggings", "=ds=#a2#", "", "7.14%" };
    { 30, 66812, "", "=q4=Warpwood Binding", "=ds=#a3#", "", "7.14%" };
	};
	...
	AtlasLoot_Data["DMWIllyannaRavenoakMYTHIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Mythic Illyanna Ravenoak", "=q5=CHANCE TO DROP"};
    { 2, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 16, 0, "AO_Unknown", "=q6=Mythic Illyanna Ravenoak", "=q5=ONE WILL DROP"};
    { 17, 18356, "", "=q3=Garona: A Study on Stealth and Treachery", "=ds=#m3#", "", "7.14%" };
    { 18, 18357, "", "=q3=Codex of Defense", "=ds=#m3#", "", "7.14%" };
    { 19, 18358, "", "=q3=The Arcanist's Cookbook", "=ds=#m3#", "", "7.14%" };
    { 20, 18359, "", "=q3=The Light and How to Swing It", "=ds=#m3#", "", "7.14%" };
    ...
    { 25, 18364, "", "=q3=The Emerald Dream", "=ds=#m3#", "", "7.14%" };
    { 26, 18401, "", "=q4=Foror's Compendium of Dragon Slaying", "=ds=#m3#", "", "7.14%" };
    { 27, 69784, "", "=q4=Well Balanced Axe", "=ds=#w1#", "", "7.14%" };
    { 28, 69785, "", "=q4=Gauntlets of Accuracy", "=ds=#a3#", "", "7.14%" };
    { 29, 69802, "", "=q4=Force Imbued Gauntlets", "=ds=#a4#", "", "7.14%" };
    { 30, 69805, "", "=q4=Padre's Trousers", "=ds=#a1#", "", "7.14%" };
	};

	AtlasLoot_Data["DMWIllyannaRavenoakHEROIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Heroic Illyanna Ravenoak", "=q5=CHANCE TO DROP"};
    { 2, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 16, 0, "AO_Unknown", "=q6=Heroic Illyanna Ravenoak", "=q5=ONE WILL DROP"};
    { 17, 18356, "", "=q3=Garona: A Study on Stealth and Treachery", "=ds=#m3#", "", "7.14%" };
    { 18, 18357, "", "=q3=Codex of Defense", "=ds=#m3#", "", "7.14%" };
    { 19, 18358, "", "=q3=The Arcanist's Cookbook", "=ds=#m3#", "", "7.14%" };
    { 20, 18359, "", "=q3=The Light and How to Swing It", "=ds=#m3#", "", "7.14%" };
    ...
    { 25, 18364, "", "=q3=The Emerald Dream", "=ds=#m3#", "", "7.14%" };
    { 26, 18401, "", "=q4=Foror's Compendium of Dragon Slaying", "=ds=#m3#", "", "7.14%" };
    { 27, 66784, "", "=q4=Well Balanced Axe", "=ds=#w1#", "", "7.14%" };
    { 28, 66785, "", "=q4=Gauntlets of Accuracy", "=ds=#a3#", "", "7.14%" };
    { 29, 66802, "", "=q4=Force Imbued Gauntlets", "=ds=#a4#", "", "7.14%" };
    { 30, 66805, "", "=q4=Padre's Trousers", "=ds=#a1#", "", "7.14%" };
	};

	AtlasLoot_Data["DMWMagisterKalendris"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Magister Kalendris", "=q5=CHANCE TO DROP"};
    { 2, 22309, "", "=q2=Pattern: Big Bag of Enchantment", "=ds=#e2#", "", "15.0%" };
    { 4, 0, "AO_Unknown", "=q6=Magister Kalendris", "=q5=ONE WILL DROP"};
    { 5, 18350, "", "=q2=Amplifying Cloak", "=ds=#a1#", "", "25.5%" };
    { 6, 18351, "", "=q2=Magically Sealed Bracers", "=ds=#a4#", "", "25.5%" };
    { 7, 18374, "", "=q3=Flamescarred Shoulders", "=ds=#a2#", "", "20.0%" };
    { 8, 18397, "", "=q3=Elder Magus Pendant", "=ds=#s2#", "", "20.0%" };
    { 9, 18371, "", "=q3=Mindtap Talisman", "=ds=#s14#", "", "9.00%" };
	};
	AtlasLoot_Data["DMWMagisterKalendrisMYTHIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Mythic Magister Kalendris", "=q5=CHANCE TO DROP"};
    { 2, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 22309, "", "=q2=Pattern: Big Bag of Enchantment", "=ds=#e2#", "", "15.0%" };
    { 6, 0, "AO_Unknown", "=q6=Mythic Magister Kalendris", "=q5=ONE WILL DROP"};
    { 7, 69794, "", "=q4=Flamescarred Shoulders", "=ds=#a2#", "", "20.0%" };
    { 8, 69816, "", "=q4=Elder Magus Pendant", "=ds=#s2#", "", "20.0%" };
    { 9, 69791, "", "=q4=Mindtap Talisman", "=ds=#s14#", "", "9.00%" };
    { 10, 18356, "", "=q3=Garona: A Study on Stealth and Treachery", "=ds=#m3#", "", "4.25%" };
    { 11, 18357, "", "=q3=Codex of Defense", "=ds=#m3#", "", "4.25%" };
    { 12, 18358, "", "=q3=The Arcanist's Cookbook", "=ds=#m3#", "", "4.25%" };
    { 13, 18359, "", "=q3=The Light and How to Swing It", "=ds=#m3#", "", "4.25%" };
    { 14, 18360, "", "=q3=Harnessing Shadows", "=ds=#m3#", "", "4.25%" };
    { 15, 18361, "", "=q3=The Greatest Race of Hunters", "=ds=#m3#", "", "4.25%" };
    { 16, 18362, "", "=q3=Holy Bologna: What the Light Won't Tell You", "=ds=#m3#", "", "4.25%" };
    { 17, 18363, "", "=q3=Frost Shock and You", "=ds=#m3#", "", "4.25%" };
    { 18, 18364, "", "=q3=The Emerald Dream", "=ds=#m3#", "", "4.25%" };
    { 19, 18401, "", "=q4=Foror's Compendium of Dragon Slaying", "=ds=#m3#", "", "4.25%" };
    { 20, 69786, "", "=q4=Amplifying Cloak", "=ds=#a1#", "", "4.25%" };
    { 21, 69787, "", "=q4=Magically Sealed Bracers", "=ds=#a4#", "", "4.25%" };
	};

	AtlasLoot_Data["DMWMagisterKalendrisHEROIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Heroic Magister Kalendris", "=q5=CHANCE TO DROP"};
    { 2, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 22309, "", "=q2=Pattern: Big Bag of Enchantment", "=ds=#e2#", "", "15.0%" };
    { 6, 0, "AO_Unknown", "=q6=Heroic Magister Kalendris", "=q5=ONE WILL DROP"};
    { 7, 66794, "", "=q4=Flamescarred Shoulders", "=ds=#a2#", "", "20.0%" };
    { 8, 66816, "", "=q4=Elder Magus Pendant", "=ds=#s2#", "", "20.0%" };
    { 9, 66791, "", "=q4=Mindtap Talisman", "=ds=#s14#", "", "9.00%" };
    { 10, 18356, "", "=q3=Garona: A Study on Stealth and Treachery", "=ds=#m3#", "", "4.25%" };
    { 11, 18357, "", "=q3=Codex of Defense", "=ds=#m3#", "", "4.25%" };
    { 12, 18358, "", "=q3=The Arcanist's Cookbook", "=ds=#m3#", "", "4.25%" };
    { 13, 18359, "", "=q3=The Light and How to Swing It", "=ds=#m3#", "", "4.25%" };
    ...
    { 18, 18364, "", "=q3=The Emerald Dream", "=ds=#m3#", "", "4.25%" };
    { 19, 18401, "", "=q4=Foror's Compendium of Dragon Slaying", "=ds=#m3#", "", "4.25%" };
    { 20, 66786, "", "=q4=Amplifying Cloak", "=ds=#a1#", "", "4.25%" };
    { 21, 66787, "", "=q4=Magically Sealed Bracers", "=ds=#a4#", "", "4.25%" };
	};
	...
	AtlasLoot_Data["DMWTsuzeeMYTHIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Mythic Tsu'zee", "=q5=CHANCE TO DROP"};
    { 2, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 5, 0, "AO_Unknown", "=q6=Mythic Tsu'zee", "=q5=ONE WILL DROP"};
    { 6, 18345, "", "=q2=Murmuring Ring", "=ds=#s13#", "", "33.3%" };
    { 7, 18346, "", "=q2=Threadbare Trousers", "=ds=#a1#", "", "33.3%" };
    { 8, 69806, "", "=q4=Brightspark Gloves", "=ds=#a1#", "", "33.3%" };
	};

	AtlasLoot_Data["DMWTsuzeeHEROIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Heroic Tsu'zee", "=q5=CHANCE TO DROP"};
    { 2, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 5, 0, "AO_Unknown", "=q6=Heroic Tsu'zee", "=q5=ONE WILL DROP"};
    { 6, 18345, "", "=q2=Murmuring Ring", "=ds=#s13#", "", "33.3%" };
    { 7, 18346, "", "=q2=Threadbare Trousers", "=ds=#a1#", "", "33.3%" };
    { 8, 66806, "", "=q4=Brightspark Gloves", "=ds=#a1#", "", "33.3%" };
	};

	AtlasLoot_Data["DMWImmolthar"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Immol'thar", "=q5=ALL WILL DROP"};
    { 2, 58717, "", "=q1=Immol'thar's Fel Essence", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Immol'thar", "=q5=CHANCE TO DROP"};
    { 5, 24345, "", "=q3=Book of Cower IV", "=ds=#e2#", "", "13.0%" };
    { 16, 0, "AO_Unknown", "=q6=Immol'thar", "=q5=ONE WILL DROP"};
	...
	AtlasLoot_Data["DMWImmoltharMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Immol'thar", "=q5=ALL WILL DROP"};
    { 2, 58717, "", "=q1=Immol'thar's Fel Essence", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Mythic Immol'thar", "=q5=CHANCE TO DROP"};
    { 5, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 24345, "", "=q3=Book of Cower IV", "=ds=#e2#", "", "13.0%" };
    { 9, 0, "AO_Unknown", "=q6=Mythic Immol'thar", "=q5=ONE WILL DROP"};
    { 10, 18356, "", "=q3=Garona: A Study on Stealth and Treachery", "=ds=#m3#", "", "5.00%" };
    { 11, 18357, "", "=q3=Codex of Defense", "=ds=#m3#", "", "5.00%" };
    { 12, 18358, "", "=q3=The Arcanist's Cookbook", "=ds=#m3#", "", "5.00%" };
    { 13, 18359, "", "=q3=The Light and How to Swing It", "=ds=#m3#", "", "5.00%" };
    { 14, 18360, "", "=q3=Harnessing Shadows", "=ds=#m3#", "", "5.00%" };
    { 15, 18361, "", "=q3=The Greatest Race of Hunters", "=ds=#m3#", "", "5.00%" };
    { 16, 18362, "", "=q3=Holy Bologna: What the Light Won't Tell You", "=ds=#m3#", "", "5.00%" };
    { 17, 18363, "", "=q3=Frost Shock and You", "=ds=#m3#", "", "5.00%" };
    { 18, 18364, "", "=q3=The Emerald Dream", "=ds=#m3#", "", "5.00%" };
    { 19, 18401, "", "=q4=Foror's Compendium of Dragon Slaying", "=ds=#m3#", "", "5.00%" };
    { 20, 69790, "", "=q4=Vigilance Charm", "=ds=#s14#", "", "5.00%" };
    { 21, 69792, "", "=q4=Blade of the New Moon", "=ds=#w4#", "", "5.00%" };
    { 22, 69797, "", "=q4=Quickdraw Gloves", "=ds=#a2#", "", "5.00%" };
    { 23, 69799, "", "=q4=Odious Greaves", "=ds=#a3#", "", "5.00%" };
    { 24, 69801, "", "=q4=Evil Eye Pendant", "=ds=#s2#", "", "5.00%" };
    { 25, 69803, "", "=q4=Bile-etched Spaulders", "=ds=#a4#", "", "5.00%" };
    { 26, 69804, "", "=q4=Robe of Everlasting Night", "=ds=#a1#", "", "5.00%" };
    { 27, 69808, "", "=q4=Cloak of the Cosmos", "=ds=#a1#", "", "5.00%" };
    { 28, 69810, "", "=q4=Eyestalk Cord", "=ds=#a2#", "", "5.00%" };
    { 29, 69813, "", "=q4=Demon Howl Wristguards", "=ds=#a3#", "", "5.00%" };
	};

	AtlasLoot_Data["DMWImmoltharHEROIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Heroic Immol'thar", "=q5=ALL WILL DROP"};
    { 2, 58717, "", "=q1=Immol'thar's Fel Essence", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Heroic Immol'thar", "=q5=CHANCE TO DROP"};
    { 5, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 24345, "", "=q3=Book of Cower IV", "=ds=#e2#", "", "13.0%" };
    { 9, 0, "AO_Unknown", "=q6=Heroic Immol'thar", "=q5=ONE WILL DROP"};
    { 10, 18356, "", "=q3=Garona: A Study on Stealth and Treachery", "=ds=#m3#", "", "5.00%" };
    { 11, 18357, "", "=q3=Codex of Defense", "=ds=#m3#", "", "5.00%" };
    { 12, 18358, "", "=q3=The Arcanist's Cookbook", "=ds=#m3#", "", "5.00%" };
    { 13, 18359, "", "=q3=The Light and How to Swing It", "=ds=#m3#", "", "5.00%" };
    ...
    { 18, 18364, "", "=q3=The Emerald Dream", "=ds=#m3#", "", "5.00%" };
    { 19, 18401, "", "=q4=Foror's Compendium of Dragon Slaying", "=ds=#m3#", "", "5.00%" };
    { 20, 66790, "", "=q4=Vigilance Charm", "=ds=#s14#", "", "5.00%" };
    { 21, 66792, "", "=q4=Blade of the New Moon", "=ds=#w4#", "", "5.00%" };
    { 22, 66797, "", "=q4=Quickdraw Gloves", "=ds=#a2#", "", "5.00%" };
    { 23, 66799, "", "=q4=Odious Greaves", "=ds=#a3#", "", "5.00%" };
    { 24, 66801, "", "=q4=Evil Eye Pendant", "=ds=#s2#", "", "5.00%" };
    { 25, 66803, "", "=q4=Bile-etched Spaulders", "=ds=#a4#", "", "5.00%" };
    { 26, 66804, "", "=q4=Robe of Everlasting Night", "=ds=#a1#", "", "5.00%" };
    { 27, 66808, "", "=q4=Cloak of the Cosmos", "=ds=#a1#", "", "5.00%" };
    { 28, 66810, "", "=q4=Eyestalk Cord", "=ds=#a2#", "", "5.00%" };
    { 29, 66813, "", "=q4=Demon Howl Wristguards", "=ds=#a3#", "", "5.00%" };
	};
	...
	AtlasLoot_Data["DMWHelnurathMYTHIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Mythic Lord Hel'nurath", "=q5=CHANCE TO DROP"};
    { 2, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 5, 0, "AO_Unknown", "=q6=Mythic Lord Hel'nurath", "=q5=ONE WILL DROP"};
    { 6, 69885, "", "=q4=Fel Hardened Bracers", "=ds=#a4#", "", "25.0%" };
    { 7, 69886, "", "=q4=Xorothian Firestick", "=ds=#w5#", "", "25.0%" };
    { 8, 69887, "", "=q4=Dreadguard's Protector", "=ds=#w8#", "", "25.0%" };
    { 9, 69888, "", "=q4=Diabolic Mantle", "=ds=#a1#", "", "25.0%" };
	};

	AtlasLoot_Data["DMWHelnurathHEROIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Heroic Lord Hel'nurath", "=q5=CHANCE TO DROP"};
    { 2, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 5, 0, "AO_Unknown", "=q6=Heroic Lord Hel'nurath", "=q5=ONE WILL DROP"};
    { 6, 66885, "", "=q4=Fel Hardened Bracers", "=ds=#a4#", "", "25.0%" };
    { 7, 66886, "", "=q4=Xorothian Firestick", "=ds=#w5#", "", "25.0%" };
    { 8, 66887, "", "=q4=Dreadguard's Protector", "=ds=#w8#", "", "25.0%" };
    { 9, 66888, "", "=q4=Diabolic Mantle", "=ds=#a1#", "", "25.0%" };
	};

	AtlasLoot_Data["DMWPrinceTortheldrin"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Prince Tortheldrin", "=q5=CHANCE TO DROP"};
    { 2, 59086, "", "=q3=Libram of Athenaeum Light", "", "", "10.0%" };
    { 4, 0, "AO_Unknown", "=q6=Prince Tortheldrin", "=q5=ONE WILL DROP"};
    { 5, 18373, "", "=q3=Chestplate of Tranquility", "=ds=#a2#", "", "10.0%" };
    { 6, 18375, "", "=q3=Bracers of the Eclipse", "=ds=#a2#", "", "10.0%" };
    { 7, 18376, "", "=q3=Timeworn Mace", "=ds=#w6#", "", "10.0%" };
    { 8, 18378, "", "=q3=Silvermoon Leggings", "=ds=#a3#", "", "10.0%" };
    { 9, 18380, "", "=q3=Eldritch Reinforced Legplates", "=ds=#a4#", "", "10.0%" };
    { 10, 18382, "", "=q3=Fluctuating Cloak", "=ds=#a1#", "", "10.0%" };
    { 11, 18388, "", "=q3=Stoneshatter", "=ds=#w3#", "", "10.0%" };
    { 12, 18392, "", "=q3=Distracting Dagger", "=ds=#w4#", "", "10.0%" };
    { 13, 18395, "", "=q3=Emerald Flame Ring", "=ds=#s13#", "", "10.0%" };
    { 14, 18396, "", "=q3=Mind Carver", "=ds=#w10#", "", "10.0%" };
	};

	AtlasLoot_Data["DMWPrinceTortheldrinMYTHIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Mythic Prince Tortheldrin", "=q5=CHANCE TO DROP"};
    { 2, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 59086, "", "=q3=Libram of Athenaeum Light", "", "", "10.0%" };
    { 6, 0, "AO_Unknown", "=q6=Mythic Prince Tortheldrin", "=q5=ONE WILL DROP"};
    { 7, 18382, "", "=q3=Fluctuating Cloak", "=ds=#a1#", "", "10.0%" };
    { 8, 69793, "", "=q4=Chestplate of Tranquility", "=ds=#a2#", "", "10.0%" };
    { 9, 69795, "", "=q4=Bracers of the Eclipse", "=ds=#a2#", "", "10.0%" };
    { 10, 69796, "", "=q4=Timeworn Mace", "=ds=#w6#", "", "10.0%" };
    { 11, 69798, "", "=q4=Silvermoon Leggings", "=ds=#a3#", "", "10.0%" };
    { 12, 69800, "", "=q4=Eldritch Reinforced Legplates", "=ds=#a4#", "", "10.0%" };
    { 13, 69807, "", "=q4=Stoneshatter", "=ds=#w3#", "", "10.0%" };
    { 14, 69811, "", "=q4=Distracting Dagger", "=ds=#w4#", "", "10.0%" };
    { 15, 69814, "", "=q4=Emerald Flame Ring", "=ds=#s13#", "", "10.0%" };
    { 16, 69815, "", "=q4=Mind Carver", "=ds=#w10#", "", "10.0%" };
	};

	AtlasLoot_Data["DMWPrinceTortheldrinHEROIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Heroic Prince Tortheldrin", "=q5=CHANCE TO DROP"};
    { 2, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 59086, "", "=q3=Libram of Athenaeum Light", "", "", "10.0%" };
    { 6, 0, "AO_Unknown", "=q6=Heroic Prince Tortheldrin", "=q5=ONE WILL DROP"};
    { 7, 18382, "", "=q3=Fluctuating Cloak", "=ds=#a1#", "", "10.0%" };
    { 8, 66793, "", "=q4=Chestplate of Tranquility", "=ds=#a2#", "", "10.0%" };
    { 9, 66795, "", "=q4=Bracers of the Eclipse", "=ds=#a2#", "", "10.0%" };
    { 10, 66796, "", "=q4=Timeworn Mace", "=ds=#w6#", "", "10.0%" };
    { 11, 66798, "", "=q4=Silvermoon Leggings", "=ds=#a3#", "", "10.0%" };
    { 12, 66800, "", "=q4=Eldritch Reinforced Legplates", "=ds=#a4#", "", "10.0%" };
    { 13, 66807, "", "=q4=Stoneshatter", "=ds=#w3#", "", "10.0%" };
    { 14, 66811, "", "=q4=Distracting Dagger", "=ds=#w4#", "", "10.0%" };
    { 15, 66814, "", "=q4=Emerald Flame Ring", "=ds=#s13#", "", "10.0%" };
    { 16, 66815, "", "=q4=Mind Carver", "=ds=#w10#", "", "10.0%" };
	};
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6=Techbot", "=q5=ALL WILL DROP"};
    { 2, 9277, "", "=q1=Techbot's Memory Core", "=ds=#m3#", "", "100%" };
    { 3, 9309, "", "=q1=Robo-mechanical Guts", "=ds=#m3#", "", "100%" };
    { 5, 0, "RoM_stellar_dice", "=q6=Techbot", "=q5=CHANCE TO DROP"};
    { 6, 9444, "", "=q2=Techbot CPU Shell", "=ds=#w8#", "", "69.2%" };
    { 7, 17, "", "=q6=Martin Fury", "=ds=#a4#", "", "" };
	};

	AtlasLoot_Data["GnomeGrubbis"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Grubbis", "=q5=CHANCE TO DROP"};
    { 2, 9445, "", "=q3=Grubbis Paws", "=ds=#a3#", "", "10.0%" };
	};

	AtlasLoot_Data["GnomeGrubbisMYTHIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Mythic Grubbis", "=q5=CHANCE TO DROP"};
    { 2, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 69435, "", "=q4=Grubbis Paws", "=ds=#a3#", "", "10.0%" };
	};

	AtlasLoot_Data["GnomeGrubbisHEROIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Heroic Grubbis", "=q5=CHANCE TO DROP"};
    { 2, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 66435, "", "=q4=Grubbis Paws", "=ds=#a3#", "", "10.0%" };
	};

	AtlasLoot_Data["GnomeViscousFallout"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Viscous Fallout", "=q5=CHANCE TO DROP"};
    { 2, 57457, "", "=q1=Technique: Scroll of Fire Resistance III", "=ds=#e2#", "", "15.0%" };
    { 3, 17, "", "=q6=Martin Fury", "=ds=#a4#", "", "" };
	...
	AtlasLoot_Data["GnomeViscousFalloutMYTHIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Mythic Viscous Fallout", "=q5=CHANCE TO DROP"};
    { 2, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 57457, "", "=q1=Technique: Scroll of Fire Resistance III", "=ds=#e2#", "", "15.0%" };
    { 16, 0, "AO_Unknown", "=q6=Mythic Viscous Fallout", "=q5=ONE WILL DROP"};
    { 17, 9452, "", "=q3=Hydrocane", "=ds=#w9#", "", "7.69%" };
    { 18, 9453, "", "=q3=Toxic Revenger", "=ds=#w4#", "", "7.69%" };
    { 19, 9485, "", "=q3=Vibroblade", "=ds=#w1#", "", "7.69%" };
    { 20, 9486, "", "=q3=Supercharger Battle Axe", "=ds=#w1#", "", "7.69%" };
    { 21, 9487, "", "=q3=Hi-tech Supergun", "=ds=#w5#", "", "7.69%" };
    { 22, 9488, "", "=q3=Oscillating Power Hammer", "=ds=#w6#", "", "7.69%" };
    { 23, 9490, "", "=q3=Gizmotron Megachopper", "=ds=#w10#", "", "7.69%" };
    { 24, 9491, "", "=q3=Hotshot Pilot's Gloves", "=ds=#a1#", "", "7.69%" };
    { 25, 9508, "", "=q3=Mechbuilder's Overalls", "=ds=#a1#", "", "7.69%" };
    { 26, 9509, "", "=q3=Petrolspill Leggings", "=ds=#a2#", "", "7.69%" };
    { 27, 9510, "", "=q3=Caverndeep Trudgers", "=ds=#a3#", "", "7.69%" };
    { 28, 69439, "", "=q4=Acidic Walkers", "=ds=#a1#", "", "7.69%" };
    { 29, 69451, "", "=q4=Gyromatic Icemaker", "=ds=#w12#", "", "7.69%" };
	};

	AtlasLoot_Data["GnomeViscousFalloutHEROIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Heroic Viscous Fallout", "=q5=CHANCE TO DROP"};
    { 2, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 57457, "", "=q1=Technique: Scroll of Fire Resistance III", "=ds=#e2#", "", "15.0%" };
    { 16, 0, "AO_Unknown", "=q6=Heroic Viscous Fallout", "=q5=ONE WILL DROP"};
    { 17, 9452, "", "=q3=Hydrocane", "=ds=#w9#", "", "7.69%" };
    { 18, 9453, "", "=q3=Toxic Revenger", "=ds=#w4#", "", "7.69%" };
    { 19, 9485, "", "=q3=Vibroblade", "=ds=#w1#", "", "7.69%" };
    { 20, 9486, "", "=q3=Supercharger Battle Axe", "=ds=#w1#", "", "7.69%" };
    ...
    { 26, 9509, "", "=q3=Petrolspill Leggings", "=ds=#a2#", "", "7.69%" };
    { 27, 9510, "", "=q3=Caverndeep Trudgers", "=ds=#a3#", "", "7.69%" };
    { 28, 66439, "", "=q4=Acidic Walkers", "=ds=#a1#", "", "7.69%" };
    { 29, 66451, "", "=q4=Gyromatic Icemaker", "=ds=#w12#", "", "7.69%" };
	};
    ...
    { 3, 9447, "", "=q3=Electrocutioner Lagnut", "=ds=#s13#", "", "33.3%" };
    { 4, 9448, "", "=q3=Spidertank Oilrag", "=ds=#a1#", "", "33.3%" };
	};

	AtlasLoot_Data["GnomeElectrocutionerMYTHIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Mythic Electrocutioner 6000", "=q5=CHANCE TO DROP"};
    { 2, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 5, 0, "AO_Unknown", "=q6=Mythic Electrocutioner 6000", "=q5=ONE WILL DROP"};
    { 6, 9446, "", "=q3=Electrocutioner Leg", "=ds=#w10#", "", "33.3%" };
    { 7, 69436, "", "=q4=Electrocutioner Lagnut", "=ds=#s13#", "", "33.3%" };
    { 8, 69437, "", "=q4=Spidertank Oilrag", "=ds=#a1#", "", "33.3%" };
	};

	AtlasLoot_Data["GnomeElectrocutionerHEROIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Heroic Electrocutioner 6000", "=q5=CHANCE TO DROP"};
    { 2, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 5, 0, "AO_Unknown", "=q6=Heroic Electrocutioner 6000", "=q5=ONE WILL DROP"};
    { 6, 9446, "", "=q3=Electrocutioner Leg", "=ds=#w10#", "", "33.3%" };
    { 7, 66436, "", "=q4=Electrocutioner Lagnut", "=ds=#s13#", "", "33.3%" };
    { 8, 66437, "", "=q4=Spidertank Oilrag", "=ds=#a1#", "", "33.3%" };
	};

	AtlasLoot_Data["GnomeCrowdPummeler"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Crowd Pummeler 9-60", "=q5=CHANCE TO DROP"};
    { 2, 11827, "", "=q1=Schematic: Lil' Smoky", "=ds=#e2#", "", "50.0%" };
    { 3, 59049, "", "=q3=Searing Totem of Embers", "", "", "10.0%" };
    { 5, 0, "AO_Unknown", "=q6=Crowd Pummeler 9-60", "=q5=ONE WILL DROP"};
    { 6, 9450, "", "=q3=Gnomebot Operating Boots", "=ds=#a2#", "", "60.0%" };
    { 7, 9449, "", "=q3=Manual Crowd Pummeler", "=ds=#w6#", "", "40.0%" };
	};

	AtlasLoot_Data["GnomeCrowdPummelerMYTHIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Mythic Crowd Pummeler 9-60", "=q5=CHANCE TO DROP"};
    { 2, 11827, "", "=q1=Schematic: Lil' Smoky", "=ds=#e2#", "", "50.0%" };
    { 3, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 5, 59049, "", "=q3=Searing Totem of Embers", "", "", "10.0%" };
    { 7, 0, "AO_Unknown", "=q6=Mythic Crowd Pummeler 9-60", "=q5=ONE WILL DROP"};
    { 8, 69438, "", "=q4=Gnomebot Operating Boots", "=ds=#a2#", "", "60.0%" };
    { 9, 9449, "", "=q3=Manual Crowd Pummeler", "=ds=#w6#", "", "40.0%" };
	};

	AtlasLoot_Data["GnomeCrowdPummelerHEROIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Heroic Crowd Pummeler 9-60", "=q5=CHANCE TO DROP"};
    { 2, 11827, "", "=q1=Schematic: Lil' Smoky", "=ds=#e2#", "", "50.0%" };
    { 3, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 5, 59049, "", "=q3=Searing Totem of Embers", "", "", "10.0%" };
    { 7, 0, "AO_Unknown", "=q6=Heroic Crowd Pummeler 9-60", "=q5=ONE WILL DROP"};
    { 8, 66438, "", "=q4=Gnomebot Operating Boots", "=ds=#a2#", "", "60.0%" };
    { 9, 9449, "", "=q3=Manual Crowd Pummeler", "=ds=#w6#", "", "40.0%" };
	};

	AtlasLoot_Data["GnomeDarkIronAmbassador"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Dark Iron Ambassador", "=q5=CHANCE TO DROP"};
    { 2, 17, "", "=q6=Martin Fury", "=ds=#a4#", "", "" };
    { 4, 0, "AO_Unknown", "=q6=Dark Iron Ambassador", "=q5=ONE WILL DROP"};
    { 5, 9455, "", "=q3=Emissary Cuffs", "=ds=#a2#", "", "33.3%" };
    { 6, 9456, "", "=q3=Glass Shooter", "=ds=#w5#", "", "33.3%" };
    { 7, 9457, "", "=q3=Royal Diplomatic Scepter", "=ds=#w6#", "", "33.3%" };
	};

	AtlasLoot_Data["GnomeThermaplugg"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mekgineer Thermaplugg", "=q5=ALL WILL DROP"};
    { 2, 58708, "", "=q1=Plugg Nuts", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Mekgineer Thermaplugg", "=q5=CHANCE TO DROP"};
    { 5, 59050, "", "=q3=Libram of Mechanized Faith", "", "", "10.0%" };
    { 6, 11828, "", "=q1=Schematic: Pet Bombling", "=ds=#e2#", "", "90.0%" };
    { 8, 0, "AO_Unknown", "=q6=Mekgineer Thermaplugg", "=q5=ONE WILL DROP"};
    { 9, 9458, "", "=q3=Thermaplugg's Central Core", "=ds=#w8#", "", "30.0%" };
    { 10, 9461, "", "=q3=Charged Gear", "=ds=#s13#", "", "30.0%" };
    { 11, 9459, "", "=q3=Thermaplugg's Left Arm", "=ds=#w1#", "", "20.0%" };
    { 12, 9492, "", "=q3=Electromagnetic Gigaflux Reactivator", "=ds=#a1#", "", "20.0%" };
	};

	AtlasLoot_Data["GnomeThermapluggMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Mekgineer Thermaplugg", "=q5=ALL WILL DROP"};
    { 2, 58708, "", "=q1=Plugg Nuts", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Mythic Mekgineer Thermaplugg", "=q5=CHANCE TO DROP"};
    { 5, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 59050, "", "=q3=Libram of Mechanized Faith", "", "", "10.0%" };
    { 8, 11828, "", "=q1=Schematic: Pet Bombling", "=ds=#e2#", "", "90.0%" };
    { 10, 0, "AO_Unknown", "=q6=Mythic Mekgineer Thermaplugg", "=q5=ONE WILL DROP"};
    { 11, 9458, "", "=q3=Thermaplugg's Central Core", "=ds=#w8#", "", "30.0%" };
    { 12, 69444, "", "=q4=Charged Gear", "=ds=#s13#", "", "30.0%" };
    { 13, 9492, "", "=q3=Electromagnetic Gigaflux Reactivator", "=ds=#a1#", "", "20.0%" };
    { 14, 69443, "", "=q4=Thermaplugg's Left Arm", "=ds=#w1#", "", "20.0%" };
	};

	AtlasLoot_Data["GnomeThermapluggHEROIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Heroic Mekgineer Thermaplugg", "=q5=ALL WILL DROP"};
    { 2, 58708, "", "=q1=Plugg Nuts", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Heroic Mekgineer Thermaplugg", "=q5=CHANCE TO DROP"};
    { 5, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 59050, "", "=q3=Libram of Mechanized Faith", "", "", "10.0%" };
    { 8, 11828, "", "=q1=Schematic: Pet Bombling", "=ds=#e2#", "", "90.0%" };
    { 10, 0, "AO_Unknown", "=q6=Heroic Mekgineer Thermaplugg", "=q5=ONE WILL DROP"};
    { 11, 9458, "", "=q3=Thermaplugg's Central Core", "=ds=#w8#", "", "30.0%" };
    { 12, 66444, "", "=q4=Charged Gear", "=ds=#s13#", "", "30.0%" };
    { 13, 9492, "", "=q3=Electromagnetic Gigaflux Reactivator", "=ds=#a1#", "", "20.0%" };
    { 14, 66443, "", "=q4=Thermaplugg's Left Arm", "=ds=#w1#", "", "20.0%" };
	};
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6=Noxxion", "=q5=ALL WILL DROP"};
    { 2, 17702, "", "=q1=Celebrian Rod", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Noxxion", "=q5=CHANCE TO DROP"};
    { 5, 17684, "", "=q1=Theradric Crystal Carving", "=ds=#m3#", "", "80.0%" };
    { 6, 59069, "", "=q3=Idol of the Earthmother", "", "", "10.0%" };
    { 8, 0, "AO_Unknown", "=q6=Noxxion", "=q5=ONE WILL DROP"};
    { 9, 17744, "", "=q3=Heart of Noxxion", "=ds=#s14#", "", "40.0%" };
    { 10, 17746, "", "=q3=Noxxion's Shackles", "=ds=#a4#", "", "40.0%" };
    { 11, 17745, "", "=q3=Noxious Shooter", "=ds=#w12#", "", "20.0%" };
	};

	AtlasLoot_Data["MaraNoxxionMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Noxxion", "=q5=ALL WILL DROP"};
    { 2, 17702, "", "=q1=Celebrian Rod", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Mythic Noxxion", "=q5=CHANCE TO DROP"};
    { 5, 17684, "", "=q1=Theradric Crystal Carving", "=ds=#m3#", "", "80.0%" };
    { 6, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 8, 59069, "", "=q3=Idol of the Earthmother", "", "", "10.0%" };
    { 10, 0, "AO_Unknown", "=q6=Mythic Noxxion", "=q5=ONE WILL DROP"};
    { 11, 17744, "", "=q3=Heart of Noxxion", "=ds=#s14#", "", "40.0%" };
    { 12, 69747, "", "=q4=Noxxion's Shackles", "=ds=#a4#", "", "40.0%" };
    { 13, 69746, "", "=q4=Noxious Shooter", "=ds=#w12#", "", "20.0%" };
	};

	AtlasLoot_Data["MaraNoxxionHEROIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Heroic Noxxion", "=q5=ALL WILL DROP"};
    { 2, 17702, "", "=q1=Celebrian Rod", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Heroic Noxxion", "=q5=CHANCE TO DROP"};
    { 5, 17684, "", "=q1=Theradric Crystal Carving", "=ds=#m3#", "", "80.0%" };
    { 6, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 8, 59069, "", "=q3=Idol of the Earthmother", "", "", "10.0%" };
    { 10, 0, "AO_Unknown", "=q6=Heroic Noxxion", "=q5=ONE WILL DROP"};
    { 11, 17744, "", "=q3=Heart of Noxxion", "=ds=#s14#", "", "40.0%" };
    { 12, 66747, "", "=q4=Noxxion's Shackles", "=ds=#a4#", "", "40.0%" };
    { 13, 66746, "", "=q4=Noxious Shooter", "=ds=#w12#", "", "20.0%" };
	};

	AtlasLoot_Data["MaraRazorlash"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Razorlash", "=q5=ALL WILL DROP"};
    { 2, 58700, "", "=q1=Razor Petal", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Razorlash", "=q5=CHANCE TO DROP"};
    { 5, 17684, "", "=q1=Theradric Crystal Carving", "=ds=#m3#", "", "80.0%" };
    { 6, 22529, "", "=q1=Savage Frond", "=ds=#m3#", "", "54.0%" };
    { 8, 0, "AO_Unknown", "=q6=Razorlash", "=q5=ONE WILL DROP"};
    { 9, 17748, "", "=q3=Vinerot Sandals", "=ds=#a1#", "", "25.0%" };
    { 10, 17749, "", "=q3=Phytoskin Spaulders", "=ds=#a2#", "", "25.0%" };
    { 11, 17750, "", "=q3=Chloromesh Girdle", "=ds=#a1#", "", "25.0%" };
    { 12, 17751, "", "=q3=Brusslehide Leggings", "=ds=#a2#", "", "25.0%" };
	};

	AtlasLoot_Data["MaraRazorlashMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Razorlash", "=q5=ALL WILL DROP"};
    { 2, 58700, "", "=q1=Razor Petal", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Mythic Razorlash", "=q5=CHANCE TO DROP"};
    { 5, 17684, "", "=q1=Theradric Crystal Carving", "=ds=#m3#", "", "80.0%" };
    { 6, 22529, "", "=q1=Savage Frond", "=ds=#m3#", "", "54.0%" };
    { 7, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 8, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 10, 0, "AO_Unknown", "=q6=Mythic Razorlash", "=q5=ONE WILL DROP"};
    { 11, 69748, "", "=q4=Vinerot Sandals", "=ds=#a1#", "", "25.0%" };
    { 12, 69749, "", "=q4=Phytoskin Spaulders", "=ds=#a2#", "", "25.0%" };
    { 13, 69750, "", "=q4=Chloromesh Girdle", "=ds=#a1#", "", "25.0%" };
    { 14, 69751, "", "=q4=Brusslehide Leggings", "=ds=#a2#", "", "25.0%" };
	};

	AtlasLoot_Data["MaraRazorlashHEROIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Heroic Razorlash", "=q5=ALL WILL DROP"};
    { 2, 58700, "", "=q1=Razor Petal", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Heroic Razorlash", "=q5=CHANCE TO DROP"};
    { 5, 17684, "", "=q1=Theradric Crystal Carving", "=ds=#m3#", "", "80.0%" };
    { 6, 22529, "", "=q1=Savage Frond", "=ds=#m3#", "", "54.0%" };
    { 7, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 8, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 10, 0, "AO_Unknown", "=q6=Heroic Razorlash", "=q5=ONE WILL DROP"};
    { 11, 66748, "", "=q4=Vinerot Sandals", "=ds=#a1#", "", "25.0%" };
    { 12, 66749, "", "=q4=Phytoskin Spaulders", "=ds=#a2#", "", "25.0%" };
    { 13, 66750, "", "=q4=Chloromesh Girdle", "=ds=#a1#", "", "25.0%" };
    { 14, 66751, "", "=q4=Brusslehide Leggings", "=ds=#a2#", "", "25.0%" };
	};
    ...
    { 4, 0, "RoM_stellar_dice", "=q6=Lord Vyletongue", "=q5=CHANCE TO DROP"};
    { 5, 17684, "", "=q1=Theradric Crystal Carving", "=ds=#m3#", "", "80.0%" };
    { 7, 0, "AO_Unknown", "=q6=Lord Vyletongue", "=q5=ONE WILL DROP"};
    { 8, 17752, "", "=q3=Satyr's Lash", "=ds=#w4#", "", "33.3%" };
    { 9, 17754, "", "=q3=Infernal Trickster Leggings", "=ds=#a3#", "", "33.3%" };
    { 10, 17755, "", "=q3=Satyrmane Sash", "=ds=#a1#", "", "33.3%" };
	};

	AtlasLoot_Data["MaraVyletongueMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Lord Vyletongue", "=q5=ALL WILL DROP"};
    { 2, 17703, "", "=q1=Celebrian Diamond", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Mythic Lord Vyletongue", "=q5=CHANCE TO DROP"};
    { 5, 17684, "", "=q1=Theradric Crystal Carving", "=ds=#m3#", "", "80.0%" };
    { 6, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 9, 0, "AO_Unknown", "=q6=Mythic Lord Vyletongue", "=q5=ONE WILL DROP"};
    { 10, 17752, "", "=q3=Satyr's Lash", "=ds=#w4#", "", "33.3%" };
    { 11, 69752, "", "=q4=Infernal Trickster Leggings", "=ds=#a3#", "", "33.3%" };
    { 12, 69753, "", "=q4=Satyrmane Sash", "=ds=#a1#", "", "33.3%" };
	};

	AtlasLoot_Data["MaraVyletongueHEROIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Heroic Lord Vyletongue", "=q5=ALL WILL DROP"};
    { 2, 17703, "", "=q1=Celebrian Diamond", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Heroic Lord Vyletongue", "=q5=CHANCE TO DROP"};
    { 5, 17684, "", "=q1=Theradric Crystal Carving", "=ds=#m3#", "", "80.0%" };
    { 6, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 9, 0, "AO_Unknown", "=q6=Heroic Lord Vyletongue", "=q5=ONE WILL DROP"};
    { 10, 17752, "", "=q3=Satyr's Lash", "=ds=#w4#", "", "33.3%" };
    { 11, 66752, "", "=q4=Infernal Trickster Leggings", "=ds=#a3#", "", "33.3%" };
    { 12, 66753, "", "=q4=Satyrmane Sash", "=ds=#a1#", "", "33.3%" };
	};

	AtlasLoot_Data["MaraMeshlok"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Meshlok the Harvester", "=q5=CHANCE TO DROP"};
    { 2, 17684, "", "=q1=Theradric Crystal Carving", "=ds=#m3#", "", "80.0%" };
    { 3, 17, "", "=q6=Martin Fury", "=ds=#a4#", "", "" };
    { 5, 0, "AO_Unknown", "=q6=Meshlok the Harvester", "=q5=ONE WILL DROP"};
    { 6, 17741, "", "=q3=Nature's Embrace", "=ds=#a1#", "", "33.3%" };
    { 7, 17742, "", "=q3=Fungus Shroud Armor", "=ds=#a2#", "", "33.3%" };
    { 8, 17767, "", "=q3=Bloomsprout Headpiece", "=ds=#a3#", "", "33.3%" };
	};

	AtlasLoot_Data["MaraCelebras"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Celebras the Cursed", "=q5=ALL WILL DROP"};
    { 2, 58701, "", "=q1=Carved Horn of Remulos", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Celebras the Cursed", "=q5=CHANCE TO DROP"};
    { 5, 17684, "", "=q1=Theradric Crystal Carving", "=ds=#m3#", "", "80.0%" };
    { 6, 57478, "", "=q1=Technique: Scroll of Nature Resistance IV", "=ds=#e2#", "", "15.0%" };
	...
	AtlasLoot_Data["MaraCelebrasMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Celebras the Cursed", "=q5=ALL WILL DROP"};
    { 2, 58701, "", "=q1=Carved Horn of Remulos", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Mythic Celebras the Cursed", "=q5=CHANCE TO DROP"};
    { 5, 17684, "", "=q1=Theradric Crystal Carving", "=ds=#m3#", "", "80.0%" };
    { 6, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 8, 57478, "", "=q1=Technique: Scroll of Nature Resistance IV", "=ds=#e2#", "", "15.0%" };
    { 10, 0, "AO_Unknown", "=q6=Mythic Celebras the Cursed", "=q5=ONE WILL DROP"};
    { 11, 17738, "", "=q3=Claw of Celebras", "=ds=#w13#", "", "33.3%" };
    { 12, 69742, "", "=q4=Grovekeeper's Drape", "=ds=#a1#", "", "33.3%" };
    { 13, 69743, "", "=q4=Soothsayer's Headdress", "=ds=#a2#", "", "33.3%" };
	};

	AtlasLoot_Data["MaraCelebrasHEROIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Heroic Celebras the Cursed", "=q5=ALL WILL DROP"};
    { 2, 58701, "", "=q1=Carved Horn of Remulos", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Heroic Celebras the Cursed", "=q5=CHANCE TO DROP"};
    { 5, 17684, "", "=q1=Theradric Crystal Carving", "=ds=#m3#", "", "80.0%" };
    { 6, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 8, 57478, "", "=q1=Technique: Scroll of Nature Resistance IV", "=ds=#e2#", "", "15.0%" };
    { 10, 0, "AO_Unknown", "=q6=Heroic Celebras the Cursed", "=q5=ONE WILL DROP"};
    { 11, 17738, "", "=q3=Claw of Celebras", "=ds=#w13#", "", "33.3%" };
    { 12, 66742, "", "=q4=Grovekeeper's Drape", "=ds=#a1#", "", "33.3%" };
    { 13, 66743, "", "=q4=Soothsayer's Headdress", "=ds=#a2#", "", "33.3%" };
	};

	AtlasLoot_Data["MaraLandslide"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Landslide", "=q5=CHANCE TO DROP"};
    { 2, 17684, "", "=q1=Theradric Crystal Carving", "=ds=#m3#", "", "80.0%" };
    { 4, 0, "AO_Unknown", "=q6=Landslide", "=q5=ONE WILL DROP"};
	...
	AtlasLoot_Data["MaraLandslideMYTHIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Mythic Landslide", "=q5=CHANCE TO DROP"};
    { 2, 17684, "", "=q1=Theradric Crystal Carving", "=ds=#m3#", "", "80.0%" };
    { 3, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 0, "AO_Unknown", "=q6=Mythic Landslide", "=q5=ONE WILL DROP"};
    { 7, 17943, "", "=q3=Fist of Stone", "=ds=#w6#", "", "25.0%" };
    { 8, 69739, "", "=q4=Helm of the Mountain", "=ds=#a4#", "", "25.0%" };
    { 9, 69740, "", "=q4=Rockgrip Gauntlets", "=ds=#a3#", "", "25.0%" };
    { 10, 69741, "", "=q4=Cloud Stone", "=ds=#s15#", "", "25.0%" };
	};

	AtlasLoot_Data["MaraLandslideHEROIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Heroic Landslide", "=q5=CHANCE TO DROP"};
    { 2, 17684, "", "=q1=Theradric Crystal Carving", "=ds=#m3#", "", "80.0%" };
    { 3, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 0, "AO_Unknown", "=q6=Heroic Landslide", "=q5=ONE WILL DROP"};
    { 7, 17943, "", "=q3=Fist of Stone", "=ds=#w6#", "", "25.0%" };
    { 8, 66739, "", "=q4=Helm of the Mountain", "=ds=#a4#", "", "25.0%" };
    { 9, 66740, "", "=q4=Rockgrip Gauntlets", "=ds=#a3#", "", "25.0%" };
    { 10, 66741, "", "=q4=Cloud Stone", "=ds=#s15#", "", "25.0%" };
	};

	AtlasLoot_Data["MaraGizlock"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Tinkerer Gizlock", "=q5=CHANCE TO DROP"};
    { 2, 17684, "", "=q1=Theradric Crystal Carving", "=ds=#m3#", "", "80.0%" };
    { 4, 0, "AO_Unknown", "=q6=Tinkerer Gizlock", "=q5=ONE WILL DROP"};
	...
	AtlasLoot_Data["MaraGizlockMYTHIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Mythic Tinkerer Gizlock", "=q5=CHANCE TO DROP"};
    { 2, 17684, "", "=q1=Theradric Crystal Carving", "=ds=#m3#", "", "80.0%" };
    { 3, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 0, "AO_Unknown", "=q6=Mythic Tinkerer Gizlock", "=q5=ONE WILL DROP"};
    { 7, 17717, "", "=q3=Megashot Rifle", "=ds=#w5#", "", "33.3%" };
    { 8, 69735, "", "=q4=Gizlock's Hypertech Buckler", "=ds=#w8#", "", "33.3%" };
    { 9, 69736, "", "=q4=Inventor's Focal Sword", "=ds=#w10#", "", "33.3%" };
	};

	AtlasLoot_Data["MaraGizlockHEROIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Heroic Tinkerer Gizlock", "=q5=CHANCE TO DROP"};
    { 2, 17684, "", "=q1=Theradric Crystal Carving", "=ds=#m3#", "", "80.0%" };
    { 3, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 0, "AO_Unknown", "=q6=Heroic Tinkerer Gizlock", "=q5=ONE WILL DROP"};
    { 7, 17717, "", "=q3=Megashot Rifle", "=ds=#w5#", "", "33.3%" };
    { 8, 66735, "", "=q4=Gizlock's Hypertech Buckler", "=ds=#w8#", "", "33.3%" };
    { 9, 66736, "", "=q4=Inventor's Focal Sword", "=ds=#w10#", "", "33.3%" };
	};

	AtlasLoot_Data["MaraRotgrip"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Rotgrip", "=q5=CHANCE TO DROP"};
    { 2, 17684, "", "=q1=Theradric Crystal Carving", "=ds=#m3#", "", "80.0%" };
    { 4, 0, "AO_Unknown", "=q6=Rotgrip", "=q5=ONE WILL DROP"};
    { 5, 17728, "", "=q3=Albino Crocscale Boots", "=ds=#a2#", "", "40.0%" };
    { 6, 17732, "", "=q3=Rotgrip Mantle", "=ds=#a1#", "", "40.0%" };
    { 7, 17730, "", "=q3=Gatorbite Axe", "=ds=#w1#", "", "20.0%" };
	};

	AtlasLoot_Data["MaraRotgripMYTHIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Mythic Rotgrip", "=q5=CHANCE TO DROP"};
    { 2, 17684, "", "=q1=Theradric Crystal Carving", "=ds=#m3#", "", "80.0%" };
    { 3, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 0, "AO_Unknown", "=q6=Mythic Rotgrip", "=q5=ONE WILL DROP"};
    { 7, 69737, "", "=q4=Albino Crocscale Boots", "=ds=#a2#", "", "40.0%" };
    { 8, 69738, "", "=q4=Rotgrip Mantle", "=ds=#a1#", "", "40.0%" };
    { 9, 17730, "", "=q3=Gatorbite Axe", "=ds=#w1#", "", "20.0%" };
	};

	AtlasLoot_Data["MaraRotgripHEROIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Heroic Rotgrip", "=q5=CHANCE TO DROP"};
    { 2, 17684, "", "=q1=Theradric Crystal Carving", "=ds=#m3#", "", "80.0%" };
    { 3, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 0, "AO_Unknown", "=q6=Heroic Rotgrip", "=q5=ONE WILL DROP"};
    { 7, 66737, "", "=q4=Albino Crocscale Boots", "=ds=#a2#", "", "40.0%" };
    { 8, 66738, "", "=q4=Rotgrip Mantle", "=ds=#a1#", "", "40.0%" };
    { 9, 17730, "", "=q3=Gatorbite Axe", "=ds=#w1#", "", "20.0%" };
	};

	AtlasLoot_Data["MaraTheradras"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Princess Theradras", "=q5=ALL WILL DROP"};
    { 2, 58746, "", "=q1=Face of Theradras", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Princess Theradras", "=q5=CHANCE TO DROP"};
    { 5, 17684, "", "=q1=Theradric Crystal Carving", "=ds=#m3#", "", "80.0%" };
    { 6, 57478, "", "=q1=Technique: Scroll of Nature Resistance IV", "=ds=#e2#", "", "15.0%" };
    { 7, 59070, "", "=q3=Libram of Sacred Ground", "", "", "10.0%" };
    { 9, 0, "AO_Unknown", "=q6=Princess Theradras", "=q5=ONE WILL DROP"};
	...
	AtlasLoot_Data["MaraTheradrasMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Princess Theradras", "=q5=ALL WILL DROP"};
    { 2, 58746, "", "=q1=Face of Theradras", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Mythic Princess Theradras", "=q5=CHANCE TO DROP"};
    { 5, 17684, "", "=q1=Theradric Crystal Carving", "=ds=#m3#", "", "80.0%" };
    { 6, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 8, 57478, "", "=q1=Technique: Scroll of Nature Resistance IV", "=ds=#e2#", "", "15.0%" };
    { 9, 59070, "", "=q3=Libram of Sacred Ground", "", "", "10.0%" };
    { 16, 0, "AO_Unknown", "=q6=Mythic Princess Theradras", "=q5=ONE WILL DROP"};
    { 17, 69732, "", "=q4=Blackstone Ring", "=ds=#s13#", "", "16.6%" };
    { 18, 69733, "", "=q4=Bracers of the Stone Princess", "=ds=#a3#", "", "16.6%" };
    { 19, 17766, "", "=q3=Princess Theradras' Scepter", "=ds=#w6#", "", "13.3%" };
    { 20, 69729, "", "=q4=Gemshard Heart", "=ds=#s2#", "", "13.3%" };
    { 21, 69730, "", "=q4=Charstone Dirk", "=ds=#w4#", "", "13.3%" };
    { 22, 69731, "", "=q4=Elemental Rockridge Leggings", "=ds=#a4#", "", "13.3%" };
    { 23, 69734, "", "=q4=Eye of Theradras", "=ds=#a1#", "", "13.3%" };
	};

	AtlasLoot_Data["MaraTheradrasHEROIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Heroic Princess Theradras", "=q5=ALL WILL DROP"};
    { 2, 58746, "", "=q1=Face of Theradras", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Heroic Princess Theradras", "=q5=CHANCE TO DROP"};
    { 5, 17684, "", "=q1=Theradric Crystal Carving", "=ds=#m3#", "", "80.0%" };
    { 6, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 8, 57478, "", "=q1=Technique: Scroll of Nature Resistance IV", "=ds=#e2#", "", "15.0%" };
    { 9, 59070, "", "=q3=Libram of Sacred Ground", "", "", "10.0%" };
    { 16, 0, "AO_Unknown", "=q6=Heroic Princess Theradras", "=q5=ONE WILL DROP"};
    { 17, 66732, "", "=q4=Blackstone Ring", "=ds=#s13#", "", "16.6%" };
    { 18, 66733, "", "=q4=Bracers of the Stone Princess", "=ds=#a3#", "", "16.6%" };
    { 19, 17766, "", "=q3=Princess Theradras' Scepter", "=ds=#w6#", "", "13.3%" };
    { 20, 66729, "", "=q4=Gemshard Heart", "=ds=#s2#", "", "13.3%" };
    { 21, 66730, "", "=q4=Charstone Dirk", "=ds=#w4#", "", "13.3%" };
    { 22, 66731, "", "=q4=Elemental Rockridge Leggings", "=ds=#a4#", "", "13.3%" };
    { 23, 66734, "", "=q4=Eye of Theradras", "=ds=#a1#", "", "13.3%" };
	};
    ...
    { 5, 57456, "", "=q1=Technique: Scroll of Fire Resistance II", "=ds=#e2#", "", "15.0%" };
	...
	AtlasLoot_Data["RFCTaragamanMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Taragaman the Hungerer", "=q5=ALL WILL DROP"};
    { 2, 14540, "", "=q1=Taragaman the Hungerer's Heart", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Mythic Taragaman the Hungerer", "=q5=CHANCE TO DROP"};
    { 5, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 57456, "", "=q1=Technique: Scroll of Fire Resistance II", "=ds=#e2#", "", "15.0%" };
    { 9, 0, "AO_Unknown", "=q6=Mythic Taragaman the Hungerer", "=q5=ONE WILL DROP"};
    { 10, 69712, "", "=q4=Crystalline Cuffs", "=ds=#a1#", "", "40.0%" };
    { 11, 69713, "", "=q4=Subterranean Cape", "=ds=#a1#", "", "40.0%" };
    { 12, 14145, "", "=q3=Cursed Felblade", "=ds=#w10#", "", "20.0%" };
	};

	AtlasLoot_Data["RFCTaragamanHEROIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Heroic Taragaman the Hungerer", "=q5=ALL WILL DROP"};
    { 2, 14540, "", "=q1=Taragaman the Hungerer's Heart", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Heroic Taragaman the Hungerer", "=q5=CHANCE TO DROP"};
    { 5, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 57456, "", "=q1=Technique: Scroll of Fire Resistance II", "=ds=#e2#", "", "15.0%" };
    { 9, 0, "AO_Unknown", "=q6=Heroic Taragaman the Hungerer", "=q5=ONE WILL DROP"};
    { 10, 66712, "", "=q4=Crystalline Cuffs", "=ds=#a1#", "", "40.0%" };
    { 11, 66713, "", "=q4=Subterranean Cape", "=ds=#a1#", "", "40.0%" };
    { 12, 14145, "", "=q3=Cursed Felblade", "=ds=#w10#", "", "20.0%" };
	};

	AtlasLoot_Data["RFCJergosh"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Jergosh the Invoker", "=q5=ALL WILL DROP"};
    { 2, 58707, "", "=q1=Searing Stone", "=ds=#m3#", "", "100%" };
	...
	AtlasLoot_Data["RFCJergoshMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Jergosh the Invoker", "=q5=ALL WILL DROP"};
    { 2, 58707, "", "=q1=Searing Stone", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Mythic Jergosh the Invoker", "=q5=CHANCE TO DROP"};
    { 5, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 57456, "", "=q1=Technique: Scroll of Fire Resistance II", "=ds=#e2#", "", "15.0%" };
    { 9, 0, "AO_Unknown", "=q6=Mythic Jergosh the Invoker", "=q5=ONE WILL DROP"};
    { 10, 69711, "", "=q4=Cavedweller Bracers", "=ds=#a3#", "", "40.0%" };
    { 11, 69714, "", "=q4=Robe of Evocation", "=ds=#a1#", "", "40.0%" };
    { 12, 69715, "", "=q4=Chanting Blade", "=ds=#w4#", "", "20.0%" };
	};

	AtlasLoot_Data["RFCJergoshHEROIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Heroic Jergosh the Invoker", "=q5=ALL WILL DROP"};
    { 2, 58707, "", "=q1=Searing Stone", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Heroic Jergosh the Invoker", "=q5=CHANCE TO DROP"};
    { 5, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 57456, "", "=q1=Technique: Scroll of Fire Resistance II", "=ds=#e2#", "", "15.0%" };
    { 9, 0, "AO_Unknown", "=q6=Heroic Jergosh the Invoker", "=q5=ONE WILL DROP"};
    { 10, 66711, "", "=q4=Cavedweller Bracers", "=ds=#a3#", "", "40.0%" };
    { 11, 66714, "", "=q4=Robe of Evocation", "=ds=#a1#", "", "40.0%" };
    { 12, 66715, "", "=q4=Chanting Blade", "=ds=#w4#", "", "20.0%" };
	};
    ...
    { 2, 57472, "", "=q1=Technique: Scroll of Shadow Resistance III", "=ds=#e2#", "", "15.0%" };
    { 3, 59061, "", "=q3=Tuskcrack Totem", "", "", "10.0%" };
    { 5, 0, "AO_Unknown", "=q6=Tuten'kash", "=q5=ONE WILL DROP"};
    { 6, 10775, "", "=q3=Carapace of Tuten'kash", "=ds=#a4#", "", "33.3%" };
    { 7, 10776, "", "=q3=Silky Spider Cape", "=ds=#a1#", "", "33.3%" };
    { 8, 10777, "", "=q3=Arachnid Gloves", "=ds=#a2#", "", "33.3%" };
	};

	AtlasLoot_Data["RFDTutenkashMYTHIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Mythic Tuten'kash", "=q5=CHANCE TO DROP"};
    { 2, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 57472, "", "=q1=Technique: Scroll of Shadow Resistance III", "=ds=#e2#", "", "15.0%" };
    { 5, 59061, "", "=q3=Tuskcrack Totem", "", "", "10.0%" };
    { 7, 0, "AO_Unknown", "=q6=Mythic Tuten'kash", "=q5=ONE WILL DROP"};
    { 8, 69469, "", "=q4=Carapace of Tuten'kash", "=ds=#a4#", "", "33.3%" };
    { 9, 69470, "", "=q4=Silky Spider Cape", "=ds=#a1#", "", "33.3%" };
    { 10, 69471, "", "=q4=Arachnid Gloves", "=ds=#a2#", "", "33.3%" };
	};

	AtlasLoot_Data["RFDTutenkashHEROIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Heroic Tuten'kash", "=q5=CHANCE TO DROP"};
    { 2, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 57472, "", "=q1=Technique: Scroll of Shadow Resistance III", "=ds=#e2#", "", "15.0%" };
    { 5, 59061, "", "=q3=Tuskcrack Totem", "", "", "10.0%" };
    { 7, 0, "AO_Unknown", "=q6=Heroic Tuten'kash", "=q5=ONE WILL DROP"};
    { 8, 66469, "", "=q4=Carapace of Tuten'kash", "=ds=#a4#", "", "33.3%" };
    { 9, 66470, "", "=q4=Silky Spider Cape", "=ds=#a1#", "", "33.3%" };
    { 10, 66471, "", "=q4=Arachnid Gloves", "=ds=#a2#", "", "33.3%" };
	};
	...
	AtlasLoot_Data["RFDMordreshMYTHIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Mythic Mordresh Fire Eye", "=q5=CHANCE TO DROP"};
    { 2, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 57472, "", "=q1=Technique: Scroll of Shadow Resistance III", "=ds=#e2#", "", "15.0%" };
    { 16, 0, "AO_Unknown", "=q6=Mythic Mordresh Fire Eye", "=q5=ONE WILL DROP"};
    { 17, 10567, "", "=q3=Quillshooter", "=ds=#w2#", "", "9.09%" };
    { 18, 10570, "", "=q3=Manslayer", "=ds=#w1#", "", "9.09%" };
    { 19, 10572, "", "=q3=Freezing Shard", "=ds=#w12#", "", "9.09%" };
    { 20, 10573, "", "=q3=Boneslasher", "=ds=#w10#", "", "9.09%" };
    { 21, 10574, "", "=q3=Corpseshroud", "=ds=#a1#", "", "9.09%" };
    { 22, 10578, "", "=q3=Thoughtcast Boots", "=ds=#a1#", "", "9.09%" };
    { 23, 10581, "", "=q3=Death's Head Vestment", "=ds=#a1#", "", "9.09%" };
    { 24, 10583, "", "=q3=Quillward Harness", "=ds=#a2#", "", "9.09%" };
    { 25, 69465, "", "=q4=Glowing Eye of Mordresh", "=ds=#s2#", "", "9.09%" };
    { 26, 69466, "", "=q4=Mordresh's Lifeless Skull", "=ds=#s15#", "", "9.09%" };
    { 27, 69467, "", "=q4=Deathmage Sash", "=ds=#a1#", "", "9.09%" };
	};

	AtlasLoot_Data["RFDMordreshHEROIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Heroic Mordresh Fire Eye", "=q5=CHANCE TO DROP"};
    { 2, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 57472, "", "=q1=Technique: Scroll of Shadow Resistance III", "=ds=#e2#", "", "15.0%" };
    { 16, 0, "AO_Unknown", "=q6=Heroic Mordresh Fire Eye", "=q5=ONE WILL DROP"};
    { 17, 10567, "", "=q3=Quillshooter", "=ds=#w2#", "", "9.09%" };
    { 18, 10570, "", "=q3=Manslayer", "=ds=#w1#", "", "9.09%" };
    { 19, 10572, "", "=q3=Freezing Shard", "=ds=#w12#", "", "9.09%" };
    { 20, 10573, "", "=q3=Boneslasher", "=ds=#w10#", "", "9.09%" };
    ...
    { 23, 10581, "", "=q3=Death's Head Vestment", "=ds=#a1#", "", "9.09%" };
    { 24, 10583, "", "=q3=Quillward Harness", "=ds=#a2#", "", "9.09%" };
    { 25, 66465, "", "=q4=Glowing Eye of Mordresh", "=ds=#s2#", "", "9.09%" };
    { 26, 66466, "", "=q4=Mordresh's Lifeless Skull", "=ds=#s15#", "", "9.09%" };
    { 27, 66467, "", "=q4=Deathmage Sash", "=ds=#a1#", "", "9.09%" };
	};
	...
	AtlasLoot_Data["RFDGluttonMYTHIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Mythic Glutton", "=q5=CHANCE TO DROP"};
    { 2, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 5, 0, "AO_Unknown", "=q6=Mythic Glutton", "=q5=ONE WILL DROP"};
    { 6, 10772, "", "=q3=Glutton's Cleaver", "=ds=#w1#", "", "50.0%" };
    { 7, 69468, "", "=q4=Fleshhide Shoulders", "=ds=#a2#", "", "50.0%" };
	};

	AtlasLoot_Data["RFDGluttonHEROIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Heroic Glutton", "=q5=CHANCE TO DROP"};
    { 2, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 5, 0, "AO_Unknown", "=q6=Heroic Glutton", "=q5=ONE WILL DROP"};
    { 6, 10772, "", "=q3=Glutton's Cleaver", "=ds=#w1#", "", "50.0%" };
    { 7, 66468, "", "=q4=Fleshhide Shoulders", "=ds=#a2#", "", "50.0%" };
	};

	AtlasLoot_Data["RFDRagglesnout"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Ragglesnout", "=q5=CHANCE TO DROP"};
    { 2, 17, "", "=q6=Martin Fury", "=ds=#a4#", "", "" };
    { 4, 0, "AO_Unknown", "=q6=Ragglesnout", "=q5=ONE WILL DROP"};
    { 5, 10767, "", "=q3=Savage Boar's Guard", "=ds=#w8#", "", "40.0%" };
    { 6, 10768, "", "=q3=Boar Champion's Belt", "=ds=#a3#", "", "40.0%" };
    { 7, 10758, "", "=q3=X'caliboar", "=ds=#w10#", "", "20.0%" };
	};

	AtlasLoot_Data["RFDRagglesnoutMYTHIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Mythic Ragglesnout", "=q5=CHANCE TO DROP"};
    { 2, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 5, 0, "AO_Unknown", "=q6=Mythic Ragglesnout", "=q5=ONE WILL DROP"};
    { 6, 69456, "", "=q4=X'caliboar", "=ds=#w10#", "", "20.0%" };
    { 7, 10567, "", "=q3=Quillshooter", "=ds=#w2#", "", "8.00%" };
    { 8, 10570, "", "=q3=Manslayer", "=ds=#w1#", "", "8.00%" };
    { 9, 10572, "", "=q3=Freezing Shard", "=ds=#w12#", "", "8.00%" };
    { 10, 10573, "", "=q3=Boneslasher", "=ds=#w10#", "", "8.00%" };
    { 11, 10574, "", "=q3=Corpseshroud", "=ds=#a1#", "", "8.00%" };
    { 12, 10578, "", "=q3=Thoughtcast Boots", "=ds=#a1#", "", "8.00%" };
    { 13, 10581, "", "=q3=Death's Head Vestment", "=ds=#a1#", "", "8.00%" };
    { 14, 10583, "", "=q3=Quillward Harness", "=ds=#a2#", "", "8.00%" };
    { 15, 69463, "", "=q4=Savage Boar's Guard", "=ds=#w8#", "", "8.00%" };
    { 16, 69464, "", "=q4=Boar Champion's Belt", "=ds=#a3#", "", "8.00%" };
	};

	AtlasLoot_Data["RFDRagglesnoutHEROIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Heroic Ragglesnout", "=q5=CHANCE TO DROP"};
    { 2, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 5, 0, "AO_Unknown", "=q6=Heroic Ragglesnout", "=q5=ONE WILL DROP"};
    { 6, 66456, "", "=q4=X'caliboar", "=ds=#w10#", "", "20.0%" };
    { 7, 10567, "", "=q3=Quillshooter", "=ds=#w2#", "", "8.00%" };
    { 8, 10570, "", "=q3=Manslayer", "=ds=#w1#", "", "8.00%" };
    { 9, 10572, "", "=q3=Freezing Shard", "=ds=#w12#", "", "8.00%" };
    { 10, 10573, "", "=q3=Boneslasher", "=ds=#w10#", "", "8.00%" };
    ...
    { 13, 10581, "", "=q3=Death's Head Vestment", "=ds=#a1#", "", "8.00%" };
    { 14, 10583, "", "=q3=Quillward Harness", "=ds=#a2#", "", "8.00%" };
    { 15, 66463, "", "=q4=Savage Boar's Guard", "=ds=#w8#", "", "8.00%" };
    { 16, 66464, "", "=q4=Boar Champion's Belt", "=ds=#a3#", "", "8.00%" };
	};

	AtlasLoot_Data["RFDAmnennar"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Amnennar the Coldbringer", "=q5=ALL WILL DROP"};
    { 2, 10420, "", "=q1=Skull of the Coldbringer", "=ds=#m3#", "", "100%" };
    { 3, 58705, "", "=q1=Frozen Bone", "=ds=#m3#", "", "100%" };
    { 5, 0, "RoM_stellar_dice", "=q6=Amnennar the Coldbringer", "=q5=CHANCE TO DROP"};
    { 6, 57462, "", "=q1=Technique: Scroll of Frost Resistance III", "=ds=#e2#", "", "20.0%" };
    { 7, 59062, "", "=q3=Idol of the Sleeping Wood", "", "", "10.0%" };
    { 8, 17, "", "=q6=Martin Fury", "=ds=#a4#", "", "" };
    { 10, 0, "AO_Unknown", "=q6=Amnennar the Coldbringer", "=q5=ONE WILL DROP"};
	...
	AtlasLoot_Data["RFDAmnennarMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Amnennar the Coldbringer", "=q5=ALL WILL DROP"};
    { 2, 10420, "", "=q1=Skull of the Coldbringer", "=ds=#m3#", "", "100%" };
    { 3, 58705, "", "=q1=Frozen Bone", "=ds=#m3#", "", "100%" };
    { 5, 0, "RoM_stellar_dice", "=q6=Mythic Amnennar the Coldbringer", "=q5=CHANCE TO DROP"};
    { 6, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 8, 57462, "", "=q1=Technique: Scroll of Frost Resistance III", "=ds=#e2#", "", "20.0%" };
    { 9, 59062, "", "=q3=Idol of the Sleeping Wood", "", "", "10.0%" };
    { 16, 0, "AO_Unknown", "=q6=Mythic Amnennar the Coldbringer", "=q5=ONE WILL DROP"};
    { 17, 10567, "", "=q3=Quillshooter", "=ds=#w2#", "", "7.69%" };
    { 18, 10570, "", "=q3=Manslayer", "=ds=#w1#", "", "7.69%" };
    { 19, 10572, "", "=q3=Freezing Shard", "=ds=#w12#", "", "7.69%" };
    { 20, 10573, "", "=q3=Boneslasher", "=ds=#w10#", "", "7.69%" };
    { 21, 10574, "", "=q3=Corpseshroud", "=ds=#a1#", "", "7.69%" };
    { 22, 10578, "", "=q3=Thoughtcast Boots", "=ds=#a1#", "", "7.69%" };
    { 23, 10581, "", "=q3=Death's Head Vestment", "=ds=#a1#", "", "7.69%" };
    { 24, 10583, "", "=q3=Quillward Harness", "=ds=#a2#", "", "7.69%" };
    { 25, 10761, "", "=q3=Coldrage Dagger", "=ds=#w4#", "", "7.69%" };
    { 26, 69458, "", "=q4=Robes of the Lich", "=ds=#a1#", "", "7.69%" };
    { 27, 69459, "", "=q4=Icemetal Barbute", "=ds=#a4#", "", "7.69%" };
    { 28, 69460, "", "=q4=Deathchill Armor", "=ds=#a3#", "", "7.69%" };
    { 29, 69461, "", "=q4=Bonefingers", "=ds=#a2#", "", "7.69%" };
	};
    ...
    { 2, 10420, "", "=q1=Skull of the Coldbringer", "=ds=#m3#", "", "100%" };
    { 3, 58705, "", "=q1=Frozen Bone", "=ds=#m3#", "", "100%" };
    { 5, 0, "RoM_stellar_dice", "=q6=Heroic Amnennar the Coldbringer", "=q5=CHANCE TO DROP"};
    { 6, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 8, 57462, "", "=q1=Technique: Scroll of Frost Resistance III", "=ds=#e2#", "", "20.0%" };
    { 9, 59062, "", "=q3=Idol of the Sleeping Wood", "", "", "10.0%" };
    { 16, 0, "AO_Unknown", "=q6=Heroic Amnennar the Coldbringer", "=q5=ONE WILL DROP"};
    { 17, 10567, "", "=q3=Quillshooter", "=ds=#w2#", "", "7.69%" };
    { 18, 10570, "", "=q3=Manslayer", "=ds=#w1#", "", "7.69%" };
    { 19, 10572, "", "=q3=Freezing Shard", "=ds=#w12#", "", "7.69%" };
    { 20, 10573, "", "=q3=Boneslasher", "=ds=#w10#", "", "7.69%" };
    ...
    { 24, 10583, "", "=q3=Quillward Harness", "=ds=#a2#", "", "7.69%" };
    { 25, 10761, "", "=q3=Coldrage Dagger", "=ds=#w4#", "", "7.69%" };
    { 26, 66458, "", "=q4=Robes of the Lich", "=ds=#a1#", "", "7.69%" };
    { 27, 66459, "", "=q4=Icemetal Barbute", "=ds=#a4#", "", "7.69%" };
    { 28, 66460, "", "=q4=Deathchill Armor", "=ds=#a3#", "", "7.69%" };
    { 29, 66461, "", "=q4=Bonefingers", "=ds=#a2#", "", "7.69%" };
	};
	...
	AtlasLoot_Data["RFDPlaguemawMYTHIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Mythic Plaguemaw the Rotting", "=q5=CHANCE TO DROP"};
    { 2, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 5, 0, "AO_Unknown", "=q6=Mythic Plaguemaw the Rotting", "=q5=ONE WILL DROP"};
    { 6, 69457, "", "=q4=Swine Fists", "=ds=#a2#", "", "60.0%" };
    { 7, 69462, "", "=q4=Plaguerot Sprig", "=ds=#w12#", "", "40.0%" };
	};

	AtlasLoot_Data["RFDPlaguemawHEROIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Heroic Plaguemaw the Rotting", "=q5=CHANCE TO DROP"};
    { 2, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 5, 0, "AO_Unknown", "=q6=Heroic Plaguemaw the Rotting", "=q5=ONE WILL DROP"};
    { 6, 66457, "", "=q4=Swine Fists", "=ds=#a2#", "", "60.0%" };
    { 7, 66462, "", "=q4=Plaguerot Sprig", "=ds=#w12#", "", "40.0%" };
	};
    ...
    { 1, 0, "AO_Unknown", "=q6=Death Speaker Jargba", "=q5=ONE WILL DROP"};
    { 2, 6682, "", "=q3=Death Speaker Robes", "=ds=#a1#", "", "40.0%" };
    { 3, 6685, "", "=q3=Death Speaker Mantle", "=ds=#a1#", "", "40.0%" };
    { 4, 2816, "", "=q3=Death Speaker Scepter", "=ds=#w6#", "", "20.0%" };
	};

	AtlasLoot_Data["RFKJargbaMYTHIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Mythic Death Speaker Jargba", "=q5=CHANCE TO DROP"};
    { 2, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 5, 0, "AO_Unknown", "=q6=Mythic Death Speaker Jargba", "=q5=ONE WILL DROP"};
    { 6, 69364, "", "=q4=Death Speaker Robes", "=ds=#a1#", "", "40.0%" };
    { 7, 69365, "", "=q4=Death Speaker Mantle", "=ds=#a1#", "", "40.0%" };
    { 8, 2816, "", "=q3=Death Speaker Scepter", "=ds=#w6#", "", "20.0%" };
	};

	AtlasLoot_Data["RFKJargbaHEROIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Heroic Death Speaker Jargba", "=q5=CHANCE TO DROP"};
    { 2, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 5, 0, "AO_Unknown", "=q6=Heroic Death Speaker Jargba", "=q5=ONE WILL DROP"};
    { 6, 66364, "", "=q4=Death Speaker Robes", "=ds=#a1#", "", "40.0%" };
    { 7, 66365, "", "=q4=Death Speaker Mantle", "=ds=#a1#", "", "40.0%" };
    { 8, 2816, "", "=q3=Death Speaker Scepter", "=ds=#w6#", "", "20.0%" };
	};

	AtlasLoot_Data["RFKRamtusk"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Overlord Ramtusk", "=q5=CHANCE TO DROP"};
    { 2, 57477, "", "=q1=Technique: Scroll of Nature Resistance III", "=ds=#e2#", "", "15.0%" };
    { 4, 0, "AO_Unknown", "=q6=Overlord Ramtusk", "=q5=ONE WILL DROP"};
    { 5, 6686, "", "=q3=Tusken Helm", "=ds=#a3#", "", "60.0%" };
    { 6, 6687, "", "=q3=Corpsemaker", "=ds=#w1#", "", "40.0%" };
	};

	AtlasLoot_Data["RFKRamtuskMYTHIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Mythic Overlord Ramtusk", "=q5=CHANCE TO DROP"};
    { 2, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 57477, "", "=q1=Technique: Scroll of Nature Resistance III", "=ds=#e2#", "", "15.0%" };
    { 6, 0, "AO_Unknown", "=q6=Mythic Overlord Ramtusk", "=q5=ONE WILL DROP"};
    { 7, 69366, "", "=q4=Tusken Helm", "=ds=#a3#", "", "60.0%" };
    { 8, 69367, "", "=q4=Corpsemaker", "=ds=#w1#", "", "40.0%" };
	};

	AtlasLoot_Data["RFKRamtuskHEROIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Heroic Overlord Ramtusk", "=q5=CHANCE TO DROP"};
    { 2, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 57477, "", "=q1=Technique: Scroll of Nature Resistance III", "=ds=#e2#", "", "15.0%" };
    { 6, 0, "AO_Unknown", "=q6=Heroic Overlord Ramtusk", "=q5=ONE WILL DROP"};
    { 7, 66366, "", "=q4=Tusken Helm", "=ds=#a3#", "", "60.0%" };
    { 8, 66367, "", "=q4=Corpsemaker", "=ds=#w1#", "", "40.0%" };
	};
	...
	AtlasLoot_Data["RFKAgathelosMYTHIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Mythic Agathelos the Raging", "=q5=CHANCE TO DROP"};
    { 2, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 5, 0, "AO_Unknown", "=q6=Mythic Agathelos the Raging", "=q5=ONE WILL DROP"};
    { 6, 69370, "", "=q4=Ferine Leggings", "=ds=#a2#", "", "60.0%" };
    { 7, 69371, "", "=q4=Swinetusk Shank", "=ds=#w4#", "", "40.0%" };
	};

	AtlasLoot_Data["RFKAgathelosHEROIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Heroic Agathelos the Raging", "=q5=CHANCE TO DROP"};
    { 2, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 5, 0, "AO_Unknown", "=q6=Heroic Agathelos the Raging", "=q5=ONE WILL DROP"};
    { 6, 66370, "", "=q4=Ferine Leggings", "=ds=#a2#", "", "60.0%" };
    { 7, 66371, "", "=q4=Swinetusk Shank", "=ds=#w4#", "", "40.0%" };
	};

	AtlasLoot_Data["RFKBlindHunter"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Blind Hunter", "=q5=CHANCE TO DROP"};
    { 2, 5801, "", "=q1=Kraul Guano", "=ds=#m3#", "", "80.0%" };
    { 3, 17, "", "=q6=Martin Fury", "=ds=#a4#", "", "" };
    { 5, 0, "AO_Unknown", "=q6=Blind Hunter", "=q5=ONE WILL DROP"};
    { 6, 6695, "", "=q3=Stygian Bone Amulet", "=ds=#s2#", "", "33.3%" };
    { 7, 6696, "", "=q3=Nightstalker Bow", "=ds=#w2#", "", "33.3%" };
    { 8, 6697, "", "=q3=Batwing Mantle", "=ds=#a1#", "", "33.3%" };
	};

	AtlasLoot_Data["RFKCharlga"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Charlga Razorflank", "=q5=ALL WILL DROP"};
    { 2, 5792, "", "=q1=Razorflank's Medallion", "=ds=#m3#", "", "100%" };
    { 3, 5793, "", "=q1=Razorflank's Heart", "=ds=#m3#", "", "100%" };
    { 4, 58704, "", "=q1=Gauntlets of Growth", "=ds=#m3#", "", "100%" };
    { 6, 0, "RoM_stellar_dice", "=q6=Charlga Razorflank", "=q5=CHANCE TO DROP"};
    { 7, 57477, "", "=q1=Technique: Scroll of Nature Resistance III", "=ds=#e2#", "", "15.0%" };
    { 8, 59052, "", "=q3=Boar-Tusk Totem", "", "", "10.0%" };
    { 10, 0, "AO_Unknown", "=q6=Charlga Razorflank", "=q5=ONE WILL DROP"};
    { 11, 6693, "", "=q3=Agamaggan's Clutch", "=ds=#s13#", "", "40.0%" };
    { 12, 6694, "", "=q3=Heart of Agamaggan", "=ds=#w8#", "", "40.0%" };
    { 13, 6692, "", "=q3=Pronged Reaver", "=ds=#w1#", "", "20.0%" };
	};

	AtlasLoot_Data["RFKCharlgaMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Charlga Razorflank", "=q5=ALL WILL DROP"};
    { 2, 5792, "", "=q1=Razorflank's Medallion", "=ds=#m3#", "", "100%" };
    { 3, 5793, "", "=q1=Razorflank's Heart", "=ds=#m3#", "", "100%" };
    { 4, 58704, "", "=q1=Gauntlets of Growth", "=ds=#m3#", "", "100%" };
    { 6, 0, "RoM_stellar_dice", "=q6=Mythic Charlga Razorflank", "=q5=CHANCE TO DROP"};
    { 7, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 8, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 9, 57477, "", "=q1=Technique: Scroll of Nature Resistance III", "=ds=#e2#", "", "15.0%" };
    { 10, 59052, "", "=q3=Boar-Tusk Totem", "", "", "10.0%" };
    { 12, 0, "AO_Unknown", "=q6=Mythic Charlga Razorflank", "=q5=ONE WILL DROP"};
    { 13, 69373, "", "=q4=Agamaggan's Clutch", "=ds=#s13#", "", "40.0%" };
    { 14, 69374, "", "=q4=Heart of Agamaggan", "=ds=#w8#", "", "40.0%" };
    { 15, 69372, "", "=q4=Pronged Reaver", "=ds=#w1#", "", "20.0%" };
	};
    ...
    { 3, 5793, "", "=q1=Razorflank's Heart", "=ds=#m3#", "", "100%" };
    { 4, 58704, "", "=q1=Gauntlets of Growth", "=ds=#m3#", "", "100%" };
    { 6, 0, "RoM_stellar_dice", "=q6=Heroic Charlga Razorflank", "=q5=CHANCE TO DROP"};
    { 7, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 8, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 9, 57477, "", "=q1=Technique: Scroll of Nature Resistance III", "=ds=#e2#", "", "15.0%" };
    { 10, 59052, "", "=q3=Boar-Tusk Totem", "", "", "10.0%" };
    { 12, 0, "AO_Unknown", "=q6=Heroic Charlga Razorflank", "=q5=ONE WILL DROP"};
    { 13, 66373, "", "=q4=Agamaggan's Clutch", "=ds=#s13#", "", "40.0%" };
    { 14, 66374, "", "=q4=Heart of Agamaggan", "=ds=#w8#", "", "40.0%" };
    { 15, 66372, "", "=q4=Pronged Reaver", "=ds=#w1#", "", "20.0%" };
	};

	AtlasLoot_Data["RFKHalmgar"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Earthcaller Halmgar", "=q5=CHANCE TO DROP"};
    { 2, 59051, "", "=q3=Idol of Greenleaf", "", "", "10.0%" };
    { 3, 17, "", "=q6=Martin Fury", "=ds=#a4#", "", "" };
    { 5, 0, "AO_Unknown", "=q6=Earthcaller Halmgar", "=q5=ONE WILL DROP"};
    { 6, 6688, "", "=q3=Whisperwind Headdress", "=ds=#a2#", "", "50.0%" };
    { 7, 6689, "", "=q3=Wind Spirit Staff", "=ds=#w9#", "", "50.0%" };
	};
    ...
    { 2, 58721, "", "=q1=Herod's War Banner", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Herod", "=q5=CHANCE TO DROP"};
    { 5, 57457, "", "=q1=Technique: Scroll of Fire Resistance III", "=ds=#e2#", "", "15.0%" };
    { 6, 59057, "", "=q3=Idol of the Feral Hunt", "", "", "10.0%" };
    { 7, 59058, "", "=q3=Libram of Sudden Wrath", "", "", "10.0%" };
    { 9, 0, "AO_Unknown", "=q6=Herod", "=q5=ONE WILL DROP"};
    { 10, 7717, "", "=q3=Ravager", "=ds=#w1#", "", "25.0%" };
    { 11, 7718, "", "=q3=Herod's Shoulder", "=ds=#a3#", "", "25.0%" };
    { 12, 7719, "", "=q3=Raging Berserker's Helm", "=ds=#a3#", "", "25.0%" };
    { 13, 10330, "", "=q3=Scarlet Leggings", "=ds=#a3#", "", "25.0%" };
    { 16, 0, "RoM_stellar_dice", "=q6=Scarlet Trainee", "=q5=CHANCE TO DROP"};
    { 17, 23192, "", "=q2=Tabard of the Scarlet Crusade", "=ds=#s7#", "", "1.60%" };
	};

	AtlasLoot_Data["SMCFairbanks"] = {
    { 1, 0, "AO_Unknown", "=q6=High Inquisitor Fairbanks", "=q5=ONE WILL DROP"};
    { 2, 19507, "", "=q3=Inquisitor's Shawl", "=ds=#a1#", "", "33.3%" };
    { 3, 19508, "", "=q3=Branded Leather Bracers", "=ds=#a2#", "", "33.3%" };
    { 4, 19509, "", "=q3=Dusty Mail Boots", "=ds=#a3#", "", "33.3%" };
	};

	AtlasLoot_Data["SMCFairbanksMYTHIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Mythic High Inquisitor Fairbanks", "=q5=CHANCE TO DROP"};
    { 2, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 5, 0, "AO_Unknown", "=q6=Mythic High Inquisitor Fairbanks", "=q5=ONE WILL DROP"};
    { 6, 19507, "", "=q3=Inquisitor's Shawl", "=ds=#a1#", "", "33.3%" };
    { 7, 19508, "", "=q3=Branded Leather Bracers", "=ds=#a2#", "", "33.3%" };
    { 8, 69917, "", "=q4=Dusty Mail Boots", "=ds=#a3#", "", "33.3%" };
	};

	AtlasLoot_Data["SMCFairbanksHEROIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Heroic High Inquisitor Fairbanks", "=q5=CHANCE TO DROP"};
    { 2, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 5, 0, "AO_Unknown", "=q6=Heroic High Inquisitor Fairbanks", "=q5=ONE WILL DROP"};
    { 6, 19507, "", "=q3=Inquisitor's Shawl", "=ds=#a1#", "", "33.3%" };
    { 7, 19508, "", "=q3=Branded Leather Bracers", "=ds=#a2#", "", "33.3%" };
    { 8, 66917, "", "=q4=Dusty Mail Boots", "=ds=#a3#", "", "33.3%" };
	};

	AtlasLoot_Data["SMCMograineWhitemane"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Scarlet Commander Mograine", "=q5=CHANCE TO DROP"};
    { 2, 57482, "", "=q1=Technique: Scroll of Holy Resistance III", "=ds=#e2#", "", "15.0%" };
    { 3, 59059, "", "=q3=Libram of Radiant Flash", "", "", "10.0%" };
    { 5, 0, "AO_Unknown", "=q6=Scarlet Commander Mograine", "=q5=ONE WILL DROP"};
    { 6, 7726, "", "=q3=Aegis of the Scarlet Commander", "=ds=#w8#", "", "40.0%" };
    { 7, 7723, "", "=q3=Mograine's Might", "=ds=#w6#", "", "20.0%" };
    { 8, 7724, "", "=q3=Gauntlets of Divinity", "=ds=#a3#", "", "20.0%" };
    { 9, 10330, "", "=q3=Scarlet Leggings", "=ds=#a3#", "", "20.0%" };
    { 16, 0, "AO_ChestWithTreasures", "=q6=High Inquisitor Whitemane", "=q5=ALL WILL DROP"};
    { 17, 58722, "", "=q1=Whitemane's Prayer Book", "=ds=#m3#", "", "100%" };
    { 19, 0, "RoM_stellar_dice", "=q6=High Inquisitor Whitemane", "=q5=CHANCE TO DROP"};
    { 20, 57482, "", "=q1=Technique: Scroll of Holy Resistance III", "=ds=#e2#", "", "15.0%" };
    { 21, 20976, "", "=q2=Design: Citrine Pendant of Golden Healing", "=ds=#e2#", "", "10.0%" };
    { 22, 57624, "", "=q6=Pattern: Expert Riding Crop", "=ds=#e2#", "", "10.0%" };
    { 23, 59060, "", "=q3=Totem of Cleansing Streams", "", "", "10.0%" };
    { 25, 0, "AO_Unknown", "=q6=High Inquisitor Whitemane", "=q5=ONE WILL DROP"};
    { 26, 7720, "", "=q3=Whitemane's Chapeau", "=ds=#a1#", "", "40.0%" };
    { 27, 7722, "", "=q3=Triune Amulet", "=ds=#s2#", "", "40.0%" };
    { 28, 7721, "", "=q3=Hand of Righteousness", "=ds=#w6#", "", "20.0%" };
	};

	AtlasLoot_Data["SMGVishas"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Interrogator Vishas", "=q5=CHANCE TO DROP"};
    { 2, 59053, "", "=q3=Libram of Steadfast Devotion", "", "", "10.0%" };
    { 4, 0, "AO_Unknown", "=q6=Interrogator Vishas", "=q5=ONE WILL DROP"};
    { 5, 7683, "", "=q3=Bloody Brass Knuckles", "=ds=#w13#", "", "90.0%" };
    { 6, 7682, "", "=q3=Torturing Poker", "=ds=#w4#", "", "10.0%" };
	};

	AtlasLoot_Data["SMGVishasMYTHIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Mythic Interrogator Vishas", "=q5=CHANCE TO DROP"};
    { 2, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 59053, "", "=q3=Libram of Steadfast Devotion", "", "", "10.0%" };
    { 6, 0, "AO_Unknown", "=q6=Mythic Interrogator Vishas", "=q5=ONE WILL DROP"};
    { 7, 69389, "", "=q4=Bloody Brass Knuckles", "=ds=#w13#", "", "90.0%" };
    { 8, 69388, "", "=q4=Torturing Poker", "=ds=#w4#", "", "10.0%" };
	};

	AtlasLoot_Data["SMGVishasHEROIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Heroic Interrogator Vishas", "=q5=CHANCE TO DROP"};
    { 2, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 59053, "", "=q3=Libram of Steadfast Devotion", "", "", "10.0%" };
    { 6, 0, "AO_Unknown", "=q6=Heroic Interrogator Vishas", "=q5=ONE WILL DROP"};
    { 7, 66389, "", "=q4=Bloody Brass Knuckles", "=ds=#w13#", "", "90.0%" };
    { 8, 66388, "", "=q4=Torturing Poker", "=ds=#w4#", "", "10.0%" };
	};

	AtlasLoot_Data["SMGThalnos"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Bloodmage Thalnos", "=q5=ALL WILL DROP"};
    { 2, 58710, "", "=q1=Bloodfire Amulet", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Bloodmage Thalnos", "=q5=CHANCE TO DROP"};
    { 5, 59054, "", "=q3=Idol of Restless Grove", "", "", "10.0%" };
    { 7, 0, "AO_Unknown", "=q6=Bloodmage Thalnos", "=q5=ONE WILL DROP"};
    { 8, 7684, "", "=q3=Bloodmage Mantle", "=ds=#a1#", "", "50.0%" };
    { 9, 7685, "", "=q3=Orb of the Forgotten Seer", "=ds=#s15#", "", "50.0%" };
	};

	AtlasLoot_Data["SMGThalnosMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Bloodmage Thalnos", "=q5=ALL WILL DROP"};
    { 2, 58710, "", "=q1=Bloodfire Amulet", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Mythic Bloodmage Thalnos", "=q5=CHANCE TO DROP"};
    { 5, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 59054, "", "=q3=Idol of Restless Grove", "", "", "10.0%" };
    { 9, 0, "AO_Unknown", "=q6=Mythic Bloodmage Thalnos", "=q5=ONE WILL DROP"};
    { 10, 69390, "", "=q4=Bloodmage Mantle", "=ds=#a1#", "", "50.0%" };
    { 11, 69391, "", "=q4=Orb of the Forgotten Seer", "=ds=#s15#", "", "50.0%" };
	};

	AtlasLoot_Data["SMGThalnosHEROIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Heroic Bloodmage Thalnos", "=q5=ALL WILL DROP"};
    { 2, 58710, "", "=q1=Bloodfire Amulet", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Heroic Bloodmage Thalnos", "=q5=CHANCE TO DROP"};
    { 5, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 59054, "", "=q3=Idol of Restless Grove", "", "", "10.0%" };
    { 9, 0, "AO_Unknown", "=q6=Heroic Bloodmage Thalnos", "=q5=ONE WILL DROP"};
    { 10, 66390, "", "=q4=Bloodmage Mantle", "=ds=#a1#", "", "50.0%" };
    { 11, 66391, "", "=q4=Orb of the Forgotten Seer", "=ds=#s15#", "", "50.0%" };
	};

	AtlasLoot_Data["SMGIronspine"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Ironspine", "=q5=CHANCE TO DROP"};
    { 2, 17, "", "=q6=Martin Fury", "=ds=#a4#", "", "" };
    { 4, 0, "AO_Unknown", "=q6=Ironspine", "=q5=ONE WILL DROP"};
    { 5, 7686, "", "=q3=Ironspine's Eye", "=ds=#s13#", "", "33.3%" };
    { 6, 7687, "", "=q3=Ironspine's Fist", "=ds=#w6#", "", "33.3%" };
    { 7, 7688, "", "=q3=Ironspine's Ribcage", "=ds=#a3#", "", "33.3%" };
	};

	AtlasLoot_Data["SMGAzshir"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Azshir the Sleepless", "=q5=CHANCE TO DROP"};
    { 2, 17, "", "=q6=Martin Fury", "=ds=#a4#", "", "" };
    { 4, 0, "AO_Unknown", "=q6=Azshir the Sleepless", "=q5=ONE WILL DROP"};
    { 5, 7708, "", "=q3=Necrotic Wand", "=ds=#w12#", "", "33.3%" };
    { 6, 7709, "", "=q3=Blighted Leggings", "=ds=#a1#", "", "33.3%" };
    { 7, 7731, "", "=q3=Ghostshard Talisman", "=ds=#s2#", "", "33.3%" };
	};

	AtlasLoot_Data["SMGFallenChampion"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Fallen Champion", "=q5=CHANCE TO DROP"};
    { 2, 17, "", "=q6=Martin Fury", "=ds=#a4#", "", "" };
    { 4, 0, "AO_Unknown", "=q6=Fallen Champion", "=q5=ONE WILL DROP"};
    { 5, 7689, "", "=q3=Morbid Dawn", "=ds=#w10#", "", "33.3%" };
    { 6, 7690, "", "=q3=Ebon Vise", "=ds=#a2#", "", "33.3%" };
    { 7, 7691, "", "=q3=Embalmed Shroud", "=ds=#a1#", "", "33.3%" };
	};

	AtlasLoot_Data["SMLLoksey"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Houndmaster Loksey", "=q5=CHANCE TO DROP"};
    { 2, 59055, "", "=q3=Libram of Scholarly Light", "", "", "10.0%" };
    { 4, 0, "AO_Unknown", "=q6=Houndmaster Loksey", "=q5=ONE WILL DROP"};
    { 5, 7756, "", "=q3=Dog Training Gloves", "=ds=#a2#", "", "60.0%" };
    { 6, 3456, "", "=q3=Dog Whistle", "=ds=#e0#", "", "30.0%" };
    { 7, 7710, "", "=q3=Loksey's Training Stick", "=ds=#w9#", "", "10.0%" };
	};

	AtlasLoot_Data["SMLLokseyMYTHIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Mythic Houndmaster Loksey", "=q5=CHANCE TO DROP"};
    { 2, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 59055, "", "=q3=Libram of Scholarly Light", "", "", "10.0%" };
    { 6, 0, "AO_Unknown", "=q6=Mythic Houndmaster Loksey", "=q5=ONE WILL DROP"};
    { 7, 69414, "", "=q4=Dog Training Gloves", "=ds=#a2#", "", "60.0%" };
    { 8, 3456, "", "=q3=Dog Whistle", "=ds=#e0#", "", "30.0%" };
    { 9, 69400, "", "=q4=Loksey's Training Stick", "=ds=#w9#", "", "10.0%" };
	};

	AtlasLoot_Data["SMLLokseyHEROIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Heroic Houndmaster Loksey", "=q5=CHANCE TO DROP"};
    { 2, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 59055, "", "=q3=Libram of Scholarly Light", "", "", "10.0%" };
    { 6, 0, "AO_Unknown", "=q6=Heroic Houndmaster Loksey", "=q5=ONE WILL DROP"};
    { 7, 66414, "", "=q4=Dog Training Gloves", "=ds=#a2#", "", "60.0%" };
    { 8, 3456, "", "=q3=Dog Whistle", "=ds=#e0#", "", "30.0%" };
    { 9, 66400, "", "=q4=Loksey's Training Stick", "=ds=#w9#", "", "10.0%" };
	};

	AtlasLoot_Data["SMLDoan"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Arcanist Doan", "=q5=ALL WILL DROP"};
    { 2, 58723, "", "=q1=Arcane Orb of Doan", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Arcanist Doan", "=q5=CHANCE TO DROP"};
    { 5, 57467, "", "=q1=Technique: Scroll of Arcane Resistance III", "=ds=#e2#", "", "15.0%" };
    { 6, 59056, "", "=q3=Forbidden Tome of Tempests", "", "", "10.0%" };
    { 8, 0, "AO_Unknown", "=q6=Arcanist Doan", "=q5=ONE WILL DROP"};
    { 9, 7711, "", "=q3=Robe of Doan", "=ds=#a1#", "", "24.0%" };
    { 10, 7712, "", "=q3=Mantle of Doan", "=ds=#a1#", "", "24.0%" };
    { 11, 7713, "", "=q3=Illusionary Rod", "=ds=#w9#", "", "24.0%" };
    { 12, 7714, "", "=q3=Hypnotic Blade", "=ds=#w4#", "", "24.0%" };
    { 13, 34227, "", "=q4=Deadman's Hand", "=ds=#s13#", "", "4.00%" };
	};

	AtlasLoot_Data["SMLDoanMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Arcanist Doan", "=q5=ALL WILL DROP"};
    { 2, 58723, "", "=q1=Arcane Orb of Doan", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Mythic Arcanist Doan", "=q5=CHANCE TO DROP"};
    { 5, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 57467, "", "=q1=Technique: Scroll of Arcane Resistance III", "=ds=#e2#", "", "15.0%" };
    { 8, 59056, "", "=q3=Forbidden Tome of Tempests", "", "", "10.0%" };
    { 10, 0, "AO_Unknown", "=q6=Mythic Arcanist Doan", "=q5=ONE WILL DROP"};
    { 11, 69401, "", "=q4=Robe of Doan", "=ds=#a1#", "", "24.0%" };
    { 12, 69402, "", "=q4=Mantle of Doan", "=ds=#a1#", "", "24.0%" };
    { 13, 69403, "", "=q4=Illusionary Rod", "=ds=#w9#", "", "24.0%" };
    { 14, 69404, "", "=q4=Hypnotic Blade", "=ds=#w4#", "", "24.0%" };
    { 15, 34227, "", "=q4=Deadman's Hand", "=ds=#s13#", "", "4.00%" };
	};

	AtlasLoot_Data["SMLDoanHEROIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Heroic Arcanist Doan", "=q5=ALL WILL DROP"};
    { 2, 58723, "", "=q1=Arcane Orb of Doan", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Heroic Arcanist Doan", "=q5=CHANCE TO DROP"};
    { 5, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 57467, "", "=q1=Technique: Scroll of Arcane Resistance III", "=ds=#e2#", "", "15.0%" };
    { 8, 59056, "", "=q3=Forbidden Tome of Tempests", "", "", "10.0%" };
    { 10, 0, "AO_Unknown", "=q6=Heroic Arcanist Doan", "=q5=ONE WILL DROP"};
    { 11, 66401, "", "=q4=Robe of Doan", "=ds=#a1#", "", "24.0%" };
    { 12, 66402, "", "=q4=Mantle of Doan", "=ds=#a1#", "", "24.0%" };
    { 13, 66403, "", "=q4=Illusionary Rod", "=ds=#w9#", "", "24.0%" };
    { 14, 66404, "", "=q4=Hypnotic Blade", "=ds=#w4#", "", "24.0%" };
    { 15, 34227, "", "=q4=Deadman's Hand", "=ds=#s13#", "", "4.00%" };
	};
    ...
    { 2, 69988, "", "=q4=The Axe of Severing", "=ds=#w1#", "", "50.0%" };
    { 3, 69989, "", "=q4=Abomination Skin Leggings", "=ds=#a1#", "", "50.0%" };
	};

	AtlasLoot_Data["SFKSeverHEROIC"] = {
    { 1, 0, "AO_Unknown", "=q6=Heroic Sever", "=q5=ONE WILL DROP"};
    { 2, 66988, "", "=q4=The Axe of Severing", "=ds=#w1#", "", "50.0%" };
    { 3, 66989, "", "=q4=Abomination Skin Leggings", "=ds=#a1#", "", "50.0%" };
	};
    ...
    { 2, 69985, "", "=q4=Scorn's Focal Dagger", "=ds=#w4#", "", "33.3%" };
    { 3, 69986, "", "=q4=Scorn's Icy Choker", "=ds=#s2#", "", "33.3%" };
    { 4, 69987, "", "=q4=The Frozen Clutch", "=ds=#a3#", "", "33.3%" };
	};

	AtlasLoot_Data["SMCScornHEROIC"] = {
    { 1, 0, "AO_Unknown", "=q6=Heroic Scorn", "=q5=ONE WILL DROP"};
    { 2, 66985, "", "=q4=Scorn's Focal Dagger", "=ds=#w4#", "", "33.3%" };
    { 3, 66986, "", "=q4=Scorn's Icy Choker", "=ds=#s2#", "", "33.3%" };
    { 4, 66987, "", "=q4=The Frozen Clutch", "=ds=#a3#", "", "33.3%" };
	};

	AtlasLoot_Data["WCFaerie"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Deviate Faerie Dragon", "=q5=CHANCE TO DROP"};
    { 2, 6443, "", "=q1=Deviate Hide", "=ds=#m3#", "", "80.0%" };
    { 4, 0, "AO_Unknown", "=q6=Deviate Faerie Dragon", "=q5=ONE WILL DROP"};
    { 5, 5243, "", "=q3=Firebelcher", "=ds=#w12#", "", "50.0%" };
    { 6, 6632, "", "=q3=Feyscale Cloak", "=ds=#a1#", "", "50.0%" };
	};

	AtlasLoot_Data["WCMutanus"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mutanus the Devourer", "=q5=ALL WILL DROP"};
    { 2, 10441, "", "=q1=Glowing Shard", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Mutanus the Devourer", "=q5=CHANCE TO DROP"};
    { 5, 6443, "", "=q1=Deviate Hide", "=ds=#m3#", "", "80.0%" };
    { 6, 59042, "", "=q2=Tongue-Lasher Totem", "", "", "10.0%" };
    { 8, 0, "AO_Unknown", "=q6=Mutanus the Devourer", "=q5=ONE WILL DROP"};
    { 9, 6461, "", "=q3=Slime-encrusted Pads", "=ds=#a1#", "", "33.3%" };
    { 10, 6463, "", "=q3=Deep Fathom Ring", "=ds=#s13#", "", "33.3%" };
    { 11, 6627, "", "=q3=Mutant Scale Breastplate", "=ds=#a3#", "", "33.3%" };
	};

	AtlasLoot_Data["WCMutanusMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Mutanus the Devourer", "=q5=ALL WILL DROP"};
    { 2, 10441, "", "=q1=Glowing Shard", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Mythic Mutanus the Devourer", "=q5=CHANCE TO DROP"};
    { 5, 6443, "", "=q1=Deviate Hide", "=ds=#m3#", "", "80.0%" };
    { 6, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 8, 59042, "", "=q2=Tongue-Lasher Totem", "", "", "10.0%" };
    { 10, 0, "AO_Unknown", "=q6=Mythic Mutanus the Devourer", "=q5=ONE WILL DROP"};
    { 11, 69351, "", "=q4=Slime-encrusted Pads", "=ds=#a1#", "", "33.3%" };
    { 12, 69352, "", "=q4=Deep Fathom Ring", "=ds=#s13#", "", "33.3%" };
    { 13, 69354, "", "=q4=Mutant Scale Breastplate", "=ds=#a3#", "", "33.3%" };
	};

	AtlasLoot_Data["WCMutanusHEROIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Heroic Mutanus the Devourer", "=q5=ALL WILL DROP"};
    { 2, 10441, "", "=q1=Glowing Shard", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Heroic Mutanus the Devourer", "=q5=CHANCE TO DROP"};
    { 5, 6443, "", "=q1=Deviate Hide", "=ds=#m3#", "", "80.0%" };
    { 6, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 8, 59042, "", "=q2=Tongue-Lasher Totem", "", "", "10.0%" };
    { 10, 0, "AO_Unknown", "=q6=Heroic Mutanus the Devourer", "=q5=ONE WILL DROP"};
    { 11, 66351, "", "=q4=Slime-encrusted Pads", "=ds=#a1#", "", "33.3%" };
    { 12, 66352, "", "=q4=Deep Fathom Ring", "=ds=#s13#", "", "33.3%" };
    { 13, 66354, "", "=q4=Mutant Scale Breastplate", "=ds=#a3#", "", "33.3%" };
	};

	AtlasLoot_Data["WCVerdan"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Verdan the Everliving", "=q5=ALL WILL DROP"};
    { 2, 58706, "", "=q1=Everliving Spore", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Verdan the Everliving", "=q5=CHANCE TO DROP"};
    { 5, 6443, "", "=q1=Deviate Hide", "=ds=#m3#", "", "80.0%" };
    { 6, 57476, "", "=q1=Technique: Scroll of Nature Resistance II", "=ds=#e2#", "", "15.0%" };
	...
	AtlasLoot_Data["WCVerdanMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Verdan the Everliving", "=q5=ALL WILL DROP"};
    { 2, 58706, "", "=q1=Everliving Spore", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Mythic Verdan the Everliving", "=q5=CHANCE TO DROP"};
    { 5, 6443, "", "=q1=Deviate Hide", "=ds=#m3#", "", "80.0%" };
    { 6, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 8, 57476, "", "=q1=Technique: Scroll of Nature Resistance II", "=ds=#e2#", "", "15.0%" };
    { 10, 0, "AO_Unknown", "=q6=Mythic Verdan the Everliving", "=q5=ONE WILL DROP"};
    { 11, 69356, "", "=q4=Seedcloud Buckler", "=ds=#w8#", "", "40.0%" };
    { 12, 69357, "", "=q4=Living Root", "=ds=#w9#", "", "40.0%" };
    { 13, 69355, "", "=q4=Sporid Cape", "=ds=#a1#", "", "20.0%" };
	};

	AtlasLoot_Data["WCVerdanHEROIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Heroic Verdan the Everliving", "=q5=ALL WILL DROP"};
    { 2, 58706, "", "=q1=Everliving Spore", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Heroic Verdan the Everliving", "=q5=CHANCE TO DROP"};
    { 5, 6443, "", "=q1=Deviate Hide", "=ds=#m3#", "", "80.0%" };
    { 6, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 8, 57476, "", "=q1=Technique: Scroll of Nature Resistance II", "=ds=#e2#", "", "15.0%" };
    { 10, 0, "AO_Unknown", "=q6=Heroic Verdan the Everliving", "=q5=ONE WILL DROP"};
    { 11, 66356, "", "=q4=Seedcloud Buckler", "=ds=#w8#", "", "40.0%" };
    { 12, 66357, "", "=q4=Living Root", "=ds=#w9#", "", "40.0%" };
    { 13, 66355, "", "=q4=Sporid Cape", "=ds=#a1#", "", "20.0%" };
	};

	AtlasLoot_Data["WCSerpentis"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Lord Serpentis", "=q5=ALL WILL DROP"};
    { 2, 9741, "", "=q1=Gem of Serpentis", "=ds=#m3#", "", "100%" };
    { 4, 0, "AO_Unknown", "=q6=Lord Serpentis", "=q5=ONE WILL DROP"};
    { 5, 5970, "", "=q3=Serpent Gloves", "=ds=#a1#", "", "25.0%" };
    { 6, 6459, "", "=q3=Savage Trodders", "=ds=#a3#", "", "25.0%" };
    { 7, 6469, "", "=q3=Venomstrike", "=ds=#w2#", "", "25.0%" };
    { 8, 10411, "", "=q3=Footpads of the Fang", "=ds=#a2#", "", "25.0%" };
	};

	AtlasLoot_Data["WCSerpentisMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Lord Serpentis", "=q5=ALL WILL DROP"};
    { 2, 9741, "", "=q1=Gem of Serpentis", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Mythic Lord Serpentis", "=q5=CHANCE TO DROP"};
    { 5, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 8, 0, "AO_Unknown", "=q6=Mythic Lord Serpentis", "=q5=ONE WILL DROP"};
    { 9, 6469, "", "=q3=Venomstrike", "=ds=#w2#", "", "25.0%" };
    { 10, 10411, "", "=q3=Footpads of the Fang", "=ds=#a2#", "", "25.0%" };
    { 11, 69334, "", "=q4=Serpent Gloves", "=ds=#a1#", "", "25.0%" };
    { 12, 69349, "", "=q4=Savage Trodders", "=ds=#a3#", "", "25.0%" };
	};

	AtlasLoot_Data["WCSerpentisHEROIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Heroic Lord Serpentis", "=q5=ALL WILL DROP"};
    { 2, 9741, "", "=q1=Gem of Serpentis", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Heroic Lord Serpentis", "=q5=CHANCE TO DROP"};
    { 5, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 8, 0, "AO_Unknown", "=q6=Heroic Lord Serpentis", "=q5=ONE WILL DROP"};
    { 9, 6469, "", "=q3=Venomstrike", "=ds=#w2#", "", "25.0%" };
    { 10, 10411, "", "=q3=Footpads of the Fang", "=ds=#a2#", "", "25.0%" };
    { 11, 66334, "", "=q4=Serpent Gloves", "=ds=#a1#", "", "25.0%" };
    { 12, 66349, "", "=q4=Savage Trodders", "=ds=#a3#", "", "25.0%" };
	};
	...
	AtlasLoot_Data["WCSkumMYTHIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Mythic Skum", "=q5=CHANCE TO DROP"};
    { 2, 6443, "", "=q1=Deviate Hide", "=ds=#m3#", "", "80.0%" };
    { 3, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 0, "AO_Unknown", "=q6=Mythic Skum", "=q5=ONE WILL DROP"};
    { 7, 69347, "", "=q4=Tail Spike", "=ds=#w4#", "", "50.0%" };
    { 8, 69348, "", "=q4=Glowing Lizardscale Cloak", "=ds=#a1#", "", "50.0%" };
	};

	AtlasLoot_Data["WCSkumHEROIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Heroic Skum", "=q5=CHANCE TO DROP"};
    { 2, 6443, "", "=q1=Deviate Hide", "=ds=#m3#", "", "80.0%" };
    { 3, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 0, "AO_Unknown", "=q6=Heroic Skum", "=q5=ONE WILL DROP"};
    { 7, 66347, "", "=q4=Tail Spike", "=ds=#w4#", "", "50.0%" };
    { 8, 66348, "", "=q4=Glowing Lizardscale Cloak", "=ds=#a1#", "", "50.0%" };
	};

	AtlasLoot_Data["WCPythas"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Lord Pythas", "=q5=ALL WILL DROP"};
    { 2, 9740, "", "=q1=Gem of Pythas", "=ds=#m3#", "", "100%" };
    { 4, 0, "AO_Unknown", "=q6=Lord Pythas", "=q5=ONE WILL DROP"};
    { 5, 6473, "", "=q3=Armor of the Fang", "=ds=#a2#", "", "60.0%" };
    { 6, 6472, "", "=q3=Stinging Viper", "=ds=#w6#", "", "40.0%" };
	};

	AtlasLoot_Data["WCPythasMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Lord Pythas", "=q5=ALL WILL DROP"};
    { 2, 9740, "", "=q1=Gem of Pythas", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Mythic Lord Pythas", "=q5=CHANCE TO DROP"};
    { 5, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 8, 0, "AO_Unknown", "=q6=Mythic Lord Pythas", "=q5=ONE WILL DROP"};
    { 9, 6473, "", "=q3=Armor of the Fang", "=ds=#a2#", "", "60.0%" };
    { 10, 6472, "", "=q3=Stinging Viper", "=ds=#w6#", "", "40.0%" };
	};

	AtlasLoot_Data["WCPythasHEROIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Heroic Lord Pythas", "=q5=ALL WILL DROP"};
    { 2, 9740, "", "=q1=Gem of Pythas", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Heroic Lord Pythas", "=q5=CHANCE TO DROP"};
    { 5, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 8, 0, "AO_Unknown", "=q6=Heroic Lord Pythas", "=q5=ONE WILL DROP"};
    { 9, 6473, "", "=q3=Armor of the Fang", "=ds=#a2#", "", "60.0%" };
    { 10, 6472, "", "=q3=Stinging Viper", "=ds=#w6#", "", "40.0%" };
	};
	...
	AtlasLoot_Data["WCKreshMYTHIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Mythic Kresh", "=q5=CHANCE TO DROP"};
    { 2, 6443, "", "=q1=Deviate Hide", "=ds=#m3#", "", "80.0%" };
    { 3, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 0, "AO_Unknown", "=q6=Mythic Kresh", "=q5=ONE WILL DROP"};
    { 7, 69346, "", "=q4=Worn Turtle Shell Shield", "=ds=#w8#", "", "90.0%" };
    { 8, 69637, "", "=q4=Kresh's Back", "=ds=#w8#", "", "10.0%" };
	};

	AtlasLoot_Data["WCKreshHEROIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Heroic Kresh", "=q5=CHANCE TO DROP"};
    { 2, 6443, "", "=q1=Deviate Hide", "=ds=#m3#", "", "80.0%" };
    { 3, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 0, "AO_Unknown", "=q6=Heroic Kresh", "=q5=ONE WILL DROP"};
    { 7, 66346, "", "=q4=Worn Turtle Shell Shield", "=ds=#w8#", "", "90.0%" };
    { 8, 66637, "", "=q4=Kresh's Back", "=ds=#w8#", "", "10.0%" };
	};
    ...
    { 5, 57466, "", "=q1=Technique: Scroll of Arcane Resistance II", "=ds=#e2#", "", "15.0%" };
	...
	AtlasLoot_Data["WCAnacondraMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Lady Anacondra", "=q5=ALL WILL DROP"};
    { 2, 9739, "", "=q1=Gem of Anacondra", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Mythic Lady Anacondra", "=q5=CHANCE TO DROP"};
    { 5, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 57466, "", "=q1=Technique: Scroll of Arcane Resistance II", "=ds=#e2#", "", "15.0%" };
    { 9, 0, "AO_Unknown", "=q6=Mythic Lady Anacondra", "=q5=ONE WILL DROP"};
    { 10, 69330, "", "=q4=Serpent's Shoulders", "=ds=#a2#", "", "80.0%" };
    { 11, 6446, "", "=q3=Snakeskin Bag", "=ds=#e1#", "", "10.0%" };
    { 12, 10412, "", "=q3=Belt of the Fang", "=ds=#a2#", "", "10.0%" };
	};

	AtlasLoot_Data["WCAnacondraHEROIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Heroic Lady Anacondra", "=q5=ALL WILL DROP"};
    { 2, 9739, "", "=q1=Gem of Anacondra", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Heroic Lady Anacondra", "=q5=CHANCE TO DROP"};
    { 5, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 57466, "", "=q1=Technique: Scroll of Arcane Resistance II", "=ds=#e2#", "", "15.0%" };
    { 9, 0, "AO_Unknown", "=q6=Heroic Lady Anacondra", "=q5=ONE WILL DROP"};
    { 10, 66330, "", "=q4=Serpent's Shoulders", "=ds=#a2#", "", "80.0%" };
    { 11, 6446, "", "=q3=Snakeskin Bag", "=ds=#e1#", "", "10.0%" };
    { 12, 10412, "", "=q3=Belt of the Fang", "=ds=#a2#", "", "10.0%" };
	};
    ...
    { 5, 57476, "", "=q1=Technique: Scroll of Nature Resistance II", "=ds=#e2#", "", "15.0%" };
    { 6, 59041, "", "=q2=Idol of the Wailing Grove", "", "", "10.0%" };
    { 8, 0, "AO_Unknown", "=q6=Lord Cobrahn", "=q5=ONE WILL DROP"};
    { 9, 6465, "", "=q3=Robe of the Moccasin", "=ds=#a1#", "", "60.0%" };
    { 10, 6460, "", "=q3=Cobrahn's Grasp", "=ds=#a3#", "", "20.0%" };
    { 11, 10410, "", "=q3=Leggings of the Fang", "=ds=#a2#", "", "20.0%" };
	};

	AtlasLoot_Data["WCCobrahnMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Lord Cobrahn", "=q5=ALL WILL DROP"};
    { 2, 9738, "", "=q1=Gem of Cobrahn", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Mythic Lord Cobrahn", "=q5=CHANCE TO DROP"};
    { 5, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 57476, "", "=q1=Technique: Scroll of Nature Resistance II", "=ds=#e2#", "", "15.0%" };
    { 8, 59041, "", "=q2=Idol of the Wailing Grove", "", "", "10.0%" };
    { 10, 0, "AO_Unknown", "=q6=Mythic Lord Cobrahn", "=q5=ONE WILL DROP"};
    { 11, 69353, "", "=q4=Robe of the Moccasin", "=ds=#a1#", "", "60.0%" };
    { 12, 10410, "", "=q3=Leggings of the Fang", "=ds=#a2#", "", "20.0%" };
    { 13, 69350, "", "=q4=Cobrahn's Grasp", "=ds=#a3#", "", "20.0%" };
	};

	AtlasLoot_Data["WCCobrahnHEROIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Heroic Lord Cobrahn", "=q5=ALL WILL DROP"};
    { 2, 9738, "", "=q1=Gem of Cobrahn", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Heroic Lord Cobrahn", "=q5=CHANCE TO DROP"};
    { 5, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 57476, "", "=q1=Technique: Scroll of Nature Resistance II", "=ds=#e2#", "", "15.0%" };
    { 8, 59041, "", "=q2=Idol of the Wailing Grove", "", "", "10.0%" };
    { 10, 0, "AO_Unknown", "=q6=Heroic Lord Cobrahn", "=q5=ONE WILL DROP"};
    { 11, 66353, "", "=q4=Robe of the Moccasin", "=ds=#a1#", "", "60.0%" };
    { 12, 10410, "", "=q3=Leggings of the Fang", "=ds=#a2#", "", "20.0%" };
    { 13, 66350, "", "=q4=Cobrahn's Grasp", "=ds=#a3#", "", "20.0%" };
	};

	AtlasLoot_Data["WCBoahn"] = {
    { 1, 0, "AO_Unknown", "=q6=Boahn", "=q5=ONE WILL DROP"};
    { 2, 5422, "", "=q2=Brambleweed Leggings", "=ds=#a2#", "", "60.0%" };
    { 3, 5423, "", "=q3=Boahn's Fang", "=ds=#w1#", "", "40.0%" };
	};

	AtlasLoot_Data["WCTrigore"] = {
    { 1, 0, "AO_Unknown", "=q6=Trigore the Lasher", "=q5=ONE WILL DROP"};
    { 2, 5425, "", "=q3=Runescale Girdle", "=ds=#a3#", "", "60.0%" };
    { 3, 5426, "", "=q3=Serpent's Kiss", "=ds=#w1#", "", "40.0%" };
	};

	AtlasLoot_Data["WCMagglish"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mad Magglish", "=q5=ALL WILL DROP"};
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6=Kel'Thuzad", "=q5=ALL WILL DROP"};
    { 2, 22520, "", "=q4=The Phylactery of Kel'Thuzad", "=ds=#e10#", "", "100%" };
    { 3, 22733, "", "=q1=Staff Head of Atiesh", "=ds=#m3#", "", "100%" };
    { 4, 30470, "", "=q0=NPC Equip 30470", "=ds=#e2#", "", "100%" };
    { 5, 30471, "", "=q0=NPC Equip 30471", "=ds=#e2#", "", "100%" };
    { 16, 0, "AO_Unknown", "=q6=Kel'Thuzad", "=q5=ONE WILL DROP"};
    ...
    { 1, 0, "AO_Unknown", "=q6=Sapphiron", "=q5=ONE WILL DROP"};
    { 2, 23040, "", "=q4=Glyph of Deflection", "=ds=#s14#", "", "10.0%" };
    { 3, 23041, "", "=q4=Slayer's Crest", "=ds=#s14#", "", "10.0%" };
    { 4, 23043, "", "=q4=The Face of Death", "=ds=#w8#", "", "10.0%" };
    { 5, 23045, "", "=q4=Shroud of Dominion", "=ds=#a1#", "", "10.0%" };
    { 6, 23046, "", "=q4=The Restrained Essence of Sapphiron", "=ds=#s14#", "", "10.0%" };
    { 7, 23047, "", "=q4=Eye of the Dead", "=ds=#s14#", "", "10.0%" };
    { 8, 23048, "", "=q4=Sapphiron's Right Eye", "=ds=#s15#", "", "10.0%" };
    { 9, 23049, "", "=q4=Sapphiron's Left Eye", "=ds=#s15#", "", "10.0%" };
    { 10, 23050, "", "=q4=Cloak of the Necropolis", "=ds=#a1#", "", "10.0%" };
    { 11, 23242, "", "=q4=Claw of the Frost Wyrm", "=ds=#w13#", "", "10.0%" };
    { 13, 0, "AO_Unknown", "=q6=Sapphiron", "=q5=ONE WILL DROP"};
    { 14, 23545, "", "=q4=Power of the Scourge", "=ds=#m3#", "", "50.0%" };
    { 15, 23547, "", "=q4=Resilience of the Scourge", "=ds=#m3#", "", "50.0%" };
    { 16, 0, "AO_Unknown", "=q6=Sapphiron", "=q5=ONE WILL DROP"};
    { 17, 23548, "", "=q4=Might of the Scourge", "=ds=#m3#", "", "50.0%" };
    { 18, 23549, "", "=q4=Fortitude of the Scourge", "=ds=#m3#", "", "50.0%" };
	};

	AtlasLoot_Data["Naxx40Thaddius"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Thaddius", "=q5=ALL WILL DROP"};
    { 2, 30450, "", "=q4=Warp-Spring Coil", "=ds=#s14#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Thaddius", "=q5=CHANCE TO DROP"};
    { 5, 22726, "", "=q5=Splinter of Atiesh", "=ds=#e10#", "", "30.0%" };
    { 7, 0, "AO_Unknown", "=q6=Thaddius", "=q5=ONE WILL DROP"};
    { 8, 22353, "", "=q4=Desecrated Helmet", "=ds=#e10#", "", "33.3%" };
    { 9, 22360, "", "=q4=Desecrated Headpiece", "=ds=#e10#", "", "33.3%" };
    { 10, 22367, "", "=q4=Desecrated Circlet", "=ds=#e10#", "", "33.3%" };
    { 16, 0, "AO_Unknown", "=q6=Thaddius", "=q5=ONE WILL DROP"};
    { 17, 22801, "", "=q4=Spire of Twilight", "=ds=#w9#", "", "20.0%" };
    { 18, 22808, "", "=q4=The Castigator", "=ds=#w6#", "", "20.0%" };
    { 19, 23000, "", "=q4=Plated Abomination Ribcage", "=ds=#a4#", "", "20.0%" };
    { 20, 23001, "", "=q4=Eye of Diminution", "=ds=#s14#", "", "20.0%" };
    { 21, 23070, "", "=q4=Leggings of Polarity", "=ds=#a1#", "", "20.0%" };
	};

	AtlasLoot_Data["Naxx40Gluth"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Gluth", "=q5=CHANCE TO DROP"};
    { 2, 22726, "", "=q5=Splinter of Atiesh", "=ds=#e10#", "", "30.0%" };
    { 4, 0, "AO_Unknown", "=q6=Gluth", "=q5=ONE WILL DROP"};
    { 5, 22354, "", "=q4=Desecrated Pauldrons", "=ds=#e10#", "", "8.33%" };
    { 6, 22355, "", "=q4=Desecrated Bracers", "=ds=#e10#", "", "8.33%" };
    { 7, 22356, "", "=q4=Desecrated Waistguard", "=ds=#e10#", "", "8.33%" };
    { 8, 22358, "", "=q4=Desecrated Sabatons", "=ds=#e10#", "", "8.33%" };
    { 9, 22361, "", "=q4=Desecrated Spaulders", "=ds=#e10#", "", "8.33%" };
    { 10, 22362, "", "=q4=Desecrated Wristguards", "=ds=#e10#", "", "8.33%" };
    { 11, 22363, "", "=q4=Desecrated Girdle", "=ds=#e10#", "", "8.33%" };
    { 12, 22365, "", "=q4=Desecrated Boots", "=ds=#e10#", "", "8.33%" };
    { 13, 22368, "", "=q4=Desecrated Shoulderpads", "=ds=#e10#", "", "8.33%" };
    { 14, 22369, "", "=q4=Desecrated Bindings", "=ds=#e10#", "", "8.33%" };
    { 15, 22370, "", "=q4=Desecrated Belt", "=ds=#e10#", "", "8.33%" };
    { 16, 22372, "", "=q4=Desecrated Sandals", "=ds=#e10#", "", "8.33%" };
    { 18, 0, "AO_Unknown", "=q6=Gluth", "=q5=ONE WILL DROP"};
    { 19, 22813, "", "=q4=Claymore of Unholy Might", "=ds=#w10#", "", "20.0%" };
    { 20, 22981, "", "=q4=Gluth's Missing Collar", "=ds=#s2#", "", "20.0%" };
    { 21, 22983, "", "=q4=Rime Covered Mantle", "=ds=#a1#", "", "20.0%" };
    { 22, 22994, "", "=q4=Digested Hand of Power", "=ds=#s15#", "", "20.0%" };
    { 23, 23075, "", "=q4=Death's Bargain", "=ds=#w8#", "", "20.0%" };
	};

	AtlasLoot_Data["Naxx40Grobbulus"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Grobbulus", "=q5=CHANCE TO DROP"};
    { 2, 22726, "", "=q5=Splinter of Atiesh", "=ds=#e10#", "", "30.0%" };
    { 4, 0, "AO_Unknown", "=q6=Grobbulus", "=q5=ONE WILL DROP"};
    { 5, 22354, "", "=q4=Desecrated Pauldrons", "=ds=#e10#", "", "33.3%" };
    { 6, 22361, "", "=q4=Desecrated Spaulders", "=ds=#e10#", "", "33.3%" };
    { 7, 22368, "", "=q4=Desecrated Shoulderpads", "=ds=#e10#", "", "33.3%" };
    { 9, 0, "AO_Unknown", "=q6=Grobbulus", "=q5=ONE WILL DROP"};
    { 10, 22803, "", "=q4=Midnight Haze", "=ds=#w4#", "", "20.0%" };
    { 11, 22810, "", "=q4=Toxin Injector", "=ds=#w5#", "", "20.0%" };
    { 12, 22967, "", "=q4=Icy Scale Spaulders", "=ds=#a3#", "", "20.0%" };
    { 13, 22968, "", "=q4=Glacial Mantle", "=ds=#a1#", "", "20.0%" };
    { 14, 22988, "", "=q4=The End of Dreams", "=ds=#w6#", "", "20.0%" };
	};

	AtlasLoot_Data["Naxx40Patchwerk"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Patchwerk", "=q5=CHANCE TO DROP"};
    { 2, 22726, "", "=q5=Splinter of Atiesh", "=ds=#e10#", "", "30.0%" };
    { 4, 0, "AO_Unknown", "=q6=Patchwerk", "=q5=ONE WILL DROP"};
    { 5, 22354, "", "=q4=Desecrated Pauldrons", "=ds=#e10#", "", "33.3%" };
    { 6, 22361, "", "=q4=Desecrated Spaulders", "=ds=#e10#", "", "33.3%" };
    { 7, 22368, "", "=q4=Desecrated Shoulderpads", "=ds=#e10#", "", "33.3%" };
    { 9, 0, "AO_Unknown", "=q6=Patchwerk", "=q5=ONE WILL DROP"};
    { 10, 22815, "", "=q4=Severance", "=ds=#w1#", "", "20.0%" };
    { 11, 22818, "", "=q4=The Plague Bearer", "=ds=#w8#", "", "20.0%" };
    { 12, 22820, "", "=q4=Wand of Fates", "=ds=#w12#", "", "20.0%" };
    { 13, 22960, "", "=q4=Cloak of Suturing", "=ds=#a1#", "", "20.0%" };
    { 14, 22961, "", "=q4=Band of Reanimation", "=ds=#s13#", "", "20.0%" };
	};

	AtlasLoot_Data["Naxx40Gothik"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Gothik the Harvester", "=q5=CHANCE TO DROP"};
    { 2, 22726, "", "=q5=Splinter of Atiesh", "=ds=#e10#", "", "30.0%" };
    { 4, 0, "AO_Unknown", "=q6=Gothik the Harvester", "=q5=ONE WILL DROP"};
    { 5, 22358, "", "=q4=Desecrated Sabatons", "=ds=#e10#", "", "33.3%" };
    { 6, 22365, "", "=q4=Desecrated Boots", "=ds=#e10#", "", "33.3%" };
    { 7, 22372, "", "=q4=Desecrated Sandals", "=ds=#e10#", "", "33.3%" };
    { 9, 0, "AO_Unknown", "=q6=Gothik the Harvester", "=q5=ONE WILL DROP"};
    { 10, 23020, "", "=q4=Polar Helmet", "=ds=#a2#", "", "20.0%" };
    { 11, 23021, "", "=q4=The Soul Harvester's Bindings", "=ds=#a1#", "", "20.0%" };
    { 12, 23023, "", "=q4=Sadist's Collar", "=ds=#s2#", "", "20.0%" };
    { 13, 23032, "", "=q4=Glacial Headdress", "=ds=#a1#", "", "20.0%" };
    { 14, 23073, "", "=q4=Boots of Displacement", "=ds=#a2#", "", "20.0%" };
	};

	AtlasLoot_Data["Naxx40Razuvious"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Instructor Razuvious", "=q5=CHANCE TO DROP"};
    { 2, 22726, "", "=q5=Splinter of Atiesh", "=ds=#e10#", "", "30.0%" };
    { 4, 0, "AO_Unknown", "=q6=Instructor Razuvious", "=q5=ONE WILL DROP"};
    { 5, 22358, "", "=q4=Desecrated Sabatons", "=ds=#e10#", "", "33.3%" };
    { 6, 22365, "", "=q4=Desecrated Boots", "=ds=#e10#", "", "33.3%" };
    { 7, 22372, "", "=q4=Desecrated Sandals", "=ds=#e10#", "", "33.3%" };
    { 9, 0, "AO_Unknown", "=q6=Instructor Razuvious", "=q5=ONE WILL DROP"};
    { 10, 23004, "", "=q4=Idol of Longevity", "", "", "16.7%" };
    { 11, 23009, "", "=q4=Wand of the Whispering Dead", "=ds=#w12#", "", "16.7%" };
    { 12, 23014, "", "=q4=Iblis, Blade of the Fallen Seraph", "=ds=#w10#", "", "16.7%" };
    { 13, 23017, "", "=q4=Veil of Eclipse", "=ds=#a1#", "", "16.7%" };
    { 14, 23018, "", "=q4=Signet of the Fallen Defender", "=ds=#s13#", "", "16.7%" };
    { 15, 23219, "", "=q4=Girdle of the Mentor", "=ds=#a4#", "", "16.7%" };
	};

	AtlasLoot_Data["Naxx40Loatheb"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Loatheb", "=q5=ALL WILL DROP"};
    { 2, 30474, "", "=q0=NPC Equip 30474", "=ds=#e2#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Loatheb", "=q5=CHANCE TO DROP"};
    { 5, 22726, "", "=q5=Splinter of Atiesh", "=ds=#e10#", "", "30.0%" };
    { 7, 0, "AO_Unknown", "=q6=Loatheb", "=q5=ONE WILL DROP"};
    { 8, 22352, "", "=q4=Desecrated Legplates", "=ds=#e10#", "", "33.3%" };
    { 9, 22359, "", "=q4=Desecrated Legguards", "=ds=#e10#", "", "33.3%" };
    { 10, 22366, "", "=q4=Desecrated Leggings", "=ds=#e10#", "", "33.3%" };
    { 16, 0, "AO_Unknown", "=q6=Loatheb", "=q5=ONE WILL DROP"};
    { 17, 22800, "", "=q4=Brimstone Staff", "=ds=#w9#", "", "20.0%" };
    { 18, 23037, "", "=q4=Ring of Spiritual Fervor", "=ds=#s13#", "", "20.0%" };
    { 19, 23038, "", "=q4=Band of Unnatural Forces", "=ds=#s13#", "", "20.0%" };
    { 20, 23039, "", "=q4=The Eye of Nerub", "=ds=#w7#", "", "20.0%" };
    { 21, 23042, "", "=q4=Loatheb's Reflection", "=ds=#s14#", "", "20.0%" };
	};

	AtlasLoot_Data["Naxx40Heigan"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Heigan the Unclean", "=q5=CHANCE TO DROP"};
    { 2, 22726, "", "=q5=Splinter of Atiesh", "=ds=#e10#", "", "30.0%" };
    { 4, 0, "AO_Unknown", "=q6=Heigan the Unclean", "=q5=ONE WILL DROP"};
    { 5, 22356, "", "=q4=Desecrated Waistguard", "=ds=#e10#", "", "33.3%" };
    { 6, 22363, "", "=q4=Desecrated Girdle", "=ds=#e10#", "", "33.3%" };
    { 7, 22370, "", "=q4=Desecrated Belt", "=ds=#e10#", "", "33.3%" };
    { 9, 0, "AO_Unknown", "=q6=Heigan the Unclean", "=q5=ONE WILL DROP"};
    { 10, 23019, "", "=q4=Icebane Helmet", "=ds=#a4#", "", "20.0%" };
    { 11, 23033, "", "=q4=Icy Scale Coif", "=ds=#a3#", "", "20.0%" };
    { 12, 23035, "", "=q4=Preceptor's Hat", "=ds=#a1#", "", "20.0%" };
    { 13, 23036, "", "=q4=Necklace of Necropsy", "=ds=#s2#", "", "20.0%" };
    { 14, 23068, "", "=q4=Legplates of Carnage", "=ds=#a4#", "", "20.0%" };
	};

	AtlasLoot_Data["Naxx40Noth"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Noth the Plaguebringer", "=q5=CHANCE TO DROP"};
    { 2, 22726, "", "=q5=Splinter of Atiesh", "=ds=#e10#", "", "30.0%" };
    { 4, 0, "AO_Unknown", "=q6=Noth the Plaguebringer", "=q5=ONE WILL DROP"};
    { 5, 22356, "", "=q4=Desecrated Waistguard", "=ds=#e10#", "", "33.3%" };
    { 6, 22363, "", "=q4=Desecrated Girdle", "=ds=#e10#", "", "33.3%" };
    { 7, 22370, "", "=q4=Desecrated Belt", "=ds=#e10#", "", "33.3%" };
    { 9, 0, "AO_Unknown", "=q6=Noth the Plaguebringer", "=q5=ONE WILL DROP"};
    { 10, 22816, "", "=q4=Hatchet of Sundered Bone", "=ds=#w1#", "", "14.3%" };
    { 11, 23005, "", "=q4=Totem of Flowing Water", "", "", "14.3%" };
    { 12, 23006, "", "=q4=Libram of Light", "", "", "14.3%" };
    { 13, 23028, "", "=q4=Hailstone Band", "=ds=#s13#", "", "14.3%" };
    { 14, 23029, "", "=q4=Noth's Frigid Heart", "=ds=#s15#", "", "14.3%" };
    { 15, 23030, "", "=q4=Cloak of the Scourge", "=ds=#a1#", "", "14.3%" };
    { 16, 23031, "", "=q4=Band of the Inevitable", "=ds=#s13#", "", "14.3%" };
	};

	AtlasLoot_Data["Naxx40Maexxna"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Maexxna", "=q5=ALL WILL DROP"};
    { 2, 30459, "", "=q3=Netherflame Robe", "=ds=#a1#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Maexxna", "=q5=CHANCE TO DROP"};
    { 5, 22726, "", "=q5=Splinter of Atiesh", "=ds=#e10#", "", "30.0%" };
    { 7, 0, "AO_Unknown", "=q6=Maexxna", "=q5=ONE WILL DROP"};
    { 8, 22357, "", "=q4=Desecrated Gauntlets", "=ds=#e10#", "", "33.3%" };
    { 9, 22364, "", "=q4=Desecrated Handguards", "=ds=#e10#", "", "33.3%" };
    { 10, 22371, "", "=q4=Desecrated Gloves", "=ds=#e10#", "", "33.3%" };
    { 16, 0, "AO_Unknown", "=q6=Maexxna", "=q5=ONE WILL DROP"};
    { 17, 22804, "", "=q4=Maexxna's Fang", "=ds=#w4#", "", "20.0%" };
    { 18, 22807, "", "=q4=Wraith Blade", "=ds=#w10#", "", "20.0%" };
    { 19, 22947, "", "=q4=Pendant of Forgotten Names", "=ds=#s2#", "", "20.0%" };
    { 20, 22954, "", "=q4=Kiss of the Spider", "=ds=#s14#", "", "20.0%" };
    { 21, 23220, "", "=q4=Crystal Webbed Robe", "=ds=#a1#", "", "20.0%" };
	};

	AtlasLoot_Data["Naxx40Faerlina"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Grand Widow Faerlina", "=q5=CHANCE TO DROP"};
    { 2, 22726, "", "=q5=Splinter of Atiesh", "=ds=#e10#", "", "30.0%" };
    { 4, 0, "AO_Unknown", "=q6=Grand Widow Faerlina", "=q5=ONE WILL DROP"};
    { 5, 22355, "", "=q4=Desecrated Bracers", "=ds=#e10#", "", "33.3%" };
    { 6, 22362, "", "=q4=Desecrated Wristguards", "=ds=#e10#", "", "33.3%" };
    { 7, 22369, "", "=q4=Desecrated Bindings", "=ds=#e10#", "", "33.3%" };
    { 9, 0, "AO_Unknown", "=q6=Grand Widow Faerlina", "=q5=ONE WILL DROP"};
    { 10, 22806, "", "=q4=Widow's Remorse", "=ds=#w10#", "", "20.0%" };
    { 11, 22940, "", "=q4=Icebane Pauldrons", "=ds=#a4#", "", "20.0%" };
    { 12, 22941, "", "=q4=Polar Shoulder Pads", "=ds=#a2#", "", "20.0%" };
    { 13, 22942, "", "=q4=The Widow's Embrace", "=ds=#w6#", "", "20.0%" };
    { 14, 22943, "", "=q4=Malice Stone Pendant", "=ds=#s2#", "", "20.0%" };
	};

	AtlasLoot_Data["Naxx40AnubRekhan"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Anub'Rekhan", "=q5=CHANCE TO DROP"};
    { 2, 22726, "", "=q5=Splinter of Atiesh", "=ds=#e10#", "", "30.0%" };
    { 4, 0, "AO_Unknown", "=q6=Anub'Rekhan", "=q5=ONE WILL DROP"};
    { 5, 22355, "", "=q4=Desecrated Bracers", "=ds=#e10#", "", "33.3%" };
    { 6, 22362, "", "=q4=Desecrated Wristguards", "=ds=#e10#", "", "33.3%" };
    { 7, 22369, "", "=q4=Desecrated Bindings", "=ds=#e10#", "", "33.3%" };
    { 9, 0, "AO_Unknown", "=q6=Anub'Rekhan", "=q5=ONE WILL DROP"};
    { 10, 22935, "", "=q4=Touch of Frost", "=ds=#s2#", "", "20.0%" };
    { 11, 22936, "", "=q4=Wristguards of Vengeance", "=ds=#a4#", "", "20.0%" };
    { 12, 22937, "", "=q4=Gem of Nerubis", "=ds=#s15#", "", "20.0%" };
    { 13, 22938, "", "=q4=Cryptfiend Silk Cloak", "=ds=#a1#", "", "20.0%" };
    { 14, 22939, "", "=q4=Band of Unanswered Prayers", "=ds=#s13#", "", "20.0%" };
	};
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6=Darkmaster Gandling", "=q5=ALL WILL DROP"};
    { 2, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    { 3, 58726, "", "=q1=Gandling's Plague Formula", "=ds=#m3#", "", "100%" };
    { 4, 59000, "", "=q3=Gandling's Armor Cache - Helm", "=ds=#e10#", "", "100%" };
    { 6, 0, "RoM_stellar_dice", "=q6=Darkmaster Gandling", "=q5=CHANCE TO DROP"};
    { 7, 57473, "", "=q1=Technique: Scroll of Shadow Resistance IV", "=ds=#e2#", "", "15.0%" };
    { 8, 13501, "", "=q1=Recipe: Major Mana Potion", "=ds=#e2#", "", "10.0%" };
    { 9, 59090, "", "=q3=Idol of Scholar's Renewal", "", "", "10.0%" };
    { 10, 14514, "", "=q4=Pattern: Robe of the Void", "=ds=#e2#", "", "7.00%" };
	...
	AtlasLoot_Data["SCHOLOGandlingMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Darkmaster Gandling", "=q5=ALL WILL DROP"};
    { 2, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    { 3, 58726, "", "=q1=Gandling's Plague Formula", "=ds=#m3#", "", "100%" };
    { 4, 59000, "", "=q3=Gandling's Armor Cache - Helm", "=ds=#e10#", "", "100%" };
    { 6, 0, "RoM_stellar_dice", "=q6=Mythic Darkmaster Gandling", "=q5=CHANCE TO DROP"};
    { 7, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 8, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 9, 57473, "", "=q1=Technique: Scroll of Shadow Resistance IV", "=ds=#e2#", "", "15.0%" };
    { 10, 13501, "", "=q1=Recipe: Major Mana Potion", "=ds=#e2#", "", "10.0%" };
    { 11, 59090, "", "=q3=Idol of Scholar's Renewal", "", "", "10.0%" };
    { 12, 14514, "", "=q4=Pattern: Robe of the Void", "=ds=#e2#", "", "7.00%" };
    { 13, 69701, "", "=q4=Detention Strap", "=ds=#a3#", "", "1.00%" };
    { 16, 0, "AO_Unknown", "=q6=Mythic Darkmaster Gandling", "=q5=ONE WILL DROP"};
    { 17, 13953, "", "=q3=Silent Fang", "=ds=#w10#", "", "14.0%" };
    { 18, 69675, "", "=q4=Boots of the Shrieker", "=ds=#a2#", "", "14.0%" };
    { 19, 69699, "", "=q4=Bonecreeper Stylus", "=ds=#w12#", "", "14.0%" };
    { 20, 69700, "", "=q4=Tombstone Breastplate", "=ds=#a2#", "", "14.0%" };
    { 21, 69702, "", "=q4=Vigorsteel Vambraces", "=ds=#a4#", "", "14.0%" };
    { 22, 69708, "", "=q4=Witchblade", "=ds=#w4#", "", "14.0%" };
    { 23, 69974, "", "=q4=Don Mauricio's Band of Domination", "=ds=#s13#", "", "14.0%" };
    { 24, 13937, "", "=q4=Headmaster's Charge", "=ds=#w9#", "", "2.00%" };
	};
    ...
    { 3, 58726, "", "=q1=Gandling's Plague Formula", "=ds=#m3#", "", "100%" };
    { 4, 59000, "", "=q3=Gandling's Armor Cache - Helm", "=ds=#e10#", "", "100%" };
    { 6, 0, "RoM_stellar_dice", "=q6=Heroic Darkmaster Gandling", "=q5=CHANCE TO DROP"};
    { 7, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 8, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 9, 57473, "", "=q1=Technique: Scroll of Shadow Resistance IV", "=ds=#e2#", "", "15.0%" };
    { 10, 13501, "", "=q1=Recipe: Major Mana Potion", "=ds=#e2#", "", "10.0%" };
    { 11, 59090, "", "=q3=Idol of Scholar's Renewal", "", "", "10.0%" };
    { 12, 14514, "", "=q4=Pattern: Robe of the Void", "=ds=#e2#", "", "7.00%" };
    { 13, 66701, "", "=q4=Detention Strap", "=ds=#a3#", "", "1.00%" };
    { 16, 0, "AO_Unknown", "=q6=Heroic Darkmaster Gandling", "=q5=ONE WILL DROP"};
    { 17, 13953, "", "=q3=Silent Fang", "=ds=#w10#", "", "14.0%" };
    { 18, 66675, "", "=q4=Boots of the Shrieker", "=ds=#a2#", "", "14.0%" };
    { 19, 66699, "", "=q4=Bonecreeper Stylus", "=ds=#w12#", "", "14.0%" };
    { 20, 66700, "", "=q4=Tombstone Breastplate", "=ds=#a2#", "", "14.0%" };
    { 21, 66702, "", "=q4=Vigorsteel Vambraces", "=ds=#a4#", "", "14.0%" };
    { 22, 66708, "", "=q4=Witchblade", "=ds=#w4#", "", "14.0%" };
    { 23, 66974, "", "=q4=Don Mauricio's Band of Domination", "=ds=#s13#", "", "14.0%" };
    { 24, 13937, "", "=q4=Headmaster's Charge", "=ds=#w9#", "", "2.00%" };
	};
    ...
    { 6, 57471, "", "=q1=Technique: Scroll of Shadow Resistance II", "=ds=#e2#", "", "15.0%" };
    { 7, 59040, "", "=q2=Idol of the Brackish Tide", "", "", "10.0%" };
    { 9, 0, "AO_Unknown", "=q6=Edwin VanCleef", "=q5=ONE WILL DROP"};
    { 10, 5193, "", "=q3=Cape of the Brotherhood", "=ds=#a1#", "", "30.0%" };
    { 11, 5202, "", "=q3=Corsair's Overshirt", "=ds=#a1#", "", "30.0%" };
    { 12, 5191, "", "=q3=Cruel Barb", "=ds=#w10#", "", "20.0%" };
    { 13, 10399, "", "=q3=Blackened Defias Armor", "=ds=#a2#", "", "20.0%" };
	};

	AtlasLoot_Data["VCVanCleefMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Edwin VanCleef", "=q5=ALL WILL DROP"};
    { 2, 2874, "", "=q1=An Unsent Letter", "=ds=#m3#", "", "100%" };
    { 3, 3637, "", "=q1=Head of VanCleef", "=ds=#m3#", "", "100%" };
    { 5, 0, "RoM_stellar_dice", "=q6=Mythic Edwin VanCleef", "=q5=CHANCE TO DROP"};
    { 6, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 8, 57471, "", "=q1=Technique: Scroll of Shadow Resistance II", "=ds=#e2#", "", "15.0%" };
    { 9, 59040, "", "=q2=Idol of the Brackish Tide", "", "", "10.0%" };
    { 11, 0, "AO_Unknown", "=q6=Mythic Edwin VanCleef", "=q5=ONE WILL DROP"};
    { 12, 69318, "", "=q4=Cape of the Brotherhood", "=ds=#a1#", "", "30.0%" };
    { 13, 69327, "", "=q4=Corsair's Overshirt", "=ds=#a1#", "", "30.0%" };
    { 14, 10399, "", "=q3=Blackened Defias Armor", "=ds=#a2#", "", "20.0%" };
    { 15, 69316, "", "=q4=Cruel Barb", "=ds=#w10#", "", "20.0%" };
	};
    ...
    { 2, 2874, "", "=q1=An Unsent Letter", "=ds=#m3#", "", "100%" };
    { 3, 3637, "", "=q1=Head of VanCleef", "=ds=#m3#", "", "100%" };
    { 5, 0, "RoM_stellar_dice", "=q6=Heroic Edwin VanCleef", "=q5=CHANCE TO DROP"};
    { 6, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 8, 57471, "", "=q1=Technique: Scroll of Shadow Resistance II", "=ds=#e2#", "", "15.0%" };
    { 9, 59040, "", "=q2=Idol of the Brackish Tide", "", "", "10.0%" };
    { 11, 0, "AO_Unknown", "=q6=Heroic Edwin VanCleef", "=q5=ONE WILL DROP"};
    { 12, 66318, "", "=q4=Cape of the Brotherhood", "=ds=#a1#", "", "30.0%" };
    { 13, 66327, "", "=q4=Corsair's Overshirt", "=ds=#a1#", "", "30.0%" };
    { 14, 10399, "", "=q3=Blackened Defias Armor", "=ds=#a2#", "", "20.0%" };
    { 15, 66316, "", "=q4=Cruel Barb", "=ds=#w10#", "", "20.0%" };
	};
	...
	AtlasLoot_Data["VCGreenskinMYTHIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Mythic Captain Greenskin", "=q5=CHANCE TO DROP"};
    { 2, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 5, 0, "AO_Unknown", "=q6=Mythic Captain Greenskin", "=q5=ONE WILL DROP"};
    { 6, 69326, "", "=q4=Emberstone Staff", "=ds=#w9#", "", "40.0%" };
    { 7, 10403, "", "=q3=Blackened Defias Belt", "=ds=#a2#", "", "30.0%" };
    { 8, 69325, "", "=q4=Impaling Harpoon", "=ds=#w7#", "", "30.0%" };
	};

	AtlasLoot_Data["VCGreenskinHEROIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Heroic Captain Greenskin", "=q5=CHANCE TO DROP"};
    { 2, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 5, 0, "AO_Unknown", "=q6=Heroic Captain Greenskin", "=q5=ONE WILL DROP"};
    { 6, 66326, "", "=q4=Emberstone Staff", "=ds=#w9#", "", "40.0%" };
    { 7, 10403, "", "=q3=Blackened Defias Belt", "=ds=#a2#", "", "30.0%" };
    { 8, 66325, "", "=q4=Impaling Harpoon", "=ds=#w7#", "", "30.0%" };
	};

	AtlasLoot_Data["VCCookie"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Cookie", "=q5=ALL WILL DROP"};
    { 2, 58727, "", "=q1=Stabby Patty Secret Formula", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Cookie", "=q5=CHANCE TO DROP"};
    { 5, 8490, "", "=q1=Cat Carrier (Siamese)", "=ds=#e10#", "", "15.0%" };
    { 6, 57461, "", "=q1=Technique: Scroll of Frost Resistance II", "=ds=#e2#", "", "15.0%" };
	...
	AtlasLoot_Data["VCCookieMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Cookie", "=q5=ALL WILL DROP"};
    { 2, 58727, "", "=q1=Stabby Patty Secret Formula", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Mythic Cookie", "=q5=CHANCE TO DROP"};
    { 5, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 8490, "", "=q1=Cat Carrier (Siamese)", "=ds=#e10#", "", "15.0%" };
    { 8, 57461, "", "=q1=Technique: Scroll of Frost Resistance II", "=ds=#e2#", "", "15.0%" };
    { 10, 0, "AO_Unknown", "=q6=Mythic Cookie", "=q5=ONE WILL DROP"};
    { 11, 69322, "", "=q4=Cookie's Tenderizer", "=ds=#w6#", "", "65.0%" };
    { 12, 69323, "", "=q4=Cookie's Stirring Rod", "=ds=#w12#", "", "35.0%" };
	};

	AtlasLoot_Data["VCCookieHEROIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Heroic Cookie", "=q5=ALL WILL DROP"};
    { 2, 58727, "", "=q1=Stabby Patty Secret Formula", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Heroic Cookie", "=q5=CHANCE TO DROP"};
    { 5, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 8490, "", "=q1=Cat Carrier (Siamese)", "=ds=#e10#", "", "15.0%" };
    { 8, 57461, "", "=q1=Technique: Scroll of Frost Resistance II", "=ds=#e2#", "", "15.0%" };
    { 10, 0, "AO_Unknown", "=q6=Heroic Cookie", "=q5=ONE WILL DROP"};
    { 11, 66322, "", "=q4=Cookie's Tenderizer", "=ds=#w6#", "", "65.0%" };
    { 12, 66323, "", "=q4=Cookie's Stirring Rod", "=ds=#w12#", "", "35.0%" };
	};

	AtlasLoot_Data["VCSmite"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Mr. Smite", "=q5=CHANCE TO DROP"};
    { 2, 57481, "", "=q1=Technique: Scroll of Holy Resistance II", "=ds=#e2#", "", "15.0%" };
    { 3, 59039, "", "=q2=Libram of Dawn's Grace", "", "", "10.0%" };
    { 5, 0, "AO_Unknown", "=q6=Mr. Smite", "=q5=ONE WILL DROP"};
    { 6, 5192, "", "=q3=Thief's Blade", "=ds=#w10#", "", "40.0%" };
    { 7, 5196, "", "=q3=Smite's Reaver", "=ds=#w1#", "", "40.0%" };
    { 8, 7230, "", "=q3=Smite's Mighty Hammer", "=ds=#w6#", "", "20.0%" };
	};

	AtlasLoot_Data["VCSmiteMYTHIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Mythic Mr. Smite", "=q5=CHANCE TO DROP"};
    { 2, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 57481, "", "=q1=Technique: Scroll of Holy Resistance II", "=ds=#e2#", "", "15.0%" };
    { 5, 59039, "", "=q2=Libram of Dawn's Grace", "", "", "10.0%" };
    { 7, 0, "AO_Unknown", "=q6=Mythic Mr. Smite", "=q5=ONE WILL DROP"};
    { 8, 69317, "", "=q4=Thief's Blade", "=ds=#w10#", "", "40.0%" };
    { 9, 69321, "", "=q4=Smite's Reaver", "=ds=#w1#", "", "40.0%" };
    { 10, 69387, "", "=q4=Smite's Mighty Hammer", "=ds=#w6#", "", "20.0%" };
	};

	AtlasLoot_Data["VCSmiteHEROIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Heroic Mr. Smite", "=q5=CHANCE TO DROP"};
    { 2, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 57481, "", "=q1=Technique: Scroll of Holy Resistance II", "=ds=#e2#", "", "15.0%" };
    { 5, 59039, "", "=q2=Libram of Dawn's Grace", "", "", "10.0%" };
    { 7, 0, "AO_Unknown", "=q6=Heroic Mr. Smite", "=q5=ONE WILL DROP"};
    { 8, 66317, "", "=q4=Thief's Blade", "=ds=#w10#", "", "40.0%" };
    { 9, 66321, "", "=q4=Smite's Reaver", "=ds=#w1#", "", "40.0%" };
    { 10, 66387, "", "=q4=Smite's Mighty Hammer", "=ds=#w6#", "", "20.0%" };
	};
	...
	AtlasLoot_Data["VCGilnidMYTHIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Mythic Gilnid", "=q5=CHANCE TO DROP"};
    { 2, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 5, 0, "AO_Unknown", "=q6=Mythic Gilnid", "=q5=ONE WILL DROP"};
    { 6, 69324, "", "=q4=Smelting Pants", "=ds=#a2#", "", "55.0%" };
    { 7, 69303, "", "=q4=Lavishly Jeweled Ring", "=ds=#s13#", "", "45.0%" };
	};

	AtlasLoot_Data["VCGilnidHEROIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Heroic Gilnid", "=q5=CHANCE TO DROP"};
    { 2, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 5, 0, "AO_Unknown", "=q6=Heroic Gilnid", "=q5=ONE WILL DROP"};
    { 6, 66324, "", "=q4=Smelting Pants", "=ds=#a2#", "", "55.0%" };
    { 7, 66303, "", "=q4=Lavishly Jeweled Ring", "=ds=#s13#", "", "45.0%" };
	};

	AtlasLoot_Data["VCMinerJohnson"] = {
    { 1, 0, "AO_Unknown", "=q6=Miner Johnson", "=q5=ONE WILL DROP"};
    { 2, 5444, "", "=q3=Miner's Cape", "=ds=#a1#", "", "65.0%" };
    { 3, 5443, "", "=q3=Gold-plated Buckler", "=ds=#w8#", "", "35.0%" };
	};

	AtlasLoot_Data["VCSneed"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Sneed's Shredder", "=q5=ALL WILL DROP"};
    { 2, 7365, "", "=q1=Gnoam Sprecklesprocket", "=ds=#m3#", "", "100%" };
    { 4, 0, "AO_Unknown", "=q6=Sneed's Shredder", "=q5=ONE WILL DROP"};
    { 5, 2169, "", "=q3=Buzzer Blade", "=ds=#w4#", "", "90.0%" };
    { 6, 1937, "", "=q3=Buzz Saw", "=ds=#w10#", "", "10.0%" };
    { 9, 0, "AO_Unknown", "=q6=Sneed", "=q5=ONE WILL DROP"};
    { 10, 5195, "", "=q3=Gold-flecked Gloves", "=ds=#a1#", "", "65.0%" };
    { 11, 5194, "", "=q3=Taskmaster Axe", "=ds=#w1#", "", "35.0%" };
	};

	AtlasLoot_Data["VCThistlenettle"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Foreman Thistlenettle", "=q5=ALL WILL DROP"};
    { 2, 1875, "", "=q1=Thistlenettle's Badge", "=ds=#m3#", "", "100%" };
	};

	AtlasLoot_Data["VCNoble"] = {
    { 1, 0, "AO_Unknown", "=q6=Brainwashed Noble", "=q5=ONE WILL DROP"};
    { 2, 5967, "", "=q2=Girdle of Nobility", "=ds=#a1#", "", "70.0%" };
    { 3, 3902, "", "=q2=Staff of Nobles", "=ds=#w9#", "", "30.0%" };
	};
	...
	AtlasLoot_Data["VCRhahkZorMYTHIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Mythic Rhahk'Zor", "=q5=CHANCE TO DROP"};
    { 2, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 5, 0, "AO_Unknown", "=q6=Mythic Rhahk'Zor", "=q5=ONE WILL DROP"};
    { 6, 69315, "", "=q4=Rhahk'Zor's Hammer", "=ds=#w6#", "", "95.0%" };
    { 7, 69300, "", "=q4=Rockslicer", "=ds=#w1#", "", "5.00%" };
	};

	AtlasLoot_Data["VCRhahkZorHEROIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Heroic Rhahk'Zor", "=q5=CHANCE TO DROP"};
    { 2, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 5, 0, "AO_Unknown", "=q6=Heroic Rhahk'Zor", "=q5=ONE WILL DROP"};
    { 6, 66315, "", "=q4=Rhahk'Zor's Hammer", "=ds=#w6#", "", "95.0%" };
    { 7, 66300, "", "=q4=Rockslicer", "=ds=#w1#", "", "5.00%" };
	};

	AtlasLoot_Data["VCMarisa"] = {
    { 1, 0, "AO_Unknown", "=q6=Marisa du'Paige", "=q5=ONE WILL DROP"};
    { 2, 4660, "", "=q2=Walking Boots", "=ds=#a1#", "", "75.0%" };
    { 3, 3019, "", "=q2=Noble's Robe", "=ds=#a1#", "", "25.0%" };
	};
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6=Kirtonos the Herald", "=q5=ALL WILL DROP"};
    { 2, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    { 4, 0, "AO_Unknown", "=q6=Kirtonos the Herald", "=q5=ONE WILL DROP"};
    { 5, 13955, "", "=q3=Stoneform Shoulders", "=ds=#a4#", "", "11.1%" };
    { 6, 13956, "", "=q3=Clutch of Andros", "=ds=#a1#", "", "11.1%" };
    { 7, 13957, "", "=q3=Gargoyle Slashers", "=ds=#a2#", "", "11.1%" };
    { 8, 13960, "", "=q3=Heart of the Fiend", "=ds=#s2#", "", "11.1%" };
    { 9, 13967, "", "=q3=Windreaver Greaves", "=ds=#a3#", "", "11.1%" };
    { 10, 13969, "", "=q3=Loomguard Armbraces", "=ds=#a3#", "", "11.1%" };
    { 11, 13983, "", "=q3=Gravestone War Axe", "=ds=#w1#", "", "11.1%" };
    { 12, 14024, "", "=q3=Frightalon", "=ds=#w4#", "", "11.1%" };
    { 13, 16734, "", "=q3=Boots of Valor", "=ds=#a4#", "", "11.1%" };
	};

	AtlasLoot_Data["SCHOLOKirtonostheHeraldMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Kirtonos the Herald", "=q5=ALL WILL DROP"};
    { 2, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Mythic Kirtonos the Herald", "=q5=CHANCE TO DROP"};
    { 5, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 16, 0, "AO_Unknown", "=q6=Mythic Kirtonos the Herald", "=q5=ONE WILL DROP"};
    { 17, 13956, "", "=q3=Clutch of Andros", "=ds=#a1#", "", "11.1%" };
    { 18, 13983, "", "=q3=Gravestone War Axe", "=ds=#w1#", "", "11.1%" };
    { 19, 14024, "", "=q3=Frightalon", "=ds=#w4#", "", "11.1%" };
    { 20, 16734, "", "=q3=Boots of Valor", "=ds=#a4#", "", "11.1%" };
    { 21, 69705, "", "=q4=Stoneform Shoulders", "=ds=#a4#", "", "11.1%" };
    { 22, 69706, "", "=q4=Gargoyle Slashers", "=ds=#a2#", "", "11.1%" };
    { 23, 69707, "", "=q4=Heart of the Fiend", "=ds=#s2#", "", "11.1%" };
    { 24, 69709, "", "=q4=Windreaver Greaves", "=ds=#a3#", "", "11.1%" };
    { 25, 69710, "", "=q4=Loomguard Armbraces", "=ds=#a3#", "", "11.1%" };
	};

	AtlasLoot_Data["SCHOLOKirtonostheHeraldHEROIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Heroic Kirtonos the Herald", "=q5=ALL WILL DROP"};
    { 2, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Heroic Kirtonos the Herald", "=q5=CHANCE TO DROP"};
    { 5, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 16, 0, "AO_Unknown", "=q6=Heroic Kirtonos the Herald", "=q5=ONE WILL DROP"};
    { 17, 13956, "", "=q3=Clutch of Andros", "=ds=#a1#", "", "11.1%" };
    { 18, 13983, "", "=q3=Gravestone War Axe", "=ds=#w1#", "", "11.1%" };
    { 19, 14024, "", "=q3=Frightalon", "=ds=#w4#", "", "11.1%" };
    { 20, 16734, "", "=q3=Boots of Valor", "=ds=#a4#", "", "11.1%" };
    { 21, 66705, "", "=q4=Stoneform Shoulders", "=ds=#a4#", "", "11.1%" };
    { 22, 66706, "", "=q4=Gargoyle Slashers", "=ds=#a2#", "", "11.1%" };
    { 23, 66707, "", "=q4=Heart of the Fiend", "=ds=#s2#", "", "11.1%" };
    { 24, 66709, "", "=q4=Windreaver Greaves", "=ds=#a3#", "", "11.1%" };
    { 25, 66710, "", "=q4=Loomguard Armbraces", "=ds=#a3#", "", "11.1%" };
	};
    ...
    { 6, 0, "AO_Unknown", "=q6=Jandice Barov", "=q5=ONE WILL DROP"};
    { 7, 16701, "", "=q3=Dreadmist Mantle", "=ds=#a1#", "", "17.0%" };
    { 8, 14541, "", "=q3=Barovian Family Sword", "=ds=#w10#", "", "13.8%" };
    { 9, 14545, "", "=q3=Ghostloom Leggings", "=ds=#a2#", "", "13.8%" };
    { 10, 14548, "", "=q3=Royal Cap Spaulders", "=ds=#a3#", "", "13.8%" };
    { 11, 18689, "", "=q3=Phantasmal Cloak", "=ds=#a1#", "", "13.8%" };
    { 12, 18690, "", "=q3=Wraithplate Leggings", "=ds=#a4#", "", "13.8%" };
    { 13, 22394, "", "=q3=Staff of Metanoia", "=ds=#w9#", "", "13.8%" };
	};

	AtlasLoot_Data["SCHOLOJandiceBarovMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Jandice Barov", "=q5=ALL WILL DROP"};
    { 2, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    { 3, 13523, "", "=q1=Blood of Innocents", "=ds=#m3#", "", "100%" };
    { 4, 13725, "", "=q1=Krastinov's Bag of Horrors", "=ds=#m3#", "", "100%" };
    { 6, 0, "RoM_stellar_dice", "=q6=Mythic Jandice Barov", "=q5=CHANCE TO DROP"};
    { 7, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 8, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 9, 69725, "", "=q4=Darkshade Gloves", "=ds=#a1#", "", "1.00%" };
	};
    ...
    { 3, 13523, "", "=q1=Blood of Innocents", "=ds=#m3#", "", "100%" };
    { 4, 13725, "", "=q1=Krastinov's Bag of Horrors", "=ds=#m3#", "", "100%" };
    { 6, 0, "RoM_stellar_dice", "=q6=Heroic Jandice Barov", "=q5=CHANCE TO DROP"};
    { 7, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 8, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 9, 66725, "", "=q4=Darkshade Gloves", "=ds=#a1#", "", "1.00%" };
	};

	AtlasLoot_Data["SCHOLORattlegore"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Rattlegore", "=q5=CHANCE TO DROP"};
    { 2, 57473, "", "=q1=Technique: Scroll of Shadow Resistance IV", "=ds=#e2#", "", "15.0%" };
    { 3, 59089, "", "=q3=Libram of the Shielded Avenger", "", "", "10.0%" };
    { 5, 0, "AO_Unknown", "=q6=Rattlegore", "=q5=ONE WILL DROP"};
	...
	AtlasLoot_Data["SCHOLORattlegoreMYTHIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Mythic Rattlegore", "=q5=CHANCE TO DROP"};
    { 2, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 57473, "", "=q1=Technique: Scroll of Shadow Resistance IV", "=ds=#e2#", "", "15.0%" };
    { 5, 59089, "", "=q3=Libram of the Shielded Avenger", "", "", "10.0%" };
    { 7, 0, "AO_Unknown", "=q6=Mythic Rattlegore", "=q5=ONE WILL DROP"};
    { 8, 16711, "", "=q3=Shadowcraft Boots", "=ds=#a2#", "", "16.0%" };
    { 9, 14531, "", "=q3=Frightskull Shaft", "=ds=#w6#", "", "14.0%" };
    { 10, 69721, "", "=q4=Rattlecage Buckler", "=ds=#w8#", "", "14.0%" };
    { 11, 69722, "", "=q4=Corpselight Greaves", "=ds=#a4#", "", "14.0%" };
    { 12, 69723, "", "=q4=Deadwalker Mantle", "=ds=#a1#", "", "14.0%" };
    { 13, 69724, "", "=q4=Bone Ring Helm", "=ds=#a2#", "", "14.0%" };
    { 14, 69858, "", "=q4=Bone Golem Shoulders", "=ds=#a3#", "", "14.0%" };
	};

	AtlasLoot_Data["SCHOLORattlegoreHEROIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Heroic Rattlegore", "=q5=CHANCE TO DROP"};
    { 2, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 57473, "", "=q1=Technique: Scroll of Shadow Resistance IV", "=ds=#e2#", "", "15.0%" };
    { 5, 59089, "", "=q3=Libram of the Shielded Avenger", "", "", "10.0%" };
    { 7, 0, "AO_Unknown", "=q6=Heroic Rattlegore", "=q5=ONE WILL DROP"};
    { 8, 16711, "", "=q3=Shadowcraft Boots", "=ds=#a2#", "", "16.0%" };
    { 9, 14531, "", "=q3=Frightskull Shaft", "=ds=#w6#", "", "14.0%" };
    { 10, 66721, "", "=q4=Rattlecage Buckler", "=ds=#w8#", "", "14.0%" };
    { 11, 66722, "", "=q4=Corpselight Greaves", "=ds=#a4#", "", "14.0%" };
    { 12, 66723, "", "=q4=Deadwalker Mantle", "=ds=#a1#", "", "14.0%" };
    { 13, 66724, "", "=q4=Bone Ring Helm", "=ds=#a2#", "", "14.0%" };
    { 14, 66858, "", "=q4=Bone Golem Shoulders", "=ds=#a3#", "", "14.0%" };
	};
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6=Vectus", "=q5=ALL WILL DROP"};
    { 2, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Vectus", "=q5=CHANCE TO DROP"};
    { 5, 22526, "", "=q1=Bone Fragments", "=ds=#m3#", "", "50.0%" };
    { 6, 14577, "", "=q3=Skullsmoke Pants", "=ds=#a1#", "", "7.00%" };
    { 7, 18691, "", "=q3=Dark Advisor's Pendant", "=ds=#s2#", "", "7.00%" };
	};

	AtlasLoot_Data["SCHOLOVectusMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Vectus", "=q5=ALL WILL DROP"};
    { 2, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Mythic Vectus", "=q5=CHANCE TO DROP"};
    { 5, 22526, "", "=q1=Bone Fragments", "=ds=#m3#", "", "50.0%" };
    { 6, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 8, 69728, "", "=q4=Skullsmoke Pants", "=ds=#a1#", "", "7.00%" };
    { 9, 69861, "", "=q4=Dark Advisor's Pendant", "=ds=#s2#", "", "7.00%" };
	};

	AtlasLoot_Data["SCHOLOVectusHEROIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Heroic Vectus", "=q5=ALL WILL DROP"};
    { 2, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Heroic Vectus", "=q5=CHANCE TO DROP"};
    { 5, 22526, "", "=q1=Bone Fragments", "=ds=#m3#", "", "50.0%" };
    { 6, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 8, 66728, "", "=q4=Skullsmoke Pants", "=ds=#a1#", "", "7.00%" };
    { 9, 66861, "", "=q4=Dark Advisor's Pendant", "=ds=#s2#", "", "7.00%" };
	};

	AtlasLoot_Data["SCHOLOMarduk"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Marduk Blackpool", "=q5=ALL WILL DROP"};
    { 2, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Marduk Blackpool", "=q5=CHANCE TO DROP"};
    { 5, 14576, "", "=q3=Ebon Hilt of Marduk", "=ds=#w10#", "", "8.00%" };
    { 6, 18692, "", "=q3=Death Knight Sabatons", "=ds=#a4#", "", "5.00%" };
	};

	AtlasLoot_Data["SCHOLOMardukMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Marduk Blackpool", "=q5=ALL WILL DROP"};
    { 2, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Mythic Marduk Blackpool", "=q5=CHANCE TO DROP"};
    { 5, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 14576, "", "=q3=Ebon Hilt of Marduk", "=ds=#w10#", "", "8.00%" };
    { 8, 69862, "", "=q4=Death Knight Sabatons", "=ds=#a4#", "", "5.00%" };
	};

	AtlasLoot_Data["SCHOLOMardukHEROIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Heroic Marduk Blackpool", "=q5=ALL WILL DROP"};
    { 2, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Heroic Marduk Blackpool", "=q5=CHANCE TO DROP"};
    { 5, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 14576, "", "=q3=Ebon Hilt of Marduk", "=ds=#w10#", "", "8.00%" };
    { 8, 66862, "", "=q4=Death Knight Sabatons", "=ds=#a4#", "", "5.00%" };
	};
	...
	AtlasLoot_Data["SCHOLORasFrostwhisperMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Ras Frostwhisper", "=q5=ALL WILL DROP"};
    { 2, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    { 3, 13626, "", "=q1=Human Head of Ras Frostwhisper", "=ds=#m3#", "", "100%" };
    { 5, 0, "RoM_stellar_dice", "=q6=Mythic Ras Frostwhisper", "=q5=CHANCE TO DROP"};
    { 6, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 16, 0, "AO_Unknown", "=q6=Mythic Ras Frostwhisper", "=q5=ONE WILL DROP"};
    { 17, 14487, "", "=q3=Bonechill Hammer", "=ds=#w6#", "", "8.33%" };
    { 18, 16689, "", "=q3=Magister's Mantle", "=ds=#a1#", "", "8.33%" };
    { 19, 69703, "", "=q4=Iceblade Hacker", "=ds=#w1#", "", "8.33%" };
    { 20, 69716, "", "=q4=Freezing Lich Robes", "=ds=#a1#", "", "8.33%" };
    { 21, 69717, "", "=q4=Frostbite Girdle", "=ds=#a2#", "", "8.33%" };
    { 22, 69718, "", "=q4=Death's Clutch", "=ds=#a2#", "", "8.33%" };
    { 23, 69719, "", "=q4=Maelstrom Leggings", "=ds=#a3#", "", "8.33%" };
    { 24, 69720, "", "=q4=Boneclenched Gauntlets", "=ds=#a4#", "", "8.33%" };
    { 25, 69863, "", "=q4=Shivery Handwraps", "=ds=#a1#", "", "8.33%" };
    { 26, 69864, "", "=q4=Shadowy Mail Greaves", "=ds=#a3#", "", "8.33%" };
    { 27, 69865, "", "=q4=Spellbound Tome", "=ds=#s15#", "", "8.33%" };
    { 28, 69866, "", "=q4=Intricately Runed Shield", "=ds=#w8#", "", "8.33%" };
	};
    ...
    { 2, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    { 3, 13626, "", "=q1=Human Head of Ras Frostwhisper", "=ds=#m3#", "", "100%" };
    { 5, 0, "RoM_stellar_dice", "=q6=Heroic Ras Frostwhisper", "=q5=CHANCE TO DROP"};
    { 6, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 16, 0, "AO_Unknown", "=q6=Heroic Ras Frostwhisper", "=q5=ONE WILL DROP"};
    { 17, 14487, "", "=q3=Bonechill Hammer", "=ds=#w6#", "", "8.33%" };
    { 18, 16689, "", "=q3=Magister's Mantle", "=ds=#a1#", "", "8.33%" };
    { 19, 66703, "", "=q4=Iceblade Hacker", "=ds=#w1#", "", "8.33%" };
    { 20, 66716, "", "=q4=Freezing Lich Robes", "=ds=#a1#", "", "8.33%" };
    { 21, 66717, "", "=q4=Frostbite Girdle", "=ds=#a2#", "", "8.33%" };
    { 22, 66718, "", "=q4=Death's Clutch", "=ds=#a2#", "", "8.33%" };
    { 23, 66719, "", "=q4=Maelstrom Leggings", "=ds=#a3#", "", "8.33%" };
    { 24, 66720, "", "=q4=Boneclenched Gauntlets", "=ds=#a4#", "", "8.33%" };
    { 25, 66863, "", "=q4=Shivery Handwraps", "=ds=#a1#", "", "8.33%" };
    { 26, 66864, "", "=q4=Shadowy Mail Greaves", "=ds=#a3#", "", "8.33%" };
    { 27, 66865, "", "=q4=Spellbound Tome", "=ds=#s15#", "", "8.33%" };
    { 28, 66866, "", "=q4=Intricately Runed Shield", "=ds=#w8#", "", "8.33%" };
	};

	AtlasLoot_Data["SCHOLOKormok"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Kormok", "=q5=ALL WILL DROP"};
    { 2, 21984, "", "=q1=Left Piece of Lord Valthalak's Amulet", "=ds=#m3#", "", "100%" };
    { 3, 22046, "", "=q1=Right Piece of Lord Valthalak's Amulet", "=ds=#m3#", "", "100%" };
    { 5, 0, "AO_Unknown", "=q6=Kormok", "=q5=ONE WILL DROP"};
    { 6, 22303, "", "=q3=Ironweave Pants", "=ds=#a1#", "", "20.0%" };
    { 7, 22326, "", "=q3=Amalgam's Band", "=ds=#s13#", "", "20.0%" };
    { 8, 22331, "", "=q3=Band of the Steadfast Hero", "=ds=#s13#", "", "20.0%" };
    { 9, 22332, "", "=q3=Blade of Necromancy", "=ds=#w10#", "", "20.0%" };
    { 10, 22333, "", "=q3=Hammer of Divine Might", "=ds=#w6#", "", "20.0%" };
	};

	AtlasLoot_Data["SCHOLOKormokMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Kormok", "=q5=ALL WILL DROP"};
    { 2, 21984, "", "=q1=Left Piece of Lord Valthalak's Amulet", "=ds=#m3#", "", "100%" };
    { 3, 22046, "", "=q1=Right Piece of Lord Valthalak's Amulet", "=ds=#m3#", "", "100%" };
    { 5, 0, "RoM_stellar_dice", "=q6=Mythic Kormok", "=q5=CHANCE TO DROP"};
    { 6, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 9, 0, "AO_Unknown", "=q6=Mythic Kormok", "=q5=ONE WILL DROP"};
    { 10, 22303, "", "=q3=Ironweave Pants", "=ds=#a1#", "", "20.0%" };
    { 11, 69948, "", "=q4=Amalgam's Band", "=ds=#s13#", "", "20.0%" };
    { 12, 69949, "", "=q4=Band of the Steadfast Hero", "=ds=#s13#", "", "20.0%" };
    { 13, 69950, "", "=q4=Blade of Necromancy", "=ds=#w10#", "", "20.0%" };
    { 14, 69951, "", "=q4=Hammer of Divine Might", "=ds=#w6#", "", "20.0%" };
	};
    ...
    { 2, 21984, "", "=q1=Left Piece of Lord Valthalak's Amulet", "=ds=#m3#", "", "100%" };
    { 3, 22046, "", "=q1=Right Piece of Lord Valthalak's Amulet", "=ds=#m3#", "", "100%" };
    { 5, 0, "RoM_stellar_dice", "=q6=Heroic Kormok", "=q5=CHANCE TO DROP"};
    { 6, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 9, 0, "AO_Unknown", "=q6=Heroic Kormok", "=q5=ONE WILL DROP"};
    { 10, 22303, "", "=q3=Ironweave Pants", "=ds=#a1#", "", "20.0%" };
    { 11, 66948, "", "=q4=Amalgam's Band", "=ds=#s13#", "", "20.0%" };
    { 12, 66949, "", "=q4=Band of the Steadfast Hero", "=ds=#s13#", "", "20.0%" };
    { 13, 66950, "", "=q4=Blade of Necromancy", "=ds=#w10#", "", "20.0%" };
    { 14, 66951, "", "=q4=Hammer of Divine Might", "=ds=#w6#", "", "20.0%" };
	};
	...
	AtlasLoot_Data["SCHOLOInstructorMaliciaMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Instructor Malicia", "=q5=ALL WILL DROP"};
    { 2, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Mythic Instructor Malicia", "=q5=CHANCE TO DROP"};
    { 5, 20520, "", "=q2=Dark Rune", "=ds=#e7#", "", "44.0%" };
    { 6, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
	};
    ...
    { 2, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Heroic Instructor Malicia", "=q5=CHANCE TO DROP"};
    { 5, 20520, "", "=q2=Dark Rune", "=ds=#e7#", "", "44.0%" };
    { 6, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
	};
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6=Doctor Theolen Krastinov", "=q5=ALL WILL DROP"};
    { 2, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    { 3, 13523, "", "=q1=Blood of Innocents", "=ds=#m3#", "", "100%" };
    { 5, 0, "RoM_stellar_dice", "=q6=Doctor Theolen Krastinov", "=q5=CHANCE TO DROP"};
    { 6, 16684, "", "=q3=Magister's Gloves", "=ds=#a1#", "", "14.0%" };
	};

	AtlasLoot_Data["SCHOLODoctorTheolenKrastinovMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Doctor Theolen Krastinov", "=q5=ALL WILL DROP"};
    { 2, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    { 3, 13523, "", "=q1=Blood of Innocents", "=ds=#m3#", "", "100%" };
    { 5, 0, "RoM_stellar_dice", "=q6=Mythic Doctor Theolen Krastinov", "=q5=CHANCE TO DROP"};
    { 6, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
	};
    ...
    { 2, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    { 3, 13523, "", "=q1=Blood of Innocents", "=ds=#m3#", "", "100%" };
    { 5, 0, "RoM_stellar_dice", "=q6=Heroic Doctor Theolen Krastinov", "=q5=CHANCE TO DROP"};
    { 6, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
	};
	...
	AtlasLoot_Data["SCHOLOLorekeeperPolkeltMYTHIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Mythic Lorekeeper Polkelt", "=q5=CHANCE TO DROP"};
    { 2, 20520, "", "=q2=Dark Rune", "=ds=#e7#", "", "44.0%" };
    { 3, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
	};
    ...
    { 1, 0, "RoM_stellar_dice", "=q6=Heroic Lorekeeper Polkelt", "=q5=CHANCE TO DROP"};
    { 2, 20520, "", "=q2=Dark Rune", "=ds=#e7#", "", "44.0%" };
    { 3, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
	};
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6=The Ravenian", "=q5=ALL WILL DROP"};
    { 2, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=The Ravenian", "=q5=CHANCE TO DROP"};
    { 5, 20520, "", "=q2=Dark Rune", "=ds=#e7#", "", "44.0%" };
    { 6, 16716, "", "=q3=Wildheart Belt", "=ds=#a2#", "", "4.00%" };
	};

	AtlasLoot_Data["SCHOLOTheRavenianMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic The Ravenian", "=q5=ALL WILL DROP"};
    { 2, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Mythic The Ravenian", "=q5=CHANCE TO DROP"};
    { 5, 20520, "", "=q2=Dark Rune", "=ds=#e7#", "", "44.0%" };
    { 6, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
	};
    ...
    { 2, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Heroic The Ravenian", "=q5=CHANCE TO DROP"};
    { 5, 20520, "", "=q2=Dark Rune", "=ds=#e7#", "", "44.0%" };
    { 6, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
	};
    ...
    { 2, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Lord Alexei Barov", "=q5=CHANCE TO DROP"};
    { 5, 16722, "", "=q3=Lightforge Bracers", "=ds=#a4#", "", "5.00%" };
	};

	AtlasLoot_Data["SCHOLOLordAlexeiBarovMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Lord Alexei Barov", "=q5=ALL WILL DROP"};
    { 2, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Mythic Lord Alexei Barov", "=q5=CHANCE TO DROP"};
    { 5, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
	};
    ...
    { 2, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Heroic Lord Alexei Barov", "=q5=CHANCE TO DROP"};
    { 5, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
	};
	...
	AtlasLoot_Data["SCHOLOLadyIlluciaBarovMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Lady Illucia Barov", "=q5=ALL WILL DROP"};
    { 2, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Mythic Lady Illucia Barov", "=q5=CHANCE TO DROP"};
    { 5, 20520, "", "=q2=Dark Rune", "=ds=#e7#", "", "48.0%" };
    { 6, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
	};
    ...
    { 2, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Heroic Lady Illucia Barov", "=q5=CHANCE TO DROP"};
    { 5, 20520, "", "=q2=Dark Rune", "=ds=#e7#", "", "48.0%" };
    { 6, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
	};
	...
	AtlasLoot_Data["SCHOLODarkmasterGandlingMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Darkmaster Gandling", "=q5=ALL WILL DROP"};
    { 2, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    { 3, 58726, "", "=q1=Gandling's Plague Formula", "=ds=#m3#", "", "100%" };
    { 4, 59000, "", "=q3=Gandling's Armor Cache - Helm", "=ds=#e10#", "", "100%" };
	...
	AtlasLoot_Data["SFKDeathsworn"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Deathsworn Captain", "=q5=CHANCE TO DROP"};
    { 2, 17, "", "=q6=Martin Fury", "=ds=#a4#", "", "" };
    { 4, 0, "AO_Unknown", "=q6=Deathsworn Captain", "=q5=ONE WILL DROP"};
    { 5, 6641, "", "=q3=Haunting Blade", "=ds=#w10#", "", "60.0%" };
    { 6, 6642, "", "=q3=Phantom Armor", "=ds=#a3#", "", "40.0%" };
	};

	AtlasLoot_Data["SFKDeathswornMYTHIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Mythic Deathsworn Captain", "=q5=CHANCE TO DROP"};
    { 2, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 16, 0, "AO_Unknown", "=q6=Mythic Deathsworn Captain", "=q5=ONE WILL DROP"};
    { 17, 69360, "", "=q4=Haunting Blade", "=ds=#w10#", "", "60.0%" };
    { 18, 69361, "", "=q4=Phantom Armor", "=ds=#a3#", "", "40.0%" };
    { 19, 1318, "", "=q3=Night Reaver", "=ds=#w1#", "", "9.09%" };
    { 20, 1482, "", "=q3=Shadowfang", "=ds=#w10#", "", "9.09%" };
    { 21, 1483, "", "=q3=Face Smasher", "=ds=#w6#", "", "9.09%" };
    { 22, 1484, "", "=q3=Witching Stave", "=ds=#w9#", "", "9.09%" };
    { 23, 1489, "", "=q3=Gloomshroud Armor", "=ds=#a2#", "", "9.09%" };
    { 24, 1935, "", "=q3=Assassin's Blade", "=ds=#w4#", "", "9.09%" };
    { 25, 1974, "", "=q3=Mindthrust Bracers", "=ds=#a1#", "", "9.09%" };
    { 26, 2205, "", "=q3=Duskbringer", "=ds=#w10#", "", "9.09%" };
    { 27, 2292, "", "=q3=Necrology Robes", "=ds=#a1#", "", "9.09%" };
    { 28, 2807, "", "=q3=Guillotine Axe", "=ds=#w1#", "", "9.09%" };
    { 29, 3194, "", "=q3=Black Malice", "=ds=#w6#", "", "9.09%" };
	};

	AtlasLoot_Data["SFKDeathswornHEROIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Heroic Deathsworn Captain", "=q5=CHANCE TO DROP"};
    { 2, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 16, 0, "AO_Unknown", "=q6=Heroic Deathsworn Captain", "=q5=ONE WILL DROP"};
    { 17, 66360, "", "=q4=Haunting Blade", "=ds=#w10#", "", "60.0%" };
    { 18, 66361, "", "=q4=Phantom Armor", "=ds=#a3#", "", "40.0%" };
    { 19, 1318, "", "=q3=Night Reaver", "=ds=#w1#", "", "9.09%" };
    { 20, 1482, "", "=q3=Shadowfang", "=ds=#w10#", "", "9.09%" };
    { 21, 1483, "", "=q3=Face Smasher", "=ds=#w6#", "", "9.09%" };
    { 22, 1484, "", "=q3=Witching Stave", "=ds=#w9#", "", "9.09%" };
	...
	AtlasLoot_Data["SFKRazorclawMYTHIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Mythic Razorclaw the Butcher", "=q5=CHANCE TO DROP"};
    { 2, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 5, 0, "AO_Unknown", "=q6=Mythic Razorclaw the Butcher", "=q5=ONE WILL DROP"};
    { 6, 69335, "", "=q4=Bloody Apron", "=ds=#a1#", "", "45.0%" };
    { 7, 69359, "", "=q4=Butcher's Slicer", "=ds=#w10#", "", "45.0%" };
    { 8, 69304, "", "=q4=Butcher's Cleaver", "=ds=#w1#", "", "10.0%" };
	};

	AtlasLoot_Data["SFKRazorclawHEROIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Heroic Razorclaw the Butcher", "=q5=CHANCE TO DROP"};
    { 2, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 5, 0, "AO_Unknown", "=q6=Heroic Razorclaw the Butcher", "=q5=ONE WILL DROP"};
    { 6, 66335, "", "=q4=Bloody Apron", "=ds=#a1#", "", "45.0%" };
    { 7, 66359, "", "=q4=Butcher's Slicer", "=ds=#w10#", "", "45.0%" };
    { 8, 66304, "", "=q4=Butcher's Cleaver", "=ds=#w1#", "", "10.0%" };
	};

	AtlasLoot_Data["SFKSilverlaine"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Baron Silverlaine", "=q5=CHANCE TO DROP"};
    { 2, 57461, "", "=q1=Technique: Scroll of Frost Resistance II", "=ds=#e2#", "", "15.0%" };
	...
	AtlasLoot_Data["SFKSilverlaineMYTHIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Mythic Baron Silverlaine", "=q5=CHANCE TO DROP"};
    { 2, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 57461, "", "=q1=Technique: Scroll of Frost Resistance II", "=ds=#e2#", "", "15.0%" };
    { 6, 0, "AO_Unknown", "=q6=Mythic Baron Silverlaine", "=q5=ONE WILL DROP"};
    { 7, 69341, "", "=q4=Baron's Scepter", "=ds=#w6#", "", "70.0%" };
    { 8, 69340, "", "=q4=Silverlaine's Family Seal", "=ds=#s13#", "", "30.0%" };
	};

	AtlasLoot_Data["SFKSilverlaineHEROIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Heroic Baron Silverlaine", "=q5=CHANCE TO DROP"};
    { 2, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 57461, "", "=q1=Technique: Scroll of Frost Resistance II", "=ds=#e2#", "", "15.0%" };
    { 6, 0, "AO_Unknown", "=q6=Heroic Baron Silverlaine", "=q5=ONE WILL DROP"};
    { 7, 66341, "", "=q4=Baron's Scepter", "=ds=#w6#", "", "70.0%" };
    { 8, 66340, "", "=q4=Silverlaine's Family Seal", "=ds=#s13#", "", "30.0%" };
	};
	...
	AtlasLoot_Data["SFKSpringvaleMYTHIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Mythic Commander Springvale", "=q5=CHANCE TO DROP"};
    { 2, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 57481, "", "=q1=Technique: Scroll of Holy Resistance II", "=ds=#e2#", "", "15.0%" };
    { 6, 0, "AO_Unknown", "=q6=Mythic Commander Springvale", "=q5=ONE WILL DROP"};
    { 7, 69310, "", "=q4=Arced War Axe", "=ds=#w1#", "", "50.0%" };
    { 8, 69339, "", "=q4=Commander's Crest", "=ds=#w8#", "", "50.0%" };
	};

	AtlasLoot_Data["SFKSpringvaleHEROIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Heroic Commander Springvale", "=q5=CHANCE TO DROP"};
    { 2, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 57481, "", "=q1=Technique: Scroll of Holy Resistance II", "=ds=#e2#", "", "15.0%" };
    { 6, 0, "AO_Unknown", "=q6=Heroic Commander Springvale", "=q5=ONE WILL DROP"};
    { 7, 66310, "", "=q4=Arced War Axe", "=ds=#w1#", "", "50.0%" };
    { 8, 66339, "", "=q4=Commander's Crest", "=ds=#w8#", "", "50.0%" };
	};

	AtlasLoot_Data["SFKOdo"] = {
    { 1, 0, "AO_Unknown", "=q6=Odo the Blindwatcher", "=q5=ONE WILL DROP"};
    { 2, 6319, "", "=q3=Girdle of the Blindwatcher", "=ds=#a2#", "", "60.0%" };
    { 3, 6318, "", "=q3=Odo's Ley Staff", "=ds=#w9#", "", "40.0%" };
	};

	AtlasLoot_Data["SFKOdoMYTHIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Mythic Odo the Blindwatcher", "=q5=CHANCE TO DROP"};
    { 2, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 5, 0, "AO_Unknown", "=q6=Mythic Odo the Blindwatcher", "=q5=ONE WILL DROP"};
    { 6, 69338, "", "=q4=Girdle of the Blindwatcher", "=ds=#a2#", "", "60.0%" };
    { 7, 69337, "", "=q4=Odo's Ley Staff", "=ds=#w9#", "", "40.0%" };
	};

	AtlasLoot_Data["SFKOdoHEROIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Heroic Odo the Blindwatcher", "=q5=CHANCE TO DROP"};
    { 2, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 5, 0, "AO_Unknown", "=q6=Heroic Odo the Blindwatcher", "=q5=ONE WILL DROP"};
    { 6, 66338, "", "=q4=Girdle of the Blindwatcher", "=ds=#a2#", "", "60.0%" };
    { 7, 66337, "", "=q4=Odo's Ley Staff", "=ds=#w9#", "", "40.0%" };
	};

	AtlasLoot_Data["SFKFenrus"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Fenrus the Devourer", "=q5=CHANCE TO DROP"};
    { 2, 59043, "", "=q2=Idol of Lunar Embrace", "", "", "10.0%" };
    { 4, 0, "AO_Unknown", "=q6=Fenrus the Devourer", "=q5=ONE WILL DROP"};
    { 5, 6340, "", "=q3=Fenrus' Hide", "=ds=#a1#", "", "70.0%" };
    { 6, 3230, "", "=q3=Black Wolf Bracers", "=ds=#a2#", "", "30.0%" };
	};

	AtlasLoot_Data["SFKFenrusMYTHIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Mythic Fenrus the Devourer", "=q5=CHANCE TO DROP"};
    { 2, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 59043, "", "=q2=Idol of Lunar Embrace", "", "", "10.0%" };
    { 6, 0, "AO_Unknown", "=q6=Mythic Fenrus the Devourer", "=q5=ONE WILL DROP"};
    { 7, 69343, "", "=q4=Fenrus' Hide", "=ds=#a1#", "", "70.0%" };
    { 8, 69312, "", "=q4=Black Wolf Bracers", "=ds=#a2#", "", "30.0%" };
	};

	AtlasLoot_Data["SFKFenrusHEROIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Heroic Fenrus the Devourer", "=q5=CHANCE TO DROP"};
    { 2, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 59043, "", "=q2=Idol of Lunar Embrace", "", "", "10.0%" };
    { 6, 0, "AO_Unknown", "=q6=Heroic Fenrus the Devourer", "=q5=ONE WILL DROP"};
    { 7, 66343, "", "=q4=Fenrus' Hide", "=ds=#a1#", "", "70.0%" };
    { 8, 66312, "", "=q4=Black Wolf Bracers", "=ds=#a2#", "", "30.0%" };
	};
	...
	AtlasLoot_Data["SFKNandosMYTHIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Mythic Wolf Master Nandos", "=q5=CHANCE TO DROP"};
    { 2, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 5, 0, "AO_Unknown", "=q6=Mythic Wolf Master Nandos", "=q5=ONE WILL DROP"};
    { 6, 69313, "", "=q4=Feline Mantle", "=ds=#a1#", "", "60.0%" };
    { 7, 69336, "", "=q4=Wolfmaster Cape", "=ds=#a1#", "", "40.0%" };
	};

	AtlasLoot_Data["SFKNandosHEROIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Heroic Wolf Master Nandos", "=q5=CHANCE TO DROP"};
    { 2, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 5, 0, "AO_Unknown", "=q6=Heroic Wolf Master Nandos", "=q5=ONE WILL DROP"};
    { 6, 66313, "", "=q4=Feline Mantle", "=ds=#a1#", "", "60.0%" };
    { 7, 66336, "", "=q4=Wolfmaster Cape", "=ds=#a1#", "", "40.0%" };
	};

	AtlasLoot_Data["SFKArugal"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Archmage Arugal", "=q5=ALL WILL DROP"};
    { 2, 5442, "", "=q1=Head of Arugal", "=ds=#m3#", "", "100%" };
    { 3, 58703, "", "=q1=Fangfire Amulet", "=ds=#m3#", "", "100%" };
    { 5, 0, "RoM_stellar_dice", "=q6=Archmage Arugal", "=q5=CHANCE TO DROP"};
    { 6, 57466, "", "=q1=Technique: Scroll of Arcane Resistance II", "=ds=#e2#", "", "15.0%" };
    { 7, 57471, "", "=q1=Technique: Scroll of Shadow Resistance II", "=ds=#e2#", "", "15.0%" };
    { 8, 59044, "", "=q2=Libram of Shadow's End", "", "", "10.0%" };
    { 10, 0, "AO_Unknown", "=q6=Archmage Arugal", "=q5=ONE WILL DROP"};
    { 11, 6324, "", "=q3=Robes of Arugal", "=ds=#a1#", "", "40.0%" };
    { 12, 6392, "", "=q3=Belt of Arugal", "=ds=#a1#", "", "40.0%" };
    { 13, 6220, "", "=q3=Meteor Shard", "=ds=#w4#", "", "20.0%" };
	};

	AtlasLoot_Data["SFKArugalMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Archmage Arugal", "=q5=ALL WILL DROP"};
    { 2, 5442, "", "=q1=Head of Arugal", "=ds=#m3#", "", "100%" };
    { 3, 58703, "", "=q1=Fangfire Amulet", "=ds=#m3#", "", "100%" };
    { 5, 0, "RoM_stellar_dice", "=q6=Mythic Archmage Arugal", "=q5=CHANCE TO DROP"};
    { 6, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 8, 57466, "", "=q1=Technique: Scroll of Arcane Resistance II", "=ds=#e2#", "", "15.0%" };
    { 9, 57471, "", "=q1=Technique: Scroll of Shadow Resistance II", "=ds=#e2#", "", "15.0%" };
    { 10, 59044, "", "=q2=Libram of Shadow's End", "", "", "10.0%" };
    { 12, 0, "AO_Unknown", "=q6=Mythic Archmage Arugal", "=q5=ONE WILL DROP"};
    { 13, 69342, "", "=q4=Robes of Arugal", "=ds=#a1#", "", "40.0%" };
    { 14, 69345, "", "=q4=Belt of Arugal", "=ds=#a1#", "", "40.0%" };
    { 15, 6220, "", "=q3=Meteor Shard", "=ds=#w4#", "", "20.0%" };
	};
    ...
    { 2, 5442, "", "=q1=Head of Arugal", "=ds=#m3#", "", "100%" };
    { 3, 58703, "", "=q1=Fangfire Amulet", "=ds=#m3#", "", "100%" };
    { 5, 0, "RoM_stellar_dice", "=q6=Heroic Archmage Arugal", "=q5=CHANCE TO DROP"};
    { 6, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 8, 57466, "", "=q1=Technique: Scroll of Arcane Resistance II", "=ds=#e2#", "", "15.0%" };
    { 9, 57471, "", "=q1=Technique: Scroll of Shadow Resistance II", "=ds=#e2#", "", "15.0%" };
    { 10, 59044, "", "=q2=Libram of Shadow's End", "", "", "10.0%" };
    { 12, 0, "AO_Unknown", "=q6=Heroic Archmage Arugal", "=q5=ONE WILL DROP"};
    { 13, 66342, "", "=q4=Robes of Arugal", "=ds=#a1#", "", "40.0%" };
    { 14, 66345, "", "=q4=Belt of Arugal", "=ds=#a1#", "", "40.0%" };
    { 15, 6220, "", "=q3=Meteor Shard", "=ds=#w4#", "", "20.0%" };
	};
    ...
    { 1, 0, "AO_Unknown", "=q6=Stratholme Courier", "=q5=ONE WILL DROP"};
    { 2, 13306, "", "=q1=King's Square Postbox Key", "=ds=#e5#", "", "50.0%" };
    { 3, 13307, "", "=q1=Fras Siabi's Postbox Key", "=ds=#e5#", "", "50.0%" };
    { 5, 0, "AO_Unknown", "=q6=Stratholme Courier", "=q5=ONE WILL DROP"};
    { 6, 13303, "", "=q1=Crusaders' Square Postbox Key", "=ds=#e5#", "", "50.0%" };
    { 7, 13305, "", "=q1=Elders' Square Postbox Key", "=ds=#e5#", "", "50.0%" };
    { 9, 0, "AO_Unknown", "=q6=Stratholme Courier", "=q5=ONE WILL DROP"};
    { 10, 13302, "", "=q1=Market Row Postbox Key", "=ds=#e5#", "", "50.0%" };
    { 11, 13304, "", "=q1=Festival Lane Postbox Key", "=ds=#e5#", "", "50.0%" };
	};

	AtlasLoot_Data["STRATStratholmeCourierMYTHIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Mythic Stratholme Courier", "=q5=CHANCE TO DROP"};
    { 2, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 5, 0, "AO_Unknown", "=q6=Mythic Stratholme Courier", "=q5=ONE WILL DROP"};
    { 6, 13306, "", "=q1=King's Square Postbox Key", "=ds=#e5#", "", "50.0%" };
    { 7, 13307, "", "=q1=Fras Siabi's Postbox Key", "=ds=#e5#", "", "50.0%" };
    { 9, 0, "AO_Unknown", "=q6=Mythic Stratholme Courier", "=q5=ONE WILL DROP"};
    { 10, 13303, "", "=q1=Crusaders' Square Postbox Key", "=ds=#e5#", "", "50.0%" };
    { 11, 13305, "", "=q1=Elders' Square Postbox Key", "=ds=#e5#", "", "50.0%" };
    { 13, 0, "AO_Unknown", "=q6=Mythic Stratholme Courier", "=q5=ONE WILL DROP"};
    ...
    { 1, 0, "RoM_stellar_dice", "=q6=Heroic Stratholme Courier", "=q5=CHANCE TO DROP"};
    { 2, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
	...
	AtlasLoot_Data["STRATFrasSiabiMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Fras Siabi", "=q5=ALL WILL DROP"};
    { 2, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    { 3, 13172, "", "=q1=Siabi's Premium Tobacco", "=ds=#m3#", "", "100%" };
    { 5, 0, "RoM_stellar_dice", "=q6=Mythic Fras Siabi", "=q5=CHANCE TO DROP"};
    { 6, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
	};
    ...
    { 2, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    { 3, 13172, "", "=q1=Siabi's Premium Tobacco", "=ds=#m3#", "", "100%" };
    { 5, 0, "RoM_stellar_dice", "=q6=Heroic Fras Siabi", "=q5=CHANCE TO DROP"};
    { 6, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
	};
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6=Hearthsinger Forresten", "=q5=ALL WILL DROP"};
    { 2, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Hearthsinger Forresten", "=q5=CHANCE TO DROP"};
    { 5, 13174, "", "=q1=Plagued Flesh Sample", "=ds=#m3#", "", "80.0%" };
    { 7, 0, "AO_Unknown", "=q6=Hearthsinger Forresten", "=q5=ONE WILL DROP"};
    { 8, 13378, "", "=q3=Songbird Blouse", "=ds=#a2#", "", "20.0%" };
    { 9, 13379, "", "=q3=Piccolo of the Flaming Fire", "=ds=#s14#", "", "20.0%" };
    { 10, 13383, "", "=q3=Woollies of the Prancing Minstrel", "=ds=#a3#", "", "20.0%" };
    { 11, 13384, "", "=q3=Rainbow Girdle", "=ds=#a4#", "", "20.0%" };
    { 12, 16682, "", "=q3=Magister's Boots", "=ds=#a1#", "", "20.0%" };
	};

	AtlasLoot_Data["STRATTheUnforgiven"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=The Unforgiven", "=q5=ALL WILL DROP"};
    { 2, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=The Unforgiven", "=q5=CHANCE TO DROP"};
    { 5, 13174, "", "=q1=Plagued Flesh Sample", "=ds=#m3#", "", "80.0%" };
    { 7, 0, "AO_Unknown", "=q6=The Unforgiven", "=q5=ONE WILL DROP"};
    { 8, 13404, "", "=q3=Mask of the Unforgiven", "=ds=#a2#", "", "20.0%" };
    { 9, 13405, "", "=q3=Wailing Nightbane Pauldrons", "=ds=#a4#", "", "20.0%" };
    { 10, 13408, "", "=q3=Soul Breaker", "=ds=#w1#", "", "20.0%" };
    { 11, 13409, "", "=q3=Tearfall Bracers", "=ds=#a1#", "", "20.0%" };
    { 12, 16717, "", "=q3=Wildheart Gloves", "=ds=#a2#", "", "20.0%" };
	};

	AtlasLoot_Data["STRATTheUnforgivenMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic The Unforgiven", "=q5=ALL WILL DROP"};
    { 2, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Mythic The Unforgiven", "=q5=CHANCE TO DROP"};
    { 5, 13174, "", "=q1=Plagued Flesh Sample", "=ds=#m3#", "", "80.0%" };
    { 6, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 9, 0, "AO_Unknown", "=q6=Mythic The Unforgiven", "=q5=ONE WILL DROP"};
    { 10, 13408, "", "=q3=Soul Breaker", "=ds=#w1#", "", "20.0%" };
    { 11, 16717, "", "=q3=Wildheart Gloves", "=ds=#a2#", "", "20.0%" };
    { 12, 69679, "", "=q4=Mask of the Unforgiven", "=ds=#a2#", "", "20.0%" };
    { 13, 69680, "", "=q4=Wailing Nightbane Pauldrons", "=ds=#a4#", "", "20.0%" };
    { 14, 69681, "", "=q4=Tearfall Bracers", "=ds=#a1#", "", "20.0%" };
	};

	AtlasLoot_Data["STRATTheUnforgivenHEROIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Heroic The Unforgiven", "=q5=ALL WILL DROP"};
    { 2, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Heroic The Unforgiven", "=q5=CHANCE TO DROP"};
    { 5, 13174, "", "=q1=Plagued Flesh Sample", "=ds=#m3#", "", "80.0%" };
    { 6, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    ...
    { 10, 13408, "", "=q3=Soul Breaker", "=ds=#w1#", "", "20.0%" };
    { 11, 16717, "", "=q3=Wildheart Gloves", "=ds=#a2#", "", "20.0%" };
    { 12, 66679, "", "=q4=Mask of the Unforgiven", "=ds=#a2#", "", "20.0%" };
    { 13, 66680, "", "=q4=Wailing Nightbane Pauldrons", "=ds=#a4#", "", "20.0%" };
    { 14, 66681, "", "=q4=Tearfall Bracers", "=ds=#a1#", "", "20.0%" };
	};

	AtlasLoot_Data["STRATTimmytheCruel"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Timmy the Cruel", "=q5=ALL WILL DROP"};
    { 2, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Timmy the Cruel", "=q5=CHANCE TO DROP"};
    { 5, 13174, "", "=q1=Plagued Flesh Sample", "=ds=#m3#", "", "80.0%" };
    { 7, 0, "AO_Unknown", "=q6=Timmy the Cruel", "=q5=ONE WILL DROP"};
    { 8, 13400, "", "=q3=Vambraces of the Sadist", "=ds=#a4#", "", "20.0%" };
    { 9, 13401, "", "=q3=The Cruel Hand of Timmy", "=ds=#w6#", "", "20.0%" };
    { 10, 13402, "", "=q3=Timmy's Galoshes", "=ds=#a3#", "", "20.0%" };
    { 11, 13403, "", "=q3=Grimgore Noose", "=ds=#a1#", "", "20.0%" };
    { 12, 16724, "", "=q3=Lightforge Gauntlets", "=ds=#a4#", "", "20.0%" };
	};

	AtlasLoot_Data["STRATTimmytheCruelMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Timmy the Cruel", "=q5=ALL WILL DROP"};
    { 2, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Mythic Timmy the Cruel", "=q5=CHANCE TO DROP"};
    { 5, 13174, "", "=q1=Plagued Flesh Sample", "=ds=#m3#", "", "80.0%" };
    { 6, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 9, 0, "AO_Unknown", "=q6=Mythic Timmy the Cruel", "=q5=ONE WILL DROP"};
    { 10, 13401, "", "=q3=The Cruel Hand of Timmy", "=ds=#w6#", "", "20.0%" };
    { 11, 16724, "", "=q3=Lightforge Gauntlets", "=ds=#a4#", "", "20.0%" };
    { 12, 69676, "", "=q4=Vambraces of the Sadist", "=ds=#a4#", "", "20.0%" };
    { 13, 69677, "", "=q4=Timmy's Galoshes", "=ds=#a3#", "", "20.0%" };
    { 14, 69678, "", "=q4=Grimgore Noose", "=ds=#a1#", "", "20.0%" };
	};

	AtlasLoot_Data["STRATTimmytheCruelHEROIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Heroic Timmy the Cruel", "=q5=ALL WILL DROP"};
    { 2, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Heroic Timmy the Cruel", "=q5=CHANCE TO DROP"};
    { 5, 13174, "", "=q1=Plagued Flesh Sample", "=ds=#m3#", "", "80.0%" };
    { 6, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    ...
    { 10, 13401, "", "=q3=The Cruel Hand of Timmy", "=ds=#w6#", "", "20.0%" };
    { 11, 16724, "", "=q3=Lightforge Gauntlets", "=ds=#a4#", "", "20.0%" };
    { 12, 66676, "", "=q4=Vambraces of the Sadist", "=ds=#a4#", "", "20.0%" };
    { 13, 66677, "", "=q4=Timmy's Galoshes", "=ds=#a3#", "", "20.0%" };
    { 14, 66678, "", "=q4=Grimgore Noose", "=ds=#a1#", "", "20.0%" };
	};
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6=Cannon Master Willey", "=q5=ALL WILL DROP"};
    { 2, 13377, "", "=q3=Miniature Cannon Balls", "=ds=#e6#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Cannon Master Willey", "=q5=CHANCE TO DROP"};
    { 5, 12839, "", "=q3=Plans: Heartseeker", "=ds=#e2#", "", "6.00%" };
    { 16, 0, "AO_Unknown", "=q6=Cannon Master Willey", "=q5=ONE WILL DROP"};
	...
	AtlasLoot_Data["STRATCannonMasterWilleyMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Cannon Master Willey", "=q5=ALL WILL DROP"};
    { 2, 13377, "", "=q3=Miniature Cannon Balls", "=ds=#e6#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Mythic Cannon Master Willey", "=q5=CHANCE TO DROP"};
    { 5, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 12839, "", "=q3=Plans: Heartseeker", "=ds=#e2#", "", "6.00%" };
    { 16, 0, "AO_Unknown", "=q6=Mythic Cannon Master Willey", "=q5=ONE WILL DROP"};
    { 17, 13382, "", "=q3=Cannonball Runner", "=ds=#s14#", "", "10.0%" };
    { 18, 16708, "", "=q3=Shadowcraft Spaulders", "=ds=#a2#", "", "10.0%" };
    { 19, 22403, "", "=q3=Diana's Pearl Necklace", "=ds=#s2#", "", "10.0%" };
    { 20, 69665, "", "=q4=Willey's Portable Howitzer", "=ds=#w5#", "", "10.0%" };
    { 21, 69666, "", "=q4=Master Cannoneer Boots", "=ds=#a4#", "", "10.0%" };
    { 22, 69871, "", "=q4=Barrage Girdle", "=ds=#a3#", "", "10.0%" };
    { 23, 69965, "", "=q4=Willey's Back Scratcher", "=ds=#w13#", "", "10.0%" };
    { 24, 69966, "", "=q4=Mantle of the Scarlet Crusade", "=ds=#a1#", "", "10.0%" };
    { 25, 69967, "", "=q4=Redemption", "=ds=#w9#", "", "10.0%" };
    { 26, 69968, "", "=q4=Helm of the New Moon", "=ds=#a2#", "", "10.0%" };
	};

	AtlasLoot_Data["STRATCannonMasterWilleyHEROIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Heroic Cannon Master Willey", "=q5=ALL WILL DROP"};
    { 2, 13377, "", "=q3=Miniature Cannon Balls", "=ds=#e6#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Heroic Cannon Master Willey", "=q5=CHANCE TO DROP"};
    { 5, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 12839, "", "=q3=Plans: Heartseeker", "=ds=#e2#", "", "6.00%" };
    ...
    { 18, 16708, "", "=q3=Shadowcraft Spaulders", "=ds=#a2#", "", "10.0%" };
    { 19, 22403, "", "=q3=Diana's Pearl Necklace", "=ds=#s2#", "", "10.0%" };
    { 20, 66665, "", "=q4=Willey's Portable Howitzer", "=ds=#w5#", "", "10.0%" };
    { 21, 66666, "", "=q4=Master Cannoneer Boots", "=ds=#a4#", "", "10.0%" };
    { 22, 66871, "", "=q4=Barrage Girdle", "=ds=#a3#", "", "10.0%" };
    { 23, 66965, "", "=q4=Willey's Back Scratcher", "=ds=#w13#", "", "10.0%" };
    { 24, 66966, "", "=q4=Mantle of the Scarlet Crusade", "=ds=#a1#", "", "10.0%" };
    { 25, 66967, "", "=q4=Redemption", "=ds=#w9#", "", "10.0%" };
    { 26, 66968, "", "=q4=Helm of the New Moon", "=ds=#a2#", "", "10.0%" };
	};
    ...
    { 3, 22897, "", "=q1=Tome of Conjure Food VII", "=ds=#e2#", "", "14.0%" };
	...
	AtlasLoot_Data["STRATArchivistGalfordMYTHIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Mythic Archivist Galford", "=q5=CHANCE TO DROP"};
    { 2, 12811, "", "=q2=Righteous Orb", "=ds=#e7#", "", "66.0%" };
    { 3, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 5, 22897, "", "=q1=Tome of Conjure Food VII", "=ds=#e2#", "", "14.0%" };
    { 7, 0, "AO_Unknown", "=q6=Mythic Archivist Galford", "=q5=ONE WILL DROP"};
    { 8, 13387, "", "=q3=Foresight Girdle", "=ds=#a3#", "", "22.0%" };
    { 9, 16692, "", "=q3=Devout Gloves", "=ds=#a1#", "", "22.0%" };
    { 10, 69670, "", "=q4=Archivist Cape", "=ds=#a1#", "", "22.0%" };
    { 11, 69867, "", "=q4=Ash Covered Boots", "=ds=#a2#", "", "22.0%" };
    { 12, 69669, "", "=q4=Tome of Knowledge", "=ds=#s15#", "", "12.0%" };
	};

	AtlasLoot_Data["STRATArchivistGalfordHEROIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Heroic Archivist Galford", "=q5=CHANCE TO DROP"};
    { 2, 12811, "", "=q2=Righteous Orb", "=ds=#e7#", "", "66.0%" };
    { 3, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 5, 22897, "", "=q1=Tome of Conjure Food VII", "=ds=#e2#", "", "14.0%" };
    { 7, 0, "AO_Unknown", "=q6=Heroic Archivist Galford", "=q5=ONE WILL DROP"};
    { 8, 13387, "", "=q3=Foresight Girdle", "=ds=#a3#", "", "22.0%" };
    { 9, 16692, "", "=q3=Devout Gloves", "=ds=#a1#", "", "22.0%" };
    { 10, 66670, "", "=q4=Archivist Cape", "=ds=#a1#", "", "22.0%" };
    { 11, 66867, "", "=q4=Ash Covered Boots", "=ds=#a2#", "", "22.0%" };
    { 12, 66669, "", "=q4=Tome of Knowledge", "=ds=#s15#", "", "12.0%" };
	};
    ...
    { 3, 58719, "", "=q1=Dathrohan's Tainted Medallion", "=ds=#m3#", "", "100%" };
    { 5, 0, "RoM_stellar_dice", "=q6=Balnazzar", "=q5=CHANCE TO DROP"};
    { 6, 57483, "", "=q1=Technique: Scroll of Holy Resistance IV", "=ds=#e2#", "", "15.0%" };
    { 7, 59087, "", "=q3=Totem of Erupting Fury", "", "", "10.0%" };
	...
	AtlasLoot_Data["STRATBalnazzarMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Balnazzar", "=q5=ALL WILL DROP"};
    { 2, 13250, "", "=q1=Head of Balnazzar", "=ds=#m3#", "", "100%" };
    { 3, 58719, "", "=q1=Dathrohan's Tainted Medallion", "=ds=#m3#", "", "100%" };
    { 5, 0, "RoM_stellar_dice", "=q6=Mythic Balnazzar", "=q5=CHANCE TO DROP"};
    { 6, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 8, 57483, "", "=q1=Technique: Scroll of Holy Resistance IV", "=ds=#e2#", "", "15.0%" };
    { 9, 59087, "", "=q3=Totem of Erupting Fury", "", "", "10.0%" };
    { 10, 14512, "", "=q4=Pattern: Truefaith Vestments", "=ds=#e2#", "", "6.00%" };
    { 16, 0, "AO_Unknown", "=q6=Mythic Balnazzar", "=q5=ONE WILL DROP"};
    { 17, 13348, "", "=q3=Demonshear", "=ds=#w10#", "", "9.80%" };
    { 18, 16725, "", "=q3=Lightforge Boots", "=ds=#a4#", "", "9.80%" };
    { 19, 69569, "", "=q4=Star of Mystaria", "=ds=#s2#", "", "9.80%" };
    { 20, 69654, "", "=q4=Wyrmtongue Shoulders", "=ds=#a2#", "", "9.80%" };
    { 21, 69655, "", "=q4=Crown of Tyranny", "=ds=#a3#", "", "9.80%" };
    { 22, 69656, "", "=q4=Gift of the Elven Magi", "=ds=#w4#", "", "9.80%" };
    { 23, 69658, "", "=q4=Fire Striders", "=ds=#a1#", "", "9.80%" };
    { 24, 69868, "", "=q4=Hammer of the Grand Crusader", "=ds=#w6#", "", "9.80%" };
    { 25, 69869, "", "=q4=Grand Crusader's Helm", "=ds=#a4#", "", "9.80%" };
    { 26, 69870, "", "=q4=Shroud of the Nathrezim", "=ds=#a1#", "", "9.80%" };
    { 27, 13353, "", "=q4=Book of the Dead", "=ds=#s15#", "", "2.00%" };
	};
    ...
    { 2, 13250, "", "=q1=Head of Balnazzar", "=ds=#m3#", "", "100%" };
    { 3, 58719, "", "=q1=Dathrohan's Tainted Medallion", "=ds=#m3#", "", "100%" };
    { 5, 0, "RoM_stellar_dice", "=q6=Heroic Balnazzar", "=q5=CHANCE TO DROP"};
    { 6, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 8, 57483, "", "=q1=Technique: Scroll of Holy Resistance IV", "=ds=#e2#", "", "15.0%" };
    { 9, 59087, "", "=q3=Totem of Erupting Fury", "", "", "10.0%" };
    ...
    { 17, 13348, "", "=q3=Demonshear", "=ds=#w10#", "", "9.80%" };
    { 18, 16725, "", "=q3=Lightforge Boots", "=ds=#a4#", "", "9.80%" };
    { 19, 66569, "", "=q4=Star of Mystaria", "=ds=#s2#", "", "9.80%" };
    { 20, 66654, "", "=q4=Wyrmtongue Shoulders", "=ds=#a2#", "", "9.80%" };
    { 21, 66655, "", "=q4=Crown of Tyranny", "=ds=#a3#", "", "9.80%" };
    { 22, 66656, "", "=q4=Gift of the Elven Magi", "=ds=#w4#", "", "9.80%" };
    { 23, 66658, "", "=q4=Fire Striders", "=ds=#a1#", "", "9.80%" };
    { 24, 66868, "", "=q4=Hammer of the Grand Crusader", "=ds=#w6#", "", "9.80%" };
    { 25, 66869, "", "=q4=Grand Crusader's Helm", "=ds=#a4#", "", "9.80%" };
    { 26, 66870, "", "=q4=Shroud of the Nathrezim", "=ds=#a1#", "", "9.80%" };
    { 27, 13353, "", "=q4=Book of the Dead", "=ds=#s15#", "", "2.00%" };
	};
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6=Stonespine", "=q5=ALL WILL DROP"};
    { 2, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    { 4, 0, "AO_Unknown", "=q6=Stonespine", "=q5=ONE WILL DROP"};
    { 5, 13397, "", "=q3=Stoneskin Gargoyle Cape", "=ds=#a1#", "", "33.3%" };
    { 6, 13399, "", "=q3=Gargoyle Shredder Talons", "=ds=#w13#", "", "33.3%" };
    { 7, 13954, "", "=q3=Verdant Footpads", "=ds=#a2#", "", "33.3%" };
	};

	AtlasLoot_Data["STRATBaronessAnastari"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Baroness Anastari", "=q5=ALL WILL DROP"};
    { 2, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Baroness Anastari", "=q5=CHANCE TO DROP"};
    { 5, 13174, "", "=q1=Plagued Flesh Sample", "=ds=#m3#", "", "80.0%" };
    { 6, 58337, "", "=q3=Codex: Prayer of Spirit", "=ds=#e2#", "", "12.0%" };
    { 8, 0, "AO_Unknown", "=q6=Baroness Anastari", "=q5=ONE WILL DROP"};
    { 9, 13534, "", "=q3=Banshee Finger", "=ds=#w12#", "", "20.0%" };
    { 10, 16704, "", "=q3=Dreadmist Sandals", "=ds=#a1#", "", "20.0%" };
    { 11, 18728, "", "=q3=Anastari Heirloom", "=ds=#s2#", "", "20.0%" };
    { 12, 18729, "", "=q3=Screeching Bow", "=ds=#w2#", "", "20.0%" };
    { 13, 18730, "", "=q3=Shadowy Laced Handwraps", "=ds=#a1#", "", "20.0%" };
    { 16, 0, "AO_Unknown", "=q6=Baroness Anastari", "=q5=ONE WILL DROP"};
	...
	AtlasLoot_Data["STRATBaronessAnastariMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Baroness Anastari", "=q5=ALL WILL DROP"};
    { 2, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Mythic Baroness Anastari", "=q5=CHANCE TO DROP"};
    { 5, 13174, "", "=q1=Plagued Flesh Sample", "=ds=#m3#", "", "80.0%" };
    { 6, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 9, 0, "AO_Unknown", "=q6=Mythic Baroness Anastari", "=q5=ONE WILL DROP"};
    { 10, 16704, "", "=q3=Dreadmist Sandals", "=ds=#a1#", "", "20.0%" };
    { 11, 69694, "", "=q4=Banshee Finger", "=ds=#w12#", "", "20.0%" };
    { 12, 69876, "", "=q4=Anastari Heirloom", "=ds=#s2#", "", "20.0%" };
    { 13, 69877, "", "=q4=Screeching Bow", "=ds=#w2#", "", "20.0%" };
    { 14, 69878, "", "=q4=Shadowy Laced Handwraps", "=ds=#a1#", "", "20.0%" };
    { 16, 0, "AO_Unknown", "=q6=Mythic Baroness Anastari", "=q5=ONE WILL DROP"};
    { 17, 13514, "", "=q2=Wail of the Banshee", "=ds=#e0#", "", "20.0%" };
    { 18, 69695, "", "=q4=Coldtouch Phantom Wraps", "=ds=#a1#", "", "20.0%" };
    { 19, 69696, "", "=q4=Chillhide Bracers", "=ds=#a2#", "", "20.0%" };
    { 20, 69697, "", "=q4=Windshrieker Pauldrons", "=ds=#a3#", "", "20.0%" };
    { 21, 69698, "", "=q4=Banshee's Touch", "=ds=#a4#", "", "20.0%" };
	};

	AtlasLoot_Data["STRATBaronessAnastariHEROIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Heroic Baroness Anastari", "=q5=ALL WILL DROP"};
    { 2, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Heroic Baroness Anastari", "=q5=CHANCE TO DROP"};
    { 5, 13174, "", "=q1=Plagued Flesh Sample", "=ds=#m3#", "", "80.0%" };
    { 6, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 9, 0, "AO_Unknown", "=q6=Heroic Baroness Anastari", "=q5=ONE WILL DROP"};
    { 10, 16704, "", "=q3=Dreadmist Sandals", "=ds=#a1#", "", "20.0%" };
    { 11, 66694, "", "=q4=Banshee Finger", "=ds=#w12#", "", "20.0%" };
    { 12, 66876, "", "=q4=Anastari Heirloom", "=ds=#s2#", "", "20.0%" };
    { 13, 66877, "", "=q4=Screeching Bow", "=ds=#w2#", "", "20.0%" };
    { 14, 66878, "", "=q4=Shadowy Laced Handwraps", "=ds=#a1#", "", "20.0%" };
    { 16, 0, "AO_Unknown", "=q6=Heroic Baroness Anastari", "=q5=ONE WILL DROP"};
    { 17, 13514, "", "=q2=Wail of the Banshee", "=ds=#e0#", "", "20.0%" };
    { 18, 66695, "", "=q4=Coldtouch Phantom Wraps", "=ds=#a1#", "", "20.0%" };
    { 19, 66696, "", "=q4=Chillhide Bracers", "=ds=#a2#", "", "20.0%" };
    { 20, 66697, "", "=q4=Windshrieker Pauldrons", "=ds=#a3#", "", "20.0%" };
    { 21, 66698, "", "=q4=Banshee's Touch", "=ds=#a4#", "", "20.0%" };
	};
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6=Nerub'enkan", "=q5=ALL WILL DROP"};
    { 2, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Nerub'enkan", "=q5=CHANCE TO DROP"};
    { 5, 13174, "", "=q1=Plagued Flesh Sample", "=ds=#m3#", "", "80.0%" };
    { 7, 0, "AO_Unknown", "=q6=Nerub'enkan", "=q5=ONE WILL DROP"};
    { 8, 13529, "", "=q3=Husk of Nerub'enkan", "=ds=#w8#", "", "20.0%" };
    { 9, 16675, "", "=q3=Beaststalker's Boots", "=ds=#a3#", "", "20.0%" };
    { 10, 18738, "", "=q3=Carapace Spine Crossbow", "=ds=#w3#", "", "20.0%" };
    { 11, 18739, "", "=q3=Chitinous Plate Legguards", "=ds=#a4#", "", "20.0%" };
    { 12, 18740, "", "=q3=Thuzadin Sash", "=ds=#a1#", "", "20.0%" };
    { 16, 0, "AO_Unknown", "=q6=Nerub'enkan", "=q5=ONE WILL DROP"};
	...
	AtlasLoot_Data["STRATNerubenkanMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Nerub'enkan", "=q5=ALL WILL DROP"};
    { 2, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Mythic Nerub'enkan", "=q5=CHANCE TO DROP"};
    { 5, 13174, "", "=q1=Plagued Flesh Sample", "=ds=#m3#", "", "80.0%" };
    { 6, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 9, 0, "AO_Unknown", "=q6=Mythic Nerub'enkan", "=q5=ONE WILL DROP"};
    { 10, 16675, "", "=q3=Beaststalker's Boots", "=ds=#a3#", "", "20.0%" };
    { 11, 69689, "", "=q4=Husk of Nerub'enkan", "=ds=#w8#", "", "20.0%" };
    { 12, 69882, "", "=q4=Carapace Spine Crossbow", "=ds=#w3#", "", "20.0%" };
    { 13, 69883, "", "=q4=Chitinous Plate Legguards", "=ds=#a4#", "", "20.0%" };
    { 14, 69884, "", "=q4=Thuzadin Sash", "=ds=#a1#", "", "20.0%" };
    { 16, 0, "AO_Unknown", "=q6=Mythic Nerub'enkan", "=q5=ONE WILL DROP"};
    { 17, 13508, "", "=q2=Eye of Arachnida", "=ds=#e0#", "", "20.0%" };
    { 18, 69690, "", "=q4=Fangdrip Runners", "=ds=#a1#", "", "20.0%" };
    { 19, 69691, "", "=q4=Crypt Stalker Leggings", "=ds=#a2#", "", "20.0%" };
    { 20, 69692, "", "=q4=Darkspinner Claws", "=ds=#a3#", "", "20.0%" };
    { 21, 69693, "", "=q4=Acid-etched Pauldrons", "=ds=#a4#", "", "20.0%" };
	};

	AtlasLoot_Data["STRATNerubenkanHEROIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Heroic Nerub'enkan", "=q5=ALL WILL DROP"};
    { 2, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Heroic Nerub'enkan", "=q5=CHANCE TO DROP"};
    { 5, 13174, "", "=q1=Plagued Flesh Sample", "=ds=#m3#", "", "80.0%" };
    { 6, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 9, 0, "AO_Unknown", "=q6=Heroic Nerub'enkan", "=q5=ONE WILL DROP"};
    { 10, 16675, "", "=q3=Beaststalker's Boots", "=ds=#a3#", "", "20.0%" };
    { 11, 66689, "", "=q4=Husk of Nerub'enkan", "=ds=#w8#", "", "20.0%" };
    { 12, 66882, "", "=q4=Carapace Spine Crossbow", "=ds=#w3#", "", "20.0%" };
    { 13, 66883, "", "=q4=Chitinous Plate Legguards", "=ds=#a4#", "", "20.0%" };
    { 14, 66884, "", "=q4=Thuzadin Sash", "=ds=#a1#", "", "20.0%" };
    { 16, 0, "AO_Unknown", "=q6=Heroic Nerub'enkan", "=q5=ONE WILL DROP"};
    { 17, 13508, "", "=q2=Eye of Arachnida", "=ds=#e0#", "", "20.0%" };
    { 18, 66690, "", "=q4=Fangdrip Runners", "=ds=#a1#", "", "20.0%" };
    { 19, 66691, "", "=q4=Crypt Stalker Leggings", "=ds=#a2#", "", "20.0%" };
    { 20, 66692, "", "=q4=Darkspinner Claws", "=ds=#a3#", "", "20.0%" };
    { 21, 66693, "", "=q4=Acid-etched Pauldrons", "=ds=#a4#", "", "20.0%" };
	};

	AtlasLoot_Data["STRATMalekithePallid"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Maleki the Pallid", "=q5=ALL WILL DROP"};
    { 2, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Maleki the Pallid", "=q5=CHANCE TO DROP"};
    { 5, 58337, "", "=q3=Codex: Prayer of Spirit", "=ds=#e2#", "", "10.0%" };
    { 6, 12833, "", "=q3=Plans: Hammer of the Titans", "=ds=#e2#", "", "6.00%" };
    { 8, 0, "AO_Unknown", "=q6=Maleki the Pallid", "=q5=ONE WILL DROP"};
    { 9, 13524, "", "=q3=Skull of Burning Shadows", "=ds=#s15#", "", "20.0%" };
    { 10, 16691, "", "=q3=Devout Sandals", "=ds=#a1#", "", "20.0%" };
    { 11, 18734, "", "=q3=Pale Moon Cloak", "=ds=#a1#", "", "20.0%" };
	...
	AtlasLoot_Data["STRATMalekithePallidMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Maleki the Pallid", "=q5=ALL WILL DROP"};
    { 2, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Mythic Maleki the Pallid", "=q5=CHANCE TO DROP"};
    { 5, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 12833, "", "=q3=Plans: Hammer of the Titans", "=ds=#e2#", "", "6.00%" };
    { 9, 0, "AO_Unknown", "=q6=Mythic Maleki the Pallid", "=q5=ONE WILL DROP"};
    { 10, 16691, "", "=q3=Devout Sandals", "=ds=#a1#", "", "20.0%" };
    { 11, 69684, "", "=q4=Skull of Burning Shadows", "=ds=#s15#", "", "20.0%" };
    { 12, 69879, "", "=q4=Pale Moon Cloak", "=ds=#a1#", "", "20.0%" };
    { 13, 69880, "", "=q4=Maleki's Footwraps", "=ds=#a1#", "", "20.0%" };
    { 14, 69881, "", "=q4=Bone Slicing Hatchet", "=ds=#w1#", "", "20.0%" };
    { 16, 0, "AO_Unknown", "=q6=Mythic Maleki the Pallid", "=q5=ONE WILL DROP"};
    { 17, 13509, "", "=q2=Clutch of Foresight", "=ds=#e0#", "", "20.0%" };
    { 18, 69685, "", "=q4=Darkbind Fingers", "=ds=#a1#", "", "20.0%" };
    { 19, 69686, "", "=q4=Flamescarred Girdle", "=ds=#a2#", "", "20.0%" };
    { 20, 69687, "", "=q4=Lavawalker Greaves", "=ds=#a4#", "", "20.0%" };
    { 21, 69688, "", "=q4=Twilight Void Bracers", "=ds=#a3#", "", "20.0%" };
	};

	AtlasLoot_Data["STRATMalekithePallidHEROIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Heroic Maleki the Pallid", "=q5=ALL WILL DROP"};
    { 2, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Heroic Maleki the Pallid", "=q5=CHANCE TO DROP"};
    { 5, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 12833, "", "=q3=Plans: Hammer of the Titans", "=ds=#e2#", "", "6.00%" };
    { 9, 0, "AO_Unknown", "=q6=Heroic Maleki the Pallid", "=q5=ONE WILL DROP"};
    { 10, 16691, "", "=q3=Devout Sandals", "=ds=#a1#", "", "20.0%" };
    { 11, 66684, "", "=q4=Skull of Burning Shadows", "=ds=#s15#", "", "20.0%" };
    { 12, 66879, "", "=q4=Pale Moon Cloak", "=ds=#a1#", "", "20.0%" };
    { 13, 66880, "", "=q4=Maleki's Footwraps", "=ds=#a1#", "", "20.0%" };
    { 14, 66881, "", "=q4=Bone Slicing Hatchet", "=ds=#w1#", "", "20.0%" };
    { 16, 0, "AO_Unknown", "=q6=Heroic Maleki the Pallid", "=q5=ONE WILL DROP"};
    { 17, 13509, "", "=q2=Clutch of Foresight", "=ds=#e0#", "", "20.0%" };
    { 18, 66685, "", "=q4=Darkbind Fingers", "=ds=#a1#", "", "20.0%" };
    { 19, 66686, "", "=q4=Flamescarred Girdle", "=ds=#a2#", "", "20.0%" };
    { 20, 66687, "", "=q4=Lavawalker Greaves", "=ds=#a4#", "", "20.0%" };
    { 21, 66688, "", "=q4=Twilight Void Bracers", "=ds=#a3#", "", "20.0%" };
	};

	AtlasLoot_Data["STRATMagistrateBarthilas"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Magistrate Barthilas", "=q5=ALL WILL DROP"};
    ...
    { 7, 57483, "", "=q1=Technique: Scroll of Holy Resistance IV", "=ds=#e2#", "", "15.0%" };
	...
	AtlasLoot_Data["STRATMagistrateBarthilasMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Magistrate Barthilas", "=q5=ALL WILL DROP"};
    { 2, 12382, "", "=q2=Key to the City", "=ds=#e5#", "", "100%" };
    { 3, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    { 5, 0, "RoM_stellar_dice", "=q6=Mythic Magistrate Barthilas", "=q5=CHANCE TO DROP"};
    { 6, 13174, "", "=q1=Plagued Flesh Sample", "=ds=#m3#", "", "80.0%" };
    { 7, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 8, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 9, 57483, "", "=q1=Technique: Scroll of Holy Resistance IV", "=ds=#e2#", "", "15.0%" };
    { 16, 0, "AO_Unknown", "=q6=Mythic Magistrate Barthilas", "=q5=ONE WILL DROP"};
    { 17, 18722, "", "=q3=Death Grips", "=ds=#a4#", "", "16.7%" };
    { 18, 69663, "", "=q4=Royal Tribunal Cloak", "=ds=#a1#", "", "16.7%" };
    { 19, 69873, "", "=q4=Peacemaker", "=ds=#w7#", "", "16.7%" };
    { 20, 69874, "", "=q4=Magistrate's Cuffs", "=ds=#a2#", "", "16.7%" };
    { 21, 69875, "", "=q4=Crimson Felt Hat", "=ds=#a1#", "", "16.7%" };
    { 22, 69993, "", "=q4=Idol of Brutality", "", "", "16.7%" };
	};
    ...
    { 2, 12382, "", "=q2=Key to the City", "=ds=#e5#", "", "100%" };
    { 3, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    { 5, 0, "RoM_stellar_dice", "=q6=Heroic Magistrate Barthilas", "=q5=CHANCE TO DROP"};
    { 6, 13174, "", "=q1=Plagued Flesh Sample", "=ds=#m3#", "", "80.0%" };
    { 7, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 8, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 9, 57483, "", "=q1=Technique: Scroll of Holy Resistance IV", "=ds=#e2#", "", "15.0%" };
    { 16, 0, "AO_Unknown", "=q6=Heroic Magistrate Barthilas", "=q5=ONE WILL DROP"};
    { 17, 18722, "", "=q3=Death Grips", "=ds=#a4#", "", "16.7%" };
    { 18, 66663, "", "=q4=Royal Tribunal Cloak", "=ds=#a1#", "", "16.7%" };
    { 19, 66873, "", "=q4=Peacemaker", "=ds=#w7#", "", "16.7%" };
    { 20, 66874, "", "=q4=Magistrate's Cuffs", "=ds=#a2#", "", "16.7%" };
    { 21, 66875, "", "=q4=Crimson Felt Hat", "=ds=#a1#", "", "16.7%" };
    { 22, 66993, "", "=q4=Idol of Brutality", "", "", "16.7%" };
	};
    ...
    { 6, 0, "RoM_stellar_dice", "=q6=Ramstein the Gorger", "=q5=CHANCE TO DROP"};
    { 7, 13174, "", "=q1=Plagued Flesh Sample", "=ds=#m3#", "", "80.0%" };
    { 9, 0, "AO_Unknown", "=q6=Ramstein the Gorger", "=q5=ONE WILL DROP"};
    { 10, 13372, "", "=q3=Slavedriver's Cane", "=ds=#w9#", "", "14.7%" };
    { 11, 13373, "", "=q3=Band of Flesh", "=ds=#s13#", "", "14.7%" };
    { 12, 13374, "", "=q3=Soulstealer Mantle", "=ds=#a1#", "", "14.7%" };
    { 13, 13375, "", "=q3=Crest of Retribution", "=ds=#w8#", "", "14.7%" };
    { 14, 13515, "", "=q3=Ramstein's Lightning Bolts", "=ds=#s14#", "", "14.7%" };
    { 15, 18723, "", "=q3=Animated Chain Necklace", "=ds=#s2#", "", "14.7%" };
    { 16, 16737, "", "=q3=Gauntlets of Valor", "=ds=#a4#", "", "12.0%" };
	};

	AtlasLoot_Data["STRATRamsteintheGorgerMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Ramstein the Gorger", "=q5=ALL WILL DROP"};
    { 2, 12735, "", "=q2=Frayed Abomination Stitching", "=ds=#m3#", "", "100%" };
    { 3, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    { 4, 15880, "", "=q1=Head of Ramstein the Gorger", "=ds=#m3#", "", "100%" };
    { 6, 0, "RoM_stellar_dice", "=q6=Mythic Ramstein the Gorger", "=q5=CHANCE TO DROP"};
    { 7, 13174, "", "=q1=Plagued Flesh Sample", "=ds=#m3#", "", "80.0%" };
    { 8, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 9, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
	};
    ...
    { 3, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    { 4, 15880, "", "=q1=Head of Ramstein the Gorger", "=ds=#m3#", "", "100%" };
    { 6, 0, "RoM_stellar_dice", "=q6=Heroic Ramstein the Gorger", "=q5=CHANCE TO DROP"};
    { 7, 13174, "", "=q1=Plagued Flesh Sample", "=ds=#m3#", "", "80.0%" };
    { 8, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 9, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
	};
    ...
    { 4, 58724, "", "=q1=Rivendare's Runeblade", "=ds=#m3#", "", "100%" };
    ...
    { 9, 58337, "", "=q3=Codex: Prayer of Spirit", "=ds=#e2#", "", "15.0%" };
    { 10, 57625, "", "=q6=Pattern: Artisan Riding Crop", "=ds=#e2#", "", "10.0%" };
    { 11, 59088, "", "=q3=Libram of the Crusader's Spire", "", "", "10.0%" };
    { 12, 13340, "", "=q3=Cape of the Black Baron", "=ds=#a1#", "", "8.70%" };
    { 13, 13335, "", "=q4=Deathcharger's Reins", "=ds=#e10#", "", "1.00%" };
	...
	AtlasLoot_Data["STRATBaronRivendareMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Baron Rivendare", "=q5=ALL WILL DROP"};
    { 2, 12843, "", "=q2=Corruptor's Scourgestone", "=ds=#m3#", "", "100%" };
    { 3, 13251, "", "=q1=Head of Baron Rivendare", "=ds=#m3#", "", "100%" };
    { 4, 58724, "", "=q1=Rivendare's Runeblade", "=ds=#m3#", "", "100%" };
    { 6, 0, "RoM_stellar_dice", "=q6=Mythic Baron Rivendare", "=q5=CHANCE TO DROP"};
    { 7, 13174, "", "=q1=Plagued Flesh Sample", "=ds=#m3#", "", "80.0%" };
    { 8, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 9, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 10, 57625, "", "=q6=Pattern: Artisan Riding Crop", "=ds=#e2#", "", "10.0%" };
    { 11, 59088, "", "=q3=Libram of the Crusader's Spire", "", "", "10.0%" };
    { 12, 69649, "", "=q4=Cape of the Black Baron", "=ds=#a1#", "", "8.70%" };
    { 13, 13335, "", "=q4=Deathcharger's Reins", "=ds=#e10#", "", "1.00%" };
    { 16, 0, "AO_Unknown", "=q6=Mythic Baron Rivendare", "=q5=ONE WILL DROP"};
    { 17, 59002, "", "=q3=Rivendare's Armor Cache - Legs", "=ds=#e10#", "", "7.91%" };
    { 18, 69650, "", "=q4=Dracorian Gauntlets", "=ds=#a3#", "", "7.91%" };
    { 19, 69651, "", "=q4=Seal of Rivendare", "=ds=#s13#", "", "7.91%" };
    { 20, 69652, "", "=q4=Robes of the Exalted", "=ds=#a1#", "", "7.91%" };
    { 21, 69653, "", "=q4=Scepter of the Unholy", "=ds=#w6#", "", "7.91%" };
    { 22, 69969, "", "=q4=Ritssyn's Wand of Bad Mojo", "=ds=#w12#", "", "7.91%" };
    { 23, 69970, "", "=q4=Tunic of the Crescent Moon", "=ds=#a2#", "", "7.91%" };
    { 24, 69971, "", "=q4=Gauntlets of Deftness", "=ds=#a3#", "", "7.91%" };
    { 25, 69972, "", "=q4=Helm of the Executioner", "=ds=#a4#", "", "7.91%" };
    { 26, 69973, "", "=q4=Thuzadin Mantle", "=ds=#a1#", "", "7.91%" };
    { 27, 13361, "", "=q3=Skullforge Reaver", "=ds=#w10#", "", "6.00%" };
    { 28, 69657, "", "=q4=Bonescraper", "=ds=#w4#", "", "6.00%" };
    { 29, 13505, "", "=q4=Runeblade of Baron Rivendare", "=ds=#w10#", "", "1.00%" };
	};
    ...
    { 3, 13251, "", "=q1=Head of Baron Rivendare", "=ds=#m3#", "", "100%" };
    { 4, 58724, "", "=q1=Rivendare's Runeblade", "=ds=#m3#", "", "100%" };
    { 6, 0, "RoM_stellar_dice", "=q6=Heroic Baron Rivendare", "=q5=CHANCE TO DROP"};
    { 7, 13174, "", "=q1=Plagued Flesh Sample", "=ds=#m3#", "", "80.0%" };
    { 8, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 9, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 10, 57625, "", "=q6=Pattern: Artisan Riding Crop", "=ds=#e2#", "", "10.0%" };
    { 11, 59088, "", "=q3=Libram of the Crusader's Spire", "", "", "10.0%" };
    { 12, 66649, "", "=q4=Cape of the Black Baron", "=ds=#a1#", "", "8.70%" };
    { 13, 13335, "", "=q4=Deathcharger's Reins", "=ds=#e10#", "", "1.00%" };
    { 16, 0, "AO_Unknown", "=q6=Heroic Baron Rivendare", "=q5=ONE WILL DROP"};
    { 17, 59002, "", "=q3=Rivendare's Armor Cache - Legs", "=ds=#e10#", "", "7.91%" };
    { 18, 66650, "", "=q4=Dracorian Gauntlets", "=ds=#a3#", "", "7.91%" };
    { 19, 66651, "", "=q4=Seal of Rivendare", "=ds=#s13#", "", "7.91%" };
    { 20, 66652, "", "=q4=Robes of the Exalted", "=ds=#a1#", "", "7.91%" };
    { 21, 66653, "", "=q4=Scepter of the Unholy", "=ds=#w6#", "", "7.91%" };
    { 22, 66969, "", "=q4=Ritssyn's Wand of Bad Mojo", "=ds=#w12#", "", "7.91%" };
    { 23, 66970, "", "=q4=Tunic of the Crescent Moon", "=ds=#a2#", "", "7.91%" };
    { 24, 66971, "", "=q4=Gauntlets of Deftness", "=ds=#a3#", "", "7.91%" };
    { 25, 66972, "", "=q4=Helm of the Executioner", "=ds=#a4#", "", "7.91%" };
    { 26, 66973, "", "=q4=Thuzadin Mantle", "=ds=#a1#", "", "7.91%" };
    { 27, 13361, "", "=q3=Skullforge Reaver", "=ds=#w10#", "", "6.00%" };
    { 28, 66657, "", "=q4=Bonescraper", "=ds=#w4#", "", "6.00%" };
    { 29, 13505, "", "=q4=Runeblade of Baron Rivendare", "=ds=#w10#", "", "1.00%" };
	};
	...
	AtlasLoot_Data["StockTargorrMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Targorr the Dread", "=q5=ALL WILL DROP"};
    { 2, 3630, "", "=q1=Head of Targorr", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Mythic Targorr the Dread", "=q5=CHANCE TO DROP"};
    { 5, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 59047, "", "=q2=Libram of Justice's Edge", "", "", "10.0%" };
	};

	AtlasLoot_Data["StockTargorrHEROIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Heroic Targorr the Dread", "=q5=ALL WILL DROP"};
    { 2, 3630, "", "=q1=Head of Targorr", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Heroic Targorr the Dread", "=q5=CHANCE TO DROP"};
    { 5, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 59047, "", "=q2=Libram of Justice's Edge", "", "", "10.0%" };
	};
	...
	AtlasLoot_Data["StockKamMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Kam Deepfury", "=q5=ALL WILL DROP"};
    { 2, 3640, "", "=q1=Head of Deepfury", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Mythic Kam Deepfury", "=q5=CHANCE TO DROP"};
    { 5, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
	};
    ...
    { 2, 3640, "", "=q1=Head of Deepfury", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Heroic Kam Deepfury", "=q5=CHANCE TO DROP"};
    { 5, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
	};

	AtlasLoot_Data["StockBazil"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Bazil Thredd", "=q5=ALL WILL DROP"};
    { 2, 2926, "", "=q1=Head of Bazil Thredd", "=ds=#m3#", "", "100%" };
    { 3, 58702, "", "=q1=Prison Wallet", "=ds=#m3#", "", "100%" };
    { 5, 0, "RoM_stellar_dice", "=q6=Bazil Thredd", "=q5=CHANCE TO DROP"};
    { 6, 2909, "", "=q1=Red Wool Bandana", "=ds=#m3#", "", "80.0%" };
    { 7, 59048, "", "=q2=Inmate's Carved Totem", "", "", "10.0%" };
    { 9, 0, "AO_Unknown", "=q6=Bazil Thredd", "=q5=ONE WILL DROP"};
    { 10, 59100, "", "=q3=Thredded Belt", "=ds=#a2#", "", "50.0%" };
    { 11, 59101, "", "=q3=Needle Thredder", "=ds=#w3#", "", "50.0%" };
	};

	AtlasLoot_Data["StockBazilMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Bazil Thredd", "=q5=ALL WILL DROP"};
    { 2, 2926, "", "=q1=Head of Bazil Thredd", "=ds=#m3#", "", "100%" };
    { 3, 58702, "", "=q1=Prison Wallet", "=ds=#m3#", "", "100%" };
    { 5, 0, "RoM_stellar_dice", "=q6=Mythic Bazil Thredd", "=q5=CHANCE TO DROP"};
    { 6, 2909, "", "=q1=Red Wool Bandana", "=ds=#m3#", "", "80.0%" };
    { 7, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 8, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 9, 59048, "", "=q2=Inmate's Carved Totem", "", "", "10.0%" };
	};
    ...
    { 2, 2926, "", "=q1=Head of Bazil Thredd", "=ds=#m3#", "", "100%" };
    { 3, 58702, "", "=q1=Prison Wallet", "=ds=#m3#", "", "100%" };
    { 5, 0, "RoM_stellar_dice", "=q6=Heroic Bazil Thredd", "=q5=CHANCE TO DROP"};
    { 6, 2909, "", "=q1=Red Wool Bandana", "=ds=#m3#", "", "80.0%" };
    { 7, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 8, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 9, 59048, "", "=q2=Inmate's Carved Totem", "", "", "10.0%" };
	...
	AtlasLoot_Data["StockDextrenMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Dextren Ward", "=q5=ALL WILL DROP"};
    { 2, 3628, "", "=q1=Hand of Dextren Ward", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Mythic Dextren Ward", "=q5=CHANCE TO DROP"};
    { 5, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
	};
    ...
    { 2, 3628, "", "=q1=Hand of Dextren Ward", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Heroic Dextren Ward", "=q5=CHANCE TO DROP"};
    { 5, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
	};

	AtlasLoot_Data["StockBruegal"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Bruegal Ironknuckle", "=q5=CHANCE TO DROP"};
    { 2, 2909, "", "=q1=Red Wool Bandana", "=ds=#m3#", "", "80.0%" };
    { 3, 17, "", "=q6=Martin Fury", "=ds=#a4#", "", "" };
    { 5, 0, "AO_Unknown", "=q6=Bruegal Ironknuckle", "=q5=ONE WILL DROP"};
    { 6, 3228, "", "=q3=Jimmied Handcuffs", "=ds=#a3#", "", "60.0%" };
    { 7, 2941, "", "=q3=Prison Shank", "=ds=#w4#", "", "20.0%" };
    { 8, 2942, "", "=q3=Iron Knuckles", "=ds=#w13#", "", "20.0%" };
	};

	AtlasLoot_Data["StockBruegalMYTHIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Mythic Bruegal Ironknuckle", "=q5=CHANCE TO DROP"};
    { 2, 2909, "", "=q1=Red Wool Bandana", "=ds=#m3#", "", "80.0%" };
    { 3, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 0, "AO_Unknown", "=q6=Mythic Bruegal Ironknuckle", "=q5=ONE WILL DROP"};
    { 7, 69311, "", "=q4=Jimmied Handcuffs", "=ds=#a3#", "", "60.0%" };
    { 8, 2942, "", "=q3=Iron Knuckles", "=ds=#w13#", "", "20.0%" };
    { 9, 69308, "", "=q4=Prison Shank", "=ds=#w4#", "", "20.0%" };
	};

	AtlasLoot_Data["StockBruegalHEROIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Heroic Bruegal Ironknuckle", "=q5=CHANCE TO DROP"};
    { 2, 2909, "", "=q1=Red Wool Bandana", "=ds=#m3#", "", "80.0%" };
    { 3, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 0, "AO_Unknown", "=q6=Heroic Bruegal Ironknuckle", "=q5=ONE WILL DROP"};
    { 7, 66311, "", "=q4=Jimmied Handcuffs", "=ds=#a3#", "", "60.0%" };
    { 8, 2942, "", "=q3=Iron Knuckles", "=ds=#w13#", "", "20.0%" };
    { 9, 66308, "", "=q4=Prison Shank", "=ds=#w4#", "", "20.0%" };
	};
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6=Atal'alarion", "=q5=ALL WILL DROP"};
    { 2, 58729, "", "=q1=Shirvallah's Tear", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Atal'alarion", "=q5=CHANCE TO DROP"};
    { 5, 6181, "", "=q1=Fetish of Hakkar", "=ds=#m3#", "", "80.0%" };
    { 6, 59071, "", "=q3=Totem of Restoring Waters", "", "", "10.0%" };
    { 8, 0, "AO_Unknown", "=q6=Atal'alarion", "=q5=ONE WILL DROP"};
    { 9, 10798, "", "=q3=Atal'alarion's Tusk Ring", "=ds=#a4#", "", "40.0%" };
    { 10, 10800, "", "=q3=Darkwater Bracers", "=ds=#a2#", "", "40.0%" };
    { 11, 10799, "", "=q3=Headspike", "=ds=#w7#", "", "20.0%" };
	};

	AtlasLoot_Data["STAtalalarionMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Atal'alarion", "=q5=ALL WILL DROP"};
    { 2, 58729, "", "=q1=Shirvallah's Tear", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Mythic Atal'alarion", "=q5=CHANCE TO DROP"};
    { 5, 6181, "", "=q1=Fetish of Hakkar", "=ds=#m3#", "", "80.0%" };
    { 6, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 8, 59071, "", "=q3=Totem of Restoring Waters", "", "", "10.0%" };
    { 10, 0, "AO_Unknown", "=q6=Mythic Atal'alarion", "=q5=ONE WILL DROP"};
    { 11, 69480, "", "=q4=Atal'alarion's Tusk Ring", "=ds=#a4#", "", "40.0%" };
    { 12, 69482, "", "=q4=Darkwater Bracers", "=ds=#a2#", "", "40.0%" };
    { 13, 69481, "", "=q4=Headspike", "=ds=#w7#", "", "20.0%" };
	};

	AtlasLoot_Data["STAtalalarionHEROIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Heroic Atal'alarion", "=q5=ALL WILL DROP"};
    { 2, 58729, "", "=q1=Shirvallah's Tear", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Heroic Atal'alarion", "=q5=CHANCE TO DROP"};
    { 5, 6181, "", "=q1=Fetish of Hakkar", "=ds=#m3#", "", "80.0%" };
    { 6, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 8, 59071, "", "=q3=Totem of Restoring Waters", "", "", "10.0%" };
    { 10, 0, "AO_Unknown", "=q6=Heroic Atal'alarion", "=q5=ONE WILL DROP"};
    { 11, 66480, "", "=q4=Atal'alarion's Tusk Ring", "=ds=#a4#", "", "40.0%" };
    { 12, 66482, "", "=q4=Darkwater Bracers", "=ds=#a2#", "", "40.0%" };
    { 13, 66481, "", "=q4=Headspike", "=ds=#w7#", "", "20.0%" };
	};
    ...
    { 3, 10796, "", "=q3=Drakestone", "=ds=#s15#", "", "5.00%" };
    { 4, 10797, "", "=q3=Firebreather", "=ds=#w10#", "", "5.00%" };
    { 5, 12243, "", "=q3=Smoldering Claw", "=ds=#w7#", "", "5.00%" };
    { 6, 12463, "", "=q3=Drakefang Butcher", "=ds=#w10#", "", "5.00%" };
    { 7, 12464, "", "=q3=Bloodfire Talons", "=ds=#a2#", "", "5.00%" };
    { 8, 12465, "", "=q3=Nightfall Drape", "=ds=#a1#", "", "5.00%" };
    { 9, 12466, "", "=q3=Dawnspire Cord", "=ds=#a1#", "", "5.00%" };
    { 16, 0, "RoM_stellar_dice", "=q6=Weaver", "=q5=CHANCE TO DROP"};
    { 17, 10795, "", "=q3=Drakeclaw Band", "=ds=#s13#", "", "5.00%" };
    { 18, 10796, "", "=q3=Drakestone", "=ds=#s15#", "", "5.00%" };
    { 19, 10797, "", "=q3=Firebreather", "=ds=#w10#", "", "5.00%" };
    { 20, 12243, "", "=q3=Smoldering Claw", "=ds=#w7#", "", "5.00%" };
    { 21, 12463, "", "=q3=Drakefang Butcher", "=ds=#w10#", "", "5.00%" };
    { 22, 12464, "", "=q3=Bloodfire Talons", "=ds=#a2#", "", "5.00%" };
    { 23, 12465, "", "=q3=Nightfall Drape", "=ds=#a1#", "", "5.00%" };
    { 24, 12466, "", "=q3=Dawnspire Cord", "=ds=#a1#", "", "5.00%" };
	};

	AtlasLoot_Data["STAvatarofHakkar"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Avatar of Hakkar", "=q5=CHANCE TO DROP"};
    { 2, 59073, "", "=q3=Idol of the Hakkari Swarm", "", "", "10.0%" };
    { 4, 0, "AO_Unknown", "=q6=Avatar of Hakkar", "=q5=ONE WILL DROP"};
    { 5, 10842, "", "=q3=Windscale Sarong", "=ds=#a2#", "", "17.2%" };
    { 6, 10843, "", "=q3=Featherskin Cape", "=ds=#a1#", "", "17.2%" };
    { 7, 10845, "", "=q3=Warrior's Embrace", "=ds=#a4#", "", "17.2%" };
    { 8, 10846, "", "=q3=Bloodshot Greaves", "=ds=#a3#", "", "17.2%" };
    { 9, 10838, "", "=q3=Might of Hakkar", "=ds=#w6#", "", "15.0%" };
    { 10, 10844, "", "=q3=Spire of Hakkar", "=ds=#w9#", "", "15.0%" };
    { 11, 12462, "", "=q4=Embrace of the Wind Serpent", "=ds=#a1#", "", "1.00%" };
	};

	AtlasLoot_Data["STAvatarofHakkarMYTHIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Mythic Avatar of Hakkar", "=q5=CHANCE TO DROP"};
    { 2, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 59073, "", "=q3=Idol of the Hakkari Swarm", "", "", "10.0%" };
    { 6, 0, "AO_Unknown", "=q6=Mythic Avatar of Hakkar", "=q5=ONE WILL DROP"};
    { 7, 69495, "", "=q4=Windscale Sarong", "=ds=#a2#", "", "17.2%" };
    { 8, 69496, "", "=q4=Featherskin Cape", "=ds=#a1#", "", "17.2%" };
    { 9, 69498, "", "=q4=Warrior's Embrace", "=ds=#a4#", "", "17.2%" };
    { 10, 69499, "", "=q4=Bloodshot Greaves", "=ds=#a3#", "", "17.2%" };
    { 11, 69494, "", "=q4=Might of Hakkar", "=ds=#w6#", "", "15.0%" };
    { 12, 69497, "", "=q4=Spire of Hakkar", "=ds=#w9#", "", "15.0%" };
    { 13, 69570, "", "=q4=Embrace of the Wind Serpent", "=ds=#a1#", "", "1.00%" };
	};

	AtlasLoot_Data["STAvatarofHakkarHEROIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Heroic Avatar of Hakkar", "=q5=CHANCE TO DROP"};
    { 2, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 59073, "", "=q3=Idol of the Hakkari Swarm", "", "", "10.0%" };
    { 6, 0, "AO_Unknown", "=q6=Heroic Avatar of Hakkar", "=q5=ONE WILL DROP"};
    { 7, 66495, "", "=q4=Windscale Sarong", "=ds=#a2#", "", "17.2%" };
    { 8, 66496, "", "=q4=Featherskin Cape", "=ds=#a1#", "", "17.2%" };
    { 9, 66498, "", "=q4=Warrior's Embrace", "=ds=#a4#", "", "17.2%" };
    { 10, 66499, "", "=q4=Bloodshot Greaves", "=ds=#a3#", "", "17.2%" };
    { 11, 66494, "", "=q4=Might of Hakkar", "=ds=#w6#", "", "15.0%" };
    { 12, 66497, "", "=q4=Spire of Hakkar", "=ds=#w9#", "", "15.0%" };
    { 13, 66570, "", "=q4=Embrace of the Wind Serpent", "=ds=#a1#", "", "1.00%" };
	};

	AtlasLoot_Data["STJammalanOgom"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Jammal'an the Prophet", "=q5=ALL WILL DROP"};
    { 2, 6212, "", "=q1=Head of Jammal'an", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Jammal'an the Prophet", "=q5=CHANCE TO DROP"};
    { 5, 6181, "", "=q1=Fetish of Hakkar", "=ds=#m3#", "", "80.0%" };
    { 6, 57468, "", "=q1=Technique: Scroll of Arcane Resistance IV", "=ds=#e2#", "", "15.0%" };
    { 7, 59072, "", "=q3=Libram of the Inner Sanctum", "", "", "10.0%" };
    { 9, 0, "AO_Unknown", "=q6=Jammal'an the Prophet", "=q5=ONE WILL DROP"};
    { 10, 10806, "", "=q3=Vestments of the Atal'ai Prophet", "=ds=#a1#", "", "33.3%" };
    { 11, 10807, "", "=q3=Kilt of the Atal'ai Prophet", "=ds=#a1#", "", "33.3%" };
    { 12, 10808, "", "=q3=Gloves of the Atal'ai Prophet", "=ds=#a1#", "", "33.3%" };
    ...
    { 20, 10803, "", "=q3=Blade of the Wretched", "=ds=#w10#", "", "33.3%" };
    { 21, 10804, "", "=q3=Fist of the Damned", "=ds=#w6#", "", "33.3%" };
    { 22, 10805, "", "=q3=Eater of the Dead", "=ds=#w1#", "", "33.3%" };
	};

	AtlasLoot_Data["STHazzasMorphaz"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Hazzas", "=q5=CHANCE TO DROP"};
    { 2, 10795, "", "=q3=Drakeclaw Band", "=ds=#s13#", "", "5.00%" };
    { 3, 10796, "", "=q3=Drakestone", "=ds=#s15#", "", "5.00%" };
    { 4, 10797, "", "=q3=Firebreather", "=ds=#w10#", "", "5.00%" };
    { 5, 12243, "", "=q3=Smoldering Claw", "=ds=#w7#", "", "5.00%" };
    ...
    { 8, 12465, "", "=q3=Nightfall Drape", "=ds=#a1#", "", "5.00%" };
    { 9, 12466, "", "=q3=Dawnspire Cord", "=ds=#a1#", "", "5.00%" };
    { 16, 0, "AO_ChestWithTreasures", "=q6=Morphaz", "=q5=ALL WILL DROP"};
    { 17, 20025, "", "=q1=Blood of Morphaz", "=ds=#m3#", "", "100%" };
    { 19, 0, "RoM_stellar_dice", "=q6=Morphaz", "=q5=CHANCE TO DROP"};
    { 20, 10795, "", "=q3=Drakeclaw Band", "=ds=#s13#", "", "5.00%" };
    { 21, 10796, "", "=q3=Drakestone", "=ds=#s15#", "", "5.00%" };
    { 22, 10797, "", "=q3=Firebreather", "=ds=#w10#", "", "5.00%" };
    { 23, 12243, "", "=q3=Smoldering Claw", "=ds=#w7#", "", "5.00%" };
    { 24, 12463, "", "=q3=Drakefang Butcher", "=ds=#w10#", "", "5.00%" };
    { 25, 12464, "", "=q3=Bloodfire Talons", "=ds=#a2#", "", "5.00%" };
    { 26, 12465, "", "=q3=Nightfall Drape", "=ds=#a1#", "", "5.00%" };
    { 27, 12466, "", "=q3=Dawnspire Cord", "=ds=#a1#", "", "5.00%" };
	};
    ...
    { 3, 58713, "", "=q1=Dream Seed", "=ds=#m3#", "", "100%" };
    { 5, 0, "RoM_stellar_dice", "=q6=Shade of Eranikus", "=q5=CHANCE TO DROP"};
    { 6, 57468, "", "=q1=Technique: Scroll of Arcane Resistance IV", "=ds=#e2#", "", "15.0%" };
    { 7, 59074, "", "=q3=Totem of Atal'ai's Bite", "", "", "10.0%" };
    { 9, 0, "AO_Unknown", "=q6=Shade of Eranikus", "=q5=ONE WILL DROP"};
    { 10, 10829, "", "=q3=The Dragon's Eye", "=ds=#s2#", "", "17.2%" };
    { 11, 10833, "", "=q3=Horns of Eranikus", "=ds=#a3#", "", "17.2%" };
    { 12, 10835, "", "=q3=Crest of Supremacy", "=ds=#w8#", "", "17.2%" };
    { 13, 10836, "", "=q3=Rod of Corrosion", "=ds=#w12#", "", "17.2%" };
    { 14, 10828, "", "=q3=Dire Nail", "=ds=#w4#", "", "15.0%" };
    { 15, 10837, "", "=q3=Tooth of Eranikus", "=ds=#w1#", "", "15.0%" };
    { 16, 10847, "", "=q4=Dragon's Call", "=ds=#w10#", "", "1.00%" };
	};

	AtlasLoot_Data["STEranikusMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Shade of Eranikus", "=q5=ALL WILL DROP"};
    { 2, 10454, "", "=q2=Essence of Eranikus", "=ds=#m3#", "", "100%" };
    { 3, 58713, "", "=q1=Dream Seed", "=ds=#m3#", "", "100%" };
    { 5, 0, "RoM_stellar_dice", "=q6=Mythic Shade of Eranikus", "=q5=CHANCE TO DROP"};
    { 6, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 8, 57468, "", "=q1=Technique: Scroll of Arcane Resistance IV", "=ds=#e2#", "", "15.0%" };
    { 9, 59074, "", "=q3=Totem of Atal'ai's Bite", "", "", "10.0%" };
    { 16, 0, "AO_Unknown", "=q6=Mythic Shade of Eranikus", "=q5=ONE WILL DROP"};
    { 17, 69489, "", "=q4=The Dragon's Eye", "=ds=#s2#", "", "17.2%" };
    { 18, 69490, "", "=q4=Horns of Eranikus", "=ds=#a3#", "", "17.2%" };
    { 19, 69491, "", "=q4=Crest of Supremacy", "=ds=#w8#", "", "17.2%" };
    { 20, 69492, "", "=q4=Rod of Corrosion", "=ds=#w12#", "", "17.2%" };
    { 21, 69488, "", "=q4=Dire Nail", "=ds=#w4#", "", "15.0%" };
    { 22, 69493, "", "=q4=Tooth of Eranikus", "=ds=#w1#", "", "15.0%" };
    { 23, 10847, "", "=q4=Dragon's Call", "=ds=#w10#", "", "1.00%" };
	};
    ...
    { 2, 10454, "", "=q2=Essence of Eranikus", "=ds=#m3#", "", "100%" };
    { 3, 58713, "", "=q1=Dream Seed", "=ds=#m3#", "", "100%" };
    { 5, 0, "RoM_stellar_dice", "=q6=Heroic Shade of Eranikus", "=q5=CHANCE TO DROP"};
    { 6, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 8, 57468, "", "=q1=Technique: Scroll of Arcane Resistance IV", "=ds=#e2#", "", "15.0%" };
    { 9, 59074, "", "=q3=Totem of Atal'ai's Bite", "", "", "10.0%" };
    { 16, 0, "AO_Unknown", "=q6=Heroic Shade of Eranikus", "=q5=ONE WILL DROP"};
    { 17, 66489, "", "=q4=The Dragon's Eye", "=ds=#s2#", "", "17.2%" };
    { 18, 66490, "", "=q4=Horns of Eranikus", "=ds=#a3#", "", "17.2%" };
    { 19, 66491, "", "=q4=Crest of Supremacy", "=ds=#w8#", "", "17.2%" };
    { 20, 66492, "", "=q4=Rod of Corrosion", "=ds=#w12#", "", "17.2%" };
    { 21, 66488, "", "=q4=Dire Nail", "=ds=#w4#", "", "15.0%" };
    { 22, 66493, "", "=q4=Tooth of Eranikus", "=ds=#w1#", "", "15.0%" };
    { 23, 10847, "", "=q4=Dragon's Call", "=ds=#w10#", "", "1.00%" };
	};
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6=Baelog", "=q5=ALL WILL DROP"};
    { 2, 9399, "", "=q2=Precision Arrow", "=ds=#e6#", "", "100%" };
    { 4, 0, "AO_Unknown", "=q6=Baelog", "=q5=ONE WILL DROP"};
    { 5, 9400, "", "=q3=Baelog's Shortbow", "=ds=#w2#", "", "90.0%" };
    { 6, 9401, "", "=q3=Nordic Longshank", "=ds=#w10#", "", "10.0%" };
	};

	AtlasLoot_Data["UldBaelogMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Baelog", "=q5=ALL WILL DROP"};
    { 2, 9399, "", "=q2=Precision Arrow", "=ds=#e6#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Mythic Baelog", "=q5=CHANCE TO DROP"};
    { 5, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 8, 0, "AO_Unknown", "=q6=Mythic Baelog", "=q5=ONE WILL DROP"};
    { 9, 69423, "", "=q4=Baelog's Shortbow", "=ds=#w2#", "", "90.0%" };
    { 10, 69424, "", "=q4=Nordic Longshank", "=ds=#w10#", "", "10.0%" };
	};

	AtlasLoot_Data["UldBaelogHEROIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Heroic Baelog", "=q5=ALL WILL DROP"};
    { 2, 9399, "", "=q2=Precision Arrow", "=ds=#e6#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Heroic Baelog", "=q5=CHANCE TO DROP"};
    { 5, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 8, 0, "AO_Unknown", "=q6=Heroic Baelog", "=q5=ONE WILL DROP"};
    { 9, 66423, "", "=q4=Baelog's Shortbow", "=ds=#w2#", "", "90.0%" };
    { 10, 66424, "", "=q4=Nordic Longshank", "=ds=#w10#", "", "10.0%" };
	};
	...
	AtlasLoot_Data["UldReveloshMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Revelosh", "=q5=ALL WILL DROP"};
    { 2, 7741, "", "=q3=The Shaft of Tsol", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Mythic Revelosh", "=q5=CHANCE TO DROP"};
    { 5, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 59063, "", "=q3=Idol of Buried Stars", "", "", "10.0%" };
    { 8, 69418, "", "=q4=Revelosh's Boots", "=ds=#a4#", "", "23.0%" };
    { 9, 69420, "", "=q4=Revelosh's Spaulders", "=ds=#a2#", "", "23.0%" };
    { 10, 69419, "", "=q4=Revelosh's Armguards", "=ds=#a3#", "", "21.0%" };
    { 11, 69421, "", "=q4=Revelosh's Gloves", "=ds=#a1#", "", "21.0%" };
	};

	AtlasLoot_Data["UldReveloshHEROIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Heroic Revelosh", "=q5=ALL WILL DROP"};
    { 2, 7741, "", "=q3=The Shaft of Tsol", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Heroic Revelosh", "=q5=CHANCE TO DROP"};
    { 5, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 59063, "", "=q3=Idol of Buried Stars", "", "", "10.0%" };
    { 8, 66418, "", "=q4=Revelosh's Boots", "=ds=#a4#", "", "23.0%" };
    { 9, 66420, "", "=q4=Revelosh's Spaulders", "=ds=#a2#", "", "23.0%" };
    { 10, 66419, "", "=q4=Revelosh's Armguards", "=ds=#a3#", "", "21.0%" };
    { 11, 66421, "", "=q4=Revelosh's Gloves", "=ds=#a1#", "", "21.0%" };
	};
	...
	AtlasLoot_Data["UldIronayaMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Ironaya", "=q5=ALL WILL DROP"};
    { 2, 58728, "", "=q1=Titanforged Beacon", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Mythic Ironaya", "=q5=CHANCE TO DROP"};
    { 5, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 57624, "", "=q6=Pattern: Expert Riding Crop", "=ds=#e2#", "", "10.0%" };
    { 8, 59064, "", "=q3=Libram of the Discsmith", "", "", "10.0%" };
    { 10, 0, "AO_Unknown", "=q6=Mythic Ironaya", "=q5=ONE WILL DROP"};
    { 11, 69426, "", "=q4=Stoneweaver Leggings", "=ds=#a1#", "", "40.0%" };
    { 12, 69428, "", "=q4=Ironaya's Bracers", "=ds=#a3#", "", "40.0%" };
    { 13, 69427, "", "=q4=Ironshod Bludgeon", "=ds=#w9#", "", "20.0%" };
	};

	AtlasLoot_Data["UldIronayaHEROIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Heroic Ironaya", "=q5=ALL WILL DROP"};
    { 2, 58728, "", "=q1=Titanforged Beacon", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Heroic Ironaya", "=q5=CHANCE TO DROP"};
    { 5, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 57624, "", "=q6=Pattern: Expert Riding Crop", "=ds=#e2#", "", "10.0%" };
    { 8, 59064, "", "=q3=Libram of the Discsmith", "", "", "10.0%" };
    { 10, 0, "AO_Unknown", "=q6=Heroic Ironaya", "=q5=ONE WILL DROP"};
    { 11, 66426, "", "=q4=Stoneweaver Leggings", "=ds=#a1#", "", "40.0%" };
    { 12, 66428, "", "=q4=Ironaya's Bracers", "=ds=#a3#", "", "40.0%" };
    { 13, 66427, "", "=q4=Ironshod Bludgeon", "=ds=#w9#", "", "20.0%" };
	};

	AtlasLoot_Data["UldObsidianSentinel"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Obsidian Sentinel", "=q5=ALL WILL DROP"};
    { 2, 8053, "", "=q1=Obsidian Power Source", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Obsidian Sentinel", "=q5=CHANCE TO DROP"};
    { 5, 17, "", "=q6=Martin Fury", "=ds=#a4#", "", "" };
	};

	AtlasLoot_Data["UldObsidianSentinelMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Obsidian Sentinel", "=q5=ALL WILL DROP"};
    { 2, 8053, "", "=q1=Obsidian Power Source", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Mythic Obsidian Sentinel", "=q5=CHANCE TO DROP"};
    { 5, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 8, 0, "AO_Unknown", "=q6=Mythic Obsidian Sentinel", "=q5=ONE WILL DROP"};
    { 9, 9383, "", "=q3=Obsidian Cleaver", "=ds=#w1#", "", "12.5%" };
    { 10, 9392, "", "=q3=Annealed Blade", "=ds=#w10#", "", "12.5%" };
    { 11, 9422, "", "=q3=Shadowforge Bushmaster", "=ds=#w5#", "", "12.5%" };
    { 12, 9424, "", "=q3=Ginn-su Sword", "=ds=#w10#", "", "12.5%" };
    { 13, 9425, "", "=q3=Pendulum of Doom", "=ds=#w1#", "", "12.5%" };
    { 14, 9426, "", "=q3=Monolithic Bow", "=ds=#w2#", "", "12.5%" };
    { 15, 9427, "", "=q3=Stonevault Bonebreaker", "=ds=#w6#", "", "12.5%" };
    { 16, 9432, "", "=q3=Skullplate Bracers", "=ds=#a4#", "", "12.5%" };
	};

	AtlasLoot_Data["UldObsidianSentinelHEROIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Heroic Obsidian Sentinel", "=q5=ALL WILL DROP"};
    { 2, 8053, "", "=q1=Obsidian Power Source", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Heroic Obsidian Sentinel", "=q5=CHANCE TO DROP"};
    { 5, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 8, 0, "AO_Unknown", "=q6=Heroic Obsidian Sentinel", "=q5=ONE WILL DROP"};
    { 9, 9383, "", "=q3=Obsidian Cleaver", "=ds=#w1#", "", "12.5%" };
    { 10, 9392, "", "=q3=Annealed Blade", "=ds=#w10#", "", "12.5%" };
    { 11, 9422, "", "=q3=Shadowforge Bushmaster", "=ds=#w5#", "", "12.5%" };
    { 12, 9424, "", "=q3=Ginn-su Sword", "=ds=#w10#", "", "12.5%" };
    ...
    { 1, 0, "RoM_stellar_dice", "=q6=Ancient Stone Keeper", "=q5=CHANCE TO DROP"};
    { 2, 17, "", "=q6=Martin Fury", "=ds=#a4#", "", "" };
    { 4, 0, "AO_Unknown", "=q6=Ancient Stone Keeper", "=q5=ONE WILL DROP"};
    { 5, 9410, "", "=q3=Cragfists", "=ds=#a4#", "", "50.0%" };
    { 6, 9411, "", "=q3=Rockshard Pauldrons", "=ds=#a3#", "", "50.0%" };
	};

	AtlasLoot_Data["UldAncientStoneKeeperMYTHIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Mythic Ancient Stone Keeper", "=q5=CHANCE TO DROP"};
    { 2, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 5, 0, "AO_Unknown", "=q6=Mythic Ancient Stone Keeper", "=q5=ONE WILL DROP"};
    { 6, 9383, "", "=q3=Obsidian Cleaver", "=ds=#w1#", "", "10.0%" };
    { 7, 9392, "", "=q3=Annealed Blade", "=ds=#w10#", "", "10.0%" };
    { 8, 9422, "", "=q3=Shadowforge Bushmaster", "=ds=#w5#", "", "10.0%" };
    { 9, 9424, "", "=q3=Ginn-su Sword", "=ds=#w10#", "", "10.0%" };
    { 10, 9425, "", "=q3=Pendulum of Doom", "=ds=#w1#", "", "10.0%" };
    { 11, 9426, "", "=q3=Monolithic Bow", "=ds=#w2#", "", "10.0%" };
    { 12, 9427, "", "=q3=Stonevault Bonebreaker", "=ds=#w6#", "", "10.0%" };
    { 13, 9432, "", "=q3=Skullplate Bracers", "=ds=#a4#", "", "10.0%" };
    { 14, 69429, "", "=q4=Cragfists", "=ds=#a4#", "", "10.0%" };
    { 15, 69430, "", "=q4=Rockshard Pauldrons", "=ds=#a3#", "", "10.0%" };
	};

	AtlasLoot_Data["UldAncientStoneKeeperHEROIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Heroic Ancient Stone Keeper", "=q5=CHANCE TO DROP"};
    { 2, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 5, 0, "AO_Unknown", "=q6=Heroic Ancient Stone Keeper", "=q5=ONE WILL DROP"};
    { 6, 9383, "", "=q3=Obsidian Cleaver", "=ds=#w1#", "", "10.0%" };
    { 7, 9392, "", "=q3=Annealed Blade", "=ds=#w10#", "", "10.0%" };
    { 8, 9422, "", "=q3=Shadowforge Bushmaster", "=ds=#w5#", "", "10.0%" };
    { 9, 9424, "", "=q3=Ginn-su Sword", "=ds=#w10#", "", "10.0%" };
    ...
    { 12, 9427, "", "=q3=Stonevault Bonebreaker", "=ds=#w6#", "", "10.0%" };
    { 13, 9432, "", "=q3=Skullplate Bracers", "=ds=#a4#", "", "10.0%" };
    { 14, 66429, "", "=q4=Cragfists", "=ds=#a4#", "", "10.0%" };
    { 15, 66430, "", "=q4=Rockshard Pauldrons", "=ds=#a3#", "", "10.0%" };
	};

	AtlasLoot_Data["UldGalgannFirehammer"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Galgann Firehammer", "=q5=CHANCE TO DROP"};
    { 2, 59065, "", "=q3=Totem of the Earth-Forged", "", "", "10.0%" };
    { 4, 0, "AO_Unknown", "=q6=Galgann Firehammer", "=q5=ONE WILL DROP"};
    { 5, 11311, "", "=q3=Emberscale Cape", "=ds=#a1#", "", "40.0%" };
    { 6, 9412, "", "=q3=Galgann's Fireblaster", "=ds=#w5#", "", "20.0%" };
    { 7, 9419, "", "=q3=Galgann's Firehammer", "=ds=#w6#", "", "20.0%" };
    { 8, 11310, "", "=q3=Flameseer Mantle", "=ds=#a1#", "", "20.0%" };
	};

	AtlasLoot_Data["UldGalgannFirehammerMYTHIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Mythic Galgann Firehammer", "=q5=CHANCE TO DROP"};
    { 2, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 59065, "", "=q3=Totem of the Earth-Forged", "", "", "10.0%" };
    { 6, 0, "AO_Unknown", "=q6=Mythic Galgann Firehammer", "=q5=ONE WILL DROP"};
    { 7, 69502, "", "=q4=Emberscale Cape", "=ds=#a1#", "", "40.0%" };
    { 8, 9412, "", "=q3=Galgann's Fireblaster", "=ds=#w5#", "", "20.0%" };
    { 9, 9419, "", "=q3=Galgann's Firehammer", "=ds=#w6#", "", "20.0%" };
    { 10, 69501, "", "=q4=Flameseer Mantle", "=ds=#a1#", "", "20.0%" };
	};

	AtlasLoot_Data["UldGalgannFirehammerHEROIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Heroic Galgann Firehammer", "=q5=CHANCE TO DROP"};
    { 2, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 59065, "", "=q3=Totem of the Earth-Forged", "", "", "10.0%" };
    { 6, 0, "AO_Unknown", "=q6=Heroic Galgann Firehammer", "=q5=ONE WILL DROP"};
    { 7, 66502, "", "=q4=Emberscale Cape", "=ds=#a1#", "", "40.0%" };
    { 8, 9412, "", "=q3=Galgann's Fireblaster", "=ds=#w5#", "", "20.0%" };
    { 9, 9419, "", "=q3=Galgann's Firehammer", "=ds=#w6#", "", "20.0%" };
    { 10, 66501, "", "=q4=Flameseer Mantle", "=ds=#a1#", "", "20.0%" };
	};
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6=Grimlok", "=q5=ALL WILL DROP"};
    { 2, 7670, "", "=q1=Shattered Necklace Sapphire", "=ds=#m3#", "", "100%" };
    { 4, 0, "AO_Unknown", "=q6=Grimlok", "=q5=ONE WILL DROP"};
    { 5, 9414, "", "=q3=Oilskin Leggings", "=ds=#a2#", "", "40.0%" };
    { 6, 9415, "", "=q3=Grimlok's Tribal Vestments", "=ds=#a1#", "", "40.0%" };
    { 7, 9416, "", "=q3=Grimlok's Charge", "=ds=#w7#", "", "20.0%" };
	};

	AtlasLoot_Data["UldGrimlokMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Grimlok", "=q5=ALL WILL DROP"};
    { 2, 7670, "", "=q1=Shattered Necklace Sapphire", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Mythic Grimlok", "=q5=CHANCE TO DROP"};
    { 5, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 8, 0, "AO_Unknown", "=q6=Mythic Grimlok", "=q5=ONE WILL DROP"};
    { 9, 69432, "", "=q4=Oilskin Leggings", "=ds=#a2#", "", "40.0%" };
    { 10, 69433, "", "=q4=Grimlok's Tribal Vestments", "=ds=#a1#", "", "40.0%" };
    { 11, 69434, "", "=q4=Grimlok's Charge", "=ds=#w7#", "", "20.0%" };
	};

	AtlasLoot_Data["UldGrimlokHEROIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Heroic Grimlok", "=q5=ALL WILL DROP"};
    { 2, 7670, "", "=q1=Shattered Necklace Sapphire", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Heroic Grimlok", "=q5=CHANCE TO DROP"};
    { 5, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 8, 0, "AO_Unknown", "=q6=Heroic Grimlok", "=q5=ONE WILL DROP"};
    { 9, 66432, "", "=q4=Oilskin Leggings", "=ds=#a2#", "", "40.0%" };
    { 10, 66433, "", "=q4=Grimlok's Tribal Vestments", "=ds=#a1#", "", "40.0%" };
    { 11, 66434, "", "=q4=Grimlok's Charge", "=ds=#w7#", "", "20.0%" };
	};
    ...
    { 12, 9413, "", "=q3=The Rockpounder", "=ds=#w6#", "", "20.0%" };
    { 13, 9418, "", "=q3=Stoneslayer", "=ds=#w10#", "", "20.0%" };
	};

	AtlasLoot_Data["UldArchaedasMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Archaedas", "=q5=ALL WILL DROP"};
    { 2, 7672, "", "=q1=Shattered Necklace Power Source", "=ds=#m3#", "", "100%" };
    { 3, 58711, "", "=q1=Resonating Stone of Unity", "=ds=#m3#", "", "100%" };
    { 5, 0, "RoM_stellar_dice", "=q6=Mythic Archaedas", "=q5=CHANCE TO DROP"};
    { 6, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 8, 57467, "", "=q1=Technique: Scroll of Arcane Resistance III", "=ds=#e2#", "", "15.0%" };
    { 9, 59066, "", "=q3=Idol of the Stone Ursine", "", "", "10.0%" };
    { 11, 0, "AO_Unknown", "=q6=Mythic Archaedas", "=q5=ONE WILL DROP"};
    { 12, 69500, "", "=q4=Archaedic Stone", "=ds=#s13#", "", "60.0%" };
    { 13, 9418, "", "=q3=Stoneslayer", "=ds=#w10#", "", "20.0%" };
    { 14, 69431, "", "=q4=The Rockpounder", "=ds=#w6#", "", "20.0%" };
	};
    ...
    { 2, 7672, "", "=q1=Shattered Necklace Power Source", "=ds=#m3#", "", "100%" };
    { 3, 58711, "", "=q1=Resonating Stone of Unity", "=ds=#m3#", "", "100%" };
    { 5, 0, "RoM_stellar_dice", "=q6=Heroic Archaedas", "=q5=CHANCE TO DROP"};
    { 6, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 8, 57467, "", "=q1=Technique: Scroll of Arcane Resistance III", "=ds=#e2#", "", "15.0%" };
    { 9, 59066, "", "=q3=Idol of the Stone Ursine", "", "", "10.0%" };
    { 11, 0, "AO_Unknown", "=q6=Heroic Archaedas", "=q5=ONE WILL DROP"};
    { 12, 66500, "", "=q4=Archaedic Stone", "=ds=#s13#", "", "60.0%" };
    { 13, 9418, "", "=q3=Stoneslayer", "=ds=#w10#", "", "20.0%" };
    { 14, 66431, "", "=q4=The Rockpounder", "=ds=#w6#", "", "20.0%" };
	};
    ...
    { 34, 6447, "", "=q3=Worn Turtle Shell Shield", "=ds=#w8#", "", "90.0%" };
    { 35, 13245, "", "=q3=Kresh's Back", "=ds=#w8#", "", "10.0%" };
	};
    ...
    { 29, 6630, "", "=q3=Seedcloud Buckler", "=ds=#w8#", "", "40.0%" };
    ...
    { 38, 6463, "", "=q3=Deep Fathom Ring", "=ds=#s13#", "", "33.3%" };
    ...
    { 1, 0, "RoM_stellar_dice", "=q6=Antu'sul", "=q5=CHANCE TO DROP"};
    { 2, 9523, "", "=q1=Troll Temper", "=ds=#m3#", "", "55.0%" };
    { 4, 0, "AO_Unknown", "=q6=Antu'sul", "=q5=ONE WILL DROP"};
    { 5, 9640, "", "=q3=Vice Grips", "=ds=#a4#", "", "35.0%" };
    { 6, 9641, "", "=q3=Lifeblood Amulet", "=ds=#s2#", "", "35.0%" };
    { 7, 9639, "", "=q3=The Hand of Antu'sul", "=ds=#w6#", "", "20.0%" };
    { 8, 9379, "", "=q3=Sang'thraze the Deflector", "=ds=#w10#", "", "10.0%" };
	};

	AtlasLoot_Data["ZFAntusulMYTHIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Mythic Antu'sul", "=q5=CHANCE TO DROP"};
    { 2, 9523, "", "=q1=Troll Temper", "=ds=#m3#", "", "55.0%" };
    { 3, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 5, 69416, "", "=q4=Shriveled Heart", "=ds=#s2#", "", "2.00%" };
    { 7, 0, "AO_Unknown", "=q6=Mythic Antu'sul", "=q5=ONE WILL DROP"};
    { 8, 69452, "", "=q4=Vice Grips", "=ds=#a4#", "", "35.0%" };
    { 9, 69453, "", "=q4=Lifeblood Amulet", "=ds=#s2#", "", "35.0%" };
    { 10, 9639, "", "=q3=The Hand of Antu'sul", "=ds=#w6#", "", "20.0%" };
    { 11, 69417, "", "=q4=Sang'thraze the Deflector", "=ds=#w10#", "", "10.0%" };
	};

	AtlasLoot_Data["ZFAntusulHEROIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Heroic Antu'sul", "=q5=CHANCE TO DROP"};
    { 2, 9523, "", "=q1=Troll Temper", "=ds=#m3#", "", "55.0%" };
    { 3, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 5, 66416, "", "=q4=Shriveled Heart", "=ds=#s2#", "", "2.00%" };
    { 7, 0, "AO_Unknown", "=q6=Heroic Antu'sul", "=q5=ONE WILL DROP"};
    { 8, 66452, "", "=q4=Vice Grips", "=ds=#a4#", "", "35.0%" };
    { 9, 66453, "", "=q4=Lifeblood Amulet", "=ds=#s2#", "", "35.0%" };
    { 10, 9639, "", "=q3=The Hand of Antu'sul", "=ds=#w6#", "", "20.0%" };
    { 11, 66417, "", "=q4=Sang'thraze the Deflector", "=ds=#w10#", "", "10.0%" };
	};
    ...
    { 6, 57463, "", "=q1=Technique: Scroll of Frost Resistance IV", "=ds=#e2#", "", "15.0%" };
	};

	AtlasLoot_Data["ZFThekatheMartyrMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Theka the Martyr", "=q5=ALL WILL DROP"};
    { 2, 10660, "", "=q1=First Mosh'aru Tablet", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Mythic Theka the Martyr", "=q5=CHANCE TO DROP"};
    { 5, 9523, "", "=q1=Troll Temper", "=ds=#m3#", "", "55.0%" };
    { 6, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 8, 57463, "", "=q1=Technique: Scroll of Frost Resistance IV", "=ds=#e2#", "", "15.0%" };
	};

	AtlasLoot_Data["ZFThekatheMartyrHEROIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Heroic Theka the Martyr", "=q5=ALL WILL DROP"};
    { 2, 10660, "", "=q1=First Mosh'aru Tablet", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Heroic Theka the Martyr", "=q5=CHANCE TO DROP"};
    { 5, 9523, "", "=q1=Troll Temper", "=ds=#m3#", "", "55.0%" };
    { 6, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 8, 57463, "", "=q1=Technique: Scroll of Frost Resistance IV", "=ds=#e2#", "", "15.0%" };
	...
	AtlasLoot_Data["ZFWitchDoctorZumrahMYTHIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Mythic Witch Doctor Zum'rah", "=q5=CHANCE TO DROP"};
    { 2, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 69416, "", "=q4=Shriveled Heart", "=ds=#s2#", "", "2.00%" };
    { 5, 69760, "", "=q4=Jumanza Grips", "=ds=#a1#", "", "30.0%" };
    { 6, 69759, "", "=q4=Zum'rah's Vexing Cane", "=ds=#w9#", "", "15.0%" };
	};

	AtlasLoot_Data["ZFWitchDoctorZumrahHEROIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Heroic Witch Doctor Zum'rah", "=q5=CHANCE TO DROP"};
    { 2, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 3, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 4, 66416, "", "=q4=Shriveled Heart", "=ds=#s2#", "", "2.00%" };
    { 5, 66760, "", "=q4=Jumanza Grips", "=ds=#a1#", "", "30.0%" };
    { 6, 66759, "", "=q4=Zum'rah's Vexing Cane", "=ds=#w9#", "", "15.0%" };
	};

	AtlasLoot_Data["ZFNekrumGutchewer"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Nekrum Gutchewer", "=q5=ALL WILL DROP"};
    { 2, 9471, "", "=q1=Nekrum's Medallion", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Nekrum Gutchewer", "=q5=CHANCE TO DROP"};
    { 5, 9523, "", "=q1=Troll Temper", "=ds=#m3#", "", "55.0%" };
	};

	AtlasLoot_Data["ZFNekrumGutchewerMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Nekrum Gutchewer", "=q5=ALL WILL DROP"};
    { 2, 9471, "", "=q1=Nekrum's Medallion", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Mythic Nekrum Gutchewer", "=q5=CHANCE TO DROP"};
    { 5, 9523, "", "=q1=Troll Temper", "=ds=#m3#", "", "55.0%" };
    { 6, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
	};
    ...
    { 2, 9471, "", "=q1=Nekrum's Medallion", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Heroic Nekrum Gutchewer", "=q5=CHANCE TO DROP"};
    { 5, 9523, "", "=q1=Troll Temper", "=ds=#m3#", "", "55.0%" };
    { 6, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
	};
	...
	AtlasLoot_Data["ZFSezzzizMYTHIC"] = {
    ...
    { 7, 9475, "", "=q3=Diabolic Skiver", "=ds=#w7#", "", "25.0%" };
    { 8, 69446, "", "=q4=Bad Mojo Mask", "=ds=#a1#", "", "25.0%" };
    { 9, 69447, "", "=q4=Jinxed Hoodoo Skin", "=ds=#a2#", "", "25.0%" };
    { 10, 69448, "", "=q4=Jinxed Hoodoo Kilt", "=ds=#a2#", "", "25.0%" };
	};
    ...
    { 7, 9475, "", "=q3=Diabolic Skiver", "=ds=#w7#", "", "25.0%" };
    { 8, 66446, "", "=q4=Bad Mojo Mask", "=ds=#a1#", "", "25.0%" };
    { 9, 66447, "", "=q4=Jinxed Hoodoo Skin", "=ds=#a2#", "", "25.0%" };
    { 10, 66448, "", "=q4=Jinxed Hoodoo Kilt", "=ds=#a2#", "", "25.0%" };
	};

	AtlasLoot_Data["ZFDustwraith"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Dustwraith", "=q5=CHANCE TO DROP"};
    { 2, 9523, "", "=q1=Troll Temper", "=ds=#m3#", "", "55.0%" };
    { 3, 12471, "", "=q3=Desertwalker Cane", "=ds=#s15#", "", "18.6%" };
    { 4, 17, "", "=q6=Martin Fury", "=ds=#a4#", "", "" };
	};

	AtlasLoot_Data["ZFSandfury"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Sandfury Executioner", "=q5=CHANCE TO DROP"};
    { 2, 9523, "", "=q1=Troll Temper", "=ds=#m3#", "", "55.0%" };
    { 3, 17, "", "=q6=Martin Fury", "=ds=#a4#", "", "" };
	};
    ...
    { 5, 57624, "", "=q6=Pattern: Expert Riding Crop", "=ds=#e2#", "", "10.0%" };
	};
    ...
    { 6, 57463, "", "=q1=Technique: Scroll of Frost Resistance IV", "=ds=#e2#", "", "15.0%" };
    { 7, 59067, "", "=q3=Totem of Forking Bolts", "", "", "10.0%" };
	};

	AtlasLoot_Data["ZFHydromancerVelrathaMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Hydromancer Velratha", "=q5=ALL WILL DROP"};
    { 2, 9234, "", "=q1=Tiara of the Deep", "=ds=#m3#", "", "100%" };
    { 3, 10661, "", "=q1=Second Mosh'aru Tablet", "=ds=#m3#", "", "100%" };
    { 5, 0, "RoM_stellar_dice", "=q6=Mythic Hydromancer Velratha", "=q5=CHANCE TO DROP"};
    { 6, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 8, 57463, "", "=q1=Technique: Scroll of Frost Resistance IV", "=ds=#e2#", "", "15.0%" };
    { 9, 59067, "", "=q3=Totem of Forking Bolts", "", "", "10.0%" };
	};
    ...
    { 2, 9234, "", "=q1=Tiara of the Deep", "=ds=#m3#", "", "100%" };
    { 3, 10661, "", "=q1=Second Mosh'aru Tablet", "=ds=#m3#", "", "100%" };
    { 5, 0, "RoM_stellar_dice", "=q6=Heroic Hydromancer Velratha", "=q5=CHANCE TO DROP"};
    { 6, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 8, 57463, "", "=q1=Technique: Scroll of Frost Resistance IV", "=ds=#e2#", "", "15.0%" };
    { 9, 59067, "", "=q3=Totem of Forking Bolts", "", "", "10.0%" };
	...
	AtlasLoot_Data["ZFGahzrillaMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Gahz'rilla", "=q5=ALL WILL DROP"};
    { 2, 8707, "", "=q1=Gahz'rilla's Electrified Scale", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Mythic Gahz'rilla", "=q5=CHANCE TO DROP"};
    { 5, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 8, 0, "AO_Unknown", "=q6=Mythic Gahz'rilla", "=q5=ONE WILL DROP"};
    { 9, 9467, "", "=q3=Gahz'rilla Fang", "=ds=#w4#", "", "50.0%" };
    { 10, 69445, "", "=q4=Gahz'rilla Scale Armor", "=ds=#a3#", "", "50.0%" };
	};

	AtlasLoot_Data["ZFGahzrillaHEROIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Heroic Gahz'rilla", "=q5=ALL WILL DROP"};
    { 2, 8707, "", "=q1=Gahz'rilla's Electrified Scale", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Heroic Gahz'rilla", "=q5=CHANCE TO DROP"};
    { 5, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 6, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 8, 0, "AO_Unknown", "=q6=Heroic Gahz'rilla", "=q5=ONE WILL DROP"};
    { 9, 9467, "", "=q3=Gahz'rilla Fang", "=ds=#w4#", "", "50.0%" };
    { 10, 66445, "", "=q4=Gahz'rilla Scale Armor", "=ds=#a3#", "", "50.0%" };
	};

	AtlasLoot_Data["ZFChiefUkorzSandscalp"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Chief Ukorz Sandscalp", "=q5=ALL WILL DROP"};
    { 2, 58712, "", "=q1=Sandfury War Drum", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Chief Ukorz Sandscalp", "=q5=CHANCE TO DROP"};
    { 5, 9523, "", "=q1=Troll Temper", "=ds=#m3#", "", "55.0%" };
    { 6, 59068, "", "=q3=Libram of the Trollbane", "", "", "10.0%" };
    { 8, 0, "AO_Unknown", "=q6=Chief Ukorz Sandscalp", "=q5=ONE WILL DROP"};
    { 9, 9476, "", "=q3=Big Bad Pauldrons", "=ds=#a4#", "", "30.0%" };
    { 10, 9477, "", "=q3=The Chief's Enforcer", "=ds=#w9#", "", "20.0%" };
    { 11, 9478, "", "=q3=Ripsaw", "=ds=#w1#", "", "20.0%" };
    { 12, 9479, "", "=q3=Embrace of the Lycan", "=ds=#a2#", "", "20.0%" };
    { 13, 11086, "", "=q3=Jang'thraze the Protector", "=ds=#w10#", "", "10.0%" };
	};

	AtlasLoot_Data["ZFChiefUkorzSandscalpMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Mythic Chief Ukorz Sandscalp", "=q5=ALL WILL DROP"};
    { 2, 58712, "", "=q1=Sandfury War Drum", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Mythic Chief Ukorz Sandscalp", "=q5=CHANCE TO DROP"};
    { 5, 9523, "", "=q1=Troll Temper", "=ds=#m3#", "", "55.0%" };
    { 6, 66202, "", "=q4=Azeroth Mythic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 66203, "", "=q4=Azeroth Mythic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 8, 59068, "", "=q3=Libram of the Trollbane", "", "", "10.0%" };
    { 9, 69416, "", "=q4=Shriveled Heart", "=ds=#s2#", "", "2.00%" };
    { 11, 0, "AO_Unknown", "=q6=Mythic Chief Ukorz Sandscalp", "=q5=ONE WILL DROP"};
    { 12, 69449, "", "=q4=Big Bad Pauldrons", "=ds=#a4#", "", "30.0%" };
    { 13, 9477, "", "=q3=The Chief's Enforcer", "=ds=#w9#", "", "20.0%" };
    { 14, 9478, "", "=q3=Ripsaw", "=ds=#w1#", "", "20.0%" };
    { 15, 69450, "", "=q4=Embrace of the Lycan", "=ds=#a2#", "", "20.0%" };
    { 16, 11086, "", "=q3=Jang'thraze the Protector", "=ds=#w10#", "", "10.0%" };
	};

	AtlasLoot_Data["ZFChiefUkorzSandscalpHEROIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Heroic Chief Ukorz Sandscalp", "=q5=ALL WILL DROP"};
    { 2, 58712, "", "=q1=Sandfury War Drum", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Heroic Chief Ukorz Sandscalp", "=q5=CHANCE TO DROP"};
    { 5, 9523, "", "=q1=Troll Temper", "=ds=#m3#", "", "55.0%" };
    { 6, 66200, "", "=q4=Azeroth Heroic Armor Cache", "=ds=#e10#", "", "25.0%" };
    { 7, 66201, "", "=q4=Azeroth Heroic Weapon Cache", "=ds=#e10#", "", "25.0%" };
    { 8, 59068, "", "=q3=Libram of the Trollbane", "", "", "10.0%" };
    { 9, 66416, "", "=q4=Shriveled Heart", "=ds=#s2#", "", "2.00%" };
    { 11, 0, "AO_Unknown", "=q6=Heroic Chief Ukorz Sandscalp", "=q5=ONE WILL DROP"};
    { 12, 66449, "", "=q4=Big Bad Pauldrons", "=ds=#a4#", "", "30.0%" };
    { 13, 9477, "", "=q3=The Chief's Enforcer", "=ds=#w9#", "", "20.0%" };
    { 14, 9478, "", "=q3=Ripsaw", "=ds=#w1#", "", "20.0%" };
    { 15, 66450, "", "=q4=Embrace of the Lycan", "=ds=#a2#", "", "20.0%" };
    { 16, 11086, "", "=q3=Jang'thraze the Protector", "=ds=#w10#", "", "10.0%" };
	};

	AtlasLoot_Data["ZFZerillis"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Zerillis", "=q5=CHANCE TO DROP"};
    { 2, 9523, "", "=q1=Troll Temper", "=ds=#m3#", "", "55.0%" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6=High Priestess Jeklik", "=q5=ALL WILL DROP"};
    { 2, 19881, "", "=q1=Channeler's Head", "=ds=#m3#", "", "100%" };
    { 3, 57608, "", "=q3=Pattern: Drums of the Wild", "=ds=#e2#", "", "100%" };
    { 5, 0, "AO_Unknown", "=q6=High Priestess Jeklik", "=q5=ONE WILL DROP"};
    { 6, 19915, "", "=q3=Zulian Defender", "=ds=#w8#", "", "14.3%" };
    { 7, 19918, "", "=q4=Jeklik's Crusher", "=ds=#w6#", "", "14.3%" };
    { 8, 19920, "", "=q3=Primalist's Band", "=ds=#s13#", "", "14.3%" };
    { 9, 19923, "", "=q3=Jeklik's Opaline Talisman", "=ds=#s2#", "", "14.3%" };
    { 10, 19928, "", "=q3=Animist's Spaulders", "=ds=#a2#", "", "14.3%" };
    { 11, 20262, "", "=q3=Seafury Boots", "=ds=#a3#", "", "14.3%" };
    { 12, 20265, "", "=q3=Peacekeeper Boots", "=ds=#a4#", "", "14.3%" };
    { 16, 0, "AO_Unknown", "=q6=High Priestess Jeklik", "=q5=ONE WILL DROP"};
    ...
    { 25, 22721, "", "=q4=Band of Servitude", "=ds=#s13#", "", "10.0%" };
    { 26, 22722, "", "=q4=Seal of the Gurubashi Berserker", "=ds=#s13#", "", "10.0%" };
	};

	AtlasLoot_Data["ZGVenoxis"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=High Priest Venoxis", "=q5=ALL WILL DROP"};
    { 2, 19881, "", "=q1=Channeler's Head", "=ds=#m3#", "", "100%" };
    { 3, 22216, "", "=q1=Venoxis's Venom Sac", "=ds=#m3#", "", "100%" };
    { 5, 0, "AO_Unknown", "=q6=High Priest Venoxis", "=q5=ONE WILL DROP"};
    { 6, 19900, "", "=q3=Zulian Stone Axe", "=ds=#w1#", "", "16.7%" };
    { 7, 19903, "", "=q4=Fang of Venoxis", "=ds=#w4#", "", "16.7%" };
    { 8, 19904, "", "=q4=Runed Bloodstained Hauberk", "=ds=#a3#", "", "16.7%" };
    { 9, 19905, "", "=q3=Zanzil's Band", "=ds=#s13#", "", "16.7%" };
    { 10, 19906, "", "=q3=Blooddrenched Footpads", "=ds=#a2#", "", "16.7%" };
    { 11, 19907, "", "=q3=Zulian Tigerhide Cloak", "=ds=#a1#", "", "16.7%" };
    { 16, 0, "AO_Unknown", "=q6=High Priest Venoxis", "=q5=ONE WILL DROP"};
    { 17, 22711, "", "=q3=Cloak of the Hakkari Worshippers", "=ds=#a1#", "", "10.0%" };
    { 18, 22712, "", "=q3=Might of the Tribe", "=ds=#a1#", "", "10.0%" };
    { 19, 22713, "", "=q3=Zulian Scepter of Rites", "=ds=#w6#", "", "10.0%" };
    { 20, 22714, "", "=q3=Sacrificial Gauntlets", "=ds=#a4#", "", "10.0%" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6=High Priestess Mar'li", "=q5=ALL WILL DROP"};
    { 2, 19881, "", "=q1=Channeler's Head", "=ds=#m3#", "", "100%" };
    { 4, 0, "AO_Unknown", "=q6=High Priestess Mar'li", "=q5=ONE WILL DROP"};
    { 5, 19871, "", "=q3=Talisman of Protection", "=ds=#s2#", "", "16.7%" };
    { 6, 19919, "", "=q3=Bloodstained Greaves", "=ds=#a3#", "", "16.7%" };
    { 7, 19925, "", "=q3=Band of Jin", "=ds=#s13#", "", "16.7%" };
    { 8, 19927, "", "=q4=Mar'li's Touch", "=ds=#w12#", "", "16.7%" };
    { 9, 19930, "", "=q3=Mar'li's Eye", "=ds=#s14#", "", "16.7%" };
    { 10, 20032, "", "=q4=Flowing Ritual Robes", "=ds=#a1#", "", "16.7%" };
    { 16, 0, "AO_Unknown", "=q6=High Priestess Mar'li", "=q5=ONE WILL DROP"};
    { 17, 22711, "", "=q3=Cloak of the Hakkari Worshippers", "=ds=#a1#", "", "10.0%" };
    { 18, 22712, "", "=q3=Might of the Tribe", "=ds=#a1#", "", "10.0%" };
    { 19, 22713, "", "=q3=Zulian Scepter of Rites", "=ds=#w6#", "", "10.0%" };
    { 20, 22714, "", "=q3=Sacrificial Gauntlets", "=ds=#a4#", "", "10.0%" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6=Bloodlord Mandokir", "=q5=ALL WILL DROP"};
    { 2, 22637, "", "=q3=Primal Hakkari Idol", "=ds=#e10#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Bloodlord Mandokir", "=q5=CHANCE TO DROP"};
    { 5, 19872, "", "=q4=Swift Razzashi Raptor", "=ds=#e10#", "", "2.00%" };
    { 16, 0, "AO_Unknown", "=q6=Bloodlord Mandokir", "=q5=ONE WILL DROP"};
    { 17, 19863, "", "=q3=Primalist's Seal", "=ds=#s13#", "", "8.33%" };
    ...
    { 22, 19873, "", "=q3=Overlord's Crimson Band", "=ds=#s13#", "", "8.33%" };
    ...
    { 26, 19893, "", "=q3=Zanzil's Seal", "=ds=#s13#", "", "8.33%" };
    ...
    { 1, 0, "RoM_stellar_dice", "=q6=Gahz'ranka", "=q5=CHANCE TO DROP"};
    { 2, 22739, "", "=q3=Tome of Polymorph: Turtle", "=ds=#e2#", "", "15.0%" };
    { 4, 0, "AO_Unknown", "=q6=Gahz'ranka", "=q5=ONE WILL DROP"};
    { 5, 19946, "", "=q3=Tigule's Harpoon", "=ds=#w7#", "", "40.0%" };
    { 6, 19947, "", "=q3=Nat Pagle's Broken Reel", "=ds=#s14#", "", "40.0%" };
    { 7, 19944, "", "=q4=Nat Pagle's Fish Terminator", "=ds=#w9#", "", "10.0%" };
    { 8, 19945, "", "=q4=Foror's Eyepatch", "=ds=#a2#", "", "10.0%" };
	};

	AtlasLoot_Data["ZGThekal"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=High Priest Thekal", "=q5=ALL WILL DROP"};
    { 2, 19881, "", "=q1=Channeler's Head", "=ds=#m3#", "", "100%" };
    { 3, 57602, "", "=q3=Pattern: Drums of Fortitude", "=ds=#e2#", "", "100%" };
    { 5, 0, "RoM_stellar_dice", "=q6=High Priest Thekal", "=q5=CHANCE TO DROP"};
    { 6, 19902, "", "=q4=Swift Zulian Tiger", "=ds=#e10#", "", "2.00%" };
    { 8, 0, "AO_Unknown", "=q6=High Priest Thekal", "=q5=ONE WILL DROP"};
    { 9, 19896, "", "=q4=Thekal's Grasp", "=ds=#w13#", "", "14.3%" };
    { 10, 19897, "", "=q4=Betrayer's Boots", "=ds=#a1#", "", "14.3%" };
    { 11, 19898, "", "=q3=Seal of Jin", "=ds=#s13#", "", "14.3%" };
    { 12, 19899, "", "=q3=Ritualistic Legguards", "=ds=#a1#", "", "14.3%" };
    { 13, 19901, "", "=q3=Zulian Slicer", "=ds=#w10#", "", "14.3%" };
    { 14, 20260, "", "=q3=Seafury Leggings", "=ds=#a3#", "", "14.3%" };
    { 15, 20266, "", "=q3=Peacekeeper Leggings", "=ds=#a4#", "", "14.3%" };
    { 16, 0, "AO_Unknown", "=q6=High Priest Thekal", "=q5=ONE WILL DROP"};
    { 17, 22711, "", "=q3=Cloak of the Hakkari Worshippers", "=ds=#a1#", "", "10.0%" };
    { 18, 22712, "", "=q3=Might of the Tribe", "=ds=#a1#", "", "10.0%" };
    { 19, 22713, "", "=q3=Zulian Scepter of Rites", "=ds=#w6#", "", "10.0%" };
    { 20, 22714, "", "=q3=Sacrificial Gauntlets", "=ds=#a4#", "", "10.0%" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6=High Priestess Arlokk", "=q5=ALL WILL DROP"};
    { 2, 19881, "", "=q1=Channeler's Head", "=ds=#m3#", "", "100%" };
    { 4, 0, "AO_Unknown", "=q6=High Priestess Arlokk", "=q5=ONE WILL DROP"};
    { 5, 19909, "", "=q4=Will of Arlokk", "=ds=#w9#", "", "16.7%" };
    { 6, 19910, "", "=q4=Arlokk's Grasp", "=ds=#w13#", "", "16.7%" };
    { 7, 19912, "", "=q3=Overlord's Onyx Band", "=ds=#s13#", "", "16.7%" };
    { 8, 19913, "", "=q3=Bloodsoaked Greaves", "=ds=#a4#", "", "16.7%" };
    { 9, 19914, "", "=q3=Panther Hide Sack", "=ds=#e1#", "", "16.7%" };
    { 10, 19922, "", "=q3=Arlokk's Hoodoo Stick", "=ds=#s15#", "", "16.7%" };
    { 16, 0, "AO_Unknown", "=q6=High Priestess Arlokk", "=q5=ONE WILL DROP"};
    { 17, 22711, "", "=q3=Cloak of the Hakkari Worshippers", "=ds=#a1#", "", "10.0%" };
    { 18, 22712, "", "=q3=Might of the Tribe", "=ds=#a1#", "", "10.0%" };
    { 19, 22713, "", "=q3=Zulian Scepter of Rites", "=ds=#w6#", "", "10.0%" };
    { 20, 22714, "", "=q3=Sacrificial Gauntlets", "=ds=#a4#", "", "10.0%" };
    ...
    { 1, 0, "AO_ChestWithTreasures", "=q6=Jin'do the Hexxer", "=q5=ALL WILL DROP"};
    { 2, 22637, "", "=q3=Primal Hakkari Idol", "=ds=#e10#", "", "100%" };
    { 4, 0, "AO_Unknown", "=q6=Jin'do the Hexxer", "=q5=ONE WILL DROP"};
    { 5, 19875, "", "=q3=Bloodstained Coif", "=ds=#a3#", "", "8.33%" };
    { 6, 19884, "", "=q4=Jin'do's Judgement", "=ds=#w9#", "", "8.33%" };
    { 7, 19885, "", "=q4=Jin'do's Evil Eye", "=ds=#s2#", "", "8.33%" };
    { 8, 19886, "", "=q3=The Hexxer's Cover", "=ds=#a1#", "", "8.33%" };
    { 9, 19887, "", "=q3=Bloodstained Legplates", "=ds=#a3#", "", "8.33%" };
    { 10, 19888, "", "=q3=Overlord's Embrace", "=ds=#a1#", "", "8.33%" };
    { 11, 19889, "", "=q3=Blooddrenched Leggings", "=ds=#a2#", "", "8.33%" };
    { 12, 19890, "", "=q4=Jin'do's Hexxer", "=ds=#w6#", "", "8.33%" };
    { 13, 19891, "", "=q4=Jin'do's Bag of Whammies", "=ds=#s15#", "", "8.33%" };
    { 14, 19892, "", "=q3=Animist's Boots", "=ds=#a2#", "", "8.33%" };
    { 15, 19894, "", "=q3=Bloodsoaked Gauntlets", "=ds=#a4#", "", "8.33%" };
    { 16, 19929, "", "=q3=Bloodtinged Gloves", "=ds=#a1#", "", "8.33%" };
	};

	AtlasLoot_Data["ZGHakkar"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Hakkar", "=q5=ALL WILL DROP"};
    { 2, 19802, "", "=q4=Heart of Hakkar", "=ds=#m3#", "", "100%" };
    { 4, 0, "AO_Unknown", "=q6=Hakkar", "=q5=ONE WILL DROP"};
    { 5, 19852, "", "=q4=Ancient Hakkari Manslayer", "=ds=#w1#", "", "14.3%" };
    { 6, 19853, "", "=q4=Gurubashi Dwarf Destroyer", "=ds=#w5#", "", "14.3%" };
    { 7, 19856, "", "=q4=The Eye of Hakkar", "=ds=#s2#", "", "14.3%" };
    ...
    { 16, 0, "AO_Unknown", "=q6=Hakkar", "=q5=ONE WILL DROP"};
    ...
    { 21, 19862, "", "=q4=Aegis of the Blood God", "=ds=#w8#", "", "14.3%" };
    { 22, 19865, "", "=q4=Warblade of the Hakkari", "=ds=#w10#", "", "14.3%" };
    { 23, 19876, "", "=q4=Soul Corrupter's Necklace", "=ds=#s2#", "", "14.3%" };
	};
	...
	AtlasLoot_Data["MiscFactions"] = {
		{ 1, 0, "INV_Jewelry_Amulet_07", "=q6=#b5#", "=q5=#r5#, =q1="..BabbleFaction["Alliance"]};
		{ 2, 20132, "", "=q1=Arathor Battle Tabard", "=q1=#m4#: =ds=#s7#"};
		{ 4, 0, "Ability_Mount_PinkTiger", "=q6="..BabbleFaction["Wintersaber Trainers"], "=q5=#r5#"};
		{ 5, 13086, "", "=q4=Reins of the Winterspring Frostsaber", "=ds=#e12#"};
		{ 16, 0, "INV_Jewelry_Amulet_07", "=q6=#b6#", "=q5=#r5#, =q1="..BabbleFaction["Horde"]};
		{ 17, 20131, "", "=q1=Battle Tabard of the Defilers", "=q1=#m4#: =ds=#s7#"};
	...
	AtlasLoot_Data["MagramCentaur"] = {
		{ 1, 0, "INV_Misc_Head_Centaur_01", "=q6=#r2#", ""};
		{ 2, 6789, "", "=q2=Ceremonial Centaur Blanket", "=q1=#m4#: =ds=#s4#"};
		{ 3, 6788, "", "=q2=Magram Hunter's Belt", "=q1=#m4#: =ds=#s10#, #a2#"};
		{ 4, 200306, "", "=q2=Centaur Longbow", "=ds=#w2#"};
		{ 6, 0, "INV_Misc_Head_Centaur_01", "=q6=#r3#", ""};
		{ 7, 200307, "", "=q2=Centaur Stompers", "=ds=#s12#, #a2#"};
		{ 8, 200308, "", "=q2=Packrunner Harness", "=ds=#s5#, #a3#"};
		{ 9, 200309, "", "=q2=Windwatcher Sash", "=ds=#s10#, #a1#"};
		{ 16, 0, "INV_Misc_Head_Centaur_01", "=q6=#r4#", ""};
		{ 17, 200301, "", "=q3=Ceremonial Magram Dagger", "=ds=#h1#, #w4#"};
		{ 18, 200302, "", "=q3=Gauntlets of the Khan", "=ds=#s9#, #a4#"};
		{ 19, 200303, "", "=q3=Magram Windstriker", "=ds=#w2#"};
		{ 21, 0, "INV_Misc_Head_Centaur_01", "=q6=#r5#", ""};
		{ 22, 200300, "", "=q4=Dar''kar of the Third Khan", "=ds=#h2#, #w1#"};
		{ 23, 200304, "", "=q3=Centaur Battle Harness", "=ds=#s5#, #a2#"};
		{ 24, 200305, "", "=q3=Dustguider Sash", "=ds=#s10#, #a1#"};
		Back = "REPMENU_ORIGINALWOW";
	};
	...
	AtlasLoot_Data["GelkisCentaur"] = {
		{ 1, 0, "INV_Misc_Head_Centaur_01", "=q6=#r2#", ""};
		{ 2, 6773, "", "=q2=Gelkis Marauder Chain", "=q1=#m4#: =ds=#s5#, #a3#"};
		{ 3, 6774, "", "=q2=Uthek's Finger", "=q1=#m4#: =ds=#s15#"};
		{ 5, 0, "INV_Misc_Head_Centaur_01", "=q6=#r3#", ""};
		{ 6, 200316, "", "=q2=Centaur Skullcap", "=ds=#s1#, #a2#"};
		{ 7, 200317, "", "=q2=Grips of the Unified Storm", "=ds=#s9#, #a1#"};
		{ 8, 200318, "", "=q2=Warleader Sash", "=ds=#s10#, #a2#"};
		{ 16, 0, "INV_Misc_Head_Centaur_01", "=q6=#r4#", ""};
		{ 17, 200311, "", "=q3=Ceremonial Centaur Ring", "=ds=#s13#"};
		{ 18, 200312, "", "=q3=Gelkis Earthbinder", "=ds=#h3#, #w6#"};
		{ 19, 200313, "", "=q3=Maraudine Oath Pauldrons", "=ds=#s3#, #a4#"};
		{ 21, 0, "INV_Misc_Head_Centaur_01", "=q6=#r5#", ""};
		{ 22, 200310, "", "=q4=Batu''kar of the Second Khan", "=ds=#h2#, #w9#"};
		{ 23, 200314, "", "=q3=Windbinder Gloves", "=ds=#s9#, #a1#"};
		{ 24, 200315, "", "=q3=Mantle of Centaur Authority", "=ds=#s3#, #a3#"};
		Back = "REPMENU_ORIGINALWOW";
	};
