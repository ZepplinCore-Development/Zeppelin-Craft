...
--- World Bosses
	...
	AtlasLoot_Data["AuchManaTavarokMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Tavarok", "=q5=ALL WILL DROP"};
    { 2, 28558, "", "=q1=Spirit Shard", "=ds=#m3#", "", "100%" };
    { 4, 0, "AO_Unknown", "=q6=Tavarok", "=q5=ONE WILL DROP"};
    { 5, 25944, "", "=q3=Shaarde the Greater", "=ds=#w10#", "", "16.7%" };
	...
	AtlasLoot_Data["AuchManaPandemoniusMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Pandemonius", "=q5=ALL WILL DROP"};
    { 2, 28558, "", "=q1=Spirit Shard", "=ds=#m3#", "", "100%" };
    { 4, 0, "AO_Unknown", "=q6=Pandemonius", "=q5=ONE WILL DROP"};
    { 5, 25939, "", "=q3=Voidfire Wand", "=ds=#w12#", "", "16.7%" };
	...
	AtlasLoot_Data["AuchSethekkDarkweaverMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Darkweaver Syth", "=q5=ALL WILL DROP"};
    { 2, 27633, "", "=q1=Terokk's Mask", "=ds=#m3#", "", "100%" };
    { 3, 28558, "", "=q1=Spirit Shard", "=ds=#m3#", "", "100%" };
    { 5, 0, "RoM_stellar_dice", "=q6=Darkweaver Syth", "=q5=CHANCE TO DROP"};
	...
	AtlasLoot_Data["AuchSethekkTalonKingMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Talon King Ikiss", "=q5=ALL WILL DROP"};
    { 2, 27632, "", "=q1=Terokk's Quill", "=ds=#m3#", "", "100%" };
    { 3, 28558, "", "=q1=Spirit Shard", "=ds=#m3#", "", "100%" };
    { 4, 58737, "", "=q1=Arakkoa Crown", "=ds=#m3#", "", "100%" };
	...
	AtlasLoot_Data["CoTHillsbradDrakeMYTHIC"] = {
    { 1, 0, "AO_Unknown", "=q6=Lieutenant Drake", "=q5=ONE WILL DROP"};
    { 2, 27417, "", "=q3=Ravenwing Pauldrons", "=ds=#a2#", "", "20.0%" };
    { 3, 27418, "", "=q3=Stormreaver Shadow-Kilt", "=ds=#a1#", "", "20.0%" };
    { 4, 27420, "", "=q3=Uther's Ceremonial Warboots", "=ds=#a4#", "", "20.0%" };
	...
	AtlasLoot_Data["CoTHillsbradHunterMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Epoch Hunter", "=q5=ALL WILL DROP"};
    { 2, 58736, "", "=q1=Infinite Drake Head", "=ds=#m3#", "", "100%" };
    { 4, 0, "AO_Unknown", "=q6=Epoch Hunter", "=q5=ONE WILL DROP"};
    { 5, 27431, "", "=q3=Time-Shifted Dagger", "=ds=#w4#", "", "20.0%" };
	...
	AtlasLoot_Data["CoTMorassAeonusMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Aeonus", "=q5=ALL WILL DROP"};
    { 2, 58741, "", "=q1=Infinite Membrane", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Aeonus", "=q5=CHANCE TO DROP"};
    { 5, 23572, "", "=q3=Primal Nether", "=ds=#e7#", "", "5.00%" };
	...
	AtlasLoot_Data["CoTMorassDejaMYTHIC"] = {
    { 1, 0, "AO_Unknown", "=q6=Chrono Lord Deja", "=q5=ONE WILL DROP"};
    { 2, 27987, "", "=q3=Melmorta's Twilight Longbow", "=ds=#w2#", "", "16.7%" };
    { 3, 27988, "", "=q3=Burnoose of Shifting Ages", "=ds=#a1#", "", "16.7%" };
    { 4, 27993, "", "=q3=Mask of Inner Fire", "=ds=#a3#", "", "16.7%" };
	...
	AtlasLoot_Data["CoTMorassTemporusMYTHIC"] = {
    { 1, 0, "AO_Unknown", "=q6=Temporus", "=q5=ONE WILL DROP"};
    { 2, 28033, "", "=q3=Epoch-Mender", "=ds=#w9#", "", "16.7%" };
    { 3, 28034, "", "=q3=Hourglass of the Unraveller", "=ds=#s14#", "", "16.7%" };
    { 4, 28184, "", "=q3=Millennium Blade", "=ds=#w10#", "", "16.7%" };
	...
	AtlasLoot_Data["CFRSlaveRokmarMYTHIC"] = {
    { 1, 0, "AO_Unknown", "=q6=Rokmar the Crackler", "=q5=ONE WILL DROP"};
    { 2, 24376, "", "=q3=Runed Fungalcap", "=ds=#s14#", "", "20.0%" };
    { 3, 24378, "", "=q3=Coilfang Hammer of Renewal", "=ds=#w6#", "", "20.0%" };
    { 4, 24379, "", "=q3=Bogstrok Scale Cloak", "=ds=#a1#", "", "20.0%" };
    ...
    { 8, 24359, "", "=q3=Princely Reign Leggings", "=ds=#a1#", "", "20.0%" };
    { 9, 24360, "", "=q3=Tracker's Belt", "=ds=#a3#", "", "20.0%" };
    { 10, 24361, "", "=q3=Spellfire Longsword", "=ds=#w10#", "", "20.0%" };
	};
	...
	AtlasLoot_Data["CFRSlaveQuagmirranMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Quagmirran", "=q5=ALL WILL DROP"};
    { 2, 58732, "", "=q1=Ancient Fungus", "=ds=#m3#", "", "100%" };
    { 4, 0, "AO_Unknown", "=q6=Quagmirran", "=q5=ONE WILL DROP"};
    { 5, 24362, "", "=q3=Spore-Soaked Vaneer", "=ds=#a1#", "", "20.0%" };
	...
	AtlasLoot_Data["CFRSteamWarlordMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Warlord Kalithresh", "=q5=ALL WILL DROP"};
    { 2, 58738, "", "=q1=Opressor Trident", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Warlord Kalithresh", "=q5=CHANCE TO DROP"};
    { 5, 24313, "", "=q4=Pattern: Battlecast Hood", "=ds=#e2#", "", "10.0%" };
	...
	AtlasLoot_Data["CFRSteamThespiaMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Hydromancer Thespia", "=q5=ALL WILL DROP"};
    { 2, 30828, "", "=q1=Vial of Underworld Loam", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Hydromancer Thespia", "=q5=CHANCE TO DROP"};
    { 5, 29673, "", "=q2=Pattern: Frost Armor Kit", "=ds=#e2#", "", "10.0%" };
	...
	AtlasLoot_Data["CFRSteamSteamriggerMYTHIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Mekgineer Steamrigger", "=q5=CHANCE TO DROP"};
    { 2, 23887, "", "=q3=Schematic: Rocket Boots Xtreme", "=ds=#e2#", "", "8.00%" };
    { 4, 0, "AO_Unknown", "=q6=Mekgineer Steamrigger", "=q5=ONE WILL DROP"};
    { 5, 27790, "", "=q3=Mask of Penance", "=ds=#a4#", "", "20.0%" };
	...
	AtlasLoot_Data["CFRUnderGhazanMYTHIC"] = {
    { 1, 0, "AO_Unknown", "=q6=Ghaz'an", "=q5=ONE WILL DROP"};
    { 2, 24458, "", "=q3=Studded Girdle of Virtue", "=ds=#a4#", "", "20.0%" };
    { 3, 24459, "", "=q3=Cloak of Healing Rays", "=ds=#a1#", "", "20.0%" };
    { 4, 24460, "", "=q3=Talisman of Tenacity", "=ds=#s2#", "", "20.0%" };
	...
	AtlasLoot_Data["CFRUnderStalkerMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=The Black Stalker", "=q5=ALL WILL DROP"};
    { 2, 24248, "", "=q1=Brain of the Black Stalker", "=ds=#m3#", "", "100%" };
    { 3, 58734, "", "=q1=Stalker Tendril", "=ds=#m3#", "", "100%" };
    { 5, 0, "AO_Unknown", "=q6=The Black Stalker", "=q5=ONE WILL DROP"};
	...
	AtlasLoot_Data["HCFurnaceBroggokMYTHIC"] = {
    { 1, 0, "AO_Unknown", "=q6=Broggok", "=q5=ONE WILL DROP"};
    { 2, 24389, "", "=q3=Legion Blunderbuss", "=ds=#w5#", "", "20.0%" };
    { 3, 24390, "", "=q3=Auslese's Light Channeler", "=ds=#s14#", "", "20.0%" };
    { 4, 24391, "", "=q3=Kilt of the Night Strider", "=ds=#a2#", "", "20.0%" };
	...
	AtlasLoot_Data["HCFurnaceMakerMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=The Maker", "=q5=ALL WILL DROP"};
    { 2, 23894, "", "=q1=Fel Orc Blood Vial", "=ds=#m3#", "", "100%" };
    { 4, 0, "AO_Unknown", "=q6=The Maker", "=q5=ONE WILL DROP"};
    { 5, 24384, "", "=q3=Diamond-Core Sledgemace", "=ds=#w6#", "", "20.0%" };
	...
	AtlasLoot_Data["HCFurnaceBreakerMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Keli'dan the Breaker", "=q5=ALL WILL DROP"};
    { 2, 23894, "", "=q1=Fel Orc Blood Vial", "=ds=#m3#", "", "100%" };
    { 3, 58731, "", "=q1=Blood Crucible", "=ds=#m3#", "", "100%" };
    { 5, 0, "AO_Unknown", "=q6=Keli'dan the Breaker", "=q5=ONE WILL DROP"};
	...
	AtlasLoot_Data["SMTFireheartMYTHIC"] = {
    { 1, 0, "AO_Unknown", "=q6=Selin Fireheart", "=q5=ONE WILL DROP"};
    { 2, 34697, "", "=q3=Bindings of Raging Fire", "=ds=#a1#", "", "16.7%" };
    { 3, 34698, "", "=q3=Bracers of the Forest Stalker", "=ds=#a3#", "", "16.7%" };
    { 4, 34699, "", "=q3=Sun-forged Cleaver", "=ds=#w1#", "", "16.7%" };
	...
	AtlasLoot_Data["SMTDelrissaMYTHIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Priestess Delrissa", "=q5=CHANCE TO DROP"};
    { 2, 35756, "", "=q3=Formula: Enchant Cloak - Steelweave", "=ds=#e2#", "", "20.0%" };
    { 4, 0, "AO_Unknown", "=q6=Priestess Delrissa", "=q5=ONE WILL DROP"};
    { 5, 34783, "", "=q3=Nightstrike", "=ds=#w11#", "", "16.7%" };
	...
	AtlasLoot_Data["TKArcUnboundMYTHIC"] = {
    { 1, 0, "AO_Unknown", "=q6=Zereketh the Unbound", "=q5=ONE WILL DROP"};
    { 2, 28372, "", "=q3=Idol of Feral Shadows", "", "", "20.0%" };
    { 3, 28373, "", "=q3=Cloak of Scintillating Auras", "=ds=#a1#", "", "20.0%" };
    { 4, 28374, "", "=q3=Mana-Sphere Shoulderguards", "=ds=#a1#", "", "20.0%" };
	...
	AtlasLoot_Data["TKBotSarannisMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Commander Sarannis", "=q5=ALL WILL DROP"};
    { 2, 28769, "", "=q1=The Keystone", "=ds=#m3#", "", "100%" };
    { 4, 0, "AO_Unknown", "=q6=Commander Sarannis", "=q5=ONE WILL DROP"};
    { 5, 28296, "", "=q3=Libram of the Lightbringer", "", "", "20.0%" };
	...
	AtlasLoot_Data["TKBotThorngrinMYTHIC"] = {
    { 1, 0, "RoM_stellar_dice", "=q6=Thorngrin the Tender", "=q5=CHANCE TO DROP"};
    { 2, 24310, "", "=q4=Pattern: Battlecast Pants", "=ds=#e2#", "", "10.0%" };
    { 4, 0, "AO_Unknown", "=q6=Thorngrin the Tender", "=q5=ONE WILL DROP"};
    { 5, 28322, "", "=q3=Runed Dagger of Solace", "=ds=#w4#", "", "20.0%" };
	...
	AtlasLoot_Data["HCRampOmorMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Omor the Unscarred", "=q5=ALL WILL DROP"};
    { 2, 23886, "", "=q1=Omor's Hoof", "=ds=#m3#", "", "100%" };
    { 4, 0, "AO_Unknown", "=q6=Omor the Unscarred", "=q5=ONE WILL DROP"};
    { 5, 24069, "", "=q3=Crystalfire Staff", "=ds=#w9#", "", "16.7%" };
	...
	AtlasLoot_Data["HCHallsNethekurseMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Grand Warlock Nethekurse", "=q5=ALL WILL DROP"};
    { 2, 23735, "", "=q1=Grand Warlock's Amulet", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Grand Warlock Nethekurse", "=q5=CHANCE TO DROP"};
    { 5, 24312, "", "=q4=Pattern: Spellstrike Hood", "=ds=#e2#", "", "10.0%" };
	...
	AtlasLoot_Data["HCHallsOmroggMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Warbringer O'mrogg", "=q5=ALL WILL DROP"};
    { 2, 30829, "", "=q1=Tear of the Earthmother", "=ds=#m3#", "", "100%" };
    { 4, 0, "AO_Unknown", "=q6=Warbringer O'mrogg", "=q5=ONE WILL DROP"};
    { 5, 27524, "", "=q3=Firemaul of Destruction", "=ds=#w6#", "", "20.0%" };
	...
	AtlasLoot_Data["HCHallsKargathMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Warchief Kargath Bladefist", "=q5=ALL WILL DROP"};
    { 2, 23723, "", "=q1=Warchief Kargath's Fist", "=ds=#m3#", "", "100%" };
    { 3, 58740, "", "=q1=Warchief Insignia", "=ds=#m3#", "", "100%" };
    { 5, 0, "RoM_stellar_dice", "=q6=Warchief Kargath Bladefist", "=q5=CHANCE TO DROP"};
	...
	AtlasLoot_Data["AuchShadowHellmawMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Ambassador Hellmaw", "=q5=ALL WILL DROP"};
    { 2, 28558, "", "=q1=Spirit Shard", "=ds=#m3#", "", "100%" };
    { 4, 0, "AO_Unknown", "=q6=Ambassador Hellmaw", "=q5=ONE WILL DROP"};
    { 5, 27884, "", "=q3=Ornate Boots of the Sanctified", "=ds=#a4#", "", "16.7%" };
	...
	AtlasLoot_Data["AuchShadowBlackheartMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Blackheart the Inciter", "=q5=ALL WILL DROP"};
    { 2, 28558, "", "=q1=Spirit Shard", "=ds=#m3#", "", "100%" };
    { 3, 30808, "", "=q1=Book of Fel Names", "=ds=#m3#", "", "100%" };
    { 5, 0, "RoM_stellar_dice", "=q6=Blackheart the Inciter", "=q5=CHANCE TO DROP"};
	...
	AtlasLoot_Data["AuchShadowMurmurMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Murmur", "=q5=ALL WILL DROP"};
    { 2, 28558, "", "=q1=Spirit Shard", "=ds=#m3#", "", "100%" };
    { 3, 58739, "", "=q1=Primordial Essence", "=ds=#m3#", "", "100%" };
    { 5, 0, "RoM_stellar_dice", "=q6=Murmur", "=q5=CHANCE TO DROP"};
	...
	AtlasLoot_Data["SMTVexallusMYTHIC"] = {
    { 1, 0, "AO_Unknown", "=q6=Vexallus", "=q5=ONE WILL DROP"};
    { 2, 34703, "", "=q3=Latro's Dancing Blade", "=ds=#w10#", "", "16.7%" };
    { 3, 34704, "", "=q3=Band of Arcane Alacrity", "=ds=#s13#", "", "16.7%" };
    { 4, 34705, "", "=q3=Bracers of Divine Infusion", "=ds=#a1#", "", "16.7%" };
    ...
    { 3, 57207, "", "=q2=Schematic: Fel Iron Arrows", "=ds=#e2#", "", "100%" };
	...
	AtlasLoot_Data["HCRampWatchkeeperMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Watchkeeper Gargolmar", "=q5=ALL WILL DROP"};
    { 2, 23881, "", "=q1=Gargolmar's Hand", "=ds=#m3#", "", "100%" };
    { 3, 57207, "", "=q2=Schematic: Fel Iron Arrows", "=ds=#e2#", "", "100%" };
    { 5, 0, "AO_Unknown", "=q6=Watchkeeper Gargolmar", "=q5=ONE WILL DROP"};
	...
	AtlasLoot_Data["HCRampVazrudenMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Vazruden", "=q5=ALL WILL DROP"};
	...
	AtlasLoot_Data["TKArcScryerMYTHIC"] = {
    { 1, 0, "AO_Unknown", "=q6=Wrath-Scryer Soccothrates", "=q5=ONE WILL DROP"};
    { 2, 28393, "", "=q3=Warmaul of Infused Light", "=ds=#w6#", "", "20.0%" };
    { 3, 28394, "", "=q3=Ryngo's Band of Ingenuity", "=ds=#s13#", "", "20.0%" };
    { 4, 28396, "", "=q3=Gloves of the Unbound", "=ds=#a2#", "", "20.0%" };
	...
	AtlasLoot_Data["TKArcHarbingerMYTHIC"] = {
    { 1, 0, "AO_ChestWithTreasures", "=q6=Harbinger Skyriss", "=q5=ALL WILL DROP"};
    { 2, 58744, "", "=q1=Qiraji Hive Mind", "=ds=#m3#", "", "100%" };
    { 4, 0, "RoM_stellar_dice", "=q6=Harbinger Skyriss", "=q5=CHANCE TO DROP"};
    { 5, 23572, "", "=q3=Primal Nether", "=ds=#e7#", "", "5.00%" };
    ...
    { 2, 25738, "", "=q3=Pattern: Felstalker Belt", "=ds=#p7#"};
    { 3, 31359, "", "=q2=Design: Enduring Deep Peridot", "=ds=#p12#"};
    { 4, 24000, "", "=q1=Formula: Enchant Bracer - Superior Healing", "=ds=#p4#"};
    { 6, 0, "INV_BannerPVP_01", "=q6=#r3#", ""};
    { 7, 35406, "", "=q3=Crusader's Ornamented Spaulders", "=ds=#s3#, #a4#"};
    { 8, 35413, "", "=q3=Crusader's Scaled Gauntlets", "=ds=#s9#, #a4#"};
    { 9, 35360, "", "=q3=Dragonhide Robe", "=ds=#s5#, #a2#"};
    { 10, 35332, "", "=q3=Dreadweave Robe", "=ds=#s5#, #a1#"};
    { 11, 35343, "", "=q3=Evoker's Silk Amice", "=ds=#s3#, #a1#"};
    { 12, 25824, "", "=q3=Farseer's Band", "=ds=#s13#"};
    { 13, 25823, "", "=q3=Grunt's Waraxe", "=ds=#h1#, #w1#"};
    { 14, 35364, "", "=q3=Kodohide Spaulders", "=ds=#s3#, #a2#"};
    { 15, 35337, "", "=q3=Mooncloth Vestments", "=ds=#s5#, #a1#"};
    { 16, 35366, "", "=q3=Opportunist's Leather Gloves", "=ds=#s9#, #a2#"};
    { 17, 31361, "", "=q3=Pattern: Cobrahide Leg Armor", "=ds=#p7#"};
    { 18, 25739, "", "=q3=Pattern: Felstalker Bracers", "=ds=#p7#"};
    { 19, 25740, "", "=q3=Pattern: Felstalker Breastplate", "=ds=#p7#"};
    { 20, 29232, "", "=q3=Recipe: Transmute Skyfire Diamond", "=ds=#p1#"};
    { 21, 35339, "", "=q3=Satin Hood", "=ds=#s1#, #a1#"};
    { 22, 35409, "", "=q3=Savage Plate Helm", "=ds=#s1#, #a4#"};
    { 23, 35383, "", "=q3=Seer's Linked Helm", "=ds=#s1#, #a3#"};
    { 24, 35386, "", "=q3=Seer's Mail Armor", "=ds=#s5#, #a3#"};
    { 25, 35392, "", "=q3=Seer's Ringmail Gloves", "=ds=#s9#, #a3#"};
    { 26, 35377, "", "=q3=Stalker's Chain Gauntlets", "=ds=#s9#, #a3#"};
    { 27, 35371, "", "=q3=Wyrmhide Gloves", "=ds=#s9#, #a2#"};
    { 28, 29197, "", "=q2=Arcanum of Fire Warding", "=ds=#m3#"};
    { 29, 24001, "", "=q1=Recipe: Elixir of Major Agility", "=ds=#p1#"};
    ...
    { 3, 29167, "", "=q3=Blackened Spear", "=ds=#h2#, #w7#"};
    { 4, 31358, "", "=q3=Design: Dawnstone Crab", "=ds=#p12#"};
    { 5, 32882, "", "=q3=Hellfire Shot", "=ds=#e6#"};
    { 6, 34201, "", "=q3=Pattern: Netherscale Ammo Pouch", "=ds=#p7#"};
    { 7, 29190, "", "=q2=Arcanum of Renewal", "=ds=#m3#"};
    { 8, 30637, "", "=q1=Flamewrought Key", "=ds=#e5#"};
    { 9, 24003, "", "=q1=Formula: Enchant Chest - Exceptional Stats", "=ds=#p4#"};
    { 16, 0, "INV_BannerPVP_01", "=q6=#r5#", ""};
    { 17, 29152, "", "=q4=Marksman's Bow", "=ds=#w2#"};
    { 18, 31362, "", "=q4=Pattern: Nethercobra Leg Armor", "=ds=#p7#"};
    { 19, 29155, "", "=q4=Stormcaller", "=ds=#h3#, #w10#"};
    { 20, 29165, "", "=q4=Warbringer", "=ds=#h1#, #w1#"};
    { 21, 33151, "", "=q3=Formula: Enchant Cloak - Subtlety", "=ds=#p4#"};
    { 22, 24002, "", "=q2=Plans: Felsteel Shield Spike", "=ds=#p2#"};
    Prev = "Thrallmar1";
    Back = "REPMENU_BURNINGCRUSADE";
	};

	AtlasLoot_Data["VioletEye1"] = {
    { 1, 0, "spell_holy_mindsooth", "=q6=#r3#", ""};
    { 2, 31401, "", "=q4=Design: The Frozen Eye", "=ds=#p12#"};
    { 3, 29187, "", "=q2=Inscription of Endurance", "=ds=#m3#"};
    { 4, 33209, "", "=q1=Recipe: Flask of Chromatic Wonder", "=ds=#p1#"};
    { 5, 902002, "", "=q1=Violet Eye Tabard", "=ds=#s7#"};
    { 7, 0, "spell_holy_mindsooth", "=q6=#r4#", ""};
    { 8, 34581, "", "=q4=Mysterious Arrow", "=ds=#e6#"};
    { 9, 34582, "", "=q4=Mysterious Shell", "=ds=#e6#"};
    { 10, 33205, "", "=q4=Pattern: Shadowprowler's Chestguard", "=ds=#p7#"};
    { 12, 0, "spell_holy_mindsooth", "=q6=#r5#", ""};
    { 13, 33124, "", "=q4=Pattern: Cloak of Darkness", "=ds=#p7#"};
    { 14, 33165, "", "=q1=Formula: Enchant Weapon - Greater Agility", "=ds=#p4#"};
    Back = "REPMENU_BURNINGCRUSADE";
	};

	AtlasLoot_Data["SunOffensive1"] = {
    { 1, 0, "inv_shield_48", "=q6=#r3#", ""};
    { 2, 34872, "", "=q3=Formula: Void Shatter", "=ds=#p4#"};
    { 3, 35500, "", "=q1=Formula: Enchant Chest - Defense", "=ds=#p4#"};
    { 4, 35221, "", "=q1=Tabard of the Shattered Sun", "=ds=#s7#"};
    { 6, 0, "inv_shield_48", "=q6=#r4#", ""};
    { 7, 35697, "", "=q4=Design: Figurine - Crimson Serpent", "=ds=#p12#"};
    { 8, 35695, "", "=q4=Design: Figurine - Empyrean Tortoise", "=ds=#p12#"};
    { 9, 35696, "", "=q4=Design: Figurine - Khorium Boar", "=ds=#p12#"};
    { 10, 35699, "", "=q4=Design: Figurine - Seaspray Albatross", "=ds=#p12#"};
    { 11, 35698, "", "=q4=Design: Figurine - Shadowsong Panther", "=ds=#p12#"};
    { 12, 35769, "", "=q4=Design: Forceful Seaspray Emerald", "=ds=#p12#"};
    { 13, 35768, "", "=q4=Design: Quick Lionseye", "=ds=#p12#"};
    { 14, 35767, "", "=q4=Design: Reckless Pyrestone", "=ds=#p12#"};
    { 15, 35766, "", "=q4=Design: Steady Seaspray Emerald", "=ds=#p12#"};
    { 16, 34667, "", "=q3=Archmage's Guile", "=ds=#h3#, #w10#"};
    { 17, 34665, "", "=q3=Bombardier's Blade", "=ds=#h1#, #w4#"};
    { 18, 35505, "", "=q3=Design: Ember Skyfire Diamond", "=ds=#p12#"};
    { 19, 35502, "", "=q3=Design: Eternal Earthstorm Diamond", "=ds=#p12#"};
    { 20, 35708, "", "=q3=Design: Regal Nightseye", "=ds=#p12#"};
    { 21, 34672, "", "=q3=Inuuro's Blade", "=ds=#h1#, #w10#"};
    { 22, 34671, "", "=q3=K'iru's Presage", "=ds=#h3#, #w6#"};
    { 23, 34673, "", "=q3=Legionfoe", "=ds=#h2#, #w1#"};
    { 24, 34670, "", "=q3=Seeker's Gavel", "=ds=#h3#, #w6#"};
    { 25, 34666, "", "=q3=The Sunbreaker", "=ds=#h1#, #w10#"};
    { 26, 34674, "", "=q3=Truestrike Crossbow", "=ds=#w3#"};
    { 27, 29193, "", "=q2=Arcanum of the Gladiator", "=ds=#m3#"};
    Next = "SunOffensive2";
    Back = "REPMENU_BURNINGCRUSADE";
	};

	AtlasLoot_Data["SunOffensive2"] = {
    { 1, 0, "inv_shield_48", "=q6=#r5#", ""};
    { 2, 34676, "", "=q4=Dawnforged Defender", "=ds=#w8#, #w8#"};
    { 3, 35755, "", "=q4=Recipe: Assassin's Alchemist Stone", "=ds=#p1#"};
    { 4, 35752, "", "=q4=Recipe: Guardian's Alchemist Stone", "=ds=#p1#"};
    { 5, 35754, "", "=q4=Recipe: Redeemer's Alchemist Stone", "=ds=#p1#"};
    { 6, 35753, "", "=q4=Recipe: Sorcerer's Alchemist Stone", "=ds=#p1#"};
    { 7, 34678, "", "=q4=Shattered Sun Pendant of Acumen", "=ds=#s2#"};
    { 8, 34679, "", "=q4=Shattered Sun Pendant of Might", "=ds=#s2#"};
    { 9, 34680, "", "=q4=Shattered Sun Pendant of Resolve", "=ds=#s2#"};
    { 10, 34677, "", "=q4=Shattered Sun Pendant of Restoration", "=ds=#s2#"};
    { 11, 34675, "", "=q4=Sunward Crest", "=ds=#w8#, #w8#"};
    Prev = "SunOffensive1";
    Back = "REPMENU_BURNINGCRUSADE";
	};

	AtlasLoot_Data["Shatar1"] = {
    { 1, 0, "Ability_Warrior_ShieldMastery", "=q6=#r2#", ""};
    { 2, 25904, "", "=q3=Design: Insightful Earthstorm Diamond", "=ds=#p12#"};
    { 4, 0, "Ability_Warrior_ShieldMastery", "=q6=#r3#", ""};
    { 5, 33155, "", "=q4=Design: Kailee's Rose", "=ds=#p12#"};
    { 6, 35404, "", "=q3=Crusader's Ornamented Headguard", "=ds=#s1#, #a4#"};
    { 7, 35416, "", "=q3=Crusader's Scaled Shoulders", "=ds=#s3#, #a4#"};
    { 8, 30826, "", "=q3=Design: Ring of Arcane Shielding", "=ds=#p12#"};
    { 9, 35359, "", "=q3=Dragonhide Spaulders", "=ds=#s3#, #a2#"};
    { 10, 35330, "", "=q3=Dreadweave Leggings", "=ds=#s11#, #a1#"};
    { 11, 35345, "", "=q3=Evoker's Silk Handguards", "=ds=#s9#, #a1#"};
    { 12, 35362, "", "=q3=Kodohide Helm", "=ds=#s1#, #a2#"};
    { 13, 35333, "", "=q3=Mooncloth Cowl", "=ds=#s1#, #a1#"};
    { 14, 35368, "", "=q3=Opportunist's Leather Legguards", "=ds=#s11#, #a2#"};
    { 15, 29717, "", "=q3=Pattern: Drums of Battle", "=ds=#p7#"};
    { 16, 35341, "", "=q3=Satin Mantle", "=ds=#s3#, #a1#"};
    { 17, 35407, "", "=q3=Savage Plate Chestpiece", "=ds=#s5#, #a4#"};
    { 18, 35381, "", "=q3=Seer's Linked Armor", "=ds=#s5#, #a3#"};
    { 19, 35388, "", "=q3=Seer's Mail Helm", "=ds=#s1#, #a3#"};
    { 20, 35395, "", "=q3=Seer's Ringmail Shoulderpads", "=ds=#s3#, #a3#"};
    { 21, 35380, "", "=q3=Stalker's Chain Spaulders", "=ds=#s3#, #a3#"};
    { 22, 35375, "", "=q3=Wyrmhide Robe", "=ds=#s5#, #a2#"};
    { 23, 29195, "", "=q2=Arcanum of Arcane Warding", "=ds=#m3#"};
    { 24, 28273, "", "=q2=Formula: Enchant Gloves - Major Healing", "=ds=#p4#"};
    { 25, 31781, "", "=q1=Sha'tar Tabard", "=ds=#s7#"};
    Next = "Shatar2";
    Back = "REPMENU_BURNINGCRUSADE";
	};

	AtlasLoot_Data["Shatar2"] = {
    { 1, 0, "Ability_Warrior_ShieldMastery", "=q6=#r4#", ""};
    { 2, 33159, "", "=q4=Design: Blood of Amber", "=ds=#p12#"};
    { 3, 13517, "", "=q4=Recipe: Alchemist's Stone", "=ds=#p1#"};
    { 4, 29180, "", "=q3=Blessed Scale Girdle", "=ds=#s10#, #a3#"};
    { 5, 24182, "", "=q3=Design: Talasite Owl", "=ds=#p12#"};
    { 6, 29179, "", "=q3=Xi'ri's Gift", "=ds=#s14#"};
    { 7, 29191, "", "=q2=Arcanum of Power", "=ds=#m3#"};
    { 8, 28281, "", "=q2=Formula: Enchant Weapon - Major Healing", "=ds=#p4#"};
    { 9, 22915, "", "=q2=Recipe: Transmute Primal Air to Fire", "=ds=#p1#"};
    { 10, 22537, "", "=q1=Formula: Enchant Ring - Healing Power", "=ds=#p4#"};
    { 11, 30634, "", "=q1=Warpforged Key", "=ds=#e5#"};
    { 16, 0, "Ability_Warrior_ShieldMastery", "=q6=#r5#", ""};
    { 17, 29177, "", "=q4=A'dal's Command", "=ds=#s13#"};
    { 18, 29176, "", "=q4=Crest of the Sha'tar", "=ds=#w8#, #w8#"};
    { 19, 29175, "", "=q4=Gavel of Pure Light", "=ds=#h3#, #w6#"};
    { 20, 33153, "", "=q3=Formula: Enchant Gloves - Threat", "=ds=#p4#"};
    { 21, 31354, "", "=q1=Recipe: Flask of the Titans", "=ds=#p1#"};
    Prev = "Shatar1";
    Back = "REPMENU_BURNINGCRUSADE";
	};
    ...
    { 2, 32274, "", "=q4=Design: Bold Crimson Spinel", "=ds=#p12#"};
    { 3, 32283, "", "=q4=Design: Bright Crimson Spinel", "=ds=#p12#"};
    { 4, 32290, "", "=q4=Design: Brilliant Lionseye", "=ds=#p12#"};
    { 5, 32277, "", "=q4=Design: Delicate Crimson Spinel", "=ds=#p12#"};
    { 6, 32293, "", "=q4=Design: Gleaming Lionseye", "=ds=#p12#"};
    { 7, 32288, "", "=q4=Design: Lustrous Empyrean Sapphire", "=ds=#p12#"};
    { 8, 32282, "", "=q4=Design: Runed Crimson Spinel", "=ds=#p12#"};
    { 9, 32291, "", "=q4=Design: Smooth Lionseye", "=ds=#p12#"};
    { 10, 32286, "", "=q4=Design: Solid Empyrean Sapphire", "=ds=#p12#"};
    { 11, 32287, "", "=q4=Design: Sparkling Empyrean Sapphire", "=ds=#p12#"};
    { 12, 32284, "", "=q4=Design: Subtle Crimson Spinel", "=ds=#p12#"};
    { 13, 32281, "", "=q4=Design: Teardrop Crimson Spinel", "=ds=#p12#"};
    { 14, 32294, "", "=q4=Design: Thick Lionseye", "=ds=#p12#"};
    { 16, 0, "INV_Misc_MonsterScales_13", "=q6=#r3#", ""};
    { 17, 32299, "", "=q4=Design: Balanced Shadowsong Amethyst", "=ds=#p12#"};
    { 18, 32311, "", "=q4=Design: Dazzling Seaspray Emerald", "=ds=#p12#"};
    { 19, 35765, "", "=q4=Design: Forceful Seaspray Emerald", "=ds=#p12#"};
    { 20, 32306, "", "=q4=Design: Glinting Pyrestone", "=ds=#p12#"};
    { 21, 32301, "", "=q4=Design: Glowing Shadowsong Amethyst", "=ds=#p12#"};
    { 22, 32300, "", "=q4=Design: Infused Shadowsong Amethyst", "=ds=#p12#"};
    { 23, 32312, "", "=q4=Design: Jagged Seaspray Emerald", "=ds=#p12#"};
    { 24, 32305, "", "=q4=Design: Luminous Pyrestone", "=ds=#p12#"};
    { 25, 32304, "", "=q4=Design: Potent Pyrestone", "=ds=#p12#"};
    { 26, 35763, "", "=q4=Design: Quick Lionseye", "=ds=#p12#"};
    { 27, 32310, "", "=q4=Design: Radiant Seaspray Emerald", "=ds=#p12#"};
    { 28, 35762, "", "=q4=Design: Reckless Pyrestone", "=ds=#p12#"};
    { 29, 35764, "", "=q4=Design: Steady Seaspray Emerald", "=ds=#p12#"};
    { 30, 902005, "", "=q1=Scale of the Sands Tabard", "=ds=#s7#"};
    Next = "ScaleSands2";
    Back = "REPMENU_BURNINGCRUSADE";
	};
    ...
    { 2, 32309, "", "=q4=Design: Enduring Seaspray Emerald", "=ds=#p12#"};
    { 3, 32292, "", "=q4=Design: Rigid Lionseye", "=ds=#p12#"};
    { 4, 32302, "", "=q4=Design: Royal Shadowsong Amethyst", "=ds=#p12#"};
    { 5, 32308, "", "=q4=Design: Wicked Pyrestone", "=ds=#p12#"};
    Prev = "ScaleSands1";
    Back = "REPMENU_BURNINGCRUSADE";
	};

	AtlasLoot_Data["Netherwing1"] = {
    { 1, 0, "Ability_Mount_Netherdrakepurple", "=q6=#r3#", ""};
    { 2, 902001, "", "=q1=Netherwing Tabard", "=ds=#s7#"};
    Back = "REPMENU_BURNINGCRUSADE";
	};

	AtlasLoot_Data["LowerCity1"] = {
    { 1, 0, "Spell_Holy_ChampionsBond", "=q6=#r2#", ""};
    { 2, 23138, "", "=q2=Design: Potent Flame Spessarite", "=ds=#p12#"};
    { 4, 0, "Spell_Holy_ChampionsBond", "=q6=#r3#", ""};
    { 5, 35405, "", "=q3=Crusader's Ornamented Leggings", "=ds=#s11#, #a4#"};
    { 6, 35412, "", "=q3=Crusader's Scaled Chestpiece", "=ds=#s5#, #a4#"};
    { 7, 35357, "", "=q3=Dragonhide Helm", "=ds=#s1#, #a2#"};
    { 8, 35331, "", "=q3=Dreadweave Mantle", "=ds=#s3#, #a1#"};
    { 9, 35344, "", "=q3=Evoker's Silk Cowl", "=ds=#s1#, #a1#"};
    { 10, 35361, "", "=q3=Kodohide Gloves", "=ds=#s9#, #a2#"};
    { 11, 35335, "", "=q3=Mooncloth Mitts", "=ds=#s9#, #a1#"};
    { 12, 35370, "", "=q3=Opportunist's Leather Tunic", "=ds=#s5#, #a2#"};
    { 13, 30833, "", "=q3=Pattern: Cloak of Arcane Evasion", "=ds=#p7#"};
    { 14, 35340, "", "=q3=Satin Leggings", "=ds=#s11#, #a1#"};
    { 15, 35411, "", "=q3=Savage Plate Shoulders", "=ds=#s3#, #a4#"};
    { 16, 35382, "", "=q3=Seer's Linked Gauntlets", "=ds=#s9#, #a3#"};
    { 17, 35389, "", "=q3=Seer's Mail Leggings", "=ds=#s11#, #a3#"};
    { 18, 35391, "", "=q3=Seer's Ringmail Chestguard", "=ds=#s5#, #a3#"};
    { 19, 35378, "", "=q3=Stalker's Chain Helm", "=ds=#s1#, #a3#"};
    { 20, 35373, "", "=q3=Wyrmhide Legguards", "=ds=#s11#, #a2#"};
    { 21, 29199, "", "=q2=Arcanum of Shadow Warding", "=ds=#m3#"};
    { 22, 22538, "", "=q1=Formula: Enchant Ring - Stats", "=ds=#p4#"};
    { 23, 31778, "", "=q1=Lower City Tabard", "=ds=#s7#"};
    Next = "LowerCity2";
    Back = "REPMENU_BURNINGCRUSADE";
	};

	AtlasLoot_Data["LowerCity2"] = {
    { 1, 0, "Spell_Holy_ChampionsBond", "=q6=#r4#", ""};
    { 2, 33157, "", "=q4=Design: Falling Star", "=ds=#p12#"};
    { 3, 24179, "", "=q3=Design: Felsteel Boar", "=ds=#p12#"};
    { 4, 24175, "", "=q3=Design: Pendant of Thawing", "=ds=#p12#"};
    { 5, 30836, "", "=q3=Leggings of the Skettis Exile", "=ds=#s11#, #a1#"};
    { 6, 30841, "", "=q3=Lower City Prayerbook", "=ds=#s14#"};
    { 7, 34200, "", "=q3=Pattern: Quiver of a Thousand Feathers", "=ds=#p7#"};
    { 8, 30835, "", "=q3=Salvager's Hauberk", "=ds=#s5#, #a3#"};
    { 9, 30846, "", "=q2=Arcanum of the Outcast", "=ds=#m3#"};
    { 10, 30633, "", "=q1=Auchenai Key", "=ds=#e5#"};
    { 11, 22910, "", "=q1=Recipe: Elixir of Major Shadow Power", "=ds=#p1#"};
    { 16, 0, "Spell_Holy_ChampionsBond", "=q6=#r5#", ""};
    { 17, 30832, "", "=q4=Gavel of Unearthed Secrets", "=ds=#h3#, #w6#"};
    { 18, 30834, "", "=q4=Shapeshifter's Signet", "=ds=#s13#"};
    { 19, 30830, "", "=q4=Trident of the Outcast Tribe", "=ds=#h2#, #w7#"};
    { 20, 33148, "", "=q3=Formula: Enchant Cloak - Dodge", "=ds=#p4#"};
    { 21, 31357, "", "=q1=Recipe: Flask of Chromatic Resistance", "=ds=#p1#"};
    Prev = "LowerCity1";
    Back = "REPMENU_BURNINGCRUSADE";
	};
    ...
    { 2, 33160, "", "=q4=Design: Facet of Eternity", "=ds=#p12#"};
    { 3, 35402, "", "=q3=Crusader's Ornamented Chestplate", "=ds=#s5#, #a4#"};
    { 4, 35414, "", "=q3=Crusader's Scaled Helm", "=ds=#s1#, #a4#"};
    { 5, 25910, "", "=q3=Design: Enigmatic Skyfire Diamond", "=ds=#p12#"};
    { 6, 35356, "", "=q3=Dragonhide Gloves", "=ds=#s9#, #a2#"};
    { 7, 35328, "", "=q3=Dreadweave Gloves", "=ds=#s9#, #a1#"};
    { 8, 35346, "", "=q3=Evoker's Silk Raiment", "=ds=#s5#, #a1#"};
    { 9, 35363, "", "=q3=Kodohide Legguards", "=ds=#s11#, #a2#"};
    { 10, 35334, "", "=q3=Mooncloth Legguards", "=ds=#s11#, #a1#"};
    { 11, 35369, "", "=q3=Opportunist's Leather Spaulders", "=ds=#s3#, #a2#"};
    { 12, 35338, "", "=q3=Satin Gloves", "=ds=#s9#, #a1#"};
    { 13, 35410, "", "=q3=Savage Plate Legguards", "=ds=#s11#, #a4#"};
    { 14, 35384, "", "=q3=Seer's Linked Leggings", "=ds=#s11#, #a3#"};
    { 15, 35390, "", "=q3=Seer's Mail Spaulders", "=ds=#s3#, #a3#"};
    { 16, 35393, "", "=q3=Seer's Ringmail Headpiece", "=ds=#s1#, #a3#"};
    { 17, 35376, "", "=q3=Stalker's Chain Armor", "=ds=#s5#, #a3#"};
    { 18, 35372, "", "=q3=Wyrmhide Helm", "=ds=#s1#, #a2#"};
    { 19, 29198, "", "=q2=Arcanum of Frost Warding", "=ds=#m3#"};
    { 20, 28272, "", "=q2=Formula: Enchant Gloves - Major Spellpower", "=ds=#p4#"};
    { 21, 29713, "", "=q2=Pattern: Drums of Panic", "=ds=#p7#"};
    { 22, 22536, "", "=q1=Formula: Enchant Ring - Spellpower", "=ds=#p4#"};
    { 23, 31777, "", "=q1=Keepers of Time Tabard", "=ds=#s7#"};
    Next = "KeepersofTime2";
    Back = "REPMENU_BURNINGCRUSADE";
	};

	AtlasLoot_Data["KeepersofTime2"] = {
    { 1, 0, "Ability_Warrior_VictoryRush", "=q6=#r4#", ""};
    { 2, 33158, "", "=q4=Design: Stone of Blades", "=ds=#p12#"};
    { 3, 29185, "", "=q3=Continuum Blade", "=ds=#h3#, #w10#"};
    { 4, 24181, "", "=q3=Design: Living Ruby Serpent", "=ds=#p12#"};
    { 5, 24174, "", "=q3=Design: Pendant of Frozen Flame", "=ds=#p12#"};
    { 6, 29184, "", "=q3=Timewarden's Leggings", "=ds=#s11#, #a4#"};
    { 7, 29186, "", "=q2=Arcanum of the Defender", "=ds=#m3#"};
    { 8, 30635, "", "=q1=Key of Time", "=ds=#e5#"};
    { 10, 0, "Ability_Warrior_VictoryRush", "=q6=#r5#", ""};
    { 11, 29183, "", "=q4=Bindings of the Timewalker", "=ds=#s8#, #a1#"};
    { 12, 29182, "", "=q4=Riftmaker", "=ds=#h1#, #w4#"};
    { 13, 29181, "", "=q4=Timelapse Shard", "=ds=#s14#"};
    { 14, 33152, "", "=q3=Formula: Enchant Gloves - Superior Agility", "=ds=#p4#"};
    { 15, 31355, "", "=q1=Recipe: Flask of Supreme Power", "=ds=#p1#"};
    Prev = "KeepersofTime1";
    Back = "REPMENU_BURNINGCRUSADE";
	};
    ...
    { 2, 25732, "", "=q3=Pattern: Fel Leather Gloves", "=ds=#p7#"};
    { 3, 23136, "", "=q2=Design: Luminous Flame Spessarite", "=ds=#p12#"};
    { 4, 23146, "", "=q2=Design: Shifting Shadow Draenite", "=ds=#p12#"};
    { 5, 28274, "", "=q2=Formula: Enchant Cloak - Spell Penetration", "=ds=#p4#"};
    { 7, 0, "INV_Weapon_Shortblade_31", "=q6=#r4#", ""};
    { 8, 33156, "", "=q4=Design: Crimson Sun", "=ds=#p12#"};
    { 9, 33305, "", "=q4=Design: Don Julio's Heart", "=ds=#p12#"};
    { 10, 29115, "", "=q3=Consortium Blaster", "=ds=#w5#"};
    { 11, 24178, "", "=q3=Design: Pendant of the Null Rune", "=ds=#p12#"};
    { 12, 29116, "", "=q3=Nomad's Leggings", "=ds=#s11#, #a2#"};
    { 13, 25734, "", "=q3=Pattern: Fel Leather Leggings", "=ds=#p7#"};
    { 14, 29117, "", "=q3=Stormspire Vest", "=ds=#s5#, #a1#"};
    { 15, 23874, "", "=q1=Schematic: Elemental Seaforium Charge", "=ds=#p5#"};
    { 16, 0, "INV_Weapon_Shortblade_31", "=q6=#r3#", ""};
    { 17, 25908, "", "=q3=Design: Swift Skyfire Diamond", "=ds=#p12#"};
    { 18, 29456, "", "=q3=Gift of the Ethereal", "=ds=#h1#, #w10#"};
    { 19, 29457, "", "=q3=Nethershard", "=ds=#h3#, #w4#"};
    { 20, 25733, "", "=q3=Pattern: Fel Leather Boots", "=ds=#p7#"};
    { 21, 29118, "", "=q3=Smuggler's Ammo Pouch", "=ds=#e11#"};
    { 22, 23134, "", "=q2=Design: Delicate Blood Garnet", "=ds=#p12#"};
    { 23, 23155, "", "=q2=Design: Lustrous Azure Moonstone", "=ds=#p12#"};
    { 24, 23150, "", "=q2=Design: Thick Golden Draenite", "=ds=#p12#"};
    { 25, 24314, "", "=q2=Pattern: Bag of Jewels", "=ds=#p8#"};
    { 26, 31776, "", "=q1=Consortium Tabard", "=ds=#s7#"};
    { 27, 22552, "", "=q1=Formula: Enchant Weapon - Major Striking", "=ds=#p4#"};
    Next = "Consortium2";
    Back = "REPMENU_BURNINGCRUSADE";
	};

	AtlasLoot_Data["Consortium2"] = {
    { 1, 0, "INV_Weapon_Shortblade_31", "=q6=#r5#", ""};
    { 2, 29121, "", "=q4=Guile of Khoraazi", "=ds=#h1#, #w4#"};
    { 3, 29119, "", "=q4=Haramad's Bargain", "=ds=#s2#"};
    { 4, 29122, "", "=q4=Nether Runner's Cowl", "=ds=#s1#, #a1#"};
    { 5, 33622, "", "=q3=Design: Relentless Earthstorm Diamond", "=ds=#p12#"};
    Prev = "Consortium1";
    Back = "REPMENU_BURNINGCRUSADE";
	};

	AtlasLoot_Data["Ashtongue1"] = {
    { 1, 0, "achievement_reputation_ashtonguedeathsworn", "=q6=#r2#", ""};
    { 2, 32429, "", "=q4=Pattern: Boots of Shackled Souls", "=ds=#p7#"};
    { 3, 32430, "", "=q4=Pattern: Bracers of Shackled Souls", "=ds=#p7#"};
    { 4, 32436, "", "=q4=Pattern: Redeemed Soul Cinch", "=ds=#p7#"};
    { 5, 32435, "", "=q4=Pattern: Redeemed Soul Legguards", "=ds=#p7#"};
    { 6, 32438, "", "=q4=Pattern: Soulguard Bracers", "=ds=#p7#"};
    { 7, 32440, "", "=q4=Pattern: Soulguard Girdle", "=ds=#p7#"};
    { 8, 32442, "", "=q4=Plans: Shadesteel Bracers", "=ds=#p2#"};
    { 9, 32444, "", "=q4=Plans: Shadesteel Girdle", "=ds=#p2#"};
    { 16, 0, "achievement_reputation_ashtonguedeathsworn", "=q6=#r3#", ""};
    { 17, 32431, "", "=q4=Pattern: Greaves of Shackled Souls", "=ds=#p7#"};
    { 18, 32447, "", "=q4=Pattern: Night's End", "=ds=#p7#"};
    { 19, 32433, "", "=q4=Pattern: Redeemed Soul Moccasins", "=ds=#p7#"};
    { 20, 32434, "", "=q4=Pattern: Redeemed Soul Wristguards", "=ds=#p7#"};
    { 21, 32439, "", "=q4=Pattern: Soulguard Leggings", "=ds=#p7#"};
    { 22, 32437, "", "=q4=Pattern: Soulguard Slippers", "=ds=#p7#"};
    { 23, 32432, "", "=q4=Pattern: Waistguard of Shackled Souls", "=ds=#p7#"};
    { 24, 32443, "", "=q4=Plans: Shadesteel Greaves", "=ds=#p2#"};
    { 25, 32441, "", "=q4=Plans: Shadesteel Sabots", "=ds=#p2#"};
    { 26, 902004, "", "=q1=Ashtongue Deathsworn Tabard", "=ds=#s7#"};
    Next = "Ashtongue2";
    Back = "REPMENU_BURNINGCRUSADE";
	};

	AtlasLoot_Data["Ashtongue2"] = {
    { 1, 0, "achievement_reputation_ashtonguedeathsworn", "=q6=#r5#", ""};
    { 2, 32490, "", "=q4=Ashtongue Talisman of Acumen", "=ds=#s14#"};
    { 3, 32486, "", "=q4=Ashtongue Talisman of Equilibrium", "=ds=#s14#"};
    { 4, 32488, "", "=q4=Ashtongue Talisman of Insight", "=ds=#s14#"};
    { 5, 32492, "", "=q4=Ashtongue Talisman of Lethality", "=ds=#s14#"};
    { 6, 32493, "", "=q4=Ashtongue Talisman of Shadows", "=ds=#s14#"};
    { 7, 32487, "", "=q4=Ashtongue Talisman of Swiftness", "=ds=#s14#"};
    { 8, 32485, "", "=q4=Ashtongue Talisman of Valor", "=ds=#s14#"};
    { 9, 32491, "", "=q4=Ashtongue Talisman of Vision", "=ds=#s14#"};
    { 10, 32489, "", "=q4=Ashtongue Talisman of Zeal", "=ds=#s14#"};
    Prev = "Ashtongue1";
    Back = "REPMENU_BURNINGCRUSADE";
	};
    ...
    { 5, 22993, "", "=q2=Volunteer's Greaves", "=ds=#s12#, #a3#"};
    ...
    { 11, 902003, "", "=q1=Tranquillien Tabard", "=ds=#s7#"};
    { 13, 0, "INV_Misc_Bandana_03", "=q6=#r5#", ""};
    { 14, 22990, "", "=q3=Tranquillien Champion's Cloak", "=ds=#s4#, #a1#"};
    ...
    { 1, 0, "inv_mushroom_11", "=q6=#r2#", ""};
    { 2, 25548, "", "=q1=Tallstalk Mushroom", "=ds=#e0#"};
    { 4, 0, "inv_mushroom_11", "=q6=#r3#", ""};
    { 5, 25827, "", "=q3=Muck-Covered Drape", "=ds=#s4#, #a1#"};
    { 6, 25828, "", "=q3=Petrified Lichen Guard", "=ds=#w8#, #w8#"};
    { 7, 25550, "", "=q1=Redcap Toadstool", "=ds=#e0#"};
    { 8, 31775, "", "=q1=Sporeggar Tabard", "=ds=#s7#"};
    { 10, 0, "inv_mushroom_11", "=q6=#r4#", ""};
    { 11, 29150, "", "=q3=Hardened Stone Shard", "=ds=#h1#, #w4#"};
    { 12, 38229, "", "=q3=Pattern: Mycah's Botanical Bag", "=ds=#p8#"};
    { 13, 29149, "", "=q3=Sporeling's Firestick", "=ds=#w12#"};
    { 14, 22916, "", "=q2=Recipe: Transmute Primal Earth to Water", "=ds=#p1#"};
    { 16, 0, "inv_mushroom_11", "=q6=#r5#", ""};
    { 17, 34478, "", "=q3=Tiny Sporebat", "=ds=#e10#"};
    { 18, 22906, "", "=q1=Recipe: Shrouding Potion", "=ds=#p1#"};
    Back = "REPMENU_BURNINGCRUSADE";
	};

	AtlasLoot_Data["Skyguard1"] = {
    { 1, 0, "INV_Misc_Ribbon_01", "=q6=#r3#", ""};
    { 2, 32445, "", "=q1=Skyguard Tabard", "=ds=#s7#"};
    { 4, 0, "INV_Misc_Ribbon_01", "=q6=#r4#", ""};
    { 5, 32539, "", "=q3=Skyguard's Drape", "=ds=#s4#, #a1#"};
    { 6, 32538, "", "=q3=Skywitch's Drape", "=ds=#s4#, #a1#"};
    { 16, 0, "INV_Misc_Ribbon_01", "=q6=#r5#", ""};
    { 17, 32771, "", "=q4=Airman's Ribbon of Gallantry", "=ds=#s14#"};
    { 18, 32319, "", "=q4=Blue Riding Nether Ray", "=ds=#e10#"};
    { 19, 32314, "", "=q4=Green Riding Nether Ray", "=ds=#e10#"};
    { 20, 32316, "", "=q4=Purple Riding Nether Ray", "=ds=#e10#"};
    { 21, 32317, "", "=q4=Red Riding Nether Ray", "=ds=#e10#"};
    { 22, 32318, "", "=q4=Silver Riding Nether Ray", "=ds=#e10#"};
    { 23, 32770, "", "=q4=Skyguard Silver Cross", "=ds=#s14#"};
    { 24, 38628, "", "=q3=Nether Ray Fry", "=ds=#e10#"};
    Back = "REPMENU_BURNINGCRUSADE";
	};

	AtlasLoot_Data["Scryer1"] = {
    { 1, 0, "INV_Misc_Foot_Centaur", "=q6=#r2#", ""};
    { 2, 23597, "", "=q3=Plans: Enchanted Adamantite Belt", "=ds=#p2#"};
    { 3, 23133, "", "=q2=Design: Runed Blood Garnet", "=ds=#p12#"};
    { 5, 0, "INV_Misc_Foot_Centaur", "=q6=#r3#", ""};
    { 6, 29701, "", "=q3=Pattern: Enchanted Clefthoof Boots", "=ds=#p7#"};
    { 7, 29682, "", "=q3=Pattern: Enchanted Felscale Gloves", "=ds=#p7#"};
    { 8, 24292, "", "=q3=Pattern: Mystic Spellthread", "=ds=#p8#"};
    { 9, 23598, "", "=q3=Plans: Enchanted Adamantite Boots", "=ds=#p2#"};
    { 10, 23143, "", "=q2=Design: Dazzling Deep Peridot", "=ds=#p12#"};
    { 11, 31780, "", "=q1=Scryers Tabard", "=ds=#s7#"};
    { 16, 0, "INV_Misc_Foot_Centaur", "=q6=#r4#", ""};
    { 17, 24176, "", "=q3=Design: Pendant of Withering", "=ds=#p12#"};
    { 18, 29134, "", "=q3=Gauntlets of the Chosen", "=ds=#s9#, #a4#"};
    { 19, 29700, "", "=q3=Pattern: Enchanted Clefthoof Gloves", "=ds=#p7#"};
    { 20, 29684, "", "=q3=Pattern: Enchanted Felscale Boots", "=ds=#p7#"};
    { 21, 23599, "", "=q3=Plans: Enchanted Adamantite Breastplate", "=ds=#p2#"};
    { 22, 29131, "", "=q3=Retainer's Leggings", "=ds=#s11#, #a2#"};
    { 23, 29132, "", "=q3=Scryer's Bloodgem", "=ds=#s14#"};
    { 24, 29133, "", "=q3=Seer's Cane", "=ds=#h2#, #w9#"};
    { 25, 25722, "", "=q1=Pattern: Magister's Armor Kit", "=ds=#p7#"};
    { 26, 22908, "", "=q1=Recipe: Elixir of Major Firepower", "=ds=#p1#"};
    Next = "Scryer2";
    Back = "REPMENU_BURNINGCRUSADE";
	};

	AtlasLoot_Data["Scryer2"] = {
    { 1, 0, "INV_Misc_Foot_Centaur", "=q6=#r5#", ""};
    { 2, 24294, "", "=q4=Pattern: Runic Spellthread", "=ds=#p8#"};
    { 3, 29125, "", "=q4=Retainer's Blade", "=ds=#h1#, #w4#"};
    { 4, 29126, "", "=q4=Seer's Signet", "=ds=#s13#"};
    { 5, 29698, "", "=q3=Pattern: Enchanted Clefthoof Leggings", "=ds=#p7#"};
    { 6, 29677, "", "=q3=Pattern: Enchanted Felscale Leggings", "=ds=#p7#"};
    { 7, 23600, "", "=q3=Plans: Enchanted Adamantite Leggings", "=ds=#p2#"};
    Prev = "Scryer1";
    Back = "REPMENU_BURNINGCRUSADE";
	};

	AtlasLoot_Data["Ogrila1"] = {
    { 1, 0, "inv_misc_apexis_crystal", "=q6=#r3#", ""};
    { 2, 32783, "", "=q1=Blue Ogre Brew", "=ds=#e0#"};
    { 3, 32828, "", "=q1=Ogri'la Tabard", "=ds=#s7#"};
    { 4, 32784, "", "=q1=Red Ogre Brew", "=ds=#e0#"};
    { 6, 0, "inv_misc_apexis_crystal", "=q6=#r4#", ""};
    { 7, 32653, "", "=q3=Apexis Cloak", "=ds=#s4#, #a1#"};
    { 8, 32650, "", "=q3=Cerulean Crystal Rod", "=ds=#w12#"};
    { 9, 32654, "", "=q3=Crystalforged Trinket", "=ds=#s14#"};
    { 10, 32652, "", "=q3=Ogri'la Aegis", "=ds=#w8#, #w8#"};
    { 16, 0, "inv_misc_apexis_crystal", "=q6=#r5#", ""};
    { 17, 32651, "", "=q4=Crystal Orb of Enlightenment", "=ds=#s15#"};
    { 18, 32645, "", "=q4=Crystalline Crossbow", "=ds=#w3#"};
    { 19, 32647, "", "=q4=Shard-bound Bracers", "=ds=#s8#, #a2#"};
    { 20, 32648, "", "=q4=Vortex Walking Boots", "=ds=#s12#, #a4#"};
    Back = "REPMENU_BURNINGCRUSADE";
	};

	AtlasLoot_Data["Maghar1"] = {
    { 1, 0, "INV_Misc_Foot_Centaur", "=q6=#r2#", ""};
    { 2, 25741, "", "=q3=Pattern: Netherfury Belt", "=ds=#p7#"};
    { 4, 0, "INV_Misc_Foot_Centaur", "=q6=#r3#", ""};
    { 5, 29143, "", "=q3=Clefthoof Hide Quiver", "=ds=#e11#"};
    { 6, 25742, "", "=q3=Pattern: Netherfury Leggings", "=ds=#p7#"};
    { 7, 34174, "", "=q2=Pattern: Drums of Restoration", "=ds=#p7#"};
    { 8, 34172, "", "=q2=Pattern: Drums of Speed", "=ds=#p7#"};
    { 9, 29664, "", "=q2=Pattern: Reinforced Mining Bag", "=ds=#p8#"};
    { 10, 31773, "", "=q1=Mag'har Tabard", "=ds=#s7#"};
    { 12, 0, "INV_Misc_Foot_Centaur", "=q6=#r4#", ""};
    { 13, 29145, "", "=q3=Band of Ancestral Spirits", "=ds=#s13#"};
    { 14, 25743, "", "=q3=Pattern: Netherfury Boots", "=ds=#p7#"};
    { 15, 29147, "", "=q3=Talbuk Hide Spaulders", "=ds=#s3#, #a2#"};
    { 16, 29141, "", "=q3=Tempest Leggings", "=ds=#s11#, #a2#"};
    { 17, 22917, "", "=q2=Recipe: Transmute Primal Fire to Earth", "=ds=#p1#"};
    { 19, 0, "INV_Misc_Foot_Centaur", "=q6=#r5#", ""};
    { 20, 31829, "", "=q4=Reins of the Cobalt Riding Talbuk", "=ds=#e10#"};
    { 21, 29102, "", "=q4=Reins of the Cobalt War Talbuk", "=ds=#e10#"};
    { 22, 31831, "", "=q4=Reins of the Silver Riding Talbuk", "=ds=#e10#"};
    { 23, 29104, "", "=q4=Reins of the Silver War Talbuk", "=ds=#e10#"};
    { 24, 31833, "", "=q4=Reins of the Tan Riding Talbuk", "=ds=#e10#"};
    { 25, 29105, "", "=q4=Reins of the Tan War Talbuk", "=ds=#e10#"};
    { 26, 31835, "", "=q4=Reins of the White Riding Talbuk", "=ds=#e10#"};
    { 27, 29103, "", "=q4=Reins of the White War Talbuk", "=ds=#e10#"};
    { 28, 29139, "", "=q3=Ceremonial Cover", "=ds=#s4#, #a1#"};
    { 29, 29135, "", "=q3=Earthcaller's Headdress", "=ds=#s1#, #a3#"};
    { 30, 29137, "", "=q3=Hellscream's Will", "=ds=#h2#, #w1#"};
    Back = "REPMENU_BURNINGCRUSADE";
	};

	AtlasLoot_Data["Kurenai1"] = {
    { 1, 0, "INV_Misc_Foot_Centaur", "=q6=#r2#", ""};
    { 2, 29217, "", "=q3=Pattern: Netherfury Belt", "=ds=#p7#"};
    { 4, 0, "INV_Misc_Foot_Centaur", "=q6=#r3#", ""};
    { 5, 29219, "", "=q3=Pattern: Netherfury Leggings", "=ds=#p7#"};
    { 6, 29144, "", "=q3=Worg Hide Quiver", "=ds=#e11#"};
    { 7, 34175, "", "=q2=Pattern: Drums of Restoration", "=ds=#p7#"};
    { 8, 34173, "", "=q2=Pattern: Drums of Speed", "=ds=#p7#"};
    { 9, 30444, "", "=q2=Pattern: Reinforced Mining Bag", "=ds=#p8#"};
    { 10, 31774, "", "=q1=Kurenai Tabard", "=ds=#s7#"};
    { 12, 0, "INV_Misc_Foot_Centaur", "=q6=#r4#", ""};
    { 13, 29146, "", "=q3=Band of Elemental Spirits", "=ds=#s13#"};
    { 14, 29148, "", "=q3=Blackened Leather Spaulders", "=ds=#s3#, #a2#"};
    { 15, 29142, "", "=q3=Kurenai Kilt", "=ds=#s11#, #a2#"};
    { 16, 29218, "", "=q3=Pattern: Netherfury Boots", "=ds=#p7#"};
    { 17, 30443, "", "=q2=Recipe: Transmute Primal Fire to Earth", "=ds=#p1#"};
    { 19, 0, "INV_Misc_Foot_Centaur", "=q6=#r5#", ""};
    { 20, 31830, "", "=q4=Reins of the Cobalt Riding Talbuk", "=ds=#e10#"};
    { 21, 29227, "", "=q4=Reins of the Cobalt War Talbuk", "=ds=#e10#"};
    { 22, 31832, "", "=q4=Reins of the Silver Riding Talbuk", "=ds=#e10#"};
    { 23, 29229, "", "=q4=Reins of the Silver War Talbuk", "=ds=#e10#"};
    { 24, 31834, "", "=q4=Reins of the Tan Riding Talbuk", "=ds=#e10#"};
    { 25, 29230, "", "=q4=Reins of the Tan War Talbuk", "=ds=#e10#"};
    { 26, 31836, "", "=q4=Reins of the White Riding Talbuk", "=ds=#e10#"};
    { 27, 29231, "", "=q4=Reins of the White War Talbuk", "=ds=#e10#"};
    { 28, 29138, "", "=q3=Arechron's Gift", "=ds=#h2#, #w6#"};
    { 29, 29140, "", "=q3=Cloak of the Ancient Spirits", "=ds=#s4#, #a1#"};
    { 30, 29136, "", "=q3=Far Seer's Helm", "=ds=#s1#, #a3#"};
    Back = "REPMENU_BURNINGCRUSADE";
	};

	AtlasLoot_Data["CExpedition1"] = {
    { 1, 0, "INV_Misc_Ammo_Arrow_02", "=q6=#r2#", ""};
    { 2, 25737, "", "=q3=Pattern: Heavy Clefthoof Boots", "=ds=#p7#"};
    { 3, 24417, "", "=q2=Scout's Arrow", "=ds=#e6#"};
    { 4, 23814, "", "=q1=Schematic: Green Smoke Flare", "=ds=#p5#"};
    Next = "CExpedition2";
    Back = "REPMENU_BURNINGCRUSADE";
	};

	AtlasLoot_Data["CExpedition2"] = {
    { 1, 0, "INV_Misc_Ammo_Arrow_02", "=q6=#r3#", ""};
    { 2, 35403, "", "=q3=Crusader's Ornamented Gloves", "=ds=#s9#, #a4#"};
    { 3, 35415, "", "=q3=Crusader's Scaled Legguards", "=ds=#s11#, #a4#"};
    { 4, 35358, "", "=q3=Dragonhide Legguards", "=ds=#s11#, #a2#"};
    { 5, 35329, "", "=q3=Dreadweave Hood", "=ds=#s1#, #a1#"};
    { 6, 35347, "", "=q3=Evoker's Silk Trousers", "=ds=#s11#, #a1#"};
    { 7, 25835, "", "=q3=Explorer's Walking Stick", "=ds=#h2#, #w9#"};
    { 8, 35365, "", "=q3=Kodohide Robe", "=ds=#s5#, #a2#"};
    { 9, 35336, "", "=q3=Mooncloth Shoulderpads", "=ds=#s3#, #a1#"};
    { 10, 35367, "", "=q3=Opportunist's Leather Helm", "=ds=#s1#, #a2#"};
    { 11, 29720, "", "=q3=Pattern: Clefthide Leg Armor", "=ds=#p7#"};
    { 12, 25736, "", "=q3=Pattern: Heavy Clefthoof Leggings", "=ds=#p7#"};
    { 13, 25735, "", "=q3=Pattern: Heavy Clefthoof Vest", "=ds=#p7#"};
    { 14, 25836, "", "=q3=Preserver's Cudgel", "=ds=#h3#, #w6#"};
    { 15, 25869, "", "=q3=Recipe: Transmute Earthstorm Diamond", "=ds=#p1#"};
    { 16, 35342, "", "=q3=Satin Robe", "=ds=#s5#, #a1#"};
    { 17, 35408, "", "=q3=Savage Plate Gauntlets", "=ds=#s9#, #a4#"};
    { 18, 35385, "", "=q3=Seer's Linked Spaulders", "=ds=#s3#, #a3#"};
    { 19, 35387, "", "=q3=Seer's Mail Gauntlets", "=ds=#s9#, #a3#"};
    { 20, 35394, "", "=q3=Seer's Ringmail Legguards", "=ds=#s11#, #a3#"};
    { 21, 35379, "", "=q3=Stalker's Chain Leggings", "=ds=#s11#, #a3#"};
    { 22, 25838, "", "=q3=Warden's Hauberk", "=ds=#s5#, #a2#"};
    { 23, 35374, "", "=q3=Wyrmhide Spaulders", "=ds=#s3#, #a2#"};
    { 24, 29194, "", "=q2=Arcanum of Nature Warding", "=ds=#m3#"};
    { 25, 23618, "", "=q2=Plans: Adamantite Sharpening Stone", "=ds=#p2#"};
    { 26, 28632, "", "=q2=Plans: Adamantite Weightstone", "=ds=#p2#"};
    { 27, 31804, "", "=q1=Cenarion Expedition Tabard", "=ds=#s7#"};
    { 28, 25526, "", "=q1=Plans: Greater Rune of Warding", "=ds=#p2#"};
    { 29, 32070, "", "=q1=Recipe: Earthen Elixir", "=ds=#p1#"};
    Next = "CExpedition3";
    Prev = "CExpedition1";
    Back = "REPMENU_BURNINGCRUSADE";
	};

	AtlasLoot_Data["CExpedition3"] = {
    { 1, 0, "INV_Misc_Ammo_Arrow_02", "=q6=#r4#", ""};
    { 2, 31392, "", "=q4=Plans: Wildguard Helm", "=ds=#p2#"};
    { 3, 31391, "", "=q4=Plans: Wildguard Leggings", "=ds=#p2#"};
    { 4, 24183, "", "=q3=Design: Nightseye Panther", "=ds=#p12#"};
    { 5, 29173, "", "=q3=Strength of the Untamed", "=ds=#s2#"};
    { 6, 31949, "", "=q3=Warden's Arrow", "=ds=#e6#"};
    { 7, 29174, "", "=q3=Watcher's Cowl", "=ds=#s1#, #a1#"};
    { 8, 29192, "", "=q2=Arcanum of Ferocity", "=ds=#m3#"};
    { 9, 28271, "", "=q2=Formula: Enchant Gloves - Precise Strikes", "=ds=#p4#"};
    { 10, 22918, "", "=q2=Recipe: Transmute Primal Water to Air", "=ds=#p1#"};
    { 11, 30623, "", "=q1=Reservoir Key", "=ds=#e5#"};
    { 16, 0, "INV_Misc_Ammo_Arrow_02", "=q6=#r5#", ""};
    { 17, 29172, "", "=q4=Ashyen's Gift", "=ds=#s13#"};
    { 18, 33999, "", "=q4=Cenarion War Hippogryph", "=ds=#e10#"};
    { 19, 31402, "", "=q4=Design: The Natural Ward", "=ds=#p12#"};
    { 20, 29171, "", "=q4=Earthwarden", "=ds=#h2#, #w6#"};
    { 21, 29721, "", "=q4=Pattern: Nethercleft Leg Armor", "=ds=#p7#"};
    { 22, 31390, "", "=q4=Plans: Wildguard Breastplate", "=ds=#p2#"};
    { 23, 29170, "", "=q4=Windcaller's Orb", "=ds=#s15#"};
    { 24, 33149, "", "=q3=Formula: Enchant Cloak - Stealth", "=ds=#p4#"};
    { 25, 31356, "", "=q1=Recipe: Flask of Distilled Wisdom", "=ds=#p1#"};
    { 26, 22922, "", "=q1=Recipe: Major Nature Protection Potion", "=ds=#p1#"};
    Prev = "CExpedition2";
    Back = "REPMENU_BURNINGCRUSADE";
	};
    ...
    { 2, 30842, "", "=q3=Pattern: Flameheart Bracers", "=ds=#p7#"};
    { 3, 23601, "", "=q3=Plans: Flamebane Bracers", "=ds=#p2#"};
    { 4, 23149, "", "=q2=Design: Gleaming Golden Draenite", "=ds=#p12#"};
    { 6, 0, "INV_Jewelry_Talisman_08", "=q6=#r3#", ""};
    { 7, 29129, "", "=q3=Anchorite's Robes", "=ds=#s5#, #a1#"};
    { 8, 29704, "", "=q3=Pattern: Blastguard Belt", "=ds=#p7#"};
    { 9, 30843, "", "=q3=Pattern: Flameheart Gloves", "=ds=#p7#"};
    { 10, 29693, "", "=q3=Pattern: Flamescale Belt", "=ds=#p7#"};
    { 11, 24293, "", "=q3=Pattern: Silver Spellthread", "=ds=#p8#"};
    { 12, 23603, "", "=q3=Plans: Flamebane Gloves", "=ds=#p2#"};
    { 13, 23145, "", "=q2=Design: Royal Shadow Draenite", "=ds=#p12#"};
    { 14, 31779, "", "=q1=Aldor Tabard", "=ds=#s7#"};
    { 16, 0, "INV_Jewelry_Talisman_08", "=q6=#r4#", ""};
    { 17, 29130, "", "=q3=Auchenai Staff", "=ds=#h2#, #w9#"};
    { 18, 24177, "", "=q3=Design: Pendant of Shadow's End", "=ds=#p12#"};
    { 19, 29128, "", "=q3=Lightwarden's Band", "=ds=#s13#"};
    { 20, 29703, "", "=q3=Pattern: Blastguard Boots", "=ds=#p7#"};
    { 21, 29691, "", "=q3=Pattern: Flamescale Boots", "=ds=#p7#"};
    { 22, 23604, "", "=q3=Plans: Flamebane Breastplate", "=ds=#p2#"};
    { 23, 29127, "", "=q3=Vindicator's Hauberk", "=ds=#s5#, #a4#"};
    { 24, 25721, "", "=q1=Pattern: Vindicator's Armor Kit", "=ds=#p7#"};
    Next = "Aldor2";
    Back = "REPMENU_BURNINGCRUSADE";
	};

	AtlasLoot_Data["Aldor2"] = {
    { 1, 0, "INV_Jewelry_Talisman_08", "=q6=#r5#", ""};
    { 2, 29123, "", "=q4=Medallion of the Lightbearer", "=ds=#s2#"};
    { 3, 24295, "", "=q4=Pattern: Golden Spellthread", "=ds=#p8#"};
    { 4, 29124, "", "=q4=Vindicator's Brand", "=ds=#h1#, #w10#"};
    { 5, 29702, "", "=q3=Pattern: Blastguard Pants", "=ds=#p7#"};
    { 6, 30844, "", "=q3=Pattern: Flameheart Vest", "=ds=#p7#"};
    { 7, 29689, "", "=q3=Pattern: Flamescale Leggings", "=ds=#p7#"};
    { 8, 23602, "", "=q3=Plans: Flamebane Helm", "=ds=#p2#"};
    Prev = "Aldor1";
    Back = "REPMENU_BURNINGCRUSADE";
	};
    ...
    { 2, 29213, "", "=q3=Pattern: Felstalker Belt", "=ds=#p7#"};
    { 3, 23142, "", "=q2=Design: Enduring Deep Peridot", "=ds=#p12#"};
    { 4, 22531, "", "=q1=Formula: Enchant Bracer - Superior Healing", "=ds=#p4#"};
    { 6, 0, "INV_BannerPVP_02", "=q6=#r3#", ""};
    { 7, 35476, "", "=q3=Crusader's Ornamented Spaulders", "=ds=#s3#, #a4#"};
    { 8, 35477, "", "=q3=Crusader's Scaled Gauntlets", "=ds=#s9#, #a4#"};
    { 9, 35469, "", "=q3=Dragonhide Robe", "=ds=#s5#, #a2#"};
    { 10, 35464, "", "=q3=Dreadweave Robe", "=ds=#s5#, #a1#"};
    { 11, 35465, "", "=q3=Evoker's Silk Amice", "=ds=#s3#, #a1#"};
    { 12, 25825, "", "=q3=Footman's Longsword", "=ds=#h1#, #w10#"};
    { 13, 35470, "", "=q3=Kodohide Spaulders", "=ds=#s3#, #a2#"};
    { 14, 35467, "", "=q3=Mooncloth Vestments", "=ds=#s5#, #a1#"};
    { 15, 35468, "", "=q3=Opportunist's Leather Gloves", "=ds=#s9#, #a2#"};
    { 16, 29719, "", "=q3=Pattern: Cobrahide Leg Armor", "=ds=#p7#"};
    { 17, 29214, "", "=q3=Pattern: Felstalker Bracers", "=ds=#p7#"};
    { 18, 29215, "", "=q3=Pattern: Felstalker Breastplate", "=ds=#p7#"};
    { 19, 25870, "", "=q3=Recipe: Transmute Skyfire Diamond", "=ds=#p1#"};
    { 20, 25826, "", "=q3=Sage's Band", "=ds=#s13#"};
    { 21, 35466, "", "=q3=Satin Hood", "=ds=#s1#, #a1#"};
    { 22, 35478, "", "=q3=Savage Plate Helm", "=ds=#s1#, #a4#"};
    { 23, 35474, "", "=q3=Seer's Linked Helm", "=ds=#s1#, #a3#"};
    { 24, 35472, "", "=q3=Seer's Mail Armor", "=ds=#s5#, #a3#"};
    { 25, 35473, "", "=q3=Seer's Ringmail Gloves", "=ds=#s9#, #a3#"};
    { 26, 35475, "", "=q3=Stalker's Chain Gauntlets", "=ds=#s9#, #a3#"};
    { 27, 35471, "", "=q3=Wyrmhide Gloves", "=ds=#s9#, #a2#"};
    { 28, 29196, "", "=q2=Arcanum of Fire Warding", "=ds=#m3#"};
    { 29, 23999, "", "=q1=Honor Hold Tabard", "=ds=#s7#"};
    { 30, 22905, "", "=q1=Recipe: Elixir of Major Agility", "=ds=#p1#"};
    Next = "HonorHold2";
    Back = "REPMENU_BURNINGCRUSADE";
	};
    ...
    { 2, 24180, "", "=q3=Design: Dawnstone Crab", "=ds=#p12#"};
    { 3, 32883, "", "=q3=Felbane Slugs", "=ds=#e6#"};
    { 4, 29166, "", "=q3=Hellforged Halberd", "=ds=#h2#, #w7#"};
    { 5, 34218, "", "=q3=Pattern: Netherscale Ammo Pouch", "=ds=#p7#"};
    { 6, 29169, "", "=q3=Ring of Convalescence", "=ds=#s13#"};
    { 7, 29189, "", "=q2=Arcanum of Renewal", "=ds=#m3#"};
    { 8, 30622, "", "=q1=Flamewrought Key", "=ds=#e5#"};
    { 9, 22547, "", "=q1=Formula: Enchant Chest - Exceptional Stats", "=ds=#p4#"};
    { 16, 0, "INV_BannerPVP_02", "=q6=#r5#", ""};
    { 17, 29153, "", "=q4=Blade of the Archmage", "=ds=#h3#, #w10#"};
    { 18, 29156, "", "=q4=Honor's Call", "=ds=#h1#, #w10#"};
    { 19, 29722, "", "=q4=Pattern: Nethercobra Leg Armor", "=ds=#p7#"};
    { 20, 29151, "", "=q4=Veteran's Musket", "=ds=#w5#"};
    { 21, 33150, "", "=q3=Formula: Enchant Cloak - Subtlety", "=ds=#p4#"};
    { 22, 23619, "", "=q2=Plans: Felsteel Shield Spike", "=ds=#p2#"};
    Prev = "HonorHold1";
    Back = "REPMENU_BURNINGCRUSADE";
	};
