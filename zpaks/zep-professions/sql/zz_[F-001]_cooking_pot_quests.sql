...
INSERT INTO `quest_template` SET
    ...
    `RewardFactionValue1` = 5,
    `LogTitle` = 'Cook''s Pot',
    `LogDescription` = 'Trade in your Artisan pot and bring dishes to exchange for a Master Cooking Pot',
    `QuestDescription` = 'Welcome to Outland, cook! The ingredients here are unlike anything from Azeroth - exotic, dangerous, and absolutely delicious! Your Artisan pot will struggle with these new materials. I have a Master Cooking Pot built for Outland''s unique ingredients. Trade in your old Artisan pot and bring me 10 Warp Burger and 10 Talbuk Steak, and the Master pot is yours. Trust me, you''ll need it!$B$BRequired:$B- 10 Warp Burger$B- 10 Talbuk Steak',
...
INSERT INTO `quest_template` SET
    ...
    `LogTitle` = 'Cook''s Pot',
    `LogDescription` = 'Trade in your Artisan pot and bring dishes to exchange for a Master Cooking Pot',
    `QuestDescription` = 'A cook from Azeroth? Good - Honor Hold needs all the skilled hands we can get. Your Artisan pot won''t hold up to Outland cooking though. I have a Master Cooking Pot built for field conditions. Trade in your old Artisan pot and bring me 10 Warp Burger and 10 Talbuk Steak for the garrison''s mess hall, and the Master pot is yours.$B$BRequired:$B- 10 Warp Burger$B- 10 Talbuk Steak',
...
INSERT INTO `quest_template` SET
    ...
    `RewardFactionValue1` = 5,
    `LogTitle` = 'Cook''s Pot',
    `LogDescription` = 'Trade in your Master pot and bring dishes to exchange for a Grand Master Cooking Pot',
    `QuestDescription` = 'Northrend''s ingredients are among the finest - and most challenging - in all of Azeroth. Your Master pot has served admirably, but grand master-level cooking demands the ultimate in equipment. I have a Grand Master Cooking Pot, the finest available. Trade in your old Master pot and bring me 10 Dragonfin Filet and 10 Imperial Manta Steak - Northrend''s signature dishes - and the Grand Master pot is yours.$B$BRequired:$B- 10 Dragonfin Filet$B- 10 Imperial Manta Steak',
