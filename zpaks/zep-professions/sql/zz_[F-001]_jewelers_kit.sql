...
DELETE FROM `spell_group` WHERE `id` = 2024;
DELETE FROM `spell_group_stack_rules` WHERE `group_id` = 2024;
...
SET `entry` = 57505,
    ...
    `description` = 'Contains a gem grinder',
...
INSERT INTO `spell_group` SET `id` = 2024, `spell_id` = 91244; -- Journeyman (first rank)
