...
INSERT INTO `quest_template` SET
    ...
    `LogTitle` = 'My First Mining Pick',
    `LogDescription` = 'Collect ore to exchange for a Journeyman Mining Pick',
    `QuestDescription` = '$GBrother:Sister;, I see you work the earth without proper tools. The Earth Mother teaches that respect for the stone brings greater bounty. I have picks here - bring me 20 Copper Ore and 20 Tin Ore for my needs, and I will trade one to you. You will find each vein yields more generously.$B$BRequired:$B- 20 Copper Ore$B- 20 Tin Ore',
...
INSERT INTO `quest_template` SET
    ...
    `QuestDescription` = 'Let''s see yer pick... aye, thought so. Chipped tae the haft already. Fel iron does that - eats Azeroth steel fer breakfast. Bring me a proper haul o'' fel iron and adamantite so I know ye can swing in this rock, hand over the Artisan pick, and I''ll fit ye with a Master pick that bites deep and brings up the whole vein.$B$BRequired:$B- 20 Fel Iron Ore$B- 20 Adamantite Ore$B- Artisan Mining Pick',
...
INSERT INTO `quest_template` SET
    ...
    `QuestDescription` = 'Listen, $Gbrother:sister;. The stone here groans - it has been broken once already, and it does not open for timid blows. Show the spirits you take only what you can carry: fel iron, adamantite. Leave your Artisan pick with me. The Master pick I give you strikes true, and the vein yields all it holds.$B$BRequired:$B- 20 Fel Iron Ore$B- 20 Adamantite Ore$B- Artisan Mining Pick',
...
INSERT INTO `quest_template` SET
    ...
    `QuestDescription` = 'Cobalt sings when you strike it - did you know? Saronite hisses. Miners who can''t hear the difference leave half the seam in the wall. Bring me ore enough to prove your ears, trade in the Master pick, and I''ll hand you a Grand Master pick balanced by Dalaran''s finest smiths. Nothing in the seam will stay behind.$B$BRequired:$B- 20 Cobalt Ore$B- 20 Saronite Ore$B- Master Mining Pick',
