...
INSERT INTO `quest_template` SET
    ...
    `RewardFactionValue1` = 5,
    `LogTitle` = 'Master''s Mortar',
    `LogDescription` = 'Bring 5 Major Healing Potions, 5 Major Mana Potions and your Artisan Alchemy Mortar to Alchemist Gribble at Honor Hold in Hellfire Peninsula.',
    `QuestDescription` = 'You saw the infirmary tents on your way in? Every potion they pour, I brewed. Out here a weak batch costs lives, and a worn grinding surface makes weak batches. Prove your bench-work - five healing, five mana, brewed proper - and trade in that Artisan mortar. I''ll issue you a Master mortar that grinds fel-tainted reagents down to honest medicine.$B$BRequired:$B- 5 Major Healing Potion$B- 5 Major Mana Potion$B- Artisan Alchemy Mortar',
...
INSERT INTO `quest_template` SET
    ...
    `RewardFactionValue1` = 5,
    `LogTitle` = 'Master''s Mortar',
    `LogDescription` = 'Bring 5 Major Healing Potions, 5 Major Mana Potions and your Artisan Alchemy Mortar to Apothecary Antonivich at Thrallmar in Hellfire Peninsula.',
    `QuestDescription` = 'Come closer. You smell of dreamfoil and... competence. Good. Outland reagents bite back, you know - fel residue, most invigorating - and a tired mortar leaves the best parts locked in the pulp. Such waste. Brew me proof of your skill and surrender the Artisan mortar. Mine grinds everything out of a reagent. Everything.$B$BRequired:$B- 5 Major Healing Potion$B- 5 Major Mana Potion$B- Artisan Alchemy Mortar',
...
INSERT INTO `quest_template` SET
    ...
    `LogDescription` = 'Bring 5 Runic Healing Potions, 5 Runic Mana Potions and your Master Alchemy Mortar to Linzy Blackbolt in Dalaran.',
    `QuestDescription` = 'Ooh, an Outland mortar! Lovely fel-scoring. Useless here, sorry! Northrend herbs are soaked in ambient ley energy and they do NOT like being ground by anything that isn''t properly attuned - the potency just evaporates. Tragic. Brew me runic potions to show your technique, trade that mortar in, and you''ll get my Kirin-Tor-attuned Grand Master model. The fumes alone will impress you.$B$BRequired:$B- 5 Runic Healing Potion$B- 5 Runic Mana Potion$B- Master Alchemy Mortar',
...
-- =====================================================
DELETE FROM `quest_poi` WHERE `QuestID` IN (90091,90092,90093,90094,90095,90096,90097,90098,90099,90100,90101,90102,90103,90104,90105,90106,90107,90108,90111,90112);
DELETE FROM `quest_poi_points` WHERE `QuestID` IN (90091,90092,90093,90094,90095,90096,90097,90098,90099,90100,90101,90102,90103,90104,90105,90106,90107,90108,90111,90112);

INSERT INTO `quest_poi` (`QuestID`, `id`, `ObjectiveIndex`, `MapID`, `WorldMapAreaId`, `Floor`, `Priority`, `Flags`, `VerifiedBuild`) VALUES
(90091, 0, -1, 0, 301, 0, 0, 1, 0),
(90092, 0, -1, 0, 341, 0, 0, 1, 0),
(90093, 0, -1, 1, 381, 0, 0, 1, 0),
(90094, 0, -1, 1, 471, 0, 0, 1, 0),
(90095, 0, -1, 1, 321, 0, 0, 1, 0),
(90096, 0, -1, 1, 362, 0, 0, 1, 0),
(90097, 0, -1, 0, 382, 0, 0, 1, 0),
(90098, 0, -1, 0, 480, 0, 0, 1, 0),
(90099, 0, -1, 0, 301, 0, 0, 1, 0),
(90100, 0, -1, 0, 341, 0, 0, 1, 0),
(90101, 0, -1, 1, 381, 0, 0, 1, 0),
(90102, 0, -1, 1, 471, 0, 0, 1, 0),
(90103, 0, -1, 1, 321, 0, 0, 1, 0),
(90104, 0, -1, 1, 362, 0, 0, 1, 0),
(90105, 0, -1, 0, 382, 0, 0, 1, 0),
(90106, 0, -1, 0, 480, 0, 0, 1, 0),
(90107, 0, -1, 530, 481, 0, 0, 1, 0),
(90108, 0, -1, 571, 510, 0, 0, 1, 0),
(90108, 1, -1, 571, 504, 1, 0, 3, 0),
(90111, 0, -1, 530, 465, 0, 0, 1, 0),
(90112, 0, -1, 530, 465, 0, 0, 1, 0);

INSERT INTO `quest_poi_points` (`QuestID`, `Idx1`, `Idx2`, `X`, `Y`, `VerifiedBuild`) VALUES
(90091, 0, 0, -9013, 736, 0),
(90091, 0, 1, -9013, 776, 0),
(90091, 0, 2, -8973, 776, 0),
(90091, 0, 3, -8973, 736, 0),
(90092, 0, 0, -4883, -1260, 0),
(90092, 0, 1, -4883, -1220, 0),
(90092, 0, 2, -4843, -1220, 0),
(90092, 0, 3, -4843, -1260, 0),
(90093, 0, 0, 10049, 2338, 0),
(90093, 0, 1, 10049, 2378, 0),
(90093, 0, 2, 10089, 2378, 0),
(90093, 0, 3, 10089, 2338, 0),
(90094, 0, 0, 5543, 6752, 0),
(90094, 0, 1, 5543, 6792, 0),
(90094, 0, 2, 5583, 6792, 0),
(90094, 0, 3, 5583, 6752, 0),
(90095, 0, 0, 1945, -4498, 0),
(90095, 0, 1, 1945, -4458, 0),
(90095, 0, 2, 1985, -4458, 0),
(90095, 0, 3, 1985, -4498, 0),
(90096, 0, 0, -1101, 10, 0),
(90096, 0, 1, -1101, 50, 0),
(90096, 0, 2, -1061, 50, 0),
(90096, 0, 3, -1061, 10, 0),
(90097, 0, 0, 1388, 395, 0),
(90097, 0, 1, 1388, 435, 0),
(90097, 0, 2, 1428, 435, 0),
(90097, 0, 3, 1428, 395, 0),
(90098, 0, 0, 7865, -5096, 0),
(90098, 0, 1, 7865, -5056, 0),
(90098, 0, 2, 7905, -5056, 0),
(90098, 0, 3, 7905, -5096, 0),
(90099, 0, 0, -9013, 736, 0),
(90099, 0, 1, -9013, 776, 0),
(90099, 0, 2, -8973, 776, 0),
(90099, 0, 3, -8973, 736, 0),
(90100, 0, 0, -4883, -1260, 0),
(90100, 0, 1, -4883, -1220, 0),
(90100, 0, 2, -4843, -1220, 0),
(90100, 0, 3, -4843, -1260, 0),
(90101, 0, 0, 10049, 2338, 0),
(90101, 0, 1, 10049, 2378, 0),
(90101, 0, 2, 10089, 2378, 0),
(90101, 0, 3, 10089, 2338, 0),
(90102, 0, 0, 5543, 6752, 0),
(90102, 0, 1, 5543, 6792, 0),
(90102, 0, 2, 5583, 6792, 0),
(90102, 0, 3, 5583, 6752, 0),
(90103, 0, 0, 1945, -4498, 0),
(90103, 0, 1, 1945, -4458, 0),
(90103, 0, 2, 1985, -4458, 0),
(90103, 0, 3, 1985, -4498, 0),
(90104, 0, 0, -1101, 10, 0),
(90104, 0, 1, -1101, 50, 0),
(90104, 0, 2, -1061, 50, 0),
(90104, 0, 3, -1061, 10, 0),
(90105, 0, 0, 1388, 395, 0),
(90105, 0, 1, 1388, 435, 0),
(90105, 0, 2, 1428, 435, 0),
(90105, 0, 3, 1428, 395, 0),
(90106, 0, 0, 7865, -5096, 0),
(90106, 0, 1, 7865, -5056, 0),
(90106, 0, 2, 7905, -5056, 0),
(90106, 0, 3, 7905, -5096, 0),
(90107, 0, 0, -1681, 5520, 0),
(90107, 0, 1, -1681, 5560, 0),
(90107, 0, 2, -1641, 5560, 0),
(90107, 0, 3, -1641, 5520, 0),
(90108, 0, 0, 5869, 679, 0),
(90108, 0, 1, 5869, 719, 0),
(90108, 0, 2, 5909, 719, 0),
(90108, 0, 3, 5909, 679, 0),
(90108, 1, 0, 5869, 679, 0),
(90108, 1, 1, 5869, 719, 0),
(90108, 1, 2, 5909, 719, 0),
(90108, 1, 3, 5909, 679, 0),
(90111, 0, 0, -805, 2741, 0),
(90111, 0, 1, -805, 2781, 0),
(90111, 0, 2, -765, 2781, 0),
(90111, 0, 3, -765, 2741, 0),
(90112, 0, 0, 206, 2819, 0),
(90112, 0, 1, 206, 2859, 0),
(90112, 0, 2, 246, 2859, 0),
(90112, 0, 3, 246, 2819, 0);
