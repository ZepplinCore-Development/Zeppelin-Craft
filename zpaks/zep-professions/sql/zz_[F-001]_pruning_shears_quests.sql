...
INSERT INTO `quest_template` SET
    ...
    `LogTitle` = 'My First Pruning Shears',
    `LogDescription` = 'Collect herbs to exchange for a pair of Journeyman Shears',
    `QuestDescription` = '$GBrother:Sister;, I see you gather herbs without proper tools. The Earth Mother teaches that respect for the plants brings greater bounty. I have shears here - bring me 20 Peacebloom and 20 Silverleaf for my needs, and I will trade them to you. You will find each plant yields more generously.$B$BRequired:$B- 20 Peacebloom$B- 20 Silverleaf',
...
INSERT INTO `quest_template` SET
    ...
    `LogDescription` = 'Bring 20 Felweed, 20 Dreaming Glory and your Artisan Pruning Shears to Rorelien at Honor Hold in Hellfire Peninsula.',
    `QuestDescription` = 'Half the poultices in this keep start as felweed, and the infirmary never has enough. I can''t have gatherers leaving good herbs mangled on the stem. Show me you can work this land, and trade in those Artisan shears - the Master pair cuts where Azeroth steel folds, and nothing of the harvest is wasted.$B$BRequired:$B- 20 Felweed$B- 20 Dreaming Glory$B- Artisan Pruning Shears',
...
INSERT INTO `quest_template` SET
    ...
    `RewardFactionValue1` = 5,
    `LogTitle` = 'Master Pruning Shears',
    `LogDescription` = 'Bring 20 Felweed, 20 Dreaming Glory and your Artisan Pruning Shears to Ruak Stronghorn at Thrallmar in Hellfire Peninsula.',
    `QuestDescription` = 'The Earth Mother speaks softly in this shattered land, $Gbrother:sister;, but she still provides. Her gifts here grow thorned and stubborn, and dull blades insult them. Gather felweed and Dreaming Glory as an offering, and give me your Artisan shears - I will give you a Master pair in return, blades worthy of her bounty.$B$BRequired:$B- 20 Felweed$B- 20 Dreaming Glory$B- Artisan Pruning Shears',
...
INSERT INTO `quest_template` SET
    ...
    `LogDescription` = 'Bring 20 Goldclover, 20 Tiger Lily and your Master Pruning Shears to Dorothy Egan in Dalaran.',
    `QuestDescription` = 'Careful with those! Northrend cuttings hold their enchantment only if the cut is clean - bruise the stem and the ley charge bleeds right out. Your Master shears are fine steel, but steel alone won''t do here. Bring me Goldclover and Tiger Lily, trade in the old pair, and I''ll imbue you shears that seal the cut as they make it.$B$BRequired:$B- 20 Goldclover$B- 20 Tiger Lily$B- Master Pruning Shears',
...
-- =====================================================
DELETE FROM `quest_poi` WHERE `QuestID` BETWEEN 90008 AND 90026;
DELETE FROM `quest_poi_points` WHERE `QuestID` BETWEEN 90008 AND 90026;

INSERT INTO `quest_poi` (`QuestID`, `id`, `ObjectiveIndex`, `MapID`, `WorldMapAreaId`, `Floor`, `Priority`, `Flags`, `VerifiedBuild`) VALUES
(90008, 0, -1, 0, 301, 0, 0, 1, 0),
(90009, 0, -1, 0, 341, 0, 0, 1, 0),
(90010, 0, -1, 1, 381, 0, 0, 1, 0),
(90011, 0, -1, 1, 321, 0, 0, 1, 0),
(90012, 0, -1, 1, 362, 0, 0, 1, 0),
(90013, 0, -1, 0, 382, 0, 0, 1, 0),
(90014, 0, -1, 1, 471, 0, 0, 1, 0),
(90015, 0, -1, 0, 480, 0, 0, 1, 0),
(90016, 0, -1, 0, 301, 0, 0, 1, 0),
(90017, 0, -1, 0, 341, 0, 0, 1, 0),
(90018, 0, -1, 1, 381, 0, 0, 1, 0),
(90019, 0, -1, 1, 321, 0, 0, 1, 0),
(90020, 0, -1, 1, 362, 0, 0, 1, 0),
(90021, 0, -1, 0, 382, 0, 0, 1, 0),
(90022, 0, -1, 1, 471, 0, 0, 1, 0),
(90023, 0, -1, 0, 480, 0, 0, 1, 0),
(90024, 0, -1, 530, 465, 0, 0, 1, 0),
(90025, 0, -1, 530, 465, 0, 0, 1, 0),
(90026, 0, -1, 571, 510, 0, 0, 1, 0),
(90026, 1, -1, 571, 504, 1, 0, 3, 0);

INSERT INTO `quest_poi_points` (`QuestID`, `Idx1`, `Idx2`, `X`, `Y`, `VerifiedBuild`) VALUES
(90008, 0, 0, -8990, 760, 0),
(90008, 0, 1, -8990, 800, 0),
(90008, 0, 2, -8950, 800, 0),
(90008, 0, 3, -8950, 760, 0),
(90009, 0, 0, -4901, -1176, 0),
(90009, 0, 1, -4901, -1136, 0),
(90009, 0, 2, -4861, -1136, 0),
(90009, 0, 3, -4861, -1176, 0),
(90010, 0, 0, 9738, 2411, 0),
(90010, 0, 1, 9738, 2451, 0),
(90010, 0, 2, 9778, 2451, 0),
(90010, 0, 3, 9778, 2411, 0),
(90011, 0, 0, 1885, -4481, 0),
(90011, 0, 1, 1885, -4441, 0),
(90011, 0, 2, 1925, -4441, 0),
(90011, 0, 3, 1925, -4481, 0),
(90012, 0, 0, -1151, -25, 0),
(90012, 0, 1, -1151, 15, 0),
(90012, 0, 2, -1111, 15, 0),
(90012, 0, 3, -1111, -25, 0),
(90013, 0, 0, 1541, 335, 0),
(90013, 0, 1, 1541, 375, 0),
(90013, 0, 2, 1581, 375, 0),
(90013, 0, 3, 1581, 335, 0),
(90014, 0, 0, 5528, 6757, 0),
(90014, 0, 1, 5528, 6797, 0),
(90014, 0, 2, 5568, 6797, 0),
(90014, 0, 3, 5568, 6757, 0),
(90015, 0, 0, 7852, -5104, 0),
(90015, 0, 1, 7852, -5064, 0),
(90015, 0, 2, 7892, -5064, 0),
(90015, 0, 3, 7892, -5104, 0),
(90016, 0, 0, -8990, 760, 0),
(90016, 0, 1, -8990, 800, 0),
(90016, 0, 2, -8950, 800, 0),
(90016, 0, 3, -8950, 760, 0),
(90017, 0, 0, -4901, -1176, 0),
(90017, 0, 1, -4901, -1136, 0),
(90017, 0, 2, -4861, -1136, 0),
(90017, 0, 3, -4861, -1176, 0),
(90018, 0, 0, 9738, 2411, 0),
(90018, 0, 1, 9738, 2451, 0),
(90018, 0, 2, 9778, 2451, 0),
(90018, 0, 3, 9778, 2411, 0),
(90019, 0, 0, 1885, -4481, 0),
(90019, 0, 1, 1885, -4441, 0),
(90019, 0, 2, 1925, -4441, 0),
(90019, 0, 3, 1925, -4481, 0),
(90020, 0, 0, -1151, -25, 0),
(90020, 0, 1, -1151, 15, 0),
(90020, 0, 2, -1111, 15, 0),
(90020, 0, 3, -1111, -25, 0),
(90021, 0, 0, 1541, 335, 0),
(90021, 0, 1, 1541, 375, 0),
(90021, 0, 2, 1581, 375, 0),
(90021, 0, 3, 1581, 335, 0),
(90022, 0, 0, 5528, 6757, 0),
(90022, 0, 1, 5528, 6797, 0),
(90022, 0, 2, 5568, 6797, 0),
(90022, 0, 3, 5568, 6757, 0),
(90023, 0, 0, 7852, -5104, 0),
(90023, 0, 1, 7852, -5064, 0),
(90023, 0, 2, 7892, -5064, 0),
(90023, 0, 3, 7892, -5104, 0),
(90024, 0, 0, -804, 2751, 0),
(90024, 0, 1, -804, 2791, 0),
(90024, 0, 2, -764, 2791, 0),
(90024, 0, 3, -764, 2751, 0),
(90025, 0, 0, 213, 2822, 0),
(90025, 0, 1, 213, 2862, 0),
(90025, 0, 2, 253, 2862, 0),
(90025, 0, 3, 253, 2822, 0),
(90026, 0, 0, 5858, 676, 0),
(90026, 0, 1, 5858, 716, 0),
(90026, 0, 2, 5898, 716, 0),
(90026, 0, 3, 5898, 676, 0),
(90026, 1, 0, 5858, 676, 0),
(90026, 1, 1, 5858, 716, 0),
(90026, 1, 2, 5898, 716, 0),
(90026, 1, 3, 5898, 676, 0);
