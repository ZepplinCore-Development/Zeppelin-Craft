...
INSERT INTO `quest_template` SET
    ...
    `QuestDescription` = 'Welcome to Outland, herbalist. Azeroth shears won''t cut fel-touched flora - half of every harvest stays in the ground. I can fix that. Trade in your Artisan shears with a sample of local herbs, and a set of Master shears is yours.$B$BRequired:$B- 20 Felweed$B- 20 Dreaming Glory$B- Artisan Pruning Shears',
...
INSERT INTO `quest_template` SET
    ...
    `QuestDescription` = 'Greetings, $Gbrother:sister;. The Earth Mother''s voice is strange in this shattered land, and her plants do not yield to Azeroth blades. Trade in your Artisan shears with a gathering of local herbs, and I will give you Master shears worthy of this soil.$B$BRequired:$B- 20 Felweed$B- 20 Dreaming Glory$B- Artisan Pruning Shears',
...
INSERT INTO `quest_template` SET
    ...
    `QuestDescription` = 'Ah, a herbalist! Northrend flora is steeped in latent ley energy - mundane shears simply bruise it. Mine are imbued to make a cleaner cut. Trade in your Master shears with some northern cuttings, and I''ll conjure up a Grand Master pair for you.$B$BRequired:$B- 20 Goldclover$B- 20 Tiger Lily$B- Master Pruning Shears',
