...
INSERT INTO `quest_template` SET
    ...
    `QuestDescription` = 'Welcome to Outland, skinner. Fel-twisted hides will dull an Azeroth blade in a week, and waste good leather besides. I keep Master knives for exactly that. Trade in your Artisan knife with some local leather, and one is yours.$B$BRequired:$B- 20 Knothide Leather$B- 5 Heavy Knothide Leather$B- Artisan Skinning Knife',
...
INSERT INTO `quest_template` SET
    ...
    `QuestDescription` = 'The beasts of this broken land wear hides like armor, $Gbrother:sister;. Your Artisan blade will tear what it should glide through. Trade it in with leather taken from Outland beasts, and a Master knife is yours.$B$BRequired:$B- 20 Knothide Leather$B- 5 Heavy Knothide Leather$B- Artisan Skinning Knife',
...
INSERT INTO `quest_template` SET
    ...
    `QuestDescription` = 'Ah... a skinner from Azeroth. The creatures here, they are... different. Fel-touched. Your knife will dull, and leather will be lost. I have Master blades, forged for such hides. Trade your Artisan knife, and leather to show your skill... and the blade is yours.$B$BRequired:$B- 20 Knothide Leather$B- 5 Heavy Knothide Leather$B- Artisan Skinning Knife',
...
INSERT INTO `quest_template` SET
    ...
    `QuestDescription` = 'Northrend beasts wear their cold well - hides frozen stiff, fur like wire. Your Master knife will drag and waste leather. Trade it in with some Borean hides, and I''ll hand you a Grand Master knife that cuts clean in any frost.$B$BRequired:$B- 20 Borean Leather$B- 5 Heavy Borean Leather$B- Master Skinning Knife',
...
(90119, 0, 0, 7210, -5021, 0),
(90119, 0, 1, 7210, -4981, 0),
(90119, 0, 2, 7250, -4981, 0),
(90119, 0, 3, 7250, -5021, 0),
(90120, 0, 0, -1170, 33, 0),
(90120, 0, 1, -1170, 73, 0),
(90120, 0, 2, -1130, 73, 0),
(90120, 0, 3, -1130, 33, 0),
...
(90127, 0, 0, 7210, -5021, 0),
(90127, 0, 1, 7210, -4981, 0),
(90127, 0, 2, 7250, -4981, 0),
(90127, 0, 3, 7250, -5021, 0),
(90128, 0, 0, -1170, 33, 0),
(90128, 0, 1, -1170, 73, 0),
(90128, 0, 2, -1130, 73, 0),
(90128, 0, 3, -1130, 33, 0),
