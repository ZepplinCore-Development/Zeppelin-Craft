...
INSERT INTO `spell` SET
    ...
    `spell_name_flags` = 16712190,
    `spell_subtext_flags` = 16712190,
    `spell_desc_enus` = 'Reduces craft time for Cooking recipes by $s1%. Increases food efficacy by $s2% and drink efficacy by $s3%. Does not stack with other Cooking Pot effects.',
    `spell_desc_flags` = 16712190,
    `spell_tooltip_flags` = 16712190,
    `spell_class_set` = 14,
    `effect_damage_multiplier_1` = 1.0,
