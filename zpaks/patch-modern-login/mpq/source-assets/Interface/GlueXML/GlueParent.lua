...
CharModelFogInfo["TROLL"] = { r=0.5, g=0.5, b=0.5, far=270 };
CharModelFogInfo["GNOME"] = { r=0.85, g=0.88, b=1.0, far=500 };
CharModelFogInfo["DRAENEI"] = { r=0.5, g=0.5, b=0.6, far=300 };
CharModelFogInfo["BLOODELF"] = { r=0.6, g=0.5, b=0.4, far=300 };
CharModelFogInfo["GOBLIN"] = { r=0.5, g=0.5, b=0.5, far=270 };
CharModelFogInfo["WORGEN"] = { r=0.5, g=0.5, b=0.5, far=300 };
...
function SetBackgroundModel(model, name)
	...
	if (nameupper == "ORC") then
		path = "Interface\\Glues\\Models\\UI_HORDE\\UI_HORDE.m2";
	elseif (nameupper == "HUMAN") then
		path = "Interface\\Glues\\Models\\UI_ALLIANCE\\UI_Alliance.m2";
	end
