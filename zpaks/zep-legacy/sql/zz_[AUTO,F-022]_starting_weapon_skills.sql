...
-- ============================================================================
-- STARTING AMMO QUANTITIES
-- ============================================================================
-- Gives hunters 2000 ammo at character creation instead of default 200.
-- Ammo type matches each outfit's ranged weapon (arrows for bows, shots for guns).
--
-- AUTO-GENERATED by: zep outfit fix
-- DO NOT EDIT MANUALLY - Changes will be overwritten
-- ============================================================================

-- Delete existing starting ammo entries
DELETE FROM `playercreateinfo_item` WHERE `itemid` IN (2512, 2516);

-- Human Hunter: Light Shot x2000
INSERT INTO `playercreateinfo_item` (`race`, `class`, `itemid`, `amount`) VALUES (1, 3, 2516, 2000);
-- Orc Hunter: Rough Arrow x2000
INSERT INTO `playercreateinfo_item` (`race`, `class`, `itemid`, `amount`) VALUES (2, 3, 2512, 2000);
-- Dwarf Hunter: Light Shot x2000
INSERT INTO `playercreateinfo_item` (`race`, `class`, `itemid`, `amount`) VALUES (3, 3, 2516, 2000);
-- Night Elf Hunter: Rough Arrow x2000
INSERT INTO `playercreateinfo_item` (`race`, `class`, `itemid`, `amount`) VALUES (4, 3, 2512, 2000);
-- Undead Hunter: Light Shot x2000
INSERT INTO `playercreateinfo_item` (`race`, `class`, `itemid`, `amount`) VALUES (5, 3, 2516, 2000);
-- Tauren Hunter: Light Shot x2000
INSERT INTO `playercreateinfo_item` (`race`, `class`, `itemid`, `amount`) VALUES (6, 3, 2516, 2000);
-- Gnome Hunter: Light Shot x2000
INSERT INTO `playercreateinfo_item` (`race`, `class`, `itemid`, `amount`) VALUES (7, 3, 2516, 2000);
-- Troll Hunter: Rough Arrow x2000
INSERT INTO `playercreateinfo_item` (`race`, `class`, `itemid`, `amount`) VALUES (8, 3, 2512, 2000);
-- Goblin Hunter: Light Shot x2000
INSERT INTO `playercreateinfo_item` (`race`, `class`, `itemid`, `amount`) VALUES (9, 3, 2516, 2000);
-- Blood Elf Hunter: Rough Arrow x2000
INSERT INTO `playercreateinfo_item` (`race`, `class`, `itemid`, `amount`) VALUES (10, 3, 2512, 2000);
-- Draenei Hunter: Rough Arrow x2000
INSERT INTO `playercreateinfo_item` (`race`, `class`, `itemid`, `amount`) VALUES (11, 3, 2512, 2000);
-- Worgen Hunter: Light Shot x2000
INSERT INTO `playercreateinfo_item` (`race`, `class`, `itemid`, `amount`) VALUES (12, 3, 2516, 2000);
